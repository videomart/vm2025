...
<?php
   ...
   $Ord_Cmp = new grid_licenca_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_licenca_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['modalidade'] = "MODALIDADE";
   $tab_labels["modalidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["modalidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["modalidade"] : "MODALIDADE";
   $tab_ger_campos['ordem'] = "on";
   $tab_def_campos['ordem'] = "ORDEM";
   $tab_labels["ordem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["ordem"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["ordem"] : "ORDEM ";
   $tab_ger_campos['data_compra'] = "on";
   $tab_def_campos['data_compra'] = "DATA_COMPRA";
   $tab_labels["data_compra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["data_compra"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["data_compra"] : "DATA COMPRA ";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "VENDEDOR";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["vendedor"] : "VENDEDOR ";
   $tab_ger_campos['empresa'] = "on";
   $tab_def_campos['empresa'] = "EMPRESA";
   $tab_labels["empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["empresa"] : "EMPRESA ";
   $tab_ger_campos['contato'] = "on";
   $tab_def_campos['contato'] = "CONTATO";
   $tab_labels["contato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["contato"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["contato"] : "CONTATO ";
   $tab_ger_campos['modelo'] = "on";
   $tab_def_campos['modelo'] = "MODELO";
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["modelo"] : "MODELO ";
   $tab_ger_campos['cod_ativacao'] = "on";
   $tab_def_campos['cod_ativacao'] = "COD_ATIVACAO";
   $tab_labels["cod_ativacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["cod_ativacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['labels']["cod_ativacao"] : "COD ATIVACAO ";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_licenca']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_licenca']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_licenca_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_licenca']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
