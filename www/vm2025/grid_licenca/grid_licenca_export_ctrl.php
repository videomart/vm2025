<?php
@session_start() ;
$_SESSION['scriptcase']['grid_licenca']['sc_process_barr'] = true;
require_once('../grid_licenca/index.php');
unset($_SESSION['scriptcase']['grid_licenca']['sc_process_barr']);
$ExportCtrl = new grid_licenca_export_control;
$ExportCtrl->Export_barr();

class grid_licenca_export_control
{
