...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data_compra';$Nm_numeric[] = "id";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_data_compra_cond" name="data_compra_cond" onChange="nm_campos_between(document.getElementById('id_vis_data_compra'), this, 'data_compra')">
      ...
      <br><span id="id_hide_data_compra"  <?php echo $str_hide_data_compra?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_empresa_cond" name="empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa'), this, 'empresa')">
      ...
      <br><span id="id_hide_empresa"  <?php echo $str_hide_empresa?>><INPUT  type="text" id="SC_empresa" name="empresa" value="<?php echo NM_encode_input($empresa) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_contato_cond" name="contato_cond" onChange="nm_campos_between(document.getElementById('id_vis_contato'), this, 'contato')">
      ...
      <br><span id="id_hide_contato"  <?php echo $str_hide_contato?>><INPUT  type="text" id="SC_contato" name="contato" value="<?php echo NM_encode_input($contato) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_modelo_cond" name="modelo_cond" onChange="nm_campos_between(document.getElementById('id_vis_modelo'), this, 'modelo')">
      ...
      <br><span id="id_hide_modelo"  <?php echo $str_hide_modelo?>><INPUT  type="text" id="SC_modelo" name="modelo" value="<?php echo NM_encode_input($modelo) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_cod_ativacao_cond" name="cod_ativacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_ativacao'), this, 'cod_ativacao')">
      ...
      <br><span id="id_hide_cod_ativacao"  <?php echo $str_hide_cod_ativacao?>><INPUT  type="text" id="SC_cod_ativacao" name="cod_ativacao" value="<?php echo NM_encode_input($cod_ativacao) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_serial_cond" name="serial_cond" onChange="nm_campos_between(document.getElementById('id_vis_serial'), this, 'serial')">
      ...
      <br><span id="id_hide_serial"  <?php echo $str_hide_serial?>><INPUT  type="text" id="SC_serial" name="serial" value="<?php echo NM_encode_input($serial) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
