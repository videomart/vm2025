...
class grid_licenca_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_licenca_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_licenca_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_licenca_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_licenca_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_licenca_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - licenca</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_licenca/grid_licenca_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_licenca_ajax_search.js"></script>
 <script type="text/javascript" src="grid_licenca_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_licenca_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_licenca']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_licenca']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_data_compra_cond#NMF#' + search_get_sel_txt('SC_data_compra_cond') + '@NMF@';
  str_out += 'SC_data_compra_dia#NMF#' + search_get_sel_txt('SC_data_compra_dia') + '@NMF@';
  str_out += 'SC_data_compra_mes#NMF#' + search_get_sel_txt('SC_data_compra_mes') + '@NMF@';
  str_out += 'SC_data_compra_ano#NMF#' + search_get_sel_txt('SC_data_compra_ano') + '@NMF@';
  str_out += 'SC_data_compra_input_2_dia#NMF#' + search_get_sel_txt('SC_data_compra_input_2_dia') + '@NMF@';
  str_out += 'SC_data_compra_input_2_mes#NMF#' + search_get_sel_txt('SC_data_compra_input_2_mes') + '@NMF@';
  str_out += 'SC_data_compra_input_2_ano#NMF#' + search_get_sel_txt('SC_data_compra_input_2_ano') + '@NMF@';
  ...
  str_out += 'SC_cod_ativacao_cond#NMF#' + search_get_sel_txt('SC_cod_ativacao_cond') + '@NMF@';
  str_out += 'SC_cod_ativacao#NMF#' + search_get_text('SC_cod_ativacao') + '@NMF@';
  str_out += 'SC_serial_cond#NMF#' + search_get_sel_txt('SC_serial_cond') + '@NMF@';
  str_out += 'SC_serial#NMF#' + search_get_text('SC_serial') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $id_cond, $id,
             $data_compra_cond, $data_compra, $data_compra_dia, $data_compra_mes, $data_compra_ano,
             $empresa_cond, $empresa,
             $contato_cond, $contato,
             $modelo_cond, $modelo,
             $cod_ativacao_cond, $cod_ativacao,
             $serial_cond, $serial,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['id_cond']; 
          $data_compra_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_dia']; 
          $data_compra_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_mes']; 
          $data_compra_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_ano']; 
          $data_compra_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_cond']; 
          $empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['empresa']; 
          $empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['empresa_cond']; 
          $contato = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['contato']; 
          $contato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['contato_cond']; 
          $modelo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['modelo']; 
          $modelo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['modelo_cond']; 
          $cod_ativacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['cod_ativacao']; 
          $cod_ativacao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['cod_ativacao_cond']; 
          $serial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['serial']; 
          $serial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['serial_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['NM_operador']; 
      ...
      if (!isset($data_compra_cond) || empty($data_compra_cond))
      {
         $data_compra_cond = "eq";
      }
      ...
      if (!isset($cod_ativacao_cond) || empty($cod_ativacao_cond))
      {
         $cod_ativacao_cond = "eq";
      }
      if (!isset($serial_cond) || empty($serial_cond))
      {
         $serial_cond = "eq";
      }
      ...
      $str_hide_data_compra = (in_array($data_compra_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_cod_ativacao = (in_array($cod_ativacao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_serial = (in_array($serial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($data_compra) || $data_compra == "")
      {
          $data_compra = "";
      }
      if (isset($data_compra) && !empty($data_compra))
      {
         $tmp_pos = (is_string($data_compra)) ? strpos($data_compra, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $data_compra = substr($data_compra, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($modelo)) ? strpos($modelo, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($cod_ativacao) || $cod_ativacao == "")
      {
          $cod_ativacao = "";
      }
      if (isset($cod_ativacao) && !empty($cod_ativacao))
      {
         $tmp_pos = (is_string($cod_ativacao)) ? strpos($cod_ativacao, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $cod_ativacao = substr($cod_ativacao, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($serial)) ? strpos($serial, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $serial = substr($serial, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_data_compra_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['data_compra'])) ? $this->New_label['data_compra'] : "DATA COMPRA "; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_data_compra_cond" name="data_compra_cond" onChange="nm_campos_between(document.getElementById('id_vis_data_compra'), this, 'data_compra')">
       <OPTION value="eq" <?php if ("eq" == $data_compra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $data_compra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $data_compra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $data_compra_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_data_compra" <?php echo $str_hide_data_compra?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['data_compra'])) ? $this->New_label['data_compra'] : "DATA COMPRA ";
 $nmgp_tab_label .= "data_compra?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_data_compra_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_compra_dia" name="data_compra_dia" value="<?php echo NM_encode_input($data_compra_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_data_compra_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_compra_mes" name="data_compra_mes" value="<?php echo NM_encode_input($data_compra_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_data_compra_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_compra_ano" name="data_compra_ano" value="<?php echo NM_encode_input($data_compra_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
      ...
      <TD id='SC_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['empresa'])) ? $this->New_label['empresa'] : "EMPRESA "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_empresa_cond" name="empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa'), this, 'empresa')">
       <OPTION value="eq" <?php if ("eq" == $empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_empresa" name="empresa" value="<?php echo NM_encode_input($empresa) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_contato_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['contato'])) ? $this->New_label['contato'] : "CONTATO "; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_contato_cond" name="contato_cond" onChange="nm_campos_between(document.getElementById('id_vis_contato'), this, 'contato')">
       <OPTION value="eq" <?php if ("eq" == $contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_contato" name="contato" value="<?php echo NM_encode_input($contato) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_modelo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['modelo'])) ? $this->New_label['modelo'] : "MODELO "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_modelo_cond" name="modelo_cond" onChange="nm_campos_between(document.getElementById('id_vis_modelo'), this, 'modelo')">
       <OPTION value="eq" <?php if ("eq" == $modelo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $modelo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $modelo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $modelo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_modelo" name="modelo" value="<?php echo NM_encode_input($modelo) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_cod_ativacao_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cod_ativacao'])) ? $this->New_label['cod_ativacao'] : "COD ATIVACAO "; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_cod_ativacao_cond" name="cod_ativacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_ativacao'), this, 'cod_ativacao')">
       <OPTION value="eq" <?php if ("eq" == $cod_ativacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $cod_ativacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cod_ativacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cod_ativacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_ativacao" <?php echo $str_hide_cod_ativacao?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cod_ativacao'])) ? $this->New_label['cod_ativacao'] : "COD ATIVACAO ";
 $nmgp_tab_label .= "cod_ativacao?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cod_ativacao" name="cod_ativacao" value="<?php echo NM_encode_input($cod_ativacao) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_serial_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['serial'])) ? $this->New_label['serial'] : "SERIAL "; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_serial_cond" name="serial_cond" onChange="nm_campos_between(document.getElementById('id_vis_serial'), this, 'serial')">
       <OPTION value="eq" <?php if ("eq" == $serial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $serial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $serial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $serial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_serial" <?php echo $str_hide_serial?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['serial'])) ? $this->New_label['serial'] : "SERIAL ";
 $nmgp_tab_label .= "serial?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_serial" name="serial" value="<?php echo NM_encode_input($serial) ?>"  size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
<?php
   if (is_file("grid_licenca_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_licenca']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_licenca']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.data_compra_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_data_compra'), document.F1.data_compra_cond, 'data_compra');
   document.F1.data_compra_dia.value = "";
   document.F1.data_compra_mes.value = "";
   document.F1.data_compra_ano.value = "";
   document.F1.empresa_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_empresa'), document.F1.empresa_cond, 'empresa');
   document.F1.empresa.value = "";
   document.F1.contato_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_contato'), document.F1.contato_cond, 'contato');
   document.F1.contato.value = "";
   document.F1.modelo_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_modelo'), document.F1.modelo_cond, 'modelo');
   document.F1.modelo.value = "";
   document.F1.cod_ativacao_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_cod_ativacao'), document.F1.cod_ativacao_cond, 'cod_ativacao');
   document.F1.cod_ativacao.value = "";
   document.F1.serial_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_serial'), document.F1.serial_cond, 'serial');
   document.F1.serial.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_data_compra_dia').bind('change', function() {sc_grid_licenca_valida_dia(this)});
    $('#SC_data_compra_mes').bind('change', function() {sc_grid_licenca_valida_mes(this)});
 }
 function sc_grid_licenca_valida_dia(obj)
 {
 ...
 function sc_grid_licenca_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_data_compra_cond'] = 'cond';
      $tp_fields['SC_data_compra_dia'] = 'text';
      $tp_fields['SC_data_compra_mes'] = 'text';
      $tp_fields['SC_data_compra_ano'] = 'text';
      $tp_fields['SC_data_compra_input_2_dia'] = 'text';
      $tp_fields['SC_data_compra_input_2_mes'] = 'text';
      $tp_fields['SC_data_compra_input_2_ano'] = 'text';
      $tp_fields['SC_empresa_cond'] = 'cond';
      $tp_fields['SC_empresa'] = 'text';
      $tp_fields['SC_contato_cond'] = 'cond';
      $tp_fields['SC_contato'] = 'text';
      $tp_fields['SC_modelo_cond'] = 'cond';
      $tp_fields['SC_modelo'] = 'text';
      $tp_fields['SC_cod_ativacao_cond'] = 'cond';
      $tp_fields['SC_cod_ativacao'] = 'text';
      $tp_fields['SC_serial_cond'] = 'cond';
      $tp_fields['SC_serial'] = 'text';
   ...
   function trata_campos()
   {
      global $id_cond, $id,
             ...
             $modelo_cond, $modelo,
             $cod_ativacao_cond, $cod_ativacao,
             $serial_cond, $serial, $nmgp_tab_label;
      ...
      $data_compra_cond_salva = $data_compra_cond; 
      ...
      $cod_ativacao_cond_salva = $cod_ativacao_cond; 
      if (!isset($cod_ativacao_input_2) || $cod_ativacao_input_2 == "")
      {
          $cod_ativacao_input_2 = $cod_ativacao;
      }
      $serial_cond_salva = $serial_cond; 
      if (!isset($serial_input_2) || $serial_input_2 == "")
      {
          $serial_input_2 = $serial;
      }
      if ($id_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_dia'] = $data_compra_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_mes'] = $data_compra_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_ano'] = $data_compra_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_cond'] = $data_compra_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['empresa'] = $empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['empresa_cond'] = $empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['contato'] = $contato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['contato_cond'] = $contato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['modelo'] = $modelo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['modelo_cond'] = $modelo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['cod_ativacao'] = $cod_ativacao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['cod_ativacao_cond'] = $cod_ativacao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['serial'] = $serial; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['serial_cond'] = $serial_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['data_compra'] = "'" . $this->cmp_formatado['data_compra'] . "'";
      if (isset($this->cmp_formatado['data_compra_input_2'])  && !empty($this->cmp_formatado['data_compra_input_2'])) {
          $this->cmp_formatado['data_compra_input_2'] = "'" . $this->cmp_formatado['data_compra_input_2'] . "'";
      }
      $Conteudo = $empresa;
      $this->cmp_formatado['empresa'] = $Conteudo;
      ...
      $Conteudo = $contato;
      $this->cmp_formatado['contato'] = $Conteudo;
      ...
      $Conteudo = $modelo;
      $this->cmp_formatado['modelo'] = $Conteudo;
      $this->cmp_formatado['modelo'] = "'" . $this->cmp_formatado['modelo'] . "'";
      if (isset($this->cmp_formatado['modelo_input_2'])  && !empty($this->cmp_formatado['modelo_input_2'])) {
          $this->cmp_formatado['modelo_input_2'] = "'" . $this->cmp_formatado['modelo_input_2'] . "'";
      }
      $Conteudo = $cod_ativacao;
      $this->cmp_formatado['cod_ativacao'] = $Conteudo;
      $this->cmp_formatado['cod_ativacao'] = "'" . $this->cmp_formatado['cod_ativacao'] . "'";
      if (isset($this->cmp_formatado['cod_ativacao_input_2'])  && !empty($this->cmp_formatado['cod_ativacao_input_2'])) {
          $this->cmp_formatado['cod_ativacao_input_2'] = "'" . $this->cmp_formatado['cod_ativacao_input_2'] . "'";
      }
      $Conteudo = $serial;
      $this->cmp_formatado['serial'] = $Conteudo;
      $this->cmp_formatado['serial'] = "'" . $this->cmp_formatado['serial'] . "'";
      if (isset($this->cmp_formatado['serial_input_2'])  && !empty($this->cmp_formatado['serial_input_2'])) {
          $this->cmp_formatado['serial_input_2'] = "'" . $this->cmp_formatado['serial_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $data_compra
      $this->Date_part = false;
      if ($data_compra_cond != "bi_TP" && $Res_comp != 'calend')
      {
          $data_compra_cond = strtoupper($data_compra_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $data_compra_ano;
          $Dtxt .= $data_compra_mes;
          $Dtxt .= $data_compra_dia;
          $val[0]['ano'] = $data_compra_ano;
          $val[0]['mes'] = $data_compra_mes;
          $val[0]['dia'] = $data_compra_dia;
          if ($data_compra_cond == "BW")
          {
              $val[1]['ano'] = $data_compra_input_2_ano;
              $val[1]['mes'] = $data_compra_input_2_mes;
              $val[1]['dia'] = $data_compra_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $data_compra_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $data_compra = $val[0];
          $this->cmp_formatado['data_compra'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['data_compra'], "YYYY-MM-DD");
          $this->cmp_formatado['data_compra'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          $this->cmp_formatado['data_compra'] = "'" . $this->cmp_formatado['data_compra'] . "'";
          if ($data_compra_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $data_compra_input_2     = $val[1];
              $this->cmp_formatado['data_compra_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']['data_compra_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['data_compra_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['data_compra_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          $this->cmp_formatado['data_compra_input_2'] = "'" . $this->cmp_formatado['data_compra_input_2'] . "'";
          }
          if (!empty($Dtxt) || $data_compra_cond == "NU" || $data_compra_cond == "NN"|| $data_compra_cond == "EP"|| $data_compra_cond == "NE")
          {
              $this->monta_condicao("DATA_COMPRA", $data_compra_cond, $data_compra, $data_compra_input_2, 'data_compra', 'DATE');
          }
      }
      ...
      {
         $this->monta_condicao("MODELO", $modelo_cond, $modelo, "", "modelo", "VARCHAR", false);
      }

      //----- $cod_ativacao
      $this->Date_part = false;
      if (isset($cod_ativacao) || $cod_ativacao_cond == "nu" || $cod_ativacao_cond == "nn" || $cod_ativacao_cond == "ep" || $cod_ativacao_cond == "ne")
      {
         $this->monta_condicao("COD_ATIVACAO", $cod_ativacao_cond, $cod_ativacao, "", "cod_ativacao", "VARCHAR", false);
      }

      //----- $serial
      $this->Date_part = false;
      if (isset($serial) || $serial_cond == "nu" || $serial_cond == "nn" || $serial_cond == "ep" || $serial_cond == "ne")
      {
         $this->monta_condicao("SERIAL", $serial_cond, $serial, "", "serial", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_licenca']['cond_pesq'] .= $this->NM_operador;
