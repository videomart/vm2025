...
//
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['rows']))
   {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opc_liga']['rows']);
   }
   ...
   if (!$GLOBALS['nm_restore_grid_save'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['prim_cons'] || !empty($nmgp_parms)) )  
   { 
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"app_grid_sec_users_jquery_8718.js\"></script>\r\n");
...
$nm_saida->saida("}\r\n");
 ...
 { 
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['proc_pdf_vert'])
  {
   ...
   $this->css_remove_margin     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['link_info']['remove_margin']))     ? "margin: 0;" : "";
   $this->css_remove_border     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['link_info']['remove_border']))     ? "border-width: 0;" : "";
   $this->css_remove_background = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['link_info']['remove_background'])) ? "background-color: transparent; background-image: none;" : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'])
   { 
