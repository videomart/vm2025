  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estoque" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_produto
  function do_ajax_form_estoque_validate_id_produto()
  {
  } // do_ajax_form_estoque_validate_id_produto

  function do_ajax_form_estoque_validate_id_produto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_id_produto_cb

  // ---------- Validate descricao
  function do_ajax_form_estoque_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldHidden(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_estoque_validate_descricao_cb);
  } // do_ajax_form_estoque_validate_descricao

  function do_ajax_form_estoque_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_descricao_cb

  // ---------- Validate id_empresa
  function do_ajax_form_estoque_validate_id_empresa()
  {
  } // do_ajax_form_estoque_validate_id_empresa

  function do_ajax_form_estoque_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_id_empresa_cb

  // ---------- Validate obs
  function do_ajax_form_estoque_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_obs(var_obs, var_script_case_init, do_ajax_form_estoque_validate_obs_cb);
  } // do_ajax_form_estoque_validate_obs

  function do_ajax_form_estoque_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_obs_cb

  // ---------- Validate estoque
  function do_ajax_form_estoque_validate_estoque()
  {
    var nomeCampo_estoque = "estoque";
    var var_estoque = scAjaxGetFieldHidden(nomeCampo_estoque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_estoque(var_estoque, var_script_case_init, do_ajax_form_estoque_validate_estoque_cb);
  } // do_ajax_form_estoque_validate_estoque

  function do_ajax_form_estoque_validate_estoque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_estoque_cb

  // ---------- Validate operacao
  function do_ajax_form_estoque_validate_operacao()
  {
    var nomeCampo_operacao = "operacao";
    var var_operacao = scAjaxGetFieldRadio(nomeCampo_operacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_operacao(var_operacao, var_script_case_init, do_ajax_form_estoque_validate_operacao_cb);
  } // do_ajax_form_estoque_validate_operacao

  function do_ajax_form_estoque_validate_operacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "operacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_operacao_cb

  // ---------- Validate entrada
  function do_ajax_form_estoque_validate_entrada()
  {
    var nomeCampo_entrada = "entrada";
    var var_entrada = scAjaxGetFieldText(nomeCampo_entrada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_entrada(var_entrada, var_script_case_init, do_ajax_form_estoque_validate_entrada_cb);
  } // do_ajax_form_estoque_validate_entrada

  function do_ajax_form_estoque_validate_entrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_entrada_cb

  // ---------- Validate saida
  function do_ajax_form_estoque_validate_saida()
  {
    var nomeCampo_saida = "saida";
    var var_saida = scAjaxGetFieldText(nomeCampo_saida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_saida(var_saida, var_script_case_init, do_ajax_form_estoque_validate_saida_cb);
  } // do_ajax_form_estoque_validate_saida

  function do_ajax_form_estoque_validate_saida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_saida_cb

  // ---------- Validate data
  function do_ajax_form_estoque_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_validate_data(var_data, var_script_case_init, do_ajax_form_estoque_validate_data_cb);
  } // do_ajax_form_estoque_validate_data

  function do_ajax_form_estoque_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_validate_data_cb

  // ---------- Event onclick operacao
  function do_ajax_form_estoque_event_operacao_onclick()
  {
    var var_operacao = scAjaxGetFieldRadio("operacao");
    var var_entrada = scAjaxGetFieldText("entrada");
    var var_saida = scAjaxGetFieldText("saida");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_estoque_event_operacao_onclick(var_operacao, var_entrada, var_saida, var_script_case_init, do_ajax_form_estoque_event_operacao_onclick_cb);
  } // do_ajax_form_estoque_event_operacao_onclick

  function do_ajax_form_estoque_event_operacao_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "operacao";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_estoque_event_operacao_onclick_cb_after_alert);
  } // do_ajax_form_estoque_event_operacao_onclick_cb
  function do_ajax_form_estoque_event_operacao_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_estoque_event_operacao_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_estoque_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estoque_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_produto = scAjaxGetFieldText("id_produto");
    var var_descricao = scAjaxGetFieldHidden("descricao");
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_obs = scAjaxGetFieldText("obs");
    var var_estoque = scAjaxGetFieldHidden("estoque");
    var var_operacao = scAjaxGetFieldRadio("operacao");
    var var_entrada = scAjaxGetFieldText("entrada");
    var var_saida = scAjaxGetFieldText("saida");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_estoque_submit_form(var_id_produto, var_descricao, var_id_empresa, var_obs, var_estoque, var_operacao, var_entrada, var_saida, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_estoque_submit_form_cb);
  } // do_ajax_form_estoque_submit_form

  function do_ajax_form_estoque_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_produto");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("id_empresa");
      scAjaxHideErrorDisplay("obs");
      scAjaxHideErrorDisplay("estoque");
      scAjaxHideErrorDisplay("operacao");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_estoque_submit_form_cb_after_alert);
  } // do_ajax_form_estoque_submit_form_cb
  function do_ajax_form_estoque_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_estoque_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_estoque_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_estoque_navigate_form, function() {});
    } else {
      perform_ajax_form_estoque_navigate_form();
    }
  }

  function perform_ajax_form_estoque_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_estoque_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estoque_navigate_form_cb);
  } // do_ajax_form_estoque_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estoque_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_estoque_navigate_form_cb_after_alert);
  } // do_ajax_form_estoque_navigate_form_cb
  function do_ajax_form_estoque_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_estoque_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_estoque_navigate_form_cb_after_alert

  function sc_hide_form_estoque_form()
  {
  ...
  function do_ajax_form_estoque_lkpedt_refresh_id_produto()
  {
    var var_id_produto = scAjaxGetFieldText("id_produto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_produto";
    x_ajax_form_estoque_lkpedt_refresh_id_produto(var_id_produto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_estoque_lkpedt_refresh_id_produto_cb);
  } // do_ajax_form_estoque_lkpedt_refresh_id_produto

  function do_ajax_form_estoque_lkpedt_refresh_id_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_estoque_lkpedt_refresh_id_produto_cb
  ...
  ajax_field_list[2] = "id_empresa";
  ajax_field_list[3] = "obs";
  ajax_field_list[4] = "estoque";
  ajax_field_list[5] = "operacao";
  ajax_field_list[6] = "entrada";
  ajax_field_list[7] = "saida";
  ...
  var ajax_error_list = {
    "id_produto": {"label": "Modelo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "id_empresa": {"label": "Cliente / Fornecedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "obs": {"label": "OBS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "estoque": {"label": "Estoque", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "operacao": {"label": "Operação", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "entrada": {"label": "ENTRADA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "saida": {"label": "SAIDA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["estoque"][1] = "estoque";
  ajax_field_mult["operacao"][1] = "operacao";
  ...
  var ajax_field_id = {
    ...
    "estoque": new Array("hidden_field_label_estoque", "hidden_field_data_estoque"),
    "operacao": new Array("hidden_field_label_operacao", "hidden_field_data_operacao"),
