  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estoque_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_produto
  function do_ajax_form_estoque_mob_validate_id_produto()
  {
  } // do_ajax_form_estoque_mob_validate_id_produto

  function do_ajax_form_estoque_mob_validate_id_produto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_id_produto_cb

  // ---------- Validate descricao
  function do_ajax_form_estoque_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldHidden(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_estoque_mob_validate_descricao_cb);
  } // do_ajax_form_estoque_mob_validate_descricao

  function do_ajax_form_estoque_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_descricao_cb

  // ---------- Validate id_empresa
  function do_ajax_form_estoque_mob_validate_id_empresa()
  {
  } // do_ajax_form_estoque_mob_validate_id_empresa

  function do_ajax_form_estoque_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_id_empresa_cb

  // ---------- Validate obs
  function do_ajax_form_estoque_mob_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_obs(var_obs, var_script_case_init, do_ajax_form_estoque_mob_validate_obs_cb);
  } // do_ajax_form_estoque_mob_validate_obs

  function do_ajax_form_estoque_mob_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_obs_cb

  // ---------- Validate estoque
  function do_ajax_form_estoque_mob_validate_estoque()
  {
    var nomeCampo_estoque = "estoque";
    var var_estoque = scAjaxGetFieldHidden(nomeCampo_estoque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_estoque(var_estoque, var_script_case_init, do_ajax_form_estoque_mob_validate_estoque_cb);
  } // do_ajax_form_estoque_mob_validate_estoque

  function do_ajax_form_estoque_mob_validate_estoque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_estoque_cb

  // ---------- Validate operacao
  function do_ajax_form_estoque_mob_validate_operacao()
  {
    var nomeCampo_operacao = "operacao";
    var var_operacao = scAjaxGetFieldRadio(nomeCampo_operacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_operacao(var_operacao, var_script_case_init, do_ajax_form_estoque_mob_validate_operacao_cb);
  } // do_ajax_form_estoque_mob_validate_operacao

  function do_ajax_form_estoque_mob_validate_operacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_operacao_cb

  // ---------- Validate entrada
  function do_ajax_form_estoque_mob_validate_entrada()
  {
    var nomeCampo_entrada = "entrada";
    var var_entrada = scAjaxGetFieldText(nomeCampo_entrada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_entrada(var_entrada, var_script_case_init, do_ajax_form_estoque_mob_validate_entrada_cb);
  } // do_ajax_form_estoque_mob_validate_entrada

  function do_ajax_form_estoque_mob_validate_entrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_entrada_cb

  // ---------- Validate saida
  function do_ajax_form_estoque_mob_validate_saida()
  {
    var nomeCampo_saida = "saida";
    var var_saida = scAjaxGetFieldText(nomeCampo_saida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_saida(var_saida, var_script_case_init, do_ajax_form_estoque_mob_validate_saida_cb);
  } // do_ajax_form_estoque_mob_validate_saida

  function do_ajax_form_estoque_mob_validate_saida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_saida_cb

  // ---------- Validate data
  function do_ajax_form_estoque_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estoque_mob_validate_data(var_data, var_script_case_init, do_ajax_form_estoque_mob_validate_data_cb);
  } // do_ajax_form_estoque_mob_validate_data

  function do_ajax_form_estoque_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estoque_mob_validate_data_cb

  // ---------- Event onclick operacao
  function do_ajax_form_estoque_mob_event_operacao_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_estoque_mob_event_operacao_onclick(var_operacao, var_entrada, var_saida, var_script_case_init, do_ajax_form_estoque_mob_event_operacao_onclick_cb);
  } // do_ajax_form_estoque_mob_event_operacao_onclick

  function do_ajax_form_estoque_mob_event_operacao_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "operacao";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_estoque_mob_event_operacao_onclick_cb_after_alert);
  } // do_ajax_form_estoque_mob_event_operacao_onclick_cb
  function do_ajax_form_estoque_mob_event_operacao_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_estoque_mob_event_operacao_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_estoque_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estoque_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_estoque_mob_submit_form(var_id_produto, var_descricao, var_id_empresa, var_obs, var_estoque, var_operacao, var_entrada, var_saida, var_data, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_estoque_mob_submit_form_cb);
  } // do_ajax_form_estoque_mob_submit_form

  function do_ajax_form_estoque_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_estoque_mob_submit_form_cb_after_alert);
  } // do_ajax_form_estoque_mob_submit_form_cb
  function do_ajax_form_estoque_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_estoque_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_estoque_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_estoque_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_estoque_mob_navigate_form();
    }
  }

  function perform_ajax_form_estoque_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_estoque_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estoque_mob_navigate_form_cb);
  } // do_ajax_form_estoque_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estoque_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_estoque_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_estoque_mob_navigate_form_cb
  function do_ajax_form_estoque_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_estoque_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_estoque_mob_navigate_form_cb_after_alert

  function sc_hide_form_estoque_mob_form()
  {
  ...
  function do_ajax_form_estoque_mob_lkpedt_refresh_id_produto()
  {
    var var_id_produto = scAjaxGetFieldText("id_produto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_produto";
    x_ajax_form_estoque_mob_lkpedt_refresh_id_produto(var_id_produto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_estoque_mob_lkpedt_refresh_id_produto_cb);
  } // do_ajax_form_estoque_mob_lkpedt_refresh_id_produto

  function do_ajax_form_estoque_mob_lkpedt_refresh_id_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_estoque_mob_lkpedt_refresh_id_produto_cb
