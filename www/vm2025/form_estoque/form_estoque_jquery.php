...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_estoque_id_onchange(this, iSeqRow, event) });
  $('#id_sc_field_id_produto' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_estoque_id_produto_onblur('#id_sc_field_id_produto' + iSeqRow, iSeqRow, event);}, 300) })
                                        .bind('change', function() { sc_form_estoque_id_produto_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data' + iSeqRow).bind('blur', function() { sc_form_estoque_data_onblur('#id_sc_field_data' + iSeqRow, iSeqRow, event) })
                                  .bind('change', function() { sc_form_estoque_data_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_operacao' + iSeqRow).bind('blur', function() { sc_form_estoque_operacao_onblur('#id_sc_field_operacao' + iSeqRow, iSeqRow, event) })
                                      .bind('change', function() { sc_form_estoque_operacao_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_entrada' + iSeqRow).bind('blur', function() { sc_form_estoque_entrada_onblur('#id_sc_field_entrada' + iSeqRow, iSeqRow, event) })
                                     .bind('change', function() { sc_form_estoque_entrada_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_saida' + iSeqRow).bind('blur', function() { sc_form_estoque_saida_onblur('#id_sc_field_saida' + iSeqRow, iSeqRow, event) })
                                   .bind('change', function() { sc_form_estoque_saida_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_id_empresa' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_estoque_id_empresa_onblur('#id_sc_field_id_empresa' + iSeqRow, iSeqRow, event);}, 300) })
                                        .bind('change', function() { sc_form_estoque_id_empresa_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_obs' + iSeqRow).bind('blur', function() { sc_form_estoque_obs_onblur('#id_sc_field_obs' + iSeqRow, iSeqRow, event) })
                                 .bind('change', function() { sc_form_estoque_obs_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_estoque' + iSeqRow).bind('blur', function() { sc_form_estoque_estoque_onblur('#id_sc_field_estoque' + iSeqRow, iSeqRow, event) })
                                     .bind('change', function() { sc_form_estoque_estoque_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_descricao' + iSeqRow).bind('blur', function() { sc_form_estoque_descricao_onblur('#id_sc_field_descricao' + iSeqRow, iSeqRow, event) })
                                       .bind('change', function() { sc_form_estoque_descricao_onchange(this, iSeqRow, event) })
...
Upload_Cancel = false;
function sc_form_estoque_id_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_id_produto_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_data_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_operacao_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_entrada_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_saida_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_id_empresa_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_obs_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_estoque_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_estoque_descricao_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_estoque_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_estoque')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
