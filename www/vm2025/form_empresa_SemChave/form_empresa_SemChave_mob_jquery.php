...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'contatos':
      case 'obs':
        sc_exib_ocult_pag('form_empresa_SemChave_mob_form0');
        break;
      case 'extrato':
        sc_exib_ocult_pag('form_empresa_SemChave_mob_form1');
        break;
    }
  }
...
function displayChange_field_extrato(row, status) {
    var fieldId;
        ...
        $("#nmsc_iframe_liga_grid_extrato")[0].contentWindow.specificStyle();
}
...
function scHidePage(pageNo) {
        $("#id_form_empresa_SemChave_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_empresa_SemChave_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
