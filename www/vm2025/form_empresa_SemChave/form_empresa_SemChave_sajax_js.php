  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empresa_SemChave" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_empresa_SemChave_form();
        }
...
?>
  ...
  // ---------- Validate empresa
  function do_ajax_form_empresa_SemChave_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_empresa_SemChave_validate_empresa_cb);
  } // do_ajax_form_empresa_SemChave_validate_empresa

  function do_ajax_form_empresa_SemChave_validate_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_empresa_cb

  // ---------- Validate tipo
  function do_ajax_form_empresa_SemChave_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_empresa_SemChave_validate_tipo_cb);
  } // do_ajax_form_empresa_SemChave_validate_tipo

  function do_ajax_form_empresa_SemChave_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_tipo_cb

  // ---------- Validate id_cidade
  function do_ajax_form_empresa_SemChave_validate_id_cidade()
  {
  } // do_ajax_form_empresa_SemChave_validate_id_cidade

  function do_ajax_form_empresa_SemChave_validate_id_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_id_cidade_cb

  // ---------- Validate razao_social
  function do_ajax_form_empresa_SemChave_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_empresa_SemChave_validate_razao_social_cb);
  } // do_ajax_form_empresa_SemChave_validate_razao_social

  function do_ajax_form_empresa_SemChave_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_razao_social_cb

  // ---------- Validate rede
  function do_ajax_form_empresa_SemChave_validate_rede()
  {
    var nomeCampo_rede = "rede";
    var var_rede = scAjaxGetFieldSelect(nomeCampo_rede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_rede(var_rede, var_script_case_init, do_ajax_form_empresa_SemChave_validate_rede_cb);
  } // do_ajax_form_empresa_SemChave_validate_rede

  function do_ajax_form_empresa_SemChave_validate_rede_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_rede_cb

  // ---------- Validate cep
  function do_ajax_form_empresa_SemChave_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_cep(var_cep, var_script_case_init, do_ajax_form_empresa_SemChave_validate_cep_cb);
  } // do_ajax_form_empresa_SemChave_validate_cep

  function do_ajax_form_empresa_SemChave_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_cep_cb

  // ---------- Validate categoria
  function do_ajax_form_empresa_SemChave_validate_categoria()
  {
    var nomeCampo_categoria = "categoria";
    var var_categoria = scAjaxGetFieldSelect(nomeCampo_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_categoria(var_categoria, var_script_case_init, do_ajax_form_empresa_SemChave_validate_categoria_cb);
  } // do_ajax_form_empresa_SemChave_validate_categoria

  function do_ajax_form_empresa_SemChave_validate_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_categoria_cb

  // ---------- Validate endereco
  function do_ajax_form_empresa_SemChave_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_empresa_SemChave_validate_endereco_cb);
  } // do_ajax_form_empresa_SemChave_validate_endereco

  function do_ajax_form_empresa_SemChave_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_endereco_cb

  // ---------- Validate local
  function do_ajax_form_empresa_SemChave_validate_local()
  {
    var nomeCampo_local = "local";
    var var_local = scAjaxGetFieldSelect(nomeCampo_local);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_local(var_local, var_script_case_init, do_ajax_form_empresa_SemChave_validate_local_cb);
  } // do_ajax_form_empresa_SemChave_validate_local

  function do_ajax_form_empresa_SemChave_validate_local_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_local_cb

  // ---------- Validate cgc
  function do_ajax_form_empresa_SemChave_validate_cgc()
  {
    var nomeCampo_cgc = "cgc";
    var var_cgc = scAjaxGetFieldText(nomeCampo_cgc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_cgc(var_cgc, var_script_case_init, do_ajax_form_empresa_SemChave_validate_cgc_cb);
  } // do_ajax_form_empresa_SemChave_validate_cgc

  function do_ajax_form_empresa_SemChave_validate_cgc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_cgc_cb

  // ---------- Validate inscmun
  function do_ajax_form_empresa_SemChave_validate_inscmun()
  {
    var nomeCampo_inscmun = "inscmun";
    var var_inscmun = scAjaxGetFieldText(nomeCampo_inscmun);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_inscmun(var_inscmun, var_script_case_init, do_ajax_form_empresa_SemChave_validate_inscmun_cb);
  } // do_ajax_form_empresa_SemChave_validate_inscmun

  function do_ajax_form_empresa_SemChave_validate_inscmun_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_inscmun_cb

  // ---------- Validate cadastrante
  function do_ajax_form_empresa_SemChave_validate_cadastrante()
  {
    var nomeCampo_cadastrante = "cadastrante";
    var var_cadastrante = scAjaxGetFieldHidden(nomeCampo_cadastrante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_cadastrante(var_cadastrante, var_script_case_init, do_ajax_form_empresa_SemChave_validate_cadastrante_cb);
  } // do_ajax_form_empresa_SemChave_validate_cadastrante

  function do_ajax_form_empresa_SemChave_validate_cadastrante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_cadastrante_cb

  // ---------- Validate saldo_real
  function do_ajax_form_empresa_SemChave_validate_saldo_real()
  {
    var nomeCampo_saldo_real = "saldo_real";
    var var_saldo_real = scAjaxGetFieldHidden(nomeCampo_saldo_real);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_saldo_real(var_saldo_real, var_script_case_init, do_ajax_form_empresa_SemChave_validate_saldo_real_cb);
  } // do_ajax_form_empresa_SemChave_validate_saldo_real

  function do_ajax_form_empresa_SemChave_validate_saldo_real_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_saldo_real_cb

  // ---------- Validate cpf
  function do_ajax_form_empresa_SemChave_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_cpf(var_cpf, var_script_case_init, do_ajax_form_empresa_SemChave_validate_cpf_cb);
  } // do_ajax_form_empresa_SemChave_validate_cpf

  function do_ajax_form_empresa_SemChave_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_cpf_cb

  // ---------- Validate inscest
  function do_ajax_form_empresa_SemChave_validate_inscest()
  {
    var nomeCampo_inscest = "inscest";
    var var_inscest = scAjaxGetFieldText(nomeCampo_inscest);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_inscest(var_inscest, var_script_case_init, do_ajax_form_empresa_SemChave_validate_inscest_cb);
  } // do_ajax_form_empresa_SemChave_validate_inscest

  function do_ajax_form_empresa_SemChave_validate_inscest_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_inscest_cb

  // ---------- Validate dat_ult_mov
  function do_ajax_form_empresa_SemChave_validate_dat_ult_mov()
  {
    var nomeCampo_dat_ult_mov = "dat_ult_mov";
    var var_dat_ult_mov = scAjaxGetFieldText(nomeCampo_dat_ult_mov);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_dat_ult_mov(var_dat_ult_mov, var_script_case_init, do_ajax_form_empresa_SemChave_validate_dat_ult_mov_cb);
  } // do_ajax_form_empresa_SemChave_validate_dat_ult_mov

  function do_ajax_form_empresa_SemChave_validate_dat_ult_mov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_dat_ult_mov_cb

  // ---------- Validate saldo_dolar
  function do_ajax_form_empresa_SemChave_validate_saldo_dolar()
  {
    var nomeCampo_saldo_dolar = "saldo_dolar";
    var var_saldo_dolar = scAjaxGetFieldHidden(nomeCampo_saldo_dolar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_saldo_dolar(var_saldo_dolar, var_script_case_init, do_ajax_form_empresa_SemChave_validate_saldo_dolar_cb);
  } // do_ajax_form_empresa_SemChave_validate_saldo_dolar

  function do_ajax_form_empresa_SemChave_validate_saldo_dolar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_saldo_dolar_cb

  // ---------- Validate homepage
  function do_ajax_form_empresa_SemChave_validate_homepage()
  {
    var nomeCampo_homepage = "homepage";
    var var_homepage = scAjaxGetFieldText(nomeCampo_homepage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_homepage(var_homepage, var_script_case_init, do_ajax_form_empresa_SemChave_validate_homepage_cb);
  } // do_ajax_form_empresa_SemChave_validate_homepage

  function do_ajax_form_empresa_SemChave_validate_homepage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_homepage_cb

  // ---------- Validate dealer
  function do_ajax_form_empresa_SemChave_validate_dealer()
  {
    var nomeCampo_dealer = "dealer";
    var var_dealer = scAjaxGetFieldSelect(nomeCampo_dealer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_dealer(var_dealer, var_script_case_init, do_ajax_form_empresa_SemChave_validate_dealer_cb);
  } // do_ajax_form_empresa_SemChave_validate_dealer

  function do_ajax_form_empresa_SemChave_validate_dealer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_dealer_cb

  // ---------- Validate data
  function do_ajax_form_empresa_SemChave_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_data(var_data, var_script_case_init, do_ajax_form_empresa_SemChave_validate_data_cb);
  } // do_ajax_form_empresa_SemChave_validate_data

  function do_ajax_form_empresa_SemChave_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_data_cb

  // ---------- Validate id_nextel
  function do_ajax_form_empresa_SemChave_validate_id_nextel()
  {
    var nomeCampo_id_nextel = "id_nextel";
    var var_id_nextel = scAjaxGetFieldText(nomeCampo_id_nextel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_id_nextel(var_id_nextel, var_script_case_init, do_ajax_form_empresa_SemChave_validate_id_nextel_cb);
  } // do_ajax_form_empresa_SemChave_validate_id_nextel

  function do_ajax_form_empresa_SemChave_validate_id_nextel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_id_nextel_cb

  // ---------- Validate contato
  function do_ajax_form_empresa_SemChave_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldHidden(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_contato(var_contato, var_script_case_init, do_ajax_form_empresa_SemChave_validate_contato_cb);
  } // do_ajax_form_empresa_SemChave_validate_contato

  function do_ajax_form_empresa_SemChave_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_contato_cb

  // ---------- Validate ddd
  function do_ajax_form_empresa_SemChave_validate_ddd()
  {
    var nomeCampo_ddd = "ddd";
    var var_ddd = scAjaxGetFieldHidden(nomeCampo_ddd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_ddd(var_ddd, var_script_case_init, do_ajax_form_empresa_SemChave_validate_ddd_cb);
  } // do_ajax_form_empresa_SemChave_validate_ddd

  function do_ajax_form_empresa_SemChave_validate_ddd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_ddd_cb

  // ---------- Validate telefone
  function do_ajax_form_empresa_SemChave_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldHidden(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_empresa_SemChave_validate_telefone_cb);
  } // do_ajax_form_empresa_SemChave_validate_telefone

  function do_ajax_form_empresa_SemChave_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_empresa_SemChave_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldHidden(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_email(var_email, var_script_case_init, do_ajax_form_empresa_SemChave_validate_email_cb);
  } // do_ajax_form_empresa_SemChave_validate_email

  function do_ajax_form_empresa_SemChave_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_email_cb

  // ---------- Validate celular
  function do_ajax_form_empresa_SemChave_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_celular(var_celular, var_script_case_init, do_ajax_form_empresa_SemChave_validate_celular_cb);
  } // do_ajax_form_empresa_SemChave_validate_celular

  function do_ajax_form_empresa_SemChave_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_celular_cb

  // ---------- Validate operadora
  function do_ajax_form_empresa_SemChave_validate_operadora()
  {
    var nomeCampo_operadora = "operadora";
    var var_operadora = scAjaxGetFieldSelect(nomeCampo_operadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_operadora(var_operadora, var_script_case_init, do_ajax_form_empresa_SemChave_validate_operadora_cb);
  } // do_ajax_form_empresa_SemChave_validate_operadora

  function do_ajax_form_empresa_SemChave_validate_operadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_operadora_cb

  // ---------- Validate fax
  function do_ajax_form_empresa_SemChave_validate_fax()
  {
    var nomeCampo_fax = "fax";
    var var_fax = scAjaxGetFieldText(nomeCampo_fax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_fax(var_fax, var_script_case_init, do_ajax_form_empresa_SemChave_validate_fax_cb);
  } // do_ajax_form_empresa_SemChave_validate_fax

  function do_ajax_form_empresa_SemChave_validate_fax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_fax_cb

  // ---------- Validate contatorelacao
  function do_ajax_form_empresa_SemChave_validate_contatorelacao()
  {
    var nomeCampo_contatorelacao = "contatorelacao";
    var var_contatorelacao = scAjaxGetFieldText(nomeCampo_contatorelacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_contatorelacao(var_contatorelacao, var_script_case_init, do_ajax_form_empresa_SemChave_validate_contatorelacao_cb);
  } // do_ajax_form_empresa_SemChave_validate_contatorelacao

  function do_ajax_form_empresa_SemChave_validate_contatorelacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_contatorelacao_cb

  // ---------- Validate telefones
  function do_ajax_form_empresa_SemChave_validate_telefones()
  {
    var nomeCampo_telefones = "telefones";
    var var_telefones = scAjaxGetFieldText(nomeCampo_telefones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_telefones(var_telefones, var_script_case_init, do_ajax_form_empresa_SemChave_validate_telefones_cb);
  } // do_ajax_form_empresa_SemChave_validate_telefones

  function do_ajax_form_empresa_SemChave_validate_telefones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_telefones_cb

  // ---------- Validate contatos
  function do_ajax_form_empresa_SemChave_validate_contatos()
  {
    var nomeCampo_contatos = "contatos";
    var var_contatos = scAjaxGetFieldText(nomeCampo_contatos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_contatos(var_contatos, var_script_case_init, do_ajax_form_empresa_SemChave_validate_contatos_cb);
  } // do_ajax_form_empresa_SemChave_validate_contatos

  function do_ajax_form_empresa_SemChave_validate_contatos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_contatos_cb

  // ---------- Validate obs
  function do_ajax_form_empresa_SemChave_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_obs(var_obs, var_script_case_init, do_ajax_form_empresa_SemChave_validate_obs_cb);
  } // do_ajax_form_empresa_SemChave_validate_obs

  function do_ajax_form_empresa_SemChave_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_obs_cb

  // ---------- Validate extrato
  function do_ajax_form_empresa_SemChave_validate_extrato()
  {
    var nomeCampo_extrato = "extrato";
    var var_extrato = scAjaxGetFieldText(nomeCampo_extrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_SemChave_validate_extrato(var_extrato, var_script_case_init, do_ajax_form_empresa_SemChave_validate_extrato_cb);
  } // do_ajax_form_empresa_SemChave_validate_extrato

  function do_ajax_form_empresa_SemChave_validate_extrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_SemChave_validate_extrato_cb

  // ---------- Event onchange categoria
  function do_ajax_form_empresa_SemChave_event_categoria_onchange()
  {
    var var_categoria = scAjaxGetFieldSelect("categoria");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_SemChave_event_categoria_onchange(var_categoria, var_script_case_init, do_ajax_form_empresa_SemChave_event_categoria_onchange_cb);
  } // do_ajax_form_empresa_SemChave_event_categoria_onchange

  function do_ajax_form_empresa_SemChave_event_categoria_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "categoria";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_SemChave_event_categoria_onchange_cb_after_alert);
  } // do_ajax_form_empresa_SemChave_event_categoria_onchange_cb
  function do_ajax_form_empresa_SemChave_event_categoria_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_SemChave_event_categoria_onchange_cb_after_alert

  // ---------- Event onchange empresa
  function do_ajax_form_empresa_SemChave_event_empresa_onchange()
  {
    var var_razao_social = scAjaxGetFieldText("razao_social");
    var var_empresa = scAjaxGetFieldText("empresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_SemChave_event_empresa_onchange(var_razao_social, var_empresa, var_script_case_init, do_ajax_form_empresa_SemChave_event_empresa_onchange_cb);
  } // do_ajax_form_empresa_SemChave_event_empresa_onchange

  function do_ajax_form_empresa_SemChave_event_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_SemChave_event_empresa_onchange_cb_after_alert);
  } // do_ajax_form_empresa_SemChave_event_empresa_onchange_cb
  function do_ajax_form_empresa_SemChave_event_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_SemChave_event_empresa_onchange_cb_after_alert

  // ---------- Event onchange id_cidade
  function do_ajax_form_empresa_SemChave_event_id_cidade_onchange()
  {
    var var_id_cidade = scAjaxGetFieldText("id_cidade");
    var var_ddd = scAjaxGetFieldHidden("ddd");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_SemChave_event_id_cidade_onchange(var_id_cidade, var_ddd, var_script_case_init, do_ajax_form_empresa_SemChave_event_id_cidade_onchange_cb);
  } // do_ajax_form_empresa_SemChave_event_id_cidade_onchange

  function do_ajax_form_empresa_SemChave_event_id_cidade_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_cidade";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_SemChave_event_id_cidade_onchange_cb_after_alert);
  } // do_ajax_form_empresa_SemChave_event_id_cidade_onchange_cb
  function do_ajax_form_empresa_SemChave_event_id_cidade_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_SemChave_event_id_cidade_onchange_cb_after_alert

  // ---------- Event onclick tipo
  function do_ajax_form_empresa_SemChave_event_tipo_onclick()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_categoria = scAjaxGetFieldSelect("categoria");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_SemChave_event_tipo_onclick(var_tipo, var_categoria, var_script_case_init, do_ajax_form_empresa_SemChave_event_tipo_onclick_cb);
  } // do_ajax_form_empresa_SemChave_event_tipo_onclick

  function do_ajax_form_empresa_SemChave_event_tipo_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_SemChave_event_tipo_onclick_cb_after_alert);
  } // do_ajax_form_empresa_SemChave_event_tipo_onclick_cb
  function do_ajax_form_empresa_SemChave_event_tipo_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_SemChave_event_tipo_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empresa_SemChave_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empresa_SemChave_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_empresa = scAjaxGetFieldText("empresa");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_empresa_SemChave_submit_form(var_empresa, var_tipo, var_id_cidade, var_razao_social, var_rede, var_cep, var_categoria, var_endereco, var_local, var_cgc, var_inscmun, var_cadastrante, var_saldo_real, var_cpf, var_inscest, var_dat_ult_mov, var_saldo_dolar, var_homepage, var_dealer, var_data, var_id_nextel, var_contato, var_ddd, var_telefone, var_email, var_celular, var_operadora, var_fax, var_telefones, var_contatos, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_empresa_SemChave_submit_form_cb);
  } // do_ajax_form_empresa_SemChave_submit_form

  function do_ajax_form_empresa_SemChave_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_empresa_SemChave_submit_form_cb_after_alert);
  } // do_ajax_form_empresa_SemChave_submit_form_cb
  function do_ajax_form_empresa_SemChave_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empresa_SemChave_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_contato"] = "off";
  scStatusDetail["grid_extrato"] = "off";

  function do_ajax_form_empresa_SemChave_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_empresa_SemChave_navigate_form, function() {});
    } else {
      perform_ajax_form_empresa_SemChave_navigate_form();
    }
  }

  function perform_ajax_form_empresa_SemChave_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_contato"] = "on";
    scStatusDetail["grid_extrato"] = "on";
    x_ajax_form_empresa_SemChave_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empresa_SemChave_navigate_form_cb);
  } // do_ajax_form_empresa_SemChave_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empresa_SemChave_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contato"] && "nmsc_iframe_liga_form_contato" != scMasterDetailIframe["nmsc_iframe_liga_form_contato"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_contato"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_contato').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_contato').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_contato').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empresa_SemChave_navigate_form_cb_after_alert);
  } // do_ajax_form_empresa_SemChave_navigate_form_cb
  function do_ajax_form_empresa_SemChave_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('tipo');
...
{
?>
    do_ajax_form_empresa_SemChave_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_empresa_SemChave_navigate_form_cb_after_alert

  function sc_hide_form_empresa_SemChave_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_contato"] && "off" == scStatusDetail["grid_extrato"])
    {
      return true;
    }
    return false;
