...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_empresa_SemChave/form_empresa_SemChave_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_empresa_SemChave_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_empresa_SemChave_mob_jquery.php');
 ...
 $(".sc-ui-autocomp-id_cidade", elem).each(function() {
  ...
  $(this).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_empresa_SemChave_mob_event_id_cidade_onchange) { do_ajax_form_empresa_SemChave_mob_event_id_cidade_onchange(sRow); }
    }
   }
   ...
   source: function (request, response) {
    $.ajax({
     url: "form_empresa_SemChave_mob.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'id_cidade' != sId ? sId.substr(9) : '';
    if ("" == $(this).val()) {
     do_ajax_form_empresa_SemChave_mob_event_id_cidade_onchange(sRow);
    }
   },
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_empresa_SemChave']['error_buffer']) && '' != $_SESSION['scriptcase']['form_empresa_SemChave']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_empresa_SemChave']['error_buffer'];
}
...
<?php
 include_once("form_empresa_SemChave_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_empresa_SemChave_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_empresa_SemChave_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_empresa_SemChave_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-14';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['etiqueta']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_disabled']['etiqueta']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['etiqueta']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['etiqueta']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['btn_label']['etiqueta'];
        }
?>
...
<script type="text/javascript">
var pag_ativa = "form_empresa_SemChave_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_empresa_SemChave_mob_form0' => array(
            'title' => "Empresa",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_empresa_SemChave_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_empresa_SemChave_mob_form1' => array(
            'title' => "Extrato",
            'class' => $nmgp_num_form == "form_empresa_SemChave_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('Empresa' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_empresa_SemChave_mob_form0']['class'] = 'scTabInactive';
            }
            if ('Extrato' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_empresa_SemChave_mob_form1']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_empresa_SemChave_mob_form0"]['class'];
?>
   <li id="id_form_empresa_SemChave_mob_form0" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_empresa_SemChave_mob_form0">
     Empresa
   </li>
<?php
    $css_celula = $this->tabCssClass["form_empresa_SemChave_mob_form1"]['class'];
?>
   <li id="id_form_empresa_SemChave_mob_form1" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_empresa_SemChave_mob_form1">
     Extrato
   </li>
</ul>
...
<div id="form_empresa_SemChave_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_empresa" style="<?php echo $sStyleHidden_empresa; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_empresa_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_empresa_label" style=" padding: 0px; width: 100%;"><span id="id_label_empresa"><?php echo $this->nm_new_label['empresa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['empresa'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></td></tr><tr><td class="css_empresa_line" style="padding: 0px; width: 100%;">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_tipo" style="<?php echo $sStyleHidden_tipo; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_tipo_label" style=" padding: 0px; width: 100%;"><span id="id_label_tipo"><?php echo $this->nm_new_label['tipo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['tipo'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></td></tr><tr><td class="css_tipo_line" style="padding: 0px; width: 100%;">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_tipo'][] = 'F'; ?>
 <option  value="J" <?php  if ($this->tipo == "J") { echo " selected" ;} ?>>Jurídica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_tipo'][] = 'J'; ?>
 </select></span>
</span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tipo_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tipo_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_id_cidade" style="<?php echo $sStyleHidden_id_cidade; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_cidade_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_id_cidade_label" style=" padding: 0px; width: 100%;"><span id="id_label_id_cidade"><?php echo $this->nm_new_label['id_cidade']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['id_cidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['id_cidade'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></td></tr><tr><td class="css_id_cidade_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_cidade_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_cidade_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_razao_social" style="<?php echo $sStyleHidden_razao_social; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_razao_social_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_razao_social_label" style=" padding: 0px; width: 100%;"><span id="id_label_razao_social"><?php echo $this->nm_new_label['razao_social']; ?></span></td></tr><tr><td class="css_razao_social_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_razao_social_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_razao_social_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_rede" style="<?php echo $sStyleHidden_rede; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rede_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_rede_label" style=" padding: 0px; width: 100%;"><span id="id_label_rede"><?php echo $this->nm_new_label['rede']; ?></span></td></tr><tr><td class="css_rede_line" style="padding: 0px; width: 100%;">
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_rede_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_rede_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_cep" style="<?php echo $sStyleHidden_cep; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cep_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_cep_label" style=" padding: 0px; width: 100%;"><span id="id_label_cep"><?php echo $this->nm_new_label['cep']; ?></span></td></tr><tr><td class="css_cep_line" style="padding: 0px; width: 100%;">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_categoria" style="<?php echo $sStyleHidden_categoria; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_categoria_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_categoria_label" style=" padding: 0px; width: 100%;"><span id="id_label_categoria"><?php echo $this->nm_new_label['categoria']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['categoria']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['php_cmp_required']['categoria'] == "on") { ?> <span class="scFormRequiredMarkOdd">*</span> <?php }?></td></tr><tr><td class="css_categoria_line" style="padding: 0px; width: 100%;">
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_categoria_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_categoria_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_local" style="<?php echo $sStyleHidden_local; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_local_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_local_label" style=" padding: 0px; width: 100%;"><span id="id_label_local"><?php echo $this->nm_new_label['local']; ?></span></td></tr><tr><td class="css_local_line" style="padding: 0px; width: 100%;">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '1'; ?>
 <option  value="2" <?php  if ($this->local == "2") { echo " selected" ;} ?>>Filial-1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '2'; ?>
 <option  value="3" <?php  if ($this->local == "3") { echo " selected" ;} ?>>Filial-2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '3'; ?>
 <option  value="5" <?php  if ($this->local == "5") { echo " selected" ;} ?>>Filial-4</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '5'; ?>
 <option  value="6" <?php  if ($this->local == "6") { echo " selected" ;} ?>>Filial-5</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '6'; ?>
 <option  value="6" <?php  if ($this->local == "6") { echo " selected" ;} ?>>Filial-5</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '6'; ?>
 <option  value="7" <?php  if ($this->local == "7") { echo " selected" ;} ?>>Filial-6</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_local'][] = '7'; ?>
 </select></span>
</span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_local_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_local_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_local_dumb = ('' == $sStyleHidden_local) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_local_dumb" style="<?php echo $sStyleHidden_local_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_cgc" style="<?php echo $sStyleHidden_cgc; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgc_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_cgc_label" style=" padding: 0px; width: 100%;"><span id="id_label_cgc"><?php echo $this->nm_new_label['cgc']; ?></span></td></tr><tr><td class="css_cgc_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cgc_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cgc_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_cadastrante" style="<?php echo $sStyleHidden_cadastrante; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cadastrante_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_cadastrante_label" style=" padding: 0px; width: 100%;"><span id="id_label_cadastrante"><?php echo $this->nm_new_label['cadastrante']; ?></span></td></tr><tr><td class="css_cadastrante_line" style="padding: 0px; width: 100%;"><input type="hidden" name="cadastrante" value="<?php echo $this->form_encode_input($cadastrante); ?>"><span id="id_ajax_label_cadastrante"><?php echo nl2br($cadastrante); ?></span>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cadastrante_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cadastrante_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_saldo_real" style="<?php echo $sStyleHidden_saldo_real; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_saldo_real_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_saldo_real_label" style=" padding: 0px; width: 100%;"><span id="id_label_saldo_real"><?php echo $this->nm_new_label['saldo_real']; ?></span></td></tr><tr><td class="css_saldo_real_line" style="padding: 0px; width: 100%;"><input type="hidden" name="saldo_real" value="<?php echo $this->form_encode_input($saldo_real); ?>"><span id="id_ajax_label_saldo_real"><?php echo nl2br($saldo_real); ?></span>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_saldo_real_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_saldo_real_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_inscest" style="<?php echo $sStyleHidden_inscest; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_inscest_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_inscest_label" style=" padding: 0px; width: 100%;"><span id="id_label_inscest"><?php echo $this->nm_new_label['inscest']; ?></span></td></tr><tr><td class="css_inscest_line" style="padding: 0px; width: 100%;">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_dat_ult_mov" style="<?php echo $sStyleHidden_dat_ult_mov; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dat_ult_mov_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_dat_ult_mov_label" style=" padding: 0px; width: 100%;"><span id="id_label_dat_ult_mov"><?php echo $this->nm_new_label['dat_ult_mov']; ?></span></td></tr><tr><td class="css_dat_ult_mov_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dat_ult_mov_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dat_ult_mov_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_saldo_dolar" style="<?php echo $sStyleHidden_saldo_dolar; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_saldo_dolar_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_saldo_dolar_label" style=" padding: 0px; width: 100%;"><span id="id_label_saldo_dolar"><?php echo $this->nm_new_label['saldo_dolar']; ?></span></td></tr><tr><td class="css_saldo_dolar_line" style="padding: 0px; width: 100%;"><input type="hidden" name="saldo_dolar" value="<?php echo $this->form_encode_input($saldo_dolar); ?>"><span id="id_ajax_label_saldo_dolar"><?php echo nl2br($saldo_dolar); ?></span>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_saldo_dolar_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_saldo_dolar_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_homepage" style="<?php echo $sStyleHidden_homepage; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_homepage_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_homepage_label" style=" padding: 0px; width: 100%;"><span id="id_label_homepage"><?php echo $this->nm_new_label['homepage']; ?></span></td></tr><tr><td class="css_homepage_line" style="padding: 0px; width: 100%;">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_dealer" style="<?php echo $sStyleHidden_dealer; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dealer_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_dealer_label" style=" padding: 0px; width: 100%;"><span id="id_label_dealer"><?php echo $this->nm_new_label['dealer']; ?></span></td></tr><tr><td class="css_dealer_line" style="padding: 0px; width: 100%;">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_dealer'][] = '1'; ?>
 <option  value="0" <?php  if ($this->dealer == "0") { echo " selected" ;} ?><?php  if (empty($this->dealer)) { echo " selected" ;} ?>>Não</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_dealer'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_id_nextel" style="<?php echo $sStyleHidden_id_nextel; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_nextel_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_id_nextel_label" style=" padding: 0px; width: 100%;"><span id="id_label_id_nextel"><?php echo $this->nm_new_label['id_nextel']; ?></span></td></tr><tr><td class="css_id_nextel_line" style="padding: 0px; width: 100%;">
...
<span id="id_read_on_id_nextel" class="sc-ui-readonly-id_nextel css_id_nextel_line" style="<?php echo $sStyleReadLab_id_nextel; ?>"><?php echo $this->form_format_readonly("id_nextel", $this->form_encode_input($this->id_nextel)); ?></span><span id="id_read_off_id_nextel" class="css_read_off_id_nextel<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_id_nextel; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_nextel_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_nextel_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $sStyleHidden_id_nextel_dumb = ('' == $sStyleHidden_id_nextel) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_nextel_dumb" style="<?php echo $sStyleHidden_id_nextel_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_operadora'][] = 'Ignorada'; ?>
 <option value="Ignorada">---------</option>
 <option  value="CLARO" <?php  if ($this->operadora == "CLARO") { echo " selected" ;} ?>>CLARO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_operadora'][] = 'CLARO'; ?>
 <option  value="TIM" <?php  if ($this->operadora == "TIM") { echo " selected" ;} ?>>TIM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_operadora'][] = 'TIM'; ?>
 <option  value="VIVO" <?php  if ($this->operadora == "VIVO") { echo " selected" ;} ?>>VIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_operadora'][] = 'VIVO'; ?>
 <option  value="OI" <?php  if ($this->operadora == "OI") { echo " selected" ;} ?>>OI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_operadora'][] = 'OI'; ?>
 <option  value="NEXTEL" <?php  if ($this->operadora == "NEXTEL") { echo " selected" ;} ?>>NEXTEL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['Lookup_operadora'][] = 'NEXTEL'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_ContatoRelacao'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_ContatoRelacao'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_ContatoRelacao'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_grid_edit'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_grid_edit_link'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_qtd_reg'] = '15';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_contato_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init'] ]['form_empresa_SemChave_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_empresa_SemChave_mob_empty.htm' : $this->Ini->link_form_contato_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_ContatoRelacao']) && 'nmsc_iframe_liga_form_contato_mob' != $this->Ini->sc_lig_target['C_@scinf_ContatoRelacao'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_ContatoRelacao'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa_SemChave_mob']['form_contato_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_contato_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_contato_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
