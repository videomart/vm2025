  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_transportadoras_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_transportadoras_mob_form();
        }
...
?>
  ...
  function do_ajax_form_transportadoras_mob_validate_transportadora()
  {
    var nomeCampo_transportadora = "transportadora";
    var var_transportadora = scAjaxGetFieldText(nomeCampo_transportadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transportadoras_mob_validate_transportadora(var_transportadora, var_script_case_init, do_ajax_form_transportadoras_mob_validate_transportadora_cb);
  } // do_ajax_form_transportadoras_mob_validate_transportadora

  function do_ajax_form_transportadoras_mob_validate_transportadora_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transportadoras_mob_validate_transportadora_cb

  // ---------- Validate endereco
  function do_ajax_form_transportadoras_mob_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transportadoras_mob_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_transportadoras_mob_validate_endereco_cb);
  } // do_ajax_form_transportadoras_mob_validate_endereco

  function do_ajax_form_transportadoras_mob_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transportadoras_mob_validate_endereco_cb

  // ---------- Validate telefone
  function do_ajax_form_transportadoras_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transportadoras_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_transportadoras_mob_validate_telefone_cb);
  } // do_ajax_form_transportadoras_mob_validate_telefone

  function do_ajax_form_transportadoras_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transportadoras_mob_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_transportadoras_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transportadoras_mob_validate_email(var_email, var_script_case_init, do_ajax_form_transportadoras_mob_validate_email_cb);
  } // do_ajax_form_transportadoras_mob_validate_email

  function do_ajax_form_transportadoras_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transportadoras_mob_validate_email_cb

  // ---------- Validate contato
  function do_ajax_form_transportadoras_mob_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_transportadoras_mob_validate_contato(var_contato, var_script_case_init, do_ajax_form_transportadoras_mob_validate_contato_cb);
  } // do_ajax_form_transportadoras_mob_validate_contato

  function do_ajax_form_transportadoras_mob_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_transportadoras_mob_validate_contato_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_transportadoras_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_transportadoras_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_transportadora = scAjaxGetFieldText("transportadora");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_transportadoras_mob_submit_form(var_transportadora, var_endereco, var_telefone, var_email, var_contato, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_transportadoras_mob_submit_form_cb);
  } // do_ajax_form_transportadoras_mob_submit_form

  function do_ajax_form_transportadoras_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_transportadoras_mob_submit_form_cb_after_alert);
  } // do_ajax_form_transportadoras_mob_submit_form_cb
  function do_ajax_form_transportadoras_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_transportadoras_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_transportadoras_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_transportadoras_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_transportadoras_mob_navigate_form();
    }
  }

  function perform_ajax_form_transportadoras_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_transportadoras_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_transportadoras_mob_navigate_form_cb);
  } // do_ajax_form_transportadoras_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_transportadoras_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_transportadoras_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_transportadoras_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_transportadoras_mob_navigate_form_cb
  function do_ajax_form_transportadoras_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_transportadoras_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_transportadoras_mob_navigate_form_cb_after_alert

  function sc_hide_form_transportadoras_mob_form()
  {
