  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_followup_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_followup_mob_form();
        }
...
?>
  ...
  function do_ajax_form_followup_mob_validate_id_proposta()
  {
  } // do_ajax_form_followup_mob_validate_id_proposta

  function do_ajax_form_followup_mob_validate_id_proposta_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_id_proposta_cb

  // ---------- Validate cod_vend
  function do_ajax_form_followup_mob_validate_cod_vend()
  {
  } // do_ajax_form_followup_mob_validate_cod_vend

  function do_ajax_form_followup_mob_validate_cod_vend_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_cod_vend_cb

  // ---------- Validate grau_oportunidade
  function do_ajax_form_followup_mob_validate_grau_oportunidade()
  {
    var nomeCampo_grau_oportunidade = "grau_oportunidade";
    var var_grau_oportunidade = scAjaxGetFieldRadio(nomeCampo_grau_oportunidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_followup_mob_validate_grau_oportunidade(var_grau_oportunidade, var_script_case_init, do_ajax_form_followup_mob_validate_grau_oportunidade_cb);
  } // do_ajax_form_followup_mob_validate_grau_oportunidade

  function do_ajax_form_followup_mob_validate_grau_oportunidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "grau_oportunidade";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_grau_oportunidade_cb

  // ---------- Validate status
  function do_ajax_form_followup_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldRadio(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_followup_mob_validate_status(var_status, var_script_case_init, do_ajax_form_followup_mob_validate_status_cb);
  } // do_ajax_form_followup_mob_validate_status

  function do_ajax_form_followup_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_status_cb

  // ---------- Validate data
  function do_ajax_form_followup_mob_validate_data()
  {
    ...
    setTimeout(function() {
      var var_data = scAjaxGetFieldText(nomeCampo_data);
      x_ajax_form_followup_mob_validate_data(var_data, var_script_case_init, do_ajax_form_followup_mob_validate_data_cb);
    }, 200);
  } // do_ajax_form_followup_mob_validate_data

  function do_ajax_form_followup_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_data_cb

  // ---------- Validate data_prevista
  function do_ajax_form_followup_mob_validate_data_prevista()
  {
    var nomeCampo_data_prevista = "data_prevista";
    var var_data_prevista = scAjaxGetFieldText(nomeCampo_data_prevista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_followup_mob_validate_data_prevista(var_data_prevista, var_script_case_init, do_ajax_form_followup_mob_validate_data_prevista_cb);
  } // do_ajax_form_followup_mob_validate_data_prevista

  function do_ajax_form_followup_mob_validate_data_prevista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_data_prevista_cb

  // ---------- Validate relato
  function do_ajax_form_followup_mob_validate_relato()
  {
    var nomeCampo_relato = "relato";
    var var_relato = scAjaxGetFieldEditorHtml(nomeCampo_relato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_followup_mob_validate_relato(var_relato, var_script_case_init, do_ajax_form_followup_mob_validate_relato_cb);
  } // do_ajax_form_followup_mob_validate_relato

  function do_ajax_form_followup_mob_validate_relato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_followup_mob_validate_relato_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_followup_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_followup_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_proposta = scAjaxGetFieldText("id_proposta");
    var var_cod_vend = scAjaxGetFieldText("cod_vend");
    var var_grau_oportunidade = scAjaxGetFieldRadio("grau_oportunidade");
    ...
    var var_relato = scAjaxGetFieldEditorHtml("relato");
    ...
    scAjaxProcOn();
    x_ajax_form_followup_mob_submit_form(var_id_proposta, var_cod_vend, var_grau_oportunidade, var_status, var_data, var_data_prevista, var_relato, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_followup_mob_submit_form_cb);
  } // do_ajax_form_followup_mob_submit_form

  function do_ajax_form_followup_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_followup_mob_submit_form_cb_after_alert);
  } // do_ajax_form_followup_mob_submit_form_cb
  function do_ajax_form_followup_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_followup_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_followup_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_followup_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_followup_mob_navigate_form();
    }
  }

  function perform_ajax_form_followup_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_followup_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_followup_mob_navigate_form_cb);
  } // do_ajax_form_followup_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_followup_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_followup_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_followup_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_followup_mob_navigate_form_cb
  function do_ajax_form_followup_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_followup_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_followup_mob_navigate_form_cb_after_alert

  function sc_hide_form_followup_mob_form()
  {
  ...
  ajax_field_list[0] = "id_proposta";
  ajax_field_list[1] = "cod_vend";
  ajax_field_list[2] = "grau_oportunidade";
  ajax_field_list[3] = "status";
  ajax_field_list[4] = "data";
  ajax_field_list[5] = "data_prevista";
  ajax_field_list[6] = "relato";
  ...
  var ajax_error_list = {
    ...
    "grau_oportunidade": {"label": "GRAU OPORTUNIDADE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "relato": {"label": "RELATO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "grau_oportunidade": new Array("hidden_field_label_grau_oportunidade", "hidden_field_data_grau_oportunidade"),
    ...
    "relato": new Array("hidden_field_label_relato", "hidden_field_data_relato")
  };

  var ajax_read_only = {
    "id_proposta": "off",
    "cod_vend": "off",
    "grau_oportunidade": "off",
    "status": "off",
    "data": "off",
    "data_prevista": "off",
    "relato": "off"
