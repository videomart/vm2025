...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_numeric[] = "id_empresa";$Nm_numeric[] = "credito";$Nm_numeric[] = "debito";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_empresa_cond" name="id_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_empresa'), this, 'id_empresa')">
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_credito_cond" name="credito_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito'), this, 'credito')">
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_debito_cond" name="debito_cond" onChange="nm_campos_between(document.getElementById('id_vis_debito'), this, 'debito')">
