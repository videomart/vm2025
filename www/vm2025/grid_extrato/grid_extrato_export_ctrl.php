<?php
@session_start() ;
$_SESSION['scriptcase']['grid_extrato']['sc_process_barr'] = true;
require_once('../grid_extrato/index.php');
unset($_SESSION['scriptcase']['grid_extrato']['sc_process_barr']);
$ExportCtrl = new grid_extrato_export_control;
$ExportCtrl->Export_barr();

class grid_extrato_export_control
{
