...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_extrato"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_extrato"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_extrato']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_extrato']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_extrato']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_extrato']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_extrato']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_extrato']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_extrato']['embutida_filho'] as $ind => $sc_init)
          {
