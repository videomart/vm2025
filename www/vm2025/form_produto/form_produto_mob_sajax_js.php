...
?>
  ...
  // ---------- Validate modelo
  function do_ajax_form_produto_mob_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_produto_mob_validate_modelo_cb);
  } // do_ajax_form_produto_mob_validate_modelo

  function do_ajax_form_produto_mob_validate_modelo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_modelo_cb

  // ---------- Validate ncm
  function do_ajax_form_produto_mob_validate_ncm()
  {
    var nomeCampo_ncm = "ncm";
    var var_ncm = scAjaxGetFieldText(nomeCampo_ncm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_ncm(var_ncm, var_script_case_init, do_ajax_form_produto_mob_validate_ncm_cb);
  } // do_ajax_form_produto_mob_validate_ncm

  function do_ajax_form_produto_mob_validate_ncm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_ncm_cb

  // ---------- Validate id_classe
  function do_ajax_form_produto_mob_validate_id_classe()
  {
    var nomeCampo_id_classe = "id_classe";
    var var_id_classe = scAjaxGetFieldSelect(nomeCampo_id_classe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_id_classe(var_id_classe, var_script_case_init, do_ajax_form_produto_mob_validate_id_classe_cb);
  } // do_ajax_form_produto_mob_validate_id_classe

  function do_ajax_form_produto_mob_validate_id_classe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_classe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_id_classe_cb

  // ---------- Validate id_marca
  function do_ajax_form_produto_mob_validate_id_marca()
  {
    var nomeCampo_id_marca = "id_marca";
    var var_id_marca = scAjaxGetFieldSelect(nomeCampo_id_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_id_marca(var_id_marca, var_script_case_init, do_ajax_form_produto_mob_validate_id_marca_cb);
  } // do_ajax_form_produto_mob_validate_id_marca

  function do_ajax_form_produto_mob_validate_id_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_id_marca_cb
  ...
  // ---------- Validate detalhe
  function do_ajax_form_produto_mob_validate_detalhe()
  {
    var nomeCampo_detalhe = "detalhe";
    var var_detalhe = scAjaxGetFieldText(nomeCampo_detalhe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_detalhe(var_detalhe, var_script_case_init, do_ajax_form_produto_mob_validate_detalhe_cb);
  } // do_ajax_form_produto_mob_validate_detalhe

  function do_ajax_form_produto_mob_validate_detalhe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_detalhe_cb

  // ---------- Validate peso
  function do_ajax_form_produto_mob_validate_peso()
  {
    var nomeCampo_peso = "peso";
    var var_peso = scAjaxGetFieldText(nomeCampo_peso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_peso(var_peso, var_script_case_init, do_ajax_form_produto_mob_validate_peso_cb);
  } // do_ajax_form_produto_mob_validate_peso

  function do_ajax_form_produto_mob_validate_peso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_peso_cb

  // ---------- Validate data
  function do_ajax_form_produto_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_data(var_data, var_script_case_init, do_ajax_form_produto_mob_validate_data_cb);
  } // do_ajax_form_produto_mob_validate_data

  function do_ajax_form_produto_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_data_cb

  // ---------- Validate markup
  function do_ajax_form_produto_mob_validate_markup()
  {
    var nomeCampo_markup = "markup";
    var var_markup = scAjaxGetFieldText(nomeCampo_markup);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_markup(var_markup, var_script_case_init, do_ajax_form_produto_mob_validate_markup_cb);
  } // do_ajax_form_produto_mob_validate_markup

  function do_ajax_form_produto_mob_validate_markup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_markup_cb

  // ---------- Validate custo
  function do_ajax_form_produto_mob_validate_custo()
  {
    var nomeCampo_custo = "custo";
    var var_custo = scAjaxGetFieldText(nomeCampo_custo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_custo(var_custo, var_script_case_init, do_ajax_form_produto_mob_validate_custo_cb);
  } // do_ajax_form_produto_mob_validate_custo

  function do_ajax_form_produto_mob_validate_custo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_custo_cb

  // ---------- Validate venda
  function do_ajax_form_produto_mob_validate_venda()
  {
    var nomeCampo_venda = "venda";
    var var_venda = scAjaxGetFieldText(nomeCampo_venda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_venda(var_venda, var_script_case_init, do_ajax_form_produto_mob_validate_venda_cb);
  } // do_ajax_form_produto_mob_validate_venda

  function do_ajax_form_produto_mob_validate_venda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_venda_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_produto_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_produto_mob_validate_sc_field_0_cb);
  } // do_ajax_form_produto_mob_validate_sc_field_0

  function do_ajax_form_produto_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_sc_field_0_cb

  // ---------- Event onchange custo
  function do_ajax_form_produto_mob_event_custo_onchange()
  {
    var var_id_classe = scAjaxGetFieldSelect("id_classe");
    var var_markup = scAjaxGetFieldText("markup");
    var var_custo = scAjaxGetFieldText("custo");
    var var_venda = scAjaxGetFieldText("venda");
    var var_sc_field_0 = scAjaxGetFieldText("sc_field_0");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produto_mob_event_custo_onchange(var_id_classe, var_markup, var_custo, var_venda, var_sc_field_0, var_script_case_init, do_ajax_form_produto_mob_event_custo_onchange_cb);
  } // do_ajax_form_produto_mob_event_custo_onchange

  function do_ajax_form_produto_mob_event_custo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "custo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produto_mob_event_custo_onchange_cb_after_alert);
  } // do_ajax_form_produto_mob_event_custo_onchange_cb
  function do_ajax_form_produto_mob_event_custo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produto_mob_event_custo_onchange_cb_after_alert

  // ---------- Event onchange id_classe
  function do_ajax_form_produto_mob_event_id_classe_onchange()
  {
    var var_id_classe = scAjaxGetFieldSelect("id_classe");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produto_mob_event_id_classe_onchange(var_id_classe, var_id_marca, var_descricao, var_modelo, var_markup, var_custo, var_venda, var_sc_field_0, var_script_case_init, do_ajax_form_produto_mob_event_id_classe_onchange_cb);
  } // do_ajax_form_produto_mob_event_id_classe_onchange

  function do_ajax_form_produto_mob_event_id_classe_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_classe";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produto_mob_event_id_classe_onchange_cb_after_alert);
  } // do_ajax_form_produto_mob_event_id_classe_onchange_cb
  function do_ajax_form_produto_mob_event_id_classe_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produto_mob_event_id_classe_onchange_cb_after_alert

  // ---------- Event onchange id_marca
  function do_ajax_form_produto_mob_event_id_marca_onchange()
  {
    var var_id_classe = scAjaxGetFieldSelect("id_classe");
    var var_id_marca = scAjaxGetFieldSelect("id_marca");
    var var_descricao = scAjaxGetFieldText("descricao");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produto_mob_event_id_marca_onchange(var_id_classe, var_id_marca, var_descricao, var_modelo, var_script_case_init, do_ajax_form_produto_mob_event_id_marca_onchange_cb);
  } // do_ajax_form_produto_mob_event_id_marca_onchange

  function do_ajax_form_produto_mob_event_id_marca_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_marca";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produto_mob_event_id_marca_onchange_cb_after_alert);
  } // do_ajax_form_produto_mob_event_id_marca_onchange_cb
  function do_ajax_form_produto_mob_event_id_marca_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produto_mob_event_id_marca_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_produto_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_modelo = scAjaxGetFieldText("modelo");
    var var_ncm = scAjaxGetFieldText("ncm");
    var var_id_classe = scAjaxGetFieldSelect("id_classe");
    var var_id_marca = scAjaxGetFieldSelect("id_marca");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_detalhe = scAjaxGetFieldText("detalhe");
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_submit_form(var_modelo, var_ncm, var_id_classe, var_id_marca, var_descricao, var_detalhe, var_peso, var_data, var_markup, var_custo, var_venda, var_sc_field_0, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produto_mob_submit_form_cb);
  ...
  function do_ajax_form_produto_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("ncm");
      scAjaxHideErrorDisplay("id_classe");
      ...
      scAjaxHideErrorDisplay("markup");
      scAjaxHideErrorDisplay("custo");
      scAjaxHideErrorDisplay("venda");
...
?>
  ...
  function do_ajax_form_produto_mob_lkpedt_refresh_id_classe()
  {
    var var_id_classe = scAjaxGetFieldSelect("id_classe");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_classe";
    x_ajax_form_produto_mob_lkpedt_refresh_id_classe(var_id_classe, nmgp_refresh_fields, var_script_case_init, do_ajax_form_produto_mob_lkpedt_refresh_id_classe_cb);
  } // do_ajax_form_produto_mob_lkpedt_refresh_id_classe

  function do_ajax_form_produto_mob_lkpedt_refresh_id_classe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_produto_mob_lkpedt_refresh_id_classe_cb

  function do_ajax_form_produto_mob_lkpedt_refresh_id_marca()
  {
    var var_id_marca = scAjaxGetFieldSelect("id_marca");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_marca";
    x_ajax_form_produto_mob_lkpedt_refresh_id_marca(var_id_marca, nmgp_refresh_fields, var_script_case_init, do_ajax_form_produto_mob_lkpedt_refresh_id_marca_cb);
  } // do_ajax_form_produto_mob_lkpedt_refresh_id_marca

  function do_ajax_form_produto_mob_lkpedt_refresh_id_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_produto_mob_lkpedt_refresh_id_marca_cb
  ...
  ajax_field_list[1] = "ncm";
  ajax_field_list[2] = "id_classe";
  ajax_field_list[3] = "id_marca";
  ajax_field_list[4] = "descricao";
  ajax_field_list[5] = "detalhe";
  ajax_field_list[6] = "peso";
  ajax_field_list[7] = "data";
  ajax_field_list[8] = "markup";
  ajax_field_list[9] = "custo";
  ajax_field_list[10] = "venda";
  ...
  var ajax_error_list = {
    ...
    "ncm": {"label": "NCM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_classe": {"label": "CLASSE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_marca": {"label": "MARCA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "detalhe": {"label": "DETALHE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "peso": {"label": "PESO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data": {"label": "DATA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "markup": {"label": "MARKUP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "custo": {"label": "CUSTO (U$)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "venda": {"label": "VENDA (U$)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sc_field_0": {"label": "VENDA (R$)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["ncm"][1] = "ncm";
  ajax_field_mult["id_classe"][1] = "id_classe";
  ...
  ajax_field_mult["markup"][1] = "markup";
  ajax_field_mult["custo"][1] = "custo";
  ajax_field_mult["venda"][1] = "venda";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";

  var ajax_field_id = {
    "modelo": new Array("hidden_field_label_modelo", "hidden_field_data_modelo"),
    "ncm": new Array("hidden_field_label_ncm", "hidden_field_data_ncm"),
    "id_classe": new Array("hidden_field_label_id_classe", "hidden_field_data_id_classe"),
    ...
    "markup": new Array("hidden_field_label_markup", "hidden_field_data_markup"),
    "custo": new Array("hidden_field_label_custo", "hidden_field_data_custo"),
    "venda": new Array("hidden_field_label_venda", "hidden_field_data_venda"),
