...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_produto']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['form_produto']['opc_ant']);
          }
          if (isset($this->dolar)) 
          {
              $_SESSION['dolar'] = $this->dolar;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
...
//---
    ...
    function ValidateField_modelo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['modelo'] == "on")) 
      { 
          if ($this->modelo == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['id_classe'])) {
      ...
      if ($this->id_classe == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['id_classe']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['id_classe'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "CLASSE" ; 
          ...
          if (!empty($this->id_classe) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_id_classe']) && !in_array($this->id_classe, $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_id_classe']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['id_marca'])) {
      ...
      if ($this->id_marca == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['id_marca']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['id_marca'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "MARCA" ; 
          ...
          if (!empty($this->id_marca) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_id_marca']) && !in_array($this->id_marca, $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_id_marca']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['id_marca']))
    ...
    function ValidateField_markup(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->markup, 18, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "MARKUP; " ; 
                  if (!isset($Campos_Erros['markup']))
    ...
    function ValidateField_custo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->custo, 8, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "CUSTO (U$); " ; 
                  if (!isset($Campos_Erros['custo']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['custo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['custo'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_venda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->venda, 8, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "VENDA (U$); " ; 
                  if (!isset($Campos_Erros['venda']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['venda']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['venda'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_sc_field_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->sc_field_0, 18, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "VENDA (R$); " ; 
                  if (!isset($Campos_Erros['sc_field_0']))
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_produto_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_produto_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_classe']['valList'][$i] = form_produto_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_marca']['valList'][$i] = form_produto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dyn_search_cache']);
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["data"] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['SC_sep_date1'];
              }
          }
  ...
  exit;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total'] + 1,
            ],
            $summaryLine
        );
