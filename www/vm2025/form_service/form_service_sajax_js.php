  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_service" == sTestField)
        {
...
?>
  ...
  // ---------- Validate osnumber
  function do_ajax_form_service_validate_osnumber()
  {
    var nomeCampo_osnumber = "osnumber";
    var var_osnumber = scAjaxGetFieldHidden(nomeCampo_osnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_osnumber(var_osnumber, var_script_case_init, do_ajax_form_service_validate_osnumber_cb);
  } // do_ajax_form_service_validate_osnumber

  function do_ajax_form_service_validate_osnumber_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_osnumber_cb

  // ---------- Validate id_empresa
  function do_ajax_form_service_validate_id_empresa()
  {
  } // do_ajax_form_service_validate_id_empresa

  function do_ajax_form_service_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_id_empresa_cb

  // ---------- Validate empresa
  function do_ajax_form_service_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_service_validate_empresa_cb);
  } // do_ajax_form_service_validate_empresa

  function do_ajax_form_service_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_empresa_cb

  // ---------- Validate telefone
  function do_ajax_form_service_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_service_validate_telefone_cb);
  } // do_ajax_form_service_validate_telefone

  function do_ajax_form_service_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_telefone_cb

  // ---------- Validate fax
  function do_ajax_form_service_validate_fax()
  {
    var nomeCampo_fax = "fax";
    var var_fax = scAjaxGetFieldText(nomeCampo_fax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_fax(var_fax, var_script_case_init, do_ajax_form_service_validate_fax_cb);
  } // do_ajax_form_service_validate_fax

  function do_ajax_form_service_validate_fax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_fax_cb

  // ---------- Validate contato
  function do_ajax_form_service_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_contato(var_contato, var_script_case_init, do_ajax_form_service_validate_contato_cb);
  } // do_ajax_form_service_validate_contato

  function do_ajax_form_service_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_contato_cb

  // ---------- Validate email
  function do_ajax_form_service_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_email(var_email, var_script_case_init, do_ajax_form_service_validate_email_cb);
  } // do_ajax_form_service_validate_email

  function do_ajax_form_service_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_email_cb

  // ---------- Validate endereco
  function do_ajax_form_service_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_service_validate_endereco_cb);
  } // do_ajax_form_service_validate_endereco

  function do_ajax_form_service_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_endereco_cb

  // ---------- Validate data
  function do_ajax_form_service_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_data(var_data, var_script_case_init, do_ajax_form_service_validate_data_cb);
  } // do_ajax_form_service_validate_data

  function do_ajax_form_service_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_data_cb

  // ---------- Validate nfs_ent
  function do_ajax_form_service_validate_nfs_ent()
  {
    var nomeCampo_nfs_ent = "nfs_ent";
    var var_nfs_ent = scAjaxGetFieldText(nomeCampo_nfs_ent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_nfs_ent(var_nfs_ent, var_script_case_init, do_ajax_form_service_validate_nfs_ent_cb);
  } // do_ajax_form_service_validate_nfs_ent

  function do_ajax_form_service_validate_nfs_ent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_nfs_ent_cb

  // ---------- Validate classe
  function do_ajax_form_service_validate_classe()
  {
  } // do_ajax_form_service_validate_classe

  function do_ajax_form_service_validate_classe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_classe_cb

  // ---------- Validate marca
  function do_ajax_form_service_validate_marca()
  {
  } // do_ajax_form_service_validate_marca

  function do_ajax_form_service_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_marca_cb

  // ---------- Validate modelo
  function do_ajax_form_service_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_service_validate_modelo_cb);
  } // do_ajax_form_service_validate_modelo

  function do_ajax_form_service_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_modelo_cb

  // ---------- Validate serie
  function do_ajax_form_service_validate_serie()
  {
    var nomeCampo_serie = "serie";
    var var_serie = scAjaxGetFieldText(nomeCampo_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_serie(var_serie, var_script_case_init, do_ajax_form_service_validate_serie_cb);
  } // do_ajax_form_service_validate_serie

  function do_ajax_form_service_validate_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_serie_cb

  // ---------- Validate natureza
  function do_ajax_form_service_validate_natureza()
  {
    var nomeCampo_natureza = "natureza";
    var var_natureza = scAjaxGetFieldRadio(nomeCampo_natureza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_natureza(var_natureza, var_script_case_init, do_ajax_form_service_validate_natureza_cb);
  } // do_ajax_form_service_validate_natureza

  function do_ajax_form_service_validate_natureza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_natureza_cb

  // ---------- Validate status
  function do_ajax_form_service_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_status(var_status, var_script_case_init, do_ajax_form_service_validate_status_cb);
  } // do_ajax_form_service_validate_status

  function do_ajax_form_service_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_status_cb

  // ---------- Validate recepcao
  function do_ajax_form_service_validate_recepcao()
  {
    var nomeCampo_recepcao = "recepcao";
    var var_recepcao = scAjaxGetFieldSelect(nomeCampo_recepcao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_recepcao(var_recepcao, var_script_case_init, do_ajax_form_service_validate_recepcao_cb);
  } // do_ajax_form_service_validate_recepcao

  function do_ajax_form_service_validate_recepcao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_recepcao_cb

  // ---------- Validate obs
  function do_ajax_form_service_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_obs(var_obs, var_script_case_init, do_ajax_form_service_validate_obs_cb);
  } // do_ajax_form_service_validate_obs

  function do_ajax_form_service_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_obs_cb

  // ---------- Validate descricao
  function do_ajax_form_service_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_service_validate_descricao_cb);
  } // do_ajax_form_service_validate_descricao

  function do_ajax_form_service_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_descricao_cb

  // ---------- Validate sintoma
  function do_ajax_form_service_validate_sintoma()
  {
    var nomeCampo_sintoma = "sintoma";
    var var_sintoma = scAjaxGetFieldText(nomeCampo_sintoma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_sintoma(var_sintoma, var_script_case_init, do_ajax_form_service_validate_sintoma_cb);
  } // do_ajax_form_service_validate_sintoma

  function do_ajax_form_service_validate_sintoma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_sintoma_cb

  // ---------- Validate dataorc
  function do_ajax_form_service_validate_dataorc()
  {
    var nomeCampo_dataorc = "dataorc";
    var var_dataorc = scAjaxGetFieldText(nomeCampo_dataorc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_dataorc(var_dataorc, var_script_case_init, do_ajax_form_service_validate_dataorc_cb);
  } // do_ajax_form_service_validate_dataorc

  function do_ajax_form_service_validate_dataorc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_dataorc_cb

  // ---------- Validate material
  function do_ajax_form_service_validate_material()
  {
    var nomeCampo_material = "material";
    var var_material = scAjaxGetFieldText(nomeCampo_material);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_material(var_material, var_script_case_init, do_ajax_form_service_validate_material_cb);
  } // do_ajax_form_service_validate_material

  function do_ajax_form_service_validate_material_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_material_cb

  // ---------- Validate tecnico
  function do_ajax_form_service_validate_tecnico()
  {
    var nomeCampo_tecnico = "tecnico";
    var var_tecnico = scAjaxGetFieldSelect(nomeCampo_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_tecnico(var_tecnico, var_script_case_init, do_ajax_form_service_validate_tecnico_cb);
  } // do_ajax_form_service_validate_tecnico

  function do_ajax_form_service_validate_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_tecnico_cb

  // ---------- Validate pendencia
  function do_ajax_form_service_validate_pendencia()
  {
    var nomeCampo_pendencia = "pendencia";
    var var_pendencia = scAjaxGetFieldText(nomeCampo_pendencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_pendencia(var_pendencia, var_script_case_init, do_ajax_form_service_validate_pendencia_cb);
  } // do_ajax_form_service_validate_pendencia

  function do_ajax_form_service_validate_pendencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_pendencia_cb

  // ---------- Validate maoobra
  function do_ajax_form_service_validate_maoobra()
  {
    var nomeCampo_maoobra = "maoobra";
    var var_maoobra = scAjaxGetFieldText(nomeCampo_maoobra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_maoobra(var_maoobra, var_script_case_init, do_ajax_form_service_validate_maoobra_cb);
  } // do_ajax_form_service_validate_maoobra

  function do_ajax_form_service_validate_maoobra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_maoobra_cb

  // ---------- Validate orcamento
  function do_ajax_form_service_validate_orcamento()
  {
    var nomeCampo_orcamento = "orcamento";
    var var_orcamento = scAjaxGetFieldText(nomeCampo_orcamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_orcamento(var_orcamento, var_script_case_init, do_ajax_form_service_validate_orcamento_cb);
  } // do_ajax_form_service_validate_orcamento

  function do_ajax_form_service_validate_orcamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_orcamento_cb

  // ---------- Validate saida
  function do_ajax_form_service_validate_saida()
  {
    var nomeCampo_saida = "saida";
    var var_saida = scAjaxGetFieldText(nomeCampo_saida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_saida(var_saida, var_script_case_init, do_ajax_form_service_validate_saida_cb);
  } // do_ajax_form_service_validate_saida

  function do_ajax_form_service_validate_saida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_saida_cb

  // ---------- Validate servico
  function do_ajax_form_service_validate_servico()
  {
    var nomeCampo_servico = "servico";
    var var_servico = scAjaxGetFieldText(nomeCampo_servico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_servico(var_servico, var_script_case_init, do_ajax_form_service_validate_servico_cb);
  } // do_ajax_form_service_validate_servico

  function do_ajax_form_service_validate_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_servico_cb

  // ---------- Validate mat
  function do_ajax_form_service_validate_mat()
  {
    var nomeCampo_mat = "mat";
    var var_mat = scAjaxGetFieldText(nomeCampo_mat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_validate_mat(var_mat, var_script_case_init, do_ajax_form_service_validate_mat_cb);
  } // do_ajax_form_service_validate_mat

  function do_ajax_form_service_validate_mat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_validate_mat_cb

  // ---------- Event onchange classe
  function do_ajax_form_service_event_classe_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_service_event_classe_onchange(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_event_classe_onchange_cb);
  } // do_ajax_form_service_event_classe_onchange

  function do_ajax_form_service_event_classe_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "classe";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_event_classe_onchange_cb_after_alert);
  } // do_ajax_form_service_event_classe_onchange_cb
  function do_ajax_form_service_event_classe_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_event_classe_onchange_cb_after_alert

  // ---------- Event onchange id_empresa
  function do_ajax_form_service_event_id_empresa_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_event_id_empresa_onchange(var_id_empresa, var_empresa, var_contato, var_telefone, var_fax, var_email, var_endereco, var_script_case_init, do_ajax_form_service_event_id_empresa_onchange_cb);
  } // do_ajax_form_service_event_id_empresa_onchange

  function do_ajax_form_service_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_service_event_id_empresa_onchange_cb
  function do_ajax_form_service_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onchange marca
  function do_ajax_form_service_event_marca_onchange()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_event_marca_onchange(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_event_marca_onchange_cb);
  } // do_ajax_form_service_event_marca_onchange

  function do_ajax_form_service_event_marca_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "marca";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_event_marca_onchange_cb_after_alert);
  } // do_ajax_form_service_event_marca_onchange_cb
  function do_ajax_form_service_event_marca_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_event_marca_onchange_cb_after_alert

  // ---------- Event onchange modelo
  function do_ajax_form_service_event_modelo_onchange()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_event_modelo_onchange(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_event_modelo_onchange_cb);
  } // do_ajax_form_service_event_modelo_onchange

  function do_ajax_form_service_event_modelo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modelo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_event_modelo_onchange_cb_after_alert);
  } // do_ajax_form_service_event_modelo_onchange_cb
  function do_ajax_form_service_event_modelo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_event_modelo_onchange_cb_after_alert

  // ---------- Event onblur serie
  function do_ajax_form_service_event_serie_onblur()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_event_serie_onblur(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_event_serie_onblur_cb);
  } // do_ajax_form_service_event_serie_onblur

  function do_ajax_form_service_event_serie_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "serie";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_event_serie_onblur_cb_after_alert);
  } // do_ajax_form_service_event_serie_onblur_cb
  function do_ajax_form_service_event_serie_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_event_serie_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_service_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_service_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_service_submit_form(var_osnumber, var_id_empresa, var_empresa, var_telefone, var_fax, var_contato, var_email, var_endereco, var_data, var_nfs_ent, var_classe, var_marca, var_modelo, var_serie, var_natureza, var_status, var_recepcao, var_obs, var_descricao, var_sintoma, var_dataorc, var_material, var_tecnico, var_pendencia, var_maoobra, var_orcamento, var_saida, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_service_submit_form_cb);
  } // do_ajax_form_service_submit_form

  function do_ajax_form_service_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_service_submit_form_cb_after_alert);
  } // do_ajax_form_service_submit_form_cb
  function do_ajax_form_service_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_service_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_work"] = "off";
  scStatusDetail["form_material"] = "off";

  function do_ajax_form_service_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_service_navigate_form, function() {});
    } else {
      perform_ajax_form_service_navigate_form();
    }
  }

  function perform_ajax_form_service_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_work"] = "on";
    scStatusDetail["form_material"] = "on";
    x_ajax_form_service_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_service_navigate_form_cb);
  } // do_ajax_form_service_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_service']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_service_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_work"] && "nmsc_iframe_liga_form_work" != scMasterDetailIframe["nmsc_iframe_liga_form_work"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_work"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_work').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_work').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_work').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_material"] && "nmsc_iframe_liga_form_material" != scMasterDetailIframe["nmsc_iframe_liga_form_material"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_material"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_material').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_material').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_material').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_service_navigate_form_cb_after_alert);
  } // do_ajax_form_service_navigate_form_cb
  function do_ajax_form_service_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_service_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_service_navigate_form_cb_after_alert

  function sc_hide_form_service_form()
  {
  ...
  function do_ajax_form_service_lkpedt_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_empresa";
    x_ajax_form_service_lkpedt_refresh_id_empresa(var_id_empresa, nmgp_refresh_fields, var_script_case_init, do_ajax_form_service_lkpedt_refresh_id_empresa_cb);
  } // do_ajax_form_service_lkpedt_refresh_id_empresa

  function do_ajax_form_service_lkpedt_refresh_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_service_lkpedt_refresh_id_empresa_cb
  ...
  {
    if ("off" == scStatusDetail["form_work"] && "off" == scStatusDetail["form_material"])
    {
      return true;
    }
    return false;
