...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_service']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_service']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_service"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Orcamento_osnumb = "<?php echo $this->form_encode_input($this->nmgp_dados_form['osnumber']); ?>";
function sc_btn_Orcamento()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Orcamento(); }, 500);
      return;
    }
    sc_btn_Orcamento_ok();
}
function sc_btn_Orcamento_cancel()
{
}
function sc_btn_Orcamento_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_Ordem_de_Servico_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "osnumb*scin' + var_btn_Orcamento_osnumb + '*scoutlink_remove_margin*scinno*scoutlink_remove_border*scinno*scoutlink_remove_background*scinno*scout"; ?>', 'inicio', '_self', '0', '0', 'Ordem_de_Servico');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_service']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_service_form0').style.width='1px';
    document.getElementById('form_service_form0').style.height='0px';
    document.getElementById('form_service_form0').style.display='none';
    document.getElementById('form_service_form0').style.overflow='scroll';
    document.getElementById('form_service_form1').style.width='1px';
    document.getElementById('form_service_form1').style.height='0px';
    document.getElementById('form_service_form1').style.display='none';
    document.getElementById('form_service_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_service']['pdf_view']) {
?>
...
?>
   ...
   if ("form_service_form1" == N_pagina) {
