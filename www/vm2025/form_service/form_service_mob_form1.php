<div id="form_service_mob_form1" style='<?php echo ($this->tabCssClass["form_service_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_dataorc" style="<?php echo $sStyleHidden_dataorc; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dataorc_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_dataorc_label" style=" padding: 0px; width: 100%;"><span id="id_label_dataorc"><?php echo $this->nm_new_label['dataorc']; ?></span></td></tr><tr><td class="css_dataorc_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_dataorc_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_dataorc_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_material" style="<?php echo $sStyleHidden_material; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_material_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_material_label" style=" padding: 0px; width: 100%;"><span id="id_label_material"><?php echo $this->nm_new_label['material']; ?></span></td></tr><tr><td class="css_material_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_material_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_material_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_tecnico" style="<?php echo $sStyleHidden_tecnico; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tecnico_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_tecnico_label" style=" padding: 0px; width: 100%;"><span id="id_label_tecnico"><?php echo $this->nm_new_label['tecnico']; ?></span></td></tr><tr><td class="css_tecnico_line" style="padding: 0px; width: 100%;">
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tecnico_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tecnico_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_pendencia" style="<?php echo $sStyleHidden_pendencia; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pendencia_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_pendencia_label" style=" padding: 0px; width: 100%;"><span id="id_label_pendencia"><?php echo $this->nm_new_label['pendencia']; ?></span></td></tr><tr><td class="css_pendencia_line" style="padding: 0px; width: 100%;">
<?php
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_pendencia_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_pendencia_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_maoobra" style="<?php echo $sStyleHidden_maoobra; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_maoobra_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_maoobra_label" style=" padding: 0px; width: 100%;"><span id="id_label_maoobra"><?php echo $this->nm_new_label['maoobra']; ?></span></td></tr><tr><td class="css_maoobra_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_maoobra_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_maoobra_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_orcamento" style="<?php echo $sStyleHidden_orcamento; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_orcamento_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_orcamento_label" style=" padding: 0px; width: 100%;"><span id="id_label_orcamento"><?php echo $this->nm_new_label['orcamento']; ?></span></td></tr><tr><td class="css_orcamento_line" style="padding: 0px; width: 100%;">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_orcamento_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_orcamento_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_saida" style="<?php echo $sStyleHidden_saida; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_saida_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_saida_label" style=" padding: 0px; width: 100%;"><span id="id_label_saida"><?php echo $this->nm_new_label['saida']; ?></span></td></tr><tr><td class="css_saida_line" style="padding: 0px; width: 100%;">
...
<?php $sStyleHidden_saida_dumb = ('' == $sStyleHidden_saida) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_saida_dumb" style="<?php echo $sStyleHidden_saida_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Servico'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Servico'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Servico'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_work_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init'] ]['form_service_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_service_mob_empty.htm' : $this->Ini->link_form_work_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Servico']) && 'nmsc_iframe_liga_form_work_mob' != $this->Ini->sc_lig_target['C_@scinf_Servico'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Servico'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_work_mob_script_case_init']);
    }
?>
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_work_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_work_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Mat'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Mat'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Mat'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_form_btn_nav'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_material_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinS*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init'] ]['form_service_mob']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_service_mob_empty.htm' : $this->Ini->link_form_material_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
...
if (isset($this->Ini->sc_lig_target['C_@scinf_Mat']) && 'nmsc_iframe_liga_form_material_mob' != $this->Ini->sc_lig_target['C_@scinf_Mat'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Mat'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['form_material_mob_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_material_mob"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_material_mob"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script> 
<?php
 $NM_pag_atual = "form_service_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_service_mob_form" . $this->nmgp_ancora;
 }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_service_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_service_mob");
 parent.scAjaxDetailHeight("form_service_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
