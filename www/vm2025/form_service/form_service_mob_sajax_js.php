  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_service_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate osnumber
  function do_ajax_form_service_mob_validate_osnumber()
  {
    var nomeCampo_osnumber = "osnumber";
    var var_osnumber = scAjaxGetFieldHidden(nomeCampo_osnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_osnumber(var_osnumber, var_script_case_init, do_ajax_form_service_mob_validate_osnumber_cb);
  } // do_ajax_form_service_mob_validate_osnumber

  function do_ajax_form_service_mob_validate_osnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "osnumber";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_osnumber_cb

  // ---------- Validate id_empresa
  function do_ajax_form_service_mob_validate_id_empresa()
  {
  } // do_ajax_form_service_mob_validate_id_empresa

  function do_ajax_form_service_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_id_empresa_cb

  // ---------- Validate empresa
  function do_ajax_form_service_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_service_mob_validate_empresa_cb);
  } // do_ajax_form_service_mob_validate_empresa

  function do_ajax_form_service_mob_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_empresa_cb

  // ---------- Validate telefone
  function do_ajax_form_service_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_service_mob_validate_telefone_cb);
  } // do_ajax_form_service_mob_validate_telefone

  function do_ajax_form_service_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_telefone_cb

  // ---------- Validate fax
  function do_ajax_form_service_mob_validate_fax()
  {
    var nomeCampo_fax = "fax";
    var var_fax = scAjaxGetFieldText(nomeCampo_fax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_fax(var_fax, var_script_case_init, do_ajax_form_service_mob_validate_fax_cb);
  } // do_ajax_form_service_mob_validate_fax

  function do_ajax_form_service_mob_validate_fax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_fax_cb

  // ---------- Validate contato
  function do_ajax_form_service_mob_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_contato(var_contato, var_script_case_init, do_ajax_form_service_mob_validate_contato_cb);
  } // do_ajax_form_service_mob_validate_contato

  function do_ajax_form_service_mob_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_contato_cb

  // ---------- Validate email
  function do_ajax_form_service_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_email(var_email, var_script_case_init, do_ajax_form_service_mob_validate_email_cb);
  } // do_ajax_form_service_mob_validate_email

  function do_ajax_form_service_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_email_cb

  // ---------- Validate endereco
  function do_ajax_form_service_mob_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_service_mob_validate_endereco_cb);
  } // do_ajax_form_service_mob_validate_endereco

  function do_ajax_form_service_mob_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_endereco_cb

  // ---------- Validate data
  function do_ajax_form_service_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_data(var_data, var_script_case_init, do_ajax_form_service_mob_validate_data_cb);
  } // do_ajax_form_service_mob_validate_data

  function do_ajax_form_service_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_data_cb

  // ---------- Validate nfs_ent
  function do_ajax_form_service_mob_validate_nfs_ent()
  {
    var nomeCampo_nfs_ent = "nfs_ent";
    var var_nfs_ent = scAjaxGetFieldText(nomeCampo_nfs_ent);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_nfs_ent(var_nfs_ent, var_script_case_init, do_ajax_form_service_mob_validate_nfs_ent_cb);
  } // do_ajax_form_service_mob_validate_nfs_ent

  function do_ajax_form_service_mob_validate_nfs_ent_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_nfs_ent_cb

  // ---------- Validate classe
  function do_ajax_form_service_mob_validate_classe()
  {
  } // do_ajax_form_service_mob_validate_classe

  function do_ajax_form_service_mob_validate_classe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_classe_cb

  // ---------- Validate marca
  function do_ajax_form_service_mob_validate_marca()
  {
  } // do_ajax_form_service_mob_validate_marca

  function do_ajax_form_service_mob_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_marca_cb

  // ---------- Validate modelo
  function do_ajax_form_service_mob_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_service_mob_validate_modelo_cb);
  } // do_ajax_form_service_mob_validate_modelo

  function do_ajax_form_service_mob_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_modelo_cb

  // ---------- Validate serie
  function do_ajax_form_service_mob_validate_serie()
  {
    var nomeCampo_serie = "serie";
    var var_serie = scAjaxGetFieldText(nomeCampo_serie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_serie(var_serie, var_script_case_init, do_ajax_form_service_mob_validate_serie_cb);
  } // do_ajax_form_service_mob_validate_serie

  function do_ajax_form_service_mob_validate_serie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_serie_cb

  // ---------- Validate natureza
  function do_ajax_form_service_mob_validate_natureza()
  {
    var nomeCampo_natureza = "natureza";
    var var_natureza = scAjaxGetFieldRadio(nomeCampo_natureza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_natureza(var_natureza, var_script_case_init, do_ajax_form_service_mob_validate_natureza_cb);
  } // do_ajax_form_service_mob_validate_natureza

  function do_ajax_form_service_mob_validate_natureza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "natureza";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_natureza_cb

  // ---------- Validate status
  function do_ajax_form_service_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_status(var_status, var_script_case_init, do_ajax_form_service_mob_validate_status_cb);
  } // do_ajax_form_service_mob_validate_status

  function do_ajax_form_service_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_status_cb

  // ---------- Validate recepcao
  function do_ajax_form_service_mob_validate_recepcao()
  {
    var nomeCampo_recepcao = "recepcao";
    var var_recepcao = scAjaxGetFieldSelect(nomeCampo_recepcao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_recepcao(var_recepcao, var_script_case_init, do_ajax_form_service_mob_validate_recepcao_cb);
  } // do_ajax_form_service_mob_validate_recepcao

  function do_ajax_form_service_mob_validate_recepcao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "recepcao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_recepcao_cb

  // ---------- Validate obs
  function do_ajax_form_service_mob_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_obs(var_obs, var_script_case_init, do_ajax_form_service_mob_validate_obs_cb);
  } // do_ajax_form_service_mob_validate_obs

  function do_ajax_form_service_mob_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_obs_cb

  // ---------- Validate descricao
  function do_ajax_form_service_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_service_mob_validate_descricao_cb);
  } // do_ajax_form_service_mob_validate_descricao

  function do_ajax_form_service_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_descricao_cb

  // ---------- Validate sintoma
  function do_ajax_form_service_mob_validate_sintoma()
  {
    var nomeCampo_sintoma = "sintoma";
    var var_sintoma = scAjaxGetFieldText(nomeCampo_sintoma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_sintoma(var_sintoma, var_script_case_init, do_ajax_form_service_mob_validate_sintoma_cb);
  } // do_ajax_form_service_mob_validate_sintoma

  function do_ajax_form_service_mob_validate_sintoma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_sintoma_cb

  // ---------- Validate dataorc
  function do_ajax_form_service_mob_validate_dataorc()
  {
    var nomeCampo_dataorc = "dataorc";
    var var_dataorc = scAjaxGetFieldText(nomeCampo_dataorc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_dataorc(var_dataorc, var_script_case_init, do_ajax_form_service_mob_validate_dataorc_cb);
  } // do_ajax_form_service_mob_validate_dataorc

  function do_ajax_form_service_mob_validate_dataorc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_dataorc_cb

  // ---------- Validate material
  function do_ajax_form_service_mob_validate_material()
  {
    var nomeCampo_material = "material";
    var var_material = scAjaxGetFieldText(nomeCampo_material);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_material(var_material, var_script_case_init, do_ajax_form_service_mob_validate_material_cb);
  } // do_ajax_form_service_mob_validate_material

  function do_ajax_form_service_mob_validate_material_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "material";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_material_cb

  // ---------- Validate tecnico
  function do_ajax_form_service_mob_validate_tecnico()
  {
    var nomeCampo_tecnico = "tecnico";
    var var_tecnico = scAjaxGetFieldSelect(nomeCampo_tecnico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_tecnico(var_tecnico, var_script_case_init, do_ajax_form_service_mob_validate_tecnico_cb);
  } // do_ajax_form_service_mob_validate_tecnico

  function do_ajax_form_service_mob_validate_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_tecnico_cb

  // ---------- Validate pendencia
  function do_ajax_form_service_mob_validate_pendencia()
  {
    var nomeCampo_pendencia = "pendencia";
    var var_pendencia = scAjaxGetFieldText(nomeCampo_pendencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_pendencia(var_pendencia, var_script_case_init, do_ajax_form_service_mob_validate_pendencia_cb);
  } // do_ajax_form_service_mob_validate_pendencia

  function do_ajax_form_service_mob_validate_pendencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "pendencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_pendencia_cb

  // ---------- Validate maoobra
  function do_ajax_form_service_mob_validate_maoobra()
  {
    var nomeCampo_maoobra = "maoobra";
    var var_maoobra = scAjaxGetFieldText(nomeCampo_maoobra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_maoobra(var_maoobra, var_script_case_init, do_ajax_form_service_mob_validate_maoobra_cb);
  } // do_ajax_form_service_mob_validate_maoobra

  function do_ajax_form_service_mob_validate_maoobra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_maoobra_cb

  // ---------- Validate orcamento
  function do_ajax_form_service_mob_validate_orcamento()
  {
    var nomeCampo_orcamento = "orcamento";
    var var_orcamento = scAjaxGetFieldText(nomeCampo_orcamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_orcamento(var_orcamento, var_script_case_init, do_ajax_form_service_mob_validate_orcamento_cb);
  } // do_ajax_form_service_mob_validate_orcamento

  function do_ajax_form_service_mob_validate_orcamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "orcamento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_orcamento_cb

  // ---------- Validate saida
  function do_ajax_form_service_mob_validate_saida()
  {
    var nomeCampo_saida = "saida";
    var var_saida = scAjaxGetFieldText(nomeCampo_saida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_saida(var_saida, var_script_case_init, do_ajax_form_service_mob_validate_saida_cb);
  } // do_ajax_form_service_mob_validate_saida

  function do_ajax_form_service_mob_validate_saida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_saida_cb

  // ---------- Validate servico
  function do_ajax_form_service_mob_validate_servico()
  {
    var nomeCampo_servico = "servico";
    var var_servico = scAjaxGetFieldText(nomeCampo_servico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_servico(var_servico, var_script_case_init, do_ajax_form_service_mob_validate_servico_cb);
  } // do_ajax_form_service_mob_validate_servico

  function do_ajax_form_service_mob_validate_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_servico_cb

  // ---------- Validate mat
  function do_ajax_form_service_mob_validate_mat()
  {
    var nomeCampo_mat = "mat";
    var var_mat = scAjaxGetFieldText(nomeCampo_mat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_service_mob_validate_mat(var_mat, var_script_case_init, do_ajax_form_service_mob_validate_mat_cb);
  } // do_ajax_form_service_mob_validate_mat

  function do_ajax_form_service_mob_validate_mat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_service_mob_validate_mat_cb

  // ---------- Event onchange classe
  function do_ajax_form_service_mob_event_classe_onchange()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    ...
    scAjaxProcOn(true);
    x_ajax_form_service_mob_event_classe_onchange(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_mob_event_classe_onchange_cb);
  } // do_ajax_form_service_mob_event_classe_onchange

  function do_ajax_form_service_mob_event_classe_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "classe";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_mob_event_classe_onchange_cb_after_alert);
  } // do_ajax_form_service_mob_event_classe_onchange_cb
  function do_ajax_form_service_mob_event_classe_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_mob_event_classe_onchange_cb_after_alert

  // ---------- Event onchange id_empresa
  function do_ajax_form_service_mob_event_id_empresa_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_mob_event_id_empresa_onchange(var_id_empresa, var_empresa, var_contato, var_telefone, var_fax, var_email, var_endereco, var_script_case_init, do_ajax_form_service_mob_event_id_empresa_onchange_cb);
  } // do_ajax_form_service_mob_event_id_empresa_onchange

  function do_ajax_form_service_mob_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_mob_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_service_mob_event_id_empresa_onchange_cb
  function do_ajax_form_service_mob_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_mob_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onchange marca
  function do_ajax_form_service_mob_event_marca_onchange()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_mob_event_marca_onchange(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_mob_event_marca_onchange_cb);
  } // do_ajax_form_service_mob_event_marca_onchange

  function do_ajax_form_service_mob_event_marca_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "marca";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_mob_event_marca_onchange_cb_after_alert);
  } // do_ajax_form_service_mob_event_marca_onchange_cb
  function do_ajax_form_service_mob_event_marca_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_mob_event_marca_onchange_cb_after_alert

  // ---------- Event onchange modelo
  function do_ajax_form_service_mob_event_modelo_onchange()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_mob_event_modelo_onchange(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_mob_event_modelo_onchange_cb);
  } // do_ajax_form_service_mob_event_modelo_onchange

  function do_ajax_form_service_mob_event_modelo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modelo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_mob_event_modelo_onchange_cb_after_alert);
  } // do_ajax_form_service_mob_event_modelo_onchange_cb
  function do_ajax_form_service_mob_event_modelo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_mob_event_modelo_onchange_cb_after_alert

  // ---------- Event onblur serie
  function do_ajax_form_service_mob_event_serie_onblur()
  {
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_service_mob_event_serie_onblur(var_descricao, var_classe, var_marca, var_modelo, var_serie, var_script_case_init, do_ajax_form_service_mob_event_serie_onblur_cb);
  } // do_ajax_form_service_mob_event_serie_onblur

  function do_ajax_form_service_mob_event_serie_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "serie";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_service_mob_event_serie_onblur_cb_after_alert);
  } // do_ajax_form_service_mob_event_serie_onblur_cb
  function do_ajax_form_service_mob_event_serie_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_service_mob_event_serie_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_service_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_service_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_osnumber = scAjaxGetFieldHidden("osnumber");
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_empresa = scAjaxGetFieldText("empresa");
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_fax = scAjaxGetFieldText("fax");
    ...
    var var_nfs_ent = scAjaxGetFieldText("nfs_ent");
    var var_classe = scAjaxGetFieldText("classe");
    var var_marca = scAjaxGetFieldText("marca");
    var var_modelo = scAjaxGetFieldText("modelo");
    var var_serie = scAjaxGetFieldText("serie");
    var var_natureza = scAjaxGetFieldRadio("natureza");
    var var_status = scAjaxGetFieldSelect("status");
    var var_recepcao = scAjaxGetFieldSelect("recepcao");
    var var_obs = scAjaxGetFieldText("obs");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_sintoma = scAjaxGetFieldText("sintoma");
    var var_dataorc = scAjaxGetFieldText("dataorc");
    var var_material = scAjaxGetFieldText("material");
    var var_tecnico = scAjaxGetFieldSelect("tecnico");
    var var_pendencia = scAjaxGetFieldText("pendencia");
    var var_maoobra = scAjaxGetFieldText("maoobra");
    var var_orcamento = scAjaxGetFieldText("orcamento");
    var var_saida = scAjaxGetFieldText("saida");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_service_mob_submit_form(var_osnumber, var_id_empresa, var_empresa, var_telefone, var_fax, var_contato, var_email, var_endereco, var_data, var_nfs_ent, var_classe, var_marca, var_modelo, var_serie, var_natureza, var_status, var_recepcao, var_obs, var_descricao, var_sintoma, var_dataorc, var_material, var_tecnico, var_pendencia, var_maoobra, var_orcamento, var_saida, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_service_mob_submit_form_cb);
  } // do_ajax_form_service_mob_submit_form

  function do_ajax_form_service_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("osnumber");
      ...
      scAjaxHideErrorDisplay("nfs_ent");
      scAjaxHideErrorDisplay("classe");
      scAjaxHideErrorDisplay("marca");
      scAjaxHideErrorDisplay("modelo");
      scAjaxHideErrorDisplay("serie");
      scAjaxHideErrorDisplay("natureza");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("recepcao");
      scAjaxHideErrorDisplay("obs");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("sintoma");
      scAjaxHideErrorDisplay("dataorc");
      scAjaxHideErrorDisplay("material");
      scAjaxHideErrorDisplay("tecnico");
      scAjaxHideErrorDisplay("pendencia");
      scAjaxHideErrorDisplay("maoobra");
      scAjaxHideErrorDisplay("orcamento");
      scAjaxHideErrorDisplay("saida");
      scAjaxHideErrorDisplay("servico");
      scAjaxHideErrorDisplay("mat");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_service_mob_submit_form_cb_after_alert);
  } // do_ajax_form_service_mob_submit_form_cb
  function do_ajax_form_service_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_service_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_work_mob"] = "off";
  scStatusDetail["form_material_mob"] = "off";

  function do_ajax_form_service_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_service_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_service_mob_navigate_form();
    }
  }

  function perform_ajax_form_service_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_work_mob"] = "on";
    scStatusDetail["form_material_mob"] = "on";
    x_ajax_form_service_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_service_mob_navigate_form_cb);
  } // do_ajax_form_service_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_service_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_service_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_work_mob"] && "nmsc_iframe_liga_form_work_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_work_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_work_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_work_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_work_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_work_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_material_mob"] && "nmsc_iframe_liga_form_material_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_material_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_material_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_material_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_material_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_material_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_service_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_service_mob_navigate_form_cb
  function do_ajax_form_service_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_service_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_service_mob_navigate_form_cb_after_alert

  function sc_hide_form_service_mob_form()
  {
  ...
  function do_ajax_form_service_mob_lkpedt_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_empresa";
    x_ajax_form_service_mob_lkpedt_refresh_id_empresa(var_id_empresa, nmgp_refresh_fields, var_script_case_init, do_ajax_form_service_mob_lkpedt_refresh_id_empresa_cb);
  } // do_ajax_form_service_mob_lkpedt_refresh_id_empresa

  function do_ajax_form_service_mob_lkpedt_refresh_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_service_mob_lkpedt_refresh_id_empresa_cb
  ...
  {
    if ("off" == scStatusDetail["form_work_mob"] && "off" == scStatusDetail["form_material_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "osnumber";
  ajax_field_list[1] = "id_empresa";
  ajax_field_list[2] = "empresa";
  ajax_field_list[3] = "telefone";
  ajax_field_list[4] = "fax";
  ajax_field_list[5] = "contato";
  ajax_field_list[6] = "email";
  ajax_field_list[7] = "endereco";
  ajax_field_list[8] = "data";
  ajax_field_list[9] = "nfs_ent";
  ajax_field_list[10] = "classe";
  ajax_field_list[11] = "marca";
  ajax_field_list[12] = "modelo";
  ajax_field_list[13] = "serie";
  ajax_field_list[14] = "natureza";
  ajax_field_list[15] = "status";
  ajax_field_list[16] = "recepcao";
  ajax_field_list[17] = "obs";
  ajax_field_list[18] = "descricao";
  ajax_field_list[19] = "sintoma";
  ajax_field_list[20] = "dataorc";
  ajax_field_list[21] = "material";
  ajax_field_list[22] = "tecnico";
  ajax_field_list[23] = "pendencia";
  ajax_field_list[24] = "maoobra";
  ajax_field_list[25] = "orcamento";
  ajax_field_list[26] = "saida";
  ajax_field_list[27] = "servico";
  ajax_field_list[28] = "mat";
  ...
  var ajax_error_list = {
    "osnumber": {"label": "O.S.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "nfs_ent": {"label": "N.F.E.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "classe": {"label": "Classe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "marca": {"label": "Marca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "modelo": {"label": "Modelo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "serie": {"label": "Num. série", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "natureza": {"label": "Natureza", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "status": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "recepcao": {"label": "Recepção", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "sintoma": {"label": "Sintoma", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dataorc": {"label": "Data orc.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "material": {"label": "Custo material", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tecnico": {"label": "Técnico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "pendencia": {"label": "Pendências", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "maoobra": {"label": "Mão de obra", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "orcamento": {"label": "Orçamento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "saida": {"label": "Data saída", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "servico": {"label": "Serviços", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "mat": {"label": "Material", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["osnumber"][1] = "osnumber";
  ...
  ajax_field_mult["nfs_ent"][1] = "nfs_ent";
  ajax_field_mult["classe"][1] = "classe";
  ajax_field_mult["marca"][1] = "marca";
  ajax_field_mult["modelo"][1] = "modelo";
  ajax_field_mult["serie"][1] = "serie";
  ajax_field_mult["natureza"][1] = "natureza";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["recepcao"][1] = "recepcao";
  ajax_field_mult["obs"][1] = "obs";
  ajax_field_mult["descricao"][1] = "descricao";
  ajax_field_mult["sintoma"][1] = "sintoma";
  ajax_field_mult["dataorc"][1] = "dataorc";
  ajax_field_mult["material"][1] = "material";
  ajax_field_mult["tecnico"][1] = "tecnico";
  ajax_field_mult["pendencia"][1] = "pendencia";
  ajax_field_mult["maoobra"][1] = "maoobra";
  ajax_field_mult["orcamento"][1] = "orcamento";
  ajax_field_mult["saida"][1] = "saida";
  ajax_field_mult["servico"][1] = "servico";
  ajax_field_mult["mat"][1] = "mat";

  var ajax_field_id = {
    "osnumber": new Array("hidden_field_label_osnumber", "hidden_field_data_osnumber"),
    ...
    "nfs_ent": new Array("hidden_field_label_nfs_ent", "hidden_field_data_nfs_ent"),
    "classe": new Array("hidden_field_label_classe", "hidden_field_data_classe"),
    ...
    "natureza": new Array("hidden_field_label_natureza", "hidden_field_data_natureza"),
    "status": new Array("hidden_field_label_status", "hidden_field_data_status"),
    "recepcao": new Array("hidden_field_label_recepcao", "hidden_field_data_recepcao"),
    ...
    "sintoma": new Array("hidden_field_label_sintoma", "hidden_field_data_sintoma"),
    "dataorc": new Array("hidden_field_label_dataorc", "hidden_field_data_dataorc"),
    "material": new Array("hidden_field_label_material", "hidden_field_data_material"),
    "tecnico": new Array("hidden_field_label_tecnico", "hidden_field_data_tecnico"),
    "pendencia": new Array("hidden_field_label_pendencia", "hidden_field_data_pendencia"),
    "maoobra": new Array("hidden_field_label_maoobra", "hidden_field_data_maoobra"),
    "orcamento": new Array("hidden_field_label_orcamento", "hidden_field_data_orcamento"),
    "saida": new Array("hidden_field_label_saida", "hidden_field_data_saida"),
    "servico": new Array("hidden_field_label_servico", "hidden_field_data_servico"),
    "mat": new Array("hidden_field_label_mat", "hidden_field_data_mat")
  };
