<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_comissao']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_comissao_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_comissao_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["data"] : "Data";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "ID_CLIENTE";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["id_cliente"] : "Cliente";
   $tab_ger_campos['cod_vend'] = "on";
   $tab_def_campos['cod_vend'] = "COD_VEND";
   $tab_labels["cod_vend"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["cod_vend"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["cod_vend"] : "Consultor";
   $tab_ger_campos['ordem'] = "on";
   $tab_def_campos['ordem'] = "ORDEM";
   $tab_labels["ordem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["ordem"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["ordem"] : "Ordem";
   $tab_ger_campos['modelo'] = "on";
   $tab_def_campos['modelo'] = "MODELO";
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["modelo"] : "Modelo";
   $tab_ger_campos['qtd'] = "on";
   $tab_def_campos['qtd'] = "QTD";
   $tab_labels["qtd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["qtd"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["qtd"] : "Qtd";
   $tab_ger_campos['fob_tot'] = "on";
   $tab_def_campos['fob_tot'] = "FOB_TOT";
   $tab_labels["fob_tot"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["fob_tot"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["fob_tot"] : "FOB total R$";
   $tab_ger_campos['custototal'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['custototal'] = "CustoTotal";
   }
   else
   {
       $tab_def_campos['custototal'] = "";
   }
   $tab_labels["custototal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["custototal"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["custototal"] : "Custo CIF Total Item";
   $tab_ger_campos['valor_max'] = "on";
   $tab_def_campos['valor_max'] = "VALOR_MAX";
   $tab_labels["valor_max"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["valor_max"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["valor_max"] : "Preço Unitário sugerido";
   $tab_ger_campos['valor_vendido'] = "on";
   $tab_def_campos['valor_vendido'] = "VALOR_VENDIDO";
   $tab_labels["valor_vendido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["valor_vendido"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["valor_vendido"] : "Valor  unitário vendido";
   $tab_ger_campos['subtotalvendido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['subtotalvendido'] = "SubTotalVendido";
   }
   else
   {
       $tab_def_campos['subtotalvendido'] = "";
   }
   $tab_labels["subtotalvendido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["subtotalvendido"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["subtotalvendido"] : "SubTotal ";
   $tab_ger_campos['margcont'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['margcont'] = "MargCont";
   }
   else
   {
       $tab_def_campos['margcont'] = "";
   }
   $tab_labels["margcont"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["margcont"])) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['labels']["margcont"] : "Margem Total";
   $tab_ger_campos['custototal'] = "none";
   $tab_ger_campos['subtotalvendido'] = "none";
   $tab_ger_campos['margcont'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_comissao']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_comissao']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_comissao_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_comissao']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
