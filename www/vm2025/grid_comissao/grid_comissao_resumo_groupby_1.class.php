...
class grid_comissao_resumo
{
    const GROUPBY_ORIGINAL = 1;
    const GROUPBY_COMPARISON = 2;
    const GROUPBY_PERC_CHANGE = 3;
    const TOTAL_ARRAY_LABEL_INDEX = 5;
    const TOTAL_ARRAY_VALUE_INDEX = 6;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_cod_vend = array();
   ...
   if ($this->Ini->Embutida_iframe) {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'DATA' => [
                    ...
                    'order_by_direction_default' => 'desc',
                    'is_rating' => '' != '',
                    'rating_function' => '',
                ...
                'COD_VEND' => [
                    ...
                    'datatype' => 'varchar',
                    'lowercase' => 'cod_vend',
                    'summary_values_array' => 'array_total_cod_vend',
                    'summary_line_values_array' => 'array_line_cod_vend',
            ...
            'metric' => [
                ...
                'custototal-S' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_custototal_S',
                    'css_class' => "css_custototal_sum_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => false,
                ],
                'subtotalvendido-S' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_subtotalvendido_S',
                    'css_class' => "css_subtotalvendido_sum_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => false,
                ],
                'margcont-S' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_margcont_S',
                    'css_class' => "css_margcont_sum_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => false,
                ],
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['DATA', 'COD_VEND'],
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_group_by'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_order'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_x_axys'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_y_axys'] = [];

        $dimensionCount = 0;

        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_x_axys'] [] = $dimensionCount;
        ...
        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_y_axys'] [] = $dimensionCount;

            $dimensionCount++;
        }

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['dimension_order'] = [];
        foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
        }
    }

    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['last_displayed_group_by'] = 'groupby_1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('groupby_1' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['last_displayed_group_by'] = 'groupby_1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['heatmap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['treemap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chord_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['sankey_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['sunburst_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
            $dimensionName = $this->SC_APP_info['group_by'] ['dimension'] ['order'] [$dimensionIndex];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_y_axys'])) {
        ...
        foreach ($this->SC_APP_info['metric_by_index'] as $metricIndex => $metricName) {
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex])) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex] = ['display' => false];
            }
        }
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summarizing_fields_order'] ['groupby_1'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_record_count'];
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length'];
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summary_cache']);
        }
    }
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_comissao/index.php";
...
SCEOT;
    ...
    let windowName = "grid_comissao_chart_window" + (Math.floor(Math.random() * 100) + 1);
...
SCEOT;
    ...
    function display_pdf_charts()
    {
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_level']) {
                continue;
            }
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($chartInfo['info_type'] != $chartInfoType) {
                continue;
            } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_level']) {
                continue;
            }

            if ($this->progress_fp) {
                grid_comissao_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_comissao_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...\n", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChartAppCharts()
    {
        ...
        if (1 < count($this->SC_APP_info['group_by'] ['metric'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['graf_opc_atual'] = 1;
        }
        ...
        foreach ($this->SC_APP_data['ordered_y_matrix'] as $rowDimensionInfo) {
            ...
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summarizing_drill_down']) || !$_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['summarizing_drill_down']) {
                continue;
            }
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_md5_list'] = $this->SC_APP_data['chart_md5_list'];
    ...
    function aux_addChartAppGrandTotalChart()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_comissao@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['skip_charts']) {
            return false;
    ...
    function aux_format_custototal_S($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_format_subtotalvendido_S($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
        ...
        nmgp_Form_Num_Val($value, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "N", "", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
        $value .= $suffix;

        return $value;
    }

    function aux_format_margcont_S($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
        ...
        nmgp_Form_Num_Val($value, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
        $value .= $suffix;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_comissao'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_comissao'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_comissao'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        switch ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['cfg_graf'] ['graf_tipo']) {
            case 'Chord':
                return 'chord_info';
            case 'Heatmap':
                return 'heatmap_info';
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['opcao']) {
            return true;
        }
    ...
    {
        return $this->aux_isPdf() && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['skip_summary'];
    }
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['comb_table_def'] = [
            'field' => [],
            'label' => [],
            'summ' => [],
        ];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['comb_table_data'] = [];

        foreach ($this->SC_APP_info['group_by'] ['metric'] as $i => $metricName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['comb_table_def'] ['field'] [] = $metricName;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['comb_table_def'] ['label'] [] = $this->SC_APP_info['metric'] [$metricName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['comb_table_def'] ['summ'] [] = $i;
        }

        $this->aux_storeSummaryTableInfo_recursive($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['comb_table_data'], $this->SC_APP_data['ordered_y_axys'], 0, []);
    }
...
SCEOT;
    ...
    function generateChartImages()
    {
        ...
        $chartInfoType = $this->aux_getChartInfoType();
        $chartList = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_comissao'] ['chart_md5_list'];
        $chartFiles = array();

        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['phantomjs_export_process'] = true;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_step']     = 'image';
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_count']    = 0;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_total']    = 0;
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_total']++;
            }
        }
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['phantomjs_export_file'] = '';
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_count']++;
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['phantomjs_export_process'] = false;
    ...
    function zipChartImages($password = '')
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_step'] = 'zip';

        $this->writeProgressFile();

        $zipFile = $this->zipFileList($chartImages, $password);

        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_step'] = 'end';
    ...
    function zipFileList($fileList, $password = '') {
        $tempDir = $this->Ini->root . $_SESSION['scriptcase']['grid_comissao']['glo_nm_path_imag_temp'] . '/';
    ...
    function writeProgressFile() {
        if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_total']}###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_step']) {
            $content = "ok###100";
        } else {
            $content = "init###0";
        }

        $f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_comissao']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['export_progress_file']}", 'w');
        fwrite($f, $content);
        fclose($f);
    }
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_resumo'] = "";
      }
      $this->Tem_Res_Compara = false;
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total_line']['data'];
                $this->array_line_cod_vend = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total_line']['cod_vend'];
            }
          $this->array_total_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total']['data'];
          $this->array_total_cod_vend = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total']['cod_vend'];
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_data = array();
                $this->array_total_cod_vend = array();
                $this->totaliza();
                ...
                $this->array_line_cod_vend = $this->array_total_cod_vend;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['SC_clear_total'] = true;
            }
          $this->array_total_data = array();
          $this->array_total_cod_vend = array();
          $this->totaliza('main');
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['json_use_label'])
       {
          $Lab_data = "DATA";
          $Lab_cod_vend = "COD_VEND";
       }
       else
       {
       $Lab_data = "Data";
       $Lab_cod_vend = "Consultor";
       }
       $this->comp_field = array(
           $Lab_data,
           $Lab_cod_vend,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['data']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['data'] = "Data"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['id_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['id_cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['cod_vend']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['cod_vend'] = "Consultor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['ordem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['ordem'] = "Ordem"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['modelo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['modelo'] = "Modelo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['qtd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['qtd'] = "Qtd"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['fob_tot']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['fob_tot'] = "FOB total R$"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['custototal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['custototal'] = "Custo CIF Total Item"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['valor_max']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['valor_max'] = "Preço Unitário sugerido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['valor_vendido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['valor_vendido'] = "Valor  unitário vendido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['subtotalvendido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['subtotalvendido'] = "SubTotal "; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['margcont']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['margcont'] = "Margem Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['labels']['id'] = "ID"; 
       }
       //-----
       $this->comp_field_nm = array(
           'data' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Margem Cont.(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           4 => "SubTotal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           5 => "Custo Total Item(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_order']['groupby_1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_order']['groupby_1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_order']['groupby_1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['summarizing_fields_display']['groupby_1'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "margcont", 'show' => true),
           4 => array('field' => "subtotalvendido", 'show' => true),
           5 => array('field' => "custototal", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           ...
           3 => "css_margcont_sum",
           4 => "css_subtotalvendido_sum",
           5 => "css_custototal_sum",
       );
       ...
       $this->comp_sum_nm = array(
           ...
           3 => "margcont_sum",
           4 => "subtotalvendido_sum",
           5 => "custototal_sum",
       );

       //-----
       foreach ($this->array_total_data as $i_data => $d_data) {
           if (!isset($i_data, $this->comp_label[0]) || !in_array($i_data, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_data[6] ] = $d_data[5];
               $this->comp_label[0][ $d_data[6] ] = $d_data[5];
           }
           foreach ($this->array_total_cod_vend[$i_data] as $i_cod_vend => $d_cod_vend) {
               if (!isset($i_cod_vend, $this->comp_label[1][ $d_data[6] ]) || !in_array($i_cod_vend, $this->comp_label[1][ $d_data[6] ], true)) {
                   $this->comp_index[1][ $d_cod_vend[6] ] = $d_cod_vend[5];
                   $this->comp_label[1][ $d_data[6] ][ $d_cod_vend[6] ] = $d_cod_vend[5];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'data', 'prot' => '@aspass@'),
           array('name' => 'cod_vend', 'prot' => '@aspass@'),
       );
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_data => $l_data) {
           if (isset($this->array_total_data[$i_data])) {
               $this->comp_group[$i_data] = array();
           }
           foreach ($this->comp_label[1][$i_data] as $i_cod_vend => $l_cod_vend) {
               if (isset($this->array_total_cod_vend[$i_data][$i_cod_vend])) {
                   $this->comp_group[$i_data][$i_cod_vend] = array();
               }
           }
       }
     }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_data;
       }
       elseif (1 == $level) {
           $return = $this->array_total_cod_vend;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_comissao@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Margem Cont.(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'DATA',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_data)),
               'label_y'  => $this->getChartText(strip_tags("Margem Cont.(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
           ...
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("Custo Total Item(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'DATA',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_data)),
               'label_y'  => $this->getChartText(strip_tags("Custo Total Item(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'COD_VEND',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_cod_vend)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['anlt_table_def']  = array();
       ...
       $this->filterChartsByGroupbyLevel();
        ...
        function filterChartsByGroupbyLevel() {
                ...
                if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['chart_level']) {
                        $applyFilter = true;
                }
                elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
                        $applyFilter = true;
                        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['chart_level'] = $_POST['chart_level'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_orig'];

                if ($applyFilter) {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_charts'] as $chartIndex => $chartData) {
                                ...
                                if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['chart_level']) {
                                        unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_charts'][$chartIndex]);
                                }
                        }
                }

                $this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_charts'];
        }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_comissao_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_comissao_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['proc_pdf_vert']){ 
   ...
   public static function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 3)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "N", "", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       }
       if ($total == 4)
       {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_comissao_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['LigR_Md5'] = array();
   }
   ...
   {
      $this->NM_res_sem_reg = false;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][1] == 0) {
          $this->NM_res_sem_reg = true;
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total']['data'];
      $this->array_total_cod_vend = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total']['cod_vend'];
      if (is_array($this->array_total_data)) {
          krsort($this->array_total_data);
      }
      if (is_array($this->array_total_cod_vend)) {
          ksort($this->array_total_cod_vend);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_pesq']        = $save_where_pesq;
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE html>\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - comissao</TITLE>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_comissao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_comissao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_comissao_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_comissao/grid_comissao_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['embutida'])
      {
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_comissao_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_comissao/grid_comissao_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=pt_br&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_comissao&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_comissao/grid_comissao_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_comissao']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_comissao']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_comissao_config_pivot.php?nome_apl=grid_comissao&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_comissao_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_comissao_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_comissao/grid_comissao_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $cod_vend = (isset($Busca_temp['cod_vend'])) ? $Busca_temp['cod_vend'] : ""; 
          $tmp_pos = (is_string($cod_vend)) ? strpos($cod_vend, "##@@") : false;
          if ($tmp_pos !== false && !is_array($cod_vend))
          {
   ...
   //---- 
   function adiciona_registro($sum_custototal, $sum_subtotalvendido, $sum_margcont, $quebra_data, $quebra_cod_vend, $quebra_data_orig, $quebra_cod_vend_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "
      if (!isset($this->array_total_data[$quebra_data_orig]))
      {
         $this->array_total_data[$quebra_data_orig][0] = 1;
         $this->array_total_data[$quebra_data_orig][1] = $sum_custototal;
         $this->array_total_data[$quebra_data_orig][2] = $sum_subtotalvendido;
         $this->array_total_data[$quebra_data_orig][3] = $sum_margcont;
         $this->array_total_data[$quebra_data_orig][4] = 1;
         $this->array_total_data[$quebra_data_orig][5] = $quebra_data;
         $this->array_total_data[$quebra_data_orig][6] = $quebra_data_orig;
      }
      else
      {
         $this->array_total_data[$quebra_data_orig][0]++;
         $this->array_total_data[$quebra_data_orig][1] = bcadd($this->array_total_data[$quebra_data_orig][1], $sum_custototal, 10);
         $this->array_total_data[$quebra_data_orig][2] = bcadd($this->array_total_data[$quebra_data_orig][2], $sum_subtotalvendido, 10);
         $this->array_total_data[$quebra_data_orig][3] = bcadd($this->array_total_data[$quebra_data_orig][3], $sum_margcont, 10);
         $this->array_total_data[$quebra_data_orig][4]++;
      }
      //----- Consultor
      if (!isset($this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig]))
      {
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][0] = 1;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][1] = $sum_custototal;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][2] = $sum_subtotalvendido;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][3] = $sum_margcont;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][4] = 1;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][5] = $quebra_cod_vend;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][6] = $quebra_cod_vend_orig;
      }
      else
      {
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][0]++;
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][1] = bcadd($this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][1], $sum_custototal, 10);
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][2] = bcadd($this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][2], $sum_subtotalvendido, 10);
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][3] = bcadd($this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][3], $sum_margcont, 10);
         $this->array_total_cod_vend[$quebra_data_orig][$quebra_cod_vend_orig][4]++;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_custototal;
         $this->array_total_geral[2] = $sum_subtotalvendido;
         $this->array_total_geral[3] = $sum_margcont;
         $this->array_total_geral[4] = 1;
      }
      else
      {
         $this->array_total_geral[0]++;
         $this->array_total_geral[1] = bcadd($this->array_total_geral[1], $sum_custototal, 10);
         $this->array_total_geral[2] = bcadd($this->array_total_geral[2], $sum_subtotalvendido, 10);
         $this->array_total_geral[3] = bcadd($this->array_total_geral[3], $sum_margcont, 10);
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total']['data'] as $campo_data => $dados_data)
      {
         $this->array_total_data[$campo_data]    = array();
         $this->array_total_data[$campo_data][1] = $dados_data;
         $this->array_total_data[$campo_data][1][4] = $dados_data[1];
         $this->array_total_data[$campo_data][1][3] = $dados_data[2];
         $this->array_total_data[$campo_data][1][2] = $dados_data[3];
         $this->array_total_data[$campo_data][1][1] = $dados_data[4];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['arr_total']['cod_vend'][$campo_data] as $campo_cod_vend => $dados_cod_vend)
         {
            $this->array_total_cod_vend[$campo_data][$campo_cod_vend]    = array();
            $this->array_total_cod_vend[$campo_data][$campo_cod_vend][1] = $dados_cod_vend;
            $this->array_total_cod_vend[$campo_data][$campo_cod_vend][1][4] = $dados_cod_vend[1];
            $this->array_total_cod_vend[$campo_data][$campo_cod_vend][1][3] = $dados_cod_vend[2];
            $this->array_total_cod_vend[$campo_data][$campo_cod_vend][1][2] = $dados_cod_vend[3];
            $this->array_total_cod_vend[$campo_data][$campo_cod_vend][1][1] = $dados_cod_vend[4];
         }
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][1] == 0)
      {
      ...
      $this->array_total_geral[1][3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][2];
      $this->array_total_geral[1][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][3];
      $this->array_total_geral[1][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][4];
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['tot_geral'][1];
   }
   //---- 
   function completa_arrays()
   {
      if (isset($this->array_total_data))
      {
         $arr_temp_0 = $this->array_total_data;
         foreach ($this->array_total_data as $campo_data => $dados_data)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_data[$campo_data][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_data[$campo_data][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_data][$ind_missing][0] = 0;
                $arr_temp_0[$campo_data][$ind_missing][1] = 0;
                $arr_temp_0[$campo_data][$ind_missing][2] = 0;
                $arr_temp_0[$campo_data][$ind_missing][3] = 0;
                $arr_temp_0[$campo_data][$ind_missing][4] = 0;
                $arr_temp_0[$campo_data][$ind_missing][self::TOTAL_ARRAY_LABEL_INDEX] = $dados_data[$ind_exists][self::TOTAL_ARRAY_LABEL_INDEX];
                $arr_temp_0[$campo_data][$ind_missing][self::TOTAL_ARRAY_VALUE_INDEX] = $dados_data[$ind_exists][self::TOTAL_ARRAY_VALUE_INDEX];
            }
            ksort($arr_temp_0[$campo_data]);
            $this->array_total_data[$campo_data] = $arr_temp_0[$campo_data];
            if (isset($this->array_total_cod_vend[$campo_data]))
            {
               $arr_temp_1 = $this->array_total_cod_vend[$campo_data];
               foreach ($this->array_total_cod_vend[$campo_data] as $campo_cod_vend => $dados_cod_vend)
               {
                  $ind_exists  = "";
                  $ind_missing = "";
                  if (!isset($this->array_total_cod_vend[$campo_data][$campo_cod_vend][1])) {
                      $ind_exists  = 2;
                      $ind_missing = 1;
                  }
                  if (!isset($this->array_total_cod_vend[$campo_data][$campo_cod_vend][2])) {
                      $ind_exists  = 1;
                      $ind_missing = 2;
                  }
                  if (!empty($ind_missing)) {
                      $arr_temp_1[$campo_cod_vend][$ind_missing][0] = 0;
                      $arr_temp_1[$campo_cod_vend][$ind_missing][1] = 0;
                      $arr_temp_1[$campo_cod_vend][$ind_missing][2] = 0;
                      $arr_temp_1[$campo_cod_vend][$ind_missing][3] = 0;
                      $arr_temp_1[$campo_cod_vend][$ind_missing][4] = 0;
                      $arr_temp_1[$campo_cod_vend][$ind_missing][self::TOTAL_ARRAY_LABEL_INDEX] = $dados_cod_vend[$ind_exists][self::TOTAL_ARRAY_LABEL_INDEX];
                      $arr_temp_1[$campo_cod_vend][$ind_missing][self::TOTAL_ARRAY_VALUE_INDEX] = $dados_cod_vend[$ind_exists][self::TOTAL_ARRAY_VALUE_INDEX];
                  }
                  ksort($arr_temp_1[$campo_cod_vend]);
                  $this->array_total_cod_vend[$campo_data][$campo_cod_vend] = $arr_temp_1[$campo_cod_vend];
               } 
            } 
         } 
      } 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->cod_vend = $Busca_temp['cod_vend']; 
       $this->cod_vend = (isset($Busca_temp['cod_vend'])) ? $Busca_temp['cod_vend'] : ""; 
       $tmp_pos = (is_string($this->cod_vend)) ? strpos($this->cod_vend, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->cod_vend))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('groupby_1', 'data');
     $campos_order = $this->Ini->Get_date_order_groupby("DATA", 'desc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('groupby_1', 'cod_vend');
     $campos_order = $this->Ini->Get_date_order_groupby("COD_VEND", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->data = $rs_res->fields[0] ;  
            $this->id_cliente = $rs_res->fields[1] ;  
            $this->cod_vend = $rs_res->fields[2] ;  
            $this->ordem = $rs_res->fields[3] ;  
            $this->modelo = $rs_res->fields[4] ;  
            $this->qtd = $rs_res->fields[5] ;  
            $this->fob_tot = $rs_res->fields[6] ;  
            $this->fob_tot =  str_replace(",", ".", $this->fob_tot);
            $this->valor_max = $rs_res->fields[7] ;  
            $this->valor_max =  str_replace(",", ".", $this->valor_max);
            $this->valor_vendido = $rs_res->fields[8] ;  
...
$_SESSION['scriptcase']['grid_comissao']['contr_erro'] = 'off'; 
            ...
            $this->data_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->data, $Format_tst);
            $this->data = $this->Ini->GB_date_format($TP_Time . $this->data, $Format_tst, $Prefix_dat);
            $this->cod_vend_orig = $this->cod_vend;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->custototal, $this->subtotalvendido, $this->margcont, $this->data, $this->cod_vend, $this->data_orig,  $this->cod_vend_orig);
            }
   }
//
