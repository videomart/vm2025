...
class grid_comissao_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_comissao_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_comissao_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_comissao_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_comissao_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_comissao_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_numeric[] = "id";$Nm_numeric[] = "qtd";$Nm_numeric[] = "id_cliente";$Nm_numeric[] = "fob_tot";$Nm_numeric[] = "valor_max";$Nm_numeric[] = "valor_vendido";$Nm_numeric[] = "";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - comissao</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_comissao/grid_comissao_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_comissao_ajax_search.js"></script>
 <script type="text/javascript" src="grid_comissao_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_comissao_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_comissao']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_comissao']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_data_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_data_dia').value + '/';
          var_dt_ini += document.getElementById('SC_data_mes').value + '/';
          var_dt_ini += document.getElementById('SC_data_ano').value;
          document.getElementById('sc_data_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_data_dia').value = aParts[0];
          document.getElementById('SC_data_mes').value = aParts[1];
          document.getElementById('SC_data_ano').value = aParts[2];
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
  ...
  $("#sc_data_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_data_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_data_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_data_input_2_ano').value;
          document.getElementById('sc_data_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_data_input_2_dia').value = aParts[0];
          document.getElementById('SC_data_input_2_mes').value = aParts[1];
          document.getElementById('SC_data_input_2_ano').value = aParts[2];
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cod_vend_cond#NMF#' + search_get_sel_txt('SC_cod_vend_cond') + '@NMF@';
  str_out += 'SC_cod_vend#NMF#' + search_get_select('SC_cod_vend') + '@NMF@';
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cod_vend = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['cod_vend']; 
          $cod_vend_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['cod_vend_cond']; 
          $data_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_dia']; 
          $data_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_mes']; 
          $data_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_ano']; 
          $data_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2_dia']; 
          $data_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2_mes']; 
          $data_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2_ano']; 
          $data_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['NM_operador']; 
      } 
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_cod_vend"  <?php echo $str_hide_cod_vend?>>
<?php
      $cod_vend_look = (is_string($cod_vend) ? substr($this->Db->qstr($cod_vend), 1, -1) : $cod_vend); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT DISTINCT USUARIO, NOME  FROM funcionario  WHERE CONSULTOR=1 ORDER BY NOME"; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['psq_check_ret']['cod_vend'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['psq_check_ret']['cod_vend'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_cod_vend">
      <SELECT class="scFilterObjectOdd" id="SC_cod_vend" name="cod_vend"  size="1">
...
{
?>
<INPUT type="hidden" id="sc_data_jq">
<?php
}
?>
</span>
...
?>
        <SPAN id="id_vis_data"  <?php echo $str_display_data; ?> class="scFilterFieldFontEven">
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_input_2_dia" name="data_input_2_dia" value="<?php echo NM_encode_input($data_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
<INPUT type="hidden" id="sc_data_jq2">
<?php
}
?>
</span>
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_input_2_mes" name="data_input_2_mes" value="<?php echo NM_encode_input($data_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_input_2_ano" name="data_input_2_ano" value="<?php echo NM_encode_input($data_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
<?php
   if (is_file("grid_comissao_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_comissao']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_comissao']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.data_cond.value = 'bi_MM';
 ...
 {
    $('#SC_data_dia').bind('change', function() {sc_grid_comissao_valida_dia(this)});
    $('#SC_data_input_2_dia').bind('change', function() {sc_grid_comissao_valida_dia(this)});
    $('#SC_data_input_2_mes').bind('change', function() {sc_grid_comissao_valida_mes(this)});
    $('#SC_data_mes').bind('change', function() {sc_grid_comissao_valida_mes(this)});
 }
 function sc_grid_comissao_valida_dia(obj)
 {
 ...
 function sc_grid_comissao_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_cod_vend_cond'] = 'cond';
      $tp_fields['SC_cod_vend'] = 'select';
   ...
   function trata_campos()
   {
      global $cod_vend_cond, $cod_vend,
             $data_cond, $data, $data_dia, $data_mes, $data_ano, $data_input_2_dia, $data_input_2_mes, $data_input_2_ano, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['psq_check_ret']['cod_vend'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['cod_vend'] = $cod_vend; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['cod_vend_cond'] = $cod_vend_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_dia'] = $data_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_mes'] = $data_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_ano'] = $data_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2_dia'] = $data_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2_mes'] = $data_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2_ano'] = $data_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_cond'] = $data_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($data_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data'] = $val[0];
          ...
          if ($data_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']['data_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['cond_pesq'] .= $this->NM_operador;
