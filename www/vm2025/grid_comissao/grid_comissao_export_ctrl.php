<?php
@session_start() ;
$_SESSION['scriptcase']['grid_comissao']['sc_process_barr'] = true;
require_once('../grid_comissao/index.php');
unset($_SESSION['scriptcase']['grid_comissao']['sc_process_barr']);
$ExportCtrl = new grid_comissao_export_control;
$ExportCtrl->Export_barr();

class grid_comissao_export_control
{
