...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_comissao.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_comissao']['contr_erro'] = 'off'; 
   ...
   function NM_export_fob_tot()
   {
         ...
         $this->fob_tot = str_replace('<', '&lt;', $this->fob_tot);
         $this->fob_tot = str_replace('>', '&gt;', $this->fob_tot);
         $this->Texto_tag .= "<td>" . $this->fob_tot . "</td>\r\n";
   }
   //----- custototal
   function NM_export_custototal()
   {
         ...
         $this->custototal = str_replace('<', '&lt;', $this->custototal);
         $this->custototal = str_replace('>', '&gt;', $this->custototal);
         $this->Texto_tag .= "<td>" . $this->custototal . "</td>\r\n";
   }
   //----- valor_max
   function NM_export_valor_max()
   {
         ...
         $this->valor_max = str_replace('<', '&lt;', $this->valor_max);
         $this->valor_max = str_replace('>', '&gt;', $this->valor_max);
         $this->Texto_tag .= "<td>" . $this->valor_max . "</td>\r\n";
   }
   //----- valor_vendido
   function NM_export_valor_vendido()
   {
         ...
         $this->valor_vendido = str_replace('<', '&lt;', $this->valor_vendido);
         $this->valor_vendido = str_replace('>', '&gt;', $this->valor_vendido);
         $this->Texto_tag .= "<td>" . $this->valor_vendido . "</td>\r\n";
   }
   //----- subtotalvendido
   function NM_export_subtotalvendido()
   {
         ...
         $this->subtotalvendido = str_replace('<', '&lt;', $this->subtotalvendido);
         $this->subtotalvendido = str_replace('>', '&gt;', $this->subtotalvendido);
         $this->Texto_tag .= "<td>" . $this->subtotalvendido . "</td>\r\n";
   }
   //----- margcont
   function NM_export_margcont()
   {
         ...
         $this->margcont = str_replace('<', '&lt;', $this->margcont);
         $this->margcont = str_replace('>', '&gt;', $this->margcont);
         $this->Texto_tag .= "<td>" . $this->margcont . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comissao']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
