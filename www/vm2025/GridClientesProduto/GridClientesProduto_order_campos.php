...
<?php
   ...
   $Ord_Cmp = new GridClientesProduto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class GridClientesProduto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["empresa_email"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["empresa_email"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["empresa_email"] : "EMAIL";
   ...
   $tab_labels["empresa_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["empresa_empresa"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["empresa_empresa"] : "EMPRESA";
   ...
   $tab_labels["empresa_contato"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["empresa_contato"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["empresa_contato"] : "CONTATO";
   $tab_ger_campos['proposta_id'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_id'] = "proposta_id";
   }
   else
   {
       $tab_def_campos['proposta_id'] = "proposta.ID";
   }
   $tab_labels["proposta_id"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["proposta_id"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["proposta_id"] : "ORDEM";
   ...
   $tab_labels["proposta_natureza"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["proposta_natureza"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["proposta_natureza"] : "Natureza";
   ...
   $tab_labels["itemproposta_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["itemproposta_modelo"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["itemproposta_modelo"] : "MODELO";
   ...
   $tab_labels["marca_marca"]   = (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["marca_marca"])) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['labels']["marca_marca"] : "MARCA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "GridClientesProduto_order_campos.php",
    data: {
...
<div class="sc_ui_sortable-wrapper" id="sorting_list_ord_campos">
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['GridClientesProduto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
