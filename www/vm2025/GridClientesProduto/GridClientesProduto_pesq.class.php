...
class GridClientesProduto_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . GridClientesProduto_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . GridClientesProduto_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(GridClientesProduto_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . GridClientesProduto_pack_protect_string($Tipo_filter[0]) . "\">.." . GridClientesProduto_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
          if (isset($nmgp_save_origem) && $nmgp_save_origem == "grid")
          {
              $Ajax_select  = "<SELECT id=\"id_sel_recup_filters\" class=\"scFilterToolbar_obj\" name=\"sel_recup_filters\" onChange=\"nm_change_grid_search(this)\" size=\"1\">\r\n";
      ...
      if ($this->NM_ajax_opcao == 'autocomp_marca_marca')
      {
          $marca_marca = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_marca_marca($marca_marca);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $NM_cond = str_replace(array("##ini##","##fim##"), array("",""),$NM_cond);
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>GridClientesProduto/GridClientesProduto_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>GridClientesProduto/GridClientesProduto_switch.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="GridClientesProduto_ajax_search.js"></script>
 <script type="text/javascript" src="GridClientesProduto_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="GridClientesProduto_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_proposta_natureza_cond#NMF#' + search_get_sel_txt('SC_proposta_natureza_cond') + '@NMF@';
  str_out += 'SC_proposta_natureza#NMF#' + search_get_checkbox('SC_proposta_natureza') + '@NMF@';
  str_out += 'SC_marca_marca_cond#NMF#' + search_get_sel_txt('SC_marca_marca_cond') + '@NMF@';
  str_out += 'SC_marca_marca#NMF#' + search_get_text('SC_marca_marca') + '@NMF@';
  str_out += 'id_ac_marca_marca#NMF#' + search_get_title('select2-id_ac_marca_marca-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-marca_marca").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_marca_marca",
      max_itens: "10",
   ...
   $("#SC_marca_marca").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $proposta_natureza_cond, $proposta_natureza,
             $marca_marca_cond, $marca_marca, $marca_marca_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $proposta_natureza = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['proposta_natureza']; 
          $proposta_natureza_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['proposta_natureza_cond']; 
          $marca_marca = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['marca_marca']; 
          $marca_marca_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['marca_marca_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['NM_operador']; 
      } 
      if (!isset($proposta_natureza_cond) || empty($proposta_natureza_cond))
      {
         $proposta_natureza_cond = "eq";
      }
      if (!isset($marca_marca_cond) || empty($marca_marca_cond))
      {
         $marca_marca_cond = "eq";
      }
      ...
      $str_hide_proposta_natureza = (in_array($proposta_natureza_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_marca_marca = (in_array($marca_marca_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      // proposta_natureza
      if (is_array($proposta_natureza) && !empty($proposta_natureza))
      {
         $tmp_array = array();
         $proposta_natureza_val_str = "";
         foreach ($proposta_natureza as $tmp_val_cmp)
         {
            if ("" != $proposta_natureza_val_str)
            {
               $proposta_natureza_val_str .= ",";
            }
            ...
            $proposta_natureza_val_str .= "'$tmp_val_cmp'";
         }
         $proposta_natureza = $tmp_array;
      }
      else
      {
         $proposta_natureza_val_str = "''";
      }
      if (!isset($proposta_natureza) || $proposta_natureza == "")
      {
          $proposta_natureza = array();
      }
      if (!isset($marca_marca) || $marca_marca == "")
      {
          $marca_marca = "";
      }
      if (isset($marca_marca) && !empty($marca_marca))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_proposta_natureza_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['proposta_natureza'])) ? $this->New_label['proposta_natureza'] : "Natureza"; ?></TD>
      
      <INPUT type="hidden" id="SC_proposta_natureza_cond" name="proposta_natureza_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_proposta_natureza" <?php echo $str_hide_proposta_natureza?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['proposta_natureza'])) ? $this->New_label['proposta_natureza'] : "Natureza";
 $nmgp_tab_label .= "proposta_natureza?#?" . $SC_Label . "?@?";
...
<?php
  if (!isset($proposta_natureza)) {$proposta_natureza = explode(";", $proposta_natureza);}
 ?>
...
<INPUT class="scFilterObjectOdd" type="checkbox" id="SC_proposta_natureza" name="proposta_natureza[]" value="Proposta##@@Proposta"  <?php if (in_array("Proposta", $proposta_natureza))  { echo " checked" ;} ?><?php  if (empty($proposta_natureza)) { echo " checked" ;} ?>><span></span>Proposta</div>
</TD>
  <TD class="scFilterFieldFontOdd"><div class="sc switch">
<INPUT class="scFilterObjectOdd" type="checkbox" id="SC_proposta_natureza" name="proposta_natureza[]" value="Venda##@@Venda"  <?php if (in_array("Venda", $proposta_natureza))  { echo " checked" ;} ?><?php  if (empty($proposta_natureza)) { echo " checked" ;} ?>><span></span>Venda</div>
</TD>
</TR></TABLE>
      ...
      <TD id='SC_marca_marca_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['marca_marca'])) ? $this->New_label['marca_marca'] : "MARCA"; ?></TD>
      
      <INPUT type="hidden" id="SC_marca_marca_cond" name="marca_marca_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_marca_marca" <?php echo $str_hide_marca_marca?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['marca_marca'])) ? $this->New_label['marca_marca'] : "MARCA";
 $nmgp_tab_label .= "marca_marca?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $marca_marca;
      }
?>
<INPUT  type="text" id="SC_marca_marca" name="marca_marca" value="<?php echo NM_encode_input($marca_marca) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-marca_marca" id="id_ac_marca_marca" name="marca_marca_autocomp"><?php if ('' !=  $marca_marca) { ?><option value="<?php echo $marca_marca ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("GridClientesProduto_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['orig_pesq'] == "grid")
   {
...
?>
 ...
 Arr_def_proposta_natureza = new Array();
 Arr_def_proposta_natureza[0] = 'Proposta';
 Arr_def_proposta_natureza[1] = 'Venda';
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.proposta_natureza_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_proposta_natureza'), document.F1.proposta_natureza_cond, 'proposta_natureza');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'proposta_natureza[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   if (Arr_def_proposta_natureza[0]) {
       for (i = 0; i < document.F1.elements.length; i++) {
           if (document.F1.elements[i].name == 'proposta_natureza[]') {
               for (iz = 0; iz < Arr_def_proposta_natureza.length; iz++) {
                    Arr_def_test = Arr_def_proposta_natureza[iz] + "##@@"
   ...
   document.F1.marca_marca_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_marca_marca'), document.F1.marca_marca_cond, 'marca_marca');
   document.F1.marca_marca.value = "";
   document.F1.marca_marca_autocomp.value = "";
   $('#select2-id_ac_marca_marca-container').html('<?php echo $this->Val_init_marca_marca['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'];
      }
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_proposta_natureza_cond'] = 'cond';
      $tp_fields['SC_proposta_natureza'] = 'checkbox';
      $tp_fields['SC_marca_marca_cond'] = 'cond';
      $tp_fields['SC_marca_marca'] = 'text_aut';
      $tp_fields['id_ac_marca_marca'] = 'select2_aut';
   ...
   {
      global $proposta_natureza_cond, $proposta_natureza,
             $marca_marca_cond, $marca_marca, $marca_marca_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($marca_marca_autocomp) && empty($marca_marca))
      {
          $marca_marca = $marca_marca_autocomp;
      }
      $proposta_natureza_cond_salva = $proposta_natureza_cond; 
      if (!isset($proposta_natureza_input_2) || $proposta_natureza_input_2 == "")
      {
          $proposta_natureza_input_2 = $proposta_natureza;
      }
      $marca_marca_cond_salva = $marca_marca_cond; 
      if (!isset($marca_marca_input_2) || $marca_marca_input_2 == "")
      {
          $marca_marca_input_2 = $marca_marca;
      }
      if (is_array($proposta_natureza)) {
          foreach ($proposta_natureza as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['psq_check_ret']['proposta_natureza'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['proposta_natureza'] = $proposta_natureza; 
      if (is_array($proposta_natureza) && !empty($proposta_natureza))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['val'][0] = $proposta_natureza;
      }
      elseif ($proposta_natureza_cond_salva == "nu" || $proposta_natureza_cond_salva == "nn" || $proposta_natureza_cond_salva == "ep" || $proposta_natureza_cond_salva == "ne" || !empty($proposta_natureza))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['val'][0][0] = $proposta_natureza;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['proposta_natureza_cond'] = $proposta_natureza_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['cmp'] = "proposta_natureza"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['opc'] = $proposta_natureza_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']['proposta_natureza'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['marca_marca'] = $marca_marca; 
      if (is_array($marca_marca) && !empty($marca_marca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['val'][0] = $marca_marca;
      }
      elseif ($marca_marca_cond_salva == "nu" || $marca_marca_cond_salva == "nn" || $marca_marca_cond_salva == "ep" || $marca_marca_cond_salva == "ne" || !empty($marca_marca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['val'][0][0] = $marca_marca;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['marca_marca_cond'] = $marca_marca_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['cmp'] = "marca_marca"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid]['opc'] = $marca_marca_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']['marca_marca'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['proposta_natureza'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']['proposta_natureza'];
      $this->cmp_formatado['proposta_natureza_input_2'] = $proposta_natureza_input_2;
      $this->cmp_formatado['proposta_natureza'] = "'" . $this->cmp_formatado['proposta_natureza'] . "'";
      if (isset($this->cmp_formatado['proposta_natureza_input_2'])  && !empty($this->cmp_formatado['proposta_natureza_input_2'])) {
          $this->cmp_formatado['proposta_natureza_input_2'] = "'" . $this->cmp_formatado['proposta_natureza_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($marca_marca != '') {
      $marca_marca_look = (is_string($marca_marca) ? substr($this->Db->qstr($marca_marca), 1, -1) : $marca_marca); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['marca_marca'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['marca_marca'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['marca_marca'] = $marca_marca;
      }
      $this->cmp_formatado['marca_marca'] = "'" . $this->cmp_formatado['marca_marca'] . "'";
      if (isset($this->cmp_formatado['marca_marca_input_2'])  && !empty($this->cmp_formatado['marca_marca_input_2'])) {
          $this->cmp_formatado['marca_marca_input_2'] = "'" . $this->cmp_formatado['marca_marca_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      $proposta_natureza = $proposta_natureza; 
      $nm_aspas = "'";
      if ($proposta_natureza_cond == "nu" || $proposta_natureza_cond == "nn" || $proposta_natureza_cond == "ep" || $proposta_natureza_cond == "ne")
      {
          $proposta_natureza = array();
      }
      if (is_array($proposta_natureza) && count($proposta_natureza) != 0)
      {
         foreach ($proposta_natureza as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($proposta_natureza[$i]);
            }
         }
      }
      if (is_array($proposta_natureza) && count($proposta_natureza) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($proposta_natureza_cond == "df" || $proposta_natureza_cond == "np")
         {
             $this->comando        .= " proposta.natureza not in (";
             $this->comando_sum    .= " proposta.natureza not in (";
             $this->comando_filtro .= " proposta.natureza not in (";
         }
         else
         {
             $this->comando        .= " proposta.natureza in (";
             $this->comando_sum    .= " proposta.natureza in (";
             $this->comando_filtro .= " proposta.natureza in (";
         }
         $x                     = count($proposta_natureza);
         $xx                    = 0;
         $nm_cond               = "";
         $Lang_concat = ($proposta_natureza_cond == "df" || $proposta_natureza_cond == "np") ? $this->Ini->Nm_lang['lang_srch_and_cond'] : $this->Ini->Nm_lang['lang_srch_orr_cond'];
         foreach ($proposta_natureza as $i => $dados)
         {
            $tmp_pos = (is_string($dados)) ? strpos($dados, "##@@") : false;
            if ($tmp_pos === false)
            ...
            {
                 $cond_descr .= (empty($cond_descr)) ? "" : " " . $Lang_concat . " ";
                 $cond_descr .= $res_lookup;
                 $count_descr++;
            }
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($proposta_natureza) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$proposta_natureza_cond]) ? $Lang_descr[$proposta_natureza_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= $nmgp_tab_label['proposta_natureza'] . " " . $Lang_descr_final . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']['proposta_natureza']['label'] = $nmgp_tab_label['proposta_natureza'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']['proposta_natureza']['descr'] = $nmgp_tab_label['proposta_natureza'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']['proposta_natureza']['hint'] = $nmgp_tab_label['proposta_natureza'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($proposta_natureza) && ($proposta_natureza_cond == "nu" || $proposta_natureza_cond == "nn" || $proposta_natureza_cond == "ep" || $proposta_natureza_cond == "ne"))
      {
         $this->monta_condicao("proposta.natureza", $proposta_natureza_cond, "", "", "proposta_natureza", "VARCHAR", false);
      }

      //----- $marca_marca
      $this->Date_part = false;
      if (isset($marca_marca) || $marca_marca_cond == "nu" || $marca_marca_cond == "nn" || $marca_marca_cond == "ep" || $marca_marca_cond == "ne")
      {
         $this->monta_condicao("marca.MARCA", $marca_marca_cond, $marca_marca, "", "marca_marca", "CHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'] .= $this->NM_operador;
