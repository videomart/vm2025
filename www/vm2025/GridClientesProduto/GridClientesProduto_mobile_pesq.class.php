...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "proposta_id";$Nm_numeric[] = "proposta_id";
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_proposta_natureza"  <?php echo $str_hide_proposta_natureza?>> 
<?php
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_marca_marca"  <?php echo $str_hide_marca_marca?>><?php
      if ($marca_marca != "")
      {
      $marca_marca_look = (is_string($marca_marca) ? substr($this->Db->qstr($marca_marca), 1, -1) : $marca_marca); 
      $nmgp_def_dados = array(); 
