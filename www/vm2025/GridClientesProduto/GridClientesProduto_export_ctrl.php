<?php
@session_start() ;
$_SESSION['scriptcase']['GridClientesProduto']['sc_process_barr'] = true;
require_once('../GridClientesProduto/index.php');
unset($_SESSION['scriptcase']['GridClientesProduto']['sc_process_barr']);
$ExportCtrl = new GridClientesProduto_export_control;
$ExportCtrl->Export_barr();

class GridClientesProduto_export_control
{
