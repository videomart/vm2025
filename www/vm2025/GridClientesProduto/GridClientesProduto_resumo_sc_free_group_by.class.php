...
class GridClientesProduto_resumo
{
   ...
   var $array_total_empresa_email;
   var $array_total_itemproposta_modelo;
   var $array_total_marca_marca;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_empresa_email       = array();
      $this->array_total_itemproposta_modelo = array();
      $this->array_total_marca_marca         = array();
   ...
   if ($this->Ini->Embutida_iframe) {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'empresa.EMAIL' => [
                    'label' => "EMAIL",
                    'datatype' => 'varchar',
                    'lowercase' => 'empresa_email',
                    'summary_values_array' => 'array_total_empresa_email',
                    'summary_line_values_array' => 'array_line_empresa_email',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'empresa_email',
                ...
                'itemproposta.MODELO' => [
                    'label' => "MODELO",
                    'datatype' => 'varchar',
                    'lowercase' => 'itemproposta_modelo',
                    'summary_values_array' => 'array_total_itemproposta_modelo',
                    'summary_line_values_array' => 'array_line_itemproposta_modelo',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'itemproposta_modelo',
                    'link_protect_string' => '@aspass@',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
                'marca.MARCA' => [
                    'label' => "MARCA",
                    'datatype' => 'char',
                    'lowercase' => 'marca_marca',
                    'summary_values_array' => 'array_total_marca_marca',
                    'summary_line_values_array' => 'array_line_marca_marca',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'marca_marca',
                    'link_protect_string' => '@aspass@',
                    'has_order' => true,
                    'limit_chart_items' => '0',
                ],
            ...
            'metric' => [
                'empresa_email-C' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_empresa_email_C',
                    'css_class' => "css_empresa_email_cnt_field",
                ...
                'itemproposta_modelo-C' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_itemproposta_modelo_C',
                    'css_class' => "css_itemproposta_modelo_cnt_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => true,
                ],
                'marca_marca-C' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_marca_marca_C',
                    'css_class' => "css_marca_marca_cnt_field",
                    'show_percentuals' => false,
                    'show_percentuals_below' => false,
                    'has_order' => true,
                ],
            ...
            'dimension_by_lowercase' => [
                ...
                'itemproposta_modelo' => 'itemproposta.MODELO',
                'marca_marca' => 'marca.MARCA',
            ],
            'metric_by_index' => [
                2 => 'empresa_email-C',
                3 => 'itemproposta_modelo-C',
                4 => 'marca_marca-C',
            ],
            'chart' => [
                'empresa.EMAIL' => [
            ...
            'options' => [
                ...
                'display_summary_pos_every_page' => false,
                'display_summary_pos_last_page' => false,
                'display_summary_pos_another_page' => true,
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_group_by'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_x_axys'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_y_axys'] = [];

        $dimensionCount = 0;

        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_x_axys'] [] = $dimensionCount;
        ...
        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_y_axys'] [] = $dimensionCount;

            $dimensionCount++;
        }

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['dimension_order'] = [];
        foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
        }
    }

    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['heatmap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['treemap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chord_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['sankey_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['sunburst_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        if (!empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['SC_Gb_Free_cmp']) && empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_x_axys']) && empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_y_axys'])) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            ...
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
                ...
                $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;
                if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order_direction'] [$dimensionIndex]) || empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order_direction'] [$dimensionIndex])) {
                    $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order_direction'] [$dimensionIndex] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction_default'];
                }
                $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_order_direction'] [$dimensionIndex];

                if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_x_axys'])) {
                    $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
                }
                if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_y_axys'])) {
                    $this->SC_APP_info['group_by'] ['dimension'] ['y'] [] = $dimensionName;
                }
        ...
        foreach ($this->SC_APP_info['metric_by_index'] as $metricIndex => $metricName) {
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex])) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] = ['display' => false];
            }
        }
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_record_count'];
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length'];
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summary_cache']);
        }
    }
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}GridClientesProduto/index.php";
...
SCEOT;
    ...
    let windowName = "GridClientesProduto_chart_window" + (Math.floor(Math.random() * 100) + 1);
...
SCEOT;
    ...
    function display_pdf_charts()
    {
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_level']) {
                continue;
            }
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($chartInfo['info_type'] != $chartInfoType) {
                continue;
            } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_level']) {
                continue;
            }

            if ($this->progress_fp) {
                GridClientesProduto_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            GridClientesProduto_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...\n", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChartAppCharts()
    {
        ...
        if (1 < count($this->SC_APP_info['group_by'] ['metric'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['graf_opc_atual'] = 2;
        } else {
        ...
        foreach ($this->SC_APP_data['ordered_y_matrix'] as $rowDimensionInfo) {
            ...
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summarizing_drill_down']) || !$_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['summarizing_drill_down']) {
                continue;
            }
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_md5_list'] = $this->SC_APP_data['chart_md5_list'];
    ...
    function aux_addChartAppGrandTotalChart()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@GridClientesProduto@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['skip_charts']) {
            return false;
    ...
    function aux_format_empresa_email_C($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_format_itemproposta_modelo_C($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_format_marca_marca_C($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['GridClientesProduto'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['GridClientesProduto'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['GridClientesProduto'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        switch ($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['cfg_graf'] ['graf_tipo']) {
            case 'Chord':
                return 'chord_info';
            case 'Heatmap':
                return 'heatmap_info';
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['opcao']) {
            return true;
        }
    ...
    {
        return $this->aux_isPdf() && $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['skip_summary'];
    }
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['comb_table_def'] = [
            'field' => [],
            'label' => [],
            'summ' => [],
        ];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['comb_table_data'] = [];

        foreach ($this->SC_APP_info['group_by'] ['metric'] as $i => $metricName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['comb_table_def'] ['field'] [] = $metricName;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['comb_table_def'] ['label'] [] = $this->SC_APP_info['metric'] [$metricName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['comb_table_def'] ['summ'] [] = $i;
        }

        $this->aux_storeSummaryTableInfo_recursive($_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['comb_table_data'], $this->SC_APP_data['ordered_y_axys'], 0, []);
    }
...
SCEOT;
    ...
    function generateChartImages()
    {
        ...
        $chartInfoType = $this->aux_getChartInfoType();
        $chartList = $_SESSION['sc_session'] [$this->Ini->sc_page] ['GridClientesProduto'] ['chart_md5_list'];
        $chartFiles = array();

        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['phantomjs_export_process'] = true;
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_step']     = 'image';
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_count']    = 0;
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_total']    = 0;
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_total']++;
            }
        }
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['phantomjs_export_file'] = '';
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_count']++;
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['phantomjs_export_process'] = false;
    ...
    function zipChartImages($password = '')
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_step'] = 'zip';

        $this->writeProgressFile();

        $zipFile = $this->zipFileList($chartImages, $password);

        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_step'] = 'end';
    ...
    function zipFileList($fileList, $password = '') {
        $tempDir = $this->Ini->root . $_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_imag_temp'] . '/';
    ...
    function writeProgressFile() {
        if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_total']}###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_step']) {
            $content = "ok###100";
        } else {
            $content = "init###0";
        }

        $f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['export_progress_file']}", 'w');
        fwrite($f, $content);
        fclose($f);
    }
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_empresa_email = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total_line']['empresa_email'];
                $this->array_line_itemproposta_modelo = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total_line']['itemproposta_modelo'];
                $this->array_line_marca_marca = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total_line']['marca_marca'];
            }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total'][$cmp_gb];
          }
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_empresa_email = array();
                $this->array_total_itemproposta_modelo = array();
                $this->array_total_marca_marca = array();
                $this->totaliza();
                ...
                $this->array_line_empresa_email = $this->array_total_empresa_email;
                $this->array_line_itemproposta_modelo = $this->array_total_itemproposta_modelo;
                $this->array_line_marca_marca = $this->array_total_marca_marca;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_clear_total'] = true;
            }
          $this->array_total_empresa_email = array();
          $this->array_total_itemproposta_modelo = array();
          $this->array_total_marca_marca = array();
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total']['empresa_email'] = $this->array_total_empresa_email;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total']['itemproposta_modelo'] = $this->array_total_itemproposta_modelo;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total']['marca_marca'] = $this->array_total_marca_marca;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total_line']['empresa_email'] = $this->array_line_empresa_email;
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total_line']['itemproposta_modelo'] = $this->array_line_itemproposta_modelo;
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total_line']['marca_marca'] = $this->array_line_marca_marca;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['json_use_label'])
       {
          $Lab_empresa_email = "empresa.EMAIL";
          $Lab_itemproposta_modelo = "itemproposta.MODELO";
          $Lab_marca_marca = "marca.MARCA";
       }
       else
       {
       $Lab_empresa_email = "EMAIL";
       $Lab_itemproposta_modelo = "MODELO";
       $Lab_marca_marca = "MARCA";
       }
       $prep_field = array();
       $prep_field['empresa_email'] = $Lab_empresa_email;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_email'] = $Lab_empresa_email; 
       $prep_field['itemproposta_modelo'] = $Lab_itemproposta_modelo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['itemproposta_modelo'] = $Lab_itemproposta_modelo; 
       $prep_field['marca_marca'] = $Lab_marca_marca;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['marca_marca'] = $Lab_marca_marca; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_email'] = "EMAIL"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_empresa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_empresa'] = "EMPRESA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_contato']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_contato'] = "CONTATO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['proposta_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['proposta_id'] = "ORDEM"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['proposta_natureza']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['proposta_natureza'] = "Natureza"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['itemproposta_modelo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['itemproposta_modelo'] = "MODELO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['marca_marca']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['marca_marca'] = "MARCA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['produto_descricao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['produto_descricao'] = "DESCRICAO"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "EMAIL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
           3 => "MODELO (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
           4 => "MARCA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "empresa_email", 'show' => true),
           3 => array('field' => "itemproposta_modelo", 'show' => true),
           4 => array('field' => "marca_marca", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_empresa_email_cnt",
           3 => "css_itemproposta_modelo_cnt",
           4 => "css_marca_marca_cnt",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "empresa_email_cnt",
           3 => "itemproposta_modelo_cnt",
           4 => "marca_marca_cnt",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['empresa_email']['alin'] = "''";
       $Arr_parms['empresa_email']['link'] = "S";
       $Arr_parms['itemproposta_modelo']['alin'] = "''";
       $Arr_parms['itemproposta_modelo']['link'] = "S";
       $Arr_parms['marca_marca']['alin'] = "''";
       $Arr_parms['marca_marca']['link'] = "S";
       $Arr_parms['empresa_email']['fill'] = "true";
       $Arr_parms['empresa_email']['order'] = "label";
       $Arr_parms['empresa_email']['order_start'] = 'asc';
       $Arr_parms['empresa_email']['order_invert'] = 'false';
       $Arr_parms['empresa_email']['order_enabled'] = 'true';
       $Arr_parms['empresa_email']['order_datatype'] = 'varchar';
       $Arr_parms['empresa_email']['rating_function'] = '';
       $Arr_parms['itemproposta_modelo']['fill'] = "true";
       $Arr_parms['itemproposta_modelo']['order'] = "label";
       $Arr_parms['itemproposta_modelo']['order_start'] = 'asc';
       $Arr_parms['itemproposta_modelo']['order_invert'] = 'false';
       $Arr_parms['itemproposta_modelo']['order_enabled'] = 'true';
       $Arr_parms['itemproposta_modelo']['order_datatype'] = 'varchar';
       $Arr_parms['itemproposta_modelo']['rating_function'] = '';
       $Arr_parms['marca_marca']['fill'] = "true";
       $Arr_parms['marca_marca']['order'] = "label";
       $Arr_parms['marca_marca']['order_start'] = 'asc';
       $Arr_parms['marca_marca']['order_invert'] = 'false';
       $Arr_parms['marca_marca']['order_enabled'] = 'true';
       $Arr_parms['marca_marca']['order_datatype'] = 'char';
       $Arr_parms['marca_marca']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['empresa_email'] = array(0 => 'empresa_email', 1 => '@aspass@');
       $prep_links_fl['itemproposta_modelo'] = array(0 => 'itemproposta_modelo', 1 => '@aspass@');
       $prep_links_fl['marca_marca'] = array(0 => 'marca_marca', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@GridClientesProduto@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'empresa_email' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("EMAIL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'empresa_email',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_empresa_email)),
               'label_y'  => $this->getChartText(strip_tags("EMAIL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
               'title'    => $this->getChartText(strip_tags("MODELO (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'empresa_email',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_empresa_email)),
               'label_y'  => $this->getChartText(strip_tags("MODELO (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '3' => array(
               'title'    => $this->getChartText(strip_tags("MARCA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'empresa_email',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_empresa_email)),
               'label_y'  => $this->getChartText(strip_tags("MARCA (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(3),
           ),
           ),
           'itemproposta_modelo' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("EMAIL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'itemproposta_modelo',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_itemproposta_modelo)),
               'label_y'  => $this->getChartText(strip_tags("EMAIL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'marca_marca',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_marca_marca)),
               'label_y'  => $this->getChartText(strip_tags("EMAIL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['anlt_table_def']  = array();
       ...
       foreach ($this->comp_chart_data as $sChartKey => $aChartData)
       {
        ...
        function filterChartsByGroupbyLevel() {
                ...
                if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['chart_level']) {
                        $applyFilter = true;
                }
                elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
                        $applyFilter = true;
                        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['chart_level'] = $_POST['chart_level'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_orig'];

                if ($applyFilter) {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts'] as $chartIndex => $chartData) {
                                ...
                                if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['chart_level']) {
                                        unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts'][$chartIndex]);
                                }
                        }
                }

                $this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts'];
        }
        ...
        function filterChartsBySummarization() {
                ...
                if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
                        ...
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_GridClientesProduto_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_GridClientesProduto_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
          require_once($this->Ini->path_aplicacao . "GridClientesProduto_total.class.php"); 
      }
      ...
      $this->Total   = new GridClientesProduto_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['LigR_Md5'] = array();
   }
   ...
   function totaliza($tipo='')
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 1, $tipo);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo_search'] . ")"; 
               }
          }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['arr_total'][$cmp_gb];
      }
      ...
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][2];
      $this->array_total_geral[1][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][3];
      $this->array_total_geral[1][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][4];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][2];
          $this->array_total_geral[2][1] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][3];
          $this->array_total_geral[2][2] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][4];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE html>\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav']) {  
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_switch.css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_GridClientesProduto_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_GridClientesProduto_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_GridClientesProduto_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'] && !$this->aux_isPdf())
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && !$this->aux_isPdf())
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=pt_br&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=GridClientesProduto&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=GridClientesProduto&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_graf_flash.php?nome_apl=GridClientesProduto&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "", "", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("GridClientesProduto_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'GridClientesProduto_config_pivot.php?nome_apl=GridClientesProduto&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"GridClientesProduto_iframe.php\";\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_GridClientesProduto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $marca_marca = (isset($Busca_temp['marca_marca'])) ? $Busca_temp['marca_marca'] : ""; 
          $tmp_pos = (is_string($marca_marca)) ? strpos($marca_marca, "##@@") : false;
          if ($tmp_pos !== false && !is_array($marca_marca))
          {
              $marca_marca = substr($marca_marca, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($cnt_empresa_email, $cnt_itemproposta_modelo, $cnt_marca_marca, $quebra_empresa_email, $quebra_itemproposta_modelo, $quebra_marca_marca, $quebra_empresa_email_orig, $quebra_itemproposta_modelo_orig, $quebra_marca_marca_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($cnt_empresa_email)) {$cnt_empresa_email = '0';}
          if (empty($cnt_itemproposta_modelo)) {$cnt_itemproposta_modelo = '0';}
          if (empty($cnt_marca_marca)) {$cnt_marca_marca = '0';}
          eval ('
            ...
            if (isset($contr_cmp_gb[1]))
            {
               ...
               foreach ($arr_name_1 as $cmp_name_1  => $dados_gb)
               {
                  ...
                  if (!empty($ind_missing)) {
                      ...
                      $arr_name_1[$cmp_name_1][$ind_missing][2] = 0;
                      $arr_name_1[$cmp_name_1][$ind_missing][3] = 0;
                      $arr_name_1[$cmp_name_1][$ind_missing][4] = $dados_gb[$ind_exists][4];
                      $arr_name_1[$cmp_name_1][$ind_missing][5] = $dados_gb[$ind_exists][5];
                  ...
                  if (isset($contr_cmp_gb[2]))
                  {
                     ...
                     foreach ($arr_name_2 as $cmp_name_2  => $dados_gb)
                     {
                        ...
                        if (!empty($ind_missing)) {
                            ...
                            $arr_name_2[$cmp_name_2][$ind_missing][2] = 0;
                            $arr_name_2[$cmp_name_2][$ind_missing][3] = 0;
                            $arr_name_2[$cmp_name_2][$ind_missing][4] = $dados_gb[$ind_exists][4];
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->marca_marca = $Busca_temp['marca_marca']; 
       $this->marca_marca = (isset($Busca_temp['marca_marca'])) ? $Busca_temp['marca_marca'] : ""; 
       $tmp_pos = (is_string($this->marca_marca)) ? strpos($this->marca_marca, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->marca_marca))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->empresa_email = $rs_res->fields[0] ;  
            $this->empresa_empresa = $rs_res->fields[1] ;  
            $this->empresa_contato = $rs_res->fields[2] ;  
            $this->proposta_id = $rs_res->fields[3] ;  
            $this->proposta_natureza = $rs_res->fields[4] ;  
            $this->itemproposta_modelo = $rs_res->fields[5] ;  
            $this->marca_marca = $rs_res->fields[6] ;  
            $this->empresa_email_orig = $this->empresa_email;
            $this->itemproposta_modelo_orig = $this->itemproposta_modelo;
            $this->marca_marca_orig = $this->marca_marca;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->empresa_email, $this->itemproposta_modelo, $this->marca_marca, $this->empresa_email, $this->itemproposta_modelo, $this->marca_marca, $this->empresa_email_orig,  $this->itemproposta_modelo_orig,  $this->marca_marca_orig);
            }
   }
//
