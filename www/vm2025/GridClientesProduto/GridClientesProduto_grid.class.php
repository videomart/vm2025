<?php
class GridClientesProduto_grid
{
   var $Ini;
   var $Erro;
   var $Db;
   ...
   var $progress_graf;
   var $count_ger;
   var $cnt_empresa_email;
   var $cnt_itemproposta_modelo;
   var $cnt_marca_marca;
   var $empresa_email_Old;
   var $arg_sum_empresa_email;
   var $Label_empresa_email;
   var $sc_proc_quebra_empresa_email;
   var $count_empresa_email;
   var $cnt_empresa_email_empresa_email;
   var $cnt_empresa_email_itemproposta_modelo;
   var $cnt_empresa_email_marca_marca;
   var $itemproposta_modelo_Old;
   var $arg_sum_itemproposta_modelo;
   var $Label_itemproposta_modelo;
   var $sc_proc_quebra_itemproposta_modelo;
   var $count_itemproposta_modelo;
   var $cnt_itemproposta_modelo_empresa_email;
   var $cnt_itemproposta_modelo_itemproposta_modelo;
   var $cnt_itemproposta_modelo_marca_marca;
   var $marca_marca_Old;
   var $arg_sum_marca_marca;
   var $Label_marca_marca;
   var $sc_proc_quebra_marca_marca;
   var $count_marca_marca;
   var $cnt_marca_marca_empresa_email;
   var $cnt_marca_marca_itemproposta_modelo;
   var $cnt_marca_marca_marca_marca;
   var $empresa_email;
   var $empresa_empresa;
   var $empresa_contato;
   var $proposta_id;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   { 
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "GridClientesProduto/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new GridClientesProduto_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
    if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false) {
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print')
       { 
       $nm_saida->saida("     <TR>\r\n");
       $nm_saida->saida("      <TD id=\"div_refin_search\" class=\"scGridRefinedSearchPadding\" valign='top'>\r\n");
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'])
           { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'])
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['refresh_interativ']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['refresh_interativ'] == "S") {
                   $this->Ini->Arr_result['setValue'][] = array('field' => 'div_refin_search', 'value' => NM_charset_to_utf8($_SESSION['scriptcase']['saida_html']));
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['refresh_interativ']);
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       } 
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['GridClientesProduto'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       $descr_refin = "";
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']))
       { 
           $display_tag_interativ = "";
           $descr_refin = "<div class='scGridFilterTagList'>";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search'] as $fil => $dados_fil) {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new GridClientesProduto_grafico();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['graf_pdf'] == "S")
       { 
           if (isset($_GET['flash_graf']) && 'pdf' == $_GET['flash_graf'] && $Gera_graf)
           {
               $this->grafico_pdf_flash();
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "grid";
           } 
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf")
           { 
               $flag_apaga_pdf_log = FALSE;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "igual";
           } 
           $this->nm_fim_grid($flag_apaga_pdf_log);
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("pt_br");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label'] .= "proposta_natureza?#?" . "Natureza" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label'] .= "marca_marca?#?" . "MARCA" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search_aut_comp']))
   {
       $Cmp_select2 = array("marca_marca");
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search_aut_comp']['cmp'];
       ...
       foreach ($nmgp_def_dados as $Ind => $Lista)
       {
          if (is_array($Lista))
          {
              foreach ($Lista as $Cod => $Valor)
              {
                  ...
                  if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search_aut_comp']['cmp'], $Cmp_select2))
                  {
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['mostra_edit'] = "N";
   }
   $this->sc_proc_quebra_empresa_email = false;
   $this->sc_proc_quebra_itemproposta_modelo = false;
   $this->sc_proc_quebra_marca_marca = false;
   $this->NM_cont_body   = 0; 
   $this->NM_emb_tree_no = false; 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("GridClientesProduto", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['empresa_email'] = " asc";
   $this->Cmps_ord_def['empresa_empresa'] = " asc";
   $this->Cmps_ord_def['empresa_contato'] = " asc";
   $this->Cmps_ord_def['proposta_id'] = " asc";
   $this->Cmps_ord_def['proposta_natureza'] = " asc";
   $this->Cmps_ord_def['itemproposta_modelo'] = " asc";
   $this->Cmps_ord_def['marca_marca'] = " asc";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'];
       ...
       $this->marca_marca = (isset($Busca_temp['marca_marca'])) ? $Busca_temp['marca_marca'] : ""; 
       $tmp_pos = (is_string($this->marca_marca)) ? strpos($this->marca_marca, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->marca_marca))
       {
           $this->marca_marca = substr($this->marca_marca, 0, $tmp_pos);
       }
   } 
   $this->nm_field_dinamico = array();
   $this->nm_order_dinamico = array();
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['GridClientesProduto'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['GridClientesProduto'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "GridClientesProduto/GridClientesProduto_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "GridClientesProduto_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new GridClientesProduto_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['rows'];  
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['rows']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               foreach ($resto as $SC_Sql_col => $SC_Sql_order)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!$GLOBALS['nm_restore_grid_save'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['prim_cons'] || !empty($nmgp_parms)) )  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'] = "";
   }   
   $GLOBALS['nm_restore_grid_save'] = false;
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   $this->cnt_empresa_email = 0;
   $this->cnt_itemproposta_modelo = 0;
   $this->cnt_marca_marca = 0;
   $this->arg_sum_empresa_email = "";
   $this->count_empresa_email = 0;
   $this->cnt_empresa_email_empresa_email = 0;
   $this->cnt_empresa_email_itemproposta_modelo = 0;
   $this->cnt_empresa_email_marca_marca = 0;
   $this->arg_sum_itemproposta_modelo = "";
   $this->count_itemproposta_modelo = 0;
   $this->cnt_itemproposta_modelo_empresa_email = 0;
   $this->cnt_itemproposta_modelo_itemproposta_modelo = 0;
   $this->cnt_itemproposta_modelo_marca_marca = 0;
   $this->arg_sum_marca_marca = "";
   $this->count_marca_marca = 0;
   $this->cnt_marca_marca_empresa_email = 0;
   $this->cnt_marca_marca_itemproposta_modelo = 0;
   $this->cnt_marca_marca_marca_marca = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['contr_array_resumo'] = "NAO";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['using_summary_cache']);
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1];
   ...
   { 
       ...
       $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq']; 
       if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'])) 
       { 
           $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo']; 
       } 
       else
       { 
           $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo'] . ")"; 
       } 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = 0; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'];
   }
//----- 
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT empresa.EMAIL as empresa_email, empresa.EMPRESA as empresa_empresa, empresa.CONTATO as empresa_contato, proposta.ID as proposta_id, proposta.natureza as proposta_natureza, itemproposta.MODELO as itemproposta_modelo, marca.MARCA as marca_marca from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT empresa.EMAIL as empresa_email, empresa.EMPRESA as empresa_empresa, empresa.CONTATO as empresa_contato, proposta.ID as proposta_id, proposta.natureza as proposta_natureza, itemproposta.MODELO as itemproposta_modelo, marca.MARCA as marca_marca from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->empresa_email = $this->rs_grid->fields[0] ;  
       $this->empresa_empresa = $this->rs_grid->fields[1] ;  
       $this->empresa_contato = $this->rs_grid->fields[2] ;  
       $this->proposta_id = $this->rs_grid->fields[3] ;  
       $this->proposta_id = (string)$this->proposta_id;
       $this->proposta_natureza = $this->rs_grid->fields[4] ;  
       $this->itemproposta_modelo = $this->rs_grid->fields[5] ;  
       $this->marca_marca = $this->rs_grid->fields[6] ;  
       if (!isset($this->empresa_email)) { $this->empresa_email = ""; }
       if (!isset($this->itemproposta_modelo)) { $this->itemproposta_modelo = ""; }
       if (!isset($this->marca_marca)) { $this->marca_marca = ""; }
       $this->arg_sum_empresa_email = " = " . $this->Db->qstr($this->empresa_email);
       $this->arg_sum_itemproposta_modelo = " = " . $this->Db->qstr($this->itemproposta_modelo);
       $this->arg_sum_marca_marca = " = " . $this->Db->qstr($this->marca_marca);
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['GridClientesProduto']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
<!DOCTYPE html>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               GridClientesProduto_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               GridClientesProduto_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               GridClientesProduto_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               GridClientesProduto_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               GridClientesProduto_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/scriptcase__NM__ico__NM__favicon.ico\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"GridClientesProduto_jquery_2237.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"GridClientesProduto_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"GridClientesProduto_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {  
...
foreach ($this->Ini->tippy_themes as $tippyTheme => $tippyThemeInfo) {
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-GridClientesProduto-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-GridClientesProduto-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-GridClientesProduto-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-GridClientesProduto-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-39b380ef\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_GridClientesProduto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_GridClientesProduto_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_GridClientesProduto_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf") {
       ...
       $nm_saida->saida("  <style type=\"text/css\">\r\n");
       $nm_saida->saida("  </style>\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_switch.css\" />\r\n");
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".GridClientesProduto_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .GridClientesProduto_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".GridClientesProduto_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida    = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['css_body_embutida'] : "";
   $this->css_remove_margin     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['link_info']['remove_margin']))     ? "margin: 0;" : "";
   $this->css_remove_border     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['link_info']['remove_border']))     ? "border-width: 0;" : "";
   $this->css_remove_background = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['link_info']['remove_background'])) ? "background-color: transparent; background-image: none;" : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && !$this->Print_All && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pdf_res'])
               ...
               {
                   $groupByLabel = sprintf("EMAIL", "empresa.EMAIL");
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['GridClientesProduto']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['GridClientesProduto']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['GridClientesProduto']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['GridClientesProduto']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) ? "GridClientesProduto_" : "";
   $this->css_sep = " ";
   ...
   $this->css_proposta_id_label = $compl_css_emb . "css_proposta_id_label";
   $this->css_proposta_id_grid_line = $compl_css_emb . "css_proposta_id_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_GridClientesProduto__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-GridClientesProduto-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_marca_marca_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_marca_marca_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf") {
       $classColFld = "";
       $classColTitle = "";
       $classColActions = "";
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . " sc-col-actionbar-left  " . $classColFld . $classColTitle . $classColActions . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_marca_marca_label'] . "\" >\r\n");
   $nm_saida->saida("<style>\r\n");
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".GridClientesProduto_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_empresa_email_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_empresa_email_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_empresa_email_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
            ...
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_empresa_email_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_empresa_empresa_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_empresa_empresa_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_empresa_empresa_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_empresa_empresa_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_empresa_contato_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_empresa_contato_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_empresa_contato_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_empresa_contato_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_proposta_id()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['proposta_id'])) ? $this->New_label['proposta_id'] : "ORDEM";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['proposta_id']) || $this->NM_cmp_hidden['proposta_id'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_proposta_id_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_proposta_id_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "proposta_id";
        $fieldSortRule = $this->scGetColumnOrderRule($NM_cmp_class);
        $fieldSortIcon = $this->scGetColumnOrderIcon($NM_cmp_class, $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_proposta_id_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_proposta_id_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_proposta_natureza()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_proposta_natureza_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_proposta_natureza_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $NM_cmp_class = "proposta_natureza";
        $fieldSortRule = $this->scGetColumnOrderRule($NM_cmp_class);
        $fieldSortIcon = $this->scGetColumnOrderIcon($NM_cmp_class, $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_proposta_natureza_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_proposta_natureza_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_itemproposta_modelo()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_itemproposta_modelo_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_itemproposta_modelo_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
 ...
 function NM_label_marca_marca()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_marca_marca_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_marca_marca_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['empresa_email'])) ? $this->New_label['empresa_email'] : "EMAIL";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['empresa_empresa'])) ? $this->New_label['empresa_empresa'] : "EMPRESA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['empresa_contato'])) ? $this->New_label['empresa_contato'] : "CONTATO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['empresa_contato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['proposta_id'])) ? $this->New_label['proposta_id'] : "ORDEM";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['proposta_id'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['proposta_natureza'])) ? $this->New_label['proposta_natureza'] : "Natureza";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['proposta_natureza'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['itemproposta_modelo'])) ? $this->New_label['itemproposta_modelo'] : "MODELO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['itemproposta_modelo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['marca_marca'])) ? $this->New_label['marca_marca'] : "MARCA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['labels']['marca_marca'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['GridClientesProduto']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_GridClientesProduto#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_GridClientesProduto#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-39b380ef\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['empresa_email'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['empresa_email'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['itemproposta_modelo'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['itemproposta_modelo'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['marca_marca'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['marca_marca'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   $this->SC_bot[]     = "empresa_email"; 
   $this->SC_top[]     = "empresa_email"; 
   $this->SC_bot[]     = "itemproposta_modelo"; 
   $this->SC_top[]     = "itemproposta_modelo"; 
   $this->SC_bot[]     = "marca_marca"; 
   $this->SC_top[]     = "marca_marca"; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       $Nivel_gb = 1;
       $this->Tab_Nv_tree = array();
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']);
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  GridClientesProduto_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_marca_marca = " = " . $this->Db->qstr($this->marca_marca);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_marca_marca_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_marca_marca_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['mostra_edit'] != "N"){ 
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->empresa_email . "*PDet*" . $this->empresa_empresa . "*PDet*" . $this->empresa_contato . "*PDet*" . $this->proposta_id . "*PDet*" . $this->proposta_natureza . "*PDet*" . $this->itemproposta_modelo . "*PDet*" . $this->marca_marca . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@GridClientesProduto@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "GridClientesProduto/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=GridClientesProduto&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "GridClientesProduto/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=GridClientesProduto&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['mostra_edit'] == "N"){ 
          ...
          $nm_saida->saida("</TD>\r\n");
 $this->grid_fixed_column_no++;} 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_empresa_email()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['empresa_email']) || $this->NM_cmp_hidden['empresa_email'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'empresa_email', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'empresa_email', $str_tem_display, $conteudo_original); 
          } 
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_empresa_email_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_empresa_email_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_empresa_email_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_empresa_empresa()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['empresa_empresa']) || $this->NM_cmp_hidden['empresa_empresa'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'empresa_empresa', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_empresa_empresa_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_empresa_empresa_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_empresa_empresa_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_empresa_contato()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['empresa_contato']) || $this->NM_cmp_hidden['empresa_contato'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'empresa_contato', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_empresa_contato_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_empresa_contato_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_empresa_contato_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_proposta_id()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['proposta_id']) || $this->NM_cmp_hidden['proposta_id'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->proposta_id));
              $conteudo_original = NM_encode_input(sc_strip_script($this->proposta_id));
          }
          else {
              $conteudo = sc_strip_script($this->proposta_id); 
              $conteudo_original = sc_strip_script($this->proposta_id); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'proposta_id', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'proposta_id', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_proposta_id_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_proposta_id_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_proposta_id_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_proposta_natureza()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['proposta_natureza']) || $this->NM_cmp_hidden['proposta_natureza'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'proposta_natureza', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_proposta_natureza_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_proposta_natureza_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_proposta_natureza_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_itemproposta_modelo()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['itemproposta_modelo']) || $this->NM_cmp_hidden['itemproposta_modelo'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'itemproposta_modelo', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_itemproposta_modelo_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_itemproposta_modelo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_itemproposta_modelo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_marca_marca()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['marca_marca']) || $this->NM_cmp_hidden['marca_marca'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'marca_marca', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_inherit_bg . ' ' . $this->css_line_fonf . $this->css_sep . $this->css_marca_marca_grid_line . " " . $classColFld . "\"  style=\"" . $this->Css_Cmp['css_marca_marca_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_marca_marca_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 }
 function quebra_empresa_email_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   $this->sc_proc_quebra_itemproposta_modelo = false;
   $this->sc_proc_quebra_marca_marca = false;
   $this->sc_proc_quebra_empresa_email = true; 
   $this->Tot->quebra_empresa_email_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_empresa_email = $$Var_name_gb;
   $conteudo = $tot_empresa_email[0] ;  
   $this->count_empresa_email = $tot_empresa_email[1];
   $this->cnt_empresa_email_empresa_email = $tot_empresa_email[2];
   $this->cnt_empresa_email_itemproposta_modelo = $tot_empresa_email[3];
   $this->cnt_empresa_email_marca_marca = $tot_empresa_email[4];
   ...
   if (isset($this->nmgp_label_quebras['empresa_email']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['empresa_email']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "EMAIL"; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_empresa_email = false; 
 } 
 function quebra_itemproposta_modelo_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $this->sc_proc_quebra_empresa_email = false;
   $this->sc_proc_quebra_marca_marca = false;
   $this->sc_proc_quebra_itemproposta_modelo = true; 
   $this->Tot->quebra_itemproposta_modelo_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_itemproposta_modelo = $$Var_name_gb;
   $conteudo = $tot_itemproposta_modelo[0] ;  
   $this->count_itemproposta_modelo = $tot_itemproposta_modelo[1];
   $this->cnt_itemproposta_modelo_empresa_email = $tot_itemproposta_modelo[2];
   $this->cnt_itemproposta_modelo_itemproposta_modelo = $tot_itemproposta_modelo[3];
   $this->cnt_itemproposta_modelo_marca_marca = $tot_itemproposta_modelo[4];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->itemproposta_modelo)); 
   }
   ...
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['itemproposta_modelo']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['itemproposta_modelo']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "MODELO"; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_itemproposta_modelo = false; 
 } 
 function quebra_marca_marca_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $this->sc_proc_quebra_empresa_email = false;
   $this->sc_proc_quebra_itemproposta_modelo = false;
   $this->sc_proc_quebra_marca_marca = true; 
   $this->Tot->quebra_marca_marca_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name);
   $tot_marca_marca = $$Var_name_gb;
   $conteudo = $tot_marca_marca[0] ;  
   $this->count_marca_marca = $tot_marca_marca[1];
   $this->cnt_marca_marca_empresa_email = $tot_marca_marca[2];
   $this->cnt_marca_marca_itemproposta_modelo = $tot_marca_marca[3];
   $this->cnt_marca_marca_marca_marca = $tot_marca_marca[4];
   $Temp_cmp_quebra = array(); 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = NM_encode_input(sc_strip_script($this->marca_marca)); 
   }
   ...
   $Temp_cmp_quebra[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['marca_marca']))
   {
       $Temp_cmp_quebra[0]['lab'] = $this->nmgp_label_quebras['marca_marca']; 
   }
   else
   {
       $Temp_cmp_quebra[0]['lab'] = "MARCA"; 
   }
   $this->$Cmps_Gb_Free = $Temp_cmp_quebra;
   $this->sc_proc_quebra_marca_marca = false; 
 } 
 function quebra_empresa_email_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $tot_empresa_email = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['empresa_email'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_empresa_email = 0; 
   $cont_quebra_empresa_email++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['rows_emb']++;
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_GridClientesProduto_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_GridClientesProduto_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_GridClientesProduto_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_GridClientesProduto, 'GridClientesProduto'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_GridClientesProduto_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_GridClientesProduto_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_GridClientesProduto_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_GridClientesProduto, 'GridClientesProduto'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['GridClientesProduto'][$this->NM_cont_body][$this->Tab_Nv_tree['empresa_email']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_GridClientesProduto_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   $this->Label_empresa_email = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_empresa_email .= "<tr>"; 
       $this->Label_empresa_email .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_empresa_email .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_empresa_email .= "</tr>"; 
   } 
   $this->Label_empresa_email .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   ...
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_empresa_email . $nm_fecha_pdf_old . "\r\n");
   ...
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['empresa_email'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['GridClientesProduto'][$this->NM_cont_body][$this->Tab_Nv_tree['empresa_email']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_GridClientesProduto_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_empresa_email_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_empresa_email = $$Var_name_gb;
   $NM_cmp_tot['empresa_email']['C'] = 2;
   $NM_cmp_tot['itemproposta_modelo']['C'] = 3;
   $NM_cmp_tot['marca_marca']['C'] = 4;
   $NM_tipos_tot = array('C' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['empresa_email'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $Cada_cmp)
   {
    if ($Cada_cmp == "empresa_email" && (!isset($this->NM_cmp_hidden['empresa_email']) || $this->NM_cmp_hidden['empresa_email'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['empresa_email'][$Tipo_Sum]))
      {
          $conteudo =  $tot_empresa_email[$NM_cmp_tot['empresa_email'][$Tipo_Sum]]; 
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "C") {
          $NM_css_field = " css_empresa_email_C_sub_tot";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {
              $NM_css_field = " GridClientesProduto_" . trim($NM_css_field);
          }
      }
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "empresa_empresa" && (!isset($this->NM_cmp_hidden['empresa_empresa']) || $this->NM_cmp_hidden['empresa_empresa'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "empresa_contato" && (!isset($this->NM_cmp_hidden['empresa_contato']) || $this->NM_cmp_hidden['empresa_contato'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "proposta_id" && (!isset($this->NM_cmp_hidden['proposta_id']) || $this->NM_cmp_hidden['proposta_id'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "proposta_natureza" && (!isset($this->NM_cmp_hidden['proposta_natureza']) || $this->NM_cmp_hidden['proposta_natureza'] != "off"))
    {
        $colspan++;
    }
    if ($Cada_cmp == "itemproposta_modelo" && (!isset($this->NM_cmp_hidden['itemproposta_modelo']) || $this->NM_cmp_hidden['itemproposta_modelo'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]))
      {
          $conteudo =  $tot_empresa_email[$NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "C") {
          $NM_css_field = " css_itemproposta_modelo_C_sub_tot";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {
              $NM_css_field = " GridClientesProduto_" . trim($NM_css_field);
          }
      }
    ...
    if ($Cada_cmp == "marca_marca" && (!isset($this->NM_cmp_hidden['marca_marca']) || $this->NM_cmp_hidden['marca_marca'] != "off"))
    {
      if ($colspan > 0)
      {
          $NM_css_field = ""; 
      ...
      $conteudo = "&nbsp;"; 
      if (isset($NM_cmp_tot['marca_marca'][$Tipo_Sum]))
      {
          $conteudo =  $tot_empresa_email[$NM_cmp_tot['marca_marca'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
      ...
      $NM_css_field = ""; 
      if ($Tipo_Sum == "C") {
          $NM_css_field = " css_marca_marca_C_sub_tot";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {
              $NM_css_field = " GridClientesProduto_" . trim($NM_css_field);
          }
      }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_itemproposta_modelo_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_itemproposta_modelo = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['itemproposta_modelo'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_itemproposta_modelo = 0; 
   $cont_quebra_itemproposta_modelo++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['GridClientesProduto'][$this->NM_cont_body][$this->Tab_Nv_tree['itemproposta_modelo']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_GridClientesProduto_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $conteudo = $tot_itemproposta_modelo[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_itemproposta_modelo = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_itemproposta_modelo .= "<tr>"; 
       $this->Label_itemproposta_modelo .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_itemproposta_modelo .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_itemproposta_modelo .= "</tr>"; 
   } 
   $this->Label_itemproposta_modelo .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_itemproposta_modelo . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['itemproposta_modelo'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['GridClientesProduto'][$this->NM_cont_body][$this->Tab_Nv_tree['itemproposta_modelo']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_GridClientesProduto_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_itemproposta_modelo_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $NM_cmp_tot['marca_marca']['C'] = 4;
   $NM_tipos_tot = array('C' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['itemproposta_modelo'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $Cada_cmp)
   {
    if ($Cada_cmp == "empresa_email" && (!isset($this->NM_cmp_hidden['empresa_email']) || $this->NM_cmp_hidden['empresa_email'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['empresa_email'][$Tipo_Sum]))
      {
          $conteudo =  $tot_itemproposta_modelo[$NM_cmp_tot['empresa_email'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
    ...
    if ($Cada_cmp == "itemproposta_modelo" && (!isset($this->NM_cmp_hidden['itemproposta_modelo']) || $this->NM_cmp_hidden['itemproposta_modelo'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]))
      {
          $conteudo =  $tot_itemproposta_modelo[$NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
    ...
    if ($Cada_cmp == "marca_marca" && (!isset($this->NM_cmp_hidden['marca_marca']) || $this->NM_cmp_hidden['marca_marca'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['marca_marca'][$Tipo_Sum]))
      {
          $conteudo =  $tot_itemproposta_modelo[$NM_cmp_tot['marca_marca'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
 ...
 function quebra_marca_marca_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_marca_marca = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['marca_marca'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_marca_marca = 0; 
   $cont_quebra_marca_marca++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['GridClientesProduto'][$this->NM_cont_body][$this->Tab_Nv_tree['marca_marca']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_GridClientesProduto_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $conteudo = $tot_marca_marca[0] ;  
    $thisColspan = 2;
   $colspan = $this->NM_colspan;
   $this->Label_marca_marca = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_marca_marca .= "<tr>"; 
       $this->Label_marca_marca .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_marca_marca .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_marca_marca .= "</tr>"; 
   } 
   $this->Label_marca_marca .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_marca_marca . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['marca_marca'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['GridClientesProduto'][$this->NM_cont_body][$this->Tab_Nv_tree['marca_marca']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_GridClientesProduto_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_marca_marca_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   ...
   $NM_cmp_tot['marca_marca']['C'] = 4;
   $NM_tipos_tot = array('C' => '' . $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . '');
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['marca_marca'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ind_tree'];
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $Cada_cmp)
   {
    if ($Cada_cmp == "empresa_email" && (!isset($this->NM_cmp_hidden['empresa_email']) || $this->NM_cmp_hidden['empresa_email'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['empresa_email'][$Tipo_Sum]))
      {
          $conteudo =  $tot_marca_marca[$NM_cmp_tot['empresa_email'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
    ...
    if ($Cada_cmp == "itemproposta_modelo" && (!isset($this->NM_cmp_hidden['itemproposta_modelo']) || $this->NM_cmp_hidden['itemproposta_modelo'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]))
      {
          $conteudo =  $tot_marca_marca[$NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
    ...
    if ($Cada_cmp == "marca_marca" && (!isset($this->NM_cmp_hidden['marca_marca']) || $this->NM_cmp_hidden['marca_marca'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['marca_marca'][$Tipo_Sum]))
      {
          $conteudo =  $tot_marca_marca[$NM_cmp_tot['marca_marca'][$Tipo_Sum]]; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][1] . ")";
  ...
  foreach ($NM_tipos_tot as $Tipo_Sum => $Tit_sum)
  {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $Cada_cmp)
   {
    if ($Cada_cmp == "empresa_email" && (!isset($this->NM_cmp_hidden['empresa_email']) || $this->NM_cmp_hidden['empresa_email'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['empresa_email'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][$NM_cmp_tot['empresa_email'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "C") {
          $NM_css_field = " css_empresa_email_C_tot_ger";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {
              $NM_css_field = " GridClientesProduto_" . trim($NM_css_field);
          }
      }
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_empresa_email_tot_ger " . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "empresa_empresa" && (!isset($this->NM_cmp_hidden['empresa_empresa']) || $this->NM_cmp_hidden['empresa_empresa'] != "off"))
    {
       $colspan++;
    ...
    if ($Cada_cmp == "itemproposta_modelo" && (!isset($this->NM_cmp_hidden['itemproposta_modelo']) || $this->NM_cmp_hidden['itemproposta_modelo'] != "off"))
    {
      ...
      if (isset($NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][$NM_cmp_tot['itemproposta_modelo'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "C") {
          $NM_css_field = " css_itemproposta_modelo_C_tot_ger";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {
              $NM_css_field = " GridClientesProduto_" . trim($NM_css_field);
          }
      }
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_itemproposta_modelo_tot_ger " . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
    if ($Cada_cmp == "marca_marca" && (!isset($this->NM_cmp_hidden['marca_marca']) || $this->NM_cmp_hidden['marca_marca'] != "off"))
    {
      if ($colspan > 0)
      ...
      if (isset($NM_cmp_tot['marca_marca'][$Tipo_Sum]))
      {
          $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['tot_geral'][$NM_cmp_tot['marca_marca'][$Tipo_Sum]] ; 
          if ($Tipo_Sum == "C" || $Tipo_Sum == "D")
          {
              nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          }
          ...
          $NM_css_field =  ""; 
      if ($Tipo_Sum == "C") {
          $NM_css_field = " css_marca_marca_C_tot_ger";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida']) {
              $NM_css_field = " GridClientesProduto_" . trim($NM_css_field);
          }
      }
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridTotalFont . " css_marca_marca_tot_ger " . $NM_css_field . "\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
   }
   if ($colspan > 0)
   {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'])
          {
          ...
          $SC_Label_atu['proposta_id'] = (isset($this->New_label['proposta_id'])) ? $this->New_label['proposta_id'] : 'ORDEM'; 
          $SC_Label_atu['proposta_natureza'] = (isset($this->New_label['proposta_natureza'])) ? $this->New_label['proposta_natureza'] : 'Natureza'; 
          $SC_Label_atu['itemproposta_modelo'] = (isset($this->New_label['itemproposta_modelo'])) ? $this->New_label['itemproposta_modelo'] : 'MODELO'; 
          $SC_Label_atu['marca_marca'] = (isset($this->New_label['marca_marca'])) ? $this->New_label['marca_marca'] : 'MARCA'; 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['field_order'] as $cada_field)
          { 
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "", "", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $UseAlias =  "S";
              $this->nm_btn_exist['sort_col'][] = "ordcmp_top";
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "", "", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "", "", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
          }
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $Tem_gb_pdf  = "s";
      $Tem_pdf_res = "n";
      $Tem_pdf_res = "s";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=pt_br&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=GridClientesProduto&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=GridClientesProduto&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_xml_res = "n";
          $Tem_xml_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['json'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_json_res = "n";
          $Tem_json_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "json_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_json_res . "&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_csv_res = "n";
          $Tem_csv_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
              $this->nm_btn_exist['rtf'][] = "rtf_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "brtf", "nm_gp_rtf_conf();", "nm_gp_rtf_conf();", "rtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + R)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=pt_br&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          if (is_file("GridClientesProduto_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("GridClientesProduto_help.txt"); 
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] == '50') ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['xml'][] = "xml_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
          ...
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['SC_Gb_Free_cmp']))
            { }
            else {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'])?'none':'';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'] as $cmp => $def)
           {
               $this->Ini->Arr_result['setValue'][] = array('field' => 'grid_search_label_' . $cmp, 'value' => NM_encode_input(NM_charset_to_utf8(trim($def['descr']))));
               $this->Ini->Arr_result['setTitle'][] = array('field' => 'grid_search_label_' . $cmp, 'value' => NM_encode_input(NM_charset_to_utf8(trim($def['hint']))));
           }
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "proposta_natureza")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "proposta_natureza";
                           $lin_obj = $this->grid_search_proposta_natureza($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "marca_marca")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "marca_marca";
                           $lin_obj = $this->grid_search_marca_marca($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('proposta_natureza','marca_marca');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']) && is_array($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq']) < 2)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_proposta_natureza($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_proposta_natureza_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_proposta_natureza_cond_" . $ind . "' name='cond_grid_search_proposta_natureza_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"grid_proposta_natureza_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['psq_check_ret']['proposta_natureza'] = array();
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "Proposta?#?Proposta?#?S?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['psq_check_ret']['proposta_natureza'][] = "Proposta";
       $nmgp_def_dados .= "Venda?#?Venda?#?S?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['psq_check_ret']['proposta_natureza'][] = "Venda";
       $i = 0;
       $lin_obj .= "   <table id=\"TBG_proposta_natureza_" . $ind . "\" style=\"padding: 0px; spacing: 0px; border-width: 0px;\"><tr>";
       $delimitador = "##@@";
       ...
       for ($j = 0; $j < sizeof($nm_opcoes); $j++)
       {
          if (!empty($nm_opcoes[$j]))
          {
             ...
             $lin_obj .= "   <td>";
             $lin_obj .= "    <div class='sc switch'>";
             $lin_obj .= "    <INPUT class='" . $this->css_scAppDivToolbarInput . "' type=\"checkbox\" id=\"grid_search_proposta_natureza_val_" . $ind . "\" name=\"val_grid_search_proposta_natureza_" . $ind . "[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $tmp_cmp_sel . "><span></span>" . $nm_opc_val;
             $lin_obj .= "    </div>";
             $lin_obj .= "   </td>";
             $i++;
   ...
   function grid_search_marca_marca($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_marca_marca_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_marca_marca_cond_" . $ind . "' name='cond_grid_search_marca_marca_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_marca_marca_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $lin_obj .= "       <br>";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $marca_marca = $val_cmp;
       if ($marca_marca != "")
       {
       $marca_marca_look = (is_string($marca_marca) ? substr($this->Db->qstr($marca_marca), 1, -1) : $marca_marca); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct marca.MARCA from " . $this->Ini->nm_tabela . " where marca.MARCA = '$marca_marca_look' order by marca.MARCA"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$marca_marca]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$marca_marca];
       }
       else
       {
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_marca_marca_val_" . $ind . "' name='val_grid_search_marca_marca_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=14 alt=\"{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       ...
       $lin_obj .= "     <select class='sc-ui-autocomp-marca_marca " . $this->css_scAppDivToolbarInput . "' id='id_ac_grid_marca_marca" . $ind . "' name='val_grid_search_marca_marca_autocomp" . $ind . "'>";
       if ('' !=  $marca_marca) {
           $lin_obj .= "     <option value='" . $marca_marca . "'  selected>" . $sAutocompValue . "</option>";
       }
       $lin_obj .= "     </select>";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function lookup_ajax_marca_marca($marca_marca)
   {
       $marca_marca = substr($this->Db->qstr($marca_marca), 1, -1);
       $this->NM_case_insensitive = false;
       $marca_marca_look = (is_string($marca_marca) ? substr($this->Db->qstr($marca_marca), 1, -1) : $marca_marca); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct marca.MARCA from " . $this->Ini->nm_tabela . " where  marca.MARCA like '%" . $marca_marca . "%' order by marca.MARCA"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = GridClientesProduto_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/GridClientesProduto";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'marca_marca')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_marca_marca = i;\r\n");
       $nm_saida->saida("                        $(\".sc-ui-autocomp-marca_marca\").on(\"focus\", function() {\r\n");
       ...
       $nm_saida->saida("                            field: \"marca_marca\",\r\n");
       ...
       $nm_saida->saida("                         $(\"#grid_search_marca_marca_val_\" + x_marca_marca).val(e.params.data.id);\r\n");
       $nm_saida->saida("                        });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("             }\r\n");
       $nm_saida->saida("         }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'proposta_natureza')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_checkbox(obj_dyn + i);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'marca_marca')\r\n");
       $nm_saida->saida("                 {\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search']) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search'])
            )
            {
                foreach($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['dyn_search'] as $_fld)
                {
                    if($_fld['cmp'] == $field)
                    {
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('empresa_email', 'empresa_empresa', 'empresa_contato', 'proposta_id', 'proposta_natureza', 'itemproposta_modelo', 'marca_marca'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
   ...
   function html_interativ_search()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_dados']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_dados'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_label']['proposta_natureza'] = (isset($this->New_label['proposta_natureza'])) ? $this->New_label['proposta_natureza'] : 'Natureza';
       $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_sql']['proposta_natureza']   = "proposta.natureza";
   ...
   function refresh_interativ_search()
   {
       ...
       if(is_array($array_fields) && !empty($array_fields))
       {
           ...
           {
               if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search'][$str_field]))
               {
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']["proposta_natureza"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']["proposta_natureza"])) ? "none" : "";
       $displ_open= true;
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_label']['proposta_natureza'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_pesq'];
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo'])) 
       { 
           if (empty($tmp_where)) 
           { 
               $tmp_where = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo']; 
           } 
           else
           { 
               $tmp_where .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['where_resumo'] . ")"; 
           } 
       } 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']['proposta_natureza'])) ? "" : "none";
       ...
       {
           $bol_populate_modal_values = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_dados']['proposta_natureza'])?false:true);
       }
       foreach ($result as $dados => $qtd_result)
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_dados']['proposta_natureza'][$dados] = array('val'=>$formatado,'qtd'=>$qtd_result);
           }
           if($dados == '')
           {
           ...
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']['proposta_natureza']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']['proposta_natureza']['val_sel'])) ? " checked" : "";
           $checked = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']['proposta_natureza']['val_sel']) && in_array($dados, $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['interativ_search']['proposta_natureza']['val_sel'])) ? " checked" : "";
           $lin_obj  .= "        <INPUT class='" . $this->css_scAppDivToolbarInput . "' style='margin:0px' type=\"checkbox\" onclick=\"nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_label']['proposta_natureza']) . "','proposta_natureza','id_int_search_proposta_natureza','proposta_natureza', '', 'N')\"  id=\"id_int_search_proposta_natureza_" . md5($dados) . "\" name=\"int_search_proposta_natureza[]\" value=\"" . NM_encode_input($dados . "##@@" . $formatado) . "\" $checked><span class='scGridRefinedSearchCampoFont'> <label for=\"id_int_search_proposta_natureza_". md5($dados) ."\" for=\"id_int_search_proposta_natureza_". md5($dados) ."\">" . $formatado_exib . "</label></span>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= " <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           }
           ...
           if($bol_refin_use_modal)
           {
               $lin_obj  .= "       <a href=\"javascript:tb_show('', 'GridClientesProduto_refin_modal.php?sc_init=" . NM_encode_input($this->Ini->sc_page) . "&cmp_modal=proposta_natureza&tp_obj=tx&TB_iframe=true&modal=true&height=440&width=630', '');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
           }
           else
           {
           ...
           $lin_obj  .= "    Tab_obj_int_mult['proposta_natureza'] = 'S';";
           $lin_obj  .= "    nm_expand_int_search('proposta_natureza');";
           $lin_obj  .= "});";
           $lin_obj  .= "</SCRIPT>";
           $lin_obj  .= "   </div></td></tr>";
           ...
           $disp_multi_btn = '';
           $disp_multi_btn = 'none';
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_label']['proposta_natureza']) . "','proposta_natureza','id_int_search_proposta_natureza','proposta_natureza', '', 'N');", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['int_search_label']['proposta_natureza']) . "','proposta_natureza','id_int_search_proposta_natureza','proposta_natureza', '', 'N');", "app_int_search_proposta_natureza", "", "", "display: $disp_multi_btn ;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "    </div>";
       $lin_obj .= "    </td>";
       $lin_obj .= "    </tr>";
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               GridClientesProduto_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           GridClientesProduto_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('GridClientesProduto', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"GridClientesProduto\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"GridClientesProduto_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"nm_grid_submit\" value=\"1\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"csrf_token\" value=\"" . $this->Ini->scCsrfGetToken() . "\"/> \r\n");
   ...
   $nm_saida->saida("                     action=\"GridClientesProduto_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "GridClientesProduto/GridClientesProduto_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"GridClientesProduto_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['GridClientesProduto_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@GridClientesProduto@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"GridClientesProduto_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"GridClientesProduto_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"GridClientesProduto_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"GridClientesProduto_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridClientesProduto']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('GridClientesProduto')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('GridClientesProduto', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
