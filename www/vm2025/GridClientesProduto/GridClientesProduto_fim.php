...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____GridClientesProduto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____GridClientesProduto"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>GridClientesProduto</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['GridClientesProduto']['embutida_filho'] as $ind => $sc_init)
          {
