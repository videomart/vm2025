...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____MaioresCompradoras"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____MaioresCompradoras"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>MaioresCompradoras</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['MaioresCompradoras']['embutida_filho'] as $ind => $sc_init)
          {
