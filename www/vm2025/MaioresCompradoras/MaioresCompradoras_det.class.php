...
class MaioresCompradoras_det
{
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['sub_dir'] = array(); 
   ...
   $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
       $nmgp_select = "SELECT count(ID_EMPRESA) as qtd, empresa.empresa as empresa_empresa, empresa.contato as empresa_contato, empresa.categoria as empresa_categoria, sum(total) as totalgeral from " . $this->Ini->nm_tabela; 
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['chave_det']) ; 
   ...
   $nmgp_select .= " where  empresa.empresa = '$parms_det[0]' and empresa.contato = '$parms_det[1]' and empresa.categoria = '$parms_det[2]' and year(proposta.data) = $parms_det[3]" ;  
...
$nm_saida->saida("</script>\r\n");
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "MaioresCompradoras/MaioresCompradoras_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
       $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "MaioresCompradoras/MaioresCompradoras_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
    $removeMargin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['remove_margin'] ? 'margin: 0;' : '';
    $removeBorder = isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['remove_border'] ? 'border-width: 0;' : '';
    $removeBackground = isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['remove_background'] ? 'background-color: transparent; background-image: none;' : '';
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cmp_acum']);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['compact_mode']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['link_info']['compact_mode']) {
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->qtd))); 
   $conteudo_original = $conteudo; 
          ...
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'qtd', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'qtd', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_qtd_det_label\"   >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_qtd_det_line\"   " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_qtd\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['opcao'] == "pdf")
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
       $conteudo = trim(NM_encode_input(sc_strip_script($this->empresa_categoria)));
       $conteudo_original =  NM_encode_input(sc_strip_script($conteudo)); 
   }
   else {
       $conteudo = trim(sc_strip_script($this->empresa_categoria)); 
       $conteudo_original = $conteudo; 
   }
          if ($conteudo === "") 
          { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'empresa_categoria', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'empresa_categoria', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_empresa_categoria_det_label\"   >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_empresa_categoria_det_line\"   " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_empresa_categoria\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['opcao'] == "pdf")
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->totalgeral))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'totalgeral', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'totalgeral', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_totalgeral_det_label\"   >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_totalgeral_det_line\"   " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\"><span id=\"id_sc_field_totalgeral\">" . $conteudo . "</span></TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if(isset($_SESSION['scriptcase']['proc_mobile']) && $_SESSION['scriptcase']['proc_mobile'])
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"MaioresCompradoras_doc.php?nmgp_parms=\" + campo1, \"_self\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['pdf_det']) 
   { 
       ...
       if ($this->nmgp_botoes['det_pdf'] == "on")
       {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "MaioresCompradoras/MaioresCompradoras_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=800&conf_larg=N&conf_fonte=10&language=pt_br&conf_socor=S&sc_ver_93=s&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $this->nm_btn_exist['det_print'][] = "Dprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "MaioresCompradoras/MaioresCompradoras_config_print.php?nm_opc=detalhe&nm_cor=PB&password=n&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
