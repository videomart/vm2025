...
<?php
   ...
   $Ord_Cmp = new MaioresCompradoras_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class MaioresCompradoras_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['qtd'] = "count(ID_EMPRESA)";
   }
   $tab_labels["qtd"]   = (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["qtd"])) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["qtd"] : "Qtd";
   ...
   $tab_labels["empresa_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["empresa_empresa"])) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["empresa_empresa"] : "Empresa";
   ...
   $tab_labels["empresa_contato"]   = (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["empresa_contato"])) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["empresa_contato"] : "Contato";
   ...
   $tab_labels["empresa_categoria"]   = (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["empresa_categoria"])) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["empresa_categoria"] : "Categoria";
   ...
   {
       $tab_def_campos['ano'] = "year(proposta.data)";
   }
   $tab_labels["ano"]   = (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["ano"])) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["ano"] : "Ano";
   $tab_ger_campos['totalgeral'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['totalgeral'] = "totalgeral";
   }
   else
   {
       $tab_def_campos['totalgeral'] = "sum(total)";
   }
   $tab_labels["totalgeral"]   = (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["totalgeral"])) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['labels']["totalgeral"] : "Total Geral";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "MaioresCompradoras_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['MaioresCompradoras']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
