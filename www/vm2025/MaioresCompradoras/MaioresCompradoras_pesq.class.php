...
class MaioresCompradoras_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . MaioresCompradoras_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . MaioresCompradoras_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(MaioresCompradoras_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . MaioresCompradoras_pack_protect_string($Tipo_filter[0]) . "\">.." . MaioresCompradoras_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>MaioresCompradoras/MaioresCompradoras_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="MaioresCompradoras_ajax_search.js"></script>
 <script type="text/javascript" src="MaioresCompradoras_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="MaioresCompradoras_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['MaioresCompradoras']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['MaioresCompradoras']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_qtd_cond#NMF#' + search_get_sel_txt('SC_qtd_cond') + '@NMF@';
  str_out += 'SC_qtd#NMF#' + search_get_text('SC_qtd') + '@NMF@';
  str_out += 'SC_empresa_empresa_cond#NMF#' + search_get_sel_txt('SC_empresa_empresa_cond') + '@NMF@';
  str_out += 'SC_empresa_empresa#NMF#' + search_get_text('SC_empresa_empresa') + '@NMF@';
  str_out += 'SC_empresa_contato_cond#NMF#' + search_get_sel_txt('SC_empresa_contato_cond') + '@NMF@';
  str_out += 'SC_empresa_contato#NMF#' + search_get_text('SC_empresa_contato') + '@NMF@';
  str_out += 'SC_empresa_categoria_cond#NMF#' + search_get_sel_txt('SC_empresa_categoria_cond') + '@NMF@';
  str_out += 'SC_empresa_categoria#NMF#' + search_get_text('SC_empresa_categoria') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $qtd_cond, $qtd,
             $empresa_empresa_cond, $empresa_empresa,
             $empresa_contato_cond, $empresa_contato,
             $empresa_categoria_cond, $empresa_categoria,
             $ano_cond, $ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $qtd = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['qtd']; 
          $qtd_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['qtd_cond']; 
          $empresa_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_empresa']; 
          $empresa_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_empresa_cond']; 
          $empresa_contato = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_contato']; 
          $empresa_contato_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_contato_cond']; 
          $empresa_categoria = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_categoria']; 
          $empresa_categoria_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_categoria_cond']; 
          $ano = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['ano']; 
          $ano_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['ano_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['NM_operador']; 
          if (strtoupper($qtd_cond) != "II" && strtoupper($qtd_cond) != "QP" && strtoupper($qtd_cond) != "NP" && strtoupper($qtd_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($qtd, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($ano_cond) != "II" && strtoupper($ano_cond) != "QP" && strtoupper($ano_cond) != "NP" && strtoupper($ano_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ano, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($qtd_cond) || empty($qtd_cond))
      {
         $qtd_cond = "eq";
      }
      if (!isset($empresa_empresa_cond) || empty($empresa_empresa_cond))
      {
         $empresa_empresa_cond = "eq";
      }
      if (!isset($empresa_contato_cond) || empty($empresa_contato_cond))
      {
         $empresa_contato_cond = "eq";
      }
      if (!isset($empresa_categoria_cond) || empty($empresa_categoria_cond))
      {
         $empresa_categoria_cond = "eq";
      }
      ...
      $str_hide_qtd = (in_array($qtd_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_empresa_empresa = (in_array($empresa_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_empresa_contato = (in_array($empresa_contato_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_empresa_categoria = (in_array($empresa_categoria_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($qtd)) ? strpos($qtd, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $qtd = substr($qtd, 0, $tmp_pos);
         }
      }
      if (!isset($empresa_empresa) || $empresa_empresa == "")
      {
          $empresa_empresa = "";
      }
      if (isset($empresa_empresa) && !empty($empresa_empresa))
      {
         $tmp_pos = (is_string($empresa_empresa)) ? strpos($empresa_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $empresa_empresa = substr($empresa_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($empresa_contato) || $empresa_contato == "")
      {
          $empresa_contato = "";
      }
      if (isset($empresa_contato) && !empty($empresa_contato))
      {
         $tmp_pos = (is_string($empresa_contato)) ? strpos($empresa_contato, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $empresa_contato = substr($empresa_contato, 0, $tmp_pos);
         }
      }
      if (!isset($empresa_categoria) || $empresa_categoria == "")
      {
          $empresa_categoria = "";
      }
      if (isset($empresa_categoria) && !empty($empresa_categoria))
      {
         $tmp_pos = (is_string($empresa_categoria)) ? strpos($empresa_categoria, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $empresa_categoria = substr($empresa_categoria, 0, $tmp_pos);
         }
      }
      if (!isset($ano) || $ano == "")
      {
      ...
      {
         $tmp_pos = (is_string($ano)) ? strpos($ano, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_qtd_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['qtd'])) ? $this->New_label['qtd'] : "Qtd"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_qtd_cond" name="qtd_cond" onChange="nm_campos_between(document.getElementById('id_vis_qtd'), this, 'qtd')">
       <OPTION value="eq" <?php if ("eq" == $qtd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $qtd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $qtd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $qtd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_qtd" <?php echo $str_hide_qtd?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['qtd'])) ? $this->New_label['qtd'] : "Qtd";
 $nmgp_tab_label .= "qtd?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<INPUT  type="text" id="SC_qtd" name="qtd" value="<?php echo NM_encode_input($qtd) ?>" size=21 alt="{datatype: 'integer', maxLength: 21, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_empresa_empresa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['empresa_empresa'])) ? $this->New_label['empresa_empresa'] : "Empresa"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_empresa_empresa_cond" name="empresa_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_empresa'), this, 'empresa_empresa')">
       <OPTION value="eq" <?php if ("eq" == $empresa_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $empresa_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $empresa_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $empresa_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_empresa_empresa" <?php echo $str_hide_empresa_empresa?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['empresa_empresa'])) ? $this->New_label['empresa_empresa'] : "Empresa";
 $nmgp_tab_label .= "empresa_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_empresa_empresa" name="empresa_empresa" value="<?php echo NM_encode_input($empresa_empresa) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_empresa_contato_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['empresa_contato'])) ? $this->New_label['empresa_contato'] : "Contato"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_empresa_contato_cond" name="empresa_contato_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_contato'), this, 'empresa_contato')">
       <OPTION value="eq" <?php if ("eq" == $empresa_contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $empresa_contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $empresa_contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $empresa_contato_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_empresa_contato" <?php echo $str_hide_empresa_contato?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['empresa_contato'])) ? $this->New_label['empresa_contato'] : "Contato";
 $nmgp_tab_label .= "empresa_contato?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_empresa_contato" name="empresa_contato" value="<?php echo NM_encode_input($empresa_contato) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_empresa_categoria_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['empresa_categoria'])) ? $this->New_label['empresa_categoria'] : "Categoria"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_empresa_categoria_cond" name="empresa_categoria_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_categoria'), this, 'empresa_categoria')">
       <OPTION value="eq" <?php if ("eq" == $empresa_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $empresa_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $empresa_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $empresa_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_empresa_categoria" <?php echo $str_hide_empresa_categoria?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['empresa_categoria'])) ? $this->New_label['empresa_categoria'] : "Categoria";
 $nmgp_tab_label .= "empresa_categoria?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_empresa_categoria" name="empresa_categoria" value="<?php echo NM_encode_input($empresa_categoria) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <INPUT type="hidden" id="SC_ano_cond" name="ano_cond" value="eq">
...
?>
<INPUT  type="text" id="SC_ano" name="ano" value="<?php echo NM_encode_input($ano) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
<?php
   if (is_file("MaioresCompradoras_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['MaioresCompradoras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['MaioresCompradoras']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.qtd_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_qtd'), document.F1.qtd_cond, 'qtd');
   document.F1.qtd.value = "";
   document.F1.empresa_empresa_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_empresa_empresa'), document.F1.empresa_empresa_cond, 'empresa_empresa');
   document.F1.empresa_empresa.value = "";
   document.F1.empresa_contato_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_empresa_contato'), document.F1.empresa_contato_cond, 'empresa_contato');
   document.F1.empresa_contato.value = "";
   document.F1.empresa_categoria_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_empresa_categoria'), document.F1.empresa_categoria_cond, 'empresa_categoria');
   document.F1.empresa_categoria.value = "";
   document.F1.ano_cond.value = 'eq';
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/MaioresCompradoras";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_qtd_cond'] = 'cond';
      $tp_fields['SC_qtd'] = 'text';
      $tp_fields['SC_empresa_empresa_cond'] = 'cond';
      $tp_fields['SC_empresa_empresa'] = 'text';
      $tp_fields['SC_empresa_contato_cond'] = 'cond';
      $tp_fields['SC_empresa_contato'] = 'text';
      $tp_fields['SC_empresa_categoria_cond'] = 'cond';
      $tp_fields['SC_empresa_categoria'] = 'text';
      $tp_fields['SC_ano_cond'] = 'cond';
      $tp_fields['SC_ano'] = 'text';
   ...
   function trata_campos()
   {
      global $qtd_cond, $qtd,
             ...
             $empresa_contato_cond, $empresa_contato,
             $empresa_categoria_cond, $empresa_categoria,
             $ano_cond, $ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $qtd_cond_salva = $qtd_cond; 
      if (!isset($qtd_input_2) || $qtd_input_2 == "")
      {
          $qtd_input_2 = $qtd;
      }
      $empresa_empresa_cond_salva = $empresa_empresa_cond; 
      if (!isset($empresa_empresa_input_2) || $empresa_empresa_input_2 == "")
      {
          $empresa_empresa_input_2 = $empresa_empresa;
      }
      $empresa_contato_cond_salva = $empresa_contato_cond; 
      if (!isset($empresa_contato_input_2) || $empresa_contato_input_2 == "")
      {
          $empresa_contato_input_2 = $empresa_contato;
      }
      $empresa_categoria_cond_salva = $empresa_categoria_cond; 
      if (!isset($empresa_categoria_input_2) || $empresa_categoria_input_2 == "")
      {
          $empresa_categoria_input_2 = $empresa_categoria;
      }
      ...
      if ($qtd_cond != "in")
      {
          nm_limpa_numero($qtd, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($ano_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['qtd'] = $qtd; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['qtd_cond'] = $qtd_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_empresa'] = $empresa_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_empresa_cond'] = $empresa_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_contato'] = $empresa_contato; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_contato_cond'] = $empresa_contato_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_categoria'] = $empresa_categoria; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['empresa_categoria_cond'] = $empresa_categoria_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['ano'] = $ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['ano_cond'] = $ano_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['qtd'] = $Conteudo;
      $this->cmp_formatado['qtd'] = "'" . $this->cmp_formatado['qtd'] . "'";
      if (isset($this->cmp_formatado['qtd_input_2'])  && !empty($this->cmp_formatado['qtd_input_2'])) {
          $this->cmp_formatado['qtd_input_2'] = "'" . $this->cmp_formatado['qtd_input_2'] . "'";
      }
      $Conteudo = $empresa_empresa;
      $this->cmp_formatado['empresa_empresa'] = $Conteudo;
      $this->cmp_formatado['empresa_empresa'] = "'" . $this->cmp_formatado['empresa_empresa'] . "'";
      if (isset($this->cmp_formatado['empresa_empresa_input_2'])  && !empty($this->cmp_formatado['empresa_empresa_input_2'])) {
          $this->cmp_formatado['empresa_empresa_input_2'] = "'" . $this->cmp_formatado['empresa_empresa_input_2'] . "'";
      }
      $Conteudo = $empresa_contato;
      $this->cmp_formatado['empresa_contato'] = $Conteudo;
      $this->cmp_formatado['empresa_contato'] = "'" . $this->cmp_formatado['empresa_contato'] . "'";
      if (isset($this->cmp_formatado['empresa_contato_input_2'])  && !empty($this->cmp_formatado['empresa_contato_input_2'])) {
          $this->cmp_formatado['empresa_contato_input_2'] = "'" . $this->cmp_formatado['empresa_contato_input_2'] . "'";
      }
      $Conteudo = $empresa_categoria;
      $this->cmp_formatado['empresa_categoria'] = $Conteudo;
      $this->cmp_formatado['empresa_categoria'] = "'" . $this->cmp_formatado['empresa_categoria'] . "'";
      if (isset($this->cmp_formatado['empresa_categoria_input_2'])  && !empty($this->cmp_formatado['empresa_categoria_input_2'])) {
          $this->cmp_formatado['empresa_categoria_input_2'] = "'" . $this->cmp_formatado['empresa_categoria_input_2'] . "'";
      }
      $Conteudo = $ano;
      if (strtoupper($ano_cond) != "II" && strtoupper($ano_cond) != "QP" && strtoupper($ano_cond) != "NP" && strtoupper($ano_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['ano'] = $Conteudo;
      $this->cmp_formatado['ano'] = "'" . $this->cmp_formatado['ano'] . "'";
      if (isset($this->cmp_formatado['ano_input_2'])  && !empty($this->cmp_formatado['ano_input_2'])) {
          $this->cmp_formatado['ano_input_2'] = "'" . $this->cmp_formatado['ano_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($qtd) || $qtd_cond == "nu" || $qtd_cond == "nn" || $qtd_cond == "ep" || $qtd_cond == "ne")
      {
         $this->monta_condicao("count(ID_EMPRESA)", $qtd_cond, $qtd, "", "qtd", "BIGINT", false);
      }

      //----- $empresa_empresa
      $this->Date_part = false;
      if (isset($empresa_empresa) || $empresa_empresa_cond == "nu" || $empresa_empresa_cond == "nn" || $empresa_empresa_cond == "ep" || $empresa_empresa_cond == "ne")
      {
         $this->monta_condicao("empresa.empresa", $empresa_empresa_cond, $empresa_empresa, "", "empresa_empresa", "VARCHAR", false);
      }

      //----- $empresa_contato
      $this->Date_part = false;
      if (isset($empresa_contato) || $empresa_contato_cond == "nu" || $empresa_contato_cond == "nn" || $empresa_contato_cond == "ep" || $empresa_contato_cond == "ne")
      {
         $this->monta_condicao("empresa.contato", $empresa_contato_cond, $empresa_contato, "", "empresa_contato", "VARCHAR", false);
      }

      //----- $empresa_categoria
      $this->Date_part = false;
      if (isset($empresa_categoria) || $empresa_categoria_cond == "nu" || $empresa_categoria_cond == "nn" || $empresa_categoria_cond == "ep" || $empresa_categoria_cond == "ne")
      {
         $this->monta_condicao("empresa.categoria", $empresa_categoria_cond, $empresa_categoria, "", "empresa_categoria", "VARCHAR", false);
      }
      ...
      {
         $this->monta_condicao("year(proposta.data)", $ano_cond, $ano, "", "ano", "SMALLINT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['MaioresCompradoras']['cond_pesq'] .= $this->NM_operador;
