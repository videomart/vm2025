...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "count(id_empresa)";$Nm_numeric[] = "year(proposta_data)";$Nm_numeric[] = "sum(total)";$Nm_numeric[] = "count(id_empresa)";$Nm_numeric[] = "year(proposta_data)";$Nm_numeric[] = "sum(total)";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_qtd_cond" name="qtd_cond" onChange="nm_campos_between(document.getElementById('id_vis_qtd'), this, 'qtd')">
      ...
      <br><span id="id_hide_qtd"  <?php echo $str_hide_qtd?>><INPUT  type="text" id="SC_qtd" name="qtd" value="<?php echo NM_encode_input($qtd) ?>" size=21 alt="{datatype: 'integer', maxLength: 21, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_empresa_empresa_cond" name="empresa_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_empresa'), this, 'empresa_empresa')">
      ...
      <br><span id="id_hide_empresa_empresa"  <?php echo $str_hide_empresa_empresa?>><INPUT  type="text" id="SC_empresa_empresa" name="empresa_empresa" value="<?php echo NM_encode_input($empresa_empresa) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_empresa_contato_cond" name="empresa_contato_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_contato'), this, 'empresa_contato')">
      ...
      <br><span id="id_hide_empresa_contato"  <?php echo $str_hide_empresa_contato?>><INPUT  type="text" id="SC_empresa_contato" name="empresa_contato" value="<?php echo NM_encode_input($empresa_contato) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_empresa_categoria_cond" name="empresa_categoria_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_categoria'), this, 'empresa_categoria')">
      ...
      <br><span id="id_hide_empresa_categoria"  <?php echo $str_hide_empresa_categoria?>><INPUT  type="text" id="SC_empresa_categoria" name="empresa_categoria" value="<?php echo NM_encode_input($empresa_categoria) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_ano"  <?php echo $str_hide_ano?>><INPUT  type="text" id="SC_ano" name="ano" value="<?php echo NM_encode_input($ano) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
