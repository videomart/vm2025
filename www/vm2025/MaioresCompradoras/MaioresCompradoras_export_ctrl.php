<?php
@session_start() ;
$_SESSION['scriptcase']['MaioresCompradoras']['sc_process_barr'] = true;
require_once('../MaioresCompradoras/index.php');
unset($_SESSION['scriptcase']['MaioresCompradoras']['sc_process_barr']);
$ExportCtrl = new MaioresCompradoras_export_control;
$ExportCtrl->Export_barr();

class MaioresCompradoras_export_control
{
