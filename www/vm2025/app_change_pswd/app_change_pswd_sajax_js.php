...
?>
  ...
  function do_ajax_app_change_pswd_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldHidden(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_change_pswd_validate_description(var_description, var_script_case_init, do_ajax_app_change_pswd_validate_description_cb);
  } // do_ajax_app_change_pswd_validate_description

  function do_ajax_app_change_pswd_validate_description_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_change_pswd_validate_description_cb
  ...
  // ---------- Validate pswd_rules
  function do_ajax_app_change_pswd_validate_pswd_rules()
  {
    var nomeCampo_pswd_rules = "pswd_rules";
    var var_pswd_rules = scAjaxGetFieldHidden(nomeCampo_pswd_rules);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_change_pswd_validate_pswd_rules(var_pswd_rules, var_script_case_init, do_ajax_app_change_pswd_validate_pswd_rules_cb);
  } // do_ajax_app_change_pswd_validate_pswd_rules

  function do_ajax_app_change_pswd_validate_pswd_rules_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_change_pswd_validate_pswd_rules_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_change_pswd_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_change_pswd_submit_form(var_description, var_old_pswd, var_pswd, var_confirm_pswd, var_pswd_rules, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_change_pswd_submit_form_cb);
