...
//
   ...
   $_SESSION['scriptcase']['app_change_pswd']['glo_nm_perfil']          = "vmdata_con";
...
/*NM*/            $_SESSION['scriptcase']['app_change_pswd']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 2, $this->force_db_utf8); 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    {
        if ('ajax_app_change_pswd_validate_description' == $_POST['rs'])
        {
        ...
        if ('ajax_app_change_pswd_validate_pswd_rules' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (isset($_POST["sett_password_strength"])) 
        {
            ...
            nm_limpa_str_app_change_pswd($_SESSION['sett_password_strength']);
        }
        ...
        if (isset($_POST["sett_password_min"])) 
        {
            ...
            nm_limpa_str_app_change_pswd($_SESSION['sett_password_min']);
        }
        ...
        if (isset($_POST["pswd_expired"])) 
        {
            ...
            nm_limpa_str_app_change_pswd($_SESSION['pswd_expired']);
        }
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_app_change_pswd_validate_description");
    ...
    sajax_export("ajax_app_change_pswd_validate_pswd_rules");
...
//
    ...
    function ajax_app_change_pswd_validate_description($description, $script_case_init)
    {
        global $inicial_app_change_pswd;
        ...
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_opcao         = 'validate_description';
    ...
    function ajax_app_change_pswd_validate_pswd_rules($pswd_rules, $script_case_init)
    {
        global $inicial_app_change_pswd;
        //register_shutdown_function("app_change_pswd_pack_ajax_response");
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_flag          = true;
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_opcao         = 'validate_pswd_rules';
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_info['param'] = array(
    ...
    function ajax_app_change_pswd_submit_form($description, $old_pswd, $pswd, $confirm_pswd, $pswd_rules, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_app_change_pswd;
        //register_shutdown_function("app_change_pswd_pack_ajax_response");
        $inicial_app_change_pswd->contr_app_change_pswd->NM_ajax_flag          = true;
