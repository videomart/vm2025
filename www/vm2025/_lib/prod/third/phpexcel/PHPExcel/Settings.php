...
class PHPExcel_Settings
{
    ...
    public static function setLibXmlLoaderOptions($options = null)
    {
        ...
        if( (int) substr(phpversion(), 0, 1) < 8) @libxml_disable_entity_loader($options == (LIBXML_DTDLOAD | LIBXML_DTDATTR));
    ...
    public static function getLibXmlLoaderOptions()
    {
        ...
        if( (int) substr(phpversion(), 0, 1) < 8) @libxml_disable_entity_loader(self::$_libXmlLoaderOptions == (LIBXML_DTDLOAD | LIBXML_DTDATTR));
