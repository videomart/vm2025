			...
			switch ($rel["Type"]) {
				case "http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties":
					...
					if (is_object($xmlCore)) {
                        ...
                        $_date = self::array_item($xmlCore->xpath("dcterms:created"));
                        if(!empty($_date))
                        {
						...
						$docProps->setCreated($_date); //! respect xsi:type
						$docProps->setModified(strtotime((is_null(self::array_item($xmlCore->xpath("dcterms:modified")))?"":self::array_item($xmlCore->xpath("dcterms:modified"))))); //! respect xsi:type
