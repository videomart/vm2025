...
class ADODB_odbc extends ADOConnection {
	...
	{
        $this->binmode = (defined("ODBC_BINMODE_RETURN")?ODBC_BINMODE_RETURN:false);
        $this->curmode = (defined("SQL_CUR_USE_DRIVER")?SQL_CUR_USE_DRIVER:false);
		$this->ADODB_odbc();
	}
	...
	*/
	...
	function ErrorMsg()
	{
		if ($this->_haserrorfunctions) {
			...
			elseif (empty($this->_connectionID) && function_exists("odbc_errormsg"))
            {
                return @odbc_errormsg();
            }
            elseif(function_exists("odbc_errormsg"))
            {
