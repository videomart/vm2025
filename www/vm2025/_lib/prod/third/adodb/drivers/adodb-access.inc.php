...
class  ADODB_access extends ADODB_odbc {	
	...
	// returns true or false
	function PConnect($argHostname = "", $argUsername = "", $argPassword = "", $argDatabaseName = "", $forceNew = false, $arrExtraArgs=array(), $charset="")
	{
		if(is_file($argHostname))
		{
			if(!empty($argUsername))
		...
		return $this->_pconnect($argHostname, $argUsername, $argPassword, $argDatabaseName);
	}
