<?php
$nm_link_help                                                   = 'https://www.scriptcase.net/docs/en_us/v9/manual/';
if($nm_config['is_dev']){
    $nm_link_help = 'http://royalsalutre.netmake.com.br/tools/nm/sc_helpv9/gerado/en_us/manual_mp/manual/';
}
