                        ...
                        <div id="security-tab" class="ui bottom attached tab segment" data-tab="security">
                            <div class="form-fields">
                                <div class="field-group unpadded">
                                    <div id="use_ssl" class="concealed ui checkbox">
                                        <input name="use_ssl" type="hidden" value="N"/>
                                        <input id="use_ssl_input" name="use_ssl" type="checkbox" value="Y"/>
                                        <label for="use_ssl_input" class="sided">Use SSL</label>
                                    </div>
                                </div>
                                <div class="field-group">
                                ...
                                <div class="field-group unpadded">
                                    <div id="mssql_encrypt" class="concealed ui checkbox">
                                        <input name="mssql_encrypt" type="hidden" value="N"/>
                                        <input id="mssql_encrypt_input" name="mssql_encrypt" type="checkbox" value="Y"/>
                                        <label for="mssql_encrypt_input" class="sided">Encrypt</label>
                                    </div>
                                </div>
                                <div class="field-group">
                                    <div id="mssql_trustservercertificate" class="concealed ui checkbox">
                                        <input name="mssql_trustservercertificate" type="hidden" value="N"/>
                                        <input id="mssql_trustservercertificate_input" name="mssql_trustservercertificate" type="checkbox" value="Y"/>
                                        <label for="mssql_trustservercertificate_input" class="sided">trustServerCertificate</label>
                                    </div>
                                    <div id="mssql_truststore" class="concealed ui input"><label>trustStore</label><input name="mssql_truststore" placeholder=""/></div>
                                    <div id="mssql_truststorepassword" class="concealed ui input"><label>trustStorePassword</label><input name="mssql_truststorepassword" placeholder=""/></div>
                                    <div id="mssql_hostnameincertificate" class="concealed ui input"><label>hostnameInCertificate</label><input name="mssql_hostnameincertificate" placeholder=""/></div>
                                </div>
                                <div class="field-group">
