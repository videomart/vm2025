...
$nm_lang['form_pass_help_desc_6']     = 'Fill in captcha field';
$nm_lang['form_pass_captcha_placeholder'] = 'Write the letters in the image above';
...
$nm_lang['pass_empty']                     = 'Password cannot be empty';
$nm_lang['pass_conf_empty']                = 'Password confirmation cannot be empty';
$nm_lang['pass_captcha_error']             = 'Invalid captcha';
...
// info
$nm_lang['info_page_pass_welcome']          = 'Welcome to the Production Environment';
$nm_lang['info_page_pass_first']            = 'Here you will be able to manage the connections of your deployed applications, configure the project\'s APIs and define the general settings of the environment where your applications will be executed.';
$nm_lang['info_page_pass_second']           = 'This is your <b>first login</b>, so you will need to configure a <b>password</b> and an <b>email</b>, if you need to perform <b>password recovery</b>.';
$nm_lang['info_page_pass_btn']              = 'Ok, got it';

$nm_lang['info_page_gd']                    = 'You must have the GD extension active in your PHP environment';
?>