...
$nm_lang['label']['listar_base'] = 'Show databases';
...
$nm_lang['label']['ssh_server']              = 'SSH Server';
$nm_lang['label']['ssh_user']                = 'SSH User';
$nm_lang['label']['ssh_port']                = 'SSH Port';
$nm_lang['label']['ssh_privatecert']         = 'Private cert file';
$nm_lang['label']['ssh_localserver']         = 'Database server from SSH';
$nm_lang['label']['ssh_localport']           = 'Database port from SSH';
$nm_lang['label']['ssh_localportforwarding'] = 'Local port for port forwarding';
?>