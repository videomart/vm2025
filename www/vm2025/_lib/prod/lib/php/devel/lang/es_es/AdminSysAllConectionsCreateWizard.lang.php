...
$nm_lang['label']['listar_base'] = 'Listar bases';
...
$nm_lang['label']['use_ssh']          = 'Usar SSH';
...
$nm_lang['label']['ssh_server']              = 'Servidor SSH';
$nm_lang['label']['ssh_user']                = 'Usuario SSH';
$nm_lang['label']['ssh_port']                = 'Puerto SSH';
$nm_lang['label']['ssh_privatecert']         = 'Archivo de certificado privado';
$nm_lang['label']['ssh_localserver']         = 'Servidor de base de datos desde SSH';
$nm_lang['label']['ssh_localport']           = 'Puerto de base de datos desde SSH';
$nm_lang['label']['ssh_localportforwarding'] = 'Puerto local para reenvío';
?>