...
class nmConnection
{
    ...
    function TestConn($arr_conn)
    {
        ...
        $ibase_charset  = isset($arr_conn['ibase_charset']) ? $arr_conn['ibase_charset'] : "";
        $ibase_rolename  = isset($arr_conn['ibase_rolename']) ? $arr_conn['ibase_rolename'] : "";
        $ibase_dialect  = isset($arr_conn['ibase_dialect']) ? $arr_conn['ibase_dialect'] : "";
        ...
        else
        {
            ...
            elseif ('firebird' == $str_dbms)
            {
                ...
                if(!empty($ibase_charset))
                {
                    $str_charset = $ibase_charset;
                    $arrExtraArgs['ibase_charset'] = $ibase_charset;
                }
                if(!empty($ibase_rolename))
                {
                    $arrExtraArgs['ibase_rolename'] = $ibase_rolename;
                }
                if(!empty($ibase_dialect))
                {
                    $arrExtraArgs['dialect'] = $ibase_dialect;
                }
            }
            elseif ('ibase' == $str_dbms)
            {
                if(!empty($ibase_charset))
                {
                    $str_charset = $ibase_charset;
            ...
            if(empty($str_db_err) && !empty($str_execute_after_connect))
            {
