...
class nmPageAdminSysAllConectionsCreateWizard extends nmPage
{
    ...
    function SaveConections($arr_fields, $str_prj="")
    {
        ...
        $arr_profile = array(
            ...
            'ibase_charset'       => nm_crypt_encode_utf8($arr_fields['ibase_charset']),
            'ibase_rolename'       => nm_crypt_encode_utf8($arr_fields['ibase_rolename']),
            'ibase_dialect'       => nm_crypt_encode_utf8($arr_fields['ibase_dialect']),
        );
    ...
    function iniSession()
    {
        ...
        $_SESSION['nm_session']['connection']['wizard']['ibase_charset']      = '';
        $_SESSION['nm_session']['connection']['wizard']['ibase_rolename']      = '';
        $_SESSION['nm_session']['connection']['wizard']['ibase_dialect']      = '';
        ...
        if ($this->FormSent('create'))
        {
            ...
            switch($this->str_page)
            {
                ...
                case 'dados_usu':
                    ...
                    $arr_fields['ibase_charset'] = $_SESSION['nm_session']['connection']['wizard']['ibase_charset'];
                    $arr_fields['ibase_rolename'] = $_SESSION['nm_session']['connection']['wizard']['ibase_rolename'];
                    $arr_fields['ibase_dialect'] = $_SESSION['nm_session']['connection']['wizard']['ibase_dialect'];
...
EOT;
    ...
    function PrepareEditConn()
    {
        ...
        if ($this->IsArg('flag_edit') && $this->GetArg('flag_edit') == 'S')
        {
            ...
            $_SESSION['nm_session']['connection']['wizard']['ibase_charset'] = nm_crypt_decode($arr_conn['ibase_charset']);
            $_SESSION['nm_session']['connection']['wizard']['ibase_rolename'] = nm_crypt_decode($arr_conn['ibase_rolename']);
            $_SESSION['nm_session']['connection']['wizard']['ibase_dialect'] = nm_crypt_decode($arr_conn['ibase_dialect']);
    ...
    function GetConnection($str_conn)
    {
        ...
        $arr_conn['ibase_charset'] = isset($arr_ini_conn['ibase_charset'])?$arr_ini_conn['ibase_charset']:"";
        $arr_conn['ibase_rolename'] = isset($arr_ini_conn['ibase_rolename'])?$arr_ini_conn['ibase_rolename']:"";
        $arr_conn['ibase_dialect'] = isset($arr_ini_conn['ibase_dialect'])?$arr_ini_conn['ibase_dialect']:"";
