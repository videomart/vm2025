		...
		if(is_file($ini_file))
		{
			...
			foreach($arr_prod_tmp as $tag=>$val)
			{
				...
				foreach($val as $_k=>$_v)
				{
                    ...
                    elseif($tag == 'PROFILE' && !isset($_v['ibase_charset']))
                    {
                        $val[ $_k ]['ibase_charset'] = "";
                    }
                    elseif($tag == 'PROFILE' && !isset($_v['ibase_rolename']))
                    {
                        $val[ $_k ]['ibase_rolename'] = "";
                    }
                    elseif($tag == 'PROFILE' && !isset($_v['ibase_dialect']))
                    {
                        $val[ $_k ]['ibase_dialect'] = "";
                    }
				}
...
function getProdDefault()
{
    ...
    $arr_prod_ini["GLOBAL"]["DISABLE_PROD_UPDATE"] = 'N';
