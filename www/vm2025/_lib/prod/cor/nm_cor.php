...
<HEAD>
    ...
    <SCRIPT LANGUAGE="Javascript">
        ...
        function nm_atualiza()
        {
            ...
            objParent.document.<?php echo nm_string_form($cor_form); ?>.elements["<?php echo nm_string_form($cor_field); ?>"].value = jv + document.f.C.value;
            <?php
            if ('' != $cor_cback)
            {
            ?>
            ...
            {
                objParent.<?php echo nm_string_form($cor_cback); ?>();
            }
            <?php
            }
            ?>
...
<BODY BGCOLOR="#<?php echo htmlspecialchars($cor_inicial, ENT_QUOTES, 'UTF-8'); ?>" LEFTMARGIN="0" MARGINWIDTH="0" TOPMARGIN="0" MARGINHEIGHT="0">
                            ...
                            <table width="100%" height="107">
                                <tr>
                                    <td align="center" valign="middle">
                                        <input type="text" name="C" size="10" value="<?php echo htmlspecialchars($cor_inicial, ENT_QUOTES, 'UTF-8'); ?>">
                                        <br>
