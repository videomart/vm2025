...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_markup";$Nm_numeric[] = "markup";$Nm_numeric[] = "id";$Nm_numeric[] = "id_markup";$Nm_numeric[] = "markup";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_classe_cond" name="classe_cond" onChange="nm_campos_between(document.getElementById('id_vis_classe'), this, 'classe')">
      ...
      <br><span id="id_hide_classe"  <?php echo $str_hide_classe?>><?php
      if ($classe != "")
      {
      $classe_look = (is_string($classe) ? substr($this->Db->qstr($classe), 1, -1) : $classe); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_markup_cond" name="id_markup_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_markup'), this, 'id_markup')">
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_markup_cond" name="markup_cond" onChange="nm_campos_between(document.getElementById('id_vis_markup'), this, 'markup')">
