<?php
@session_start() ;
$_SESSION['scriptcase']['grid_classe']['sc_process_barr'] = true;
require_once('../grid_classe/index.php');
unset($_SESSION['scriptcase']['grid_classe']['sc_process_barr']);
$ExportCtrl = new grid_classe_export_control;
$ExportCtrl->Export_barr();

class grid_classe_export_control
{
