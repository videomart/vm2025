<?php
@session_start() ;
$_SESSION['scriptcase']['grid_markup']['sc_process_barr'] = true;
require_once('../grid_markup/index.php');
unset($_SESSION['scriptcase']['grid_markup']['sc_process_barr']);
$ExportCtrl = new grid_markup_export_control;
$ExportCtrl->Export_barr();

class grid_markup_export_control
{
