...
//
   ...
   $_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_perfil']          = "vmdata_con";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
/*NM*/            $_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          db_conect_devel($_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 2, $this->force_db_utf8); 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_control_2fa_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8);
    }
    else {
