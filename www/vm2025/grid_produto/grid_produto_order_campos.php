<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_produto']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["modelo"] : "MODELO";
   $tab_ger_campos['venda'] = "on";
   $tab_def_campos['venda'] = "VENDA";
   $tab_labels["venda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["venda"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["venda"] : "VENDA U$";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["sc_field_0"] : "VENDA R$";
   $tab_ger_campos['id_classe'] = "on";
   $tab_def_campos['id_classe'] = "ID_CLASSE";
   $tab_labels["id_classe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["id_classe"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["id_classe"] : "CLASSE";
   $tab_ger_campos['id_marca'] = "on";
   $tab_def_campos['id_marca'] = "ID_MARCA";
   $tab_labels["id_marca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["id_marca"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["id_marca"] : "MARCA";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "DESCRICAO";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["descricao"] : "DESCRICAO";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "DATA";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["data"] : "DATA";
   $tab_ger_campos['sc_field_0'] = "none";
   $tab_ger_campos['descricao'] = "none";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> produto</TITLE>
