<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_produto']['glo_nm_perfil']          = "vmdata_con";
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_produto']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_produto']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_produto']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_produto']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_produto']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            $_SESSION['sc_session'][$this->sc_page]['grid_produto']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            $_SESSION['sc_session'][$this->sc_page]['grid_produto']['link_info']['margin_top'] = $link_margin_top;
        }
      ...
      if (isset($_POST['nm_grid_submit']) && $_POST['nm_grid_submit'] == 1 && isset($_SESSION['sc_session'][$this->sc_page]['grid_produto']['csrf_token'] ) && !isset($_SESSION['sc_session'][$this->sc_page]['grid_produto']['embutida']) && !isset($_SESSION['sc_session'][$this->sc_page]['grid_produto']['embutida_form'])) {
          if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] != $_SESSION['sc_session'][$this->sc_page]['grid_produto']['csrf_token']) {
              echo "<html>";
              echo "<body>";
              echo "<table align=\"center\" width=\"50%\" border=1 height=\"50px\">";
              echo "<tr>";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_produto']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_produto']['csrf_token']))
       {
           $_SESSION['sc_session'][$this->sc_page]['grid_produto']['csrf_token'] = $this->scCsrfGenerateToken();
       }

       return $_SESSION['sc_session'][$this->sc_page]['grid_produto']['csrf_token'];
   }
   ...
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          if (isset($dolar)) 
          {
              ...
              nm_limpa_str_grid_produto($_SESSION["dolar"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_produto']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_produto']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " produto";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  unset($_SESSION['sc_session'][$script_case_init]['grid_produto']['using_summary_cache']);
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_produto']['skip_summary'] = false;
      if ('chart' == $this->Ini->SC_module_export) {
          $_SESSION['sc_session'][$script_case_init]['grid_produto']['skip_summary'] = true;
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_produto']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "modelo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "venda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "sc_field_0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "id_classe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "id_marca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "descricao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "data";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_produto_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_refresh'] = true;
          } 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['using_summary_cache']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_refresh'] = true;
      } 
      ...
      if ('gantt' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] && 'inicio' == $_GET['nmgp_opcao']) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] = 'inicio';
      }
//
      ...
      { 
       ...
       if (!$GLOBALS['nm_restore_grid_save']) { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] = "";
       }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['contr_total_geral'] = "NAO";
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_produto/grid_produto_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_produto_res_xls.class.php"); 
          } 
          $this->xls  = new grid_produto_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_produto/grid_produto_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_produto_res_xml.class.php"); 
          } 
          $this->xml  = new grid_produto_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_produto/grid_produto_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_produto_res_json.class.php"); 
          } 
          $this->json  = new grid_produto_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_produto/grid_produto_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_produto_res_csv.class.php"); 
          } 
          $this->csv  = new grid_produto_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_produto/grid_produto_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_produto_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_produto_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
    if (isset($_POST['chartapp_action']) && 'Y' == $_POST['chartapp_action']) {
        if (isset($_POST['chartapp_chart_type']) && 'Y' == $_POST['chartapp_chart_type'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_info'][$_POST['chart_md5']])) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida']) {
                require_once($this->Ini->path_embutida . "grid_produto" . $this->Ini->Apl_resumo);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo);
            }
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_app_change_type'] = true;
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_app_md5'] = $_POST['chart_md5'];
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_app_type'] = $_POST['chart_type'];
      ...
      { 
          ...
          { 
              if (isset($_POST['summary_chart_data']) && 'Y' == $_POST['summary_chart_data'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_data($_POST['chart_md5']);
              }
              elseif (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['dashboard_refresh_after_chart'])) {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_produto/grid_produto_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_produto_det.class.php"); 
              } 
              $this->det  = new grid_produto_det();
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_produto']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] . ")"; 
              }
          }
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "VENDA", $arg_search, str_replace(",", ".", $data_search));
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] . ")";
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_grid'])) 
      {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date']))
      {
          $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date'];
          $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date1'];
      }
   ...
   function SC_lookup_id_classe($condicao, $campo)
   {
       ...
       $nm_comando = "SELECT CLASSE, ID FROM classe WHERE (#cmp_iCLASSE#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos$Ctrl_sql_escape)"; 
       if ($condicao == "ii")
       {
   ...
   function SC_lookup_id_marca($condicao, $campo)
   {
       ...
       $nm_comando = "SELECT MARCA, ID FROM marca WHERE (#cmp_iMARCA#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos$Ctrl_sql_escape)"; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE '%#arg_i" . $campo . "#arg_f%'", "LIKE '#arg_i" . $campo . "#arg_f%'", $nm_comando);
       }
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $Cmps_check_return = array('id_classe','id_marca');
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmps_numeric = array();
       $cmps_numeric[] = "id_classe";
       $cmps_numeric[] = "id_marca";
       $range_bw = array();
       if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($Parms))
       {
           $Parms = NM_conv_charset($Parms, $_SESSION['scriptcase']['charset'], "UTF-8");
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               {
                   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date']))
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
           }
           elseif ($prep == "" && $delim != "")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_fast'] . ")";
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> produto :: Doc</TITLE>
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto'][$path_doc_md5][1] = "grid_produto_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_produto']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_produto']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_VM2025'])) {
               $_SESSION['scriptcase']['grid_produto']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_VM2025'];
           }
       }
   }
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_produto']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_produto']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_produto']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_produto']['Sc_seq_det'] = $Sc_seq_det;
       } 
