...
$_SESSION['scriptcase']['grid_produto']['contr_erro'] = 'off'; 
   ...
   {
             nmgp_Form_Num_Val($this->venda, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         $this->venda = NM_charset_to_utf8($this->venda);
         $this->venda = str_replace('<', '&lt;', $this->venda);
         $this->venda = str_replace('>', '&gt;', $this->venda);
         $this->Texto_tag .= "<td>" . $this->venda . "</td>\r\n";
   }
   //----- sc_field_0
   function NM_export_sc_field_0()
   {
             nmgp_Form_Num_Val($this->sc_field_0, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "1", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   function NM_export_id_classe()
   {
         ...
         $this->look_id_classe = str_replace('<', '&lt;', $this->look_id_classe);
         $this->look_id_classe = str_replace('>', '&gt;', $this->look_id_classe);
         $this->Texto_tag .= "<td>" . $this->look_id_classe . "</td>\r\n";
   }
   //----- id_marca
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> produto :: RTF</TITLE>
