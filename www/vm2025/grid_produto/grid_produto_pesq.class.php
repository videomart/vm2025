...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_produto_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_produto_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            ...
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
             ...
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               ...
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "DF":     // 
               ...
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "GE":     // 
               ...
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "LT":     // 
               ...
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "LE":     // 
               ...
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "EP":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
            ...
            case "NE":     // 
               ...
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> produto</TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_classe_cond#NMF#' + search_get_sel_txt('SC_id_classe_cond') + '@NMF@';
  str_out += 'SC_id_classe#NMF#' + search_get_select('SC_id_classe') + '@NMF@';
  str_out += 'SC_id_marca_cond#NMF#' + search_get_sel_txt('SC_id_marca_cond') + '@NMF@';
  str_out += 'SC_id_marca#NMF#' + search_get_select('SC_id_marca') + '@NMF@';
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> produto</div>
...
<?php
   ...
   {
      global 
             $id_classe_cond, $id_classe,
             $id_marca_cond, $id_marca,
      ...
      { 
          ...
          $id_classe = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_classe']; 
          $id_classe_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_classe_cond']; 
          $id_marca = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_marca']; 
          $id_marca_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_marca_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_classe_cond) || empty($id_classe_cond))
      {
         $id_classe_cond = "eq";
      }
      if (!isset($id_marca_cond) || empty($id_marca_cond))
      {
         $id_marca_cond = "eq";
      }
      ...
      $str_hide_id_classe = (in_array($id_classe_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_marca = (in_array($id_marca_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($id_classe)) ? strpos($id_classe, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_classe = substr($id_classe, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($id_marca)) ? strpos($id_marca, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_marca = substr($id_marca, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_id_classe_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_classe'])) ? $this->New_label['id_classe'] : "CLASSE"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_classe_cond" name="id_classe_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_classe" <?php echo $str_hide_id_classe?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_classe'])) ? $this->New_label['id_classe'] : "CLASSE";
 $nmgp_tab_label .= "id_classe?#?" . $SC_Label . "?@?";
...
?>
   <span id="idAjaxSelect_id_classe">
      <SELECT class="scFilterObjectOdd" id="SC_id_classe" name="id_classe"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_classe)
            {
                    $id_classe_sel = ($nm_opc_cod === $id_classe) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_classe_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_id_marca_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_marca'])) ? $this->New_label['id_marca'] : "MARCA"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_marca_cond" name="id_marca_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_marca" <?php echo $str_hide_id_marca?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_marca'])) ? $this->New_label['id_marca'] : "MARCA";
 $nmgp_tab_label .= "id_marca?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_id_marca">
      <SELECT class="scFilterObjectEven" id="SC_id_marca" name="id_marca"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $id_marca)
            {
                    $id_marca_sel = ($nm_opc_cod === $id_marca) ? "selected" : "";
            }
            else
            {
            ...
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_marca_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_produto']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_produto']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_classe_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_id_classe'), document.F1.id_classe_cond, 'id_classe');
   document.F1.id_classe.value = "";
   document.F1.id_marca_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_id_marca'), document.F1.id_marca_cond, 'id_marca');
   document.F1.id_marca.value = "";
 }
...
<?php
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_id_classe_cond'] = 'cond';
      $tp_fields['SC_id_classe'] = 'select';
      $tp_fields['SC_id_marca_cond'] = 'cond';
      $tp_fields['SC_id_marca'] = 'select';
   ...
   {
      global $id_classe_cond, $id_classe,
             $id_marca_cond, $id_marca, $nmgp_tab_label;
      ...
      $id_classe_cond_salva = $id_classe_cond; 
      if (!isset($id_classe_input_2) || $id_classe_input_2 == "")
      {
          $id_classe_input_2 = $id_classe;
      }
      $id_marca_cond_salva = $id_marca_cond; 
      if (!isset($id_marca_input_2) || $id_marca_input_2 == "")
      {
          $id_marca_input_2 = $id_marca;
      }
      $tmp_pos = (is_string($id_classe)) ? strpos($id_classe, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $id_classe;
          ...
          $L_lookup = substr($id_classe, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['psq_check_ret']['id_classe'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "CLASSE : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = (is_string($id_marca)) ? strpos($id_marca, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $id_marca;
          ...
          $L_lookup = substr($id_marca, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['psq_check_ret']['id_marca'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "MARCA : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_classe'] = $id_classe; 
      if (is_array($id_classe) && !empty($id_classe))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['val'][0] = $id_classe;
      }
      elseif ($id_classe_cond_salva == "nu" || $id_classe_cond_salva == "nn" || $id_classe_cond_salva == "ep" || $id_classe_cond_salva == "ne" || !empty($id_classe))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['val'][0][0] = $id_classe;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_classe_cond'] = $id_classe_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['cmp'] = "id_classe"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['opc'] = $id_classe_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq']['id_classe'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_marca'] = $id_marca; 
      if (is_array($id_marca) && !empty($id_marca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['val'][0] = $id_marca;
      }
      elseif ($id_marca_cond_salva == "nu" || $id_marca_cond_salva == "nn" || $id_marca_cond_salva == "ep" || $id_marca_cond_salva == "ne" || !empty($id_marca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['val'][0][0] = $id_marca;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca']['id_marca_cond'] = $id_marca_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['cmp'] = "id_marca"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid]['opc'] = $id_marca_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq']['id_marca'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      ...
      $this->cmp_formatado['id_classe'] = $Conteudo;
      $this->cmp_formatado['id_classe'] = "'" . $this->cmp_formatado['id_classe'] . "'";
      if (isset($this->cmp_formatado['id_classe_input_2'])  && !empty($this->cmp_formatado['id_classe_input_2'])) {
          $this->cmp_formatado['id_classe_input_2'] = "'" . $this->cmp_formatado['id_classe_input_2'] . "'";
      }
      $Conteudo = $id_marca;
      if (strpos($Conteudo, "##@@") !== false)
      {
      ...
      $this->cmp_formatado['id_marca'] = $Conteudo;
      $this->cmp_formatado['id_marca'] = "'" . $this->cmp_formatado['id_marca'] . "'";
      if (isset($this->cmp_formatado['id_marca_input_2'])  && !empty($this->cmp_formatado['id_marca_input_2'])) {
          $this->cmp_formatado['id_marca_input_2'] = "'" . $this->cmp_formatado['id_marca_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($id_classe))
      {
         $this->monta_condicao("ID_CLASSE", $id_classe_cond, $id_classe, "", "id_classe", "SMALLINT UNSIGNED", false);
      }
      ...
      if (isset($id_marca))
      {
         $this->monta_condicao("ID_MARCA", $id_marca_cond, $id_marca, "", "id_marca", "SMALLINT UNSIGNED", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "id_classe" : return ('class="scFilterObjectOdd"'); break;
         case "id_marca" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
...
$sc_field_0 = $venda  * $this->sc_temp_dolar;
