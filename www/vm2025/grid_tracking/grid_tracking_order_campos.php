...
<?php
   ...
   $Ord_Cmp = new grid_tracking_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tracking_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['job'] = "JOB";
   $tab_labels["job"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["job"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["job"] : "JOB";
   $tab_ger_campos['ordem'] = "on";
   $tab_def_campos['ordem'] = "ORDEM";
   $tab_labels["ordem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["ordem"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["ordem"] : "ORDEM";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "STATUS";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["status"] : "STATUS";
   $tab_ger_campos['modelo'] = "on";
   $tab_def_campos['modelo'] = "MODELO";
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["modelo"] : "MODELO";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "DESCRICAO";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["descricao"] : "DESCRICAO";
   $tab_ger_campos['qtd'] = "on";
   $tab_def_campos['qtd'] = "QTD";
   $tab_labels["qtd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["qtd"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["qtd"] : "QTD";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "VENDEDOR";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["vendedor"] : "VENDEDOR";
   $tab_ger_campos['data_venda'] = "on";
   $tab_def_campos['data_venda'] = "DATA_VENDA";
   $tab_labels["data_venda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["data_venda"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["data_venda"] : "DATA_VENDA";
   $tab_ger_campos['id_dealer'] = "on";
   $tab_def_campos['id_dealer'] = "ID_DEALER";
   $tab_labels["id_dealer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["id_dealer"])) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['labels']["id_dealer"] : "Dealer";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tracking']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tracking']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_tracking']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tracking_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tracking']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
