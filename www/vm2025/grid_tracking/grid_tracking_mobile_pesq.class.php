...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data_venda';$Nm_datas[] = 'data_entrega';$Nm_datas[] = 'data_compra';$Nm_datas[] = 'data_prevista';$Nm_datas[] = 'data_recebimento';$Nm_numeric[] = "job";$Nm_numeric[] = "id_dealer";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_dealer_cond" name="dealer_cond" onChange="nm_campos_between(document.getElementById('id_vis_dealer'), this, 'dealer')">
       <OPTION value="qp" <?php if ("qp" == $dealer_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_dealer"  <?php echo $str_hide_dealer?>>
<?php
...
?>
   <span id="idAjaxSelect_dealer">
      <SELECT class="scFilterObjectEven " id="SC_dealer" name="dealer" onChange="nm_submit_form();" size="1">
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "dealer" : return ('class="scFilterObjectEven "'); break;
         default       : return ("");
      }
   }
