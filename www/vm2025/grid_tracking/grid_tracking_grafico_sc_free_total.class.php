...
SCEOT;
        ...
        $this->SC_APP_info = [
            'chart' => [
                ...
                'json_filename' => "sc_fc_grid_tracking_{$chartMd5}.json",
    ...
    function info_loadMd5Info($chartMd5)
    {
        ...
        $this->SC_APP_data['md5_data'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] [$chartInfo] [$chartMd5];
    ...
    {
        $this->SC_APP_data['type'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'];
        $this->SC_APP_data['data_mode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['graf_opc_atual'];

        $this->SC_APP_data['width'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_larg'];
        $this->SC_APP_data['height'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_alt'];

        $this->SC_APP_data['order'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['graf_order'];

        $this->SC_APP_info['types'] ['area'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_forma'];
        $this->SC_APP_info['types'] ['area'] ['stacking'] = 'Off' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_empil'];
        $this->SC_APP_info['types'] ['area'] ['isScroll'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_is_scroll'];

        $this->SC_APP_info['types'] ['bar'] ['orientation'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_orien'];
        $this->SC_APP_info['types'] ['bar'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_dimen'];
        $this->SC_APP_info['types'] ['bar'] ['stacking'] = 'Off' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_empil'];
        $this->SC_APP_info['types'] ['bar'] ['stack100Percent'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_empil'] ? '1' : '0';
        $this->SC_APP_info['types'] ['bar'] ['seriesMode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_agrup'];
        $this->SC_APP_info['types'] ['bar'] ['isScroll'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_scroll'];
        $this->SC_APP_info['types'] ['bar'] ['isOverlapped'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_overlapped'];

        $this->SC_APP_info['types'] ['funnel'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_funil_dimen'];

        $this->SC_APP_info['types'] ['gauge'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_gauge_forma'];

        $this->SC_APP_info['types'] ['line'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_forma'];
        $this->SC_APP_info['types'] ['line'] ['seriesMode'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_agrup'];
        $this->SC_APP_info['types'] ['line'] ['isScroll'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_scroll'];
        $this->SC_APP_info['types'] ['line'] ['isZoom'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_zoom'];

        $this->SC_APP_info['types'] ['pie'] ['format'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_forma'];
        $this->SC_APP_info['types'] ['pie'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_dimen'];
        $this->SC_APP_info['types'] ['pie'] ['order'] = strtolower($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_orden']);
        $this->SC_APP_info['types'] ['pie'] ['showPercentValues'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_valor'];

        $this->SC_APP_info['types'] ['pyramid'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pyram_dimen'];
        $this->SC_APP_info['types'] ['pyramid'] ['showPercentValues'] = 'Percent' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pyram_valor'];
        $this->SC_APP_info['types'] ['pyramid'] ['isSliced'] = 'S' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pyram_forma'];

        $this->SC_APP_info['types'] ['combination'] ['dimension'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_combi_dimen'];
    }
    ...
    {
        if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['has_limit_chart_items']) {
            if ('' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['limit_chart_items'] && '0' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['limit_chart_items']) {
                $this->SC_APP_data['limit_chart_items'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['limit_chart_items'];
    ...
    function info_createFusionChartsData_json_data_singleSeries()
    {
        ...
        $displayValues = [];
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['chart_display_values'] as $thisDisplayValue) {
    ...
    function info_createFusionChartsData_json_data_combinationSeries()
    {
        ...
        $renderAs = [];
        $displayValues = [];
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['comb_field_display_type'] as $thisRenderAs) {
    ...
    function display_chartApp_type($chartMd5, $chartType, $chartTitle)
    {
        ...
        $ajaxResponse = [
            ...
            'chartUrl' => "{$this->SC_APP_info['chart'] ['json_base_url']}sc_fc_grid_tracking_{$chartMd5}.json",
            'chartMd5' => $chartMd5,
...
SCEOT;
    ...
    function display_summaryChart_inline_initialAjaxCall($chartMd5)
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_tracking/index.php";
...
SCEOT;
    ...
    function display_summaryChart_inline_initialAjaxResponse($chartMd5)
    {
        ...
        if ('' != $chartMd5 && isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['chart_info'] [$chartMd5])) {
    ...
    function display_summaryChart_data($chartMd5)
    {
        ...
        $chartFile = "{$this->SC_APP_info['chart'] ['json_base_dir']}sc_fc_grid_tracking_{$chartMd5}.json";
...
SCEOT;
    ...
    {
        $scPage = NM_encode_input($this->Ini->sc_page);
        $ajaxUrl = "{$this->Ini->path_link}grid_tracking/grid_tracking_config_graf_flash.php?nome_apl=grid_tracking&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br";
        $ajaxUrlDrillDown = "{$this->Ini->path_link}grid_tracking/index.php";
...
SCEOT;
    ...
    function aux_createSummaryCss()
    {
        ...
        $cssFileName = $this->Ini->path_imag_temp . '/sc_css_grid_tracking_sum_' . $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['num_css'] . '.css'; 
        $cssFilePointer = @fopen($this->Ini->root . $cssFileName, 'w');

        if (($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb") {
    ...
    function aux_getChartErrorMessage()
    {
        ...
        //return $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] . ' - ' . $dimensionCount . ' - ' . $metricCount;

        switch ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo']) {
            case 'Bubble':
                    if (3 != $metricCount) {
            ...
            case 'Treemap':
                ...
                break;
            default:
                //return $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'];
                break;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['opcao']) {
            return true;
        }
    ...
    {
        return $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['responsive_chart'] ['active'];
    }
    ...
    {
        $this->tempSortField = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['chart_combination_order_field'];
        $this->tempSortRule = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['chart_combination_order_rule'];
    ...
    function aux_setChartType($chartType)
    {
        switch ($chartType) {
            ...
            case 'msbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_orien'] = 'Horizontal';
            ...
            case 'msbar3d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Bar';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_orien'] = 'Horizontal';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_dimen'] = '3d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'stackedbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_orien'] = 'Horizontal';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_dimen'] = '2d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_empil'] = 'On';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'scrollbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_dimen'] = '2d';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_scroll'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_overlapped'] = false;
                break;
            ...
            case 'overlappedbar2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_barra_is_overlapped'] = true;
                break;
            ...
            case 'line':
            case 'msline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Line';
            ...
            case 'msspline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_forma'] = 'Spline';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;
            ...
            case 'msstepline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_forma'] = 'Step';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;
            ...
            case 'scrollline2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_scroll'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_zoom'] = false;
                break;
            ...
            case 'zoomline':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Line';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_scroll'] = false;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_linha_is_zoom'] = true;
                break;
            ...
            case 'area2d':
            case 'msarea':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Area';
            ...
            case 'mssplinearea':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_forma'] = 'Spline';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_is_scroll'] = false;
                break;
            ...
            case 'scrollarea2d':
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_forma'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_empil'] = 'Off';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_is_scroll'] = true;
                break;
            ...
            case 'stackedarea2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_forma'] = 'Area';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_empil'] = 'On';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_area_is_scroll'] = false;
                break;

            // pie
            case 'pie2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Pie';
            ...
            case 'pie3d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_forma'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_dimen'] = '3d';
                break;

            case 'doughnut2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Pie';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_forma'] = 'Donut';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pizza_dimen'] = '2d';
                break;
            ...
            // gauge
            case 'angulargauge':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Gauge';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_gauge_forma'] = 'Circular';
                break;

            case 'semicirculargauge':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Gauge';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_gauge_forma'] = 'Semicircular';
                break;

            case 'hlineargauge':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Gauge';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_gauge_forma'] = 'LinearGauge';
                break;

            // heatmap
            case 'heatmap':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Heatmap';
                break;

            // treemap
            case 'treemap':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Treemap';
                break;

            // chord
            case 'chord':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Chord';
                break;

            // sankey
            case 'sankey':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Sankey';
                break;

            // sunburst
            case 'sunburst':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Sunburst';
                break;

            // pyramid
            case 'pyramid':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Pyramid';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pyram_dimen'] = '3d';
                break;

            case 'pyramid2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Pyramid';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_pyram_dimen'] = '2d';
                break;

            // funnel
            case 'funnel':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Funnel';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_funil_dimen'] = '3d';
                break;
            ...
            // radar
            case 'radar':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Radar';
                break;

            // scatter
            case 'scatter':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Scatter';
                break;

            // bubble
            case 'bubble':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Bubble';
                break;

            // combination
            case 'mscombidy2d':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Combination';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_combi_dimen'] = '2d';
                break;

            case 'mscolumn3dlinedy':
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_tipo'] = 'Combination';
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_tracking'] ['cfg_graf'] ['graf_combi_dimen'] = '3d';
                break;
        }
    }
   ...
   function monta_grafico($chart_key = '', $operation = 'chart', $graf_col = false)
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf'];
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_opc_atual'] == 1)
       {
           $this->sc_graf_sint = true;
       }
       ...
       {
           $b_export = true;
           $chart_key = key($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts']);
       }
       elseif ('' == $chart_key)
       {
       ...
       if ($graf_field)
       {
           ...
           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field]['graf_pyram_forma'],
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']               = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking'][$field];
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_order'];
           $this->grafico_flash($arr_param, $this->grafico_dados($chart_data, $arr_param['export'], ''), $mode);
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$chart_key]))
       {
           $chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$chart_key];

           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_pyram_forma'],
               'tit_datay'   => $chart_data['label_y'],
               'tit_label'   => $chart_data['label_x'],
               'tit_chart'   => $chart_data['title'],
           ...
           elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_full'])
           {
               $mode = 'full';
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_full']);
           }
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_bot']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_bot'])
           {
               $mode = 'full';
           }
           elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_first'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_first'] = false;
               $mode = array('js', 'chart');
           }
           else
           {
           ...
           elseif ((!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_bot']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_bot']))
           {
               exit;
           }
       }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- 
   ...
   function monta_arrays()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_total']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_total'] as $label => $valor)
          {
          ...
          if (!$this->sc_graf_sint)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_linhas'] as $cada_elemento)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_linhas']))
      {
          if ($this->campo > 0)
          {
              $lab_quebra    = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_linhas'][$this->campo][0], 1);
              $lab_quebra    = str_replace("&nbsp;", "", $lab_quebra);
              $this->titulo .= " - " . $this->label[$this->nivel] . " = " . $lab_quebra;
          }
          if ($this->campo > 0)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_linhas'][$this->campo] as $ind => $valor)
              {
                  if ($ind > 0)
                  {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['del_graph_col']))
      {
          ...
          {
              $tst_ind = $ind + 1;
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['del_graph_col'][$tst_ind]))
              {
...
//
   function grafico_col($campo_grafico)
   {
     ...
     if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_lab']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_lab']))
     {
         $this->calcula_graf_col();
     }
     if ($campo_grafico == "status")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['using_column_chart'] = "status";
         $array_lab        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_lab']['status'];
         $array_val[" "] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_val']['status'];
         $this->Decimais = 0;
         $graf_lab  = "STATUS";
         $graf_val  = "STATUS";
         $pos = true;
...
//
   ...
   {
     $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_lab'] = array();
     $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_val'] = array();
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $this->sc_proc_grid = true;
// GROUP BY STATUS
     $nmgp_select = "SELECT STATUS, COUNT(STATUS) FROM " . $this->Ini->nm_tabela; 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['where_pesq']; 
     $nmgp_select .= " GROUP BY STATUS"; 
     ...
     while (!$rs_graf->EOF) 
     {  
         $status = $rs_graf->fields[0] ;  
         $count_status = $rs_graf->fields[1] ;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_lab']['status'][] = trim($status); 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_val']['status'][] = $count_status; 
         $rs_graf->MoveNext();
     }  
     $rs_graf->Close();
   }
//
   function storeCombinationTable($arr_series)
   {
       foreach ($arr_series as $serie_data)
       {
           if ($serie_data['comb'])
           {
               $this->storeCombinationTableSerie($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['comb_table_data'], $serie_data, $serie_data['param']);
           }
       }
   }
   ...
   function storeCombinationTableSerieData(&$comb_data, $serie_data)
   {
       foreach ($serie_data['db_values'] as $index => $dbval)
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['comb_table_def']['field'][ $serie_data['summ_idx'] ] = $serie_data['field_y'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['comb_table_def']['label'][ $serie_data['summ_idx'] ] = $serie_data['name'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['comb_table_def']['summ'][ $serie_data['summ_idx'] ]  = $serie_data['summ_idx'];
       }
   }
   ...
   function storeAnalyticTable($arr_series)
   {
       foreach ($arr_series as $serie_data)
       {
           $this->storeAnaliticTableSerie($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['anlt_table_data'], $serie_data);
       }
   }

   function storeAnaliticTableSerie(&$comb_data, $serie_data)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['anlt_table_def']['field'][ $serie_data['name'] ] = $serie_data['field_y'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['anlt_table_def']['label'][ $serie_data['name'] ] = $serie_data['name'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['anlt_table_def']['summ'][ $serie_data['name'] ]  = $serie_data['summ_idx'];
   ...
   function grafico_flash($arr_param, $arr_charts, $html_par = 'full')
   {
      global $nm_saida, $nm_retorno_graf;
         $Ind_groupby = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['SC_Ind_Groupby'];
         $this->orderCharts($arr_charts, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_order']);
...
<?php
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['phantomjs_export_process']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['phantomjs_export_process'])
         {
             return;
         }
...
<?php
   ...
   {
       $sChartTheme = '__app';
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['using_column_chart']) && "status" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['using_column_chart'])
       {
       $sChartTheme = '__app';
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['using_column_chart']);
       }
       if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['opcao'] == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['opcao'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       {
           $sChartTheme = 'scriptcase__NM__sc_GrayScale.php';
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['export_print_bw']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['export_print_bw'])
       {
           $sChartTheme = 'scriptcase__NM__sc_GrayScale.php';
       }
       $prjFallback = '';
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       $chart_attr_j['showValues'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_exibe_val'];

       $bDisableLinks = false;
       $b_dual_axys   = false;
       if ($is_combinat)
       {
           if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['chart_combination_type'], array('angulargauge', 'hlineargauge', 'msstepline', 'stackedarea', 'stackedbar2d', 'stackedbar3d', 'stackedcolumn2d', 'stackedcolumn3d')))
           {
               $bDisableLinks = true;
           }
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_font']))
       {
           $chart_attr_j['baseFontSize'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_font'];
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['chartpallet']) && false == $chart_theme)
       {
           $chart_attr_j['palette'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['chartpallet'];
       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['this_chart_label'] = $chart_attr_j['caption'];
       if (isset($chart_attr_j['subCaption']) && '' != $chart_attr_j['subCaption']) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['this_chart_label'] .= $chart_attr_j['subCaption'];
       }
       ...
       elseif (1 < sizeof($arr_series) || 'Radar' == $tipo || 'Step' == $arr_param['linha_forma'] || $is_combinat)
       {
           ...
           foreach ($arr_series as $i_serie => $arr_serie)
           {
               ...
               if ($is_combinat)
               {
                   if (isset($arr_serie['summ_idx']) && !empty($arr_serie['summ_idx']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ]))
                   {
                       $a_dataset['renderas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ];
                   }
...
<?php
   ...
   function grafico_flash_config_js()
   {
      ...
      $sUrlConfigSave = $this->Ini->path_link . "grid_tracking/grid_tracking_config_graf_flash.php?nome_apl=grid_tracking&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br";
      ...
      $nm_saida->saida("          nome_apl: \"grid_tracking\",\r\n");
   ...
   function grafico_flash_config_div()
   {
      ...
      $aChartDisp        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_disp'])      && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_disp']))    ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_disp']      : array('Bar', 'Pie', 'Line', 'Area');
      $sChartType        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_tipo'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_tipo'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_tipo']      : 'Bar';
      $iSinteticAnalitic = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_opc_atual']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_opc_atual']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_opc_atual'] : '2';
      $iChartWidth       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_larg'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_larg'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_larg']      : '800';
      $iChartHeight      = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_alt'])       && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_alt'])       ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cfg_graf']['graf_alt']       : '500';
      $sChartOrder       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_order'])     && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_order'])     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['graf_order']     : '';
...
if (!$_SESSION['scriptcase']['proc_mobile']) {
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['skip_charts']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['skip_charts']) {
          return;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['bmulti'] = $bMulti;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['bcomb']  = $bComb;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['phantomjs_export_process']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['phantomjs_export_process'])
      {
 ...
 { 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['responsive_chart']['active']) {
              $summary_width  = '100%';
              $summary_height = '85%';
          }
          else {
      ...
      {
         if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['charts_html']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['charts_html'])
         {
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['charts_html'] .= $sPDFHtmlCall;
      }
   }
   ...
   function generatePhantom($sFileLocal, $width, $height, $bMulti, $bComb)
   {
          ...
          $sTmpId       = md5($sTmpId . 'grid_tracking');
          $sImageName   = 'sc_pjs_png_' . $sTmpId . '.png';
          $sImageUrl    = $_SESSION['scriptcase']['grid_tracking']['glo_nm_path_imag_temp'] . '/' . $sImageName;
          $sImageFile   = $this->Ini->root . $sImageUrl;
          $sPDFHtmlCall = "";
          $sAppDir      = getcwd();
          $aOS          = $this->Ini->getRunningOS();
          $sPhantomCmd  = 'phantomjs --ignore-ssl-errors=true "' . $this->Ini->root . $_SESSION['scriptcase']['grid_tracking']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js"';
          $iJsDelay     = 150;
          if ('win' != $aOS['os'])
          {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['phantomjs_export_file'] = $sImageName;
          return $sImageUrl;
   }
   function generatePhantomJs($sTmpId, $sImageFile, $iDelay)
   {
       $server_phanton = $this->Ini->server_pdf;
       $fPhantomJs = @fopen($this->Ini->root . $_SESSION['scriptcase']['grid_tracking']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js', 'w');
   ...
   {
       $fPhantomChart = @fopen($this->Ini->root . $_SESSION['scriptcase']['grid_tracking']['glo_nm_path_imag_temp'] . '/sc_pjs_php_' . $sTmpId . '.html', 'w');
   ...
   function grafico_dados($cht_data, $export, $chart_key)
   {
       ...
       if ('Y' != $export)
       {
           if (isset($cht_data['combination']) && $cht_data['combination'])
           {
               ...
               foreach ($cht_data['charts'] as $s_comb_chart_index)
               {
                   if (empty($label))
                   {
                       $label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['labels'];
                   }
                   if (empty($dbval))
                   {
                       $dbval = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['db_values'];
                   }
                   if (empty($lbord))
                   {
                       $lbord = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['label_order'];
                   }
                   if (empty($param))
                   {
                       $param = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['param'];
                   }
                   if ('' == $name)
                   {
                       $name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['label_x'];
                   }
                   if ('' == $fld_x)
                   {
                       $fld_x = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['field_x'];
                   }
                   if ('' == $subt)
                   {
                       $subt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['subtitle'];
                   }
                   if ('' == $legnd && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['legend']))
                   {
                       $legnd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['legend'];
                   }
                   $fld_y[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['field_y'];
                   $lab_y[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['label_y'];
                   $sum_i[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['summ_idx'];
                   $sum_f[]         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['summ_fn'];
                   $fmt[]           = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['format'];
                   $datay['anal'][] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['values']['sint'][0];
                   $tmp_xml_links   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'][$s_comb_chart_index]['xml_links'];
       ...
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['pivot_charts'] as $chart_index => $chart_data)
           {
   ...
   function getChartRenderer($bMulti, $bComb)
   {
       ...
       {
           $tmp_count = 0;
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['summarizing_fields_order'][$Ind_groupby] as $i_sum)
           {
               if ('' != $i_sum && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['summarizing_fields_display'][$Ind_groupby][$i_sum]))
               {
                   $d_sum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['summarizing_fields_display'][$Ind_groupby][$i_sum];
                   if ($d_sum['display'])
                   {
                       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['summarizing_fields_control'][$Ind_groupby] as $l_field => $d_field)
                       {
           ...
           switch ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['chart_combination_type']) {
               case 'angulargauge':
       ...
       $sChart = '';
       $sMulti = $bMulti ? 'MS' : '';
       switch ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_tipo'])
       {
           case 'Bar':
               if ('Horizontal' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_barra_orien'])
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       $sChart .= 'StackedBar';
                       $sChart .= '3d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_barra_dimen']  ? '3D' : '2D';
                   }
                   else
                   {
                       $sChart .= $sMulti . 'Bar';
               ...
               else
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       ...
                       $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_barra_dimen'] ? '2D' : '3D';
                   }
                   else
                   {
               ...
               break;
           case 'Pie':
               if ('Pie' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_pizza_forma'])
               {
                   $sChart .= 'Pie';
               }
               else
               ...
               $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_pizza_dimen'] ? '2D' : '3D';
               break;
           case 'Line':
               if ('Line' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_linha_forma'])
               {
                   $sChart .= $sMulti . 'Line';
               }
               elseif ('Spline' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_linha_forma'])
               {
               ...
               break;
           case 'Area':
               if ('Area' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_area_forma'])
               {
                   if ($bMulti)
                   {
                       $sChart .= $sMulti . 'Area';
   ...
   function getChartModule($sChartType = '')
   {
       if ('' == $sChartType)
       {
           $sChartType = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_tipo'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['parms_graf']['graf_tipo'] : "";
       }
       switch ($sChartType)
       {
           case 'Bar':
