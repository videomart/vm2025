<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tracking']['sc_process_barr'] = true;
require_once('../grid_tracking/index.php');
unset($_SESSION['scriptcase']['grid_tracking']['sc_process_barr']);
$ExportCtrl = new grid_tracking_export_control;
$ExportCtrl->Export_barr();

class grid_tracking_export_control
{
