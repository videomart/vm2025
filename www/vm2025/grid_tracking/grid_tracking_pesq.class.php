...
class grid_tracking_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data_venda';$Nm_datas[] = 'data_entrega';$Nm_datas[] = 'data_compra';$Nm_datas[] = 'data_prevista';$Nm_datas[] = 'data_recebimento';
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['proc_res'])) 
    {
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_tracking').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_tracking').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_tracking').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tracking</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tracking/grid_tracking_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_tracking_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tracking_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tracking_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tracking']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tracking']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['status']; 
          $status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['status_cond']; 
          $dealer = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['dealer']; 
          $dealer_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['dealer_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['NM_operador']; 
      } 
      if (!isset($status_cond) || empty($status_cond))
      {
         $status_cond = "eq";
      }
      if (!isset($dealer_cond) || empty($dealer_cond))
      {
         $dealer_cond = "qp";
      }
      ...
      $str_hide_dealer = (in_array($dealer_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($dealer)) ? strpos($dealer, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $dealer = substr($dealer, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Cotar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Comprar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Importar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Receber";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Entregar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Finalizar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'][] = "Concluido";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px; border-spacing: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="##@@Todos" onClick="nm_submit_form();" <?php if ("" == $status)  { echo " checked" ;} ?>>Todos</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Cotar##@@Cotar" onClick="nm_submit_form();" <?php if ("Cotar" == $status)  { echo " checked" ;} ?>>Cotar</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Comprar##@@Comprar" onClick="nm_submit_form();" <?php if ("Comprar" == $status)  { echo " checked" ;} ?>>Comprar</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Importar##@@Importar" onClick="nm_submit_form();" <?php if ("Importar" == $status)  { echo " checked" ;} ?>>Importar</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Receber##@@Receber" onClick="nm_submit_form();" <?php if ("Receber" == $status)  { echo " checked" ;} ?>>Receber</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Entregar##@@Entregar" onClick="nm_submit_form();" <?php if ("Entregar" == $status)  { echo " checked" ;} ?>>Entregar</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Finalizar##@@Finalizar" onClick="nm_submit_form();" <?php if ("Finalizar" == $status)  { echo " checked" ;} ?>>Finalizar</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_status" name="status" value="Concluido##@@Concluido" onClick="nm_submit_form();" <?php if ("Concluido" == $status)  { echo " checked" ;} ?>>Concluido</TD>
</TR></TABLE>
      ...
      <TD id='SC_dealer_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['dealer'])) ? $this->New_label['dealer'] : "DEALER"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_dealer_cond" name="dealer_cond" onChange="nm_campos_between(document.getElementById('id_vis_dealer'), this, 'dealer')">
       <OPTION value="qp" <?php if ("qp" == $dealer_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dealer" <?php echo $str_hide_dealer?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['dealer'])) ? $this->New_label['dealer'] : "DEALER";
 $nmgp_tab_label .= "dealer?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $dealer_look = (is_string($dealer) ? substr($this->Db->qstr($dealer), 1, -1) : $dealer); 
      $nmgp_def_dados = "" ; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['dealer'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['dealer'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_dealer">
      <SELECT class="scFilterObjectOdd" id="SC_dealer" name="dealer" onChange="nm_submit_form();" size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $dealer)
            {
                    $dealer_sel = ($nm_opc_cod === $dealer) ? "selected" : "";
            }
            else
            {
               $dealer_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $dealer_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if (is_file("grid_tracking_help.txt"))
   {
...
{
?>
<iframe id="nmsc_iframe_grid_tracking" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_tracking" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_tracking_pesq"  name="nm_iframe_grid_tracking_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 ...
 {
    document.F1.target = "nm_iframe_grid_tracking_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_tracking').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   for (i = 0; i < document.F1.status.length; i++)
   {
      ...
      {
          document.F1.status[i].checked = false;
      }
   }
   document.F1.dealer_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_dealer'), document.F1.dealer_cond, 'dealer');
   document.F1.dealer.value = "";
   document.F1.status_cond.selectedIndex = 0;
   document.F1.dealer_cond.selectedIndex = 0;
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function trata_campos()
   {
      global $status_cond, $status,
             $dealer_cond, $dealer, $nmgp_tab_label;
      ...
      $dealer_cond_salva = $dealer_cond; 
      if (!isset($dealer_input_2) || $dealer_input_2 == "")
      {
          $dealer_input_2 = $dealer;
      }
      $tmp_pos = (is_string($status)) ? strpos($status, "##@@") : false;
      if ($tmp_pos === false) {
          $L_lookup = $status;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['status'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($dealer, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['psq_check_ret']['dealer'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "DEALER : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['status'] = $status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['status_cond'] = $status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['dealer'] = $dealer; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['dealer_cond'] = $dealer_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca'] = $Temp_Busca;
      }
      ...
      if (strpos($this->cmp_formatado['status'], "##@@") !== false)
      {
          $this->cmp_formatado['status'] = substr($this->cmp_formatado['status'], strpos($this->cmp_formatado['status'], "##@@") + 4);
      }
      ...
      $this->cmp_formatado['dealer'] = $Conteudo;
      $this->cmp_formatado['dealer'] = "'" . $this->cmp_formatado['dealer'] . "'";
      if (isset($this->cmp_formatado['dealer_input_2'])  && !empty($this->cmp_formatado['dealer_input_2'])) {
          $this->cmp_formatado['dealer_input_2'] = "'" . $this->cmp_formatado['dealer_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($dealer))
      {
         $this->monta_condicao("DEALER", $dealer_cond, $dealer, "", "dealer", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tracking']['cond_pesq'] .= $this->NM_operador;
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "dealer" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
