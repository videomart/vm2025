...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_mailing"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_mailing"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mailing'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mailing']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mailing']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mailing']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mailing']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mailing']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mailing']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mailing']['embutida_filho'] as $ind => $sc_init)
          {
