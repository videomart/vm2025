<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mailing']['sc_process_barr'] = true;
require_once('../grid_mailing/index.php');
unset($_SESSION['scriptcase']['grid_mailing']['sc_process_barr']);
$ExportCtrl = new grid_mailing_export_control;
$ExportCtrl->Export_barr();

class grid_mailing_export_control
{
