...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____chart_leads"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____chart_leads"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_leads']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_leads']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_leads']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_leads']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_leads']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_leads']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_leads']['embutida_filho'] as $ind => $sc_init)
          {
