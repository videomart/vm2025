...
class chart_leads_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_leads'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_leads'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
           $this->nmgp_botoes[$BTN] = $BTN_opc;
       }
   }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_leads']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_leads']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_leads']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'ASSUNTO' => [
                    ...
                    'datatype' => 'varchar',
                    'lowercase' => 'assunto',
                    'summary_values_array' => 'array_total_assunto',
                    'summary_line_values_array' => 'array_line_assunto',
            ...
            'metric' => [
                'id-C' => [
                    ...
                    'is_rating' => '' != '',
                    'rating_function' => '',
                    'format_function' => 'aux_format_id_C',
                    'css_class' => "css_id_cnt_field",
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_group_by'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_x_axys'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_y_axys'] = [];

        $dimensionCount = 0;

        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_x_axys'] [] = $dimensionCount;
        ...
        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_y_axys'] [] = $dimensionCount;

            $dimensionCount++;
        }

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['dimension_order'] = [];
        foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
        }
    }

    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('sc_free_group_by' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['last_displayed_group_by'] = 'sc_free_group_by';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['heatmap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['treemap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chord_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['sankey_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['sunburst_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        if (!empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['SC_Gb_Free_cmp']) && empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_x_axys']) && empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_y_axys'])) {
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
            ...
            foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['SC_Gb_Free_cmp'] as $dimensionNameLower => $dimensionAppField) {
                ...
                $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;
                if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order_direction'] [$dimensionIndex]) || empty($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order_direction'] [$dimensionIndex])) {
                    $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order_direction'] [$dimensionIndex] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction_default'];
                }
                $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_order_direction'] [$dimensionIndex];

                if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_x_axys'])) {
                    $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
                }
                if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_y_axys'])) {
                    $this->SC_APP_info['group_by'] ['dimension'] ['y'] [] = $dimensionName;
                }
        ...
        foreach ($this->SC_APP_info['metric_by_index'] as $metricIndex => $metricName) {
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex])) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] = ['display' => false];
            }
        }
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summarizing_fields_order'] ['sc_free_group_by'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summarizing_fields_display'] ['sc_free_group_by'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_record_count'];
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length'];
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['summary_cache']);
        }
    }
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    let windowName = "chart_leads_chart_window" + (Math.floor(Math.random() * 100) + 1);
...
SCEOT;
    ...
    function display_pdf_charts()
    {
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_level']) {
                continue;
            }
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($chartInfo['info_type'] != $chartInfoType) {
                continue;
            } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_level']) {
                continue;
            }

            if ($this->progress_fp) {
                chart_leads_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            chart_leads_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...\n", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChartAppCharts()
    {
        ...
        if (1 < count($this->SC_APP_info['group_by'] ['metric'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['graf_opc_atual'] = 2;
        } else {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_md5_list'] = $this->SC_APP_data['chart_md5_list'];
    ...
    function aux_addChartAppGrandTotalChart()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@chart_leads@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['skip_charts']) {
            return false;
    ...
    function aux_format_id_C($value)
    {
        $isNegative = 0 > $value;
        $suffix = '';
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['chart_leads'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['chart_leads'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['chart_leads'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['opcao']) {
            return true;
        }
    ...
    {
        return $this->aux_isPdf() && $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['skip_summary'];
    }
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['comb_table_def'] = [
            'field' => [],
            'label' => [],
            'summ' => [],
        ];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['comb_table_data'] = [];

        foreach ($this->SC_APP_info['group_by'] ['metric'] as $i => $metricName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['comb_table_def'] ['field'] [] = $metricName;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['comb_table_def'] ['label'] [] = $this->SC_APP_info['metric'] [$metricName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['comb_table_def'] ['summ'] [] = $i;
        }

        $this->aux_storeSummaryTableInfo_recursive($_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['comb_table_data'], $this->SC_APP_data['ordered_y_axys'], 0, []);
    }
...
SCEOT;
    ...
    function generateChartImages()
    {
        ...
        $chartInfoType = $this->aux_getChartInfoType();
        $chartList = $_SESSION['sc_session'] [$this->Ini->sc_page] ['chart_leads'] ['chart_md5_list'];
        $chartFiles = array();

        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['phantomjs_export_process'] = true;
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_step']     = 'image';
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_total']++;
            }
        }
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['phantomjs_export_file'] = '';
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_count']++;
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['phantomjs_export_process'] = false;
    ...
    function zipChartImages($password = '')
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_step'] = 'zip';

        $this->writeProgressFile();

        $zipFile = $this->zipFileList($chartImages, $password);

        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_step'] = 'end';
    ...
    function writeProgressFile() {
        if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_total']}###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_step']) {
            $content = "ok###100";
        } else {
            $content = "init###0";
        }

        $f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_leads']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['export_progress_file']}", 'w');
        fwrite($f, $content);
        fclose($f);
    }
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_combination_type']        = 'column2d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_combination_order_rule']  = 'desc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_combination_order_rule_groupby']["assunto"]  = 'desc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_combination_order_field_groupby']["assunto"] = 'label';
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_search_add']);
          exit;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav'])
      {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_assunto = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_total_line']['assunto'];
            }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_total'][$cmp_gb];
          }
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_assunto = array();
                $this->totaliza();
                ...
                $this->array_line_assunto = $this->array_total_assunto;
                $forceFields = [];
                foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
                    $forceFields[] = $this->SC_APP_info['dimension'] [$dimensionName] ['lowercase'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_clear_total'] = true;
            }
          $this->array_total_assunto = array();
          $this->totaliza('main');
          if ($this->Tem_Res_Compara) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_total']['assunto'] = $this->array_total_assunto;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_total_line']['assunto'] = $this->array_line_assunto;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_array_resumo'] = "OK";
      }
      if ($this->aux_useNewSummary()) {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_change_type']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_change_type']) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['json_use_label'])
       {
          $Lab_assunto = "ASSUNTO";
       }
       else
       ...
       $prep_field = array();
       $prep_field['assunto'] = $Lab_assunto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['assunto'] = $Lab_assunto; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['id'] = "ID"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['assunto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['assunto'] = "ASSUNTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['data']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['labels']['data'] = "DATA"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "ID (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['assunto']['alin'] = "''";
       $Arr_parms['assunto']['link'] = "S";
       $Arr_parms['assunto']['fill'] = "true";
       $Arr_parms['assunto']['order'] = "label";
       $Arr_parms['assunto']['order_start'] = 'asc';
       $Arr_parms['assunto']['order_invert'] = 'false';
       $Arr_parms['assunto']['order_enabled'] = 'true';
       $Arr_parms['assunto']['order_datatype'] = 'varchar';
       $Arr_parms['assunto']['rating_function'] = '';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['assunto'] = array(0 => 'assunto', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_fill'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_leads@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'assunto' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("ID (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'assunto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_assunto)),
               'label_y'  => $this->getChartText(strip_tags("ID (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_leads_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_leads_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['anlt_table_def']  = array();
       ...
       $this->Graf->Lookup = $this->Lookup;
        ...
        function filterChartsByGroupbyLevel() {
                ...
                if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_level']) {
                        $applyFilter = true;
                }
                elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
                        $applyFilter = true;
                        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_level'] = $_POST['chart_level'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_orig'];

                if ($applyFilter) {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts'] as $chartIndex => $chartData) {
                                ...
                                if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_level']) {
                                        unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts'][$chartIndex]);
                                }
                        }
                }

                $this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts'];
        }
        ...
        function filterChartsBySummarization() {
                ...
                if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
                        ...
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
        ...
        function filterChartsByMultiseries() {
                ...
                if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['summarizing_drill_down'])) {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts'] as $chartIndex => $chartData) {
                                $indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_leads_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_leads_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
      ...
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_leads']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_leads']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_leads']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_leads']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_leads_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_leads_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['LigR_Md5'] = array();
   }
   ...
   function totaliza($tipo='')
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 1, $tipo);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_orig'])) {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_orig']; 
          }
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_filtro'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq_filtro'] . ")"; 
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_sc_free_group_by("res", $this->NM_export, 2, $tipo);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['arr_total'][$cmp_gb];
      }
      ...
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'][2];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'][2];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq']        = $save_where_pesq;
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Ind_Groupby'];
...
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " leads</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav']) {  
        ...
        <link rel='stylesheet' href='../_lib/lib/css/nm_mobile.css' type='text/css'/>
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_leads_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_leads_jquery_7600.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_leads_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_leads_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_leads_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_leads_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_leads/chart_leads_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['doc_word'] && !$this->aux_isPdf())
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none;' : '';
          $vertical_center = '';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['embutida'] && !$this->aux_isPdf())
      {
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_leads/chart_leads_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=pt_br&conf_socor=N&is_chart_app=Y&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_leads&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_leads/chart_leads_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=chart&nm_all_modules=chart&password=n&origem=chart&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         ...
         if (is_file("chart_leads_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_leads_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_leads']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_leads']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_leads_config_pivot.php?nome_apl=chart_leads&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_leads_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_leads_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"chart_leads_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_leads_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_leads@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          ...
          $nm_saida->saida("          document.Fres_pdf.action = \"chart_leads_iframe.php\";\r\n");
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_leads_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_leads/chart_leads_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['skip_charts']))
   {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               chart_leads_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if ($bChartFP)
       {
           ...
           chart_leads_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
    ...
    function grafico_bot_chart()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_change_type']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_change_type']) {
            unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_change_type']);

            $this->aux_addChartAppCharts();

            $chartMd5 = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_md5'];
            $chartTitle = '';
            ...
            $this->Graf->display_chartApp_type(
                $chartMd5,
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['chart_app_type'],
                $chartTitle
            );
            exit;
        }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_leads_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['under_dashboard'])
       {
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           chart_leads_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           chart_leads_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_leads_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_leads_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   chart_leads_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " leads</div>\r\n");
   ...
   //---- 
   function adiciona_registro($cnt_id, $quebra_assunto, $quebra_assunto_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT ID, ASSUNTO, DATA from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT ID, ASSUNTO, DATA from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->assunto = $rs_res->fields[1] ;  
            $this->data = $rs_res->fields[2] ;  
            $this->assunto_orig = $this->assunto;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->id, $this->assunto, $this->assunto_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq'])?'none':'';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']) && is_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_leads']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
