<?php
@session_start() ;
$_SESSION['scriptcase']['chart_leads']['sc_process_barr'] = true;
require_once('../chart_leads/index.php');
unset($_SESSION['scriptcase']['chart_leads']['sc_process_barr']);
$ExportCtrl = new chart_leads_export_control;
$ExportCtrl->Export_barr();

class chart_leads_export_control
{
