  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mailing_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_mailing_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_id(var_id, var_script_case_init, do_ajax_form_mailing_mob_validate_id_cb);
  } // do_ajax_form_mailing_mob_validate_id

  function do_ajax_form_mailing_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_id_cb

  // ---------- Validate tipo
  function do_ajax_form_mailing_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_mailing_mob_validate_tipo_cb);
  } // do_ajax_form_mailing_mob_validate_tipo

  function do_ajax_form_mailing_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_tipo_cb

  // ---------- Validate empresa
  function do_ajax_form_mailing_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_mailing_mob_validate_empresa_cb);
  } // do_ajax_form_mailing_mob_validate_empresa

  function do_ajax_form_mailing_mob_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_empresa_cb

  // ---------- Validate contato
  function do_ajax_form_mailing_mob_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_contato(var_contato, var_script_case_init, do_ajax_form_mailing_mob_validate_contato_cb);
  } // do_ajax_form_mailing_mob_validate_contato

  function do_ajax_form_mailing_mob_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_contato_cb

  // ---------- Validate email
  function do_ajax_form_mailing_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_email(var_email, var_script_case_init, do_ajax_form_mailing_mob_validate_email_cb);
  } // do_ajax_form_mailing_mob_validate_email

  function do_ajax_form_mailing_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_email_cb

  // ---------- Validate enviar
  function do_ajax_form_mailing_mob_validate_enviar()
  {
    var nomeCampo_enviar = "enviar";
    var var_enviar = scAjaxGetFieldText(nomeCampo_enviar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_enviar(var_enviar, var_script_case_init, do_ajax_form_mailing_mob_validate_enviar_cb);
  } // do_ajax_form_mailing_mob_validate_enviar

  function do_ajax_form_mailing_mob_validate_enviar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_enviar_cb

  // ---------- Validate data
  function do_ajax_form_mailing_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mailing_mob_validate_data(var_data, var_script_case_init, do_ajax_form_mailing_mob_validate_data_cb);
  } // do_ajax_form_mailing_mob_validate_data

  function do_ajax_form_mailing_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mailing_mob_validate_data_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mailing_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mailing_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_enviar = scAjaxGetFieldText("enviar");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_mailing_mob_submit_form(var_id, var_tipo, var_empresa, var_contato, var_email, var_enviar, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_mailing_mob_submit_form_cb);
  } // do_ajax_form_mailing_mob_submit_form

  function do_ajax_form_mailing_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mailing_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mailing_mob_submit_form_cb
  function do_ajax_form_mailing_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mailing_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mailing_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_mailing_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_mailing_mob_navigate_form();
    }
  }

  function perform_ajax_form_mailing_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mailing_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mailing_mob_navigate_form_cb);
  } // do_ajax_form_mailing_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mailing_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mailing_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mailing_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mailing_mob_navigate_form_cb
  function do_ajax_form_mailing_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_mailing_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mailing_mob_navigate_form_cb_after_alert

  function sc_hide_form_mailing_mob_form()
  {
  ...
  ajax_field_list[3] = "contato";
  ajax_field_list[4] = "email";
  ajax_field_list[5] = "enviar";
  ...
  var ajax_error_list = {
    ...
    "enviar": {"label": "ENVIAR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["enviar"][1] = "enviar";
  ...
  var ajax_field_id = {
    ...
    "enviar": new Array("hidden_field_label_enviar", "hidden_field_data_enviar"),
