<?php
@session_start() ;
$_SESSION['scriptcase']['grid_credoras']['sc_process_barr'] = true;
require_once('../grid_credoras/index.php');
unset($_SESSION['scriptcase']['grid_credoras']['sc_process_barr']);
$ExportCtrl = new grid_credoras_export_control;
$ExportCtrl->Export_barr();

class grid_credoras_export_control
{
