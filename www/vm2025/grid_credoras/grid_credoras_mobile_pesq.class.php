...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "contas_id_empresa";$Nm_numeric[] = "round(sum(credito-debito),2)";$Nm_numeric[] = "contas_id_empresa";$Nm_numeric[] = "round(sum(credito-debito),2)";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_contas_id_empresa_cond" name="contas_id_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_contas_id_empresa'), this, 'contas_id_empresa')">
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_contas_moeda_cond" name="contas_moeda_cond" onChange="nm_campos_between(document.getElementById('id_vis_contas_moeda'), this, 'contas_moeda')">
      ...
      <br><span id="id_hide_contas_moeda"  <?php echo $str_hide_contas_moeda?>><INPUT  type="text" id="SC_contas_moeda" name="contas_moeda" value="<?php echo NM_encode_input($contas_moeda) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_empresa_empresa_cond" name="empresa_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_empresa'), this, 'empresa_empresa')">
