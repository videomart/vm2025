...
class grid_credoras_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_credoras_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_credoras_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_credoras_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_credoras_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_credoras_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_credoras/grid_credoras_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_credoras_ajax_search.js"></script>
 <script type="text/javascript" src="grid_credoras_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_credoras_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_credoras']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_credoras']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_contas_id_empresa_cond#NMF#' + search_get_sel_txt('SC_contas_id_empresa_cond') + '@NMF@';
  str_out += 'SC_contas_id_empresa#NMF#' + search_get_text('SC_contas_id_empresa') + '@NMF@';
  str_out += 'SC_contas_moeda_cond#NMF#' + search_get_sel_txt('SC_contas_moeda_cond') + '@NMF@';
  str_out += 'SC_contas_moeda#NMF#' + search_get_text('SC_contas_moeda') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $contas_id_empresa_cond, $contas_id_empresa,
             $contas_moeda_cond, $contas_moeda,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $contas_id_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_id_empresa']; 
          $contas_id_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_id_empresa_cond']; 
          $contas_moeda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_moeda']; 
          $contas_moeda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_moeda_cond']; 
          $empresa_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['empresa_empresa']; 
          $empresa_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['empresa_empresa_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['NM_operador']; 
          if (strtoupper($contas_id_empresa_cond) != "II" && strtoupper($contas_id_empresa_cond) != "QP" && strtoupper($contas_id_empresa_cond) != "NP" && strtoupper($contas_id_empresa_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($contas_id_empresa, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($contas_id_empresa_cond) || empty($contas_id_empresa_cond))
      {
         $contas_id_empresa_cond = "eq";
      }
      if (!isset($contas_moeda_cond) || empty($contas_moeda_cond))
      {
         $contas_moeda_cond = "eq";
      }
      ...
      $str_hide_contas_id_empresa = (in_array($contas_id_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_contas_moeda = (in_array($contas_moeda_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_empresa_empresa = (in_array($empresa_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($contas_id_empresa) || $contas_id_empresa == "")
      {
          $contas_id_empresa = "";
      }
      if (isset($contas_id_empresa) && !empty($contas_id_empresa))
      {
         $tmp_pos = (is_string($contas_id_empresa)) ? strpos($contas_id_empresa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $contas_id_empresa = substr($contas_id_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($contas_moeda) || $contas_moeda == "")
      {
          $contas_moeda = "";
      }
      if (isset($contas_moeda) && !empty($contas_moeda))
      {
         $tmp_pos = (is_string($contas_moeda)) ? strpos($contas_moeda, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $contas_moeda = substr($contas_moeda, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_contas_id_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['contas_id_empresa'])) ? $this->New_label['contas_id_empresa'] : "id_empresa"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_contas_id_empresa_cond" name="contas_id_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_contas_id_empresa'), this, 'contas_id_empresa')">
       <OPTION value="eq" <?php if ("eq" == $contas_id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $contas_id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $contas_id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $contas_id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_contas_id_empresa" <?php echo $str_hide_contas_id_empresa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['contas_id_empresa'])) ? $this->New_label['contas_id_empresa'] : "id_empresa";
 $nmgp_tab_label .= "contas_id_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<INPUT  type="text" id="SC_contas_id_empresa" name="contas_id_empresa" value="<?php echo NM_encode_input($contas_id_empresa) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_contas_moeda_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['contas_moeda'])) ? $this->New_label['contas_moeda'] : "Moeda"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_contas_moeda_cond" name="contas_moeda_cond" onChange="nm_campos_between(document.getElementById('id_vis_contas_moeda'), this, 'contas_moeda')">
       <OPTION value="eq" <?php if ("eq" == $contas_moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $contas_moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $contas_moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $contas_moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_contas_moeda" <?php echo $str_hide_contas_moeda?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['contas_moeda'])) ? $this->New_label['contas_moeda'] : "Moeda";
 $nmgp_tab_label .= "contas_moeda?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_contas_moeda" name="contas_moeda" value="<?php echo NM_encode_input($contas_moeda) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_empresa_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['empresa_empresa'])) ? $this->New_label['empresa_empresa'] : "Empresa"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_empresa_empresa_cond" name="empresa_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa_empresa'), this, 'empresa_empresa')">
...
?>
<INPUT  type="text" id="SC_empresa_empresa" name="empresa_empresa" value="<?php echo NM_encode_input($empresa_empresa) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
<?php
   if (is_file("grid_credoras_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_credoras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_credoras']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.contas_id_empresa_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_contas_id_empresa'), document.F1.contas_id_empresa_cond, 'contas_id_empresa');
   document.F1.contas_id_empresa.value = "";
   document.F1.contas_moeda_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_contas_moeda'), document.F1.contas_moeda_cond, 'contas_moeda');
   document.F1.contas_moeda.value = "";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_contas_id_empresa_cond'] = 'cond';
      $tp_fields['SC_contas_id_empresa'] = 'text';
      $tp_fields['SC_contas_moeda_cond'] = 'cond';
      $tp_fields['SC_contas_moeda'] = 'text';
   ...
   {
      global $contas_id_empresa_cond, $contas_id_empresa,
             $contas_moeda_cond, $contas_moeda,
             $empresa_empresa_cond, $empresa_empresa, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $contas_id_empresa_cond_salva = $contas_id_empresa_cond; 
      if (!isset($contas_id_empresa_input_2) || $contas_id_empresa_input_2 == "")
      {
          $contas_id_empresa_input_2 = $contas_id_empresa;
      }
      $contas_moeda_cond_salva = $contas_moeda_cond; 
      if (!isset($contas_moeda_input_2) || $contas_moeda_input_2 == "")
      {
          $contas_moeda_input_2 = $contas_moeda;
      }
      ...
      if ($contas_id_empresa_cond != "in")
      {
          nm_limpa_numero($contas_id_empresa, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_id_empresa'] = $contas_id_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_id_empresa_cond'] = $contas_id_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_moeda'] = $contas_moeda; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['contas_moeda_cond'] = $contas_moeda_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['empresa_empresa'] = $empresa_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['empresa_empresa_cond'] = $empresa_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $contas_id_empresa;
      if (strtoupper($contas_id_empresa_cond) != "II" && strtoupper($contas_id_empresa_cond) != "QP" && strtoupper($contas_id_empresa_cond) != "NP" && strtoupper($contas_id_empresa_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['contas_id_empresa'] = $Conteudo;
      $this->cmp_formatado['contas_id_empresa'] = "'" . $this->cmp_formatado['contas_id_empresa'] . "'";
      if (isset($this->cmp_formatado['contas_id_empresa_input_2'])  && !empty($this->cmp_formatado['contas_id_empresa_input_2'])) {
          $this->cmp_formatado['contas_id_empresa_input_2'] = "'" . $this->cmp_formatado['contas_id_empresa_input_2'] . "'";
      }
      $Conteudo = $contas_moeda;
      $this->cmp_formatado['contas_moeda'] = $Conteudo;
      $this->cmp_formatado['contas_moeda'] = "'" . $this->cmp_formatado['contas_moeda'] . "'";
      if (isset($this->cmp_formatado['contas_moeda_input_2'])  && !empty($this->cmp_formatado['contas_moeda_input_2'])) {
          $this->cmp_formatado['contas_moeda_input_2'] = "'" . $this->cmp_formatado['contas_moeda_input_2'] . "'";
      }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($contas_id_empresa) || $contas_id_empresa_cond == "nu" || $contas_id_empresa_cond == "nn" || $contas_id_empresa_cond == "ep" || $contas_id_empresa_cond == "ne")
      {
         $this->monta_condicao("contas.id_empresa", $contas_id_empresa_cond, $contas_id_empresa, "", "contas_id_empresa", "MEDIUMINT", false);
      }

      //----- $contas_moeda
      $this->Date_part = false;
      if (isset($contas_moeda) || $contas_moeda_cond == "nu" || $contas_moeda_cond == "nn" || $contas_moeda_cond == "ep" || $contas_moeda_cond == "ne")
      {
         $this->monta_condicao("contas.moeda", $contas_moeda_cond, $contas_moeda, "", "contas_moeda", "VARCHAR", false);
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_credoras']['cond_pesq'] .= $this->NM_operador;
