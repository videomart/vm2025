<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_empresa']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_empresa_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_empresa_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['empresa_tipo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_tipo'] = "empresa_tipo";
   }
   else
   {
       $tab_def_campos['empresa_tipo'] = "empresa.TIPO";
   }
   $tab_labels["empresa_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_tipo"] : "TIPO";
   ...
   $tab_labels["empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa"] : "Empresa";
   $tab_ger_campos['empresa_categoria'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_categoria'] = "empresa_categoria";
   }
   else
   {
       $tab_def_campos['empresa_categoria'] = "empresa.CATEGORIA";
   }
   $tab_labels["empresa_categoria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_categoria"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_categoria"] : "" . $this->Nm_lang['lang_calendar_fld_category'] . "";
   $tab_ger_campos['cidade_cidade'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cidade_cidade'] = "cidade_cidade";
   }
   else
   {
       $tab_def_campos['cidade_cidade'] = "cidade.CIDADE";
   }
   $tab_labels["cidade_cidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["cidade_cidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["cidade_cidade"] : "CIDADE";
   $tab_ger_campos['cidade_uf'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cidade_uf'] = "cidade_uf";
   }
   else
   {
       $tab_def_campos['cidade_uf'] = "cidade.UF";
   }
   $tab_labels["cidade_uf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["cidade_uf"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["cidade_uf"] : "UF";
   $tab_ger_campos['empresa_email'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_email'] = "empresa_email";
   }
   else
   {
       $tab_def_campos['empresa_email'] = "empresa.EMAIL";
   }
   $tab_labels["empresa_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_email"] : "EMAIL";
   $tab_ger_campos['empresa_dat_ult_proposta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_dat_ult_proposta'] = "empresa_dat_ult_proposta";
   }
   else
   {
       $tab_def_campos['empresa_dat_ult_proposta'] = "empresa.DAT_ULT_PROPOSTA";
   }
   $tab_labels["empresa_dat_ult_proposta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_dat_ult_proposta"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_dat_ult_proposta"] : "DAT ULT PROPOSTA";
   $tab_ger_campos['empresa_rede'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_rede'] = "empresa_rede";
   }
   else
   {
       $tab_def_campos['empresa_rede'] = "empresa.REDE";
   }
   $tab_labels["empresa_rede"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_rede"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_rede"] : "REDE";
   $tab_ger_campos['empresa_empresa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_empresa'] = "empresa_empresa";
   }
   else
   {
       $tab_def_campos['empresa_empresa'] = "empresa.EMPRESA";
   }
   $tab_labels["empresa_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_empresa"] : "EMPRESA";
   $tab_ger_campos['empresa_telefone'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_telefone'] = "empresa_telefone";
   }
   else
   {
       $tab_def_campos['empresa_telefone'] = "empresa.TELEFONE";
   }
   $tab_labels["empresa_telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_telefone"] : "TELEFONE";
   $tab_ger_campos['empresa_contato'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_contato'] = "empresa_contato";
   }
   else
   {
       $tab_def_campos['empresa_contato'] = "empresa.CONTATO";
   }
   $tab_labels["empresa_contato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_contato"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['labels']["empresa_contato"] : "CONTATO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_empresa']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_empresa']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> empresa</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_empresa_order_campos.php",
    data: {
...
<div class="sc_ui_sortable-wrapper" id="sorting_list_ord_campos">
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_empresa']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
