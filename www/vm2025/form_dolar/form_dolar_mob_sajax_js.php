  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dolar_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate data
  function do_ajax_form_dolar_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dolar_mob_validate_data(var_data, var_script_case_init, do_ajax_form_dolar_mob_validate_data_cb);
  } // do_ajax_form_dolar_mob_validate_data

  function do_ajax_form_dolar_mob_validate_data_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dolar_mob_validate_data_cb

  // ---------- Validate dolar
  function do_ajax_form_dolar_mob_validate_dolar()
  {
    var nomeCampo_dolar = "dolar";
    var var_dolar = scAjaxGetFieldText(nomeCampo_dolar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dolar_mob_validate_dolar(var_dolar, var_script_case_init, do_ajax_form_dolar_mob_validate_dolar_cb);
  } // do_ajax_form_dolar_mob_validate_dolar

  function do_ajax_form_dolar_mob_validate_dolar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dolar_mob_validate_dolar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dolar_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dolar_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_data = scAjaxGetFieldText("data");
    var var_dolar = scAjaxGetFieldText("dolar");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dolar_mob_submit_form(var_data, var_dolar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_dolar_mob_submit_form_cb);
  } // do_ajax_form_dolar_mob_submit_form

  function do_ajax_form_dolar_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dolar_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dolar_mob_submit_form_cb
  function do_ajax_form_dolar_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dolar_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dolar_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dolar_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dolar_mob_navigate_form();
    }
  }

  function perform_ajax_form_dolar_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("data");
    scAjaxHideErrorDisplay("dolar");
    var var_data = document.F2.data.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dolar_mob_navigate_form(var_data, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dolar_mob_navigate_form_cb);
  } // do_ajax_form_dolar_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dolar_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dolar_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.data.value = scAjaxGetKeyValue("data");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dolar_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dolar_mob_navigate_form_cb
  function do_ajax_form_dolar_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_dolar_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dolar_mob_navigate_form_cb_after_alert

  function sc_hide_form_dolar_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "dolar": {"label": "Dolar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["dolar"][1] = "dolar";

  var ajax_field_id = {
    "data": new Array("hidden_field_label_data", "hidden_field_data_data"),
    "dolar": new Array("hidden_field_label_dolar", "hidden_field_data_dolar")
  };
