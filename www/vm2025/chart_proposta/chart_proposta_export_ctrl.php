<?php
@session_start() ;
$_SESSION['scriptcase']['chart_proposta']['sc_process_barr'] = true;
require_once('../chart_proposta/index.php');
unset($_SESSION['scriptcase']['chart_proposta']['sc_process_barr']);
$ExportCtrl = new chart_proposta_export_control;
$ExportCtrl->Export_barr();

class chart_proposta_export_control
{
