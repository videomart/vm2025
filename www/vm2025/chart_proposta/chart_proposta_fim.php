...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____chart_proposta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____chart_proposta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_proposta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_proposta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_proposta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_proposta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_proposta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_proposta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_proposta']['embutida_filho'] as $ind => $sc_init)
          {
