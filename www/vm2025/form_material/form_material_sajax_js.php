  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_material" == sTestField)
        {
...
?>
  ...
  // ---------- Validate partnumber_
  function do_ajax_form_material_validate_partnumber_(iNumLinha)
  {
    var nomeCampo_partnumber_ = "partnumber_" + iNumLinha;
    var var_partnumber_ = scAjaxGetFieldText(nomeCampo_partnumber_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_material_validate_partnumber_(var_partnumber_, iNumLinha, var_script_case_init, do_ajax_form_material_validate_partnumber__cb);
  } // do_ajax_form_material_validate_partnumber_

  function do_ajax_form_material_validate_partnumber__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "partnumber_" + iLineNumber;
    }
    else
    {
      sFieldValid = "partnumber_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "partnumber_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "partnumber_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_material_validate_partnumber__cb

  // ---------- Validate descricao_
  function do_ajax_form_material_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_material_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_form_material_validate_descricao__cb);
  } // do_ajax_form_material_validate_descricao_

  function do_ajax_form_material_validate_descricao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_material_validate_descricao__cb

  // ---------- Validate qty_
  function do_ajax_form_material_validate_qty_(iNumLinha)
  {
    var nomeCampo_qty_ = "qty_" + iNumLinha;
    var var_qty_ = scAjaxGetFieldText(nomeCampo_qty_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_material_validate_qty_(var_qty_, iNumLinha, var_script_case_init, do_ajax_form_material_validate_qty__cb);
  } // do_ajax_form_material_validate_qty_

  function do_ajax_form_material_validate_qty__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_material_validate_qty__cb

  // ---------- Validate unit_
  function do_ajax_form_material_validate_unit_(iNumLinha)
  {
    var nomeCampo_unit_ = "unit_" + iNumLinha;
    var var_unit_ = scAjaxGetFieldText(nomeCampo_unit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_material_validate_unit_(var_unit_, iNumLinha, var_script_case_init, do_ajax_form_material_validate_unit__cb);
  } // do_ajax_form_material_validate_unit_

  function do_ajax_form_material_validate_unit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_material_validate_unit__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_material_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_material_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_material_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_material_add_new_line_cb);
  } // do_ajax_form_material_add_new_line

  var ctrl_new_line  = false;
  var ctrl_last_line = 0;
  function do_ajax_form_material_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_material_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_material_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_material_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_material_backup_line_cb);
  } // do_ajax_form_material_backup_line

  function do_ajax_form_material_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_material_backup_line_cb

  function do_ajax_form_material_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_material_cancel_insert

  function do_ajax_form_material_cancel_update(iSeqVert)
  {
    do_ajax_form_material_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_material_cancel_update

  function do_ajax_form_material_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_material_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_material_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_material_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_material_table_refresh_cb);
  } //  do_ajax_form_material_table_refresh

  function do_ajax_form_material_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_material_table_refresh_cb_after_alert);
  } // do_ajax_form_material_table_refresh_cb
  function do_ajax_form_material_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_material_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_material_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_material_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_partnumber_ = scAjaxGetFieldText("partnumber_" + iNumLinha);
...
?>
    x_ajax_form_material_submit_form(var_partnumber_, var_descricao_, var_qty_, var_unit_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_material_submit_form_cb);
  } // do_ajax_form_material_submit_form

  function do_ajax_form_material_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("partnumber_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_material_submit_form_cb_after_alert);
  } // do_ajax_form_material_submit_form_cb
  function do_ajax_form_material_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_material_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_material_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_material_navigate_form, function() {});
    } else {
      perform_ajax_form_material_navigate_form();
    }
  }

  function perform_ajax_form_material_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_material_cancel_insert(sc_form_material_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("partnumber_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_material_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_material_navigate_form_cb);
  } // do_ajax_form_material_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_material']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_material_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_material_navigate_form_cb_after_alert);
  } // do_ajax_form_material_navigate_form_cb
  function do_ajax_form_material_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_material_navigate_form_cb_after_alert

    function sc_form_material_get_last_line_number()
    {
    ...
    } //sc_form_material_get_last_line_number

  function sc_hide_form_material_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "partnumber_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["partnumber_" + iNumLinha] = {"label": "Part Number<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_error_list["unit_" + iNumLinha] = {"label": "Valor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["partnumber_"][iNumLinha] = "partnumber_" + iNumLinha;
    ...
    ajax_field_id["partnumber_" + iNumLinha] = new Array("hidden_field_label_partnumber_", "hidden_field_data_partnumber_" + iNumLinha);
    ...
    ajax_error_count["partnumber_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["partnumber_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["partnumber_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["partnumber_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["partnumber_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["partnumber_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["partnumber_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["partnumber_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["partnumber_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['partnumber_'])) ? $this->nmgp_cmp_readonly['partnumber_'] : 'off';
?>
    scAjaxFieldRead("partnumber_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("partnumber_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["partnumber_" + iRow] || "on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["qty_" + iRow] || "on" == ajax_error_count["unit_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_partnumber_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["partnumber_" + iRow] && "off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["qty_" + iRow] && "off" == ajax_error_count["unit_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["partnumber_" + iRow] = "off";
      ...
      $("#hidden_field_data_partnumber_" + iRow).removeClass("scFormErrorLine");
