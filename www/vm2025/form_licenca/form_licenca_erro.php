...
$old_error_handler = set_error_handler("form_licenca_scriptcase_error_handler");

function form_licenca_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="", $err_usr=false)
{
    ...
    if (isset($_SESSION['scriptcase']['form_licenca']['contr_erro']) && $_SESSION['scriptcase']['form_licenca']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_licenca->contr_form_licenca->Apl_com_erro = true;
            if ($inicial_form_licenca->contr_form_licenca->NM_ajax_flag)
            {
                $inicial_form_licenca->contr_form_licenca->NM_ajax_info['errList']['geral_form_licenca'][] = $msg;
                return;
            }
            form_licenca_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_licenca_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_licenca'])  && '' != $_SESSION['scriptcase']['error_icon']['form_licenca'])  ? $_SESSION['scriptcase']['error_icon']['form_licenca']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_licenca']) && '' != $_SESSION['scriptcase']['error_close']['form_licenca']) ? $_SESSION['scriptcase']['error_close']['form_licenca'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_licenca']) && '' != $_SESSION['scriptcase']['error_span_title']['form_licenca']) ? $_SESSION['scriptcase']['error_span_title']['form_licenca'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_licenca']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_licenca']) ? $_SESSION['scriptcase']['error_icon_title']['form_licenca'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_licenca']['error_buffer'] .= ob_get_flush();
}
