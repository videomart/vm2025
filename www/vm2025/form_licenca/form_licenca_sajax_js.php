  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_licenca" == sTestField)
        {
...
?>
  ...
  // ---------- Validate ordem
  function do_ajax_form_licenca_validate_ordem()
  {
  } // do_ajax_form_licenca_validate_ordem

  function do_ajax_form_licenca_validate_ordem_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_ordem_cb

  // ---------- Validate vendedor
  function do_ajax_form_licenca_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldSelect(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_form_licenca_validate_vendedor_cb);
  } // do_ajax_form_licenca_validate_vendedor

  function do_ajax_form_licenca_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_vendedor_cb

  // ---------- Validate data_compra
  function do_ajax_form_licenca_validate_data_compra()
  {
    var nomeCampo_data_compra = "data_compra";
    var var_data_compra = scAjaxGetFieldText(nomeCampo_data_compra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_data_compra(var_data_compra, var_script_case_init, do_ajax_form_licenca_validate_data_compra_cb);
  } // do_ajax_form_licenca_validate_data_compra

  function do_ajax_form_licenca_validate_data_compra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_data_compra_cb

  // ---------- Validate modalidade
  function do_ajax_form_licenca_validate_modalidade()
  {
    var nomeCampo_modalidade = "modalidade";
    var var_modalidade = scAjaxGetFieldRadio(nomeCampo_modalidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_modalidade(var_modalidade, var_script_case_init, do_ajax_form_licenca_validate_modalidade_cb);
  } // do_ajax_form_licenca_validate_modalidade

  function do_ajax_form_licenca_validate_modalidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_modalidade_cb

  // ---------- Validate modelo
  function do_ajax_form_licenca_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_licenca_validate_modelo_cb);
  } // do_ajax_form_licenca_validate_modelo

  function do_ajax_form_licenca_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_modelo_cb

  // ---------- Validate empresa
  function do_ajax_form_licenca_validate_empresa()
  {
  } // do_ajax_form_licenca_validate_empresa

  function do_ajax_form_licenca_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_empresa_cb

  // ---------- Validate contato
  function do_ajax_form_licenca_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_contato(var_contato, var_script_case_init, do_ajax_form_licenca_validate_contato_cb);
  } // do_ajax_form_licenca_validate_contato

  function do_ajax_form_licenca_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_contato_cb

  // ---------- Validate serial
  function do_ajax_form_licenca_validate_serial()
  {
    var nomeCampo_serial = "serial";
    var var_serial = scAjaxGetFieldText(nomeCampo_serial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_serial(var_serial, var_script_case_init, do_ajax_form_licenca_validate_serial_cb);
  } // do_ajax_form_licenca_validate_serial

  function do_ajax_form_licenca_validate_serial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_serial_cb

  // ---------- Validate cod_ativacao
  function do_ajax_form_licenca_validate_cod_ativacao()
  {
    var nomeCampo_cod_ativacao = "cod_ativacao";
    var var_cod_ativacao = scAjaxGetFieldText(nomeCampo_cod_ativacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_cod_ativacao(var_cod_ativacao, var_script_case_init, do_ajax_form_licenca_validate_cod_ativacao_cb);
  } // do_ajax_form_licenca_validate_cod_ativacao

  function do_ajax_form_licenca_validate_cod_ativacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_cod_ativacao_cb

  // ---------- Validate obs
  function do_ajax_form_licenca_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldEditorHtml(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_licenca_validate_obs(var_obs, var_script_case_init, do_ajax_form_licenca_validate_obs_cb);
  } // do_ajax_form_licenca_validate_obs

  function do_ajax_form_licenca_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_licenca_validate_obs_cb

  // ---------- Event onchange ordem
  function do_ajax_form_licenca_event_ordem_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_licenca_event_ordem_onchange(var_ordem, var_empresa, var_contato, var_modelo, var_data_compra, var_vendedor, var_script_case_init, do_ajax_form_licenca_event_ordem_onchange_cb);
  } // do_ajax_form_licenca_event_ordem_onchange

  function do_ajax_form_licenca_event_ordem_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ordem";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_licenca_event_ordem_onchange_cb_after_alert);
  } // do_ajax_form_licenca_event_ordem_onchange_cb
  function do_ajax_form_licenca_event_ordem_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_licenca_event_ordem_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_licenca_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_licenca_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_licenca_submit_form(var_ordem, var_vendedor, var_data_compra, var_modalidade, var_modelo, var_empresa, var_contato, var_serial, var_cod_ativacao, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_licenca_submit_form_cb);
  } // do_ajax_form_licenca_submit_form

  function do_ajax_form_licenca_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_licenca_submit_form_cb_after_alert);
  } // do_ajax_form_licenca_submit_form_cb
  function do_ajax_form_licenca_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_licenca_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_licenca_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_licenca_navigate_form, function() {});
    } else {
      perform_ajax_form_licenca_navigate_form();
    }
  }

  function perform_ajax_form_licenca_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_licenca_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_licenca_navigate_form_cb);
  } // do_ajax_form_licenca_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_licenca']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_licenca_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_licenca_navigate_form_cb_after_alert);
  } // do_ajax_form_licenca_navigate_form_cb
  function do_ajax_form_licenca_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_licenca_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_licenca_navigate_form_cb_after_alert

  function sc_hide_form_licenca_form()
  {
