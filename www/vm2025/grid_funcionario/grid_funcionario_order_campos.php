<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["endereco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["endereco"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["endereco"] : "ENDERECO";
   ...
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["usuario"] : "USUARIO";
   ...
   $tab_ger_campos['divisao'] = "on";
   $tab_def_campos['divisao'] = "DIVISAO";
   $tab_labels["divisao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["divisao"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["divisao"] : "DIVISÃO";
