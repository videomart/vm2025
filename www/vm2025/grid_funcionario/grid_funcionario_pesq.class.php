...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_funcionario_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_funcionario_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "salario";
      ...
      $Nm_datas[] = 'nascimento';$Nm_datas[] = 'admissao';
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - funcionario</TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_nascimento_cond#NMF#' + search_get_sel_txt('SC_nascimento_cond') + '@NMF@';
  str_out += 'SC_nascimento_dia#NMF#' + search_get_sel_txt('SC_nascimento_dia') + '@NMF@';
  str_out += 'SC_nascimento_mes#NMF#' + search_get_sel_txt('SC_nascimento_mes') + '@NMF@';
  str_out += 'SC_nascimento_ano#NMF#' + search_get_sel_txt('SC_nascimento_ano') + '@NMF@';
  str_out += 'SC_nascimento_input_2_dia#NMF#' + search_get_sel_txt('SC_nascimento_input_2_dia') + '@NMF@';
  str_out += 'SC_nascimento_input_2_mes#NMF#' + search_get_sel_txt('SC_nascimento_input_2_mes') + '@NMF@';
  str_out += 'SC_nascimento_input_2_ano#NMF#' + search_get_sel_txt('SC_nascimento_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $nascimento_cond, $nascimento, $nascimento_dia, $nascimento_mes, $nascimento_ano,
             $cep_cond, $cep,
             $telefone_cond, $telefone,
             $cpf_cond, $cpf,
      ...
      { 
          ...
          $endereco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['endereco']; 
          $endereco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['endereco_cond']; 
          $nascimento_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_dia']; 
          $nascimento_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_mes']; 
          $nascimento_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_ano']; 
          $nascimento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_cond']; 
          $cep = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['cep']; 
          $cep_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['cep_cond']; 
          $telefone = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['telefone']; 
          $telefone_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['telefone_cond']; 
      ...
      if (!isset($nascimento_cond) || empty($nascimento_cond))
      {
         $nascimento_cond = "eq";
      }
      ...
      $str_hide_nascimento = (in_array($nascimento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($nome)) ? strpos($nome, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($nascimento)) ? strpos($nascimento, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $nascimento = substr($nascimento, 0, $tmp_pos);
         }
      }
      if (!isset($cep) || $cep == "")
      {
      ...
      {
         $tmp_pos = (is_string($cep)) ? strpos($cep, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($cpf)) ? strpos($cpf, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
...
?>
<INPUT  type="text" id="SC_nome" name="nome" value="<?php echo NM_encode_input($nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_endereco_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['endereco'])) ? $this->New_label['endereco'] : "ENDERECO"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_endereco_cond" name="endereco_cond" onChange="nm_campos_between(document.getElementById('id_vis_endereco'), this, 'endereco')">
       <OPTION value="eq" <?php if ("eq" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_endereco" name="endereco" value="<?php echo NM_encode_input($endereco) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_nascimento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nascimento'])) ? $this->New_label['nascimento'] : "NASCIMENTO"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_nascimento_cond" name="nascimento_cond" onChange="nm_campos_between(document.getElementById('id_vis_nascimento'), this, 'nascimento')">
       <OPTION value="eq" <?php if ("eq" == $nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $nascimento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nascimento" <?php echo $str_hide_nascimento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nascimento'])) ? $this->New_label['nascimento'] : "NASCIMENTO";
 $nmgp_tab_label .= "nascimento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_nascimento_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_nascimento_dia" name="nascimento_dia" value="<?php echo NM_encode_input($nascimento_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_nascimento_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_nascimento_mes" name="nascimento_mes" value="<?php echo NM_encode_input($nascimento_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<?php
  ...
  {
?>
<span id='id_date_part_nascimento_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_nascimento_ano" name="nascimento_ano" value="<?php echo NM_encode_input($nascimento_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_cep_cond" name="cep_cond" onChange="nm_campos_between(document.getElementById('id_vis_cep'), this, 'cep')">
       ...
       <OPTION value="ii" <?php if ("ii" == $cep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_cep" name="cep" value="<?php echo NM_encode_input($cep) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_telefone_cond" name="telefone_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefone'), this, 'telefone')">
       ...
       <OPTION value="ii" <?php if ("ii" == $telefone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $telefone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $telefone_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_telefone" name="telefone" value="<?php echo NM_encode_input($telefone) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_cpf_cond" name="cpf_cond" onChange="nm_campos_between(document.getElementById('id_vis_cpf'), this, 'cpf')">
       ...
       <OPTION value="ii" <?php if ("ii" == $cpf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cpf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cpf_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_cpf" name="cpf" value="<?php echo NM_encode_input($cpf) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.endereco_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_endereco'), document.F1.endereco_cond, 'endereco');
   document.F1.endereco.value = "";
   document.F1.nascimento_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_nascimento'), document.F1.nascimento_cond, 'nascimento');
   document.F1.nascimento_dia.value = "";
   document.F1.nascimento_mes.value = "";
   document.F1.nascimento_ano.value = "";
   document.F1.cep_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_cep'), document.F1.cep_cond, 'cep');
   document.F1.cep.value = "";
   document.F1.telefone_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_telefone'), document.F1.telefone_cond, 'telefone');
   document.F1.telefone.value = "";
   document.F1.cpf_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_cpf'), document.F1.cpf_cond, 'cpf');
   document.F1.cpf.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_nascimento_dia').bind('change', function() {sc_grid_funcionario_valida_dia(this)});
    $('#SC_nascimento_mes').bind('change', function() {sc_grid_funcionario_valida_mes(this)});
 }
 function sc_grid_funcionario_valida_dia(obj)
 {
 ...
 function sc_grid_funcionario_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/grid_funcionario";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_nome'] = 'text';
      $tp_fields['SC_endereco_cond'] = 'cond';
      $tp_fields['SC_endereco'] = 'text';
      $tp_fields['SC_nascimento_cond'] = 'cond';
      $tp_fields['SC_nascimento_dia'] = 'text';
      $tp_fields['SC_nascimento_mes'] = 'text';
      $tp_fields['SC_nascimento_ano'] = 'text';
      $tp_fields['SC_nascimento_input_2_dia'] = 'text';
      $tp_fields['SC_nascimento_input_2_mes'] = 'text';
      $tp_fields['SC_nascimento_input_2_ano'] = 'text';
      $tp_fields['SC_cep_cond'] = 'cond';
      $tp_fields['SC_cep'] = 'text';
      $tp_fields['SC_telefone_cond'] = 'cond';
      $tp_fields['SC_telefone'] = 'text';
   ...
   function trata_campos()
   {
      ...
      $nascimento_cond_salva = $nascimento_cond; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['endereco'] = $endereco; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['endereco_cond'] = $endereco_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_dia'] = $nascimento_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_mes'] = $nascimento_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_ano'] = $nascimento_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_cond'] = $nascimento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['cep'] = $cep; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['cep_cond'] = $cep_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['telefone'] = $telefone; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['telefone_cond'] = $telefone_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['dyn_search']  = array(); 
      ...
      $this->cmp_formatado['nome'] = "'" . $this->cmp_formatado['nome'] . "'";
      if (isset($this->cmp_formatado['nome_input_2'])  && !empty($this->cmp_formatado['nome_input_2'])) {
          $this->cmp_formatado['nome_input_2'] = "'" . $this->cmp_formatado['nome_input_2'] . "'";
      }
      $Conteudo = $endereco;
      ...
      $this->cmp_formatado['nascimento'] = "'" . $this->cmp_formatado['nascimento'] . "'";
      if (isset($this->cmp_formatado['nascimento_input_2'])  && !empty($this->cmp_formatado['nascimento_input_2'])) {
          $this->cmp_formatado['nascimento_input_2'] = "'" . $this->cmp_formatado['nascimento_input_2'] . "'";
      }
      $Conteudo = $cep;
      $this->cmp_formatado['cep'] = $Conteudo;
      $this->cmp_formatado['cep'] = "'" . $this->cmp_formatado['cep'] . "'";
      if (isset($this->cmp_formatado['cep_input_2'])  && !empty($this->cmp_formatado['cep_input_2'])) {
          $this->cmp_formatado['cep_input_2'] = "'" . $this->cmp_formatado['cep_input_2'] . "'";
      }
      $Conteudo = $telefone;
      $this->cmp_formatado['telefone'] = $Conteudo;
      ...
      $this->cmp_formatado['cpf'] = "'" . $this->cmp_formatado['cpf'] . "'";
      if (isset($this->cmp_formatado['cpf_input_2'])  && !empty($this->cmp_formatado['cpf_input_2'])) {
          $this->cmp_formatado['cpf_input_2'] = "'" . $this->cmp_formatado['cpf_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      {
         $this->monta_condicao("NOME", $nome_cond, $nome, "", "nome", "VARCHAR", false);
      }
      ...
      {
         $this->monta_condicao("ENDERECO", $endereco_cond, $endereco, "", "endereco", "VARCHAR", false);
      }

      //----- $nascimento
      $this->Date_part = false;
      if ($nascimento_cond != "bi_TP" && $Res_comp != 'calend')
      {
          $nascimento_cond = strtoupper($nascimento_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $nascimento_ano;
          $Dtxt .= $nascimento_mes;
          $Dtxt .= $nascimento_dia;
          $val[0]['ano'] = $nascimento_ano;
          $val[0]['mes'] = $nascimento_mes;
          $val[0]['dia'] = $nascimento_dia;
          if ($nascimento_cond == "BW")
          {
              $val[1]['ano'] = $nascimento_input_2_ano;
              $val[1]['mes'] = $nascimento_input_2_mes;
              $val[1]['dia'] = $nascimento_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $nascimento_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $nascimento = $val[0];
          $this->cmp_formatado['nascimento'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['nascimento'], "YYYY-MM-DD");
          $this->cmp_formatado['nascimento'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          $this->cmp_formatado['nascimento'] = "'" . $this->cmp_formatado['nascimento'] . "'";
          if ($nascimento_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $nascimento_input_2     = $val[1];
              $this->cmp_formatado['nascimento_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['campos_busca']['nascimento_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['nascimento_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['nascimento_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          $this->cmp_formatado['nascimento_input_2'] = "'" . $this->cmp_formatado['nascimento_input_2'] . "'";
          }
          if (!empty($Dtxt) || $nascimento_cond == "NU" || $nascimento_cond == "NN"|| $nascimento_cond == "EP"|| $nascimento_cond == "NE")
          {
              $this->monta_condicao("NASCIMENTO", $nascimento_cond, $nascimento, $nascimento_input_2, 'nascimento', 'DATE');
          }
      }
      ...
      {
         $this->monta_condicao("CEP", $cep_cond, $cep, "", "cep", "VARCHAR", false);
      }
      ...
      {
         $this->monta_condicao("CPF", $cpf_cond, $cpf, "", "cpf", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         ...
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['using_summary_cache']);
