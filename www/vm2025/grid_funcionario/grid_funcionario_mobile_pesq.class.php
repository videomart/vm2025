...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'nascimento';$Nm_datas[] = 'admissao';$Nm_numeric[] = "id";$Nm_numeric[] = "salario";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_nome"  <?php echo $str_hide_nome?>><INPUT  type="text" id="SC_nome" name="nome" value="<?php echo NM_encode_input($nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_endereco_cond" name="endereco_cond" onChange="nm_campos_between(document.getElementById('id_vis_endereco'), this, 'endereco')">
      ...
      <br><span id="id_hide_endereco"  <?php echo $str_hide_endereco?>><INPUT  type="text" id="SC_endereco" name="endereco" value="<?php echo NM_encode_input($endereco) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_nascimento_cond" name="nascimento_cond" onChange="nm_campos_between(document.getElementById('id_vis_nascimento'), this, 'nascimento')">
      ...
      <br><span id="id_hide_nascimento"  <?php echo $str_hide_nascimento?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_cep"  <?php echo $str_hide_cep?>><INPUT  type="text" id="SC_cep" name="cep" value="<?php echo NM_encode_input($cep) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_telefone"  <?php echo $str_hide_telefone?>><INPUT  type="text" id="SC_telefone" name="telefone" value="<?php echo NM_encode_input($telefone) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_cpf"  <?php echo $str_hide_cpf?>><INPUT  type="text" id="SC_cpf" name="cpf" value="<?php echo NM_encode_input($cpf) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
