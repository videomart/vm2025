<?php
@session_start() ;
$_SESSION['scriptcase']['grid_categoria']['sc_process_barr'] = true;
require_once('../grid_categoria/index.php');
unset($_SESSION['scriptcase']['grid_categoria']['sc_process_barr']);
$ExportCtrl = new grid_categoria_export_control;
$ExportCtrl->Export_barr();

class grid_categoria_export_control
{
