...
class grid_categoria_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_categoria_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_categoria_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_categoria_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_categoria_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_categoria_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_categoria_categoria')
      {
          $categoria_categoria = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_categoria_categoria($categoria_categoria);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_categoria_categoria($categoria_categoria)
   {
      $categoria_categoria = substr($this->Db->qstr($categoria_categoria), 1, -1);
            $categoria_categoria_look = (is_string($categoria_categoria) ? substr($this->Db->qstr($categoria_categoria), 1, -1) : $categoria_categoria); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct categoria.CATEGORIA from " . $this->Ini->nm_tabela . " where (categoria.CATEGORIA=empresa.CATEGORIA) and  #lowerI#categoria.CATEGORIA#lowerF# like #lowerI#'%" . $categoria_categoria . "%'#lowerF# order by categoria.CATEGORIA"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         $nm_ini_lower = "";
         $nm_fim_lower = "";
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - categoria</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_categoria/grid_categoria_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_categoria_ajax_search.js"></script>
 <script type="text/javascript" src="grid_categoria_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_categoria_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_categoria']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_categoria']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_categoria_categoria_cond#NMF#' + search_get_sel_txt('SC_categoria_categoria_cond') + '@NMF@';
  str_out += 'SC_categoria_categoria#NMF#' + search_get_text('SC_categoria_categoria') + '@NMF@';
  str_out += 'id_ac_categoria_categoria#NMF#' + search_get_text('id_ac_categoria_categoria') + '@NMF@';
  str_out += 'SC_count(empresa.categoria)_cond#NMF#' + search_get_sel_txt('SC_sc_field_0_cond') + '@NMF@';
  str_out += 'SC_count(empresa.categoria)#NMF#' + search_get_text('SC_sc_field_0') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_categoria_categoria").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_categoria_categoria").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_categoria_categoria",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_categoria_categoria").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_categoria_categoria").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $categoria_categoria_cond, $categoria_categoria, $categoria_categoria_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $categoria_categoria = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['categoria_categoria']; 
          $categoria_categoria_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['categoria_categoria_cond']; 
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['sc_field_0_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['NM_operador']; 
      ...
      if (!isset($categoria_categoria_cond) || empty($categoria_categoria_cond))
      {
         $categoria_categoria_cond = "qp";
      }
      ...
      $str_hide_categoria_categoria = (in_array($categoria_categoria_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sc_field_0 = (in_array($sc_field_0_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($categoria_categoria) || $categoria_categoria == "")
      {
          $categoria_categoria = "";
      }
      if (isset($categoria_categoria) && !empty($categoria_categoria))
      {
         $tmp_pos = (is_string($categoria_categoria)) ? strpos($categoria_categoria, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $categoria_categoria = substr($categoria_categoria, 0, $tmp_pos);
         }
      }
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_categoria_categoria_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['categoria_categoria'])) ? $this->New_label['categoria_categoria'] : "CATEGORIA"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_categoria_categoria_cond" name="categoria_categoria_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoria_categoria'), this, 'categoria_categoria')">
       <OPTION value="qp" <?php if ("qp" == $categoria_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $categoria_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $categoria_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $categoria_categoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_categoria_categoria" <?php echo $str_hide_categoria_categoria?> valign="top">
 ...
 $nmgp_tab_label .= "categoria_categoria?#?" . $SC_Label . "?@?";
...
?>
<?php
      if ($categoria_categoria != "")
      {
      $categoria_categoria_look = (is_string($categoria_categoria) ? substr($this->Db->qstr($categoria_categoria), 1, -1) : $categoria_categoria); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct categoria.CATEGORIA from " . $this->Ini->nm_tabela . " where (categoria.CATEGORIA=empresa.CATEGORIA) and #lowerI#categoria.CATEGORIA#lowerF# = #lowerI#'$categoria_categoria_look'#lowerF# order by categoria.CATEGORIA"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if (isset($nmgp_def_dados[0][$categoria_categoria]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$categoria_categoria];
      }
      else
      {
          $sAutocompValue = $categoria_categoria;
      }
?>
<INPUT  type="text" id="SC_categoria_categoria" name="categoria_categoria" value="<?php echo NM_encode_input($categoria_categoria) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_categoria_categoria" name="categoria_categoria_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Quantidade de empresas"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
...
?>
<?php
   if (is_file("grid_categoria_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_categoria']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_categoria']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.categoria_categoria_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_categoria_categoria'), document.F1.categoria_categoria_cond, 'categoria_categoria');
   document.F1.categoria_categoria.value = "";
   document.F1.categoria_categoria_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/grid_categoria";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_categoria_categoria_cond'] = 'cond';
      $tp_fields['SC_categoria_categoria'] = 'text_aut';
      $tp_fields['id_ac_categoria_categoria'] = 'text_aut';
      $tp_fields['SC_sc_field_0_cond'] = 'cond';
      $tp_fields['SC_sc_field_0'] = 'text';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_count(empresa.categoria)_cond'] = 'SC_sc_field_0_cond';
      $tb_fields_esp['SC_count(empresa.categoria)'] = 'SC_sc_field_0';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $categoria_categoria_cond, $categoria_categoria, $categoria_categoria_autocomp,
      ...
      if (!empty($categoria_categoria_autocomp) && empty($categoria_categoria))
      {
          $categoria_categoria = $categoria_categoria_autocomp;
      }
      $categoria_categoria_cond_salva = $categoria_categoria_cond; 
      if (!isset($categoria_categoria_input_2) || $categoria_categoria_input_2 == "")
      {
          $categoria_categoria_input_2 = $categoria_categoria;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['categoria_categoria'] = $categoria_categoria; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['categoria_categoria_cond'] = $categoria_categoria_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['sc_field_0'] = $sc_field_0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($categoria_categoria != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['categoria_categoria'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['categoria_categoria'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['categoria_categoria'] = $categoria_categoria;
      }
      $this->cmp_formatado['categoria_categoria'] = "'" . $this->cmp_formatado['categoria_categoria'] . "'";
      if (isset($this->cmp_formatado['categoria_categoria_input_2'])  && !empty($this->cmp_formatado['categoria_categoria_input_2'])) {
          $this->cmp_formatado['categoria_categoria_input_2'] = "'" . $this->cmp_formatado['categoria_categoria_input_2'] . "'";
      }
      $Conteudo = $sc_field_0;
      if (strtoupper($sc_field_0_cond) != "II" && strtoupper($sc_field_0_cond) != "QP" && strtoupper($sc_field_0_cond) != "NP" && strtoupper($sc_field_0_cond) != "IN") 
      { 
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($categoria_categoria) || $categoria_categoria_cond == "nu" || $categoria_categoria_cond == "nn" || $categoria_categoria_cond == "ep" || $categoria_categoria_cond == "ne")
      {
         $this->monta_condicao("categoria.CATEGORIA", $categoria_categoria_cond, $categoria_categoria, "", "categoria_categoria", "CHAR", false);
      }
      ...
      {
         $this->monta_condicao("count(empresa.CATEGORIA)", $sc_field_0_cond, $sc_field_0, "", "sc_field_0", "BIGINT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_categoria']['where_pesq'];
