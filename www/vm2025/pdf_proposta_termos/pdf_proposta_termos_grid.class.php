<?php
class pdf_proposta_termos_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdf_proposta_termos']['default_font'] = $this->default_font;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdf_proposta_termos']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['qt_col_grid']) 
      {  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_proposta_termos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          { 
            ...
            $cell_VMPABX = array('posx' => '141.34941249998218', 'posy' => '19.707224999997514', 'data' => $this->SC_conv_utf8('PABX: 21 2142-1300'), 'width'      => '0', 'align'      => 'R', 'font_type'  => $this->default_font, 'font_size'  => '8', 'color_r'    => '60', 'color_g'    => '60', 'color_b'    => '60', 'font_style' => $this->default_style);
            $cell_VMEMAIL = array('posx' => '138.4389958333159', 'posy' => '25.292579166663476', 'data' => $this->SC_conv_utf8('Email: comercial@videomart.com.br'), 'width'      => '0', 'align'      => 'R', 'font_type'  => $this->default_font, 'font_size'  => '8', 'color_r'    => '60', 'color_g'    => '60', 'color_b'    => '60', 'font_style' => $this->default_style);
            $cell_VMWhatsApp = array('posx' => '130.7660791666502', 'posy' => '31.411068749996037', 'data' => $this->SC_conv_utf8('WhatsApp: 55 21 99312-3607'), 'width'      => '0', 'align'      => 'R', 'font_type'  => $this->default_font, 'font_size'  => '8', 'color_r'    => '60', 'color_g'    => '60', 'color_b'    => '60', 'font_style' => $this->default_style);
            ...
            $cell_termos = array('posx' => '10', 'posy' => '197', 'data' => $this->proposta_condpag[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '8', 'color_r'    => '60', 'color_g'    => '60', 'color_b'    => '60', 'font_style' => $this->default_style);
            $cell_obs = array('posx' => '10.260859166665373', 'posy' => '245.51692916663572', 'data' => $this->proposta_obs[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '8', 'color_r'    => '60', 'color_g'    => '60', 'color_b'    => '60', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetFont($cell_termos['font_type'], $cell_termos['font_style'], $cell_termos['font_size']);
            $this->Pdf->SetTextColor($cell_termos['color_r'], $cell_termos['color_g'], $cell_termos['color_b']);
            if (!empty($cell_termos['posx']) && !empty($cell_termos['posy']))
            {
                $this->Pdf->SetXY($cell_termos['posx'], $cell_termos['posy']);
            }
            elseif (!empty($cell_termos['posx']))
            {
                $this->Pdf->SetX($cell_termos['posx']);
            }
            elseif (!empty($cell_termos['posy']))
            {
                $this->Pdf->SetY($cell_termos['posy']);
            }
            if ($this->Font_ttf)
            {
                $this->Pdf->Cell($cell_termos['width'], 0, $cell_termos['data'], 0, 0, $cell_termos['align']);
            }
            else
            {
                $atu_X = $this->Pdf->GetX();
                $atu_Y = $this->Pdf->GetY();
                $this->Pdf->writeHTMLCell($cell_termos['width'], 0, $atu_X, $atu_Y, $cell_termos['data'], 0, 0, false, true, $cell_termos['align']);
            }
