<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_proposta_termos']['sc_process_barr'] = true;
require_once('../pdf_proposta_termos/index.php');
unset($_SESSION['scriptcase']['pdf_proposta_termos']['sc_process_barr']);
$ExportCtrl = new pdf_proposta_termos_export_control;
$ExportCtrl->Export_barr();

class pdf_proposta_termos_export_control
{
