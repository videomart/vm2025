<?php
@session_start() ;
$_SESSION['scriptcase']['ChartPropostaXVendas']['sc_process_barr'] = true;
require_once('../ChartPropostaXVendas/index.php');
unset($_SESSION['scriptcase']['ChartPropostaXVendas']['sc_process_barr']);
$ExportCtrl = new ChartPropostaXVendas_export_control;
$ExportCtrl->Export_barr();

class ChartPropostaXVendas_export_control
{
