...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____ChartPropostaXVendas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____ChartPropostaXVendas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>ChartPropostaXVendas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['ChartPropostaXVendas']['embutida_filho'] as $ind => $sc_init)
          {
