...
<?php
   ...
   $Ord_Cmp = new grid_contas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["id_empresa"] : "Empresa";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "DATA";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["data"] : "Período";
   $tab_ger_campos['referencia'] = "on";
   $tab_def_campos['referencia'] = "REFERENCIA";
   $tab_labels["referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["referencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["referencia"] : "Referência";
   $tab_ger_campos['moeda'] = "on";
   $tab_def_campos['moeda'] = "moeda";
   $tab_labels["moeda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["moeda"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["moeda"] : "Moeda";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "CREDITO";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["credito"] : "Crédito";
   $tab_ger_campos['debito'] = "on";
   $tab_def_campos['debito'] = "DEBITO";
   $tab_labels["debito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["debito"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["debito"] : "Débito";
   ...
   {
       $tab_def_campos['subtotal'] = "(CREDITO-DEBITO)";
   }
   $tab_labels["subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["subtotal"] : "SubTotal";
   $tab_ger_campos['id_subconta'] = "on";
   $tab_def_campos['id_subconta'] = "ID_SUBCONTA";
   $tab_labels["id_subconta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["id_subconta"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['labels']["id_subconta"] : "Subconta";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_contas']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
