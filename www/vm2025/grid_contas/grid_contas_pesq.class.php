...
class grid_contas_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_contas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_contas_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_contas_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_contas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_contas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_empresa')
      {
          $id_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_empresa($id_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_empresa($id_empresa)
   {
      $id_empresa = substr($this->Db->qstr($id_empresa), 1, -1);
      ...
      {
          $nm_comando = "select ID, EMPRESA from empresa where  EMPRESA like '%" . $id_empresa . "%' order by EMPRESA"; 
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - contas</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_contas/grid_contas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_contas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_contas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_contas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_contas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_contas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
nmdg_enter_tab = true;
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_moeda#NMF#' + search_get_radio('SC_moeda') + '@NMF@';
  ...
  str_out += 'id_ac_id_empresa#NMF#' + search_get_text('id_ac_id_empresa') + '@NMF@';
  str_out += 'SC_data_cond#NMF#' + search_get_sel_txt('SC_data_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_data_cond');
  if (opc.substring(0, 3) != "bi_")
  {
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_id_empresa").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_id_empresa").autocomplete({
     minLength: 1,
     ...
     select: function (event, ui) {
       ...
       $("#SC_id_empresa").val(ui.item.value);
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             $moeda_cond, $moeda,
             $id_empresa_cond, $id_empresa, $id_empresa_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $moeda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['moeda']; 
          $moeda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['moeda_cond']; 
          $id_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['id_empresa']; 
          $id_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['id_empresa_cond']; 
          $data_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_dia']; 
          $data_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_mes']; 
          $data_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_ano']; 
          $data_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2_dia']; 
          $data_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2_mes']; 
          $data_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2_ano']; 
          $data_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_cond']; 
          $referencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['referencia']; 
          $referencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['referencia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['NM_operador']; 
      } 
      ...
      if (isset($data_cond) && substr($data_cond, 0, 3) == "bi_")
      {
         $Temp_cond = $data_cond;
         $this->Ini->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $data_dia = substr($BI_data1, 0, 2);
         $data_mes = substr($BI_data1, 2, 2);
         $data_ano = substr($BI_data1, 4, 4);
         if (strlen($BI_data1) > 8)
         {
             $data_hor = substr($BI_data1, 8, 2);
             $data_min = substr($BI_data1, 10, 2);
             $data_seg = substr($BI_data1, 12, 2);
         }
         $data_input_2_dia = substr($BI_data2, 0, 2);
         $data_input_2_mes = substr($BI_data2, 2, 2);
         $data_input_2_ano = substr($BI_data2, 4, 4);
         if (strlen($BI_data2) > 8)
         {
             $data_input_2_hor = substr($BI_data2, 8, 2);
             $data_input_2_min = substr($BI_data2, 10, 2);
             $data_input_2_seg = substr($BI_data2, 12, 2);
         }
         $Script_BI .= "  formata_bi_data('" . $data_cond . "', '" . $Temp_cond . "', '" . $BI_data1 . "');\r\n";
      }
      ...
      $str_display_moeda = ('bw' == $moeda_cond) ? $display_aberto : $display_fechado;
      $str_display_id_empresa = ('bw' == $id_empresa_cond) ? $display_aberto : $display_fechado;
      $str_display_data = ('bw' == $data_cond || 'bi_' == substr($data_cond, 0, 3)) ? $display_aberto : $display_fechado;
      $str_display_referencia = ('bw' == $referencia_cond) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <INPUT type="hidden" id="SC_moeda_cond" name="moeda_cond" value="eq">
...
<?php
  if (!isset($moeda)) {$moeda = $moeda;}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['psq_check_ret']['moeda'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['psq_check_ret']['moeda'][] = "Dolar";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['psq_check_ret']['moeda'][] = "Real";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px; border-spacing: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_moeda" name="moeda" value="Dolar##@@Dolar"  <?php if ("Dolar" == $moeda)  { echo " checked" ;} ?>>Dolar</TD>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_moeda" name="moeda" value="Real##@@Real"  <?php if ("Real" == $moeda)  { echo " checked" ;} ?><?php  if (empty($moeda)) { echo " checked" ;} ?>>Real</TD>
</TR></TABLE>
...
<?php
   ...
   { 
      if (isset($this->Ini->nm_bases_postgres) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select ID, EMPRESA from empresa where ID = $id_empresa_look order by EMPRESA"; 
      }
      elseif (isset($this->Ini->nm_bases_sybase) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select ID, EMPRESA from empresa where ID = $id_empresa_look order by EMPRESA"; 
      ...
      if (isset($nmgp_def_dados[0][$id_empresa]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_empresa];
      }
      else
      {
          $sAutocompValue = $id_empresa;
      }
?>
<INPUT  type="text" id="SC_id_empresa" name="id_empresa" value="<?php echo NM_encode_input($id_empresa) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: true}" style="display: none">
<input class="sc-js-input scFilterObjectEven " type="text" id="id_ac_id_empresa" name="id_empresa_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: true}">
      ...
      <TD id='SC_data_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['data'])) ? $this->New_label['data'] : "Período"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd " alt="{autoTab: false, enterTab: true}" id="SC_data_cond" name="data_cond" onChange="nm_campos_between(document.getElementById('id_vis_data'), this, 'data')">
       <OPTION value="bi_TP" <?php if ("bi_TP" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_ever'] ?></OPTION>
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="bi_OT" <?php if ("bi_OT" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="bi_U7" <?php if ("bi_U7" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="bi_SP" <?php if ("bi_SP" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw'] ?></OPTION>
       <OPTION value="bi_US" <?php if ("bi_US" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw_bsnd'] ?></OPTION>
       <OPTION value="bi_MM" <?php if ("bi_MM" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="bi_UM" <?php if ("bi_UM" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="bi_AM" <?php if ("bi_AM" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tomw'] ?></OPTION>
       <OPTION value="bi_PS" <?php if ("bi_PS" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nxtw_mond_frid'] ?></OPTION>
       <OPTION value="bi_SS" <?php if ("bi_SS" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nxtw_mond_sund'] ?></OPTION>
       <OPTION value="bi_P3" <?php if ("bi_P3" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nx30'] ?></OPTION>
       <OPTION value="bi_PM" <?php if ("bi_PM" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_next_mnth'] ?></OPTION>
       <OPTION value="bi_P7" <?php if ("bi_P7" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nxt7'] ?></OPTION>
       <OPTION value="bi_CY" <?php if ("bi_CY" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year_today'] ?></OPTION>
       <OPTION value="bi_LY" <?php if ("bi_LY" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="bi_YY" <?php if ("bi_YY" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="bi_M6" <?php if ("bi_M6" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="bi_M3" <?php if ("bi_M3" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_data" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_data"  style=display:  border="0" cellpadding="0" cellspacing="0">
...
?>
      ...
      <TD id='SC_referencia_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['referencia'])) ? $this->New_label['referencia'] : "Referência"; ?></TD>
...
?>
<INPUT  type="text" id="SC_referencia" name="referencia" value="<?php echo NM_encode_input($referencia) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}" class="sc-js-input scFilterObjectEven ">
...
?>
<?php
   if (is_file("grid_contas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 Arr_def_moeda = new Array();
 Arr_def_moeda[0] = 'Real';
 function limpa_form()
 {
   document.F1.reset();
   ...
   for (i = 0; i < document.F1.moeda.length; i++)
   {
      if (document.F1.moeda[i].checked)
      {
          document.F1.moeda[i].checked = false;
      }
   }
   if (Arr_def_moeda[0]) {
       for (i = 0; i < document.F1.elements.length; i++) {
           if (document.F1.elements[i].name == 'moeda') {
               for (iz = 0; iz < Arr_def_moeda.length; iz++) {
                    Arr_def_test = Arr_def_moeda[iz] + "##@@"
   ...
   document.F1.id_empresa_autocomp.value = "";
   document.F1.data_cond.value = 'bi_TP';
 ...
 {
    $('#SC_data_dia').bind('change', function() {sc_grid_contas_valida_dia(this)});
    $('#SC_data_input_2_dia').bind('change', function() {sc_grid_contas_valida_dia(this)});
    $('#SC_data_input_2_mes').bind('change', function() {sc_grid_contas_valida_mes(this)});
    $('#SC_data_mes').bind('change', function() {sc_grid_contas_valida_mes(this)});
 }
 function sc_grid_contas_valida_dia(obj)
 {
 ...
 function sc_grid_contas_valida_mes(obj)
 {
...
function formata_bi_data(opc, opc_bi, dt_fmt)
{
   if (opc.substring(0,3) != "bi_")
   {
       document.getElementById('Nm_bi_dados_data').style.display = 'none';
       document.getElementById('opc_bi_TP_data').style.display = '';
       return;
   }
   if (opc == "bi_TP")
   {
       document.getElementById('Nm_bi_dados_data').style.display = 'none';
       document.getElementById('opc_bi_TP_data').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.data_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.data_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.data_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.data_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.data_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.data_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
       saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_data').innerHTML = saida;
   document.getElementById('opc_bi_TP_data').style.display = 'none';
   document.getElementById('Nm_bi_dados_data').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_moeda'] = 'radio';
      $tp_fields['SC_id_empresa_cond'] = 'cond';
      $tp_fields['SC_id_empresa'] = 'text_aut';
      $tp_fields['id_ac_id_empresa'] = 'text_aut';
   ...
   function trata_campos()
   {
      ...
      if (!empty($id_empresa_autocomp) && empty($id_empresa))
      {
          $id_empresa = $id_empresa_autocomp;
      }
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($moeda, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['psq_check_ret']['moeda'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Moeda : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['moeda'] = $moeda; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['moeda_cond'] = $moeda_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['id_empresa'] = $id_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['id_empresa_cond'] = $id_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_dia'] = $data_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_mes'] = $data_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_ano'] = $data_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2_dia'] = $data_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2_mes'] = $data_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2_ano'] = $data_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_cond'] = $data_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['referencia'] = $referencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['referencia_cond'] = $referencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca'] = $Temp_Busca;
      }
      if ($id_empresa_cond != "in" && $id_empresa_cond != "bw" && !empty($id_empresa) && !is_numeric($id_empresa))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Empresa";
      }
      if ($id_empresa_cond == "bw" && ((!empty($id_empresa) && !is_numeric($id_empresa)) || (!empty($id_empresa_input_2) && !is_numeric($id_empresa_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Empresa";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['moeda'] = $moeda;
      if (strpos($this->cmp_formatado['moeda'], "##@@") !== false)
      {
          $this->cmp_formatado['moeda'] = substr($this->cmp_formatado['moeda'], strpos($this->cmp_formatado['moeda'], "##@@") + 4);
      }
      $this->cmp_formatado['moeda_input_2'] = $moeda_input_2;
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_empresa'] = $id_empresa;
      }
          $this->cmp_formatado['id_empresa'] = strtoupper($this->cmp_formatado['id_empresa']);
      ...
      $this->cmp_formatado['referencia'] = "'" . $this->cmp_formatado['referencia'] . "'";
      if (isset($this->cmp_formatado['referencia_input_2'])  && !empty($this->cmp_formatado['referencia_input_2'])) {
          $this->cmp_formatado['referencia_input_2'] = "'" . $this->cmp_formatado['referencia_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if ($data_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data'] = $val[0];
          ...
          if ($data_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']['data_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("REFERENCIA", $referencia_cond, $referencia, "", "referencia", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq'] .= $this->NM_operador;
