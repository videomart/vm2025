...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_contas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_contas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_filho'] as $ind => $sc_init)
          {
