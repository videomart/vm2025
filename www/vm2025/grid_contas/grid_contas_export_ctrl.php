<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contas']['sc_process_barr'] = true;
require_once('../grid_contas/index.php');
unset($_SESSION['scriptcase']['grid_contas']['sc_process_barr']);
$ExportCtrl = new grid_contas_export_control;
$ExportCtrl->Export_barr();

class grid_contas_export_control
{
