<?php
   include_once('grid_contas_session.php');
   @ini_set('session.cookie_httponly', 0);
   @ini_set('session.use_only_cookies', 0);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['grid_contas']['glo_nm_perfil']          = "vmdata_con";
   $_SESSION['scriptcase']['grid_contas']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_contas']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_contas']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_contas']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['grid_contas']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['grid_contas']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['grid_contas']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['grid_contas']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['grid_contas']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_contas']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['grid_contas']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['grid_contas']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class grid_contas_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_contas']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "grid_contas"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_contas']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_contas']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_contas']['save_session']['data'] = '';
      } 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['sub_cons_schema_filter'];
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_contas';
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_contas']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['grid_contas']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_contas']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_contas']['actual_lang']) || $_SESSION['scriptcase']['grid_contas']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_contas']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("grid_contas_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['grid_contas']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_border']   = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_background'] = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
              if (isset($_GET['remove_background'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_background'] = 1 == $_GET['remove_background'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
              if (isset($remove_background)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['remove_background'] = 1 == $remove_background;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "form_contas";
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_contas_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_contas_ini.php");
          $Tmp_apl_lig = $arr_data['friendly_url'];
          if (isset($arr_data['md5']) && trim($arr_data['md5']) == "LigMd5")
          {
              $this->sc_lig_md5["form_contas"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_id_empresa"] = '_self';
      $this->sc_lig_target["C_@scinf_id_empresa_@scinf_form_contas"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_contas"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_contas"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) || isset($link_remove_margin) || isset($link_remove_border) || isset($link_remove_background) || isset($link_margin_top)) {
            $_SESSION['sc_session'][$this->sc_page]['grid_contas']['link_info'] = array();
        }
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            $_SESSION['sc_session'][$this->sc_page]['grid_contas']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            $_SESSION['sc_session'][$this->sc_page]['grid_contas']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            $_SESSION['sc_session'][$this->sc_page]['grid_contas']['link_info']['remove_border'] = true;
        }
        if (isset($link_remove_background) && 'ok' == $link_remove_background) {
            $_SESSION['sc_session'][$this->sc_page]['grid_contas']['link_info']['remove_background'] = true;
        }
        if (isset($link_margin_top) && '' != $link_margin_top) {
            $_SESSION['sc_session'][$this->sc_page]['grid_contas']['link_info']['margin_top'] = $link_margin_top;
        }
      $this->link_form_contas_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_contas') . "/" ; 
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_contas']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_contas']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_contas']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_contas']['path_doc'] = $this->path_doc; 
...
<body>
    <div class='ui container' style='padding-top:2rem'>
        <section class='ui message'>
         ...
         echo $str_message;
          if (!$_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "grid_contas_erro.class.php"); 
      $this->Erro = new grid_contas_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('grid_contas'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['grid_contas']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_contas']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_contas']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_contas']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_contas']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_contas']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_contas']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['grid_contas']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao']) && $_SESSION['scriptcase']['grid_contas']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_contas']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_contas']['glo_nm_perfil']) && $_SESSION['scriptcase']['grid_contas']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['grid_contas']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['grid_contas']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['grid_contas']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['grid_contas']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['grid_contas']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['grid_contas']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['grid_contas']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['grid_contas']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_contas']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_contas']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_contas']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_contas']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
class grid_contas_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['grid_contas']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['grid_contas']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['grid_contas'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class grid_contas_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_contas']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_contas'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_grid_contas($cadapar[1]);
                       nm_protect_num_grid_contas($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini) 
      { 
          $this->Ini = new grid_contas_ini(); 
          $this->Ini->init();
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           {
                $cadapar  = explode("?#?", $param);
                if ($cadapar[0] == "id_empresa")  
                { 
                    $cadapar[0] = str_replace("id_empresa", "ID_EMPRESA", $cadapar[0]);
                } 
                if ($cadapar[0] == "data")  
                { 
                ...
                { 
                    $cadapar[0] = str_replace("referencia", "REFERENCIA", $cadapar[0]);
                } 
                if ($cadapar[0] == "credito")  
                { 
                    $cadapar[0] = str_replace("credito", "CREDITO", $cadapar[0]);
                } 
                if ($cadapar[0] == "debito")  
                { 
                    $cadapar[0] = str_replace("debito", "DEBITO", $cadapar[0]);
                } 
                if ($cadapar[0] == "subtotal")  
                { 
                    $cadapar[0] = str_replace("subtotal", "(CREDITO-DEBITO)", $cadapar[0]);
                } 
                if ($cadapar[0] == "id_subconta")  
                { 
                    $cadapar[0] = str_replace("id_subconta", "ID_SUBCONTA", $cadapar[0]);
                } 
                if ($cadapar[0] == "id")  
                { 
                    $cadapar[0] = str_replace("id", "ID", $cadapar[0]);
                } 
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'] == "groupby_1")
                { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_contas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['grid_contas'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_contas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_contas']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_contas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_contas']['label'] = "Sistema Videomart 2020";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_contas/grid_contas_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "grid_contas_erro.class.php"); 
      } 
      $this->Erro      = new grid_contas_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_contas/grid_contas_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "grid_contas_lookup.class.php"); 
      } 
      $this->Lookup       = new grid_contas_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_contas_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['grid_contas']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['grid_contas']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['using_summary_cache']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['pivot_tabular']);
              }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_date_format'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_date_format']['groupby_1']['data'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_date_format']['groupby_1']['data'] = 'YYYYMM';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_def_sql']['groupby_1']['data'] = 'DATA';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_All_Groupby'] = array('groupby_1' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'] == "groupby_1")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['Labels_GB'][] = "Período";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display']['groupby_1']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display']['groupby_1'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_order']['groupby_1'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display']['groupby_1'][3] = array('label' => "Crédito(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_order']['groupby_1'][] = 3;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display']['groupby_1'][4] = array('label' => "Débito(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_order']['groupby_1'][] = 4;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display']['groupby_1'][5] = array('label' => "SUBTOTAL(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_order']['groupby_1'][] = 5;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_control']['groupby_1']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_control']['groupby_1'] = array(
               array(
                   'cmp_res' => "NM_Count",
               ...
               array(
                   'cmp_res' => "credito",
                   'label' => "Crédito(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "Crédito",
                   'options' => array(
                       array('op' => 'S', 'index' => '3', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-credito\" onChange=\"scSummChange($(this))\"><option value=\"3\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
               array(
                   'cmp_res' => "debito",
                   'label' => "Débito(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
                   'label_field' => "Débito",
                   'options' => array(
                       array('op' => 'S', 'index' => '4', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-debito\" onChange=\"scSummChange($(this))\"><option value=\"4\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
               array(
                   'cmp_res' => "subtotal",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_contas_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_contas_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_grid_contas_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_grid_contas_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['grid_contas']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$script_case_init]['grid_contas']['skip_summary'] = false;
      if ('chart' == $this->Ini->SC_module_export) {
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['skip_summary'] = true;
          $this->Ini->SC_module_export = 'resume,chart';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_disp']))
      {
          $thisChartWidth = '800';
          $thisChartHeight = '500';
          if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_contas'] ['responsive_chart'] ['active']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_contas'] ['responsive_chart'] ['active']) {
              $thisChartWidth = '100%';
              $thisChartHeight = '85%';
          } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_contas'] ['responsive_chart'] ['active']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_contas'] ['responsive_chart'] ['active']) {
              $thisChartWidth = '800';
              $thisChartHeight = '500';
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_disp'] = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_tipo'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_larg'] = $thisChartWidth;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_alt'] = $thisChartHeight;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_opc_atual'] = '2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_order'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chartpallet'] = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_exibe_val'] = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_has_enable_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_show_enable_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_enable_scroll'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_is_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_is_overlapped'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_barra_is_overlapped'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pizza_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_linha_is_scroll'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_linha_is_zoom'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_area_is_scroll']  = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_funil_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_pyram_forma'] = 'S';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cfg_graf']['graf_combi_dimen'] = '2d';
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['subtotal']['graf_tipo']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_disp']        = array('Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_tipo']        = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_mod_allowed'] = array(1);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_font']        = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_subtitle_val'] = 'below';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_funil_dimen'] = '2d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['subtotal']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_treeview'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida_opcao'] = "";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "id_empresa";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "data";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "referencia";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "moeda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "credito";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "debito";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "subtotal";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'][] = "id_subconta";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_contas']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga']['inicial'];
              $_SESSION['sc_session'][$script_case_init]['grid_contas']['orig_pesq'] = "grid";
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "pdf")
      { 
      ...
      if (isset($_POST['nmgp_opcao']) && 'resumo' == $_POST['nmgp_opcao']
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_array_resumo'] = 'NAO';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_total_geral'] = 'NAO';
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['using_summary_cache']);
      }

      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_array_resumo'] = "NAO";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_total_geral']  = "NAO";
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['tot_geral']);
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['using_summary_cache']);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq'] = 'grid';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'inicio';
          } 
      } 
      if ('gantt' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] && ('inicio' == $_GET['nmgp_opcao'] || 'inicio' == $_POST['nmgp_opcao'])) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = 'inicio';
      }
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf']);
       if (!$GLOBALS['nm_restore_grid_save']) { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_fast']   = "";
       }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['tot_geral']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['using_summary_cache']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_array_resumo'] = "NAO";
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_ant'];  
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_contas_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_contas.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_grid_contas_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_contas_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_grid_contas_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_xls.class.php"); 
          } 
          $this->xls  = new grid_contas_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_res_xls.class.php"); 
          } 
          $this->xls  = new grid_contas_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_xml.class.php"); 
          } 
          $this->xml  = new grid_contas_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_res_xml.class.php"); 
          } 
          $this->xml  = new grid_contas_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_json.class.php"); 
          } 
          $this->json  = new grid_contas_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_csv.class.php"); 
          } 
          $this->csv  = new grid_contas_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_res_csv.class.php"); 
          } 
          $this->csv  = new grid_contas_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_rtf.class.php"); 
          } 
          $this->rtf  = new grid_contas_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_contas_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
    if (isset($_POST['chartapp_action']) && 'Y' == $_POST['chartapp_action']) {
        if (isset($_POST['chartapp_chart_type']) && 'Y' == $_POST['chartapp_chart_type'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_info'][$_POST['chart_md5']])) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida']) {
                require_once($this->Ini->path_embutida . "grid_contas" . $this->Ini->Apl_resumo);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo);
            }
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_app_change_type'] = true;
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_app_md5'] = $_POST['chart_md5'];
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_app_type'] = $_POST['chart_type'];
            $this->Res = new grid_contas_resumo("out");
            $this->prep_modulos("Res");
            $this->Res->monta_resumo();
        } else {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida']) {
                require_once($this->Ini->path_embutida . "grid_contas" . $this->Ini->Apl_grafico);
            } else {
                require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico);
            }
            $this->Graf = new grid_contas_grafico();
      ...
      { 
          ...
          $this->Graf  = new grid_contas_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_POST['summary_chart_data']) && 'Y' == $_POST['summary_chart_data'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_data($_POST['chart_md5']);
              }
              elseif (isset($_POST['summary_chart']) && 'Y' == $_POST['summary_chart'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_info'][$_POST['chart_md5']])) {
              ...
              elseif (isset($_POST['chart_inline_update']) && 'Y' == $_POST['chart_inline_update'] && isset($_POST['chart_md5']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['chart_info'][$_POST['chart_md5']])) {
                  $this->Graf->display_summaryChart_inline_updateAjaxResponse($_POST['chart_md5']);
              }
              elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new grid_contas_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/" . $this->Ini->Apl_resumo); 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_grid_contas_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_contas/grid_contas_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_contas_grid.class.php"); 
          } 
          $this->grid  = new grid_contas_grid();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['opcao'] != "ajax_detalhe")  
             {
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_contas_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_contas_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_contas_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_contas']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_contas.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_fast'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_filtro'] = "";
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq'] = $tmp_cmd;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['fast_search']);
          return;
      }
      $comando = "";
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "DEBITO", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp") 
          {
              $this->SC_monta_condicao($comando, "(CREDITO-DEBITO)", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_fast'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq_filtro'] = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'])) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_orig'] . " and ( " . $comando . " )"; 
      }
      else
      {
          $comando = " where (" . $comando . ")"; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $nm_numeric[] = "id";$nm_numeric[] = "id_empresa";$nm_numeric[] = "credito";$nm_numeric[] = "debito";$nm_numeric[] = "(credito-debito)";$nm_numeric[] = "id_subconta";
      if (in_array($campo_join, $nm_numeric))
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_sep_date']))
      {
          $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_sep_date'];
          $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['SC_sep_date1'];
      }
   ...
   function SC_lookup_id_subconta($condicao, $campo)
   {
       ...
       $nm_comando = "SELECT CONTA, ID FROM subconta WHERE (#lowerI##cmp_iCONTA#cmp_f)#cmp_apos LIKE #lowerI#'%#arg_i" . $campo . "#arg_f%')#arg_apos$Ctrl_sql_escape)"; 
       if ($condicao == "ii")
       {
           $nm_comando = str_replace("LIKE #lowerI#'%#arg_i" . $campo . "#arg_f%')", "LIKE #lowerI#'#arg_i" . $campo . "#arg_f%')", $nm_comando);
       }
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'] . "/");
...
<form name="Fdown" method="get" action="grid_contas_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_contas"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contas'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['grid_contas']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['grid_contas']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_grid_contas($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_grid_contas($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_contas']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "grid_contas") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_contas']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_contas']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['grid_contas']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_VM2025'])) {
               $_SESSION['scriptcase']['grid_contas']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_VM2025'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_contas']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_contas']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['grid_contas']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['grid_contas']['embutida_form_parms']);
       $nm_apl_dependente = 1;
       $nm_embutida_form  = true;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['grid_contas']);
               $_SESSION['sc_session'][$script_case_init]['grid_contas']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['grid_contas']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['grid_contas']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['grid_contas']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['grid_contas']['protect_modal']) && !empty($_SESSION['scriptcase']['grid_contas']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['grid_contas']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "grid_contas";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'grid_contas' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['grid_contas']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_contas/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['grid_contas']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['contr_total_geral'] = "NAO";
   }
   ...
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "pt_br";
   if (isset($_SESSION['scriptcase']['grid_contas']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_contas']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_Meadow/Sc9_Meadow";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'grid_contas')
   {
       $_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['grid_contas']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/grid_contas_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['grid_contas']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = $nmgp_opcao ;  
       }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['grid_contas']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['grid_contas']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['grid_contas']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['volta_redirect_tp'] = "";
           $nm_url_saida = "grid_contas_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['grid_contas']['sc_modal'] = true;
               }
               $nm_url_saida = "grid_contas_fim.php"; 
           }
           elseif (!$nm_embutida_form)
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['grid_contas']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['grid_contas']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['grid_contas']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['grid_contas']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_contas']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['grid_contas']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['grid_contas']['mostra_edit'] = "N";   
           } 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_contas'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_contas'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['grid_contas']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_contas']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contas']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_contas'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_contas']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("grid_contas", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
       ...
       $contr_grid_contas = new grid_contas_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = "busca";
          $contr_grid_contas->NM_ajax_flag = true;
          $contr_grid_contas->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = "busca";
          $contr_grid_contas->NM_ajax_flag = true;
          $contr_grid_contas->NM_ajax_opcao = "ajax_ch_bi_search";
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = "busca";
          $contr_grid_contas->NM_ajax_flag = true;
          $contr_grid_contas->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = "busca";
          $contr_grid_contas->NM_ajax_flag = true;
          $contr_grid_contas->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] = "busca";
          $contr_grid_contas->NM_ajax_flag = true;
          $contr_grid_contas->NM_ajax_opcao = "ajax_filter_select";
      }
       $contr_grid_contas->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['grid_contas']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_grid_contas(&$str)
   {
   }
   function nm_protect_num_grid_contas($name, &$val)
   {
       if (empty($val))
       {
          return;
       ...
       $Nm_numeric[] = "credito";
       $Nm_numeric[] = "debito";
       $Nm_numeric[] = "(credito-debito)";
       $Nm_numeric[] = "id_subconta";
   ...
   function grid_contas_pack_protect_string($sString)
   {
    ...
    function grid_contas_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_contas']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
