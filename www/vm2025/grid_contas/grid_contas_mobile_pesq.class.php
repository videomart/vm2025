...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_numeric[] = "id";$Nm_numeric[] = "id_empresa";$Nm_numeric[] = "credito";$Nm_numeric[] = "debito";$Nm_numeric[] = "(credito-debito)";$Nm_numeric[] = "id_subconta";
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_moeda"  <?php echo $str_hide_moeda?>> 
<?php
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_id_empresa"  <?php echo $str_hide_id_empresa?>><?php
      if ($id_empresa != "")
      {
      $id_empresa_look = (is_string($id_empresa) ? substr($this->Db->qstr($id_empresa), 1, -1) : $id_empresa); 
      $nmgp_def_dados = array(); 
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd " alt="{autoTab: false, enterTab: true}" id="SC_data_cond" name="data_cond" onChange="nm_campos_between(document.getElementById('id_vis_data'), this, 'data')">
...
<SPAN id="Nm_bi_dados_data" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_data"  style="display:''">
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_referencia"  <?php echo $str_hide_referencia?>><INPUT  type="text" id="SC_referencia" name="referencia" value="<?php echo NM_encode_input($referencia) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}" class="sc-js-input scFilterObjectEven ">
 </TD>
