...
session_start();
    ...
    $SC_cod_proj = "VM2025";
    $SC_apl_proc = "grid_resultado_financeiro";
    $SC_ver_93   = true;
...
$bookmarks    = (isset($_GET['bookmarks'])) ?    htmlspecialchars($_GET['bookmarks'], ENT_QUOTES, 'UTF-8') : "S";
$label_group  = (isset($_GET['nm_label_group'])) ? htmlspecialchars($_GET['nm_label_group'], ENT_QUOTES, 'UTF-8') : "S";
$all_cab      = (isset($_GET['nm_all_cab']))     ? htmlspecialchars($_GET['nm_all_cab'], ENT_QUOTES, 'UTF-8') : "N";
$all_label    = (isset($_GET['nm_all_label']))   ? htmlspecialchars($_GET['nm_all_label'], ENT_QUOTES, 'UTF-8') : "N";
$pdf_zip      = (isset($_GET['pdf_zip']) && $ver_93 == "s") ? htmlspecialchars($_GET['pdf_zip'], ENT_QUOTES, 'UTF-8') : "N";
$orient_grid  = (isset($_GET['nm_orient_grid'])) ? htmlspecialchars($_GET['nm_orient_grid'], ENT_QUOTES, 'UTF-8') : "2";
...
<head>
    <META http-equiv="Content-Type"
          content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html']; ?>"/>
    <?php
    ...
    <link rel="stylesheet" type="text/css"
          href="../_lib/css/<?php echo $_SESSION['scriptcase']['css_popup_tab_dir'] ?>"/>
    <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $_SESSION['scriptcase']['css_popup_div'] ?>"/>
    <link rel="stylesheet" type="text/css"
          href="../_lib/css/<?php echo $_SESSION['scriptcase']['css_popup_div_dir'] ?>"/>
    <?php
    ...
    ?>
    <link rel="stylesheet" type="text/css"
          href="../_lib/buttons/<?php echo $_SESSION['scriptcase']['css_btn_popup'] ?>"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo $_SESSION['sc_session']['path_third'] ?>/jquery/css/smoothness/jquery-ui.css"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo $_SESSION['sc_session']['path_third'] ?>/font-awesome/6/css/all.min.css"/>
</head>
<body class="scGridPage" style="margin: 0px; overflow-x: hidden">

<script language="javascript" type="text/javascript"
        src="<?php echo $_SESSION['sc_session']['path_third'] ?>/jquery/js/jquery.js"></script>
<script language="javascript" type="text/javascript"
        src="<?php echo $_SESSION['sc_session']['path_third'] ?>/jquery/js/jquery-ui.js"></script>
<script language="javascript" type="text/javascript"
        src="<?php echo $_SESSION['sc_session']['path_third'] ?>/tigra_color_picker/picker.js"></script>
...
<form name="config_pdf" method="post">
    ...
    ?>
    <table id="main_table" class="exportConfig"
           style="position: relative; <?php echo $top; ?> <?php echo $pos; ?>: 20px">
        <tr>
            <td align="center">

                <div id="tabs">
                    <ul class="scAppDivTabLine" style="display:<?php echo ($hasSelColumns) ? "" : "none"; ?>">
                        <li class="scTabActive scGridToolbar" id="ctrl_tabs-general"
                            style="font-weight: bold;cursor: pointer;"
                            onclick="change_tabs('tabs-general', 'tabs-sel-columns')"><?php echo $tradutor[$language]['titulo']; ?></li>
                        <li class="scTabInactive scGridToolbar" id="ctrl_tabs-sel-columns"
                            style="font-weight: bold;cursor: pointer;"
                            onclick="change_tabs('tabs-sel-columns', 'tabs-general')"><?php echo $tradutor[$language]['titulo_colunas']; ?></li>
                    </ul>
                    <div id="tabs-general" style="padding: 0px; margin: 0px">
                        ...
                        <table class="scGridBorder" width='100%' cellspacing="0" cellpadding="0">
                            ...
                            ?>
                            <tr>
                                <td class='scGridToolbar' colspan=<?php echo $colspan; ?> style='font-weight: bold;
                                '><?php echo $tradutor[$language]['group_general']; ?></td>
        </tr>
            ...
            <td class="scGridFieldOddFont" align="left">
                ...
                <div class="input-group input-group-horizontal">
                    ...
                    foreach ($all_modules as $cada_mod) {
                        ...
                        ?>
                        <label>
                            <input type=checkbox id="id_tem_res_cons"
                                   name="tem_res_cons[]" <?php echo $ckeck . $set_grid ?>
                                   value="<?php echo $cada_mod ?>"> <?php echo $tradutor[$language]['mod_' . $cada_mod]; ?>
                        </label>
                        <?php
                    }
                    ?>
        ...
        <tr<?php echo $Opt_display ?>>
            <td class="scGridFieldOddFont">
                ...
                <select name="cor_imp" size=1>
                    <option value="cor" <?php if ($cor == "cor") {
                        echo " selected";
                    } ?>><?php echo $tradutor[$language]['color']; ?></option>
                    <option value="pb" <?php if ($cor == "pb") {
                        echo " selected";
                    } ?>><?php echo $tradutor[$language]['econm']; ?></option>
                </select>
            </td>
        </tr>
        <?php
        if ($conf_socor == "N") {
            ...
            <tr<?php echo $Opt_display ?>>
                <td class="scGridFieldOddFont">
                    ...
                    echo "       <option value=\"" . $tp_papel[1] . "\"";
                    if ($papel == "1") {
                        echo " selected";
                    }
                    echo ">" . $tradutor[$language]['carta'] . " (216 x 279 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[2] . "\"";
                    if ($papel == "2") {
                        echo " selected";
                    }
                    echo ">" . $tradutor[$language]['oficio'] . " (216 x 356 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[3] . "\"";
                    if ($papel == "3") {
                        echo " selected";
                    }
                    echo ">Ledger (432 x 279 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[4] . "\"";
                    if ($papel == "4") {
                        echo " selected";
                    }
                    echo ">A0 (841 X 1189 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[5] . "\"";
                    if ($papel == "5") {
                        echo " selected";
                    }
                    echo ">A1 (594 x 841  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[6] . "\"";
                    if ($papel == "6") {
                        echo " selected";
                    }
                    echo ">A2 (420 x 594  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[7] . "\"";
                    if ($papel == "7") {
                        echo " selected";
                    }
                    echo ">A3 (297 x 420  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[8] . "\"";
                    if ($papel == "8") {
                        echo " selected";
                    }
                    echo ">A4 (210 X 297  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[9] . "\"";
                    if ($papel == "9") {
                        echo " selected";
                    }
                    echo ">A5 (148 x 210  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[10] . "\"";
                    if ($papel == "10") {
                        echo " selected";
                    }
                    echo ">A6 (105 x 148  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[16] . "\"";
                    if ($papel == "16") {
                        echo " selected";
                    }
                    echo ">A7 (74  x 105  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[17] . "\"";
                    if ($papel == "17") {
                        echo " selected";
                    }
                    echo ">A8 (52  x 74   mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[18] . "\"";
                    if ($papel == "18") {
                        echo " selected";
                    }
                    echo ">A9 (37  x 52   mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[20] . "\"";
                    if ($papel == "20") {
                        echo " selected";
                    }
                    echo ">B0 (1000 x 1414 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[21] . "\"";
                    if ($papel == "21") {
                        echo " selected";
                    }
                    echo ">B1 (707  x 1000 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[22] . "\"";
                    if ($papel == "22") {
                        echo " selected";
                    }
                    echo ">B2 (500  x 707  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[23] . "\"";
                    if ($papel == "23") {
                        echo " selected";
                    }
                    echo ">B3 (353  x 500  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[24] . "\"";
                    if ($papel == "24") {
                        echo " selected";
                    }
                    echo ">B4 (250  x 353  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[11] . "\"";
                    if ($papel == "11") {
                        echo " selected";
                    }
                    ...
                    echo ">B9 (33  x 62  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[11] . "\"";
                    if ($papel == "31") {
                        echo " selected";
                    }
                    echo ">B10 (31  x 44  mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[13] . "\"";
                    if ($papel == "13") {
                        echo " selected";
                    }
                    echo ">Tabliod (280 x 432 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[25] . "\"";
                    if ($papel == "25") {
                        echo " selected";
                    }
                    echo ">Executive (190 x 254 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[26] . "\"";
                    if ($papel == "32") {
                        echo " selected";
                    }
                    echo ">C5E (163 x 229 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[26] . "\"";
                    if ($papel == "33") {
                        echo " selected";
                    }
                    echo ">Comm10E (105 x 241 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[26] . "\"";
                    if ($papel == "34") {
                        echo " selected";
                    }
                    echo ">DLE (110 x 220 mm)</option>\r\n";
                    echo "       <option value=\"" . $tp_papel[26] . "\"";
                    if ($papel == "35") {
                        echo " selected";
                    }
                    echo ">Folio (210 x 330 mm)</option>\r\n";
                    ?>
                    </select>
                </td>
            </tr>
            <tr id='customiz_papel' style='display: none'>
                <td class="scGridFieldOddFont" align=right>
                    <font size="1">
                        ...
                        ?>
                        <input type=text name="alt_papel" size=2 maxlength=4
                               value="<?php echo NM_encode_input($apapel); ?>">&nbsp;x&nbsp;
                        <input type=text name="larg_papel" size=2 maxlength=4
                               value="<?php echo NM_encode_input($lpapel); ?>">&nbsp;mm
                </td>
            </tr>
            <?php
        }
            ...
            <tr<?php echo $Opt_display ?>>
                <td class="scGridFieldOddFont">
                    ...
                    <select name="orientacao" size=1>
                        <option value="portrait" <?php if ($orientacao == "1") {
                            echo " selected";
                        } ?>><?php echo $tradutor[$language]['retrato']; ?></option>
                        <option value="landscape"<?php if ($orientacao == "2") {
                            echo " selected";
                        } ?>><?php echo $tradutor[$language]['paisag']; ?></option>
                    </select>
                </td>
            </tr>
            <?php
            ...
            if (isset($_SESSION['scriptcase']['sc_tp_pdf']) && $_SESSION['scriptcase']['sc_tp_pdf'] == "wkhtmltopdf") {
                ...
                <tr>
                    <td class="scGridFieldOddFont">
                        ...
                        ?>
                        <input type="text" name="largura" value="<?php echo NM_encode_input($largura); ?>" size=6
                               maxlength=4>
                    </td>
                </tr>
                <input type="hidden" name="fonte" value="<?php echo NM_encode_input($fonte); ?>">
                ...
                <td class="scGridFieldOddFont">
                    ...
                    <div class="input-group input-group-vertical">
                        ...
                        if ($bookmarks != "XX" && $conf_socor == "N") {
                            ...
                            ?>
                            <label <?php echo $sDisplay; ?>><input type="checkbox" id="id_bookmarks" name="bookmarks"
                                                                   value="<?php echo htmlspecialchars($bookmarks, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $check; ?>><?php echo $tradutor[$language]['book']; ?>
                            </label>
                            <?php
                        }
                        ...
                        if (in_array("grid", $all_modules) !== false && $SC_ver_93) {
                            ...
                            ?>
                            <label id="id_grid_cab" <?php echo $sDisplay; ?>><input type="checkbox" id="id_all_cab"
                                                                                    name="all_cab"
                                                                                    value="<?php echo htmlspecialchars($all_cab, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $check; ?>><?php echo $tradutor[$language]['page_header']; ?>
                            </label>
                            <?php
                            if ($orient_grid == 2) {
                                ...
                                ?>
                                <label id="id_grid_label" <?php echo $sDisplay; ?>><input type="checkbox"
                                                                                          id="id_all_label"
                                                                                          name="all_label"
                                                                                          onclick="control_all_cab()"
                                                                                          value="<?php echo htmlspecialchars($all_label, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $check; ?>><?php echo $tradutor[$language]['page_label']; ?>
                                </label>
                                <?php
                                ...
                                ?>
                                <label id="id_grid_group" <?php echo $sDisplay; ?>><input type="checkbox"
                                                                                          id="id_label_group"
                                                                                          name="label_group"
                                                                                          value="<?php echo htmlspecialchars($label_group, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $check; ?>><?php echo $tradutor[$language]['label_group']; ?>
                                </label>
                                <?php
                            }
                        }
                        ...
                        ?>
                        <label id="id_grid_zip" <?php echo $sDisplay; ?>><input type="checkbox" id="id_pdf_zip"
                                                                                name="pdf_zip"
                                                                                value="<?php echo htmlspecialchars($pdf_zip, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $check; ?>><?php echo $tradutor[$language]['format_zip']; ?>
                        </label>
                    ...
                    <td class="scGridFieldOddFont">
                        ...
                        <div class="input-group input-group-vertical">
                            ...
                            foreach ($_SESSION['sc_session'][$script_case_init][$app_name]['Page_break_PDF'] as $cmp => $page_br) {
                                ...
                                ?>
                                <label>
                                    <input type="checkbox" id="id_page_break" name="page_break[]"
                                           value="<?php echo NM_encode_input($cmp); ?>" <?php echo $sel_br; ?>><?php echo $_SESSION['sc_session'][$script_case_init][$app_name]['Labels_GB'][$ix_lab]; ?>
                                </label>
                                <?php
                                $ix_lab++;
                            }
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_resultado_financeiro']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_resultado_financeiro']['summarizing_drill_down']);
        $isAnalitic = isset($_SESSION['sc_session'][$script_case_init]['grid_resultado_financeiro']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_resultado_financeiro']['graf_opc_atual'];

        if ($ver_93 == "n") {
            $sDisplay = !isset($_SESSION['sc_session']['grid_resultado_financeiro']['show_skip_charts_option']) ||
            !$_SESSION['sc_session']['grid_resultado_financeiro']['show_skip_charts_option'] ||
            (isset($_SESSION['sc_session'][$script_case_init]['grid_resultado_financeiro']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_resultado_financeiro']['SC_Ind_Groupby']) ||
            $isMultiSeriesChart ||
            $isAnalitic ||
            ($opc == 'pdf_det')
                ? ' style="display: none"' : '';
            ...
            <tr<?php echo $sDisplay; ?>>
                <td class='scGridToolbar' style='font-weight: bold;'
                    colspan=<?php echo $colspan; ?>><?php echo $tradutor[$language]['group_chart']; ?></td>
            </tr>
            ...
            <tr<?php echo $sDisplay; ?>>
                <td class="scGridFieldOddFont">
                    ...
                    <select name="create" size=1 onchange='hide_level(this);'>
                        <option value="S"<?php if ($createCharts == "S") {
                            echo " selected";
                        } ?>><?php echo $tradutor[$language]['sim']; ?></option>
                        <option value="N"<?php if ($createCharts == "N") {
                            echo " selected";
                        } ?>><?php echo $tradutor[$language]['nao']; ?></option>
                    </select>
                </td>
            </tr>
        ...
        {
        $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_resultado_financeiro']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_resultado_financeiro']['show_skip_charts_option'] ||
            $isMultiSeriesChart ||
            $isAnalitic ||
            ...
            <td class="scGridFieldOddFont">
                ...
                <div class="input-group input-group-vertical">
                    ...
                    foreach ($_SESSION['sc_session'][$script_case_init][$app_name]['Labels_GB'] as $ind => $gb) {
                        ...
                        ?>
                        <label><input type="radio" name="chart_level"
                                      value=<?php echo $ind . $selected ?>><?php echo $gb ?></label>
                        <?php
                    }
                    ?>
                </div>
...
<script language="javascript">
    ...
    function processa() {
        ...
        parent.nm_gp_move('<?php echo NM_encode_input($opc); ?>', '<?php echo NM_encode_input($target); ?>', cor, parms_pdf, grafico, create, '<?php echo NM_encode_input($export_ajax); ?>', chart_level, page_break, res_cons, use_pass, s_all_cab, s_all_label, s_label_group, s_pdf_zip);
        return false;
