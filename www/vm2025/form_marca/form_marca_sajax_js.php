...
?>
  ...
  // ---------- Validate marca
  function do_ajax_form_marca_validate_marca()
  {
    var nomeCampo_marca = "marca";
    var var_marca = scAjaxGetFieldText(nomeCampo_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_marca_validate_marca(var_marca, var_script_case_init, do_ajax_form_marca_validate_marca_cb);
  } // do_ajax_form_marca_validate_marca

  function do_ajax_form_marca_validate_marca_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_marca_validate_marca_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_marca_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_marca_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_marca_submit_form(var_marca, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_marca_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_marca_navigate_form, function() {});
    } else {
  ...
  function perform_ajax_form_marca_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_marca_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_marca_navigate_form_cb);
