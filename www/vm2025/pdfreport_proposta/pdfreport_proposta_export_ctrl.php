<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_proposta']['sc_process_barr'] = true;
require_once('../pdfreport_proposta/index.php');
unset($_SESSION['scriptcase']['pdfreport_proposta']['sc_process_barr']);
$ExportCtrl = new pdfreport_proposta_export_control;
$ExportCtrl->Export_barr();

class pdfreport_proposta_export_control
{
