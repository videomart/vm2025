  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_leads" == sTestField)
        {
...
?>
  ...
  // ---------- Validate empresa
  function do_ajax_form_leads_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_leads_validate_empresa_cb);
  } // do_ajax_form_leads_validate_empresa

  function do_ajax_form_leads_validate_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_empresa_cb

  // ---------- Validate contato
  function do_ajax_form_leads_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_contato(var_contato, var_script_case_init, do_ajax_form_leads_validate_contato_cb);
  } // do_ajax_form_leads_validate_contato

  function do_ajax_form_leads_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_contato_cb

  // ---------- Validate telefone
  function do_ajax_form_leads_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_leads_validate_telefone_cb);
  } // do_ajax_form_leads_validate_telefone

  function do_ajax_form_leads_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_leads_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_email(var_email, var_script_case_init, do_ajax_form_leads_validate_email_cb);
  } // do_ajax_form_leads_validate_email

  function do_ajax_form_leads_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_email_cb

  // ---------- Validate cidade
  function do_ajax_form_leads_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldSelect(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_leads_validate_cidade_cb);
  } // do_ajax_form_leads_validate_cidade

  function do_ajax_form_leads_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_cidade_cb

  // ---------- Validate uf
  function do_ajax_form_leads_validate_uf()
  {
  } // do_ajax_form_leads_validate_uf

  function do_ajax_form_leads_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_uf_cb

  // ---------- Validate assunto
  function do_ajax_form_leads_validate_assunto()
  {
    var nomeCampo_assunto = "assunto";
    var var_assunto = scAjaxGetFieldText(nomeCampo_assunto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_assunto(var_assunto, var_script_case_init, do_ajax_form_leads_validate_assunto_cb);
  } // do_ajax_form_leads_validate_assunto

  function do_ajax_form_leads_validate_assunto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_assunto_cb

  // ---------- Validate data
  function do_ajax_form_leads_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_data(var_data, var_script_case_init, do_ajax_form_leads_validate_data_cb);
  } // do_ajax_form_leads_validate_data

  function do_ajax_form_leads_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_data_cb

  // ---------- Validate cod_vend
  function do_ajax_form_leads_validate_cod_vend()
  {
    var nomeCampo_cod_vend = "cod_vend";
    var var_cod_vend = scAjaxGetFieldSelect(nomeCampo_cod_vend);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_cod_vend(var_cod_vend, var_script_case_init, do_ajax_form_leads_validate_cod_vend_cb);
  } // do_ajax_form_leads_validate_cod_vend

  function do_ajax_form_leads_validate_cod_vend_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_cod_vend_cb

  // ---------- Validate info
  function do_ajax_form_leads_validate_info()
  {
    var nomeCampo_info = "info";
    var var_info = scAjaxGetFieldEditorHtml(nomeCampo_info);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_leads_validate_info(var_info, var_script_case_init, do_ajax_form_leads_validate_info_cb);
  } // do_ajax_form_leads_validate_info

  function do_ajax_form_leads_validate_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_leads_validate_info_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_leads_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_leads_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_leads_submit_form(var_empresa, var_contato, var_telefone, var_email, var_cidade, var_uf, var_assunto, var_data, var_cod_vend, var_info, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_leads_submit_form_cb);
  } // do_ajax_form_leads_submit_form

  function do_ajax_form_leads_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_leads_submit_form_cb_after_alert);
  } // do_ajax_form_leads_submit_form_cb
  function do_ajax_form_leads_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_leads_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_leads_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_leads_navigate_form, function() {});
    } else {
      perform_ajax_form_leads_navigate_form();
    }
  }

  function perform_ajax_form_leads_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_leads_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_leads_navigate_form_cb);
  } // do_ajax_form_leads_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_leads']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_leads_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_leads_navigate_form_cb_after_alert);
  } // do_ajax_form_leads_navigate_form_cb
  function do_ajax_form_leads_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_leads_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_leads_navigate_form_cb_after_alert

  function sc_hide_form_leads_form()
  {
