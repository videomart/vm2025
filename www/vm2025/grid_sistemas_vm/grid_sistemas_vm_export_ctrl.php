<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sistemas_vm']['sc_process_barr'] = true;
require_once('../grid_sistemas_vm/index.php');
unset($_SESSION['scriptcase']['grid_sistemas_vm']['sc_process_barr']);
$ExportCtrl = new grid_sistemas_vm_export_control;
$ExportCtrl->Export_barr();

class grid_sistemas_vm_export_control
{
