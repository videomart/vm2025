<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_sistemas_vm']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_sistemas_vm_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sistemas_vm_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['empresas_empresa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresas_empresa'] = "empresas_empresa";
   }
   else
   {
       $tab_def_campos['empresas_empresa'] = "Empresas.EMPRESA";
   }
   $tab_labels["empresas_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["empresas_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["empresas_empresa"] : "EMPRESA";
   $tab_ger_campos['sistemasvm_contato'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sistemasvm_contato'] = "sistemasvm_contato";
   }
   else
   {
       $tab_def_campos['sistemasvm_contato'] = "SistemasVM.CONTATO";
   }
   $tab_labels["sistemasvm_contato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_contato"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_contato"] : "CONTATO";
   $tab_ger_campos['sistemasvm_telefone'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sistemasvm_telefone'] = "sistemasvm_telefone";
   }
   else
   {
       $tab_def_campos['sistemasvm_telefone'] = "SistemasVM.TELEFONE";
   }
   $tab_labels["sistemasvm_telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_telefone"] : "TELEFONE";
   $tab_ger_campos['sistemasvm_email'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sistemasvm_email'] = "sistemasvm_email";
   }
   else
   {
       $tab_def_campos['sistemasvm_email'] = "SistemasVM.EMAIL";
   }
   $tab_labels["sistemasvm_email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_email"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_email"] : "EMAIL";
   $tab_ger_campos['sistemasvm_cnpj'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sistemasvm_cnpj'] = "sistemasvm_cnpj";
   }
   else
   {
       $tab_def_campos['sistemasvm_cnpj'] = "SistemasVM.CNPJ";
   }
   $tab_labels["sistemasvm_cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_cnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_cnpj"] : "CNPJ";
   $tab_ger_campos['sistemasvm_data_venda'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sistemasvm_data_venda'] = "sistemasvm_data_venda";
   }
   else
   {
       $tab_def_campos['sistemasvm_data_venda'] = "SistemasVM.DATA_VENDA";
   }
   $tab_labels["sistemasvm_data_venda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_data_venda"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_data_venda"] : "DATA VENDA";
   $tab_ger_campos['sistemasvm_modelo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sistemasvm_modelo'] = "sistemasvm_modelo";
   }
   else
   {
       $tab_def_campos['sistemasvm_modelo'] = "SistemasVM.MODELO";
   }
   $tab_labels["sistemasvm_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['labels']["sistemasvm_modelo"] : "MODELO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sistemas_vm_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sistemas_vm']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
