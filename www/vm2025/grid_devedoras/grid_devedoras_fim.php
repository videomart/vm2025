...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_devedoras"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_devedoras"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devedoras']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_devedoras']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devedoras']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_devedoras']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_devedoras']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_devedoras']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_devedoras']['embutida_filho'] as $ind => $sc_init)
          {
