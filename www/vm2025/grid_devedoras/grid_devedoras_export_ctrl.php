<?php
@session_start() ;
$_SESSION['scriptcase']['grid_devedoras']['sc_process_barr'] = true;
require_once('../grid_devedoras/index.php');
unset($_SESSION['scriptcase']['grid_devedoras']['sc_process_barr']);
$ExportCtrl = new grid_devedoras_export_control;
$ExportCtrl->Export_barr();

class grid_devedoras_export_control
{
