...
class grid_termos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_termos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_termos_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_termos_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_termos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_termos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - termos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_termos/grid_termos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_termos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_termos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_termos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_termos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_termos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_entrega_cond#NMF#' + search_get_sel_txt('SC_entrega_cond') + '@NMF@';
  str_out += 'SC_entrega#NMF#' + search_get_text('SC_entrega') + '@NMF@';
  str_out += 'SC_garantia_cond#NMF#' + search_get_sel_txt('SC_garantia_cond') + '@NMF@';
  str_out += 'SC_garantia#NMF#' + search_get_text('SC_garantia') + '@NMF@';
  str_out += 'SC_condpag_cond#NMF#' + search_get_sel_txt('SC_condpag_cond') + '@NMF@';
  str_out += 'SC_condpag#NMF#' + search_get_text('SC_condpag') + '@NMF@';
  str_out += 'SC_formpag_cond#NMF#' + search_get_sel_txt('SC_formpag_cond') + '@NMF@';
  str_out += 'SC_formpag#NMF#' + search_get_text('SC_formpag') + '@NMF@';
  str_out += 'SC_instdep_cond#NMF#' + search_get_sel_txt('SC_instdep_cond') + '@NMF@';
  str_out += 'SC_instdep#NMF#' + search_get_text('SC_instdep') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $garantia_cond, $garantia,
             $condpag_cond, $condpag,
             $formpag_cond, $formpag,
             $instdep_cond, $instdep,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['codigo']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['codigo_cond']; 
          $moeda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['moeda']; 
          $moeda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['moeda_cond']; 
          $entrega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['entrega']; 
          $entrega_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['entrega_cond']; 
          $garantia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['garantia']; 
          $garantia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['garantia_cond']; 
          $condpag = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['condpag']; 
          $condpag_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['condpag_cond']; 
          $formpag = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['formpag']; 
          $formpag_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['formpag_cond']; 
          $instdep = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['instdep']; 
          $instdep_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['instdep_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['NM_operador']; 
      ...
      if (!isset($garantia_cond) || empty($garantia_cond))
      {
         $garantia_cond = "eq";
      }
      if (!isset($condpag_cond) || empty($condpag_cond))
      {
         $condpag_cond = "eq";
      }
      if (!isset($formpag_cond) || empty($formpag_cond))
      {
         $formpag_cond = "eq";
      }
      if (!isset($instdep_cond) || empty($instdep_cond))
      {
         $instdep_cond = "eq";
      }
      ...
      $str_hide_entrega = (in_array($entrega_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_garantia = (in_array($garantia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_condpag = (in_array($condpag_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_formpag = (in_array($formpag_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_instdep = (in_array($instdep_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = (is_string($entrega)) ? strpos($entrega, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      if (!isset($garantia) || $garantia == "")
      {
          $garantia = "";
      }
      if (isset($garantia) && !empty($garantia))
      {
         $tmp_pos = (is_string($garantia)) ? strpos($garantia, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $garantia = substr($garantia, 0, $tmp_pos);
         }
      }
      if (!isset($condpag) || $condpag == "")
      {
          $condpag = "";
      }
      if (isset($condpag) && !empty($condpag))
      {
         $tmp_pos = (is_string($condpag)) ? strpos($condpag, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $condpag = substr($condpag, 0, $tmp_pos);
         }
      }
      if (!isset($formpag) || $formpag == "")
      {
          $formpag = "";
      }
      if (isset($formpag) && !empty($formpag))
      {
         $tmp_pos = (is_string($formpag)) ? strpos($formpag, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $formpag = substr($formpag, 0, $tmp_pos);
         }
      }
      if (!isset($instdep) || $instdep == "")
      {
          $instdep = "";
      }
      if (isset($instdep) && !empty($instdep))
      {
         $tmp_pos = (is_string($instdep)) ? strpos($instdep, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $instdep = substr($instdep, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
   ...
   <tr valign="top">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigo_cond" name="codigo_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo'), this, 'codigo')">
       ...
       <OPTION value="df" <?php if ("df" == $codigo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_moeda_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['moeda'])) ? $this->New_label['moeda'] : "moeda"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_moeda_cond" name="moeda_cond" onChange="nm_campos_between(document.getElementById('id_vis_moeda'), this, 'moeda')">
...
?>
<INPUT  type="text" id="SC_moeda" name="moeda" value="<?php echo NM_encode_input($moeda) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_entrega_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['entrega'])) ? $this->New_label['entrega'] : "Entrega"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_entrega_cond" name="entrega_cond" onChange="nm_campos_between(document.getElementById('id_vis_entrega'), this, 'entrega')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_entrega" <?php echo $str_hide_entrega?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
?>
<INPUT  type="text" id="SC_entrega" name="entrega" value="<?php echo NM_encode_input($entrega) ?>"  size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_garantia_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['garantia'])) ? $this->New_label['garantia'] : "Garantia"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_garantia_cond" name="garantia_cond" onChange="nm_campos_between(document.getElementById('id_vis_garantia'), this, 'garantia')">
       <OPTION value="eq" <?php if ("eq" == $garantia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $garantia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $garantia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $garantia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_garantia" <?php echo $str_hide_garantia?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['garantia'])) ? $this->New_label['garantia'] : "Garantia";
 $nmgp_tab_label .= "garantia?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_garantia" name="garantia" value="<?php echo NM_encode_input($garantia) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_condpag_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['condpag'])) ? $this->New_label['condpag'] : "CondPag"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_condpag_cond" name="condpag_cond" onChange="nm_campos_between(document.getElementById('id_vis_condpag'), this, 'condpag')">
       <OPTION value="eq" <?php if ("eq" == $condpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $condpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $condpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $condpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_condpag" <?php echo $str_hide_condpag?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['condpag'])) ? $this->New_label['condpag'] : "CondPag";
 $nmgp_tab_label .= "condpag?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_condpag" name="condpag" value="<?php echo NM_encode_input($condpag) ?>"  size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_formpag_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['formpag'])) ? $this->New_label['formpag'] : "FormPag"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_formpag_cond" name="formpag_cond" onChange="nm_campos_between(document.getElementById('id_vis_formpag'), this, 'formpag')">
       <OPTION value="eq" <?php if ("eq" == $formpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $formpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $formpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $formpag_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_formpag" <?php echo $str_hide_formpag?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['formpag'])) ? $this->New_label['formpag'] : "FormPag";
 $nmgp_tab_label .= "formpag?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_formpag" name="formpag" value="<?php echo NM_encode_input($formpag) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_instdep_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['instdep'])) ? $this->New_label['instdep'] : "InstDep"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_instdep_cond" name="instdep_cond" onChange="nm_campos_between(document.getElementById('id_vis_instdep'), this, 'instdep')">
       <OPTION value="eq" <?php if ("eq" == $instdep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $instdep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $instdep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $instdep_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_instdep" <?php echo $str_hide_instdep?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['instdep'])) ? $this->New_label['instdep'] : "InstDep";
 $nmgp_tab_label .= "instdep?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_instdep" name="instdep" value="<?php echo NM_encode_input($instdep) ?>"  size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
<?php
   if (is_file("grid_termos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_termos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_termos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.entrega_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_entrega'), document.F1.entrega_cond, 'entrega');
   document.F1.entrega.value = "";
   document.F1.garantia_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_garantia'), document.F1.garantia_cond, 'garantia');
   document.F1.garantia.value = "";
   document.F1.condpag_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_condpag'), document.F1.condpag_cond, 'condpag');
   document.F1.condpag.value = "";
   document.F1.formpag_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_formpag'), document.F1.formpag_cond, 'formpag');
   document.F1.formpag.value = "";
   document.F1.instdep_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_instdep'), document.F1.instdep_cond, 'instdep');
   document.F1.instdep.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_entrega_cond'] = 'cond';
      $tp_fields['SC_entrega'] = 'text';
      $tp_fields['SC_garantia_cond'] = 'cond';
      $tp_fields['SC_garantia'] = 'text';
      $tp_fields['SC_condpag_cond'] = 'cond';
      $tp_fields['SC_condpag'] = 'text';
      $tp_fields['SC_formpag_cond'] = 'cond';
      $tp_fields['SC_formpag'] = 'text';
      $tp_fields['SC_instdep_cond'] = 'cond';
      $tp_fields['SC_instdep'] = 'text';
   ...
   function trata_campos()
   {
      global $codigo_cond, $codigo,
             ...
             $condpag_cond, $condpag,
             $formpag_cond, $formpag,
             $instdep_cond, $instdep, $nmgp_tab_label;
      ...
      $garantia_cond_salva = $garantia_cond; 
      if (!isset($garantia_input_2) || $garantia_input_2 == "")
      {
          $garantia_input_2 = $garantia;
      }
      $condpag_cond_salva = $condpag_cond; 
      if (!isset($condpag_input_2) || $condpag_input_2 == "")
      {
          $condpag_input_2 = $condpag;
      }
      $formpag_cond_salva = $formpag_cond; 
      if (!isset($formpag_input_2) || $formpag_input_2 == "")
      {
          $formpag_input_2 = $formpag;
      }
      $instdep_cond_salva = $instdep_cond; 
      if (!isset($instdep_input_2) || $instdep_input_2 == "")
      {
          $instdep_input_2 = $instdep;
      }
      if ($codigo_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['moeda'] = $moeda; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['moeda_cond'] = $moeda_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['entrega'] = $entrega; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['entrega_cond'] = $entrega_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['garantia'] = $garantia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['garantia_cond'] = $garantia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['condpag'] = $condpag; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['condpag_cond'] = $condpag_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['formpag'] = $formpag; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['formpag_cond'] = $formpag_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['instdep'] = $instdep; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['instdep_cond'] = $instdep_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['codigo'] = "'" . $this->cmp_formatado['codigo'] . "'";
      if (isset($this->cmp_formatado['codigo_input_2'])  && !empty($this->cmp_formatado['codigo_input_2'])) {
          $this->cmp_formatado['codigo_input_2'] = "'" . $this->cmp_formatado['codigo_input_2'] . "'";
      }
      $Conteudo = $moeda;
      ...
      $this->cmp_formatado['entrega'] = "'" . $this->cmp_formatado['entrega'] . "'";
      if (isset($this->cmp_formatado['entrega_input_2'])  && !empty($this->cmp_formatado['entrega_input_2'])) {
          $this->cmp_formatado['entrega_input_2'] = "'" . $this->cmp_formatado['entrega_input_2'] . "'";
      }
      $Conteudo = $garantia;
      $this->cmp_formatado['garantia'] = $Conteudo;
      $this->cmp_formatado['garantia'] = "'" . $this->cmp_formatado['garantia'] . "'";
      if (isset($this->cmp_formatado['garantia_input_2'])  && !empty($this->cmp_formatado['garantia_input_2'])) {
          $this->cmp_formatado['garantia_input_2'] = "'" . $this->cmp_formatado['garantia_input_2'] . "'";
      }
      $Conteudo = $condpag;
      $this->cmp_formatado['condpag'] = $Conteudo;
      $this->cmp_formatado['condpag'] = "'" . $this->cmp_formatado['condpag'] . "'";
      if (isset($this->cmp_formatado['condpag_input_2'])  && !empty($this->cmp_formatado['condpag_input_2'])) {
          $this->cmp_formatado['condpag_input_2'] = "'" . $this->cmp_formatado['condpag_input_2'] . "'";
      }
      $Conteudo = $formpag;
      $this->cmp_formatado['formpag'] = $Conteudo;
      $this->cmp_formatado['formpag'] = "'" . $this->cmp_formatado['formpag'] . "'";
      if (isset($this->cmp_formatado['formpag_input_2'])  && !empty($this->cmp_formatado['formpag_input_2'])) {
          $this->cmp_formatado['formpag_input_2'] = "'" . $this->cmp_formatado['formpag_input_2'] . "'";
      }
      $Conteudo = $instdep;
      $this->cmp_formatado['instdep'] = $Conteudo;
      $this->cmp_formatado['instdep'] = "'" . $this->cmp_formatado['instdep'] . "'";
      if (isset($this->cmp_formatado['instdep_input_2'])  && !empty($this->cmp_formatado['instdep_input_2'])) {
          $this->cmp_formatado['instdep_input_2'] = "'" . $this->cmp_formatado['instdep_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      {
         $this->monta_condicao("codigo", $codigo_cond, $codigo, "", "codigo", "SMALLINT", false);
      }
      ...
      //----- $entrega
      $this->Date_part = false;
      if (isset($entrega) || $entrega_cond == "nu" || $entrega_cond == "nn" || $entrega_cond == "ep" || $entrega_cond == "ne")
      {
         $this->monta_condicao("Entrega", $entrega_cond, $entrega, "", "entrega", "VARCHAR", false);
      }

      //----- $garantia
      $this->Date_part = false;
      if (isset($garantia) || $garantia_cond == "nu" || $garantia_cond == "nn" || $garantia_cond == "ep" || $garantia_cond == "ne")
      {
         $this->monta_condicao("Garantia", $garantia_cond, $garantia, "", "garantia", "VARCHAR", false);
      }

      //----- $condpag
      $this->Date_part = false;
      if (isset($condpag) || $condpag_cond == "nu" || $condpag_cond == "nn" || $condpag_cond == "ep" || $condpag_cond == "ne")
      {
         $this->monta_condicao("CondPag", $condpag_cond, $condpag, "", "condpag", "VARCHAR", false);
      }

      //----- $formpag
      $this->Date_part = false;
      if (isset($formpag) || $formpag_cond == "nu" || $formpag_cond == "nn" || $formpag_cond == "ep" || $formpag_cond == "ne")
      {
         $this->monta_condicao("FormPag", $formpag_cond, $formpag, "", "formpag", "VARCHAR", false);
      }

      //----- $instdep
      $this->Date_part = false;
      if (isset($instdep) || $instdep_cond == "nu" || $instdep_cond == "nn" || $instdep_cond == "ep" || $instdep_cond == "ne")
      {
         $this->monta_condicao("InstDep", $instdep_cond, $instdep, "", "instdep", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_termos']['cond_pesq'] .= $this->NM_operador;
