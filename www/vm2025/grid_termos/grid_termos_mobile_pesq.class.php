...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "codigo";$Nm_numeric[] = "validade";$Nm_numeric[] = "desconto";$Nm_numeric[] = "codigo";$Nm_numeric[] = "validade";$Nm_numeric[] = "desconto";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_codigo"  <?php echo $str_hide_codigo?>><INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_moeda_cond" name="moeda_cond" onChange="nm_campos_between(document.getElementById('id_vis_moeda'), this, 'moeda')">
      ...
      <br><span id="id_hide_moeda"  <?php echo $str_hide_moeda?>><INPUT  type="text" id="SC_moeda" name="moeda" value="<?php echo NM_encode_input($moeda) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_entrega_cond" name="entrega_cond" onChange="nm_campos_between(document.getElementById('id_vis_entrega'), this, 'entrega')">
      ...
      <br><span id="id_hide_entrega"  <?php echo $str_hide_entrega?>><INPUT  type="text" id="SC_entrega" name="entrega" value="<?php echo NM_encode_input($entrega) ?>"  size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_garantia_cond" name="garantia_cond" onChange="nm_campos_between(document.getElementById('id_vis_garantia'), this, 'garantia')">
      ...
      <br><span id="id_hide_garantia"  <?php echo $str_hide_garantia?>><INPUT  type="text" id="SC_garantia" name="garantia" value="<?php echo NM_encode_input($garantia) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_condpag_cond" name="condpag_cond" onChange="nm_campos_between(document.getElementById('id_vis_condpag'), this, 'condpag')">
      ...
      <br><span id="id_hide_condpag"  <?php echo $str_hide_condpag?>><INPUT  type="text" id="SC_condpag" name="condpag" value="<?php echo NM_encode_input($condpag) ?>"  size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_formpag_cond" name="formpag_cond" onChange="nm_campos_between(document.getElementById('id_vis_formpag'), this, 'formpag')">
      ...
      <br><span id="id_hide_formpag"  <?php echo $str_hide_formpag?>><INPUT  type="text" id="SC_formpag" name="formpag" value="<?php echo NM_encode_input($formpag) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_instdep_cond" name="instdep_cond" onChange="nm_campos_between(document.getElementById('id_vis_instdep'), this, 'instdep')">
      ...
      <br><span id="id_hide_instdep"  <?php echo $str_hide_instdep?>><INPUT  type="text" id="SC_instdep" name="instdep" value="<?php echo NM_encode_input($instdep) ?>"  size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
