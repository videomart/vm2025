<?php
@session_start() ;
$_SESSION['scriptcase']['grid_termos']['sc_process_barr'] = true;
require_once('../grid_termos/index.php');
unset($_SESSION['scriptcase']['grid_termos']['sc_process_barr']);
$ExportCtrl = new grid_termos_export_control;
$ExportCtrl->Export_barr();

class grid_termos_export_control
{
