...
<?php
   ...
   $Ord_Cmp = new grid_termos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_termos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["codigo"] : "Código";
   $tab_ger_campos['moeda'] = "on";
   $tab_def_campos['moeda'] = "moeda";
   $tab_labels["moeda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["moeda"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["moeda"] : "moeda";
   $tab_ger_campos['entrega'] = "on";
   $tab_def_campos['entrega'] = "Entrega";
   $tab_labels["entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["entrega"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["entrega"] : "Entrega";
   $tab_ger_campos['garantia'] = "on";
   $tab_def_campos['garantia'] = "Garantia";
   $tab_labels["garantia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["garantia"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["garantia"] : "Garantia";
   $tab_ger_campos['condpag'] = "on";
   $tab_def_campos['condpag'] = "CondPag";
   $tab_labels["condpag"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["condpag"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["condpag"] : "CondPag";
   $tab_ger_campos['formpag'] = "on";
   $tab_def_campos['formpag'] = "FormPag";
   $tab_labels["formpag"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["formpag"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["formpag"] : "FormPag";
   $tab_ger_campos['instdep'] = "on";
   $tab_def_campos['instdep'] = "InstDep";
   $tab_labels["instdep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["instdep"])) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['labels']["instdep"] : "InstDep";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_termos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_termos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_termos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_termos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
