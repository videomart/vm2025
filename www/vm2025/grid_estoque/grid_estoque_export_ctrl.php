<?php
@session_start() ;
$_SESSION['scriptcase']['grid_estoque']['sc_process_barr'] = true;
require_once('../grid_estoque/index.php');
unset($_SESSION['scriptcase']['grid_estoque']['sc_process_barr']);
$ExportCtrl = new grid_estoque_export_control;
$ExportCtrl->Export_barr();

class grid_estoque_export_control
{
