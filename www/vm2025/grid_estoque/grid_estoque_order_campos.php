...
<?php
   ...
   $Ord_Cmp = new grid_estoque_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_estoque_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_produto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["id_produto"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["id_produto"] : "Modelo";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "DATA";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["data"] : "DATA";
   $tab_ger_campos['id_empresa'] = "on";
   $tab_def_campos['id_empresa'] = "ID_EMPRESA";
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["id_empresa"] : "Cliente / Fornecedor";
   $tab_ger_campos['entrada'] = "on";
   $tab_def_campos['entrada'] = "ENTRADA";
   $tab_labels["entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["entrada"] : "ENTRADA";
   $tab_ger_campos['saida'] = "on";
   $tab_def_campos['saida'] = "SAIDA";
   $tab_labels["saida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["saida"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["saida"] : "SAIDA";
   $tab_ger_campos['unit_estoq'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['unit_estoq'] = "unit_estoq";
   }
   else
   {
       $tab_def_campos['unit_estoq'] = "(ENTRADA-SAIDA)";
   }
   $tab_labels["unit_estoq"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["unit_estoq"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['labels']["unit_estoq"] : "QTD. ESTOQUE";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estoque']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estoque']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_estoque_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_estoque']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
