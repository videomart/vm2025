...
<?php
   ...
   $Ord_Cmp = new grid_transportadoras_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_transportadoras_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["id"] : "ID";
   $tab_ger_campos['transportadora'] = "on";
   $tab_def_campos['transportadora'] = "TRANSPORTADORA";
   $tab_labels["transportadora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["transportadora"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["transportadora"] : "TRANSPORTADORA";
   $tab_ger_campos['endereco'] = "on";
   $tab_def_campos['endereco'] = "ENDERECO";
   $tab_labels["endereco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["endereco"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["endereco"] : "ENDERECO";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "TELEFONE";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["telefone"] : "TELEFONE";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "EMAIL";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["email"] : "EMAIL";
   $tab_ger_campos['contato'] = "on";
   $tab_def_campos['contato'] = "CONTATO";
   $tab_labels["contato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["contato"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['labels']["contato"] : "CONTATO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_transportadoras_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_transportadoras']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
