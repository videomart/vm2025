...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_telefone_cond" name="telefone_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefone'), this, 'telefone')">
...
<input class="sc-js-input scFilterObjectEven " type="text" id="id_ac_id" name="id_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        ...
        <SPAN id="id_vis_id"  <?php echo $str_display_id; ?> class="scFilterFieldFontEven">
         ...
         <BR>
         <INPUT type="text" id="SC_id_input_2" name="id_input_2" value="<?php echo NM_encode_input($id_input_2) ?>"  size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven ">         </SPAN>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_transportadora_cond" name="transportadora_cond" onChange="nm_campos_between(document.getElementById('id_vis_transportadora'), this, 'transportadora')">
      ...
      <br><span id="id_hide_transportadora"  <?php echo $str_hide_transportadora?>><?php
      if ($transportadora != "")
      {
      $transportadora_look = (is_string($transportadora) ? substr($this->Db->qstr($transportadora), 1, -1) : $transportadora); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_endereco_cond" name="endereco_cond" onChange="nm_campos_between(document.getElementById('id_vis_endereco'), this, 'endereco')">
      ...
      <br><span id="id_hide_endereco"  <?php echo $str_hide_endereco?>><INPUT  type="text" id="SC_endereco" name="endereco" value="<?php echo NM_encode_input($endereco) ?>" size="50" maxlength="32767" class="scFilterObjectEven ">
 </TD>
