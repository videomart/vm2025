...
class grid_transportadoras_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_transportadoras_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_transportadoras_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_transportadoras_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_transportadoras_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_transportadoras_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_transportadora')
      {
          $transportadora = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_transportadora($transportadora);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_telefone($telefone)
   {
      ...
      $nm_comando = "select distinct TELEFONE from " . $this->Ini->nm_tabela . " where  #lowerI#TELEFONE#lowerF# like #lowerI#'%" . $telefone . "%'#lowerF# order by TELEFONE"; 
   ...
   function lookup_ajax_transportadora($transportadora)
   {
      $transportadora = substr($this->Db->qstr($transportadora), 1, -1);
            $transportadora_look = (is_string($transportadora) ? substr($this->Db->qstr($transportadora), 1, -1) : $transportadora); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TRANSPORTADORA from " . $this->Ini->nm_tabela . " where  #lowerI#TRANSPORTADORA#lowerF# like #lowerI#'%" . $transportadora . "%'#lowerF# order by TRANSPORTADORA"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - transportadoras</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_transportadoras/grid_transportadoras_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_transportadoras_ajax_search.js"></script>
 <script type="text/javascript" src="grid_transportadoras_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_transportadoras_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_transportadoras']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_transportadoras']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_transportadora_cond#NMF#' + search_get_sel_txt('SC_transportadora_cond') + '@NMF@';
  str_out += 'SC_transportadora#NMF#' + search_get_text('SC_transportadora') + '@NMF@';
  str_out += 'id_ac_transportadora#NMF#' + search_get_text('id_ac_transportadora') + '@NMF@';
  str_out += 'SC_endereco_cond#NMF#' + search_get_sel_txt('SC_endereco_cond') + '@NMF@';
  str_out += 'SC_endereco#NMF#' + search_get_text('SC_endereco') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   scClass = $("#id_ac_transportadora").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_transportadora").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_transportadora",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_transportadora").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_transportadora").val( $(this).val() );
       }
     }
   });
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $transportadora_cond, $transportadora, $transportadora_autocomp,
             $endereco_cond, $endereco,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $telefone = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['telefone']; 
          $telefone_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['telefone_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['id_cond']; 
          $transportadora = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['transportadora']; 
          $transportadora_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['transportadora_cond']; 
          $endereco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['endereco']; 
          $endereco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['endereco_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($transportadora_cond) || empty($transportadora_cond))
      {
         $transportadora_cond = "qp";
      }
      if (!isset($endereco_cond) || empty($endereco_cond))
      {
         $endereco_cond = "qp";
      }
      ...
      $str_hide_transportadora = (in_array($transportadora_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_endereco = (in_array($endereco_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_telefone = ('bw' == $telefone_cond) ? $display_aberto : $display_fechado;
      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_transportadora = ('bw' == $transportadora_cond) ? $display_aberto : $display_fechado;
      $str_display_endereco = ('bw' == $endereco_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($transportadora) || $transportadora == "")
      {
          $transportadora = "";
      }
      if (isset($transportadora) && !empty($transportadora))
      {
         $tmp_pos = (is_string($transportadora)) ? strpos($transportadora, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $transportadora = substr($transportadora, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($endereco)) ? strpos($endereco, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $endereco = substr($endereco, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_telefone_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['telefone'])) ? $this->New_label['telefone'] : "TELEFONE"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_telefone_cond" name="telefone_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefone'), this, 'telefone')">
...
<?php
      ...
      $telefone_look = (is_string($telefone) ? substr($this->Db->qstr($telefone), 1, -1) : $telefone); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TELEFONE from " . $this->Ini->nm_tabela . " where #lowerI#TELEFONE#lowerF# = #lowerI#'$telefone_look'#lowerF# order by TELEFONE"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
?>
<INPUT  type="text" id="SC_telefone" name="telefone" value="<?php echo NM_encode_input($telefone) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_telefone" name="telefone_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven " type="text" id="id_ac_id" name="id_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id"  <?php echo $str_display_id; ?> class="scFilterFieldFontEven">
         ...
         <BR>
         <INPUT type="text" id="SC_id_input_2" name="id_input_2" value="<?php echo NM_encode_input($id_input_2) ?>"  size=4 alt="{datatype: 'integer', maxLength: 4, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_transportadora_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['transportadora'])) ? $this->New_label['transportadora'] : "TRANSPORTADORA"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_transportadora_cond" name="transportadora_cond" onChange="nm_campos_between(document.getElementById('id_vis_transportadora'), this, 'transportadora')">
       <OPTION value="qp" <?php if ("qp" == $transportadora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $transportadora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $transportadora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $transportadora_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_transportadora" <?php echo $str_hide_transportadora?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['transportadora'])) ? $this->New_label['transportadora'] : "TRANSPORTADORA";
 $nmgp_tab_label .= "transportadora?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $transportadora_look = (is_string($transportadora) ? substr($this->Db->qstr($transportadora), 1, -1) : $transportadora); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct TRANSPORTADORA from " . $this->Ini->nm_tabela . " where #lowerI#TRANSPORTADORA#lowerF# = #lowerI#'$transportadora_look'#lowerF# order by TRANSPORTADORA"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if (isset($nmgp_def_dados[0][$transportadora]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$transportadora];
      }
      else
      {
          $sAutocompValue = $transportadora;
      }
?>
<INPUT  type="text" id="SC_transportadora" name="transportadora" value="<?php echo NM_encode_input($transportadora) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd " type="text" id="id_ac_transportadora" name="transportadora_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_endereco_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['endereco'])) ? $this->New_label['endereco'] : "ENDERECO"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_endereco_cond" name="endereco_cond" onChange="nm_campos_between(document.getElementById('id_vis_endereco'), this, 'endereco')">
       <OPTION value="qp" <?php if ("qp" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $endereco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_endereco" <?php echo $str_hide_endereco?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['endereco'])) ? $this->New_label['endereco'] : "ENDERECO";
 $nmgp_tab_label .= "endereco?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_endereco" name="endereco" value="<?php echo NM_encode_input($endereco) ?>" size="50" maxlength="32767" class="scFilterObjectEven ">
...
?>
<?php
   if (is_file("grid_transportadoras_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_transportadoras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_transportadoras']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.transportadora_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_transportadora'), document.F1.transportadora_cond, 'transportadora');
   document.F1.transportadora.value = "";
   document.F1.transportadora_autocomp.value = "";
   document.F1.endereco_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_endereco'), document.F1.endereco_cond, 'endereco');
   document.F1.endereco.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/grid_transportadoras";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_transportadora_cond'] = 'cond';
      $tp_fields['SC_transportadora'] = 'text_aut';
      $tp_fields['id_ac_transportadora'] = 'text_aut';
      $tp_fields['SC_endereco_cond'] = 'cond';
      $tp_fields['SC_endereco'] = 'text';
   ...
   {
      global $telefone_cond, $telefone, $telefone_autocomp,
             $id_cond, $id, $id_input_2, $id_autocomp,
             $transportadora_cond, $transportadora, $transportadora_autocomp,
             $endereco_cond, $endereco, $nmgp_tab_label;
      ...
      if (!empty($transportadora_autocomp) && empty($transportadora))
      {
          $transportadora = $transportadora_autocomp;
      }
      ...
      $transportadora_cond_salva = $transportadora_cond; 
      if (!isset($transportadora_input_2) || $transportadora_input_2 == "")
      {
          $transportadora_input_2 = $transportadora;
      }
      $endereco_cond_salva = $endereco_cond; 
      if (!isset($endereco_input_2) || $endereco_input_2 == "")
      {
          $endereco_input_2 = $endereco;
      }
      if ($id_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['telefone'] = $telefone; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['telefone_cond'] = $telefone_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['transportadora'] = $transportadora; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['transportadora_cond'] = $transportadora_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['endereco'] = $endereco; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['endereco_cond'] = $endereco_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
    ...
    if ($transportadora != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['transportadora'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['transportadora'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['transportadora'] = $transportadora;
      }
      $this->cmp_formatado['transportadora'] = "'" . $this->cmp_formatado['transportadora'] . "'";
      if (isset($this->cmp_formatado['transportadora_input_2'])  && !empty($this->cmp_formatado['transportadora_input_2'])) {
          $this->cmp_formatado['transportadora_input_2'] = "'" . $this->cmp_formatado['transportadora_input_2'] . "'";
      }
      $Conteudo = $endereco;
      $this->cmp_formatado['endereco'] = $Conteudo;
      $this->cmp_formatado['endereco'] = "'" . $this->cmp_formatado['endereco'] . "'";
      if (isset($this->cmp_formatado['endereco_input_2'])  && !empty($this->cmp_formatado['endereco_input_2'])) {
          $this->cmp_formatado['endereco_input_2'] = "'" . $this->cmp_formatado['endereco_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      {
         $this->monta_condicao("ID", $id_cond, $id, $id_input_2, "id", "SMALLINT", false);
      }

      //----- $transportadora
      $this->Date_part = false;
      if (isset($transportadora) || $transportadora_cond == "nu" || $transportadora_cond == "nn" || $transportadora_cond == "ep" || $transportadora_cond == "ne")
      {
         $this->monta_condicao("TRANSPORTADORA", $transportadora_cond, $transportadora, "", "transportadora", "VARCHAR", false);
      }

      //----- $endereco
      $this->Date_part = false;
      if (isset($endereco) || $endereco_cond == "nu" || $endereco_cond == "nn" || $endereco_cond == "ep" || $endereco_cond == "ne")
      {
         $this->monta_condicao("ENDERECO", $endereco_cond, $endereco, "", "endereco", "TEXT", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadoras']['cond_pesq'] .= $this->NM_operador;
