<?php
@session_start() ;
$_SESSION['scriptcase']['grid_transportadoras']['sc_process_barr'] = true;
require_once('../grid_transportadoras/index.php');
unset($_SESSION['scriptcase']['grid_transportadoras']['sc_process_barr']);
$ExportCtrl = new grid_transportadoras_export_control;
$ExportCtrl->Export_barr();

class grid_transportadoras_export_control
{
