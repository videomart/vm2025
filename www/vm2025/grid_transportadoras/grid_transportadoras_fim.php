...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_transportadoras"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_transportadoras"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_transportadoras'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_transportadoras</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_transportadoras']['embutida_filho'] as $ind => $sc_init)
          {
