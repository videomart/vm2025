  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_operacoes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_operacoes_mob_form();
        }
...
?>
  ...
  // ---------- Validate cfop
  function do_ajax_form_operacoes_mob_validate_cfop()
  {
    var nomeCampo_cfop = "cfop";
    var var_cfop = scAjaxGetFieldText(nomeCampo_cfop);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operacoes_mob_validate_cfop(var_cfop, var_script_case_init, do_ajax_form_operacoes_mob_validate_cfop_cb);
  } // do_ajax_form_operacoes_mob_validate_cfop

  function do_ajax_form_operacoes_mob_validate_cfop_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operacoes_mob_validate_cfop_cb

  // ---------- Validate operacao
  function do_ajax_form_operacoes_mob_validate_operacao()
  {
    var nomeCampo_operacao = "operacao";
    var var_operacao = scAjaxGetFieldText(nomeCampo_operacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_operacoes_mob_validate_operacao(var_operacao, var_script_case_init, do_ajax_form_operacoes_mob_validate_operacao_cb);
  } // do_ajax_form_operacoes_mob_validate_operacao

  function do_ajax_form_operacoes_mob_validate_operacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_operacoes_mob_validate_operacao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_operacoes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_operacoes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cfop = scAjaxGetFieldText("cfop");
    var var_operacao = scAjaxGetFieldText("operacao");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_operacoes_mob_submit_form(var_cfop, var_operacao, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_operacoes_mob_submit_form_cb);
  } // do_ajax_form_operacoes_mob_submit_form

  function do_ajax_form_operacoes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_operacoes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_operacoes_mob_submit_form_cb
  function do_ajax_form_operacoes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_operacoes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_operacoes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_operacoes_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_operacoes_mob_navigate_form();
    }
  }

  function perform_ajax_form_operacoes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_operacoes_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_operacoes_mob_navigate_form_cb);
  } // do_ajax_form_operacoes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_operacoes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_operacoes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_operacoes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_operacoes_mob_navigate_form_cb
  function do_ajax_form_operacoes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_operacoes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_operacoes_mob_navigate_form_cb_after_alert

  function sc_hide_form_operacoes_mob_form()
  {
  ...
  ajax_field_list[0] = "cfop";
  ajax_field_list[1] = "operacao";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cfop": {"label": "Cfop", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["cfop"][1] = "cfop";
  ajax_field_mult["operacao"][1] = "operacao";

  var ajax_field_id = {
    "cfop": new Array("hidden_field_label_cfop", "hidden_field_data_cfop"),
