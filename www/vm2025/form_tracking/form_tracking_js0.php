<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="job" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['job']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tracking']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_tracking']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tracking"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tracking']['where_detal']))
  {
?>  
...
function lookup_ordem(campo)
{
   dados  = document.F1.ordem.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_tracking')?>/form_tracking.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_ordem, "ordem", dados, false);
}
function recebe_ordem(string)
{
   document.getElementById('id_lookup_ordem').innerHTML = string;
}
<?php 
