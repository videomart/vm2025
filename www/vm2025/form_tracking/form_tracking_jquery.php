...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_job' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_tracking_job_onblur('#id_sc_field_job' + iSeqRow, iSeqRow, event);}, 300) })
                                 .bind('change', function() { sc_form_tracking_job_onchange(this, iSeqRow, event) })
                                 .bind('focus', function() { sc_form_tracking_job_onfocus(this, iSeqRow, event) });
  $('#id_sc_field_id_itemproposta' + iSeqRow).bind('change', function() { sc_form_tracking_id_itemproposta_onchange(this, iSeqRow, event) });
  ...
  $('#id_sc_field_modelo' + iSeqRow).bind('blur', function() { sc_form_tracking_modelo_onblur('#id_sc_field_modelo' + iSeqRow, iSeqRow, event) })
                                    .bind('change', function() { sc_form_tracking_modelo_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_fob' + iSeqRow).bind('blur', function() { sc_form_tracking_fob_onblur('#id_sc_field_fob' + iSeqRow, iSeqRow, event) })
                                 .bind('change', function() { sc_form_tracking_fob_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_descricao' + iSeqRow).bind('blur', function() { sc_form_tracking_descricao_onblur('#id_sc_field_descricao' + iSeqRow, iSeqRow, event) })
                                       .bind('change', function() { sc_form_tracking_descricao_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_qtd' + iSeqRow).bind('blur', function() { sc_form_tracking_qtd_onblur('#id_sc_field_qtd' + iSeqRow, iSeqRow, event) })
                                 .bind('change', function() { sc_form_tracking_qtd_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_vendedor' + iSeqRow).bind('blur', function() { sc_form_tracking_vendedor_onblur('#id_sc_field_vendedor' + iSeqRow, iSeqRow, event) })
                                      .bind('change', function() { sc_form_tracking_vendedor_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data_venda' + iSeqRow).bind('blur', function() { sc_form_tracking_data_venda_onblur('#id_sc_field_data_venda' + iSeqRow, iSeqRow, event) })
                                        .bind('change', function() { sc_form_tracking_data_venda_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data_entrega' + iSeqRow).bind('blur', function() { sc_form_tracking_data_entrega_onblur('#id_sc_field_data_entrega' + iSeqRow, iSeqRow, event) })
                                          .bind('change', function() { sc_form_tracking_data_entrega_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data_compra' + iSeqRow).bind('blur', function() { sc_form_tracking_data_compra_onblur('#id_sc_field_data_compra' + iSeqRow, iSeqRow, event) })
                                         .bind('change', function() { sc_form_tracking_data_compra_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_comprador' + iSeqRow).bind('blur', function() { sc_form_tracking_comprador_onblur('#id_sc_field_comprador' + iSeqRow, iSeqRow, event) })
                                       .bind('change', function() { sc_form_tracking_comprador_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_id_dealer' + iSeqRow).bind('blur', function() { sc_form_tracking_id_dealer_onblur('#id_sc_field_id_dealer' + iSeqRow, iSeqRow, event) })
                                       .bind('change', function() { sc_form_tracking_id_dealer_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_dealer' + iSeqRow).bind('blur', function() { sc_form_tracking_dealer_onblur('#id_sc_field_dealer' + iSeqRow, iSeqRow, event) })
                                    .bind('change', function() { sc_form_tracking_dealer_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_purch_order' + iSeqRow).bind('blur', function() { sc_form_tracking_purch_order_onblur('#id_sc_field_purch_order' + iSeqRow, iSeqRow, event) })
                                         .bind('change', function() { sc_form_tracking_purch_order_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data_prevista' + iSeqRow).bind('blur', function() { sc_form_tracking_data_prevista_onblur('#id_sc_field_data_prevista' + iSeqRow, iSeqRow, event) })
                                           .bind('change', function() { sc_form_tracking_data_prevista_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data_recebimento' + iSeqRow).bind('blur', function() { sc_form_tracking_data_recebimento_onblur('#id_sc_field_data_recebimento' + iSeqRow, iSeqRow, event) })
                                              .bind('change', function() { sc_form_tracking_data_recebimento_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_via' + iSeqRow).bind('blur', function() { sc_form_tracking_via_onblur('#id_sc_field_via' + iSeqRow, iSeqRow, event) })
                                 .bind('change', function() { sc_form_tracking_via_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_status' + iSeqRow).bind('blur', function() { sc_form_tracking_status_onblur('#id_sc_field_status' + iSeqRow, iSeqRow, event) })
                                    .bind('change', function() { sc_form_tracking_status_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_obs' + iSeqRow).bind('blur', function() { sc_form_tracking_obs_onblur('#id_sc_field_obs' + iSeqRow, iSeqRow, event) })
                                 .bind('change', function() { sc_form_tracking_obs_onchange(this, iSeqRow, event) })
...
function sc_form_tracking_job_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_id_itemproposta_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_modelo_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_fob_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_descricao_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_qtd_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_vendedor_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_data_venda_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_data_entrega_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_data_compra_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_comprador_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_id_dealer_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_dealer_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_purch_order_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_data_prevista_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_data_recebimento_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_via_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_status_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_tracking_obs_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_tracking_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_data_prevista" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tracking_validate_data_prevista(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_recebimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tracking_validate_data_recebimento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tracking')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
