  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tracking_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_tracking_mob_form();
        }
...
?>
  ...
  // ---------- Validate ordem
  function do_ajax_form_tracking_mob_validate_ordem()
  {
    var nomeCampo_ordem = "ordem";
    var var_ordem = scAjaxGetFieldHidden(nomeCampo_ordem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_ordem(var_ordem, var_script_case_init, do_ajax_form_tracking_mob_validate_ordem_cb);
  } // do_ajax_form_tracking_mob_validate_ordem

  function do_ajax_form_tracking_mob_validate_ordem_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_ordem_cb

  // ---------- Validate job
  function do_ajax_form_tracking_mob_validate_job()
  {
    var nomeCampo_job = "job";
    var var_job = scAjaxGetFieldText(nomeCampo_job);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_job(var_job, var_script_case_init, do_ajax_form_tracking_mob_validate_job_cb);
  } // do_ajax_form_tracking_mob_validate_job

  function do_ajax_form_tracking_mob_validate_job_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_job_cb

  // ---------- Validate modelo
  function do_ajax_form_tracking_mob_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldHidden(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_tracking_mob_validate_modelo_cb);
  } // do_ajax_form_tracking_mob_validate_modelo

  function do_ajax_form_tracking_mob_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_modelo_cb

  // ---------- Validate fob
  function do_ajax_form_tracking_mob_validate_fob()
  {
    var nomeCampo_fob = "fob";
    var var_fob = scAjaxGetFieldHidden(nomeCampo_fob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_fob(var_fob, var_script_case_init, do_ajax_form_tracking_mob_validate_fob_cb);
  } // do_ajax_form_tracking_mob_validate_fob

  function do_ajax_form_tracking_mob_validate_fob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_fob_cb

  // ---------- Validate descricao
  function do_ajax_form_tracking_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_tracking_mob_validate_descricao_cb);
  } // do_ajax_form_tracking_mob_validate_descricao

  function do_ajax_form_tracking_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_descricao_cb

  // ---------- Validate qtd
  function do_ajax_form_tracking_mob_validate_qtd()
  {
    var nomeCampo_qtd = "qtd";
    var var_qtd = scAjaxGetFieldHidden(nomeCampo_qtd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_qtd(var_qtd, var_script_case_init, do_ajax_form_tracking_mob_validate_qtd_cb);
  } // do_ajax_form_tracking_mob_validate_qtd

  function do_ajax_form_tracking_mob_validate_qtd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_qtd_cb

  // ---------- Validate vendedor
  function do_ajax_form_tracking_mob_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldHidden(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_form_tracking_mob_validate_vendedor_cb);
  } // do_ajax_form_tracking_mob_validate_vendedor

  function do_ajax_form_tracking_mob_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_vendedor_cb

  // ---------- Validate data_venda
  function do_ajax_form_tracking_mob_validate_data_venda()
  {
    var nomeCampo_data_venda = "data_venda";
    var var_data_venda = scAjaxGetFieldHidden(nomeCampo_data_venda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_data_venda(var_data_venda, var_script_case_init, do_ajax_form_tracking_mob_validate_data_venda_cb);
  } // do_ajax_form_tracking_mob_validate_data_venda

  function do_ajax_form_tracking_mob_validate_data_venda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "data_venda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_data_venda_cb

  // ---------- Validate data_entrega
  function do_ajax_form_tracking_mob_validate_data_entrega()
  {
    var nomeCampo_data_entrega = "data_entrega";
    var var_data_entrega = scAjaxGetFieldHidden(nomeCampo_data_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_data_entrega(var_data_entrega, var_script_case_init, do_ajax_form_tracking_mob_validate_data_entrega_cb);
  } // do_ajax_form_tracking_mob_validate_data_entrega

  function do_ajax_form_tracking_mob_validate_data_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_data_entrega_cb

  // ---------- Validate data_prevista
  function do_ajax_form_tracking_mob_validate_data_prevista()
  {
    var nomeCampo_data_prevista = "data_prevista";
    var var_data_prevista = scAjaxGetFieldText(nomeCampo_data_prevista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_data_prevista(var_data_prevista, var_script_case_init, do_ajax_form_tracking_mob_validate_data_prevista_cb);
  } // do_ajax_form_tracking_mob_validate_data_prevista

  function do_ajax_form_tracking_mob_validate_data_prevista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "data_prevista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_data_prevista_cb

  // ---------- Validate data_compra
  function do_ajax_form_tracking_mob_validate_data_compra()
  {
    var nomeCampo_data_compra = "data_compra";
    var var_data_compra = scAjaxGetFieldHidden(nomeCampo_data_compra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_data_compra(var_data_compra, var_script_case_init, do_ajax_form_tracking_mob_validate_data_compra_cb);
  } // do_ajax_form_tracking_mob_validate_data_compra

  function do_ajax_form_tracking_mob_validate_data_compra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "data_compra";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_data_compra_cb

  // ---------- Validate comprador
  function do_ajax_form_tracking_mob_validate_comprador()
  {
    var nomeCampo_comprador = "comprador";
    var var_comprador = scAjaxGetFieldHidden(nomeCampo_comprador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_comprador(var_comprador, var_script_case_init, do_ajax_form_tracking_mob_validate_comprador_cb);
  } // do_ajax_form_tracking_mob_validate_comprador

  function do_ajax_form_tracking_mob_validate_comprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "comprador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_comprador_cb

  // ---------- Validate id_dealer
  function do_ajax_form_tracking_mob_validate_id_dealer()
  {
    var nomeCampo_id_dealer = "id_dealer";
    var var_id_dealer = scAjaxGetFieldSelect(nomeCampo_id_dealer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_id_dealer(var_id_dealer, var_script_case_init, do_ajax_form_tracking_mob_validate_id_dealer_cb);
  } // do_ajax_form_tracking_mob_validate_id_dealer

  function do_ajax_form_tracking_mob_validate_id_dealer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_dealer";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_id_dealer_cb

  // ---------- Validate dealer
  function do_ajax_form_tracking_mob_validate_dealer()
  {
    var nomeCampo_dealer = "dealer";
    var var_dealer = scAjaxGetFieldHidden(nomeCampo_dealer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_dealer(var_dealer, var_script_case_init, do_ajax_form_tracking_mob_validate_dealer_cb);
  } // do_ajax_form_tracking_mob_validate_dealer

  function do_ajax_form_tracking_mob_validate_dealer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_dealer_cb

  // ---------- Validate purch_order
  function do_ajax_form_tracking_mob_validate_purch_order()
  {
  } // do_ajax_form_tracking_mob_validate_purch_order

  function do_ajax_form_tracking_mob_validate_purch_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "purch_order";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_purch_order_cb

  // ---------- Validate status
  function do_ajax_form_tracking_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_status(var_status, var_script_case_init, do_ajax_form_tracking_mob_validate_status_cb);
  } // do_ajax_form_tracking_mob_validate_status

  function do_ajax_form_tracking_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_status_cb

  // ---------- Validate via
  function do_ajax_form_tracking_mob_validate_via()
  {
    var nomeCampo_via = "via";
    var var_via = scAjaxGetFieldText(nomeCampo_via);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_via(var_via, var_script_case_init, do_ajax_form_tracking_mob_validate_via_cb);
  } // do_ajax_form_tracking_mob_validate_via

  function do_ajax_form_tracking_mob_validate_via_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_via_cb

  // ---------- Validate data_recebimento
  function do_ajax_form_tracking_mob_validate_data_recebimento()
  {
    var nomeCampo_data_recebimento = "data_recebimento";
    var var_data_recebimento = scAjaxGetFieldText(nomeCampo_data_recebimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_data_recebimento(var_data_recebimento, var_script_case_init, do_ajax_form_tracking_mob_validate_data_recebimento_cb);
  } // do_ajax_form_tracking_mob_validate_data_recebimento

  function do_ajax_form_tracking_mob_validate_data_recebimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "data_recebimento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_data_recebimento_cb

  // ---------- Validate obs
  function do_ajax_form_tracking_mob_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_mob_validate_obs(var_obs, var_script_case_init, do_ajax_form_tracking_mob_validate_obs_cb);
  } // do_ajax_form_tracking_mob_validate_obs

  function do_ajax_form_tracking_mob_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_mob_validate_obs_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tracking_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tracking_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ordem = scAjaxGetFieldHidden("ordem");
    var var_job = scAjaxGetFieldText("job");
    var var_modelo = scAjaxGetFieldHidden("modelo");
    var var_fob = scAjaxGetFieldHidden("fob");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_qtd = scAjaxGetFieldHidden("qtd");
    var var_vendedor = scAjaxGetFieldHidden("vendedor");
    var var_data_venda = scAjaxGetFieldHidden("data_venda");
    var var_data_entrega = scAjaxGetFieldHidden("data_entrega");
    var var_data_prevista = scAjaxGetFieldText("data_prevista");
    var var_data_compra = scAjaxGetFieldHidden("data_compra");
    var var_comprador = scAjaxGetFieldHidden("comprador");
    var var_id_dealer = scAjaxGetFieldSelect("id_dealer");
    var var_dealer = scAjaxGetFieldHidden("dealer");
    var var_purch_order = scAjaxGetFieldHidden("purch_order");
    var var_status = scAjaxGetFieldSelect("status");
    var var_via = scAjaxGetFieldText("via");
    var var_data_recebimento = scAjaxGetFieldText("data_recebimento");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tracking_mob_submit_form(var_ordem, var_job, var_modelo, var_fob, var_descricao, var_qtd, var_vendedor, var_data_venda, var_data_entrega, var_data_prevista, var_data_compra, var_comprador, var_id_dealer, var_dealer, var_purch_order, var_status, var_via, var_data_recebimento, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tracking_mob_submit_form_cb);
  } // do_ajax_form_tracking_mob_submit_form

  function do_ajax_form_tracking_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ordem");
      scAjaxHideErrorDisplay("job");
      scAjaxHideErrorDisplay("modelo");
      scAjaxHideErrorDisplay("fob");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("qtd");
      scAjaxHideErrorDisplay("vendedor");
      scAjaxHideErrorDisplay("data_venda");
      scAjaxHideErrorDisplay("data_entrega");
      scAjaxHideErrorDisplay("data_prevista");
      scAjaxHideErrorDisplay("data_compra");
      scAjaxHideErrorDisplay("comprador");
      scAjaxHideErrorDisplay("id_dealer");
      scAjaxHideErrorDisplay("dealer");
      scAjaxHideErrorDisplay("purch_order");
      scAjaxHideErrorDisplay("status");
      scAjaxHideErrorDisplay("via");
      scAjaxHideErrorDisplay("data_recebimento");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tracking_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tracking_mob_submit_form_cb
  function do_ajax_form_tracking_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tracking_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tracking_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tracking_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tracking_mob_navigate_form();
    }
  }

  function perform_ajax_form_tracking_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("data_recebimento");
    scAjaxHideErrorDisplay("obs");
    var var_job = document.F2.job.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tracking_mob_navigate_form(var_job, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tracking_mob_navigate_form_cb);
  } // do_ajax_form_tracking_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tracking_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tracking_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.job.value = scAjaxGetKeyValue("job");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tracking_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tracking_mob_navigate_form_cb
  function do_ajax_form_tracking_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tracking_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tracking_mob_navigate_form_cb_after_alert

  function sc_hide_form_tracking_mob_form()
  {
  ...
  ajax_field_list[0] = "ordem";
  ajax_field_list[1] = "job";
  ajax_field_list[2] = "modelo";
  ajax_field_list[3] = "fob";
  ajax_field_list[4] = "descricao";
  ajax_field_list[5] = "qtd";
  ajax_field_list[6] = "vendedor";
  ajax_field_list[7] = "data_venda";
  ajax_field_list[8] = "data_entrega";
  ajax_field_list[9] = "data_prevista";
  ajax_field_list[10] = "data_compra";
  ajax_field_list[11] = "comprador";
  ajax_field_list[12] = "id_dealer";
  ajax_field_list[13] = "dealer";
  ajax_field_list[14] = "purch_order";
  ajax_field_list[15] = "status";
  ajax_field_list[16] = "via";
  ajax_field_list[17] = "data_recebimento";
  ...
  var ajax_error_list = {
    "ordem": {"label": "Ordem", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "job": {"label": "Job", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "modelo": {"label": "Modelo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "fob": {"label": "Fob", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "qtd": {"label": "Qtd", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "vendedor": {"label": "Vendedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data_venda": {"label": "Data venda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data_entrega": {"label": "Data  entrada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data_prevista": {"label": "Data prevista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data_compra": {"label": "Data compra", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "comprador": {"label": "Comprador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_dealer": {"label": "Dealer", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dealer": {"label": "Dealer", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "purch_order": {"label": "Purch order", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "status": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "via": {"label": "Via", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data_recebimento": {"label": "Data recebimento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    ...
    "qtd": new Array(),
    "vendedor": new Array(),
    "data_venda": new Array(),
    "data_entrega": new Array(),
    "data_prevista": new Array(),
    "data_compra": new Array(),
    "comprador": new Array(),
    "id_dealer": new Array(),
    "dealer": new Array(),
    "purch_order": new Array(),
    "status": new Array(),
    "via": new Array(),
    "data_recebimento": new Array(),
    "obs": new Array()
  };
  ajax_field_mult["ordem"][1] = "ordem";
  ajax_field_mult["job"][1] = "job";
  ajax_field_mult["modelo"][1] = "modelo";
  ajax_field_mult["fob"][1] = "fob";
  ajax_field_mult["descricao"][1] = "descricao";
  ajax_field_mult["qtd"][1] = "qtd";
  ajax_field_mult["vendedor"][1] = "vendedor";
  ajax_field_mult["data_venda"][1] = "data_venda";
  ajax_field_mult["data_entrega"][1] = "data_entrega";
  ajax_field_mult["data_prevista"][1] = "data_prevista";
  ajax_field_mult["data_compra"][1] = "data_compra";
  ajax_field_mult["comprador"][1] = "comprador";
  ajax_field_mult["id_dealer"][1] = "id_dealer";
  ajax_field_mult["dealer"][1] = "dealer";
  ajax_field_mult["purch_order"][1] = "purch_order";
  ajax_field_mult["status"][1] = "status";
  ajax_field_mult["via"][1] = "via";
  ajax_field_mult["data_recebimento"][1] = "data_recebimento";
  ajax_field_mult["obs"][1] = "obs";

  var ajax_field_id = {
    "ordem": new Array("hidden_field_label_ordem", "hidden_field_data_ordem"),
    ...
    "fob": new Array("hidden_field_label_fob", "hidden_field_data_fob"),
    "descricao": new Array("hidden_field_label_descricao", "hidden_field_data_descricao"),
    "qtd": new Array("hidden_field_label_qtd", "hidden_field_data_qtd"),
    "vendedor": new Array("hidden_field_label_vendedor", "hidden_field_data_vendedor"),
    "data_venda": new Array("hidden_field_label_data_venda", "hidden_field_data_data_venda"),
    "data_entrega": new Array("hidden_field_label_data_entrega", "hidden_field_data_data_entrega"),
    "data_prevista": new Array("hidden_field_label_data_prevista", "hidden_field_data_data_prevista"),
    "data_compra": new Array("hidden_field_label_data_compra", "hidden_field_data_data_compra"),
    "comprador": new Array("hidden_field_label_comprador", "hidden_field_data_comprador"),
    "id_dealer": new Array("hidden_field_label_id_dealer", "hidden_field_data_id_dealer"),
    "dealer": new Array("hidden_field_label_dealer", "hidden_field_data_dealer"),
    "purch_order": new Array("hidden_field_label_purch_order", "hidden_field_data_purch_order"),
    "status": new Array("hidden_field_label_status", "hidden_field_data_status"),
    "via": new Array("hidden_field_label_via", "hidden_field_data_via"),
    "data_recebimento": new Array("hidden_field_label_data_recebimento", "hidden_field_data_data_recebimento"),
