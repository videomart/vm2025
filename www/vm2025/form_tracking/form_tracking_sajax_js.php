  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tracking" == sTestField)
        {
...
?>
  ...
  // ---------- Validate ordem
  function do_ajax_form_tracking_validate_ordem()
  {
    var nomeCampo_ordem = "ordem";
    var var_ordem = scAjaxGetFieldHidden(nomeCampo_ordem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_ordem(var_ordem, var_script_case_init, do_ajax_form_tracking_validate_ordem_cb);
  } // do_ajax_form_tracking_validate_ordem

  function do_ajax_form_tracking_validate_ordem_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_ordem_cb

  // ---------- Validate job
  function do_ajax_form_tracking_validate_job()
  {
    var nomeCampo_job = "job";
    var var_job = scAjaxGetFieldText(nomeCampo_job);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_job(var_job, var_script_case_init, do_ajax_form_tracking_validate_job_cb);
  } // do_ajax_form_tracking_validate_job

  function do_ajax_form_tracking_validate_job_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_job_cb

  // ---------- Validate modelo
  function do_ajax_form_tracking_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldHidden(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_tracking_validate_modelo_cb);
  } // do_ajax_form_tracking_validate_modelo

  function do_ajax_form_tracking_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_modelo_cb

  // ---------- Validate fob
  function do_ajax_form_tracking_validate_fob()
  {
    var nomeCampo_fob = "fob";
    var var_fob = scAjaxGetFieldHidden(nomeCampo_fob);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_fob(var_fob, var_script_case_init, do_ajax_form_tracking_validate_fob_cb);
  } // do_ajax_form_tracking_validate_fob

  function do_ajax_form_tracking_validate_fob_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_fob_cb

  // ---------- Validate descricao
  function do_ajax_form_tracking_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_tracking_validate_descricao_cb);
  } // do_ajax_form_tracking_validate_descricao

  function do_ajax_form_tracking_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_descricao_cb

  // ---------- Validate qtd
  function do_ajax_form_tracking_validate_qtd()
  {
    var nomeCampo_qtd = "qtd";
    var var_qtd = scAjaxGetFieldHidden(nomeCampo_qtd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_qtd(var_qtd, var_script_case_init, do_ajax_form_tracking_validate_qtd_cb);
  } // do_ajax_form_tracking_validate_qtd

  function do_ajax_form_tracking_validate_qtd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_qtd_cb

  // ---------- Validate vendedor
  function do_ajax_form_tracking_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldHidden(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_form_tracking_validate_vendedor_cb);
  } // do_ajax_form_tracking_validate_vendedor

  function do_ajax_form_tracking_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_vendedor_cb

  // ---------- Validate data_venda
  function do_ajax_form_tracking_validate_data_venda()
  {
    var nomeCampo_data_venda = "data_venda";
    var var_data_venda = scAjaxGetFieldHidden(nomeCampo_data_venda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_data_venda(var_data_venda, var_script_case_init, do_ajax_form_tracking_validate_data_venda_cb);
  } // do_ajax_form_tracking_validate_data_venda

  function do_ajax_form_tracking_validate_data_venda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_data_venda_cb

  // ---------- Validate data_entrega
  function do_ajax_form_tracking_validate_data_entrega()
  {
    var nomeCampo_data_entrega = "data_entrega";
    var var_data_entrega = scAjaxGetFieldHidden(nomeCampo_data_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_data_entrega(var_data_entrega, var_script_case_init, do_ajax_form_tracking_validate_data_entrega_cb);
  } // do_ajax_form_tracking_validate_data_entrega

  function do_ajax_form_tracking_validate_data_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_data_entrega_cb

  // ---------- Validate data_prevista
  function do_ajax_form_tracking_validate_data_prevista()
  {
    var nomeCampo_data_prevista = "data_prevista";
    var var_data_prevista = scAjaxGetFieldText(nomeCampo_data_prevista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_data_prevista(var_data_prevista, var_script_case_init, do_ajax_form_tracking_validate_data_prevista_cb);
  } // do_ajax_form_tracking_validate_data_prevista

  function do_ajax_form_tracking_validate_data_prevista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_data_prevista_cb

  // ---------- Validate data_compra
  function do_ajax_form_tracking_validate_data_compra()
  {
    var nomeCampo_data_compra = "data_compra";
    var var_data_compra = scAjaxGetFieldHidden(nomeCampo_data_compra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_data_compra(var_data_compra, var_script_case_init, do_ajax_form_tracking_validate_data_compra_cb);
  } // do_ajax_form_tracking_validate_data_compra

  function do_ajax_form_tracking_validate_data_compra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_data_compra_cb

  // ---------- Validate comprador
  function do_ajax_form_tracking_validate_comprador()
  {
    var nomeCampo_comprador = "comprador";
    var var_comprador = scAjaxGetFieldHidden(nomeCampo_comprador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_comprador(var_comprador, var_script_case_init, do_ajax_form_tracking_validate_comprador_cb);
  } // do_ajax_form_tracking_validate_comprador

  function do_ajax_form_tracking_validate_comprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_comprador_cb

  // ---------- Validate id_dealer
  function do_ajax_form_tracking_validate_id_dealer()
  {
    var nomeCampo_id_dealer = "id_dealer";
    var var_id_dealer = scAjaxGetFieldSelect(nomeCampo_id_dealer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_id_dealer(var_id_dealer, var_script_case_init, do_ajax_form_tracking_validate_id_dealer_cb);
  } // do_ajax_form_tracking_validate_id_dealer

  function do_ajax_form_tracking_validate_id_dealer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_id_dealer_cb

  // ---------- Validate dealer
  function do_ajax_form_tracking_validate_dealer()
  {
    var nomeCampo_dealer = "dealer";
    var var_dealer = scAjaxGetFieldHidden(nomeCampo_dealer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_dealer(var_dealer, var_script_case_init, do_ajax_form_tracking_validate_dealer_cb);
  } // do_ajax_form_tracking_validate_dealer

  function do_ajax_form_tracking_validate_dealer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_dealer_cb

  // ---------- Validate purch_order
  function do_ajax_form_tracking_validate_purch_order()
  {
  } // do_ajax_form_tracking_validate_purch_order

  function do_ajax_form_tracking_validate_purch_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_purch_order_cb

  // ---------- Validate status
  function do_ajax_form_tracking_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_status(var_status, var_script_case_init, do_ajax_form_tracking_validate_status_cb);
  } // do_ajax_form_tracking_validate_status

  function do_ajax_form_tracking_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_status_cb

  // ---------- Validate via
  function do_ajax_form_tracking_validate_via()
  {
    var nomeCampo_via = "via";
    var var_via = scAjaxGetFieldText(nomeCampo_via);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_via(var_via, var_script_case_init, do_ajax_form_tracking_validate_via_cb);
  } // do_ajax_form_tracking_validate_via

  function do_ajax_form_tracking_validate_via_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_via_cb

  // ---------- Validate data_recebimento
  function do_ajax_form_tracking_validate_data_recebimento()
  {
    var nomeCampo_data_recebimento = "data_recebimento";
    var var_data_recebimento = scAjaxGetFieldText(nomeCampo_data_recebimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_data_recebimento(var_data_recebimento, var_script_case_init, do_ajax_form_tracking_validate_data_recebimento_cb);
  } // do_ajax_form_tracking_validate_data_recebimento

  function do_ajax_form_tracking_validate_data_recebimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_data_recebimento_cb

  // ---------- Validate obs
  function do_ajax_form_tracking_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tracking_validate_obs(var_obs, var_script_case_init, do_ajax_form_tracking_validate_obs_cb);
  } // do_ajax_form_tracking_validate_obs

  function do_ajax_form_tracking_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tracking_validate_obs_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tracking_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tracking_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tracking_submit_form(var_ordem, var_job, var_modelo, var_fob, var_descricao, var_qtd, var_vendedor, var_data_venda, var_data_entrega, var_data_prevista, var_data_compra, var_comprador, var_id_dealer, var_dealer, var_purch_order, var_status, var_via, var_data_recebimento, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_tracking_submit_form_cb);
  } // do_ajax_form_tracking_submit_form

  function do_ajax_form_tracking_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tracking_submit_form_cb_after_alert);
  } // do_ajax_form_tracking_submit_form_cb
  function do_ajax_form_tracking_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tracking_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tracking_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tracking_navigate_form, function() {});
    } else {
      perform_ajax_form_tracking_navigate_form();
    }
  }

  function perform_ajax_form_tracking_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tracking_navigate_form(var_job, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tracking_navigate_form_cb);
  } // do_ajax_form_tracking_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tracking']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tracking_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tracking_navigate_form_cb_after_alert);
  } // do_ajax_form_tracking_navigate_form_cb
  function do_ajax_form_tracking_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tracking_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tracking_navigate_form_cb_after_alert

  function sc_hide_form_tracking_form()
  {
