...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["desconto_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["desconto_" + iSeqRow] && scEventControl_data["desconto_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["desconto_" + iSeqRow] && scEventControl_data["desconto_" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["modelo_" + iSeqRow] && scEventControl_data["modelo_" + iSeqRow]["autocomp"]) {
    return true;
  }
  return false;
...
function scEventControl_onFocus(oField, iSeq) {
  ...
  if ("desconto_" + iSeq == fieldName) {
    scEventControl_data[fieldName]["change"]   = true;
    scEventControl_data[fieldName]["original"] = $(oField).val();
    scEventControl_data[fieldName]["calculated"] = $(oField).val();
    return;
  }
  if ("modelo_" + iSeq == fieldName) {
    scEventControl_data[fieldName]["change"]   = true;
    scEventControl_data[fieldName]["original"] = $(oField).val();
    scEventControl_data[fieldName]["calculated"] = $(oField).val();
    return;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('change', function() { sc_form_itemproposta_id__onchange(this, iSeqRow) });
  $('#id_sc_field_id_proposta_' + iSeqRow).bind('change', function() { sc_form_itemproposta_id_proposta__onchange(this, iSeqRow) });
  $('#id_sc_field_modelo_' + iSeqRow).bind('blur', function() { sc_form_itemproposta_modelo__onblur('#id_sc_field_modelo_' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_itemproposta_modelo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_itemproposta_modelo__onfocus(this, iSeqRow) });
  $('#id_sc_field_descricao_' + iSeqRow).bind('blur', function() { sc_form_itemproposta_descricao__onblur('#id_sc_field_descricao_' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_form_itemproposta_descricao__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_itemproposta_descricao__onfocus(this, iSeqRow) });
  $('#id_sc_field_unit_' + iSeqRow).bind('blur', function() { sc_form_itemproposta_unit__onblur('#id_sc_field_unit_' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_itemproposta_unit__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_itemproposta_unit__onfocus(this, iSeqRow) });
  $('#id_sc_field_desconto_' + iSeqRow).bind('blur', function() { sc_form_itemproposta_desconto__onblur('#id_sc_field_desconto_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_itemproposta_desconto__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_itemproposta_desconto__onfocus(this, iSeqRow) });
  $('#id_sc_field_qty_' + iSeqRow).bind('blur', function() { sc_form_itemproposta_qty__onblur('#id_sc_field_qty_' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_itemproposta_qty__onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_itemproposta_qty__onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal_' + iSeqRow).bind('blur', function() { sc_form_itemproposta_subtotal__onblur('#id_sc_field_subtotal_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_itemproposta_subtotal__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_itemproposta_subtotal__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_itemproposta_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_itemproposta_id_proposta__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_itemproposta_modelo__onblur(oThis, iSeqRow) {
  do_ajax_form_itemproposta_validate_modelo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_itemproposta_modelo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_itemproposta_event_modelo__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_itemproposta_modelo__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}

function sc_form_itemproposta_descricao__onblur(oThis, iSeqRow) {
  do_ajax_form_itemproposta_validate_descricao_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_itemproposta_descricao__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_itemproposta_descricao__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_itemproposta_unit__onblur(oThis, iSeqRow) {
  do_ajax_form_itemproposta_validate_unit_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
  do_ajax_form_itemproposta_event_unit__onblur(iSeqRow);
}

function sc_form_itemproposta_unit__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_itemproposta_unit__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_itemproposta_desconto__onblur(oThis, iSeqRow) {
  do_ajax_form_itemproposta_validate_desconto_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
  do_ajax_form_itemproposta_event_desconto__onblur(iSeqRow);
}

function sc_form_itemproposta_desconto__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_itemproposta_event_desconto__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_itemproposta_desconto__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_itemproposta_qty__onblur(oThis, iSeqRow) {
  do_ajax_form_itemproposta_validate_qty_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
  do_ajax_form_itemproposta_event_qty__onblur(iSeqRow);
}

function sc_form_itemproposta_qty__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_itemproposta_qty__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_itemproposta_subtotal__onblur(oThis, iSeqRow) {
  do_ajax_form_itemproposta_validate_subtotal_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_itemproposta_subtotal__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_itemproposta_subtotal__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
        ...
        displayChange_field("desconto_", "", status);
...
function displayChange_row(row, status) {
        ...
        displayChange_field_desconto_(row, status);
...
function displayChange_field_desconto_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
        $("#id_form_itemproposta_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_itemproposta')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
