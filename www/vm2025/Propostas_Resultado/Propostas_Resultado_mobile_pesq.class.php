...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_numeric[] = "total";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_natureza_cond" name="natureza_cond" onChange="nm_campos_between(document.getElementById('id_vis_natureza'), this, 'natureza')">
      ...
      <br><span id="id_hide_natureza"  <?php echo $str_hide_natureza?>><INPUT  type="text" id="SC_natureza" name="natureza" value="<?php echo NM_encode_input($natureza) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_cliente"  <?php echo $str_hide_cliente?>><INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_cod_vend_cond" name="cod_vend_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_vend'), this, 'cod_vend')">
      ...
      <br><span id="id_hide_cod_vend"  <?php echo $str_hide_cod_vend?>><INPUT  type="text" id="SC_cod_vend" name="cod_vend" value="<?php echo NM_encode_input($cod_vend) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
