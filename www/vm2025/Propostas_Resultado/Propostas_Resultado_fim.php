...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____Propostas_Resultado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____Propostas_Resultado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Propostas_Resultado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Propostas_Resultado']['embutida_filho'] as $ind => $sc_init)
          {
