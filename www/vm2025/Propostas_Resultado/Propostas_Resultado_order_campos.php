...
<?php
   ...
   $Ord_Cmp = new Propostas_Resultado_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Propostas_Resultado_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["natureza"]   = (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["natureza"])) ? $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["natureza"] : "natureza";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["cliente"] : "cliente";
   $tab_ger_campos['cod_vend'] = "on";
   $tab_def_campos['cod_vend'] = "cod_vend";
   $tab_labels["cod_vend"]   = (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["cod_vend"])) ? $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["cod_vend"] : "cod_vend";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['labels']["total"] : "total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Propostas_Resultado_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Propostas_Resultado']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
