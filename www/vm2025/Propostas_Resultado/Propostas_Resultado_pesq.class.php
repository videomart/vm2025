...
class Propostas_Resultado_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Propostas_Resultado_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Propostas_Resultado_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(Propostas_Resultado_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . Propostas_Resultado_pack_protect_string($Tipo_filter[0]) . "\">.." . Propostas_Resultado_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
            ...
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - proposta</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>Propostas_Resultado/Propostas_Resultado_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="Propostas_Resultado_ajax_search.js"></script>
 <script type="text/javascript" src="Propostas_Resultado_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="Propostas_Resultado_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Propostas_Resultado']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['Propostas_Resultado']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_natureza_cond#NMF#' + search_get_sel_txt('SC_natureza_cond') + '@NMF@';
  str_out += 'SC_natureza#NMF#' + search_get_text('SC_natureza') + '@NMF@';
  ...
  str_out += 'SC_cod_vend#NMF#' + search_get_text('SC_cod_vend') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $natureza = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['natureza']; 
          $natureza_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['natureza_cond']; 
          $data_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_dia']; 
          $data_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_mes']; 
          $data_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_ano']; 
          $data_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cliente_cond']; 
          $cod_vend = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cod_vend']; 
          $cod_vend_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cod_vend_cond']; 
          $total = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['total']; 
          $total_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['total_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['NM_operador']; 
      ...
      {
         $tmp_pos = (is_string($cliente)) ? strpos($cliente, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($total)) ? strpos($total, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_natureza_cond" name="natureza_cond" onChange="nm_campos_between(document.getElementById('id_vis_natureza'), this, 'natureza')">
       <OPTION value="eq" <?php if ("eq" == $natureza_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $natureza_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $natureza_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $natureza_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
...
?>
<INPUT  type="text" id="SC_natureza" name="natureza" value="<?php echo NM_encode_input($natureza) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_cliente_cond" name="cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cliente'), this, 'cliente')">
       ...
       <OPTION value="ii" <?php if ("ii" == $cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=50 alt="{datatype: 'text', maxLength: 65, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_cod_vend_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cod_vend'])) ? $this->New_label['cod_vend'] : "cod_vend"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_cod_vend_cond" name="cod_vend_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_vend'), this, 'cod_vend')">
       <OPTION value="eq" <?php if ("eq" == $cod_vend_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $cod_vend_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cod_vend_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cod_vend_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_cod_vend" name="cod_vend" value="<?php echo NM_encode_input($cod_vend) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
...
?>
<?php
   if (is_file("Propostas_Resultado_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Propostas_Resultado']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Propostas_Resultado']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_data_dia').bind('change', function() {sc_Propostas_Resultado_valida_dia(this)});
    $('#SC_data_mes').bind('change', function() {sc_Propostas_Resultado_valida_mes(this)});
 }
 function sc_Propostas_Resultado_valida_dia(obj)
 {
 ...
 function sc_Propostas_Resultado_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/Propostas_Resultado";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_natureza_cond'] = 'cond';
      $tp_fields['SC_natureza'] = 'text';
      ...
      $tp_fields['SC_cliente'] = 'text';
      $tp_fields['SC_cod_vend_cond'] = 'cond';
      $tp_fields['SC_cod_vend'] = 'text';
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['natureza'] = $natureza; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['natureza_cond'] = $natureza_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_dia'] = $data_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_mes'] = $data_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_ano'] = $data_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_cond'] = $data_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cod_vend'] = $cod_vend; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['cod_vend_cond'] = $cod_vend_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['total'] = $total; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['total_cond'] = $total_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca'] = $Temp_Busca;
      }
      ...
      $this->cmp_formatado['cliente'] = "'" . $this->cmp_formatado['cliente'] . "'";
      if (isset($this->cmp_formatado['cliente_input_2'])  && !empty($this->cmp_formatado['cliente_input_2'])) {
          $this->cmp_formatado['cliente_input_2'] = "'" . $this->cmp_formatado['cliente_input_2'] . "'";
      }
      $Conteudo = $cod_vend;
      ...
      $this->cmp_formatado['total'] = "'" . $this->cmp_formatado['total'] . "'";
      if (isset($this->cmp_formatado['total_input_2'])  && !empty($this->cmp_formatado['total_input_2'])) {
          $this->cmp_formatado['total_input_2'] = "'" . $this->cmp_formatado['total_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($natureza) || $natureza_cond == "nu" || $natureza_cond == "nn" || $natureza_cond == "ep" || $natureza_cond == "ne")
      {
      ...
      if ($data_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data'] = $val[0];
          ...
          if ($data_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']['data_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("cliente", $cliente_cond, $cliente, "", "cliente", "VARCHAR", false);
      }

      //----- $cod_vend
      $this->Date_part = false;
      if (isset($cod_vend) || $cod_vend_cond == "nu" || $cod_vend_cond == "nn" || $cod_vend_cond == "ep" || $cod_vend_cond == "ne")
      {
      ...
      {
         $this->monta_condicao("total", $total_cond, $total, "", "total", "DOUBLE", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['Propostas_Resultado']['cond_pesq'] .= $this->NM_operador;
