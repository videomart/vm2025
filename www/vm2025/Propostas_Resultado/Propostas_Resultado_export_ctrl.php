<?php
@session_start() ;
$_SESSION['scriptcase']['Propostas_Resultado']['sc_process_barr'] = true;
require_once('../Propostas_Resultado/index.php');
unset($_SESSION['scriptcase']['Propostas_Resultado']['sc_process_barr']);
$ExportCtrl = new Propostas_Resultado_export_control;
$ExportCtrl->Export_barr();

class Propostas_Resultado_export_control
{
