...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_app_form_edit_users_name_onblur('#id_sc_field_name' + iSeqRow, iSeqRow);}, 300) })
  ...
  $('#id_sc_field_role' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_role_onblur('#id_sc_field_role' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_app_form_edit_users_role_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_app_form_edit_users_role_onfocus(this, iSeqRow) });
  $('#id_sc_field_phone' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_phone_onblur('#id_sc_field_phone' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_app_form_edit_users_phone_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_app_form_edit_users_phone_onfocus(this, iSeqRow) });
  $('#id_sc_field_pswd_last_updated' + iSeqRow).bind('change', function() { sc_app_form_edit_users_pswd_last_updated_onchange(this, iSeqRow) });
  $('#id_sc_field_pswd_last_updated_hora' + iSeqRow).bind('change', function() { sc_app_form_edit_users_pswd_last_updated_hora_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_pswd_rules' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_pswd_rules_onblur('#id_sc_field_pswd_rules' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_app_form_edit_users_pswd_rules_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_app_form_edit_users_pswd_rules_onfocus(this, iSeqRow) });
...
function sc_app_form_edit_users_role_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_role();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_role_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_role_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_phone_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_phone();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_phone_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_app_form_edit_users_pswd_last_updated_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_pswd_last_updated_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_app_form_edit_users_pswd_rules_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_validate_pswd_rules();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_pswd_rules_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_form_edit_users_pswd_rules_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_app_form_edit_users_validate_pswd_last_updated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
