...
?>
  ...
  // ---------- Validate pswd_rules
  function do_ajax_app_form_edit_users_validate_pswd_rules()
  {
    var nomeCampo_pswd_rules = "pswd_rules";
    var var_pswd_rules = scAjaxGetFieldHidden(nomeCampo_pswd_rules);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_pswd_rules(var_pswd_rules, var_script_case_init, do_ajax_app_form_edit_users_validate_pswd_rules_cb);
  } // do_ajax_app_form_edit_users_validate_pswd_rules

  function do_ajax_app_form_edit_users_validate_pswd_rules_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_pswd_rules_cb
  ...
  // ---------- Validate role
  function do_ajax_app_form_edit_users_validate_role()
  {
    var nomeCampo_role = "role";
    var var_role = scAjaxGetFieldText(nomeCampo_role);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_role(var_role, var_script_case_init, do_ajax_app_form_edit_users_validate_role_cb);
  } // do_ajax_app_form_edit_users_validate_role

  function do_ajax_app_form_edit_users_validate_role_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_role_cb

  // ---------- Validate phone
  function do_ajax_app_form_edit_users_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_phone(var_phone, var_script_case_init, do_ajax_app_form_edit_users_validate_phone_cb);
  } // do_ajax_app_form_edit_users_validate_phone

  function do_ajax_app_form_edit_users_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_phone_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_picture, var_login, var_pswd, var_confirm_pswd, var_pswd_rules, var_name, var_email, var_active, var_role, var_phone, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
