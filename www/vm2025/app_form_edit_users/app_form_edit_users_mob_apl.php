...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['app_form_edit_users_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['app_form_edit_users_mob']['opc_ant']);
          }
          if (isset($this->sett_send_email_adm)) 
          {
              $_SESSION['sett_send_email_adm'] = $this->sett_send_email_adm;
...
//
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") {
          $this->pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_form']['pswd'];
      }
...
//
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_select']['pswd']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['dados_select']['pswd'];
          } 
      }
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_login = $this->login;
     ...
     $nm_select ="DELETE FROM sec_users_social WHERE sec_users_social.login = ". $this->Db->qstr($this->login ); 
      ...
      $Nm_datas["pswd_last_updated"] = "timestamp";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              ...
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['SC_sep_date1'];
              }
          }
