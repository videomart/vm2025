...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['app_form_sec_groups_apps']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['app_form_sec_groups_apps']['opc_ant']);
          }
          if (isset($this->group_desc)) 
          {
              $_SESSION['group_desc'] = $this->group_desc;
...
$_SESSION['scriptcase']['app_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_sec_groups_apps']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_sec_groups_apps']['label'] = "" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . " - " . $this->Ini->Nm_lang['lang_sec_group'] . ": " . $_SESSION['group_desc'] . "";
   ...
   function controle()
   {
      ...
      { 
         ...
         else
         {
             ...
             $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['description_'] =  $this->description_; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_sec_groups_apps']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
   ...
   function ajax_return_values_all_vert()
   {
          if (isset($this->nmgp_refresh_fields) && isset($this->nmgp_refresh_row) && '' != $this->nmgp_refresh_row)
          {
              ...
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_app_form_sec_groups_apps[$this->nmgp_refresh_row]['description_'] = $this->description_;
                  }
