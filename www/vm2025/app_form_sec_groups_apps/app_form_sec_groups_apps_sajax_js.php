...
?>
  ...
  function do_ajax_app_form_sec_groups_apps_validate_description_(iNumLinha)
  {
    ...
    x_ajax_app_form_sec_groups_apps_validate_description_(var_description_, iNumLinha, var_script_case_init, do_ajax_app_form_sec_groups_apps_validate_description__cb);
  } // do_ajax_app_form_sec_groups_apps_validate_description_

  function do_ajax_app_form_sec_groups_apps_validate_description__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_sec_groups_apps_validate_description__cb
...
?>
    x_ajax_app_form_sec_groups_apps_submit_form(var_app_name_, var_description_, var_priv_access_, var_priv_insert_, var_priv_delete_, var_priv_update_, var_priv_export_, var_priv_print_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_sec_groups_apps_submit_form_cb);
