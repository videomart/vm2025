...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_description_' + iSeqRow).bind('blur', function() { sc_app_form_sec_groups_apps_description__onblur('#id_sc_field_description_' + iSeqRow, iSeqRow) })
                                          .bind('change', function() { sc_app_form_sec_groups_apps_description__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_app_form_sec_groups_apps_description__onfocus(this, iSeqRow) });
...
function sc_app_form_sec_groups_apps_description__onblur(oThis, iSeqRow) {
  do_ajax_app_form_sec_groups_apps_validate_description_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_app_form_sec_groups_apps_description__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_app_form_sec_groups_apps_description__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
