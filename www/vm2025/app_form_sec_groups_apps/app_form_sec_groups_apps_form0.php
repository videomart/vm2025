...
<?php
if (!empty($this->Mens_return_ok)) {
?>
  oResp = new Array();
  oResp = {"msgDisplay": {"msgText" : "<?php echo $this->Mens_return_ok ?>"}};
...
{ 
   ...
   foreach ($this->form_vert_app_form_sec_groups_apps as $sc_seq_vert => $sc_lixo)
   {
       ...
       $this->description_ = $this->form_vert_app_form_sec_groups_apps[$sc_seq_vert]['description_']; 
