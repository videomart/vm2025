  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_subconta" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_pai
  function do_ajax_form_subconta_validate_id_pai()
  {
    var nomeCampo_id_pai = "id_pai";
    var var_id_pai = scAjaxGetFieldSelect(nomeCampo_id_pai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subconta_validate_id_pai(var_id_pai, var_script_case_init, do_ajax_form_subconta_validate_id_pai_cb);
  } // do_ajax_form_subconta_validate_id_pai

  function do_ajax_form_subconta_validate_id_pai_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subconta_validate_id_pai_cb

  // ---------- Validate conta
  function do_ajax_form_subconta_validate_conta()
  {
    var nomeCampo_conta = "conta";
    var var_conta = scAjaxGetFieldText(nomeCampo_conta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subconta_validate_conta(var_conta, var_script_case_init, do_ajax_form_subconta_validate_conta_cb);
  } // do_ajax_form_subconta_validate_conta

  function do_ajax_form_subconta_validate_conta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subconta_validate_conta_cb

  // ---------- Validate tipo
  function do_ajax_form_subconta_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subconta_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_subconta_validate_tipo_cb);
  } // do_ajax_form_subconta_validate_tipo

  function do_ajax_form_subconta_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subconta_validate_tipo_cb

  // ---------- Event onchange id_pai
  function do_ajax_form_subconta_event_id_pai_onchange()
  {
    var var_id_pai = scAjaxGetFieldSelect("id_pai");
    var var_tipo = scAjaxGetFieldRadio("tipo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_subconta_event_id_pai_onchange(var_id_pai, var_tipo, var_script_case_init, do_ajax_form_subconta_event_id_pai_onchange_cb);
  } // do_ajax_form_subconta_event_id_pai_onchange

  function do_ajax_form_subconta_event_id_pai_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_pai";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_subconta_event_id_pai_onchange_cb_after_alert);
  } // do_ajax_form_subconta_event_id_pai_onchange_cb
  function do_ajax_form_subconta_event_id_pai_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_subconta_event_id_pai_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_subconta_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_subconta_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_pai = scAjaxGetFieldSelect("id_pai");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_subconta_submit_form(var_id_pai, var_conta, var_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_subconta_submit_form_cb);
  } // do_ajax_form_subconta_submit_form

  function do_ajax_form_subconta_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_subconta_submit_form_cb_after_alert);
  } // do_ajax_form_subconta_submit_form_cb
  function do_ajax_form_subconta_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_subconta_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_subconta_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_subconta_navigate_form, function() {});
    } else {
      perform_ajax_form_subconta_navigate_form();
    }
  }

  function perform_ajax_form_subconta_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_subconta_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subconta_navigate_form_cb);
  } // do_ajax_form_subconta_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_subconta']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_subconta_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_subconta_navigate_form_cb_after_alert);
  } // do_ajax_form_subconta_navigate_form_cb
  function do_ajax_form_subconta_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_subconta_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_subconta_navigate_form_cb_after_alert

  function sc_hide_form_subconta_form()
  {
