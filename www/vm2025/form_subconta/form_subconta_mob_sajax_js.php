  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_subconta_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_subconta_mob_form();
        }
...
?>
  ...
  // ---------- Validate id_pai
  function do_ajax_form_subconta_mob_validate_id_pai()
  {
    var nomeCampo_id_pai = "id_pai";
    var var_id_pai = scAjaxGetFieldSelect(nomeCampo_id_pai);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subconta_mob_validate_id_pai(var_id_pai, var_script_case_init, do_ajax_form_subconta_mob_validate_id_pai_cb);
  } // do_ajax_form_subconta_mob_validate_id_pai

  function do_ajax_form_subconta_mob_validate_id_pai_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subconta_mob_validate_id_pai_cb

  // ---------- Validate conta
  function do_ajax_form_subconta_mob_validate_conta()
  {
    var nomeCampo_conta = "conta";
    var var_conta = scAjaxGetFieldText(nomeCampo_conta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subconta_mob_validate_conta(var_conta, var_script_case_init, do_ajax_form_subconta_mob_validate_conta_cb);
  } // do_ajax_form_subconta_mob_validate_conta

  function do_ajax_form_subconta_mob_validate_conta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subconta_mob_validate_conta_cb

  // ---------- Validate tipo
  function do_ajax_form_subconta_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subconta_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_subconta_mob_validate_tipo_cb);
  } // do_ajax_form_subconta_mob_validate_tipo

  function do_ajax_form_subconta_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subconta_mob_validate_tipo_cb

  // ---------- Event onchange id_pai
  function do_ajax_form_subconta_mob_event_id_pai_onchange()
  {
    var var_id_pai = scAjaxGetFieldSelect("id_pai");
    var var_tipo = scAjaxGetFieldRadio("tipo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_subconta_mob_event_id_pai_onchange(var_id_pai, var_tipo, var_script_case_init, do_ajax_form_subconta_mob_event_id_pai_onchange_cb);
  } // do_ajax_form_subconta_mob_event_id_pai_onchange

  function do_ajax_form_subconta_mob_event_id_pai_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_pai";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_subconta_mob_event_id_pai_onchange_cb_after_alert);
  } // do_ajax_form_subconta_mob_event_id_pai_onchange_cb
  function do_ajax_form_subconta_mob_event_id_pai_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_subconta_mob_event_id_pai_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_subconta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_subconta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_pai = scAjaxGetFieldSelect("id_pai");
    var var_conta = scAjaxGetFieldText("conta");
    var var_tipo = scAjaxGetFieldRadio("tipo");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_subconta_mob_submit_form(var_id_pai, var_conta, var_tipo, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_subconta_mob_submit_form_cb);
  } // do_ajax_form_subconta_mob_submit_form

  function do_ajax_form_subconta_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_pai");
      scAjaxHideErrorDisplay("conta");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_subconta_mob_submit_form_cb_after_alert);
  } // do_ajax_form_subconta_mob_submit_form_cb
  function do_ajax_form_subconta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_subconta_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_subconta_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_subconta_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_subconta_mob_navigate_form();
    }
  }

  function perform_ajax_form_subconta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_subconta_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subconta_mob_navigate_form_cb);
  } // do_ajax_form_subconta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_subconta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_subconta_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_subconta_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_subconta_mob_navigate_form_cb
  function do_ajax_form_subconta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_subconta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_subconta_mob_navigate_form_cb_after_alert

  function sc_hide_form_subconta_mob_form()
  {
  ...
  ajax_field_list[0] = "id_pai";
  ajax_field_list[1] = "conta";
  ...
  var ajax_error_list = {
    "id_pai": {"label": "Conta Pai", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "conta": {"label": "Subconta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["id_pai"][1] = "id_pai";
  ajax_field_mult["conta"][1] = "conta";
  ajax_field_mult["tipo"][1] = "tipo";

  var ajax_field_id = {
    "id_pai": new Array("hidden_field_label_id_pai", "hidden_field_data_id_pai"),
    "conta": new Array("hidden_field_label_conta", "hidden_field_data_conta"),
