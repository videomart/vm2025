  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_price" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_modelo_
  function do_ajax_form_price_validate_id_modelo_(iNumLinha)
  {
  } // do_ajax_form_price_validate_id_modelo_

  function do_ajax_form_price_validate_id_modelo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_modelo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_modelo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_modelo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_modelo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_id_modelo__cb

  // ---------- Validate id_empresa_
  function do_ajax_form_price_validate_id_empresa_(iNumLinha)
  {
  } // do_ajax_form_price_validate_id_empresa_

  function do_ajax_form_price_validate_id_empresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_id_empresa__cb

  // ---------- Validate fob_
  function do_ajax_form_price_validate_fob_(iNumLinha)
  {
    var nomeCampo_fob_ = "fob_" + iNumLinha;
    var var_fob_ = scAjaxGetFieldText(nomeCampo_fob_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_validate_fob_(var_fob_, iNumLinha, var_script_case_init, do_ajax_form_price_validate_fob__cb);
  } // do_ajax_form_price_validate_fob_

  function do_ajax_form_price_validate_fob__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fob_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fob_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_fob__cb

  // ---------- Validate peso_
  function do_ajax_form_price_validate_peso_(iNumLinha)
  {
    var nomeCampo_peso_ = "peso_" + iNumLinha;
    var var_peso_ = scAjaxGetFieldText(nomeCampo_peso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_validate_peso_(var_peso_, iNumLinha, var_script_case_init, do_ajax_form_price_validate_peso__cb);
  } // do_ajax_form_price_validate_peso_

  function do_ajax_form_price_validate_peso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_peso__cb

  // ---------- Validate moeda_
  function do_ajax_form_price_validate_moeda_(iNumLinha)
  {
    var nomeCampo_moeda_ = "moeda_" + iNumLinha;
    var var_moeda_ = scAjaxGetFieldSelect(nomeCampo_moeda_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_validate_moeda_(var_moeda_, iNumLinha, var_script_case_init, do_ajax_form_price_validate_moeda__cb);
  } // do_ajax_form_price_validate_moeda_

  function do_ajax_form_price_validate_moeda__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "moeda_" + iLineNumber;
    }
    else
    {
      sFieldValid = "moeda_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "moeda_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "moeda_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_moeda__cb

  // ---------- Validate data_
  function do_ajax_form_price_validate_data_(iNumLinha)
  {
    var nomeCampo_data_ = "data_" + iNumLinha;
    var var_data_ = scAjaxGetFieldText(nomeCampo_data_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_validate_data_(var_data_, iNumLinha, var_script_case_init, do_ajax_form_price_validate_data__cb);
  } // do_ajax_form_price_validate_data_

  function do_ajax_form_price_validate_data__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_data__cb

  // ---------- Validate obs_
  function do_ajax_form_price_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_price_validate_obs__cb);
  } // do_ajax_form_price_validate_obs_

  function do_ajax_form_price_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_obs__cb

  // ---------- Validate minimo_
  function do_ajax_form_price_validate_minimo_(iNumLinha)
  {
    var nomeCampo_minimo_ = "minimo_" + iNumLinha;
    var var_minimo_ = scAjaxGetFieldText(nomeCampo_minimo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_validate_minimo_(var_minimo_, iNumLinha, var_script_case_init, do_ajax_form_price_validate_minimo__cb);
  } // do_ajax_form_price_validate_minimo_

  function do_ajax_form_price_validate_minimo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_price_validate_minimo__cb

  // ---------- Event onchange fob_
  function do_ajax_form_price_event_fob__onchange(iSeqForm)
  {
    var var_id_modelo_ = scAjaxGetFieldText("id_modelo_" + iSeqForm);
    var var_minimo_ = scAjaxGetFieldText("minimo_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_price_event_fob__onchange(var_id_modelo_, var_minimo_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_price_event_fob__onchange_cb);
  } // do_ajax_form_price_event_fob__onchange

  function do_ajax_form_price_event_fob__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_price_event_fob__onchange_cb_after_alert);
  } // do_ajax_form_price_event_fob__onchange_cb
  function do_ajax_form_price_event_fob__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_price_event_fob__onchange_cb_after_alert

  // ---------- Event onchange id_empresa_
  function do_ajax_form_price_event_id_empresa__onchange(iSeqForm)
  {
    var var_id_empresa_ = scAjaxGetFieldText("id_empresa_" + iSeqForm);
    var var_obs_ = scAjaxGetFieldText("obs_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_price_event_id_empresa__onchange(var_id_empresa_, var_obs_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_price_event_id_empresa__onchange_cb);
  } // do_ajax_form_price_event_id_empresa__onchange

  function do_ajax_form_price_event_id_empresa__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_price_event_id_empresa__onchange_cb_after_alert);
  } // do_ajax_form_price_event_id_empresa__onchange_cb
  function do_ajax_form_price_event_id_empresa__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_price_event_id_empresa__onchange_cb_after_alert

  // ---------- Event onchange id_modelo_
  function do_ajax_form_price_event_id_modelo__onchange(iSeqForm)
  {
    var var_id_modelo_ = scAjaxGetFieldText("id_modelo_" + iSeqForm);
    var var_peso_ = scAjaxGetFieldText("peso_" + iSeqForm);
    var var_minimo_ = scAjaxGetFieldText("minimo_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_price_event_id_modelo__onchange(var_id_modelo_, var_peso_, var_minimo_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_price_event_id_modelo__onchange_cb);
  } // do_ajax_form_price_event_id_modelo__onchange

  function do_ajax_form_price_event_id_modelo__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_price_event_id_modelo__onchange_cb_after_alert);
  } // do_ajax_form_price_event_id_modelo__onchange_cb
  function do_ajax_form_price_event_id_modelo__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_price_event_id_modelo__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_price_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_price_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_price_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_price_add_new_line_cb);
  } // do_ajax_form_price_add_new_line

  var ctrl_new_line  = false;
  var ctrl_last_line = 0;
  function do_ajax_form_price_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    lin_old_ins = iAjaxNewLine - 1;
    if (iAjaxNewLine > 1 && ctrl_last_line == lin_old_ins) {
        scJQElementsAdd(lin_old_ins);
    }
    ...
    scFocusField('id_modelo_' + iAjaxNewLine);

    setTimeout(function() {ctrl_new_line = false; }, 500);
  } // do_ajax_form_price_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_price_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_price_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_price_backup_line_cb);
  } // do_ajax_form_price_backup_line

  function do_ajax_form_price_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_price_backup_line_cb

  function do_ajax_form_price_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_price_cancel_insert

  function do_ajax_form_price_cancel_update(iSeqVert)
  {
    do_ajax_form_price_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_price_cancel_update

  function do_ajax_form_price_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_price_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_price_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_price_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_price_table_refresh_cb);
  } //  do_ajax_form_price_table_refresh

  function do_ajax_form_price_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_price_table_refresh_cb_after_alert);
  } // do_ajax_form_price_table_refresh_cb
  function do_ajax_form_price_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_price_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_price_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_price_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_modelo_ = scAjaxGetFieldText("id_modelo_" + iNumLinha);
    var var_id_empresa_ = scAjaxGetFieldText("id_empresa_" + iNumLinha);
    var var_fob_ = scAjaxGetFieldText("fob_" + iNumLinha);
    var var_peso_ = scAjaxGetFieldText("peso_" + iNumLinha);
    var var_moeda_ = scAjaxGetFieldSelect("moeda_" + iNumLinha);
    var var_data_ = scAjaxGetFieldText("data_" + iNumLinha);
...
?>
    x_ajax_form_price_submit_form(var_id_modelo_, var_id_empresa_, var_fob_, var_peso_, var_moeda_, var_data_, var_obs_, var_minimo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_price_submit_form_cb);
  } // do_ajax_form_price_submit_form

  function do_ajax_form_price_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_modelo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fob_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("peso_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("moeda_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_price_submit_form_cb_after_alert);
  } // do_ajax_form_price_submit_form_cb
  function do_ajax_form_price_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_price_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_price_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_price_navigate_form, function() {});
    } else {
      perform_ajax_form_price_navigate_form();
    }
  }

  function perform_ajax_form_price_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_price_cancel_insert(sc_form_price_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_modelo_" + iNavForm);
      scAjaxHideErrorDisplay("id_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("fob_" + iNavForm);
      scAjaxHideErrorDisplay("peso_" + iNavForm);
      scAjaxHideErrorDisplay("moeda_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_price_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_price_navigate_form_cb);
  } // do_ajax_form_price_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_price']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_price_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_price_navigate_form_cb_after_alert);
  } // do_ajax_form_price_navigate_form_cb
  function do_ajax_form_price_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_price_navigate_form_cb_after_alert

    function sc_form_price_get_last_line_number()
    {
    ...
    } //sc_form_price_get_last_line_number

  function sc_hide_form_price_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_modelo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fob_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "peso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "moeda_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["id_modelo_" + iNumLinha] = {"label": "Modelo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["id_empresa_" + iNumLinha] = {"label": "Dealer<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["fob_" + iNumLinha] = {"label": "Fob<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["peso_" + iNumLinha] = {"label": "Peso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["moeda_" + iNumLinha] = {"label": "Moeda<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["data_" + iNumLinha] = {"label": "Data<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["obs_" + iNumLinha] = {"label": "Obs<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["minimo_" + iNumLinha] = {"label": "Min. <?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_modelo_"][iNumLinha] = "id_modelo_" + iNumLinha;
    ajax_field_mult["id_empresa_"][iNumLinha] = "id_empresa_" + iNumLinha;
    ajax_field_mult["fob_"][iNumLinha] = "fob_" + iNumLinha;
    ajax_field_mult["peso_"][iNumLinha] = "peso_" + iNumLinha;
    ajax_field_mult["moeda_"][iNumLinha] = "moeda_" + iNumLinha;
    ...
    ajax_field_id["id_modelo_" + iNumLinha] = new Array("hidden_field_label_id_modelo_", "hidden_field_data_id_modelo_" + iNumLinha);
    ajax_field_id["id_empresa_" + iNumLinha] = new Array("hidden_field_label_id_empresa_", "hidden_field_data_id_empresa_" + iNumLinha);
    ajax_field_id["fob_" + iNumLinha] = new Array("hidden_field_label_fob_", "hidden_field_data_fob_" + iNumLinha);
    ajax_field_id["peso_" + iNumLinha] = new Array("hidden_field_label_peso_", "hidden_field_data_peso_" + iNumLinha);
    ajax_field_id["moeda_" + iNumLinha] = new Array("hidden_field_label_moeda_", "hidden_field_data_moeda_" + iNumLinha);
    ...
    ajax_error_count["id_modelo_" + iNumLinha] = "off";
    ajax_error_count["id_empresa_" + iNumLinha] = "off";
    ajax_error_count["fob_" + iNumLinha] = "off";
    ajax_error_count["peso_" + iNumLinha] = "off";
    ajax_error_count["moeda_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["id_modelo_" + iNumLinha] = "off";
    ajax_read_only["id_empresa_" + iNumLinha] = "off";
    ajax_read_only["fob_" + iNumLinha] = "off";
    ajax_read_only["peso_" + iNumLinha] = "off";
    ajax_read_only["moeda_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["id_modelo_" + iNumLinha] = "on";
    ajax_read_only["id_empresa_" + iNumLinha] = "on";
    ajax_read_only["fob_" + iNumLinha] = "on";
    ajax_read_only["peso_" + iNumLinha] = "on";
    ajax_read_only["moeda_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_modelo_" + iNumLinha] = null;
    ajax_error_list["id_empresa_" + iNumLinha] = null;
    ajax_error_list["fob_" + iNumLinha] = null;
    ajax_error_list["peso_" + iNumLinha] = null;
    ajax_error_list["moeda_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_modelo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_modelo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_modelo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_modelo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_modelo_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["fob_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fob_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fob_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fob_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fob_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["moeda_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["moeda_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["moeda_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["moeda_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["moeda_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_modelo_'])) ? $this->nmgp_cmp_readonly['id_modelo_'] : 'off';
?>
    scAjaxFieldRead("id_modelo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fob_'])) ? $this->nmgp_cmp_readonly['fob_'] : 'off';
?>
    scAjaxFieldRead("fob_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['moeda_'])) ? $this->nmgp_cmp_readonly['moeda_'] : 'off';
?>
    scAjaxFieldRead("moeda_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("id_modelo_" + iSeq, "on");
    scAjaxFieldRead("id_empresa_" + iSeq, "on");
    scAjaxFieldRead("fob_" + iSeq, "on");
    scAjaxFieldRead("peso_" + iSeq, "on");
    scAjaxFieldRead("moeda_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_modelo_" + iRow] || "on" == ajax_error_count["id_empresa_" + iRow] || "on" == ajax_error_count["fob_" + iRow] || "on" == ajax_error_count["peso_" + iRow] || "on" == ajax_error_count["moeda_" + iRow] || "on" == ajax_error_count["data_" + iRow] || "on" == ajax_error_count["obs_" + iRow] || "on" == ajax_error_count["minimo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_modelo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fob_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_peso_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_moeda_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_data_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_obs_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_minimo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_modelo_" + iRow] && "off" == ajax_error_count["id_empresa_" + iRow] && "off" == ajax_error_count["fob_" + iRow] && "off" == ajax_error_count["peso_" + iRow] && "off" == ajax_error_count["moeda_" + iRow] && "off" == ajax_error_count["data_" + iRow] && "off" == ajax_error_count["obs_" + iRow] && "off" == ajax_error_count["minimo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_modelo_" + iRow] = "off";
        ajax_error_count["id_empresa_" + iRow] = "off";
        ajax_error_count["fob_" + iRow] = "off";
        ajax_error_count["peso_" + iRow] = "off";
        ajax_error_count["moeda_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_modelo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fob_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_peso_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_moeda_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_data_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_obs_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_minimo_" + iRow).removeClass("scFormErrorLine");
    }
  }
