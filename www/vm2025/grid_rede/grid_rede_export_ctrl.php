<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rede']['sc_process_barr'] = true;
require_once('../grid_rede/index.php');
unset($_SESSION['scriptcase']['grid_rede']['sc_process_barr']);
$ExportCtrl = new grid_rede_export_control;
$ExportCtrl->Export_barr();

class grid_rede_export_control
{
