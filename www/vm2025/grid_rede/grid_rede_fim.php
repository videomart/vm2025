...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_rede"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_rede"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_rede'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rede']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_rede']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rede']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_rede']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_rede']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_rede']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_rede']['embutida_filho'] as $ind => $sc_init)
          {
