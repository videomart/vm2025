...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["telefone_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["celular_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["whatsapp_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["id_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}

function scEventControl_active(iSeqRow) {
  if (scEventControl_data["contato_" + iSeqRow] && scEventControl_data["contato_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["contato_" + iSeqRow] && scEventControl_data["contato_" + iSeqRow]["change"]) {
    return true;
  }
  ...
  if (scEventControl_data["telefone_" + iSeqRow] && scEventControl_data["telefone_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["telefone_" + iSeqRow] && scEventControl_data["telefone_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["celular_" + iSeqRow] && scEventControl_data["celular_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["celular_" + iSeqRow] && scEventControl_data["celular_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["whatsapp_" + iSeqRow] && scEventControl_data["whatsapp_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["whatsapp_" + iSeqRow] && scEventControl_data["whatsapp_" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_contato_id__onblur('#id_sc_field_id_' + iSeqRow, iSeqRow) })
                                 .bind('change', function() { sc_form_contato_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_contato_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_id_empresa_' + iSeqRow).bind('change', function() { sc_form_contato_id_empresa__onchange(this, iSeqRow) });
  $('#id_sc_field_contato_' + iSeqRow).bind('blur', function() { sc_form_contato_contato__onblur('#id_sc_field_contato_' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_contato_contato__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_contato_contato__onfocus(this, iSeqRow) });
  $('#id_sc_field_telefone_' + iSeqRow).bind('blur', function() { sc_form_contato_telefone__onblur('#id_sc_field_telefone_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_contato_telefone__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_contato_telefone__onfocus(this, iSeqRow) });
  $('#id_sc_field_celular_' + iSeqRow).bind('blur', function() { sc_form_contato_celular__onblur('#id_sc_field_celular_' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_contato_celular__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_contato_celular__onfocus(this, iSeqRow) });
  $('#id_sc_field_whatsapp_' + iSeqRow).bind('blur', function() { sc_form_contato_whatsapp__onblur('#id_sc_field_whatsapp_' + iSeqRow, iSeqRow) })
                                       .bind('change', function() { sc_form_contato_whatsapp__onchange(this, iSeqRow) })
                                       .bind('click', function() { sc_form_contato_whatsapp__onclick(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_contato_whatsapp__onfocus(this, iSeqRow) });
  $('#id_sc_field_cargo_' + iSeqRow).bind('change', function() { sc_form_contato_cargo__onchange(this, iSeqRow) });
  $('#id_sc_field_email_' + iSeqRow).bind('blur', function() { sc_form_contato_email__onblur('#id_sc_field_email_' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_contato_email__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_contato_email__onfocus(this, iSeqRow) });
  $('#id_sc_field_newsletter_' + iSeqRow).bind('change', function() { sc_form_contato_newsletter__onchange(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_contato_id__onblur(oThis, iSeqRow) {
  do_ajax_form_contato_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_contato_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_contato_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_contato_id_empresa__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_contato_contato__onblur(oThis, iSeqRow) {
  do_ajax_form_contato_validate_contato_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_contato_contato__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_contato_contato__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_contato_telefone__onblur(oThis, iSeqRow) {
  do_ajax_form_contato_validate_telefone_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_contato_telefone__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_contato_telefone__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_contato_celular__onblur(oThis, iSeqRow) {
  do_ajax_form_contato_validate_celular_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_contato_celular__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_contato_event_celular__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_contato_celular__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_contato_whatsapp__onblur(oThis, iSeqRow) {
  do_ajax_form_contato_validate_whatsapp_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_contato_whatsapp__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_contato_whatsapp__onclick(oThis, iSeqRow) {
  do_ajax_form_contato_event_whatsapp__onclick(iSeqRow);
}

function sc_form_contato_whatsapp__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_contato_cargo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_contato_email__onblur(oThis, iSeqRow) {
  do_ajax_form_contato_validate_email_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_contato_email__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_contato_email__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_contato_newsletter__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_telefone_(row, status) {
    var fieldId;
}
...
function displayChange_field_whatsapp_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
        $("#id_form_contato_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_contato')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
