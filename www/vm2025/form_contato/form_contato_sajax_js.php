  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contato" == sTestField)
        {
...
?>
  ...
  // ---------- Validate contato_
  function do_ajax_form_contato_validate_contato_(iNumLinha)
  {
    var nomeCampo_contato_ = "contato_" + iNumLinha;
    var var_contato_ = scAjaxGetFieldText(nomeCampo_contato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_validate_contato_(var_contato_, iNumLinha, var_script_case_init, do_ajax_form_contato_validate_contato__cb);
  } // do_ajax_form_contato_validate_contato_

  function do_ajax_form_contato_validate_contato__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contato_validate_contato__cb

  // ---------- Validate email_
  function do_ajax_form_contato_validate_email_(iNumLinha)
  {
    var nomeCampo_email_ = "email_" + iNumLinha;
    var var_email_ = scAjaxGetFieldText(nomeCampo_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_validate_email_(var_email_, iNumLinha, var_script_case_init, do_ajax_form_contato_validate_email__cb);
  } // do_ajax_form_contato_validate_email_

  function do_ajax_form_contato_validate_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contato_validate_email__cb

  // ---------- Validate telefone_
  function do_ajax_form_contato_validate_telefone_(iNumLinha)
  {
    var nomeCampo_telefone_ = "telefone_" + iNumLinha;
    var var_telefone_ = scAjaxGetFieldText(nomeCampo_telefone_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_validate_telefone_(var_telefone_, iNumLinha, var_script_case_init, do_ajax_form_contato_validate_telefone__cb);
  } // do_ajax_form_contato_validate_telefone_

  function do_ajax_form_contato_validate_telefone__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contato_validate_telefone__cb

  // ---------- Validate celular_
  function do_ajax_form_contato_validate_celular_(iNumLinha)
  {
    var nomeCampo_celular_ = "celular_" + iNumLinha;
    var var_celular_ = scAjaxGetFieldText(nomeCampo_celular_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_validate_celular_(var_celular_, iNumLinha, var_script_case_init, do_ajax_form_contato_validate_celular__cb);
  } // do_ajax_form_contato_validate_celular_

  function do_ajax_form_contato_validate_celular__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contato_validate_celular__cb

  // ---------- Validate whatsapp_
  function do_ajax_form_contato_validate_whatsapp_(iNumLinha)
  {
    var nomeCampo_whatsapp_ = "whatsapp_" + iNumLinha;
    var var_whatsapp_ = scAjaxGetFieldText(nomeCampo_whatsapp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_validate_whatsapp_(var_whatsapp_, iNumLinha, var_script_case_init, do_ajax_form_contato_validate_whatsapp__cb);
  } // do_ajax_form_contato_validate_whatsapp_

  function do_ajax_form_contato_validate_whatsapp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "whatsapp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "whatsapp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "whatsapp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "whatsapp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contato_validate_whatsapp__cb

  // ---------- Validate id_
  function do_ajax_form_contato_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_contato_validate_id__cb);
  } // do_ajax_form_contato_validate_id_

  function do_ajax_form_contato_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contato_validate_id__cb

  // ---------- Event onchange celular_
  function do_ajax_form_contato_event_celular__onchange(iSeqForm)
  {
    var var_whatsapp_ = scAjaxGetFieldText("whatsapp_" + iSeqForm);
    var var_celular_ = scAjaxGetFieldText("celular_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_contato_event_celular__onchange(var_whatsapp_, var_celular_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_contato_event_celular__onchange_cb);
  } // do_ajax_form_contato_event_celular__onchange

  function do_ajax_form_contato_event_celular__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contato_event_celular__onchange_cb_after_alert);
  } // do_ajax_form_contato_event_celular__onchange_cb
  function do_ajax_form_contato_event_celular__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contato_event_celular__onchange_cb_after_alert

  // ---------- Event onclick whatsapp_
  function do_ajax_form_contato_event_whatsapp__onclick(iSeqForm)
  {
    var var_whatsapp_ = scAjaxGetFieldText("whatsapp_" + iSeqForm);
    var var_celular_ = scAjaxGetFieldText("celular_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_contato_event_whatsapp__onclick(var_whatsapp_, var_celular_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_contato_event_whatsapp__onclick_cb);
  } // do_ajax_form_contato_event_whatsapp__onclick

  function do_ajax_form_contato_event_whatsapp__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contato_event_whatsapp__onclick_cb_after_alert);
  } // do_ajax_form_contato_event_whatsapp__onclick_cb
  function do_ajax_form_contato_event_whatsapp__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contato_event_whatsapp__onclick_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_contato_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_contato_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contato_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_contato_add_new_line_cb);
  } // do_ajax_form_contato_add_new_line

  function do_ajax_form_contato_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_contato_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_contato_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contato_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_contato_backup_line_cb);
  } // do_ajax_form_contato_backup_line

  function do_ajax_form_contato_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_contato_backup_line_cb

  function do_ajax_form_contato_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_contato_cancel_insert

  function do_ajax_form_contato_cancel_update(iSeqVert)
  {
    do_ajax_form_contato_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_contato_cancel_update

  function do_ajax_form_contato_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_contato_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_contato_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contato_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contato_table_refresh_cb);
  } //  do_ajax_form_contato_table_refresh

  function do_ajax_form_contato_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_contato_table_refresh_cb_after_alert);
  } // do_ajax_form_contato_table_refresh_cb
  function do_ajax_form_contato_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_contato_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_contato_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_contato_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_whatsapp_ = scAjaxGetFieldText("whatsapp_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_contato_submit_form(var_contato_, var_email_, var_telefone_, var_celular_, var_whatsapp_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contato_submit_form_cb);
  } // do_ajax_form_contato_submit_form

  function do_ajax_form_contato_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("whatsapp_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contato_submit_form_cb_after_alert);
  } // do_ajax_form_contato_submit_form_cb
  function do_ajax_form_contato_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contato_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contato_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contato_navigate_form, function() {});
    } else {
      perform_ajax_form_contato_navigate_form();
    }
  }

  function perform_ajax_form_contato_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_contato_cancel_insert(sc_form_contato_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("whatsapp_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contato_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contato_navigate_form_cb);
  } // do_ajax_form_contato_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contato']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contato_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contato_navigate_form_cb_after_alert);
  } // do_ajax_form_contato_navigate_form_cb
  function do_ajax_form_contato_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_contato_navigate_form_cb_after_alert

    function sc_form_contato_get_last_line_number()
    {
    ...
    } //sc_form_contato_get_last_line_number

  function sc_hide_form_contato_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "whatsapp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["contato_" + iNumLinha] = {"label": "CONTATO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_error_list["telefone_" + iNumLinha] = {"label": "TELEFONE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["celular_" + iNumLinha] = {"label": "CELULAR<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["whatsapp_" + iNumLinha] = {"label": "WHATSAPP<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["whatsapp_"][iNumLinha] = "whatsapp_" + iNumLinha;
    ...
    ajax_field_id["whatsapp_" + iNumLinha] = new Array("hidden_field_label_whatsapp_", "hidden_field_data_whatsapp_" + iNumLinha);
    ...
    ajax_error_count["whatsapp_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["telefone_" + iNumLinha] = "off";
    ajax_read_only["celular_" + iNumLinha] = "off";
    ajax_read_only["whatsapp_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["whatsapp_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["whatsapp_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["whatsapp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["whatsapp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["whatsapp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["whatsapp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["whatsapp_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['telefone_'])) ? $this->nmgp_cmp_readonly['telefone_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['whatsapp_'])) ? $this->nmgp_cmp_readonly['whatsapp_'] : 'off';
?>
    scAjaxFieldRead("whatsapp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("whatsapp_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["contato_" + iRow] || "on" == ajax_error_count["email_" + iRow] || "on" == ajax_error_count["telefone_" + iRow] || "on" == ajax_error_count["celular_" + iRow] || "on" == ajax_error_count["whatsapp_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      $("#hidden_field_data_whatsapp_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["contato_" + iRow] && "off" == ajax_error_count["email_" + iRow] && "off" == ajax_error_count["telefone_" + iRow] && "off" == ajax_error_count["celular_" + iRow] && "off" == ajax_error_count["whatsapp_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["whatsapp_" + iRow] = "off";
      ...
      $("#hidden_field_data_whatsapp_" + iRow).removeClass("scFormErrorLine");
