...
class grid_analise_modelos_resumo
{
   ...
   var $array_total_proposta_natureza;
   var $array_total_proposta_data;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_proposta_natureza   = array();
      $this->array_total_proposta_data       = array();
   ...
   if ($this->Ini->Embutida_iframe) {
        ...
        $this->SC_APP_info = [
            ...
            'dimension' => [
                'proposta.natureza' => [
                    'label' => "Natureza",
                    'datatype' => 'varchar',
                    'lowercase' => 'proposta_natureza',
                    'summary_values_array' => 'array_total_proposta_natureza',
                    'summary_line_values_array' => 'array_line_proposta_natureza',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'proposta_natureza',
                ...
                'proposta.data' => [
                    'label' => "Data",
                    'datatype' => 'date',
                    'lowercase' => 'proposta_data',
                    'summary_values_array' => 'array_total_proposta_data',
                    'summary_line_values_array' => 'array_line_proposta_data',
                    'order_by_index' => self::TOTAL_ARRAY_LABEL_INDEX,
                    'order_by_direction' => 'asc',
                    'order_by_direction_default' => 'asc',
                    'is_rating' => '' != '',
                    ...
                    'align_css_class' => '',
                    'show_link' => true,
                    'link_field_var_name' => 'proposta_data',
                    'link_protect_string' => '@aspass@',
                    'has_order' => false,
                    'limit_chart_items' => '0',
                ],
            ...
            'dimension_by_lowercase' => [
                'proposta_natureza' => 'proposta.natureza',
            ...
            'options' => [
                ...
                'order_initial_rule' => '',
                'order_metric_apply_to_dimensions' => ['proposta.natureza', 'proposta.data', 'itemproposta.modelo'],
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_group_by'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_order'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_x_axys'] = [];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_y_axys'] = [];

        $dimensionCount = 0;

        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['x'] as $dimensionName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_group_by'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_x_axys'] [] = $dimensionCount;
        ...
        foreach ($this->SC_APP_info['group_by'] ['dimension'] ['y'] as $dimensionName) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_order'] [] = self::TOTAL_ARRAY_LABEL_INDEX == $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] ? 'label' : 'value';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_order_direction'] [] = $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_y_axys'] [] = $dimensionCount;

            $dimensionCount++;
        }

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['dimension_order'] = [];
        foreach ($this->SC_APP_info['dimension'] as $dimensionName => $dimensionInfo) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['dimension_order'] [$dimensionName] = $dimensionInfo['order_by_direction'];
        }
    }

    function info_saveSessionDefaultInfo()
    {
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['last_displayed_group_by'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['last_displayed_group_by'] = 'groupby_1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        if ('groupby_1' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['last_displayed_group_by']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['last_displayed_group_by'] = 'groupby_1';
            $this->SC_APP_info['options'] ['starting_group_by'] = true;
        }
        ...
        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_using'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_using'] = false;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_name'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_rule'] = '';
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_parameters'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_length'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_length'] = $this->SC_APP_data['pagination'] ['length'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_first'] = $this->SC_APP_data['pagination'] ['first'];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_info'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['heatmap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['treemap_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chord_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['sankey_info'] = [];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['sunburst_info'] = [];
        }

        if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_tabular'])) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_tabular'] = $this->SC_APP_info['options'] ['tabular'];
        }
        ...
        if ($this->SC_APP_info['options'] ['starting_group_by']) {
            if ('' != $this->SC_APP_info['options'] ['order_initial_metric'] && '' != $this->SC_APP_info['options'] ['order_initial_rule'] && !$this->aux_hasXAxysDimensionField()) {
                ...
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_name'] = $this->SC_APP_info['options'] ['order_initial_metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_rule'] = $this->SC_APP_info['options'] ['order_initial_rule'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_parameters'] = [];
            }

            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['has_limit_chart_items'] = $this->SC_APP_info['options'] ['has_limit_chart_items'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['limit_chart_items'] = '0';
        }
    }
    ...
    function info_loadSessionInfo()
    {
        ...
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_group_by'] as $dimensionIndex => $dimensionLabel) {
            $dimensionName = $this->SC_APP_info['group_by'] ['dimension'] ['order'] [$dimensionIndex];

            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_index'] = 'label' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_order'] [$dimensionIndex] ? self::TOTAL_ARRAY_LABEL_INDEX : self::TOTAL_ARRAY_VALUE_INDEX;

            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_x_axys'])) {
                $this->SC_APP_info['group_by'] ['dimension'] ['x'] [] = $dimensionName;
            }
            if (in_array($dimensionIndex, $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_y_axys'])) {
        ...
        foreach ($this->SC_APP_info['metric_by_index'] as $metricIndex => $metricName) {
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex])) {
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex] = ['display' => false];
            }
        }
        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summarizing_fields_order'] ['groupby_1'] as $metricIndex) {
            if ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summarizing_fields_display'] ['groupby_1'] [$metricIndex] ['display']) {
                $this->SC_APP_info['group_by'] ['metric'] [] = $this->SC_APP_info['metric_by_index'] [$metricIndex];
            }
        }

        $this->SC_APP_info['options'] ['tabular'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pivot_tabular'];

        foreach ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['dimension_order'] as $dimensionName => $dimensionOrder) {
            $this->SC_APP_info['dimension'] [$dimensionName] ['order_by_direction'] = $dimensionOrder;
        }

        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['contr_array_resumo']) && 'NAO' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['contr_array_resumo']) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_first'] = 1;
        }
        $this->SC_APP_data['pagination'] ['length'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_length'];
        $this->SC_APP_data['pagination'] ['first'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_first'];

        $this->SC_APP_data['metric_order'] ['using'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_using'];
        $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_name'];
        $this->SC_APP_data['metric_order'] ['rule'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_rule'];
        $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_parameters'];
    }
    ...
    function info_changeSort_dimension()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['dimension_order'] [$sortDimension] = $sortRule;
    ...
    function info_changeSort_metric()
    {
        ...
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] [$sortMetricMd5])) {
            if ('' != $sortRule) {
                $this->SC_APP_data['metric_order'] ['using'] = true;
                $this->SC_APP_data['metric_order'] ['name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $this->SC_APP_data['metric_order'] ['rule'] = $sortRule;
                $this->SC_APP_data['metric_order'] ['parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];

                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_using'] = true;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_name'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] [$sortMetricMd5] ['metric'];
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_rule'] = $sortRule;
                $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_parameters'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] [$sortMetricMd5] ['parameters'];
            } else {
                $this->info_clearSort_metric();
            }
        }
    ...
    function info_changePagination_length()
    {
        if ('all' == strtolower($this->SC_APP_data['process'] ['parameters'] ['length'])) {
            $paginationLength = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_record_count'];
        } else {
            $paginationLength = (int)$this->SC_APP_data['process'] ['parameters'] ['length'];
        }

        $this->SC_APP_data['pagination'] ['length'] = $paginationLength;
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_length'] = $paginationLength;
    ...
    function info_changePagination_page()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_first'] = $paginationFirst;
    }
    ...
    function info_changePagination_record()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_first'] = $paginationRecord;
    }
    ...
    function info_setPagination()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['pagination_record_count'] = $this->SC_APP_data['pagination'] ['record_count'];
    ...
    function info_setComparisonLabels()
    {
        if ($this->aux_isComparison()) {
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_ORIGINAL] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['cond_pesq_compara'] [self::GROUPBY_ORIGINAL];
            $this->SC_APP_data['comparison_labels'] [self::GROUPBY_COMPARISON] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['cond_pesq_compara'] [self::GROUPBY_COMPARISON];
    ...
    {
        return isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['using_summary_cache']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['using_summary_cache'];
    }

    function info_saveSummaryCache()
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['using_summary_cache'] = true;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache'] = [
    ...
    {
        $this->SC_APP_data['dimension_value_labels'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache'] ['dimension_value_labels'];
        $this->SC_APP_data['ordered_x_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache'] ['ordered_x_axys'];
        $this->SC_APP_data['ordered_y_axys'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache'] ['ordered_y_axys'];
        $this->SC_APP_data['ordered_x_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache'] ['ordered_x_matrix'];
        $this->SC_APP_data['ordered_y_matrix'] = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache'] ['ordered_y_matrix'];
    }

    function info_deleteSummaryCache()
    {
        if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['using_summary_cache'])) {
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['using_summary_cache']);
            unset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summary_cache']);
        }
    }
    ...
    function info_exportData()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['export_data'] = $exportData;

        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['export_info'] = [
            'dimension_count' => [
...
SCEOT;
    ...
    function display_js_chart()
    {
        ...
        $ajaxUrl = "{$this->Ini->path_link}grid_analise_modelos/index.php";
...
SCEOT;
    ...
    let windowName = "grid_analise_modelos_chart_window" + (Math.floor(Math.random() * 100) + 1);
...
SCEOT;
    ...
    function display_pdf_charts()
    {
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_level']) {
                continue;
            }
...
SCEOT;
        ...
        foreach ($this->SC_APP_data['chart_md5_list'] as $chartInfo) {
            if ($chartInfo['info_type'] != $chartInfoType) {
                continue;
            } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_level']) && '' != $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_level'] && $chartInfo['chart_level'] > $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_level']) {
                continue;
            }

            if ($this->progress_fp) {
                grid_analise_modelos_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $chartLang . " " . $chartCount . "/" . $chartTotal . "...\n", $this->Ini->Nm_lang, true);
...
SCEOT;
        ...
        if ($chartFP) {
            ...
            grid_analise_modelos_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $pdfGenerateLang . "...\n", $this->Ini->Nm_lang);
...
SCEOT;
    ...
    function aux_addChartAppCharts()
    {
        ...
        if (1 < count($this->SC_APP_info['group_by'] ['metric'])) {
            ...
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['graf_opc_atual'] = 1;
        }
        ...
        foreach ($this->SC_APP_data['ordered_y_matrix'] as $rowDimensionInfo) {
            ...
            if (!isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summarizing_drill_down']) || !$_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['summarizing_drill_down']) {
                continue;
            }
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_md5_list'] = $this->SC_APP_data['chart_md5_list'];
    ...
    function aux_addChartAppGrandTotalChart()
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_info'] [$chartMd5] = $chartInfo;
...
SCEOT;
    ...
    function aux_addOrderToMetric($metricLabel, $metricName, $parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['metric_order_info'] [$metricOrderMd5] = $orderInfo;
...
SCEOT;
    ...
    function aux_createLinkInfo($parameters)
    {
        ...
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['LigR_Md5'] [$linkMd5] = $linkInfo;

        return '@SC_par@' . NM_encode_input($this->Ini->sc_page) . '@SC_par@grid_analise_modelos@SC_par@' . $linkMd5;
    }
...
SCEOT;
    ...
    function aux_displayPdfCharts()
    {
        if (!$this->aux_isPdf()) {
            return false;
        } elseif (isset($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['skip_charts']) && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['skip_charts']) {
            return false;
    ...
    function aux_generatePhantomImage($chartMd5)
    {
        ...
        $imageUrlDir = "{$_SESSION['scriptcase'] ['grid_analise_modelos'] ['glo_nm_path_imag_temp']}/";
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_analise_modelos'] ['glo_nm_path_imag_temp']}/sc_pjs_js_{$phantomId}.js", $jsCode);
    }
...
SCEOT;
        ...
        @file_put_contents("{$this->Ini->root}{$_SESSION['scriptcase'] ['grid_analise_modelos'] ['glo_nm_path_imag_temp']}/sc_pjs_php_{$phantomId}.html", $htmlCode);
    }
    ...
    {
        switch ($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['cfg_graf'] ['graf_tipo']) {
            case 'Chord':
                return 'chord_info';
            case 'Heatmap':
                return 'heatmap_info';
    ...
    {
        if ('doc_word' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('doc_word_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('csv' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('csv_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('json' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('json_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('xls' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('xls_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        }

        if ('xml' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('xml_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        }

        if ('rtf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        } elseif ('rtf_res' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        }
    ...
    function aux_isPdf()
    {
        if ('pdf' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        }
    ...
    {
        if ('print' == $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['opcao']) {
            return true;
        }
    ...
    {
        return $this->aux_isPdf() && $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['skip_summary'];
    }
    ...
    {
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['comb_table_def'] = [
            'field' => [],
            'label' => [],
            'summ' => [],
        ];
        $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['comb_table_data'] = [];

        foreach ($this->SC_APP_info['group_by'] ['metric'] as $i => $metricName) {
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['comb_table_def'] ['field'] [] = $metricName;
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['comb_table_def'] ['label'] [] = $this->SC_APP_info['metric'] [$metricName] ['label'];
            $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['comb_table_def'] ['summ'] [] = $i;
        }

        $this->aux_storeSummaryTableInfo_recursive($_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['comb_table_data'], $this->SC_APP_data['ordered_y_axys'], 0, []);
    }
...
SCEOT;
    ...
    function generateChartImages()
    {
        ...
        $chartInfoType = $this->aux_getChartInfoType();
        $chartList = $_SESSION['sc_session'] [$this->Ini->sc_page] ['grid_analise_modelos'] ['chart_md5_list'];
        $chartFiles = array();

        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['phantomjs_export_process'] = true;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_step']     = 'image';
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_count']    = 0;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_total']    = 0;
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_total']++;
            }
        }
        ...
        foreach ($chartList as $chartInfo) {
            ...
            if ($chartInfo['info_type'] == $chartInfoType) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['phantomjs_export_file'] = '';
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_count']++;
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['phantomjs_export_process'] = false;
    ...
    function zipChartImages($password = '')
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_step'] = 'zip';

        $this->writeProgressFile();

        $zipFile = $this->zipFileList($chartImages, $password);

        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_step'] = 'end';
    ...
    function zipFileList($fileList, $password = '') {
        $tempDir = $this->Ini->root . $_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_imag_temp'] . '/';
    ...
    function writeProgressFile() {
        if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_total']}###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_step']) {
            $progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_total'] + 1));
            $content = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

            $content = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
        } elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_step']) {
            $content = "ok###100";
        } else {
            $content = "init###0";
        }

        $f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['export_progress_file']}", 'w');
        fwrite($f, $content);
        fclose($f);
    }
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['orig_pesq'] = "resumo";
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo'] = "";
      }
      $this->inicializa_vars();
        $this->info_initializeSummary();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_array_resumo'] == "OK")
      {
            if ($this->aux_hasXAxysDimensionField()) {
                $this->array_line_proposta_natureza = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total_line']['proposta_natureza'];
                $this->array_line_proposta_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total_line']['proposta_data'];
                $this->array_line_itemproposta_modelo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total_line']['itemproposta_modelo'];
            }
          $this->array_total_proposta_natureza = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total']['proposta_natureza'];
          $this->array_total_proposta_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total']['proposta_data'];
          $this->array_total_itemproposta_modelo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total']['itemproposta_modelo'];
          $this->array_total_geral = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral_res'];
          $this->NM_res_sem_reg    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_sem_reg'];
          $this->Tem_Res_Compara   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_compara'];
      }
      else
      {
            $this->info_deleteSummaryCache();
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_force_fiels_gb'] = $forceFields;
                $this->array_total_proposta_natureza = array();
                $this->array_total_proposta_data = array();
                $this->array_total_itemproposta_modelo = array();
                $this->totaliza();
                ...
                $this->array_line_proposta_natureza = $this->array_total_proposta_natureza;
                $this->array_line_proposta_data = $this->array_total_proposta_data;
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_force_fiels_gb'] = $forceFields;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_clear_total'] = true;
            }
          $this->array_total_proposta_natureza = array();
          $this->array_total_proposta_data = array();
          $this->array_total_itemproposta_modelo = array();
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total']['proposta_natureza'] = $this->array_total_proposta_natureza;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total']['proposta_data'] = $this->array_total_proposta_data;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total']['itemproposta_modelo'] = $this->array_total_itemproposta_modelo;
            if ($this->aux_hasXAxysDimensionField() && $this->SC_APP_info['options'] ['display_total_column']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total_line']['proposta_natureza'] = $this->array_line_proposta_natureza;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total_line']['proposta_data'] = $this->array_line_proposta_data;
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total_line']['itemproposta_modelo'] = $this->array_line_itemproposta_modelo;
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_force_fiels_gb']);
            }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_array_resumo'] = "OK";
      }
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          if ($this->aux_useNewSummary()) {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['json_use_label'])
       {
          $Lab_proposta_natureza = "proposta.natureza";
          $Lab_proposta_data = "proposta.data";
          $Lab_itemproposta_modelo = "itemproposta.modelo";
       }
       else
       {
       $Lab_proposta_natureza = "Natureza";
       $Lab_proposta_data = "Data";
       $Lab_itemproposta_modelo = "Modelo";
       }
       $this->comp_field = array(
           $Lab_proposta_natureza,
           $Lab_proposta_data,
           $Lab_itemproposta_modelo,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['itemproposta_modelo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['itemproposta_modelo'] = "Modelo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_data']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_data'] = "Data"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_natureza']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_natureza'] = "Natureza"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_atencao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_atencao'] = "Atencao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_cod_vend']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_cod_vend'] = "Cod Vend"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_ordem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_ordem'] = "Ordem"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['itemproposta_descricao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['itemproposta_descricao'] = "Descricao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['empresa_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['empresa_email'] = "Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['empresa_telefone']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['empresa_telefone'] = "Telefone"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['labels']['proposta_status'] = "Status"; 
       }
       //-----
       $this->comp_field_nm = array(
           'proposta_natureza' => 0,
           'proposta_data' => 1,
           'itemproposta_modelo' => 2,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_order']['groupby_1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_order']['groupby_1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_order']['groupby_1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['summarizing_fields_display']['groupby_1'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_proposta_natureza as $i_proposta_natureza => $d_proposta_natureza) {
           if (!isset($i_proposta_natureza, $this->comp_label[0]) || !in_array($i_proposta_natureza, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_proposta_natureza[3] ] = $d_proposta_natureza[2];
               $this->comp_label[0][ $d_proposta_natureza[3] ] = $d_proposta_natureza[2];
           }
           foreach ($this->array_total_proposta_data[$i_proposta_natureza] as $i_proposta_data => $d_proposta_data) {
               if (!isset($i_proposta_data, $this->comp_label[1][ $d_proposta_natureza[3] ]) || !in_array($i_proposta_data, $this->comp_label[1][ $d_proposta_natureza[3] ], true)) {
                   $this->comp_index[1][ $d_proposta_data[3] ] = $d_proposta_data[2];
                   $this->comp_label[1][ $d_proposta_natureza[3] ][ $d_proposta_data[3] ] = $d_proposta_data[2];
               }
               foreach ($this->array_total_itemproposta_modelo[$i_proposta_natureza][$i_proposta_data] as $i_itemproposta_modelo => $d_itemproposta_modelo) {
                   if (!isset($i_itemproposta_modelo, $this->comp_label[2][ $d_proposta_natureza[3] ][ $d_proposta_data[3] ]) || !in_array($i_itemproposta_modelo, $this->comp_label[2][ $d_proposta_natureza[3] ][ $d_proposta_data[3] ], true)) {
                       $this->comp_index[2][ $d_itemproposta_modelo[3] ] = $d_itemproposta_modelo[2];
                       $this->comp_label[2][ $d_proposta_natureza[3] ][ $d_proposta_data[3] ][ $d_itemproposta_modelo[3] ] = $d_itemproposta_modelo[2];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'proposta_natureza', 'prot' => '@aspass@'),
           array('name' => 'proposta_data', 'prot' => '@aspass@'),
           array('name' => 'itemproposta_modelo', 'prot' => '@aspass@'),
       );
       ...
       //-----
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_tabular_label'];
     ...
     if (isset($this->comp_label[0])) {
       foreach ($this->comp_label[0] as $i_proposta_natureza => $l_proposta_natureza) {
           if (isset($this->array_total_proposta_natureza[$i_proposta_natureza])) {
               $this->comp_group[$i_proposta_natureza] = array();
           }
           foreach ($this->comp_label[1][$i_proposta_natureza] as $i_proposta_data => $l_proposta_data) {
               if (isset($this->array_total_proposta_data[$i_proposta_natureza][$i_proposta_data])) {
                   $this->comp_group[$i_proposta_natureza][$i_proposta_data] = array();
               }
               foreach ($this->comp_label[2][$i_proposta_natureza][$i_proposta_data] as $i_itemproposta_modelo => $l_itemproposta_modelo) {
                   if (isset($this->array_total_itemproposta_modelo[$i_proposta_natureza][$i_proposta_data][$i_itemproposta_modelo])) {
                       $this->comp_group[$i_proposta_natureza][$i_proposta_data][$i_itemproposta_modelo] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_proposta_natureza;
       }
       elseif (1 == $level) {
           $return = $this->array_total_proposta_data;
       }
       elseif (2 == $level) {
           $return = $this->array_total_itemproposta_modelo;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_analise_modelos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'proposta.natureza',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_proposta_natureza)),
           ...
           '1|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'proposta.data',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_proposta_data)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['anlt_table_def']  = array();
       ...
       $this->filterChartsByGroupbyLevel();
        ...
        function filterChartsByGroupbyLevel() {
                ...
                if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['chart_level']) {
                        $applyFilter = true;
                }
                elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
                        $applyFilter = true;
                        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['chart_level'] = $_POST['chart_level'];
                }
                ...
                $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_orig'];

                if ($applyFilter) {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_charts'] as $chartIndex => $chartData) {
                                ...
                                if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['chart_level']) {
                                        unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_charts'][$chartIndex]);
                                }
                        }
                }

                $this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_charts'];
        }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_analise_modelos_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_analise_modelos_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialOrderFA = '';
                       ...
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
          require_once($this->Ini->path_aplicacao . "grid_analise_modelos_total.class.php"); 
      }
      ...
      $this->Total   = new grid_analise_modelos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['LigR_Md5'] = array();
   }
   ...
   function totaliza($tipo='')
   {
      ...
      $save_where_pesq = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq'];
      $where_compara   = "";
      $this->Total->Calc_resumo_groupby_1("res", $this->NM_export, 1, $tipo);
      if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_compara'])    && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_compara'])) 
       || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_dyn_compara'])     && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_dyn_compara'])) )
       {
          $tmp_cmd = "";
          ...
          if  (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_compara']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_compara'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_compara'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_compara'] . ")"; 
              }
          }
          elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_filtro'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_filtro'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_fast'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_fast'] . ")";
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_fast'] . ")";
              }
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search_2']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search_2'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search_2'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search_2'] . ")"; 
               }
          }
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search'])) {
              if (!empty($tmp_cmd)) {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search'] . ")"; 
              }
              else {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_resumo_search'] . ")"; 
               }
          }
          $where_compara = $tmp_cmd;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq'] = $tmp_cmd;
          $this->Total->Calc_resumo_groupby_1("res", $this->NM_export, 2, $tipo);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq'] = $save_where_pesq;
          $this->Tem_Res_Compara = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_compara'] = $this->Tem_Res_Compara;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total'][$cmp_gb];
      }
      if (is_array($this->array_total_proposta_natureza)) {
          ksort($this->array_total_proposta_natureza);
      }
      if (is_array($this->array_total_proposta_data)) {
          ksort($this->array_total_proposta_data);
      }
      if (is_array($this->array_total_itemproposta_modelo)) {
          ksort($this->array_total_itemproposta_modelo);
      }
      $this->NM_res_sem_reg = true;
      $Sv_tot_ger  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'];
      $Sv_flag_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_total_geral'];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_total_geral'] = "N";
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_Ind_Groupby'];
      $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['Res_search_metric_use'])) ? true : false;
      $this->Total->$Gb_geral($tp_tot, $this->NM_export);
      $this->array_total_geral = array();
      $this->array_total_geral[1][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1] > 0) {
          $this->NM_res_sem_reg = false;
      }
      if ($this->Tem_Res_Compara) {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq'] = $where_compara;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_total_geral'] = "N";
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_Ind_Groupby'];
          $tp_tot = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['Res_search_metric_use']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['Res_search_metric_use'])) ? true : false;
          $this->Total->$Gb_geral($tp_tot, $this->NM_export);
          $this->array_total_geral[2][0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1]) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1] > 0) {
              $this->NM_res_sem_reg = false;
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral_res']     = $this->array_total_geral;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral']         = $Sv_tot_ger;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_total_geral'] = $Sv_flag_tot;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['res_sem_reg']       = $this->NM_res_sem_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq']        = $save_where_pesq;
      if ("out" == $this->NM_tipo)
      {
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_Ind_Groupby'];
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE html>\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("    </style>\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_analise_modelos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_analise_modelos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_analise_modelos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['num_css'] . '.css');
     ...
     $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
     $nm_saida->saida(" <style type=\"text/css\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      $nm_saida->saida("<TD style=\"padding: 0px; vertical-align: initial\" class='sc-mobile-inner-control'>\r\n");
       $tableHeight = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['dashboard_info']['under_dashboard'])
       {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=pt_br&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_analise_modelos&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         $this->nm_btn_exist['chart_conf'][] = "Rgraf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_config_graf_flash.php?nome_apl=grid_analise_modelos&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_analise_modelos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=pt_br&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_analise_modelos&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_xls_conf('xls', 'grid,resume,chart', '','N');", "nm_gp_xls_conf('xls', 'grid,resume,chart', '','N');", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "nm_gp_xml_conf('attribute', 'N', 'grid,resume,chart', '');", "nm_gp_xml_conf('attribute', 'N', 'grid,resume,chart', '');", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "nm_gp_csv_conf('1','1','1','N','grid,resume,chart','');", "nm_gp_csv_conf('1','1','1','N','grid,resume,chart','');", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_analise_modelos_config_pivot.php?nome_apl=grid_analise_modelos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("          document.Fres_pdf.action = \"grid_analise_modelos_iframe.php\";\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_analise_modelos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_analise_modelos/grid_analise_modelos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $itemproposta_modelo = (isset($Busca_temp['itemproposta_modelo'])) ? $Busca_temp['itemproposta_modelo'] : ""; 
          $tmp_pos = (is_string($itemproposta_modelo)) ? strpos($itemproposta_modelo, "##@@") : false;
          if ($tmp_pos !== false && !is_array($itemproposta_modelo))
          {
              $itemproposta_modelo = substr($itemproposta_modelo, 0, $tmp_pos);
          }
   ...
   //---- 
   function adiciona_registro($quebra_proposta_natureza, $quebra_proposta_data, $quebra_itemproposta_modelo, $quebra_proposta_natureza_orig, $quebra_proposta_data_orig, $quebra_itemproposta_modelo_orig)
   {
      //----- Natureza
      if (!isset($this->array_total_proposta_natureza[$quebra_proposta_natureza_orig]))
      {
         $this->array_total_proposta_natureza[$quebra_proposta_natureza_orig][0] = 1;
         $this->array_total_proposta_natureza[$quebra_proposta_natureza_orig][1] = 1;
         $this->array_total_proposta_natureza[$quebra_proposta_natureza_orig][2] = $quebra_proposta_natureza;
         $this->array_total_proposta_natureza[$quebra_proposta_natureza_orig][3] = $quebra_proposta_natureza_orig;
      }
      else
      {
         $this->array_total_proposta_natureza[$quebra_proposta_natureza_orig][0]++;
         $this->array_total_proposta_natureza[$quebra_proposta_natureza_orig][2]++;
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYY'] . "
      if (!isset($this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig]))
      {
         $this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][0] = 1;
         $this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][1] = 1;
         $this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][2] = $quebra_proposta_data;
         $this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][3] = $quebra_proposta_data_orig;
      }
      else
      {
         $this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][0]++;
         $this->array_total_proposta_data[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][2]++;
      }
      //----- Modelo
      if (!isset($this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig]))
      {
         $this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig][0] = 1;
         $this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig][1] = 1;
         $this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig][2] = $quebra_itemproposta_modelo;
         $this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig][3] = $quebra_itemproposta_modelo_orig;
      }
      else
      {
         $this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig][0]++;
         $this->array_total_itemproposta_modelo[$quebra_proposta_natureza_orig][$quebra_proposta_data_orig][$quebra_itemproposta_modelo_orig][2]++;
      }
   }
   ...
   {
      if (isset($this->array_total_proposta_natureza))
      {
         $arr_temp_0 = $this->array_total_proposta_natureza;
         foreach ($this->array_total_proposta_natureza as $campo_proposta_natureza => $dados_proposta_natureza)
         {
            $ind_exists  = "";
            $ind_missing = "";
            if (!isset($this->array_total_proposta_natureza[$campo_proposta_natureza][1])) {
                $ind_exists  = 2;
                $ind_missing = 1;
            }
            if (!isset($this->array_total_proposta_natureza[$campo_proposta_natureza][2])) {
                $ind_exists  = 1;
                $ind_missing = 2;
            }
            if (!empty($ind_missing)) {
                $arr_temp_0[$campo_proposta_natureza][$ind_missing][0] = 0;
                $arr_temp_0[$campo_proposta_natureza][$ind_missing][1] = 0;
                $arr_temp_0[$campo_proposta_natureza][$ind_missing][self::TOTAL_ARRAY_LABEL_INDEX] = $dados_proposta_natureza[$ind_exists][self::TOTAL_ARRAY_LABEL_INDEX];
                $arr_temp_0[$campo_proposta_natureza][$ind_missing][self::TOTAL_ARRAY_VALUE_INDEX] = $dados_proposta_natureza[$ind_exists][self::TOTAL_ARRAY_VALUE_INDEX];
            }
            ksort($arr_temp_0[$campo_proposta_natureza]);
            $this->array_total_proposta_natureza[$campo_proposta_natureza] = $arr_temp_0[$campo_proposta_natureza];
            if (isset($this->array_total_proposta_data[$campo_proposta_natureza]))
            {
               $arr_temp_1 = $this->array_total_proposta_data[$campo_proposta_natureza];
               foreach ($this->array_total_proposta_data[$campo_proposta_natureza] as $campo_proposta_data => $dados_proposta_data)
               {
                  $ind_exists  = "";
                  $ind_missing = "";
                  if (!isset($this->array_total_proposta_data[$campo_proposta_natureza][$campo_proposta_data][1])) {
                      $ind_exists  = 2;
                      $ind_missing = 1;
                  }
                  if (!isset($this->array_total_proposta_data[$campo_proposta_natureza][$campo_proposta_data][2])) {
                      $ind_exists  = 1;
                      $ind_missing = 2;
                  }
                  if (!empty($ind_missing)) {
                      $arr_temp_1[$campo_proposta_data][$ind_missing][0] = 0;
                      $arr_temp_1[$campo_proposta_data][$ind_missing][1] = 0;
                      $arr_temp_1[$campo_proposta_data][$ind_missing][self::TOTAL_ARRAY_LABEL_INDEX] = $dados_proposta_data[$ind_exists][self::TOTAL_ARRAY_LABEL_INDEX];
                      $arr_temp_1[$campo_proposta_data][$ind_missing][self::TOTAL_ARRAY_VALUE_INDEX] = $dados_proposta_data[$ind_exists][self::TOTAL_ARRAY_VALUE_INDEX];
                  }
                  ksort($arr_temp_1[$campo_proposta_data]);
                  $this->array_total_proposta_data[$campo_proposta_natureza][$campo_proposta_data] = $arr_temp_1[$campo_proposta_data];
                  if (isset($this->array_total_itemproposta_modelo[$campo_proposta_natureza][$campo_proposta_data]))
                  {
                     $arr_temp_2 = $this->array_total_itemproposta_modelo[$campo_proposta_natureza][$campo_proposta_data];
                     foreach ($this->array_total_itemproposta_modelo[$campo_proposta_natureza][$campo_proposta_data] as $campo_itemproposta_modelo => $dados_itemproposta_modelo)
                     {
                        $ind_exists  = "";
                        $ind_missing = "";
                        if (!isset($this->array_total_itemproposta_modelo[$campo_proposta_natureza][$campo_proposta_data][$campo_itemproposta_modelo][1])) {
                            $ind_exists  = 2;
                            $ind_missing = 1;
                        }
                        if (!isset($this->array_total_itemproposta_modelo[$campo_proposta_natureza][$campo_proposta_data][$campo_itemproposta_modelo][2])) {
                            $ind_exists  = 1;
                            $ind_missing = 2;
                        }
                        if (!empty($ind_missing)) {
                            $arr_temp_2[$campo_itemproposta_modelo][$ind_missing][0] = 0;
                            $arr_temp_2[$campo_itemproposta_modelo][$ind_missing][1] = 0;
                            $arr_temp_2[$campo_itemproposta_modelo][$ind_missing][self::TOTAL_ARRAY_LABEL_INDEX] = $dados_itemproposta_modelo[$ind_exists][self::TOTAL_ARRAY_LABEL_INDEX];
                            $arr_temp_2[$campo_itemproposta_modelo][$ind_missing][self::TOTAL_ARRAY_VALUE_INDEX] = $dados_itemproposta_modelo[$ind_exists][self::TOTAL_ARRAY_VALUE_INDEX];
                        }
                        ksort($arr_temp_2[$campo_itemproposta_modelo]);
                        $this->array_total_itemproposta_modelo[$campo_proposta_natureza][$campo_proposta_data][$campo_itemproposta_modelo] = $arr_temp_2[$campo_itemproposta_modelo];
                     } 
                  } 
               } 
            } 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->itemproposta_modelo = $Busca_temp['itemproposta_modelo']; 
       $this->itemproposta_modelo = (isset($Busca_temp['itemproposta_modelo'])) ? $Busca_temp['itemproposta_modelo'] : ""; 
       $tmp_pos = (is_string($this->itemproposta_modelo)) ? strpos($this->itemproposta_modelo, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->itemproposta_modelo))
       {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('groupby_1', 'proposta_natureza');
     $campos_order = $this->Ini->Get_date_order_groupby("proposta.natureza", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('groupby_1', 'proposta_data');
     $campos_order = $this->Ini->Get_date_order_groupby("proposta.data", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('groupby_1', 'itemproposta_modelo');
     $campos_order = $this->Ini->Get_date_order_groupby("itemproposta.modelo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->itemproposta_modelo = $rs_res->fields[0] ;  
            $this->proposta_data = $rs_res->fields[1] ;  
            $this->proposta_natureza = $rs_res->fields[2] ;  
            $this->proposta_cliente = $rs_res->fields[3] ;  
            $this->proposta_atencao = $rs_res->fields[4] ;  
            $this->proposta_cod_vend = $rs_res->fields[5] ;  
            $this->proposta_total = $rs_res->fields[6] ;  
            $this->proposta_natureza_orig = $this->proposta_natureza;
            ...
            $this->proposta_data_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->proposta_data, $Format_tst);
            $this->proposta_data = $this->Ini->GB_date_format($TP_Time . $this->proposta_data, $Format_tst, $Prefix_dat);
            $this->itemproposta_modelo_orig = $this->itemproposta_modelo;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->proposta_natureza, $this->proposta_data, $this->itemproposta_modelo, $this->proposta_natureza_orig,  $this->proposta_data_orig,  $this->itemproposta_modelo_orig);
            }
   }
//
