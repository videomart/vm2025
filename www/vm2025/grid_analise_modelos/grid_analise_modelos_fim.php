...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_analise_modelos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_analise_modelos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_analise_modelos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_analise_modelos']['embutida_filho'] as $ind => $sc_init)
          {
