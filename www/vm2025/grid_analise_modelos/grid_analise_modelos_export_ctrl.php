<?php
@session_start() ;
$_SESSION['scriptcase']['grid_analise_modelos']['sc_process_barr'] = true;
require_once('../grid_analise_modelos/index.php');
unset($_SESSION['scriptcase']['grid_analise_modelos']['sc_process_barr']);
$ExportCtrl = new grid_analise_modelos_export_control;
$ExportCtrl->Export_barr();

class grid_analise_modelos_export_control
{
