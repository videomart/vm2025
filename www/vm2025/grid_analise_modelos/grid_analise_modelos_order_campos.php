<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_analise_modelos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_analise_modelos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["itemproposta_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["itemproposta_modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["itemproposta_modelo"] : "Modelo";
   ...
   $tab_labels["proposta_data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_data"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_data"] : "Data";
   $tab_ger_campos['proposta_natureza'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_natureza'] = "proposta_natureza";
   }
   else
   {
       $tab_def_campos['proposta_natureza'] = "proposta.natureza";
   }
   $tab_labels["proposta_natureza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_natureza"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_natureza"] : "Natureza";
   $tab_ger_campos['proposta_cliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_cliente'] = "proposta_cliente";
   }
   else
   {
       $tab_def_campos['proposta_cliente'] = "proposta.cliente";
   }
   $tab_labels["proposta_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_cliente"] : "Cliente";
   $tab_ger_campos['proposta_atencao'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_atencao'] = "proposta_atencao";
   }
   else
   {
       $tab_def_campos['proposta_atencao'] = "proposta.atencao";
   }
   $tab_labels["proposta_atencao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_atencao"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_atencao"] : "Atencao";
   ...
   $tab_labels["proposta_cod_vend"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_cod_vend"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_cod_vend"] : "Cod Vend";
   $tab_ger_campos['proposta_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_total'] = "proposta_total";
   }
   else
   {
       $tab_def_campos['proposta_total'] = "proposta.total";
   }
   $tab_labels["proposta_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['labels']["proposta_total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_analise_modelos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_analise_modelos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
