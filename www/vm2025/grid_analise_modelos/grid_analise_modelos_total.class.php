...
class grid_analise_modelos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_analise_modelos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_analise_modelos']['campos_busca']))
      { 
   ...
   //----- 
   function Calc_resumo_groupby_1($destino_resumo, $res_export=false, $ind_compara="", $tipo="")
   {
      global $nm_lang;
      $this->nm_data = new nm_data("pt_br");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('proposta_natureza' => "proposta.natureza",'proposta_data' => "proposta.data",'itemproposta_modelo' => "itemproposta.modelo");
      $cmps_quebra_atual = array("proposta_natureza","proposta_data","itemproposta_modelo");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_force_fiels_gb']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_force_fiels_gb']))
      {
          $cmps_quebra_atual = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_force_fiels_gb'];
      }
      $Save_Format = '';
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_clear_total']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_clear_total']) {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_clear_total']);
      $ind_cmps  = 1;
      $ind_alias = "1";
      $cmp_dim   = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          ...
          $this->Res_Totaliza_groupby_1($ind_qb, $cmp_gb, $arr_tots . $arr_compara, $group, $join, $cmps_gb, $cmps_gb1, $cmps_gb2, $cmps_gbS, $cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export, $Save_Format);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }

   function Res_Totaliza_groupby_1($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def, $res_export, $Save_Format)
   {
      $sc_having = ((isset($parms_sub_sel['having']))) ? "  having " . $parms_sub_sel['having'] : "";
      $Tem_estat_manual = false;
      $where_ok = $this->sc_where_atual;
      $cmp_sql_tp_num = array('proposta_ordem' => 'N','proposta_total' => 'N');
     ...
     $comando .= " ON " . $join;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['proposta_natureza']['reg'] = "S";
      $format_dimensions['proposta_natureza']['msk'] = "";
      $format_dimensions['proposta_data']['reg'] = "S";
      $format_dimensions['proposta_data']['msk'] = "";
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['contr_total_geral'] = "OK";
   } 

   //-----  proposta_natureza
   function quebra_proposta_natureza_groupby_1($proposta_natureza, $arg_sum_proposta_natureza) 
   {
      global $tot_proposta_natureza;
      $tot_proposta_natureza = array() ;  
      $tot_proposta_natureza[0] = $proposta_natureza ; 
   }
   //-----  proposta_data
   function quebra_proposta_data_groupby_1($proposta_natureza, $proposta_data, $arg_sum_proposta_natureza, $arg_sum_proposta_data) 
   {
      global $tot_proposta_data;
      $tot_proposta_data = array() ;  
      $tot_proposta_data[0] = $proposta_data ; 
   }
   //-----  itemproposta_modelo
   function quebra_itemproposta_modelo_groupby_1($proposta_natureza, $proposta_data, $itemproposta_modelo, $arg_sum_proposta_natureza, $arg_sum_proposta_data, $arg_sum_itemproposta_modelo) 
   {
      global $tot_itemproposta_modelo;
      $tot_itemproposta_modelo = array() ;  
      $tot_itemproposta_modelo[0] = $itemproposta_modelo ; 
   }
