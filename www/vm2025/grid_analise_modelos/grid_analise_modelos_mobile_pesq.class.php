...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'proposta.data';$Nm_datas[] = 'proposta_data';$Nm_numeric[] = "proposta_ordem";$Nm_numeric[] = "proposta_total";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_itemproposta_modelo_cond" name="itemproposta_modelo_cond" onChange="nm_campos_between(document.getElementById('id_vis_itemproposta_modelo'), this, 'itemproposta_modelo')">
       <OPTION value="eq" <?php if ("eq" == $itemproposta_modelo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_itemproposta_modelo"  <?php echo $str_hide_itemproposta_modelo?>><INPUT  type="text" id="SC_itemproposta_modelo" name="itemproposta_modelo" value="<?php echo NM_encode_input($itemproposta_modelo) ?>"  size=18 alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_proposta_natureza_cond" name="proposta_natureza_cond" onChange="nm_campos_between(document.getElementById('id_vis_proposta_natureza'), this, 'proposta_natureza')">
       <OPTION value="eq" <?php if ("eq" == $proposta_natureza_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_proposta_natureza"  <?php echo $str_hide_proposta_natureza?>><INPUT  type="text" id="SC_proposta_natureza" name="proposta_natureza" value="<?php echo NM_encode_input($proposta_natureza) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
