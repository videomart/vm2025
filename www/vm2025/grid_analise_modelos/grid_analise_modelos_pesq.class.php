...
class grid_analise_modelos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_analise_modelos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_analise_modelos_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_analise_modelos_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_analise_modelos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_analise_modelos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'proposta.data';$Nm_datas[] = 'proposta_data';
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - itemproposta</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_analise_modelos/grid_analise_modelos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_analise_modelos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_analise_modelos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_analise_modelos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_analise_modelos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_itemproposta_modelo_cond#NMF#' + search_get_sel_txt('SC_itemproposta_modelo_cond') + '@NMF@';
  str_out += 'SC_itemproposta_modelo#NMF#' + search_get_text('SC_itemproposta_modelo') + '@NMF@';
  str_out += 'SC_proposta_natureza_cond#NMF#' + search_get_sel_txt('SC_proposta_natureza_cond') + '@NMF@';
  str_out += 'SC_proposta_natureza#NMF#' + search_get_text('SC_proposta_natureza') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $itemproposta_modelo_cond, $itemproposta_modelo,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $itemproposta_modelo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['itemproposta_modelo']; 
          $itemproposta_modelo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['itemproposta_modelo_cond']; 
          $proposta_natureza = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['proposta_natureza']; 
          $proposta_natureza_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['proposta_natureza_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['NM_operador']; 
      } 
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_itemproposta_modelo = (in_array($itemproposta_modelo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_proposta_natureza = (in_array($proposta_natureza_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($itemproposta_modelo) || $itemproposta_modelo == "")
      {
          $itemproposta_modelo = "";
      }
      if (isset($itemproposta_modelo) && !empty($itemproposta_modelo))
      {
      ...
      if (isset($proposta_natureza) && !empty($proposta_natureza))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_itemproposta_modelo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['itemproposta_modelo'])) ? $this->New_label['itemproposta_modelo'] : "Modelo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_itemproposta_modelo_cond" name="itemproposta_modelo_cond" onChange="nm_campos_between(document.getElementById('id_vis_itemproposta_modelo'), this, 'itemproposta_modelo')">
       <OPTION value="eq" <?php if ("eq" == $itemproposta_modelo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_itemproposta_modelo" <?php echo $str_hide_itemproposta_modelo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['itemproposta_modelo'])) ? $this->New_label['itemproposta_modelo'] : "Modelo";
 $nmgp_tab_label .= "itemproposta_modelo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<INPUT  type="text" id="SC_itemproposta_modelo" name="itemproposta_modelo" value="<?php echo NM_encode_input($itemproposta_modelo) ?>"  size=18 alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_proposta_natureza_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['proposta_natureza'])) ? $this->New_label['proposta_natureza'] : "Natureza"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_proposta_natureza_cond" name="proposta_natureza_cond" onChange="nm_campos_between(document.getElementById('id_vis_proposta_natureza'), this, 'proposta_natureza')">
       <OPTION value="eq" <?php if ("eq" == $proposta_natureza_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_proposta_natureza" name="proposta_natureza" value="<?php echo NM_encode_input($proposta_natureza) ?>"  size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
...
?>
<?php
   if (is_file("grid_analise_modelos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_analise_modelos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_analise_modelos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_itemproposta_modelo'), document.F1.itemproposta_modelo_cond, 'itemproposta_modelo');
   document.F1.itemproposta_modelo.value = "";
   nm_campos_between(document.getElementById('id_vis_proposta_natureza'), document.F1.proposta_natureza_cond, 'proposta_natureza');
   document.F1.proposta_natureza.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "VM2025/grid_analise_modelos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_orig'] = "";
      }
      $this->init_comando();
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_itemproposta_modelo_cond'] = 'cond';
      $tp_fields['SC_itemproposta_modelo'] = 'text';
      $tp_fields['SC_proposta_natureza_cond'] = 'cond';
      $tp_fields['SC_proposta_natureza'] = 'text';
   ...
   {
      global $itemproposta_modelo_cond, $itemproposta_modelo,
             $proposta_natureza_cond, $proposta_natureza, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $itemproposta_modelo_cond_salva = $itemproposta_modelo_cond; 
      if (!isset($itemproposta_modelo_input_2) || $itemproposta_modelo_input_2 == "")
      {
          $itemproposta_modelo_input_2 = $itemproposta_modelo;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['itemproposta_modelo'] = $itemproposta_modelo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['itemproposta_modelo_cond'] = $itemproposta_modelo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['proposta_natureza'] = $proposta_natureza; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['proposta_natureza_cond'] = $proposta_natureza_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $itemproposta_modelo;
      $this->cmp_formatado['itemproposta_modelo'] = $Conteudo;
      $this->cmp_formatado['itemproposta_modelo'] = "'" . $this->cmp_formatado['itemproposta_modelo'] . "'";
      if (isset($this->cmp_formatado['itemproposta_modelo_input_2'])  && !empty($this->cmp_formatado['itemproposta_modelo_input_2'])) {
          $this->cmp_formatado['itemproposta_modelo_input_2'] = "'" . $this->cmp_formatado['itemproposta_modelo_input_2'] . "'";
      }
      $Conteudo = $proposta_natureza;
      $this->cmp_formatado['proposta_natureza'] = $Conteudo;
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($itemproposta_modelo) || $itemproposta_modelo_cond == "nu" || $itemproposta_modelo_cond == "nn" || $itemproposta_modelo_cond == "ep" || $itemproposta_modelo_cond == "ne")
      {
         $this->monta_condicao("itemproposta.modelo", $itemproposta_modelo_cond, $itemproposta_modelo, "", "itemproposta_modelo", "VARCHAR", false);
      }

      //----- $proposta_natureza
      $this->Date_part = false;
      if (isset($proposta_natureza) || $proposta_natureza_cond == "nu" || $proposta_natureza_cond == "nn" || $proposta_natureza_cond == "ep" || $proposta_natureza_cond == "ne")
      {
         $this->monta_condicao("proposta.natureza", $proposta_natureza_cond, $proposta_natureza, "", "proposta_natureza", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_analise_modelos']['cond_pesq'] .= $this->NM_operador;
