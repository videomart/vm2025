...
class grid_service_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_service_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_service_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_service_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_service_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_service_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_osnumber')
      {
          $osnumber = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_osnumber($osnumber);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_marca')
      {
          $marca = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_marca($marca);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_osnumber($osnumber)
   {
      $osnumber = substr($this->Db->qstr($osnumber), 1, -1);
            $osnumber_look = (is_string($osnumber) ? substr($this->Db->qstr($osnumber), 1, -1) : $osnumber); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select OSNUMBER, OSNUMBER from service where  #lowerI#OSNUMBER#lowerF# like #lowerI#'%" . $osnumber . "%'#lowerF# order by OSNUMBER"; 
   ...
   function lookup_ajax_classe($classe)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select CLASSE, CLASSE from classe where  #lowerI#CLASSE#lowerF# like #lowerI#'%" . $classe . "%'#lowerF# order by CLASSE"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_marca($marca)
   {
      $marca = substr($this->Db->qstr($marca), 1, -1);
            $marca_look = (is_string($marca) ? substr($this->Db->qstr($marca), 1, -1) : $marca); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select MARCA, MARCA from marca where  #lowerI#MARCA#lowerF# like #lowerI#'%" . $marca . "%'#lowerF# order by MARCA"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_datas[] = 'dataorc';$Nm_datas[] = 'saida';$Nm_numeric[] = "id";$Nm_numeric[] = "id_empresa";$Nm_numeric[] = "maoobra";$Nm_numeric[] = "material";$Nm_numeric[] = "orcamento";
      ...
      $Nm_datas[] = 'data';$Nm_datas[] = 'dataorc';$Nm_datas[] = 'saida';
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_betw'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo] . " </span>" . $this->Ini->Nm_lang['lang_srch_and_cond'] . " <span class='scGridFilterDynValue'>" . $this->cmp_formatado[$nome_campo . "_input_2"] . "</span>##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_service/grid_service_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_service_ajax_search.js"></script>
 <script type="text/javascript" src="grid_service_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_service_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_service']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_service']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_osnumber_cond#NMF#' + search_get_sel_txt('SC_osnumber_cond') + '@NMF@';
  str_out += 'SC_osnumber#NMF#' + search_get_text('SC_osnumber') + '@NMF@';
  str_out += 'id_ac_osnumber#NMF#' + search_get_text('id_ac_osnumber') + '@NMF@';
  ...
  str_out += 'SC_marca_cond#NMF#' + search_get_sel_txt('SC_marca_cond') + '@NMF@';
  str_out += 'SC_marca#NMF#' + search_get_text('SC_marca') + '@NMF@';
  str_out += 'id_ac_marca#NMF#' + search_get_text('id_ac_marca') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_osnumber").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_osnumber").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_osnumber",
          max_itens: "10",
          cod_desc: "N",
   ...
   scClass = $("#id_ac_marca").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_marca").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $osnumber = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['osnumber']; 
          $osnumber_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['osnumber_cond']; 
          $id_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['id_empresa']; 
          $id_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['id_empresa_cond']; 
          $classe = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['classe']; 
          $classe_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['classe_cond']; 
          $marca = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['marca']; 
          $marca_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['marca_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['NM_operador']; 
      } 
      if (!isset($osnumber_cond) || empty($osnumber_cond))
      {
         $osnumber_cond = "ii";
      }
      ...
      if (!isset($marca_cond) || empty($marca_cond))
      {
         $marca_cond = "qp";
      }
      ...
      $str_hide_osnumber = (in_array($osnumber_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_marca = (in_array($marca_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($osnumber) || $osnumber == "")
      {
          $osnumber = "";
      }
      if (isset($osnumber) && !empty($osnumber))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <INPUT type="hidden" id="SC_osnumber_cond" name="osnumber_cond" value="ii">
 ...
 $nmgp_tab_label .= "osnumber?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_osnumber"  <?php echo $str_hide_osnumber?>><?php
      if ($osnumber != "")
      {
      $osnumber_look = (is_string($osnumber) ? substr($this->Db->qstr($osnumber), 1, -1) : $osnumber); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select OSNUMBER, OSNUMBER from service where #lowerI#OSNUMBER#lowerF# = #lowerI#'$osnumber_look'#lowerF# order by OSNUMBER"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if (isset($nmgp_def_dados[0][$osnumber]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$osnumber];
      }
      else
      {
          $sAutocompValue = $osnumber;
      }
?>
<INPUT  type="text" id="SC_osnumber" name="osnumber" value="<?php echo NM_encode_input($osnumber) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_osnumber" name="osnumber_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_id_empresa_cond" name="id_empresa_cond" value="qp">
...
?>
<INPUT  type="text" id="SC_id_empresa" name="id_empresa" value="<?php echo NM_encode_input($id_empresa) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven " type="text" id="id_ac_id_empresa" name="id_empresa_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_classe_cond" name="classe_cond" value="qp">
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_classe"  <?php echo $str_hide_classe?>><?php
      if ($classe != "")
      {
      $classe_look = (is_string($classe) ? substr($this->Db->qstr($classe), 1, -1) : $classe); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select CLASSE, CLASSE from classe where #lowerI#CLASSE#lowerF# = #lowerI#'$classe_look'#lowerF# order by CLASSE"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
?>
<INPUT  type="text" id="SC_classe" name="classe" value="<?php echo NM_encode_input($classe) ?>"  size=19 alt="{datatype: 'text', maxLength: 19, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd " type="text" id="id_ac_classe" name="classe_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_marca_cond" name="marca_cond" value="qp">

    <TD nowrap class="scFilterFieldEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['marca'])) ? $this->New_label['marca'] : "Marca";
 $nmgp_tab_label .= "marca?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_marca"  <?php echo $str_hide_marca?>><?php
      if ($marca != "")
      {
      $marca_look = (is_string($marca) ? substr($this->Db->qstr($marca), 1, -1) : $marca); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select MARCA, MARCA from marca where #lowerI#MARCA#lowerF# = #lowerI#'$marca_look'#lowerF# order by MARCA"; 
      $this->Sel_case_sensitive($nm_comando);
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if (isset($nmgp_def_dados[0][$marca]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$marca];
      }
      else
      {
          $sAutocompValue = $marca;
      }
?>
<INPUT  type="text" id="SC_marca" name="marca" value="<?php echo NM_encode_input($marca) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven " type="text" id="id_ac_marca" name="marca_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (is_file("grid_service_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_service']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_service']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.osnumber_cond.value = 'ii';
   nm_campos_between(document.getElementById('id_vis_osnumber'), document.F1.osnumber_cond, 'osnumber');
   document.F1.osnumber.value = "";
   document.F1.osnumber_autocomp.value = "";
   ...
   document.F1.marca_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_marca'), document.F1.marca_cond, 'marca');
   document.F1.marca.value = "";
   document.F1.marca_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_osnumber_cond'] = 'cond';
      $tp_fields['SC_osnumber'] = 'text_aut';
      $tp_fields['id_ac_osnumber'] = 'text_aut';
      ...
      $tp_fields['SC_marca_cond'] = 'cond';
      $tp_fields['SC_marca'] = 'text_aut';
      $tp_fields['id_ac_marca'] = 'text_aut';
   ...
   {
      global $osnumber_cond, $osnumber, $osnumber_autocomp,
             $id_empresa_cond, $id_empresa, $id_empresa_autocomp,
             $classe_cond, $classe, $classe_autocomp,
             $marca_cond, $marca, $marca_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($osnumber_autocomp) && empty($osnumber))
      {
          $osnumber = $osnumber_autocomp;
      }
      ...
      if (!empty($marca_autocomp) && empty($marca))
      {
          $marca = $marca_autocomp;
      }
      $osnumber_cond_salva = $osnumber_cond; 
      if (!isset($osnumber_input_2) || $osnumber_input_2 == "")
      {
          $osnumber_input_2 = $osnumber;
      }
      ...
      $marca_cond_salva = $marca_cond; 
      if (!isset($marca_input_2) || $marca_input_2 == "")
      {
          $marca_input_2 = $marca;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['osnumber'] = $osnumber; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['osnumber_cond'] = $osnumber_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['id_empresa'] = $id_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['id_empresa_cond'] = $id_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['classe'] = $classe; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['classe_cond'] = $classe_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['marca'] = $marca; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['marca_cond'] = $marca_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca'] = $Temp_Busca;
      }
    ...
    if ($osnumber != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['osnumber'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['osnumber'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['osnumber'] = $osnumber;
      }
      $this->cmp_formatado['osnumber'] = "'" . $this->cmp_formatado['osnumber'] . "'";
      if (isset($this->cmp_formatado['osnumber_input_2'])  && !empty($this->cmp_formatado['osnumber_input_2'])) {
          $this->cmp_formatado['osnumber_input_2'] = "'" . $this->cmp_formatado['osnumber_input_2'] . "'";
      }
      $nmgp_def_dados = array();
    if ($id_empresa != '') {
      $id_empresa_look = (is_string($id_empresa) ? substr($this->Db->qstr($id_empresa), 1, -1) : $id_empresa); 
   ...
   { 
    ...
    if ($marca != '') {
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['marca'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['marca'] = $marca;
      }
      $this->cmp_formatado['marca'] = "'" . $this->cmp_formatado['marca'] . "'";
      if (isset($this->cmp_formatado['marca_input_2'])  && !empty($this->cmp_formatado['marca_input_2'])) {
          $this->cmp_formatado['marca_input_2'] = "'" . $this->cmp_formatado['marca_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      if (isset($osnumber) || $osnumber_cond == "nu" || $osnumber_cond == "nn" || $osnumber_cond == "ep" || $osnumber_cond == "ne")
      {
         $this->monta_condicao("OSNUMBER", $osnumber_cond, $osnumber, "", "osnumber", "VARCHAR", false);
      }
      ...
      //----- $marca
      $this->Date_part = false;
      if (isset($marca) || $marca_cond == "nu" || $marca_cond == "nn" || $marca_cond == "ep" || $marca_cond == "ne")
      {
         $this->monta_condicao("MARCA", $marca_cond, $marca, "", "marca", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_service']['cond_pesq'] .= $this->NM_operador;
