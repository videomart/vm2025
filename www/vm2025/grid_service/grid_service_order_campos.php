...
<?php
   ...
   $Ord_Cmp = new grid_service_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_service_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['osnumber'] = "OSNUMBER";
   $tab_labels["osnumber"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["osnumber"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["osnumber"] : "O.S.";
   $tab_ger_campos['id_empresa'] = "on";
   $tab_def_campos['id_empresa'] = "ID_EMPRESA";
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["id_empresa"] : "Empresa";
   $tab_ger_campos['modelo'] = "on";
   $tab_def_campos['modelo'] = "MODELO";
   $tab_labels["modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["modelo"] : "Modelo";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "DATA";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["data"] : "Data";
   $tab_ger_campos['classe'] = "on";
   $tab_def_campos['classe'] = "CLASSE";
   $tab_labels["classe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["classe"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["classe"] : "Classe";
   $tab_ger_campos['marca'] = "on";
   $tab_def_campos['marca'] = "MARCA";
   $tab_labels["marca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["marca"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["marca"] : "Marca";
   $tab_ger_campos['serie'] = "on";
   $tab_def_campos['serie'] = "SERIE";
   $tab_labels["serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_service']['labels']["serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_service']['labels']["serie"] : "Série";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_service']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_service']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_service']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_service']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_service']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_service_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_service']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
