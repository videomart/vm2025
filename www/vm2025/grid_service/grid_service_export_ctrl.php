<?php
@session_start() ;
$_SESSION['scriptcase']['grid_service']['sc_process_barr'] = true;
require_once('../grid_service/index.php');
unset($_SESSION['scriptcase']['grid_service']['sc_process_barr']);
$ExportCtrl = new grid_service_export_control;
$ExportCtrl->Export_barr();

class grid_service_export_control
{
