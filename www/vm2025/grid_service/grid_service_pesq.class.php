...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - service</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr valign="top">
      ...
      <TD id='SC_osnumber_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['osnumber'])) ? $this->New_label['osnumber'] : "O.S."; ?></TD>
      
      <INPUT type="hidden" id="SC_osnumber_cond" name="osnumber_cond" value="ii">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_osnumber" <?php echo $str_hide_osnumber?> valign="top">
...
<input class="sc-js-input scFilterObjectEven " type="text" id="id_ac_id_empresa" name="id_empresa_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_classe_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['classe'])) ? $this->New_label['classe'] : "Classe"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd " type="text" id="id_ac_classe" name="classe_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_marca_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['marca'])) ? $this->New_label['marca'] : "Marca"; ?></TD>
      
      <INPUT type="hidden" id="SC_marca_cond" name="marca_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_marca" <?php echo $str_hide_marca?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
