<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_perfil']          = "vmdata_con";
...
<?php
      ...
      if (isset($_POST['nm_grid_submit']) && $_POST['nm_grid_submit'] == 1 && isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['csrf_token'] ) && !isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['embutida']) && !isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['embutida_form'])) {
          if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] != $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['csrf_token']) {
              echo "<html>";
              echo "<body>";
              echo "<table align=\"center\" width=\"50%\" border=1 height=\"50px\">";
              echo "<tr>";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['csrf_token']))
       {
           $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['csrf_token'] = $this->scCsrfGenerateToken();
       }

       return $_SESSION['sc_session'][$this->sc_page]['app_search_sec_groups']['csrf_token'];
   }
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'VM2025', 1, $this->Ini->force_db_utf8); 
      } 
      else 
      { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_VM2025'])) {
               $_SESSION['scriptcase']['app_search_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_VM2025'];
           }
       }
   }
   if (isset($group)) 
