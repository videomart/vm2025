<?php
@session_start() ;
$_SESSION['scriptcase']['grid_uf']['sc_process_barr'] = true;
require_once('../grid_uf/index.php');
unset($_SESSION['scriptcase']['grid_uf']['sc_process_barr']);
$ExportCtrl = new grid_uf_export_control;
$ExportCtrl->Export_barr();

class grid_uf_export_control
{
