...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "icm";$Nm_numeric[] = "id";$Nm_numeric[] = "icm";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_uf"  <?php echo $str_hide_uf?>><INPUT  type="text" id="SC_uf" name="uf" value="<?php echo NM_encode_input($uf) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_regiao_cond" name="regiao_cond" onChange="nm_campos_between(document.getElementById('id_vis_regiao'), this, 'regiao')">
      ...
      <br><span id="id_hide_regiao"  <?php echo $str_hide_regiao?>><INPUT  type="text" id="SC_regiao" name="regiao" value="<?php echo NM_encode_input($regiao) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_icm_cond" name="icm_cond" onChange="nm_campos_between(document.getElementById('id_vis_icm'), this, 'icm')">
