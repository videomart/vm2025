...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_marca_cond" name="marca_cond" onChange="nm_campos_between(document.getElementById('id_vis_marca'), this, 'marca')">
      ...
      <br><span id="id_hide_marca"  <?php echo $str_hide_marca?>><INPUT  type="text" id="SC_marca" name="marca" value="<?php echo NM_encode_input($marca) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
