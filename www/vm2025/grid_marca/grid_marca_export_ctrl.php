<?php
@session_start() ;
$_SESSION['scriptcase']['grid_marca']['sc_process_barr'] = true;
require_once('../grid_marca/index.php');
unset($_SESSION['scriptcase']['grid_marca']['sc_process_barr']);
$ExportCtrl = new grid_marca_export_control;
$ExportCtrl->Export_barr();

class grid_marca_export_control
{
