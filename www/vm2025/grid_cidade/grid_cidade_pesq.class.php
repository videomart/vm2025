...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - cidade</TITLE>
...
?>
<INPUT  type="text" id="SC_cidade" name="cidade" value="<?php echo NM_encode_input($cidade) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_uf_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['uf'])) ? $this->New_label['uf'] : "Uf"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_uf_cond" name="uf_cond" onChange="nm_campos_between(document.getElementById('id_vis_uf'), this, 'uf')">
...
?>
<INPUT  type="text" id="SC_uf" name="uf" value="<?php echo NM_encode_input($uf) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
<INPUT  type="text" id="SC_ddd" name="ddd" value="<?php echo NM_encode_input($ddd) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
