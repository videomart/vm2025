<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cidade']['sc_process_barr'] = true;
require_once('../grid_cidade/index.php');
unset($_SESSION['scriptcase']['grid_cidade']['sc_process_barr']);
$ExportCtrl = new grid_cidade_export_control;
$ExportCtrl->Export_barr();

class grid_cidade_export_control
{
