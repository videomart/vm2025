<?php
@session_start() ;
$_SESSION['scriptcase']['grid_operacoes']['sc_process_barr'] = true;
require_once('../grid_operacoes/index.php');
unset($_SESSION['scriptcase']['grid_operacoes']['sc_process_barr']);
$ExportCtrl = new grid_operacoes_export_control;
$ExportCtrl->Export_barr();

class grid_operacoes_export_control
{
