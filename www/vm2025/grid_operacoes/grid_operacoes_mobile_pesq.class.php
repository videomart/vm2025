...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "codigo";$Nm_numeric[] = "cfop";$Nm_numeric[] = "id";$Nm_numeric[] = "codigo";$Nm_numeric[] = "cfop";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_operacao_cond" name="operacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_operacao'), this, 'operacao')">
      ...
      <br><span id="id_hide_operacao"  <?php echo $str_hide_operacao?>><INPUT  type="text" id="SC_operacao" name="operacao" value="<?php echo NM_encode_input($operacao) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_cfop_cond" name="cfop_cond" onChange="nm_campos_between(document.getElementById('id_vis_cfop'), this, 'cfop')">
      ...
      <br><span id="id_hide_cfop"  <?php echo $str_hide_cfop?>><INPUT  type="text" id="SC_cfop" name="cfop" value="<?php echo NM_encode_input($cfop) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
