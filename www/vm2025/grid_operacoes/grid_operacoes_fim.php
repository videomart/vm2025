...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_operacoes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_operacoes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_operacoes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operacoes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_operacoes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_operacoes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_operacoes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_operacoes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_operacoes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_operacoes']['embutida_filho'] as $ind => $sc_init)
          {
