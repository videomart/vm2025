<?php
@session_start() ;
$_SESSION['scriptcase']['grid_followup']['sc_process_barr'] = true;
require_once('../grid_followup/index.php');
unset($_SESSION['scriptcase']['grid_followup']['sc_process_barr']);
$ExportCtrl = new grid_followup_export_control;
$ExportCtrl->Export_barr();

class grid_followup_export_control
{
