...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_followup/grid_followup_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_followup.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              $this->Res = new grid_followup_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_res_grid']);
          } 
      }
   ...
   function NM_export_cliente()
   {
         ...
         $this->NM_export_id_proposta(true, $SC_Label);
         $this->NM_export_relato(true, $SC_Label);
   }
   //----- data
   ...
   //----- data_prevista
   function NM_export_data_prevista($Grouping=false, $Lab_Mult="")
   {
         if ($this->Json_format)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->data_prevista;
         }
         else {
             $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->data_prevista;
         }
   }
   //----- status
   function NM_export_status($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->status;
         }
         else {
   ...
   //----- grau_oportunidade
   function NM_export_grau_oportunidade($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->grau_oportunidade;
         }
         else {
             $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->grau_oportunidade;
         }
   }
   //----- id
   ...
   //----- id_proposta
   function NM_export_id_proposta($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->look_id_proposta;
         }
         else {
             $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_id_proposta;
         }
   }
   //----- relato
   function NM_export_relato($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->relato;
         }
         else {
             $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->relato;
         }
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> followup :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_followup']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
