...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_datas[] = 'data_prevista';$Nm_numeric[] = "id";$Nm_numeric[] = "id_proposta";
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_proposta_cond" name="id_proposta_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_proposta'), this, 'id_proposta')">
      ...
      <br><span id="id_hide_id_proposta"  <?php echo $str_hide_id_proposta?>><INPUT  type="text" id="SC_id_proposta" name="id_proposta" value="<?php echo NM_encode_input($id_proposta) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_relato_cond" name="relato_cond" onChange="nm_campos_between(document.getElementById('id_vis_relato'), this, 'relato')">
      ...
      <br><span id="id_hide_relato"  <?php echo $str_hide_relato?>><INPUT  type="text" id="SC_relato" name="relato" value="<?php echo NM_encode_input($relato) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
