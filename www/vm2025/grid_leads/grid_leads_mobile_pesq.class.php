...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_empresa_cond" name="empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_empresa'), this, 'empresa')">
      ...
      <br><span id="id_hide_empresa"  <?php echo $str_hide_empresa?>><?php
      if ($empresa != "")
      {
      $empresa_look = (is_string($empresa) ? substr($this->Db->qstr($empresa), 1, -1) : $empresa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_contato_cond" name="contato_cond" onChange="nm_campos_between(document.getElementById('id_vis_contato'), this, 'contato')">
      ...
      <br><span id="id_hide_contato"  <?php echo $str_hide_contato?>><?php
      if ($contato != "")
      {
      $contato_look = (is_string($contato) ? substr($this->Db->qstr($contato), 1, -1) : $contato); 
      $nmgp_def_dados = array(); 
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_telefone_cond" name="telefone_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefone'), this, 'telefone')">
      ...
      <br><span id="id_hide_telefone"  <?php echo $str_hide_telefone?>><?php
      if ($telefone != "")
      {
      $telefone_look = (is_string($telefone) ? substr($this->Db->qstr($telefone), 1, -1) : $telefone); 
      $nmgp_def_dados = array(); 
