<?php
@session_start() ;
$_SESSION['scriptcase']['grid_leads']['sc_process_barr'] = true;
require_once('../grid_leads/index.php');
unset($_SESSION['scriptcase']['grid_leads']['sc_process_barr']);
$ExportCtrl = new grid_leads_export_control;
$ExportCtrl->Export_barr();

class grid_leads_export_control
{
