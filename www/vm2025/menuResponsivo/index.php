...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menuResponsivo']['glo_nm_perfil']         = "vmdata_con";
    $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo']      = "";
...
class menuResponsivo_class
{
 ...
 function menuResponsivo_menu()
 {
    global $menuResponsivo_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "menuResponsivo/img";
...
include_once(dirname(__FILE__) . "/menuResponsivo_erro.class.php"); 
$this->Erro = new menuResponsivo_erro();
$str_path = substr($_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menuResponsivo']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$menuResponsivo_menuData         = array();
$menuResponsivo_menuData['path'] = array();
$menuResponsivo_menuData['url']  = array();
$menuResponsivo_menuData['data'] = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menuResponsivo_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menuResponsivo_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menuResponsivo_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menuResponsivo_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menuResponsivo_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menuResponsivo_menuData['url']['web']   = str_replace("\\", '/', $menuResponsivo_menuData['url']['web']);
$menuResponsivo_menuData['path']['root'] = substr($menuResponsivo_menuData['path']['sys'],  0, -1 * strlen($menuResponsivo_menuData['url']['web']));
$menuResponsivo_menuData['path']['app']  = substr($menuResponsivo_menuData['path']['sys'],  0, strrpos($menuResponsivo_menuData['path']['sys'],  '/'));
$menuResponsivo_menuData['path']['link'] = substr($menuResponsivo_menuData['path']['app'],  0, strrpos($menuResponsivo_menuData['path']['app'],  '/'));
$menuResponsivo_menuData['path']['link'] = substr($menuResponsivo_menuData['path']['link'], 0, strrpos($menuResponsivo_menuData['path']['link'], '/')) . '/';
$menuResponsivo_menuData['path']['app'] .= '/';
$menuResponsivo_menuData['url']['app']   = substr($menuResponsivo_menuData['url']['web'],  0, strrpos($menuResponsivo_menuData['url']['web'],  '/'));
$menuResponsivo_menuData['url']['link']  = substr($menuResponsivo_menuData['url']['app'],  0, strrpos($menuResponsivo_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] == "S")
{
    $menuResponsivo_menuData['url']['link']  = substr($menuResponsivo_menuData['url']['link'], 0, strrpos($menuResponsivo_menuData['url']['link'], '/'));
}
$menuResponsivo_menuData['url']['link']  .= '/';
$menuResponsivo_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menuResponsivo']['sc_apl_link'] = $menuResponsivo_menuData['url']['link'];
...
include_once("menuResponsivo_toolbar.php");
...
if ($_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_apls']['menuResponsivo'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menuResponsivo']['glo_nm_conexao']) && $_SESSION['scriptcase']['menuResponsivo']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menuResponsivo']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menuResponsivo']['glo_nm_perfil']) && $_SESSION['scriptcase']['menuResponsivo']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menuResponsivo']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menuResponsivo']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menuResponsivo']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menuResponsivo']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menuResponsivo']['init']))
{
    $_SESSION['sc_session'][1]['menuResponsivo']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menuResponsivo']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menuResponsivo']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menuResponsivo'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menuResponsivo'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menuResponsivo'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menuResponsivo'))
{
    $_SESSION['sc_session'][1]['menuResponsivo']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menuResponsivo'] = "javascript:window.close()";
}
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_leads_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_leads_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_leads']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_leads'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_followup_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_followup_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_followup']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_followup'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/GridAnaliseProdutosPropostos_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/GridAnaliseProdutosPropostos_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['GridAnaliseProdutosPropostos']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/chart_proposta_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/chart_proposta_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_proposta']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['chart_proposta'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_sistemas_vm_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_sistemas_vm_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sistemas_vm']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_sistemas_vm'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/GridClientesProduto_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/GridClientesProduto_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['GridClientesProduto']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['GridClientesProduto'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_proposta_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_proposta_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proposta']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_termos_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_termos_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_termos']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_termos'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_empresa_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_empresa_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_empresa']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_empresa'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_contato_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_contato_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contato']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_contato'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_empresa_duplicadas_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_empresa_duplicadas_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_empresa_duplicadas']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_categoria_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_categoria_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_produto_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_classe_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_classe_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_classe']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_classe'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_marca_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_marca_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_marca']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_marca'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_markup_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_markup_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_markup']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_markup'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_markup_custo_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_markup_custo_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_markup_custo']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_markup_custo'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_cst_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_cst_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cst']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_cst'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_comissao_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_comissao_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_comissao']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_comissao'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_transportadoras_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_transportadoras_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadoras']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_transportadoras'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_cidade_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_cidade_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cidade']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_cidade'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_uf_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_uf_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_uf']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_uf'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_rede_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_rede_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_rede']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_rede'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_operacoes_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_operacoes_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_operacoes']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_operacoes'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_funcionario_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_funcionario_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_status_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_status_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_status']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_status'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_licenca_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_licenca_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_licenca']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_licenca'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_service_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_service_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_service']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_service'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_dolar_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_dolar_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_dolar']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_dolar'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_contas_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_contas_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contas']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_contas_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_contas_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_contas']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_contas'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_subconta_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_subconta_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_subconta']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_subconta'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Grid_MailingList_Contatos_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/Grid_MailingList_Contatos_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Grid_MailingList_Contatos']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_mailing_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_mailing_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mailing']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_mailing'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_tracking_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_tracking_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tracking']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_cotacao_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_cotacao_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cotacao']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_cotacao'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_cotacao_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_cotacao_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cotacao']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_cotacao'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_price_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_price_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_price']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_price_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_price_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_price']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_price'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_estoque_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_estoque_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estoque']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_estoque'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_devedoras_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_devedoras_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_devedoras']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_devedoras'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_resultado_financeiro_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_resultado_financeiro_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_resultado_financeiro']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/MaioresCompradoras_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/MaioresCompradoras_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['MaioresCompradoras']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_credoras_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/grid_credoras_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_credoras']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_credoras'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_setup_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/form_setup_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_setup']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['form_setup'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_grid_sec_users_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_grid_sec_apps_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_grid_sec_groups_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_grid_sec_users_groups_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_search_sec_groups_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_sync_apps_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_add_2fa_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_settings_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_change_pswd_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_my_info_ini.php"))
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_my_info_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_my_info']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['app_my_info'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
{
    include($path_apls . $this->tab_grupo[0] . "_lib/_app_data/app_Login_ini.php");
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menuResponsivo'];

$menuResponsivo_menuData['data'] = array();
$str_disabled = 'N';
$str_label = "                                                           ";
$str_hint = "ESPAÇO A ESQUERDA";
...
$menuResponsivo_menuData['data']['itens']['item_57'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "",
                                                  ...
                                                  'icon_check'     => "S",
                                                  'id'     => "item_57",
                                                  'target'      => $this->menuResponsivo_target('_self'),
...
$menuResponsivo_menuData['data']['itens']['item_56'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_56&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-asterisk",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_leads']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_leads']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_10'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_leads&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-address-book",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_followup']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_followup']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_11'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_followup&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fab fa-accusoft",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_77'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['GridAnaliseProdutosPropostos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['GridAnaliseProdutosPropostos']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Analise Produtos X Propostas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_77']['itens']['item_19'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_19&sc_apl_menu=GridAnaliseProdutosPropostos&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fab fa-apple",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_proposta']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['chart_proposta']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Gráfico de Vendas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_77']['itens']['item_79'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_79&sc_apl_menu=chart_proposta&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sistemas_vm']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_sistemas_vm']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Registro de Vendas  linha VM";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_77']['itens']['item_18'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_18&sc_apl_menu=grid_sistemas_vm&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['GridClientesProduto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['GridClientesProduto']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Consulta clientes X produtos";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_1']['itens']['item_77']['itens']['item_78'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_78&sc_apl_menu=GridClientesProduto&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_76'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proposta']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_proposta']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_76']['itens']['item_12'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_proposta&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_termos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_termos']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Termos de proposta";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_76']['itens']['item_30'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_30&sc_apl_menu=grid_termos&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_75'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_empresa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_empresa']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Cadastro de Empresas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_75']['itens']['item_13'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_empresa&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contato']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_contato']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Cadastro de Contatos";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_75']['itens']['item_20'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_20&sc_apl_menu=grid_contato&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_empresa_duplicadas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_empresa_duplicadas']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Empresas duplicadas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_75']['itens']['item_17'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_empresa_duplicadas&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_label = "Categoria de empresas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_75']['itens']['item_27'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_categoria&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59']['itens']['item_14'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_produto&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_classe']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_classe']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Classes";
$str_hint = "Classes de produtos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
    $str_hint = sc_convert_encoding($str_hint, "UTF-8", $_SESSION['scriptcase']['charset']);
}
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59']['itens']['item_25'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_25&sc_apl_menu=grid_classe&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_marca']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_marca']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59']['itens']['item_28'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_28&sc_apl_menu=grid_marca&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_markup']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_markup']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Perfis de MarkUp";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59']['itens']['item_60'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_60&sc_apl_menu=form_markup&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_markup_custo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_markup_custo']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Custos de Markup";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59']['itens']['item_61'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_61&sc_apl_menu=form_markup_custo&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cst']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cst']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Código situação tributária";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_59']['itens']['item_33'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_cst&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_comissao']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_comissao']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_2']['itens']['item_16'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_16&sc_apl_menu=grid_comissao&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-microphone-alt",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadoras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadoras']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Transportadoras";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_21'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_21&sc_apl_menu=grid_transportadoras&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cidade']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cidade']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_23'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_cidade&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_uf']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_uf']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_24'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_uf&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_rede']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_rede']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Redes de TV";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_29'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_rede&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_operacoes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_operacoes']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_31'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_31&sc_apl_menu=grid_operacoes&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_label = "Cadastro de funcionários";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_32'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_funcionario&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_status']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_status']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Status de serviços";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_3']['itens']['item_34'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_status&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "S",
...
$menuResponsivo_menuData['data']['itens']['item_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fab fa-servicestack",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_licenca']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_licenca']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Licença de sistemas VM";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_36'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_36&sc_apl_menu=grid_licenca&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fab fa-angular",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_service']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_service']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Ordem de serviço";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_35'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_service&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_38'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_dolar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_dolar']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Cotação Dolar";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_39'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_39&sc_apl_menu=grid_dolar&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_contas']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Estrato de contas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_40'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_40&sc_apl_menu=grid_contas&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_contas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_contas']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Movimentar contas";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_41'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_41&sc_apl_menu=form_contas&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_subconta']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_subconta']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_4']['itens']['item_42'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_42&sc_apl_menu=grid_subconta&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-map-marked",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Grid_MailingList_Contatos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Grid_MailingList_Contatos']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Contatos no sistema";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_5']['itens']['item_44'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_44&sc_apl_menu=Grid_MailingList_Contatos&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mailing']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_mailing']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Contatos através do site-VM";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_5']['itens']['item_43'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_43&sc_apl_menu=grid_mailing&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_6'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-hand-paper",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tracking']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tracking']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_6']['itens']['item_45'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_45&sc_apl_menu=grid_tracking&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cotacao']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cotacao']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Ordem de compra";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_6']['itens']['item_46'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_46&sc_apl_menu=grid_cotacao&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_cotacao']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_cotacao']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_6']['itens']['item_47'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_47&sc_apl_menu=form_cotacao&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_price']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_price']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Cadastra preços";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_6']['itens']['item_48'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_48&sc_apl_menu=form_price&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_price']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_price']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Consulta preços";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_6']['itens']['item_49'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_49&sc_apl_menu=grid_price&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estoque']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_estoque']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Controle de estoque";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_6']['itens']['item_50'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_estoque&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_7'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-bug",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_devedoras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_devedoras']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Empresas devedoras";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_7']['itens']['item_52'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_52&sc_apl_menu=grid_devedoras&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_resultado_financeiro']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_resultado_financeiro']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Resultado Operacional";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_7']['itens']['item_53'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_53&sc_apl_menu=grid_resultado_financeiro&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['MaioresCompradoras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['MaioresCompradoras']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Maiores compradoras";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_7']['itens']['item_54'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_54&sc_apl_menu=MaioresCompradoras&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_credoras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_credoras']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
$str_label = "Empresas credoras";
$str_hint = "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
...
$menuResponsivo_menuData['data']['itens']['item_7']['itens']['item_55'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_55&sc_apl_menu=grid_credoras&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-file",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_setup']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_setup']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data']['itens']['item_8'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_setup&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-hammer",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
                                                  'mega_check'     => "N",
                                                  'icon_check'     => "S",
...
$menuResponsivo_menuData['data']['itens']['item_80'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "#",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_81'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_81&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_82'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_82&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_83'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_83&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_90'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_90&sc_apl_menu=app_grid_sec_users_groups&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_84'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_84&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_85'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_85&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_91'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_91&sc_apl_menu=app_add_2fa&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_92'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_92&sc_apl_menu=app_settings&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data']['itens']['item_80']['itens']['item_86'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_86&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-cog",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
$str_label = "Sair";
$str_hint = "" . $this->Nm_lang['lang_exit'] . "";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && !NM_is_utf8($str_label))
{
    $str_label = sc_convert_encoding($str_label, "UTF-8", $_SESSION['scriptcase']['charset']);
    $str_hint = sc_convert_encoding($str_hint, "UTF-8", $_SESSION['scriptcase']['charset']);
}
$menuResponsivo_menuData['data']['itens']['item_9'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_9&sc_apl_menu=https://www.videomart.com.br&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-ankh",
                                                  'link_target'     => "parente",
                                                  'fav_check'     => "N",
...
$str_disabled = 'N';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_my_info']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_my_info']) != "on")
{
    $str_link = "#";
    $str_disabled = 'Y';
}
...
$menuResponsivo_menuData['data_user']['itens']['item_user_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_user_1&sc_apl_menu=app_my_info&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-user",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data_user']['itens']['item_user_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_user_3&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-key",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
$menuResponsivo_menuData['data_user']['itens']['item_user_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_user_2&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menuResponsivo_menuData['data_tb']['itens']['item_tb_1'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_tb_1&sc_apl_menu=search&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menuResponsivo_menuData['data_tb']['itens']['item_tb_2'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_tb_2&sc_apl_menu=languages&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menuResponsivo_menuData['data_tb']['itens']['item_tb_3'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_tb_3&sc_apl_menu=themes&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menuResponsivo_menuData['data_tb']['itens']['item_tb_4'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_tb_4&sc_apl_menu=shortcuts&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
...
$menuResponsivo_menuData['data_tb']['itens']['item_tb_5'] = array(
                                                  'label'       => $str_label,
                                                  'link'        => "menuResponsivo_form_php.php?sc_item_menu=item_tb_5&sc_apl_menu=notification&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "",
                                                  'hint'        => $str_hint,
                                                  'icon_fa'     => "fas fa-bell",
                                                  'link_target'     => "self",
                                                  'fav_check'     => "N",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menuResponsivo']))
{
    $menuResponsivo_menuData['data']['itens'] = $_SESSION['scriptcase']['sc_def_menu']['menuResponsivo'];
}
if (isset($_SESSION['scriptcase']['sc_usermenu']['menuResponsivo']))
{
    $menuResponsivo_menuData['data_user']['itens'] = $_SESSION['scriptcase']['sc_usermenu']['menuResponsivo'];
}
if (isset($_SESSION['scriptcase']['sc_def_shortcuts']['menuResponsivo']) && !empty($_SESSION['scriptcase']['sc_def_shortcuts']['menuResponsivo']))
{
    $menuResponsivo_menuData['shortcuts'] = $_SESSION['scriptcase']['sc_def_shortcuts']['menuResponsivo'];
}
if (is_file("menuResponsivo_help.txt"))
{
    $Arq_WebHelp = file("menuResponsivo_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menuResponsivo_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->menuResponsivo_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menuResponsivo']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menuResponsivo']))
{
    sc_menu_delete($menuResponsivo_menuData['data'], $_SESSION['scriptcase']['sc_menu_del']['menuResponsivo']);
    sc_menu_delete($menuResponsivo_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_del']['menuResponsivo']);
}
if (isset($_SESSION['scriptcase']['sc_menu_disable']['menuResponsivo']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menuResponsivo']))
{
    sc_menu_disable($menuResponsivo_menuData['data'], $_SESSION['scriptcase']['sc_menu_disable']['menuResponsivo']);
    sc_menu_disable($menuResponsivo_menuData['data_user'], $_SESSION['scriptcase']['sc_menu_disable']['menuResponsivo']);
}
...
<head>
 ...
 ?> 
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod']; ?>/third/font-awesome/6/css/all.min.css" type="text/css" media="screen" />
<style>
   .scTabText {
   }    <?php
...
<script type="text/javascript">
   ...
   {
           var str_location = document.getElementById('iframe_menuResponsivo').contentWindow.location.toString();
...
/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod']; ?>/third/lineicons/web-font-files/lineicons.css" /> 
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod']; ?>/third/Fuse/dist/fuse.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menuResponsivo']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menuResponsivo_message.js"></script>
...
?>
<script>
Iframe_atual = "menuResponsivo_iframe";
Aba_atual = 'nm_frame_app';
Tab_links = new Array();
<?php
echo "Tab_links['menuResponsivo']   = \"\";\r\n";
 if(isset($menuResponsivo_menuData['data']) && !empty($menuResponsivo_menuData['data']))
 {
   foreach ($menuResponsivo_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menuResponsivo_menuData['data_vertical']) && !empty($menuResponsivo_menuData['data_vertical']))
 {
   foreach ($menuResponsivo_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         echo "Tab_links['" . $dados_menu['id'] . "']   = \"\";\r\n";
 ...
 if(isset($menuResponsivo_menuData['data_user']) && !empty($menuResponsivo_menuData['data_user']))
 {
   foreach ($menuResponsivo_menuData['data_user'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         echo "Tab_links['" . $dados_menu['id'] . "']   = \"\";\r\n";
...
function writeFastMenu(arr_link)
{
    ...
    for (i = 0; i < arr_link.length; i++) 
    {
        if (link_ok != "")
        {
            link_ok += "<i class='fa-solid fa-angle-right'></i>";
        }
        link_ok += arr_link[i].replace(/#NMIframe#/g, Aba_atual);
    }
    document.getElementById('links_apls_itens').innerHTML = link_ok;
    $('#links_apls_itens').parent().show();
}
function clearFastMenu()
{
    document.getElementById('links_apls_itens').innerHTML = '';
    $('#links_apls_itens').parent().hide();
}
...
{
  if (str_id != "iframe_menuResponsivo")
  {
      str_id        = str_id.replace("menuResponsivo_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menuResponsivo', 'menuResponsivo');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_menuResponsivo').length)
        $('#iframe_menuResponsivo')[0].contentWindow.focus();
  }
}
</script>
<div id='main_menu_table' class='scMenuHMoldura'>
    <?php echo $this->menuResponsivo_MenuH($menuResponsivo_menuData, $path_imag_cab, $strAlign); ?>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menuResponsivo');\" item-href=\"menuResponsivo_form_php.php?sc_item_menu=menuResponsivo&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($menuResponsivo_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'] . "\"  item-target=\"menuResponsivo_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menuResponsivo_pag_ini.php");
} 
?>
      <iframe id="iframe_menuResponsivo" name="menuResponsivo_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: ;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
...
function menuResponsivo_Header()
{
?>
    
<?php
}function menuResponsivo_MenuH($menuResponsivo_menuData, $path_imag_cab, $strAlign)
{
?>
    <div id='idMenuLine' class='scMenuArea'>
        <?php echo $this->menuResponsivo_escreveMenu($menuResponsivo_menuData, $path_imag_cab, $strAlign); ?>
    </div>
<?php
}
function menuResponsivo_Footer()
{
?>
    
<?php
}
function menuResponsivo_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab = '')
{
    ...
    $menu_data = json_decode('{"theme":"dark-midnight","layout":"H","header_string":"Sistema Videomart Broadcast 2024","header_string_pos":"H","check_split":"N","check_toolbar":"S","check_show_search_path":"S","check_shortcut_label":"N","check_start_expanded":"S","check_use_loader":"N","should_reload":"N","layout_usr_pos":"out","usercheck":"N","username":"\" . $_SESSION[\'usr_name\'] . \"","userimage":"\" . $_SESSION[\'usr_picture\'] . \"","userdesc":"\" . $_SESSION[\'usr_login\'] . \" \/ \" . $_SESSION[\'usr_email\'] . \" \/ \" . $_SESSION[\'usr_phone\'] . \"","logo":"..\/_lib\/img\/sys__NM__bg__NM__LogoPretoNovo.png.webp","logo_compact":"..\/_lib\/img\/sys__NM__bg__NM__iconeVM.png","pick_themes":["dark-cobalt","dark-coffee","dark-sunset","dark-rhino","dark-pink","dark-hyper-space","dark-midnight","light-gray"],"shortcuts":["item_34","item_33"],"items":[{"text":"                                                           ","app":"","icon":"","icon_check":"S","id":"item_57","hint":"ESPA\u00c7O A ESQUERDA","link_target":"self","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"},{"text":"Home","app":"dashboard","icon":"fas fa-file","icon_check":"S","id":"item_56","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Oportunidades","app":"","icon":"fas fa-asterisk","icon_check":"S","id":"item_1","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Leads","app":"grid_leads","icon":"fas fa-address-book","icon_check":"S","id":"item_10","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Follow-UP","app":"grid_followup","icon":"fab fa-accusoft","icon_check":"S","id":"item_11","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Relat\u00f3rios","app":"","icon":"fas fa-file","icon_check":"S","id":"item_77","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Analise Produtos X Propostas","app":"GridAnaliseProdutosPropostos","icon":"fab fa-apple","icon_check":"S","id":"item_19","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Gr\u00e1fico de Vendas","app":"chart_proposta","icon":"fas fa-file","icon_check":"S","id":"item_79","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Registro de Vendas  linha VM","app":"grid_sistemas_vm","icon":"fas fa-file","icon_check":"S","id":"item_18","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Consulta clientes X produtos","app":"GridClientesProduto","icon":"fas fa-file","icon_check":"S","id":"item_78","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Neg\u00f3cios","app":"","icon":"fas fa-file-invoice-dollar","icon_check":"S","id":"item_2","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Vendas","app":"","icon":"fas fa-file","icon_check":"S","id":"item_76","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Propostas","app":"grid_proposta","icon":"fas fa-file","icon_check":"S","id":"item_12","hint":"Propostas","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Termos de proposta","app":"grid_termos","icon":"fas fa-file","icon_check":"S","id":"item_30","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Clentes","app":"","icon":"fas fa-file","icon_check":"S","id":"item_75","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Cadastro de Empresas","app":"grid_empresa","icon":"fas fa-file","icon_check":"S","id":"item_13","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cadastro de Contatos","app":"grid_contato","icon":"fas fa-file","icon_check":"S","id":"item_20","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Empresas duplicadas","app":"grid_empresa_duplicadas","icon":"fas fa-file","icon_check":"S","id":"item_17","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Categoria de empresas","app":"grid_categoria","icon":"fas fa-file","icon_check":"S","id":"item_27","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Produtos","app":"","icon":"fas fa-file","icon_check":"S","id":"item_59","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Produtos","app":"grid_produto","icon":"fas fa-file","icon_check":"S","id":"item_14","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Classes","app":"grid_classe","icon":"fas fa-file","icon_check":"S","id":"item_25","hint":"Classes de produtos","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Marcas","app":"grid_marca","icon":"fas fa-file","icon_check":"S","id":"item_28","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Perfis de MarkUp","app":"form_markup","icon":"fas fa-file","icon_check":"S","id":"item_60","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Custos de Markup","app":"form_markup_custo","icon":"fas fa-file","icon_check":"S","id":"item_61","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"C\u00f3digo situa\u00e7\u00e3o tribut\u00e1ria","app":"grid_cst","icon":"fas fa-file","icon_check":"S","id":"item_33","hint":"","link_target":"self","fav_check":"S","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Comiss\u00f5es","app":"grid_comissao","icon":"fas fa-file","icon_check":"S","id":"item_16","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Cadastros","app":"","icon":"fas fa-microphone-alt","icon_check":"S","id":"item_3","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Transportadoras","app":"grid_transportadoras","icon":"fas fa-file","icon_check":"N","id":"item_21","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cidades","app":"grid_cidade","icon":"fas fa-file","icon_check":"N","id":"item_23","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"UF","app":"grid_uf","icon":"fas fa-file","icon_check":"N","id":"item_24","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Redes de TV","app":"grid_rede","icon":"fas fa-file","icon_check":"N","id":"item_29","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"CFOP","app":"grid_operacoes","icon":"fas fa-file","icon_check":"N","id":"item_31","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cadastro de funcion\u00e1rios","app":"grid_funcionario","icon":"fas fa-file","icon_check":"N","id":"item_32","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Status de servi\u00e7os","app":"grid_status","icon":"fas fa-file","icon_check":"N","id":"item_34","hint":"","link_target":"self","fav_check":"S","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Servi\u00e7os","app":"","icon":"fab fa-servicestack","icon_check":"S","id":"item_4","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Licen\u00e7a de sistemas VM","app":"grid_licenca","icon":"fab fa-angular","icon_check":"S","id":"item_36","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Ordem de servi\u00e7o","app":"grid_service","icon":"fas fa-file","icon_check":"N","id":"item_35","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Financeiro","app":"","icon":"fas fa-file","icon_check":"N","id":"item_38","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cota\u00e7\u00e3o Dolar","app":"grid_dolar","icon":"fas fa-file","icon_check":"N","id":"item_39","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Estrato de contas","app":"grid_contas","icon":"fas fa-file","icon_check":"N","id":"item_40","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Movimentar contas","app":"form_contas","icon":"fas fa-file","icon_check":"N","id":"item_41","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Subcontas","app":"grid_subconta","icon":"fas fa-file","icon_check":"N","id":"item_42","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Marketing","app":"","icon":"fas fa-map-marked","icon_check":"S","id":"item_5","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Contatos no sistema","app":"Grid_MailingList_Contatos","icon":"fas fa-file","icon_check":"N","id":"item_44","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Contatos atrav\u00e9s do site-VM","app":"grid_mailing","icon":"fas fa-file","icon_check":"N","id":"item_43","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Estoque","app":"","icon":"fas fa-hand-paper","icon_check":"S","id":"item_6","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Trackling","app":"grid_tracking","icon":"fas fa-file","icon_check":"N","id":"item_45","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Ordem de compra","app":"grid_cotacao","icon":"fas fa-file","icon_check":"N","id":"item_46","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cotar","app":"form_cotacao","icon":"fas fa-file","icon_check":"N","id":"item_47","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Cadastra pre\u00e7os","app":"form_price","icon":"fas fa-file","icon_check":"N","id":"item_48","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Consulta pre\u00e7os","app":"grid_price","icon":"fas fa-file","icon_check":"N","id":"item_49","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Controle de estoque","app":"grid_estoque","icon":"fas fa-file","icon_check":"N","id":"item_50","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Relat\u00f3rios","app":"","icon":"fas fa-bug","icon_check":"S","id":"item_7","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"Empresas devedoras","app":"grid_devedoras","icon":"fas fa-file","icon_check":"N","id":"item_52","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Resultado Operacional","app":"grid_resultado_financeiro","icon":"fas fa-file","icon_check":"N","id":"item_53","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Maiores compradoras","app":"MaioresCompradoras","icon":"fas fa-file","icon_check":"N","id":"item_54","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"Empresas credoras","app":"grid_credoras","icon":"fas fa-file","icon_check":"S","id":"item_55","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Setup","app":"form_setup","icon":"fas fa-hammer","icon_check":"S","id":"item_8","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"},{"text":"{lang_menu_security}","app":"","icon":"fas fa-cog","icon_check":"S","id":"item_80","link_target":"self","fav_check":"N","hint":"","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"children":[{"text":"{lang_list_users}","app":"app_grid_sec_users","icon":"fas fa-cog","icon_check":"S","id":"item_81","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","mega_check":"N"},{"text":"{lang_list_apps}","app":"app_grid_sec_apps","icon":"fas fa-cog","icon_check":"S","id":"item_82","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","mega_check":"N"},{"text":"{lang_list_groups}","app":"app_grid_sec_groups","icon":"fas fa-cog","icon_check":"S","id":"item_83","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"{lang_list_users_x_groups}","app":"app_grid_sec_users_groups","icon":"fas fa-cog","icon_check":"S","id":"item_90","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","mega_check":"N"},{"text":"{lang_list_apps_x_groups}","app":"app_search_sec_groups","icon":"fas fa-cog","icon_check":"S","id":"item_84","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","mega_check":"N"},{"text":"{lang_list_sync_apps}","app":"app_sync_apps","icon":"fas fa-cog","icon_check":"S","id":"item_85","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"{lang_2fa}","app":"app_add_2fa","icon":"fas fa-cog","icon_check":"S","id":"item_91","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"{lang_settings}","app":"app_settings","icon":"fas fa-cog","icon_check":"S","id":"item_92","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"{lang_change_pswd}","app":"app_change_pswd","icon":"fas fa-cog","icon_check":"S","id":"item_86","hint":"","link_target":"self","fav_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","mega_check":"N"}],"target":"_self","mega_check":"N"},{"text":"Sair","app":"https:\/\/www.videomart.com.br","icon":"fas fa-ankh","icon_check":"S","id":"item_9","hint":"{lang_exit}","link_target":"parente","fav_check":"N","mega_check":"N","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self"}],"user_items":[{"text":"{lang_sec_edit_profile}","app":"app_my_info","icon":"fas fa-user","icon_check":"S","id":"item_user_1","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N","mega_check":"N"},{"text":"{lang_change_pswd}","app":"app_change_pswd","icon":"fas fa-key","icon_check":"S","id":"item_user_3","hint":"","link_target":"self","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N","mega_check":"N"},{"text":"{lang_exit}","app":"app_Login","icon":"fas fa-sign-out-alt","icon_check":"S","id":"item_user_2","hint":"","link_target":"parente","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","fav_check":"N","mega_check":"N"}],"tb_items":[{"text":"Filtro","app":"search","icon":"fas fa-search","icon_check":"S","display":"N","id":"item_tb_1","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Idiomas","app":"languages","icon":"fas fa-globe","icon_check":"S","display":"N","id":"item_tb_2","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Temas","app":"themes","icon":"fas fa-paint-roller","icon_check":"S","display":"S","id":"item_tb_3","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Atalhos","app":"shortcuts","icon":"fas fa-grip-vertical","icon_check":"S","display":"N","id":"item_tb_4","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"},{"text":"Notifica\u00e7\u00f5es","app":"notification","icon":"fas fa-bell","icon_check":"S","display":"N","id":"item_tb_5","itree":{"a":{"attributes":[]},"icon":false,"li":{"attributes":[]}},"target":"_self","hint":"","fav_check":"N","mega_check":"N","link_target":"self"}],"font_string":"Open Sans","notif_login_var":"\" . $_SESSION[\'usr_login\'] . \"","notif_data":{"notif_table":"notif_notifications","notif_id":"notif_id","notif_title":"notif_title","notif_message":"notif_message","notif_dtexpire":"notif_dtexpire","notif_login_sender":"notif_login_sender","notif_categ":"notif_categ","notif_type":"notif_type","notif_link":"notif_link","inbox_table":"notif_inbox","inbox_field_notif_id":"notif_id","inbox_field_ontop":"notif_ontop","inbox_field_userid":"login","inbox_field_isread":"notif_isread","inbox_field_read_date":"notif_dtread","inbox_field_sent_date":"notif_dtsent","inbox_field_tag":"notif_tags","inbox_field_important":"notif_important","user_table":"sec_users","user_login":"login","user_fullname":"name","user_image":"picture","notif_connection":""},"notif_open_all_app":"","notif_refresh_interval":"10000","notif_limit":"10"}', true);
    ...
    $apl_link_build = "menuResponsivo_form_php.php?sc_item_menu=notif_app_link&sc_apl_menu=###APPNAME###&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'];

    $apl_default = 'dashboard';
    $apl_name_ref_sc = 'menuResponsivo';
    if (isset($_SESSION['scriptcase']['sc_apl_seg'][ $apl_default ]) && $_SESSION['scriptcase']['sc_apl_seg'][ $apl_default ] == 'on')
    {
        $apl_default = "menuResponsivo_form_php.php?sc_item_menu=menuResponsivo&sc_apl_menu=" . $apl_default . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'];
    }
    if (isset($menu_data['notif_open_all_app']) && !empty($menu_data['notif_open_all_app']))
    {
        $menu_data['notif_open_all_app'] = "menuResponsivo_form_php.php?sc_item_menu=notif_see_all&sc_apl_menu=" . $menu_data['notif_open_all_app'] . "&sc_apl_link=" . urlencode($arr_menu_apl['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menuResponsivo']['glo_nm_usa_grupo'];
    }
...
?>
  ...
  <!-- template -->
  <section class="ae-menubar menubar" role="toolbar" aria-orientation="horizontal" tabindex="0" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-midnight"; ?>">
    <div class="wrapper">
      <div class="logo"><a id="sc-menu-link-home" href="./"><span class="only-sr">Scriptcase menubar home </span><img
            class="d-none xl:d-block" src="<?php echo "../_lib/img/sys__NM__bg__NM__LogoPretoNovo.png.webp"; ?>"
            aria-hidden="true" /><img class="d-block xl:d-none"
            src="<?php echo "../_lib/img/sys__NM__bg__NM__iconeVM.png"; ?>" aria-hidden="true" /></a></div>
...
<script>
  ...
  <section class="ae-menubar tabsbar" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-midnight"; ?>" aria-orientation="horizontal">
   ...
   <style>
    .ae-menubar.breadcrumbs {
        ...
        justify-content: center;
        align-items: flex-start;
        background-color: var(--theme-menubar-nav-submenu-backgroundColor\:hover);
        opacity: .6;
        z-index: auto;
    }

    .ae-menubar.breadcrumbs #links_apls_itens {
        display: flex;
        flex-direction: row;
        align-items: center;
        justify-content: flex-start;
    ...
    .ae-menubar.breadcrumbs #links_apls_itens > img {
        visibility: hidden;
        width: auto;
        margin: 5px;
    }

    .ae-menubar.breadcrumbs #links_apls_itens > img:after {
        content: '›';
        visibility: visible;
        color: var(--theme-color-text);
        margin-left: -10px;
    ...
    .ae-menubar.breadcrumbs #links_apls_itens > a, .ae-menubar.breadcrumbs #links_apls_itens > i {
        color: var(--theme-color-text);
        font-size: .825rem;
        white-space: nowrap;
        display: block;
    ...
    .ae-menubar.breadcrumbs #links_apls_itens > i {
        font-size: 0.5vw;
        padding: 0px 4px;
    }

    .ae-menubar.breadcrumbs #links_apls_itens > a:hover {
        text-decoration: underline;
    }

</style>
<section class="ae-menubar breadcrumbs" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-midnight"; ?>" aria-orientation="horizontal" style="display: none;"></section> <script> 
function openTabBreadCrumb(e)
{
    if($('#links_apls_itens').attr('data-enabled') == 'enabled')
    {
        if(Aba_atual != e.id && Aba_atual != '') {
            Tab_links[Aba_atual] = $('#links_apls_itens').html();
        }
        Aba_atual = e.id;
        $('#links_apls_itens').html('');
        if(typeof Tab_links[Aba_atual] !== 'undefined') {
            $('#links_apls_itens').html(Tab_links[Aba_atual]);
        }
        if($('#links_apls_itens').html()!='') {
            $('#links_apls_itens').closest('section.breadcrumbs').show();
        } else {
            $('#links_apls_itens').closest('section.breadcrumbs').hide();
        }
    }
}
function startCrumbs() {
    $('#links_apls_itens').appendTo('.ae-menubar.breadcrumbs');
    $('#links_apls_itens').attr('data-enabled', 'enabled');
} </script> 
  <div class="frame-container" id="app-frames" data-aetheme="<?php echo ( isset($_COOKIE["menuTheme"]) && !empty($_COOKIE["menuTheme"]) && in_array($_COOKIE["menuTheme"], $menu_data["pick_themes"]) ) ? $_COOKIE["menuTheme"] : "dark-midnight"; ?>">
...
}function menuResponsivo_escreveMenu($arr_menu_apl, $path_imag_cab = '', $strAlign = '')
{
        ...
        <div class='menu menu--horizontal'>
            ...
            <div class='menu__container scMenuHTableCssAlt'>
                <div class='menu__layer'>
                    <?php
                    $this->menuResponsivo_escreveMenuRec($arr_menu, $arr_menu_apl, $path_imag_cab, 'menu__list');
                    ?>
                </div>
            </div>
        </div><?php
}
function menuResponsivo_target($str_target)
{
   ...
   {
        $_SESSION['scriptcase']['menuResponsivo']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
$contr_menuResponsivo = new menuResponsivo_class;
$contr_menuResponsivo->menuResponsivo_menu();
