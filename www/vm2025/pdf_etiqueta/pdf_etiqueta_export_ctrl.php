<?php
@session_start() ;
$_SESSION['scriptcase']['pdf_etiqueta']['sc_process_barr'] = true;
require_once('../pdf_etiqueta/index.php');
unset($_SESSION['scriptcase']['pdf_etiqueta']['sc_process_barr']);
$ExportCtrl = new pdf_etiqueta_export_control;
$ExportCtrl->Export_barr();

class pdf_etiqueta_export_control
{
