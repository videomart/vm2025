...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____pdf_etiqueta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____pdf_etiqueta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pdf_etiqueta']['embutida_filho'] as $ind => $sc_init)
          {
