...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdf_etiqueta/pdf_etiqueta_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "pdf_etiqueta_res_xls.class.php");
              $this->Res_xls = new pdf_etiqueta_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdf_etiqueta.zip";
          $this->Arquivo   .= "_pdf_etiqueta" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_empresa_inscmun()
   {
         ...
         $this->empresa_inscmun = html_entity_decode($this->empresa_inscmun, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->empresa_inscmun = strip_tags($this->empresa_inscmun);
         $this->empresa_inscmun = NM_charset_to_utf8($this->empresa_inscmun);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->empresa_inscmun, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->empresa_inscmun, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- empresa_empresa
   ...
   //----- empresa_telefone
   function NM_sub_cons_empresa_telefone()
   {
         $this->empresa_telefone = html_entity_decode($this->empresa_telefone, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->empresa_telefone = strip_tags($this->empresa_telefone);
         $this->empresa_telefone = NM_charset_to_utf8($this->empresa_telefone);
   ...
   //----- empresa_inscmun
   function NM_sub_cons_empresa_inscmun()
   {
         $this->empresa_inscmun = html_entity_decode($this->empresa_inscmun, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->empresa_inscmun = strip_tags($this->empresa_inscmun);
         $this->empresa_inscmun = NM_charset_to_utf8($this->empresa_inscmun);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->empresa_inscmun;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdf_etiqueta']['nolabel'])
       {
