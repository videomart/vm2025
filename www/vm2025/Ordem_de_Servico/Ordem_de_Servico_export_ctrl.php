<?php
@session_start() ;
$_SESSION['scriptcase']['Ordem_de_Servico']['sc_process_barr'] = true;
require_once('../Ordem_de_Servico/index.php');
unset($_SESSION['scriptcase']['Ordem_de_Servico']['sc_process_barr']);
$ExportCtrl = new Ordem_de_Servico_export_control;
$ExportCtrl->Export_barr();

class Ordem_de_Servico_export_control
{
