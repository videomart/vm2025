...
?>
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_cst_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cst'])) ? $this->New_label['cst'] : "cst"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_cst_cond" name="cst_cond" onChange="nm_campos_between(document.getElementById('id_vis_cst'), this, 'cst')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cst" <?php echo $str_hide_cst?> valign="top">
...
?>
<INPUT  type="text" id="SC_cst" name="cst" value="<?php echo NM_encode_input($cst) ?>"  size=3 alt="{datatype: 'text', maxLength: 3, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
...
?>
<INPUT  type="text" id="SC_descricao" name="descricao" value="<?php echo NM_encode_input($descricao) ?>"  size=50 alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
