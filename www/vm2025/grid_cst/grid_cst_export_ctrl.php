<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cst']['sc_process_barr'] = true;
require_once('../grid_cst/index.php');
unset($_SESSION['scriptcase']['grid_cst']['sc_process_barr']);
$ExportCtrl = new grid_cst_export_control;
$ExportCtrl->Export_barr();

class grid_cst_export_control
{
