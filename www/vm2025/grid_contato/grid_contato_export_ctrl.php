<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contato']['sc_process_barr'] = true;
require_once('../grid_contato/index.php');
unset($_SESSION['scriptcase']['grid_contato']['sc_process_barr']);
$ExportCtrl = new grid_contato_export_control;
$ExportCtrl->Export_barr();

class grid_contato_export_control
{
