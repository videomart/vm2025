...
<?php
   ...
   $Ord_Cmp = new grid_contato_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["id"] : "ID";
   $tab_ger_campos['id_empresa'] = "on";
   $tab_def_campos['id_empresa'] = "ID_EMPRESA";
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["id_empresa"] : "EMPRESA";
   $tab_ger_campos['contato'] = "on";
   $tab_def_campos['contato'] = "CONTATO";
   $tab_labels["contato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["contato"])) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["contato"] : "CONTATO";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "TELEFONE";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["telefone"] : "TELEFONE";
   $tab_ger_campos['celular'] = "on";
   $tab_def_campos['celular'] = "CELULAR";
   $tab_labels["celular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["celular"])) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["celular"] : "CELULAR";
   $tab_ger_campos['whatsapp'] = "on";
   $tab_def_campos['whatsapp'] = "WHATSAPP";
   $tab_labels["whatsapp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["whatsapp"])) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['labels']["whatsapp"] : "WHATSAPP";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contato_order_campos.php",
    data: {
...
<div class="sc_ui_sortable-wrapper" id="sorting_list_ord_campos">
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contato']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
