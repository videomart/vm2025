<?php
@session_start() ;
$_SESSION['scriptcase']['grid_price']['sc_process_barr'] = true;
require_once('../grid_price/index.php');
unset($_SESSION['scriptcase']['grid_price']['sc_process_barr']);
$ExportCtrl = new grid_price_export_control;
$ExportCtrl->Export_barr();

class grid_price_export_control
{
