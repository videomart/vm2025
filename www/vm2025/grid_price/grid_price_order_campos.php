...
<?php
   ...
   $Ord_Cmp = new grid_price_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_price_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_price']['labels']["id_modelo"])) ? $_SESSION['sc_session'][$sc_init]['grid_price']['labels']["id_modelo"] : "Modelo";
   $tab_ger_campos['id_empresa'] = "on";
   $tab_def_campos['id_empresa'] = "ID_EMPRESA";
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_price']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_price']['labels']["id_empresa"] : "Dealer";
   $tab_ger_campos['moeda'] = "on";
   $tab_def_campos['moeda'] = "MOEDA";
   $tab_labels["moeda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_price']['labels']["moeda"])) ? $_SESSION['sc_session'][$sc_init]['grid_price']['labels']["moeda"] : "Moeda";
   $tab_ger_campos['fob'] = "on";
   $tab_def_campos['fob'] = "FOB";
   $tab_labels["fob"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_price']['labels']["fob"])) ? $_SESSION['sc_session'][$sc_init]['grid_price']['labels']["fob"] : "Fob";
   $tab_ger_campos['peso'] = "on";
   $tab_def_campos['peso'] = "PESO";
   $tab_labels["peso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_price']['labels']["peso"])) ? $_SESSION['sc_session'][$sc_init]['grid_price']['labels']["peso"] : "Peso";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "DATA";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_price']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_price']['labels']["data"] : "Data";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_price']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_price']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_price']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_price']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_price']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_price_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_price']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
