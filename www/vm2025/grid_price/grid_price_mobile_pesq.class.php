...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_numeric[] = "id";$Nm_numeric[] = "id_empresa";$Nm_numeric[] = "fob";$Nm_numeric[] = "peso";$Nm_numeric[] = "id_modelo";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_id_empresa"  <?php echo $str_hide_id_empresa?>><INPUT  type="text" id="SC_id_empresa" name="id_empresa" value="<?php echo NM_encode_input($id_empresa) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_moeda_cond" name="moeda_cond" onChange="nm_campos_between(document.getElementById('id_vis_moeda'), this, 'moeda')">
      ...
      <br><span id="id_hide_moeda"  <?php echo $str_hide_moeda?>><INPUT  type="text" id="SC_moeda" name="moeda" value="<?php echo NM_encode_input($moeda) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_fob_cond" name="fob_cond" onChange="nm_campos_between(document.getElementById('id_vis_fob'), this, 'fob')">
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_peso_cond" name="peso_cond" onChange="nm_campos_between(document.getElementById('id_vis_peso'), this, 'peso')">
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_data_cond" name="data_cond" onChange="nm_campos_between(document.getElementById('id_vis_data'), this, 'data')">
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_obs_cond" name="obs_cond" onChange="nm_campos_between(document.getElementById('id_vis_obs'), this, 'obs')">
      ...
      <br><span id="id_hide_obs"  <?php echo $str_hide_obs?>><INPUT  type="text" id="SC_obs" name="obs" value="<?php echo NM_encode_input($obs) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
