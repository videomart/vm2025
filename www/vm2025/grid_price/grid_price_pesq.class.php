...
class grid_price_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_price_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_price_pack_protect_string($Tipo_filter[0]) . "\">.." . htmlspecialchars(grid_price_pack_protect_string($Cada_filter) , ENT_QUOTES, 'UTF-8').  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_delete")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              $Opt_filter .= "<option value=\"" . grid_price_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_price_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "II":     // 
               $op_all = " like ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_strt'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . ":</span> " . str_replace(array("##ini##","##fim##"), array("<span class='scGridFilterDynValue'>","</span>"),$NM_cond) . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . sc_sql_escape($this->Ini->nm_tpbanco, $campo) . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'] . $_SESSION['sc_session']['sc_sql_escape'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $lang_like . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_diff'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " <span class='scGridFilterDynValue'>" . nm_encode_input($this->cmp_formatado[$nome_campo]) . "</span>##*@@";
            break;
            case "BW":     // 
            ...
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_equl'] . " <span class='scGridFilterDynValue'>" . $nm_cond . "</span>##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= "<span class='scGridFilterDynField'>" . $nmgp_tab_label[$nome_campo] . "</span> " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - price</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_price/grid_price_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_price_ajax_search.js"></script>
 <script type="text/javascript" src="grid_price_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_price_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_price']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_price']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_empresa#NMF#' + search_get_text('SC_id_empresa') + '@NMF@';
  str_out += 'SC_moeda_cond#NMF#' + search_get_sel_txt('SC_moeda_cond') + '@NMF@';
  str_out += 'SC_moeda#NMF#' + search_get_text('SC_moeda') + '@NMF@';
  str_out += 'SC_fob_cond#NMF#' + search_get_sel_txt('SC_fob_cond') + '@NMF@';
  str_out += 'SC_fob#NMF#' + search_get_text('SC_fob') + '@NMF@';
  str_out += 'SC_peso_cond#NMF#' + search_get_sel_txt('SC_peso_cond') + '@NMF@';
  str_out += 'SC_peso#NMF#' + search_get_text('SC_peso') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $fob_cond, $fob,
             $peso_cond, $peso,
             $data_cond, $data, $data_dia, $data_mes, $data_ano, $data_hor, $data_min, $data_seg,
             $obs_cond, $obs,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id_cond']; 
          $id_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id_empresa']; 
          $id_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id_empresa_cond']; 
          $moeda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['moeda']; 
          $moeda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['moeda_cond']; 
          $fob = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['fob']; 
          $fob_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['fob_cond']; 
          $peso = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['peso']; 
          $peso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['peso_cond']; 
          $data_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_dia']; 
          $data_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_mes']; 
          $data_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_ano']; 
          $data_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_hor']; 
          $data_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_min']; 
          $data_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_seg']; 
          $data_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_cond']; 
          $obs = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['obs']; 
          $obs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['obs_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($id_empresa_cond) != "II" && strtoupper($id_empresa_cond) != "QP" && strtoupper($id_empresa_cond) != "NP" && strtoupper($id_empresa_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_empresa, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($fob_cond) != "II" && strtoupper($fob_cond) != "QP" && strtoupper($fob_cond) != "NP" && strtoupper($fob_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($fob, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($peso_cond) != "II" && strtoupper($peso_cond) != "QP" && strtoupper($peso_cond) != "NP" && strtoupper($peso_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($peso, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($moeda_cond) || empty($moeda_cond))
      {
         $moeda_cond = "eq";
      }
      if (!isset($fob_cond) || empty($fob_cond))
      {
         $fob_cond = "eq";
      }
      if (!isset($peso_cond) || empty($peso_cond))
      {
         $peso_cond = "eq";
      }
      ...
      $str_hide_moeda = (in_array($moeda_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fob = (in_array($fob_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_peso = (in_array($peso_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=8 alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_empresa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_empresa'])) ? $this->New_label['id_empresa'] : "Dealer"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_id_empresa_cond" name="id_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_empresa'), this, 'id_empresa')">
       ...
       <OPTION value="ii" <?php if ("ii" == $id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $id_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_id_empresa" name="id_empresa" value="<?php echo NM_encode_input($id_empresa) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_moeda_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['moeda'])) ? $this->New_label['moeda'] : "Moeda"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_moeda_cond" name="moeda_cond" onChange="nm_campos_between(document.getElementById('id_vis_moeda'), this, 'moeda')">
       <OPTION value="eq" <?php if ("eq" == $moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $moeda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_moeda" <?php echo $str_hide_moeda?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['moeda'])) ? $this->New_label['moeda'] : "Moeda";
 $nmgp_tab_label .= "moeda?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_moeda" name="moeda" value="<?php echo NM_encode_input($moeda) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_fob_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fob'])) ? $this->New_label['fob'] : "Fob"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_fob_cond" name="fob_cond" onChange="nm_campos_between(document.getElementById('id_vis_fob'), this, 'fob')">
       <OPTION value="eq" <?php if ("eq" == $fob_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $fob_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $fob_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $fob_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fob" <?php echo $str_hide_fob?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['fob'])) ? $this->New_label['fob'] : "Fob";
 $nmgp_tab_label .= "fob?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<INPUT  type="text" id="SC_fob" name="fob" value="<?php echo NM_encode_input($fob) ?>" size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 0, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
      ...
      <TD id='SC_peso_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['peso'])) ? $this->New_label['peso'] : "Peso"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_peso_cond" name="peso_cond" onChange="nm_campos_between(document.getElementById('id_vis_peso'), this, 'peso')">
       <OPTION value="eq" <?php if ("eq" == $peso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $peso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $peso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $peso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_peso" <?php echo $str_hide_peso?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['peso'])) ? $this->New_label['peso'] : "Peso";
 $nmgp_tab_label .= "peso?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<INPUT  type="text" id="SC_peso" name="peso" value="<?php echo NM_encode_input($peso) ?>" size=12 alt="{datatype: 'decimal', maxLength: 12, precision: 0, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
      ...
      <TD id='SC_data_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['data'])) ? $this->New_label['data'] : "Data"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven " id="SC_data_cond" name="data_cond" onChange="nm_campos_between(document.getElementById('id_vis_data'), this, 'data')">
       <OPTION value="eq" <?php if ("eq" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $data_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_dia" name="data_dia" value="<?php echo NM_encode_input($data_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_mes" name="data_mes" value="<?php echo NM_encode_input($data_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_ano" name="data_ano" value="<?php echo NM_encode_input($data_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_hor" name="data_hor" value="<?php echo NM_encode_input($data_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_min" name="data_min" value="<?php echo NM_encode_input($data_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven " type="text" id="SC_data_seg" name="data_seg" value="<?php echo NM_encode_input($data_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
      ...
      <TD id='SC_obs_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['obs'])) ? $this->New_label['obs'] : "OBS"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd " id="SC_obs_cond" name="obs_cond" onChange="nm_campos_between(document.getElementById('id_vis_obs'), this, 'obs')">
       <OPTION value="eq" <?php if ("eq" == $obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $obs_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<INPUT  type="text" id="SC_obs" name="obs" value="<?php echo NM_encode_input($obs) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
...
?>
<?php
   if (is_file("grid_price_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_price']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_price']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_empresa_cond.value = 'eq';
   ...
   document.F1.moeda_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_moeda'), document.F1.moeda_cond, 'moeda');
   document.F1.moeda.value = "";
   document.F1.fob_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fob'), document.F1.fob_cond, 'fob');
   document.F1.fob.value = "";
   document.F1.peso_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_peso'), document.F1.peso_cond, 'peso');
   document.F1.peso.value = "";
   ...
   document.F1.obs_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_obs'), document.F1.obs_cond, 'obs');
   document.F1.obs.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_data_dia').bind('change', function() {sc_grid_price_valida_dia(this)});
    $('#SC_data_hor').bind('change', function() {sc_grid_price_valida_hora(this)});
    $('#SC_data_mes').bind('change', function() {sc_grid_price_valida_mes(this)});
    $('#SC_data_min').bind('change', function() {sc_grid_price_valida_min(this)});
    $('#SC_data_seg').bind('change', function() {sc_grid_price_valida_seg(this)});
 }
 function sc_grid_price_valida_dia(obj)
 {
 ...
 function sc_grid_price_valida_mes(obj)
 {
 ...
 function sc_grid_price_valida_hora(obj)
 {
 ...
 function sc_grid_price_valida_min(obj)
 {
 ...
 function sc_grid_price_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
             ...
             if (@is_file($this->NM_path_filter . $NM_patch . "/" . $NM_arq))
             {
                 ...
                 if (substr($NMcmp_filter[0], 0, 6) == "SC_V6_" || substr($NMcmp_filter[0], 0, 6) == "SC_V8_")
                 {
                     ...
                     if (!empty($Name_filter))
                     {
                         ...
                         if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                         {
                             $this->NM_fil_ant[$NM_arq][1] = sc_convert_encoding("P̼blico", $_SESSION['scriptcase']['charset'], "UTF-8");
                         }
                         else
                         {
                             $this->NM_fil_ant[$NM_arq][1] = "P̼blico";
                         }
                         $Sc_v6 = true;
                     }
                 }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['where_orig']))
      {
   ...
   function init_comando()
   {
      ...
      $this->comando         = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['where_orig'];
      $this->comando_sum     = "";
      $this->comando_filtro  = "";
   ...
   function recupera_filtro($NM_filters, $Orig_Fil)
   {
      ...
      $tp_fields['SC_id_empresa'] = 'text';
      $tp_fields['SC_moeda_cond'] = 'cond';
      $tp_fields['SC_moeda'] = 'text';
      $tp_fields['SC_fob_cond'] = 'cond';
      $tp_fields['SC_fob'] = 'text';
      $tp_fields['SC_peso_cond'] = 'cond';
      $tp_fields['SC_peso'] = 'text';
   ...
   function trata_campos()
   {
      ...
      $moeda_cond_salva = $moeda_cond; 
      if (!isset($moeda_input_2) || $moeda_input_2 == "")
      {
          $moeda_input_2 = $moeda;
      }
      $fob_cond_salva = $fob_cond; 
      if (!isset($fob_input_2) || $fob_input_2 == "")
      {
          $fob_input_2 = $fob;
      }
      $peso_cond_salva = $peso_cond; 
      if (!isset($peso_input_2) || $peso_input_2 == "")
      {
          $peso_input_2 = $peso;
      }
      ...
      if ($id_empresa_cond != "in")
      {
          nm_limpa_numero($id_empresa, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($fob_cond != "in")
      {
          nm_limpa_numero($fob, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($peso_cond != "in")
      {
          nm_limpa_numero($peso, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id_empresa'] = $id_empresa; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['id_empresa_cond'] = $id_empresa_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['moeda'] = $moeda; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['moeda_cond'] = $moeda_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['fob'] = $fob; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['fob_cond'] = $fob_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['peso'] = $peso; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['peso_cond'] = $peso_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_dia'] = $data_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_mes'] = $data_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_ano'] = $data_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_hor'] = $data_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_min'] = $data_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_seg'] = $data_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_cond'] = $data_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['obs'] = $obs; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['obs_cond'] = $obs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca'] = $Temp_Busca;
      }
      if ($fob_cond != "in" && $fob_cond != "bw" && !empty($fob) && !is_numeric($fob))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Fob";
      }
      if ($fob_cond == "bw" && ((!empty($fob) && !is_numeric($fob)) || (!empty($fob_input_2) && !is_numeric($fob_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Fob";
      }
      if ($peso_cond != "in" && $peso_cond != "bw" && !empty($peso) && !is_numeric($peso))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Peso";
      }
      if ($peso_cond == "bw" && ((!empty($peso) && !is_numeric($peso)) || (!empty($peso_input_2) && !is_numeric($peso_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Peso";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $Conteudo = $moeda;
      $this->cmp_formatado['moeda'] = $Conteudo;
      $this->cmp_formatado['moeda'] = "'" . $this->cmp_formatado['moeda'] . "'";
      if (isset($this->cmp_formatado['moeda_input_2'])  && !empty($this->cmp_formatado['moeda_input_2'])) {
          $this->cmp_formatado['moeda_input_2'] = "'" . $this->cmp_formatado['moeda_input_2'] . "'";
      }
      $Conteudo = $fob;
      if (strtoupper($fob_cond) != "II" && strtoupper($fob_cond) != "QP" && strtoupper($fob_cond) != "NP" && strtoupper($fob_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['fob'] = $Conteudo;
      $this->cmp_formatado['fob'] = "'" . $this->cmp_formatado['fob'] . "'";
      if (isset($this->cmp_formatado['fob_input_2'])  && !empty($this->cmp_formatado['fob_input_2'])) {
          $this->cmp_formatado['fob_input_2'] = "'" . $this->cmp_formatado['fob_input_2'] . "'";
      }
      $Conteudo = $peso;
      if (strtoupper($peso_cond) != "II" && strtoupper($peso_cond) != "QP" && strtoupper($peso_cond) != "NP" && strtoupper($peso_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['peso'] = $Conteudo;
      $this->cmp_formatado['peso'] = "'" . $this->cmp_formatado['peso'] . "'";
      if (isset($this->cmp_formatado['peso_input_2'])  && !empty($this->cmp_formatado['peso_input_2'])) {
          $this->cmp_formatado['peso_input_2'] = "'" . $this->cmp_formatado['peso_input_2'] . "'";
      }
      ...
      $Conteudo = $obs;
      $this->cmp_formatado['obs'] = $Conteudo;
      $this->cmp_formatado['obs'] = "'" . $this->cmp_formatado['obs'] . "'";
      if (isset($this->cmp_formatado['obs_input_2'])  && !empty($this->cmp_formatado['obs_input_2'])) {
          $this->cmp_formatado['obs_input_2'] = "'" . $this->cmp_formatado['obs_input_2'] . "'";
      }
   }
   ...
   function processa_campos($Res_comp='pesq')
   {
      ...
      //----- $id_empresa
      $this->Date_part = false;
      if (isset($id_empresa) || $id_empresa_cond == "nu" || $id_empresa_cond == "nn" || $id_empresa_cond == "ep" || $id_empresa_cond == "ne")
      {
         $this->monta_condicao("ID_EMPRESA", $id_empresa_cond, $id_empresa, "", "id_empresa", "MEDIUMINT", false);
      }

      //----- $moeda
      $this->Date_part = false;
      if (isset($moeda) || $moeda_cond == "nu" || $moeda_cond == "nn" || $moeda_cond == "ep" || $moeda_cond == "ne")
      {
         $this->monta_condicao("MOEDA", $moeda_cond, $moeda, "", "moeda", "VARCHAR", false);
      }

      //----- $fob
      $this->Date_part = false;
      if (isset($fob) || $fob_cond == "nu" || $fob_cond == "nn" || $fob_cond == "ep" || $fob_cond == "ne")
      {
         $this->monta_condicao("FOB", $fob_cond, $fob, "", "fob", "DOUBLE", false);
      }

      //----- $peso
      $this->Date_part = false;
      if (isset($peso) || $peso_cond == "nu" || $peso_cond == "nn" || $peso_cond == "ep" || $peso_cond == "ne")
      {
         $this->monta_condicao("PESO", $peso_cond, $peso, "", "peso", "DOUBLE", false);
      }
      ...
      if ($data_cond != "bi_TP" && $Res_comp != 'calend')
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data'] = $val[0];
          ...
          if ($data_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']['data_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("OBS", $obs_cond, $obs, "", "obs", "VARCHAR", false);
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['where_pesq_filtro'] = " (" . trim($this->comando_filtro) . ")";
      }
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_price']['cond_pesq'] .= $this->NM_operador;
