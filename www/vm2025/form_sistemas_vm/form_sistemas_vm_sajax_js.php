  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sistemas_vm" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_sistemas_vm_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_id(var_id, var_script_case_init, do_ajax_form_sistemas_vm_validate_id_cb);
  } // do_ajax_form_sistemas_vm_validate_id

  function do_ajax_form_sistemas_vm_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_id_cb

  // ---------- Validate id_empresa
  function do_ajax_form_sistemas_vm_validate_id_empresa()
  {
  } // do_ajax_form_sistemas_vm_validate_id_empresa

  function do_ajax_form_sistemas_vm_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_id_empresa_cb

  // ---------- Validate contato
  function do_ajax_form_sistemas_vm_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_contato(var_contato, var_script_case_init, do_ajax_form_sistemas_vm_validate_contato_cb);
  } // do_ajax_form_sistemas_vm_validate_contato

  function do_ajax_form_sistemas_vm_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_contato_cb

  // ---------- Validate email
  function do_ajax_form_sistemas_vm_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_email(var_email, var_script_case_init, do_ajax_form_sistemas_vm_validate_email_cb);
  } // do_ajax_form_sistemas_vm_validate_email

  function do_ajax_form_sistemas_vm_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_email_cb

  // ---------- Validate telefone
  function do_ajax_form_sistemas_vm_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_sistemas_vm_validate_telefone_cb);
  } // do_ajax_form_sistemas_vm_validate_telefone

  function do_ajax_form_sistemas_vm_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_telefone_cb

  // ---------- Validate cnpj
  function do_ajax_form_sistemas_vm_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_sistemas_vm_validate_cnpj_cb);
  } // do_ajax_form_sistemas_vm_validate_cnpj

  function do_ajax_form_sistemas_vm_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_cnpj_cb

  // ---------- Validate id_proposta
  function do_ajax_form_sistemas_vm_validate_id_proposta()
  {
    var nomeCampo_id_proposta = "id_proposta";
    var var_id_proposta = scAjaxGetFieldSelect(nomeCampo_id_proposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_id_proposta(var_id_proposta, var_script_case_init, do_ajax_form_sistemas_vm_validate_id_proposta_cb);
  } // do_ajax_form_sistemas_vm_validate_id_proposta

  function do_ajax_form_sistemas_vm_validate_id_proposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_proposta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_id_proposta_cb

  // ---------- Validate id_itemproposta
  function do_ajax_form_sistemas_vm_validate_id_itemproposta()
  {
    var nomeCampo_id_itemproposta = "id_itemproposta";
    var var_id_itemproposta = scAjaxGetFieldSelect(nomeCampo_id_itemproposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_id_itemproposta(var_id_itemproposta, var_script_case_init, do_ajax_form_sistemas_vm_validate_id_itemproposta_cb);
  } // do_ajax_form_sistemas_vm_validate_id_itemproposta

  function do_ajax_form_sistemas_vm_validate_id_itemproposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_itemproposta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_id_itemproposta_cb

  // ---------- Validate data_venda
  function do_ajax_form_sistemas_vm_validate_data_venda()
  {
    var nomeCampo_data_venda = "data_venda";
    var var_data_venda = scAjaxGetFieldText(nomeCampo_data_venda);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_data_venda = scAjaxGetFieldText(nomeCampo_data_venda);
      x_ajax_form_sistemas_vm_validate_data_venda(var_data_venda, var_script_case_init, do_ajax_form_sistemas_vm_validate_data_venda_cb);
    }, 200);
  } // do_ajax_form_sistemas_vm_validate_data_venda

  function do_ajax_form_sistemas_vm_validate_data_venda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_data_venda_cb

  // ---------- Validate modelo
  function do_ajax_form_sistemas_vm_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_sistemas_vm_validate_modelo_cb);
  } // do_ajax_form_sistemas_vm_validate_modelo

  function do_ajax_form_sistemas_vm_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_modelo_cb

  // ---------- Validate serial
  function do_ajax_form_sistemas_vm_validate_serial()
  {
    var nomeCampo_serial = "serial";
    var var_serial = scAjaxGetFieldText(nomeCampo_serial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_serial(var_serial, var_script_case_init, do_ajax_form_sistemas_vm_validate_serial_cb);
  } // do_ajax_form_sistemas_vm_validate_serial

  function do_ajax_form_sistemas_vm_validate_serial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_serial_cb

  // ---------- Validate cod_ativacao
  function do_ajax_form_sistemas_vm_validate_cod_ativacao()
  {
    var nomeCampo_cod_ativacao = "cod_ativacao";
    var var_cod_ativacao = scAjaxGetFieldText(nomeCampo_cod_ativacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_cod_ativacao(var_cod_ativacao, var_script_case_init, do_ajax_form_sistemas_vm_validate_cod_ativacao_cb);
  } // do_ajax_form_sistemas_vm_validate_cod_ativacao

  function do_ajax_form_sistemas_vm_validate_cod_ativacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "cod_ativacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_cod_ativacao_cb

  // ---------- Validate dados_integracao
  function do_ajax_form_sistemas_vm_validate_dados_integracao()
  {
    var nomeCampo_dados_integracao = "dados_integracao";
    var var_dados_integracao = scAjaxGetFieldEditorHtml(nomeCampo_dados_integracao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_dados_integracao(var_dados_integracao, var_script_case_init, do_ajax_form_sistemas_vm_validate_dados_integracao_cb);
  } // do_ajax_form_sistemas_vm_validate_dados_integracao

  function do_ajax_form_sistemas_vm_validate_dados_integracao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "dados_integracao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_dados_integracao_cb

  // ---------- Validate dados_suporte
  function do_ajax_form_sistemas_vm_validate_dados_suporte()
  {
    var nomeCampo_dados_suporte = "dados_suporte";
    var var_dados_suporte = scAjaxGetFieldEditorHtml(nomeCampo_dados_suporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_validate_dados_suporte(var_dados_suporte, var_script_case_init, do_ajax_form_sistemas_vm_validate_dados_suporte_cb);
  } // do_ajax_form_sistemas_vm_validate_dados_suporte

  function do_ajax_form_sistemas_vm_validate_dados_suporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "dados_suporte";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_validate_dados_suporte_cb

  // ---------- Refresh id_empresa
  function do_ajax_form_sistemas_vm_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_nmgp_refresh_fields = "id_proposta";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_refresh_id_empresa(var_id_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sistemas_vm_refresh_id_empresa_cb);
  } // do_ajax_form_sistemas_vm_refresh_id_empresa

  function do_ajax_form_sistemas_vm_refresh_id_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_sistemas_vm_refresh_id_proposta();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_refresh_id_empresa_cb

  // ---------- Refresh id_proposta
  function do_ajax_form_sistemas_vm_refresh_id_proposta()
  {
    var var_id_proposta = scAjaxGetFieldSelect("id_proposta");
    var var_nmgp_refresh_fields = "id_itemproposta";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_refresh_id_proposta(var_id_proposta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sistemas_vm_refresh_id_proposta_cb);
  } // do_ajax_form_sistemas_vm_refresh_id_proposta

  function do_ajax_form_sistemas_vm_refresh_id_proposta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_refresh_id_proposta_cb

  // ---------- Event onchange id_empresa
  function do_ajax_form_sistemas_vm_event_id_empresa_onchange()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_event_id_empresa_onchange(var_id_empresa, var_contato, var_telefone, var_cnpj, var_email, var_script_case_init, do_ajax_form_sistemas_vm_event_id_empresa_onchange_cb);
  } // do_ajax_form_sistemas_vm_event_id_empresa_onchange

  function do_ajax_form_sistemas_vm_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sistemas_vm_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_sistemas_vm_event_id_empresa_onchange_cb
  function do_ajax_form_sistemas_vm_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_sistemas_vm_refresh_id_empresa();
    scAjaxRedir();
  } // do_ajax_form_sistemas_vm_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onchange id_itemproposta
  function do_ajax_form_sistemas_vm_event_id_itemproposta_onchange()
  {
    var var_id_itemproposta = scAjaxGetFieldSelect("id_itemproposta");
    var var_modelo = scAjaxGetFieldText("modelo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_event_id_itemproposta_onchange(var_id_itemproposta, var_modelo, var_script_case_init, do_ajax_form_sistemas_vm_event_id_itemproposta_onchange_cb);
  } // do_ajax_form_sistemas_vm_event_id_itemproposta_onchange

  function do_ajax_form_sistemas_vm_event_id_itemproposta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_itemproposta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sistemas_vm_event_id_itemproposta_onchange_cb_after_alert);
  } // do_ajax_form_sistemas_vm_event_id_itemproposta_onchange_cb
  function do_ajax_form_sistemas_vm_event_id_itemproposta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sistemas_vm_event_id_itemproposta_onchange_cb_after_alert

  // ---------- Event onchange id_proposta
  function do_ajax_form_sistemas_vm_event_id_proposta_onchange()
  {
    var var_id_proposta = scAjaxGetFieldSelect("id_proposta");
    var var_data_venda = scAjaxGetFieldText("data_venda");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_event_id_proposta_onchange(var_id_proposta, var_data_venda, var_script_case_init, do_ajax_form_sistemas_vm_event_id_proposta_onchange_cb);
  } // do_ajax_form_sistemas_vm_event_id_proposta_onchange

  function do_ajax_form_sistemas_vm_event_id_proposta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_proposta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sistemas_vm_event_id_proposta_onchange_cb_after_alert);
  } // do_ajax_form_sistemas_vm_event_id_proposta_onchange_cb
  function do_ajax_form_sistemas_vm_event_id_proposta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_sistemas_vm_refresh_id_proposta();
    scAjaxRedir();
  } // do_ajax_form_sistemas_vm_event_id_proposta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sistemas_vm_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sistemas_vm_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_cod_ativacao = scAjaxGetFieldText("cod_ativacao");
    var var_dados_integracao = scAjaxGetFieldEditorHtml("dados_integracao");
    var var_dados_suporte = scAjaxGetFieldEditorHtml("dados_suporte");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sistemas_vm_submit_form(var_id, var_id_empresa, var_contato, var_email, var_telefone, var_cnpj, var_id_proposta, var_id_itemproposta, var_data_venda, var_modelo, var_serial, var_cod_ativacao, var_dados_integracao, var_dados_suporte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_sistemas_vm_submit_form_cb);
  } // do_ajax_form_sistemas_vm_submit_form

  function do_ajax_form_sistemas_vm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_proposta");
      scAjaxHideErrorDisplay("id_itemproposta");
      scAjaxHideErrorDisplay("data_venda");
      scAjaxHideErrorDisplay("modelo");
      scAjaxHideErrorDisplay("serial");
      scAjaxHideErrorDisplay("cod_ativacao");
      scAjaxHideErrorDisplay("dados_integracao");
      scAjaxHideErrorDisplay("dados_suporte");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sistemas_vm_submit_form_cb_after_alert);
  } // do_ajax_form_sistemas_vm_submit_form_cb
  function do_ajax_form_sistemas_vm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sistemas_vm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sistemas_vm_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sistemas_vm_navigate_form, function() {});
    } else {
      perform_ajax_form_sistemas_vm_navigate_form();
    }
  }

  function perform_ajax_form_sistemas_vm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sistemas_vm_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sistemas_vm_navigate_form_cb);
  } // do_ajax_form_sistemas_vm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sistemas_vm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sistemas_vm_navigate_form_cb_after_alert);
  } // do_ajax_form_sistemas_vm_navigate_form_cb
  function do_ajax_form_sistemas_vm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sistemas_vm_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sistemas_vm_navigate_form_cb_after_alert

  function sc_hide_form_sistemas_vm_form()
  {
  ...
  ajax_field_list[2] = "contato";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "telefone";
  ajax_field_list[5] = "cnpj";
  ajax_field_list[6] = "id_proposta";
  ajax_field_list[7] = "id_itemproposta";
  ajax_field_list[8] = "data_venda";
  ajax_field_list[9] = "modelo";
  ajax_field_list[10] = "serial";
  ajax_field_list[11] = "cod_ativacao";
  ajax_field_list[12] = "dados_integracao";
  ajax_field_list[13] = "dados_suporte";
  ...
  var ajax_error_list = {
    ...
    "id_proposta": {"label": "PROPOSTA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_itemproposta": {"label": "PRODUTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "serial": {"label": "SERIAL", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cod_ativacao": {"label": "COD ATIVACAO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dados_integracao": {"label": "DADOS INTEGRACAO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dados_suporte": {"label": "DADOS SUPORTE TÉCNICO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "telefone": new Array(),
    "cnpj": new Array(),
    "id_proposta": new Array(),
    "id_itemproposta": new Array(),
    "data_venda": new Array(),
    "modelo": new Array(),
    "serial": new Array(),
    "cod_ativacao": new Array(),
    "dados_integracao": new Array(),
    "dados_suporte": new Array()
  };
  ...
  ajax_field_mult["id_proposta"][1] = "id_proposta";
  ajax_field_mult["id_itemproposta"][1] = "id_itemproposta";
  ajax_field_mult["data_venda"][1] = "data_venda";
  ajax_field_mult["modelo"][1] = "modelo";
  ajax_field_mult["serial"][1] = "serial";
  ajax_field_mult["cod_ativacao"][1] = "cod_ativacao";
  ajax_field_mult["dados_integracao"][1] = "dados_integracao";
  ajax_field_mult["dados_suporte"][1] = "dados_suporte";
  ...
  var ajax_field_id = {
    ...
    "id_proposta": new Array("hidden_field_label_id_proposta", "hidden_field_data_id_proposta"),
    "id_itemproposta": new Array("hidden_field_label_id_itemproposta", "hidden_field_data_id_itemproposta"),
    ...
    "cod_ativacao": new Array("hidden_field_label_cod_ativacao", "hidden_field_data_cod_ativacao"),
    "dados_integracao": new Array("hidden_field_label_dados_integracao", "hidden_field_data_dados_integracao"),
    "dados_suporte": new Array("hidden_field_label_dados_suporte", "hidden_field_data_dados_suporte")
  };
