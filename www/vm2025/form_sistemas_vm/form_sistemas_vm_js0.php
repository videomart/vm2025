...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_sistemas_vm"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_grid_consulta_historica_por_produtos_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "link_remove_margin*scinno*scoutlink_remove_border*scinno*scoutlink_remove_background*scinno*scout"; ?>', 'inicio', '_blank', '0', '0', 'grid_consulta_historica_por_produtos');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_sistemas_vm_form0').style.width='1px';
    document.getElementById('form_sistemas_vm_form0').style.height='0px';
    document.getElementById('form_sistemas_vm_form0').style.display='none';
    document.getElementById('form_sistemas_vm_form0').style.overflow='scroll';
    document.getElementById('form_sistemas_vm_form1').style.width='1px';
    document.getElementById('form_sistemas_vm_form1').style.height='0px';
    document.getElementById('form_sistemas_vm_form1').style.display='none';
    document.getElementById('form_sistemas_vm_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['pdf_view']) {
?>
