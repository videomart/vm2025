  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'dados_integracao':
        sc_exib_ocult_pag('form_sistemas_vm_form0');
        break;
      case 'dados_suporte':
        sc_exib_ocult_pag('form_sistemas_vm_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_sistemas_vm_id_onblur('#id_sc_field_id' + iSeqRow, iSeqRow, event) })
                                .bind('change', function() { sc_form_sistemas_vm_id_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_contato' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_sistemas_vm_contato_onblur('#id_sc_field_contato' + iSeqRow, iSeqRow, event);}, 300) })
                                     .bind('change', function() { sc_form_sistemas_vm_contato_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_telefone' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_sistemas_vm_telefone_onblur('#id_sc_field_telefone' + iSeqRow, iSeqRow, event);}, 300) })
                                      .bind('change', function() { sc_form_sistemas_vm_telefone_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_form_sistemas_vm_email_onblur('#id_sc_field_email' + iSeqRow, iSeqRow, event) })
                                   .bind('change', function() { sc_form_sistemas_vm_email_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_cnpj' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_sistemas_vm_cnpj_onblur('#id_sc_field_cnpj' + iSeqRow, iSeqRow, event);}, 300) })
                                  .bind('change', function() { sc_form_sistemas_vm_cnpj_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_data_venda' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_sistemas_vm_data_venda_onblur('#id_sc_field_data_venda' + iSeqRow, iSeqRow, event);}, 300) })
                                        .bind('change', function() { sc_form_sistemas_vm_data_venda_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_modelo' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_sistemas_vm_modelo_onblur('#id_sc_field_modelo' + iSeqRow, iSeqRow, event);}, 300) })
                                    .bind('change', function() { sc_form_sistemas_vm_modelo_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_serial' + iSeqRow).bind('blur', function() { sc_form_sistemas_vm_serial_onblur('#id_sc_field_serial' + iSeqRow, iSeqRow, event) })
                                    .bind('change', function() { sc_form_sistemas_vm_serial_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_cod_ativacao' + iSeqRow).bind('blur', function() { sc_form_sistemas_vm_cod_ativacao_onblur('#id_sc_field_cod_ativacao' + iSeqRow, iSeqRow, event) })
                                          .bind('change', function() { sc_form_sistemas_vm_cod_ativacao_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_dados_integracao' + iSeqRow).bind('blur', function() { sc_form_sistemas_vm_dados_integracao_onblur('#id_sc_field_dados_integracao' + iSeqRow, iSeqRow, event) })
                                              .bind('change', function() { sc_form_sistemas_vm_dados_integracao_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_dados_suporte' + iSeqRow).bind('blur', function() { sc_form_sistemas_vm_dados_suporte_onblur('#id_sc_field_dados_suporte' + iSeqRow, iSeqRow, event) })
                                           .bind('change', function() { sc_form_sistemas_vm_dados_suporte_onchange(this, iSeqRow, event) })
...
function sc_form_sistemas_vm_id_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_contato_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_telefone_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_email_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_cnpj_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_data_venda_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_modelo_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_serial_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_cod_ativacao_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_dados_integracao_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_sistemas_vm_dados_suporte_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_sistemas_vm_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_data_venda" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_sistemas_vm_validate_data_venda(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_sistemas_vm')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
