...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['opc_ant']);
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_sistemas_vm_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_sistemas_vm']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_sistemas_vm']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_sistemas_vm'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_sistemas_vm']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_sistemas_vm']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_sistemas_vm') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_sistemas_vm']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - sistemas_vm";
      ...
      $_SESSION['scriptcase']['error_icon']['form_sistemas_vm']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_sistemas_vm'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_sistemas_vm']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_sistemas_vm'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_sistemas_vm'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_sistemas_vm/form_sistemas_vm_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_sistemas_vm_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_sistemas_vm_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_sistemas_vm_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_sistemas_vm/form_sistemas_vm_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_sistemas_vm_erro.class.php"); 
      }
      $this->Erro      = new form_sistemas_vm_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_sistemas_vm']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] = "novo";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_sistemas_vm']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_sistemas_vm']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dados_select'];
     }
   }
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_sistemas_vm_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_sistemas_vm_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_sistemas_vm.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_sistemas_vm_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_sistemas_vm"> 
...
//---
    ...
    function ValidateField_contato(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['contato']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['contato'] == "on")) 
      { 
          if ($this->contato == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_telefone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['telefone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['telefone'] == "on")) 
      { 
          if ($this->telefone == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cnpj(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['cnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['cnpj'] == "on")) 
      { 
          if ($this->cnpj == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['id_proposta'])) {
       return;
               ...
               if (!empty($this->id_proposta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Lookup_id_proposta']) && !in_array($this->id_proposta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Lookup_id_proposta']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['id_itemproposta'])) {
      ...
      if ($this->id_itemproposta == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['id_itemproposta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['id_itemproposta'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_itemproposta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Lookup_id_itemproposta']) && !in_array($this->id_itemproposta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Lookup_id_itemproposta']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['id_itemproposta']))
    ...
    function ValidateField_data_venda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['data_venda']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['data_venda'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_modelo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['modelo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['php_cmp_required']['modelo'] == "on")) 
      { 
          if ($this->modelo == "")  
          { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_sistemas_vm_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_sistemas_vm_pack_protect_string(NM_charset_to_utf8($this->id_empresa))]) ? $aLookup[0][form_sistemas_vm_pack_protect_string(NM_charset_to_utf8($this->id_empresa))] : "";
...
$aLookup[] = array(form_sistemas_vm_pack_protect_string('') => str_replace('<', '&lt;',form_sistemas_vm_pack_protect_string('Selecionar Proposta')));
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (strpos(strtolower($rs->fields[0]), "e")) ? (float)$rs->fields[0] : $rs->fields[0];
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(form_sistemas_vm_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_sistemas_vm_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_proposta']['valList'][$i] = form_sistemas_vm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_sistemas_vm_pack_protect_string('') => str_replace('<', '&lt;',form_sistemas_vm_pack_protect_string('Selecione o sistema')));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_itemproposta']['valList'][$i] = form_sistemas_vm_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_dados_suporte($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opcao'] = '';
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['parms'] = ""; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              $aWhere[] = "ID = $this->id"; 
              if (!empty($sc_where_filter))  
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dados_select'] = $this->nmgp_dados_select;
...
{
$_SESSION['scriptcase']['form_sistemas_vm']['contr_erro'] = 'on';
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
        include_once("form_sistemas_vm_form0.php");
        include_once("form_sistemas_vm_form1.php");
        $this->hideFormPages();
 }
        ...
        function initFormPages() {
                ...
                foreach ($this->Ini->nm_page_blocks as $pageName => $pageBlocks) {
                        ...
                        if (!$hasDisplayedBlock) {
                                ...
                                if (isset($this->Ini->nm_page_names[$pageName]) && $this->Ini->nm_page_names[$pageName] == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['form_wizard']['actual_step']) {
                                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['form_wizard']['actual_step']++;
                                }
                                if (isset($this->Ini->nm_page_names[$pageName]) && ($this->Ini->nm_page_names[$pageName] + 1) == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['form_wizard']['total_steps']) {
                                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['form_wizard']['total_steps']--;
                                }
                        }
                }
        } // initFormPages
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['table_refresh'])
        {
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_sistemas_vm = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] = $qt_geral_reg_form_sistemas_vm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_sistemas_vm_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
      ...
      $Nm_datas["data_venda"] = "date";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_sistemas_vm_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_sistemas_vm_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['masterValue']))
{
...
<?php
  exit;
    ...
    function displayAppFooter()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm']['ordem_ord'] == " desc") {
