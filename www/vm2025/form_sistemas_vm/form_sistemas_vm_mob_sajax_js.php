  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sistemas_vm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_sistemas_vm_mob_form();
        }
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_sistemas_vm_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_id(var_id, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_id_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_id

  function do_ajax_form_sistemas_vm_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_id_cb

  // ---------- Validate id_empresa
  function do_ajax_form_sistemas_vm_mob_validate_id_empresa()
  {
  } // do_ajax_form_sistemas_vm_mob_validate_id_empresa

  function do_ajax_form_sistemas_vm_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_id_empresa_cb

  // ---------- Validate contato
  function do_ajax_form_sistemas_vm_mob_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_contato(var_contato, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_contato_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_contato

  function do_ajax_form_sistemas_vm_mob_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_contato_cb

  // ---------- Validate email
  function do_ajax_form_sistemas_vm_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_email(var_email, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_email_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_email

  function do_ajax_form_sistemas_vm_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_email_cb

  // ---------- Validate telefone
  function do_ajax_form_sistemas_vm_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_telefone_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_telefone

  function do_ajax_form_sistemas_vm_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_telefone_cb

  // ---------- Validate cnpj
  function do_ajax_form_sistemas_vm_mob_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_cnpj_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_cnpj

  function do_ajax_form_sistemas_vm_mob_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_cnpj_cb

  // ---------- Validate id_proposta
  function do_ajax_form_sistemas_vm_mob_validate_id_proposta()
  {
    var nomeCampo_id_proposta = "id_proposta";
    var var_id_proposta = scAjaxGetFieldSelect(nomeCampo_id_proposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_id_proposta(var_id_proposta, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_id_proposta_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_id_proposta

  function do_ajax_form_sistemas_vm_mob_validate_id_proposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_id_proposta_cb

  // ---------- Validate id_itemproposta
  function do_ajax_form_sistemas_vm_mob_validate_id_itemproposta()
  {
    var nomeCampo_id_itemproposta = "id_itemproposta";
    var var_id_itemproposta = scAjaxGetFieldSelect(nomeCampo_id_itemproposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_id_itemproposta(var_id_itemproposta, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_id_itemproposta_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_id_itemproposta

  function do_ajax_form_sistemas_vm_mob_validate_id_itemproposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_id_itemproposta_cb

  // ---------- Validate data_venda
  function do_ajax_form_sistemas_vm_mob_validate_data_venda()
  {
    ...
    setTimeout(function() {
      var var_data_venda = scAjaxGetFieldText(nomeCampo_data_venda);
      x_ajax_form_sistemas_vm_mob_validate_data_venda(var_data_venda, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_data_venda_cb);
    }, 200);
  } // do_ajax_form_sistemas_vm_mob_validate_data_venda

  function do_ajax_form_sistemas_vm_mob_validate_data_venda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_data_venda_cb

  // ---------- Validate modelo
  function do_ajax_form_sistemas_vm_mob_validate_modelo()
  {
    var nomeCampo_modelo = "modelo";
    var var_modelo = scAjaxGetFieldText(nomeCampo_modelo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_modelo(var_modelo, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_modelo_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_modelo

  function do_ajax_form_sistemas_vm_mob_validate_modelo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_modelo_cb

  // ---------- Validate serial
  function do_ajax_form_sistemas_vm_mob_validate_serial()
  {
    var nomeCampo_serial = "serial";
    var var_serial = scAjaxGetFieldText(nomeCampo_serial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_serial(var_serial, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_serial_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_serial

  function do_ajax_form_sistemas_vm_mob_validate_serial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_serial_cb

  // ---------- Validate cod_ativacao
  function do_ajax_form_sistemas_vm_mob_validate_cod_ativacao()
  {
    var nomeCampo_cod_ativacao = "cod_ativacao";
    var var_cod_ativacao = scAjaxGetFieldText(nomeCampo_cod_ativacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_cod_ativacao(var_cod_ativacao, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_cod_ativacao_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_cod_ativacao

  function do_ajax_form_sistemas_vm_mob_validate_cod_ativacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_cod_ativacao_cb

  // ---------- Validate dados_integracao
  function do_ajax_form_sistemas_vm_mob_validate_dados_integracao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_dados_integracao(var_dados_integracao, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_dados_integracao_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_dados_integracao

  function do_ajax_form_sistemas_vm_mob_validate_dados_integracao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_dados_integracao_cb

  // ---------- Validate dados_suporte
  function do_ajax_form_sistemas_vm_mob_validate_dados_suporte()
  {
    var nomeCampo_dados_suporte = "dados_suporte";
    var var_dados_suporte = scAjaxGetFieldEditorHtml(nomeCampo_dados_suporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sistemas_vm_mob_validate_dados_suporte(var_dados_suporte, var_script_case_init, do_ajax_form_sistemas_vm_mob_validate_dados_suporte_cb);
  } // do_ajax_form_sistemas_vm_mob_validate_dados_suporte

  function do_ajax_form_sistemas_vm_mob_validate_dados_suporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_validate_dados_suporte_cb

  // ---------- Refresh id_empresa
  function do_ajax_form_sistemas_vm_mob_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_nmgp_refresh_fields = "id_proposta";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_mob_refresh_id_empresa(var_id_empresa, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sistemas_vm_mob_refresh_id_empresa_cb);
  } // do_ajax_form_sistemas_vm_mob_refresh_id_empresa

  function do_ajax_form_sistemas_vm_mob_refresh_id_empresa_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_sistemas_vm_mob_refresh_id_proposta();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_refresh_id_empresa_cb

  // ---------- Refresh id_proposta
  function do_ajax_form_sistemas_vm_mob_refresh_id_proposta()
  {
    var var_id_proposta = scAjaxGetFieldSelect("id_proposta");
    var var_nmgp_refresh_fields = "id_itemproposta";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_mob_refresh_id_proposta(var_id_proposta, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_sistemas_vm_mob_refresh_id_proposta_cb);
  } // do_ajax_form_sistemas_vm_mob_refresh_id_proposta

  function do_ajax_form_sistemas_vm_mob_refresh_id_proposta_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sistemas_vm_mob_refresh_id_proposta_cb

  // ---------- Event onchange id_empresa
  function do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_mob_event_id_empresa_onchange(var_id_empresa, var_contato, var_telefone, var_cnpj, var_email, var_script_case_init, do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange_cb);
  } // do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange

  function do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange_cb
  function do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_sistemas_vm_mob_refresh_id_empresa();
    scAjaxRedir();
  } // do_ajax_form_sistemas_vm_mob_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onchange id_itemproposta
  function do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange()
  {
    var var_id_itemproposta = scAjaxGetFieldSelect("id_itemproposta");
    var var_modelo = scAjaxGetFieldText("modelo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange(var_id_itemproposta, var_modelo, var_script_case_init, do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange_cb);
  } // do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange

  function do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_itemproposta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange_cb_after_alert);
  } // do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange_cb
  function do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sistemas_vm_mob_event_id_itemproposta_onchange_cb_after_alert

  // ---------- Event onchange id_proposta
  function do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange()
  {
    var var_id_proposta = scAjaxGetFieldSelect("id_proposta");
    var var_data_venda = scAjaxGetFieldText("data_venda");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sistemas_vm_mob_event_id_proposta_onchange(var_id_proposta, var_data_venda, var_script_case_init, do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange_cb);
  } // do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange

  function do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_proposta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange_cb_after_alert);
  } // do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange_cb
  function do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_sistemas_vm_mob_refresh_id_proposta();
    scAjaxRedir();
  } // do_ajax_form_sistemas_vm_mob_event_id_proposta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sistemas_vm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sistemas_vm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sistemas_vm_mob_submit_form(var_id, var_id_empresa, var_contato, var_email, var_telefone, var_cnpj, var_id_proposta, var_id_itemproposta, var_data_venda, var_modelo, var_serial, var_cod_ativacao, var_dados_integracao, var_dados_suporte, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_sistemas_vm_mob_submit_form_cb);
  } // do_ajax_form_sistemas_vm_mob_submit_form

  function do_ajax_form_sistemas_vm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sistemas_vm_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sistemas_vm_mob_submit_form_cb
  function do_ajax_form_sistemas_vm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sistemas_vm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sistemas_vm_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_sistemas_vm_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_sistemas_vm_mob_navigate_form();
    }
  }

  function perform_ajax_form_sistemas_vm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sistemas_vm_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sistemas_vm_mob_navigate_form_cb);
  } // do_ajax_form_sistemas_vm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sistemas_vm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sistemas_vm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sistemas_vm_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sistemas_vm_mob_navigate_form_cb
  function do_ajax_form_sistemas_vm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sistemas_vm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sistemas_vm_mob_navigate_form_cb_after_alert

  function sc_hide_form_sistemas_vm_mob_form()
  {
