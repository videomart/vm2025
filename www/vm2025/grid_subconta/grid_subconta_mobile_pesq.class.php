...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "id_pai";$Nm_numeric[] = "id";$Nm_numeric[] = "id_pai";
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven " id="SC_id_pai_cond" name="id_pai_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_pai'), this, 'id_pai')">
      ...
      <br><span id="id_hide_id_pai"  <?php echo $str_hide_id_pai?>><INPUT  type="text" id="SC_id_pai" name="id_pai" value="<?php echo NM_encode_input($id_pai) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd " id="SC_conta_cond" name="conta_cond" onChange="nm_campos_between(document.getElementById('id_vis_conta'), this, 'conta')">
      ...
      <br><span id="id_hide_conta"  <?php echo $str_hide_conta?>><INPUT  type="text" id="SC_conta" name="conta" value="<?php echo NM_encode_input($conta) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd ">
 </TD>
...
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      ...
      <br><span id="id_hide_tipo"  <?php echo $str_hide_tipo?>><INPUT  type="text" id="SC_tipo" name="tipo" value="<?php echo NM_encode_input($tipo) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven ">
 </TD>
