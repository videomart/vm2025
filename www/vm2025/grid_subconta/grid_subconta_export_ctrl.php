<?php
@session_start() ;
$_SESSION['scriptcase']['grid_subconta']['sc_process_barr'] = true;
require_once('../grid_subconta/index.php');
unset($_SESSION['scriptcase']['grid_subconta']['sc_process_barr']);
$ExportCtrl = new grid_subconta_export_control;
$ExportCtrl->Export_barr();

class grid_subconta_export_control
{
