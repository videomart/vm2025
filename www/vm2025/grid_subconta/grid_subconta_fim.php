...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_subconta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_subconta"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_subconta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_subconta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_subconta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_subconta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_subconta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_subconta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_subconta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_subconta']['embutida_filho'] as $ind => $sc_init)
          {
