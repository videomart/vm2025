...
<?php
   ...
   $Ord_Cmp = new grid_subconta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_subconta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["id"] : "ID";
   $tab_ger_campos['id_pai'] = "on";
   $tab_def_campos['id_pai'] = "ID_PAI";
   $tab_labels["id_pai"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["id_pai"])) ? $_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["id_pai"] : "Conta ";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "TIPO";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["tipo"] : "TIPO";
   $tab_ger_campos['conta'] = "on";
   $tab_def_campos['conta'] = "CONTA";
   $tab_labels["conta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["conta"])) ? $_SESSION['sc_session'][$sc_init]['grid_subconta']['labels']["conta"] : "Subconta";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_subconta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_subconta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_subconta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_subconta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
