<div id="form_setup_form1" style='<?php echo ($this->tabCssClass["form_setup_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable scFormDataOdd<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="21" height="20" class="scFormBlock">
...
<?php } else { $sc_hidden_no++; ?>
   ...
   <?php }?>
    ...
    <TD class="scFormDataOdd" colspan="19" >&nbsp;</TD>
