...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_setup"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['where_detal']))
  {
?>  
...
function cep_cep(num_cep, campos_cep)
{
   ...
   jsrsExecute("form_setup_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep, "cep", num_cep, false);
}
...
{
    document.getElementById('form_setup_form0').style.width='1px';
    document.getElementById('form_setup_form0').style.height='0px';
    document.getElementById('form_setup_form0').style.display='none';
    document.getElementById('form_setup_form0').style.overflow='scroll';
    document.getElementById('form_setup_form1').style.width='1px';
    document.getElementById('form_setup_form1').style.height='0px';
    document.getElementById('form_setup_form1').style.display='none';
    document.getElementById('form_setup_form1').style.overflow='scroll';
    document.getElementById('form_setup_form2').style.width='1px';
    document.getElementById('form_setup_form2').style.height='0px';
    document.getElementById('form_setup_form2').style.display='none';
    document.getElementById('form_setup_form2').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['pdf_view']) {
?>
