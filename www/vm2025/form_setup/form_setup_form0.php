...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_setup/form_setup_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_setup_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_setup_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['link_info']['remove_border']) {
...
<?php
 include_once("form_setup_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/jsrsClient.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_setup'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_setup'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['btn_label']['first'];
        }
?>
...
<script type="text/javascript">
var pag_ativa = "form_setup_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_setup_form0' => array(
            'title' => "Dados",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_setup_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_setup_form1' => array(
            'title' => "Textos Proposta",
            'class' => $nmgp_num_form == "form_setup_form1" ? "scTabActive" : "scTabInactive",
        ),
        'form_setup_form2' => array(
            'title' => "Imagens",
            'class' => $nmgp_num_form == "form_setup_form2" ? "scTabActive" : "scTabInactive",
        ),
    );
    if (!empty($this->Ini->nm_hidden_pages)) {
        foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
            if ('Dados' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_setup_form0']['class'] = 'scTabInactive';
            }
            if ('Textos Proposta' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_setup_form1']['class'] = 'scTabInactive';
            }
            if ('Imagens' == $pageName && 'off' == $pageStatus) {
                $this->tabCssClass['form_setup_form2']['class'] = 'scTabInactive';
            }
        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_setup_form0"]['class'];
?>
   <li id="id_form_setup_form0" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_setup_form0">
     Dados
   </li>
<?php
    $css_celula = $this->tabCssClass["form_setup_form1"]['class'];
?>
   <li id="id_form_setup_form1" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_setup_form1">
     Textos Proposta
   </li>
<?php
    $css_celula = $this->tabCssClass["form_setup_form2"]['class'];
?>
   <li id="id_form_setup_form2" class="sc-form-page sc-tab-click <?php echo $css_celula; ?>" data-tab-name="form_setup_form2">
     Imagens
   </li>
</ul>
...
<div id="form_setup_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_inscest_line" id="hidden_field_data_inscest" style="<?php echo $sStyleHidden_inscest; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_inscest_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_inscmun_line" id="hidden_field_data_inscmun" style="<?php echo $sStyleHidden_inscmun; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_inscmun_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_admin_label" id="hidden_field_label_email_admin" style="<?php echo $sStyleHidden_email_admin; ?>"><span id="id_label_email_admin"><?php echo $this->nm_new_label['email_admin']; ?></span></TD>
    <TD class="scFormDataOdd css_email_admin_line" id="hidden_field_data_email_admin" style="<?php echo $sStyleHidden_email_admin; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_admin_line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_email_admin_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_email_admin_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_homepage_line" id="hidden_field_data_homepage" style="<?php echo $sStyleHidden_homepage; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_homepage_line" style="vertical-align: top;padding: 0px">
