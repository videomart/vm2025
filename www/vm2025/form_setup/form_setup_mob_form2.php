<div id="form_setup_mob_form2" style='<?php echo ($this->tabCssClass["form_setup_mob_form2"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<script> 
<?php
 $NM_pag_atual = "form_setup_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_setup_mob_form" . $this->nmgp_ancora;
 }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_setup_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_setup_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_setup_mob");
 parent.scAjaxDetailHeight("form_setup_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
        ...
        function scBtnFn_sys_format_ini() {
                ...
                if ($("#sc_b_ini_t.sc-unique-btn-12").length && $("#sc_b_ini_t.sc-unique-btn-12").is(":visible")) {
                    if ($("#sc_b_ini_t.sc-unique-btn-12").hasClass("disabled")) {
                        return;
                    }
                        nm_move ('inicio');
                        toggleToolbar(event, true); return;
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_setup_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
