...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'email_admin':
      case 'homepage':
        sc_exib_ocult_pag('form_setup_form0');
        break;
      case 'rodape':
      case 'header_proposta':
        sc_exib_ocult_pag('form_setup_form1');
        break;
      case 'logo':
        sc_exib_ocult_pag('form_setup_form2');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_setup_id_onchange(this, iSeqRow, event) });
  $('#id_sc_field_empresa' + iSeqRow).bind('blur', function() { sc_form_setup_empresa_onblur('#id_sc_field_empresa' + iSeqRow, iSeqRow, event) })
                                     .bind('change', function() { sc_form_setup_empresa_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_endereco' + iSeqRow).bind('blur', function() { sc_form_setup_endereco_onblur('#id_sc_field_endereco' + iSeqRow, iSeqRow, event) })
                                      .bind('change', function() { sc_form_setup_endereco_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_cidade' + iSeqRow).bind('blur', function() { sc_form_setup_cidade_onblur('#id_sc_field_cidade' + iSeqRow, iSeqRow, event) })
                                    .bind('change', function() { sc_form_setup_cidade_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_uf' + iSeqRow).bind('blur', function() { sc_form_setup_uf_onblur('#id_sc_field_uf' + iSeqRow, iSeqRow, event) })
                                .bind('change', function() { sc_form_setup_uf_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_cnpj' + iSeqRow).bind('blur', function() { sc_form_setup_cnpj_onblur('#id_sc_field_cnpj' + iSeqRow, iSeqRow, event) })
                                  .bind('change', function() { sc_form_setup_cnpj_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_inscest' + iSeqRow).bind('blur', function() { sc_form_setup_inscest_onblur('#id_sc_field_inscest' + iSeqRow, iSeqRow, event) })
                                     .bind('change', function() { sc_form_setup_inscest_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_inscmun' + iSeqRow).bind('blur', function() { sc_form_setup_inscmun_onblur('#id_sc_field_inscmun' + iSeqRow, iSeqRow, event) })
                                     .bind('change', function() { sc_form_setup_inscmun_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_telefone' + iSeqRow).bind('blur', function() { sc_form_setup_telefone_onblur('#id_sc_field_telefone' + iSeqRow, iSeqRow, event) })
                                      .bind('change', function() { sc_form_setup_telefone_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_form_setup_email_onblur('#id_sc_field_email' + iSeqRow, iSeqRow, event) })
                                   .bind('change', function() { sc_form_setup_email_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_email_admin' + iSeqRow).bind('blur', function() { sc_form_setup_email_admin_onblur('#id_sc_field_email_admin' + iSeqRow, iSeqRow, event) })
                                         .bind('change', function() { sc_form_setup_email_admin_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_homepage' + iSeqRow).bind('blur', function() { sc_form_setup_homepage_onblur('#id_sc_field_homepage' + iSeqRow, iSeqRow, event) })
                                      .bind('change', function() { sc_form_setup_homepage_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_logo' + iSeqRow).bind('blur', function() { sc_form_setup_logo_onblur('#id_sc_field_logo' + iSeqRow, iSeqRow, event) })
                                  .bind('change', function() { sc_form_setup_logo_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_rodape' + iSeqRow).bind('blur', function() { sc_form_setup_rodape_onblur('#id_sc_field_rodape' + iSeqRow, iSeqRow, event) })
                                    .bind('change', function() { sc_form_setup_rodape_onchange(this, iSeqRow, event) })
  ...
  $('#id_sc_field_header_proposta' + iSeqRow).bind('blur', function() { sc_form_setup_header_proposta_onblur('#id_sc_field_header_proposta' + iSeqRow, iSeqRow, event) })
                                             .bind('change', function() { sc_form_setup_header_proposta_onchange(this, iSeqRow, event) })
                                             .bind('focus', function() { sc_form_setup_header_proposta_onfocus(this, iSeqRow, event) });
} // scJQEventsAdd

Upload_Cancel = false;
function sc_form_setup_id_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_empresa_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_endereco_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_cidade_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_uf_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_cnpj_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_inscest_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_inscmun_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_telefone_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_email_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_email_admin_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_homepage_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_logo_onchange(oThis, iSeqRow, event) {
  ...
  if (File_Arr.length > 0) {
      ...
      if (File_Name.indexOf('*') != -1) {
          ...
          document.getElementById('id_sc_field_logo' + iSeqRow).value = '';
          Upload_Cancel = true;
          return;
      }
  }
...
function sc_form_setup_rodape_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function sc_form_setup_header_proposta_onchange(oThis, iSeqRow, event) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_setup_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_setup')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
