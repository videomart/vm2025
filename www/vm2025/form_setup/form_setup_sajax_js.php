  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_setup" == sTestField)
        {
...
?>
  ...
  // ---------- Validate empresa
  function do_ajax_form_setup_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_setup_validate_empresa_cb);
  } // do_ajax_form_setup_validate_empresa

  function do_ajax_form_setup_validate_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_empresa_cb

  // ---------- Validate cep
  function do_ajax_form_setup_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_cep(var_cep, var_script_case_init, do_ajax_form_setup_validate_cep_cb);
  } // do_ajax_form_setup_validate_cep

  function do_ajax_form_setup_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_setup_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_setup_validate_endereco_cb);
  } // do_ajax_form_setup_validate_endereco

  function do_ajax_form_setup_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_endereco_cb

  // ---------- Validate cidade
  function do_ajax_form_setup_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_setup_validate_cidade_cb);
  } // do_ajax_form_setup_validate_cidade

  function do_ajax_form_setup_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_cidade_cb

  // ---------- Validate uf
  function do_ajax_form_setup_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_uf(var_uf, var_script_case_init, do_ajax_form_setup_validate_uf_cb);
  } // do_ajax_form_setup_validate_uf

  function do_ajax_form_setup_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_uf_cb

  // ---------- Validate cnpj
  function do_ajax_form_setup_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_setup_validate_cnpj_cb);
  } // do_ajax_form_setup_validate_cnpj

  function do_ajax_form_setup_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_cnpj_cb

  // ---------- Validate inscest
  function do_ajax_form_setup_validate_inscest()
  {
    var nomeCampo_inscest = "inscest";
    var var_inscest = scAjaxGetFieldText(nomeCampo_inscest);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_inscest(var_inscest, var_script_case_init, do_ajax_form_setup_validate_inscest_cb);
  } // do_ajax_form_setup_validate_inscest

  function do_ajax_form_setup_validate_inscest_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_inscest_cb

  // ---------- Validate inscmun
  function do_ajax_form_setup_validate_inscmun()
  {
    var nomeCampo_inscmun = "inscmun";
    var var_inscmun = scAjaxGetFieldText(nomeCampo_inscmun);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_inscmun(var_inscmun, var_script_case_init, do_ajax_form_setup_validate_inscmun_cb);
  } // do_ajax_form_setup_validate_inscmun

  function do_ajax_form_setup_validate_inscmun_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_inscmun_cb

  // ---------- Validate telefone
  function do_ajax_form_setup_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_setup_validate_telefone_cb);
  } // do_ajax_form_setup_validate_telefone

  function do_ajax_form_setup_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_setup_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_email(var_email, var_script_case_init, do_ajax_form_setup_validate_email_cb);
  } // do_ajax_form_setup_validate_email

  function do_ajax_form_setup_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_email_cb

  // ---------- Validate email_admin
  function do_ajax_form_setup_validate_email_admin()
  {
    var nomeCampo_email_admin = "email_admin";
    var var_email_admin = scAjaxGetFieldText(nomeCampo_email_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_email_admin(var_email_admin, var_script_case_init, do_ajax_form_setup_validate_email_admin_cb);
  } // do_ajax_form_setup_validate_email_admin

  function do_ajax_form_setup_validate_email_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_email_admin_cb

  // ---------- Validate homepage
  function do_ajax_form_setup_validate_homepage()
  {
    var nomeCampo_homepage = "homepage";
    var var_homepage = scAjaxGetFieldText(nomeCampo_homepage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_homepage(var_homepage, var_script_case_init, do_ajax_form_setup_validate_homepage_cb);
  } // do_ajax_form_setup_validate_homepage

  function do_ajax_form_setup_validate_homepage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_homepage_cb

  // ---------- Validate rodape
  function do_ajax_form_setup_validate_rodape()
  {
    var nomeCampo_rodape = "rodape";
    var var_rodape = scAjaxGetFieldEditorHtml(nomeCampo_rodape);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_rodape(var_rodape, var_script_case_init, do_ajax_form_setup_validate_rodape_cb);
  } // do_ajax_form_setup_validate_rodape

  function do_ajax_form_setup_validate_rodape_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_rodape_cb

  // ---------- Validate header_proposta
  function do_ajax_form_setup_validate_header_proposta()
  {
    var nomeCampo_header_proposta = "header_proposta";
    var var_header_proposta = scAjaxGetFieldEditorHtml(nomeCampo_header_proposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_header_proposta(var_header_proposta, var_script_case_init, do_ajax_form_setup_validate_header_proposta_cb);
  } // do_ajax_form_setup_validate_header_proposta

  function do_ajax_form_setup_validate_header_proposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_header_proposta_cb

  // ---------- Validate logo
  function do_ajax_form_setup_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_setup_validate_logo(var_logo, var_script_case_init, do_ajax_form_setup_validate_logo_cb);
  } // do_ajax_form_setup_validate_logo

  function do_ajax_form_setup_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_setup_validate_logo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_setup_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_setup_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_setup_submit_form(var_empresa, var_cep, var_endereco, var_cidade, var_uf, var_cnpj, var_inscest, var_inscmun, var_telefone, var_email, var_email_admin, var_homepage, var_rodape, var_header_proposta, var_logo, var_logo_ul_name, var_logo_ul_type, var_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_setup_submit_form_cb);
  } // do_ajax_form_setup_submit_form

  function do_ajax_form_setup_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_setup_submit_form_cb_after_alert);
  } // do_ajax_form_setup_submit_form_cb
  function do_ajax_form_setup_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_setup_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_setup_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_setup_navigate_form, function() {});
    } else {
      perform_ajax_form_setup_navigate_form();
    }
  }

  function perform_ajax_form_setup_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_setup_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_setup_navigate_form_cb);
  } // do_ajax_form_setup_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_setup']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_setup_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_setup_navigate_form_cb_after_alert);
  } // do_ajax_form_setup_navigate_form_cb
  function do_ajax_form_setup_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_setup_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_setup_navigate_form_cb_after_alert

  function sc_hide_form_setup_form()
  {
