...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_contas']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_contas']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_contas']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_contas']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_contas']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas']['sc_redir_insert'] = $this->sc_redir_insert;
              unset($_SESSION['sc_session'][$script_case_init]['form_contas']['opc_ant']);
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_contas']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_contas']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_contas']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_contas_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_contas']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_contas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - contas";
      ...
      $_SESSION['scriptcase']['error_icon']['form_contas']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_contas'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "", '', '', '', '', '', '', '', '', "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_contas_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_contas_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_contas/form_contas_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_contas_erro.class.php"); 
      }
      $this->Erro      = new form_contas_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao'] = "novo";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_contas']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_contas']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_empresa']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_empresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_empresa']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_empresa'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_contas_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_contas_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_empresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select']['debito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->debito = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select']['debito'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_contas.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas'][$path_doc_md5][1] = $Zip_name;
?><!DOCTYPE html>
...
<form name="Fdown" method="get" action="form_contas_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_contas"> 
...
//---
      ...
      {
      $_SESSION['scriptcase']['form_contas']['contr_erro'] = 'on';
  $this->ProcessaSaldo();
$_SESSION['scriptcase']['form_contas']['contr_erro'] = 'off'; 
      }
    ...
    function ValidateField_id_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['id_empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['id_empresa'] == "on")) 
      { 
          if ($this->id_empresa == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_data(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['data']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['data'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Data" ; 
              if (!isset($Campos_Erros['data']))
    ...
    function ValidateField_referencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['referencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['referencia'] == "on")) 
      { 
          if ($this->referencia == "")  
          { 
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['id_subconta'])) {
      ...
      if ($this->id_subconta == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['id_subconta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['id_subconta'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_subconta) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta']) && !in_array($this->id_subconta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['moeda'])) {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['moeda']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['php_cmp_required']['moeda'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Moeda" ; 
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_moeda']) && !in_array($this->moeda, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_moeda']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['moeda']))
    ...
    function ValidateField_debito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->debito, 10, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Débito; " ; 
                  if (!isset($Campos_Erros['debito']))
    ...
    function ValidateField_credito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->credito, 10, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Crédito; " ; 
                  if (!isset($Campos_Erros['credito']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_contas_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_contas_pack_protect_string(NM_charset_to_utf8($this->id_empresa))]) ? $aLookup[0][form_contas_pack_protect_string(NM_charset_to_utf8($this->id_empresa))] : "";
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta'] = array(); 
}
$aLookup[] = array(form_contas_pack_protect_string('') => str_replace('<', '&lt;',form_contas_pack_protect_string('Informe a subconta')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_id_subconta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_subconta']['valList'][$i] = form_contas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_contas_pack_protect_string('Dolar') => str_replace('<', '&lt;',form_contas_pack_protect_string("Dolar")));
$aLookup[] = array(form_contas_pack_protect_string('Real') => str_replace('<', '&lt;',form_contas_pack_protect_string("Real")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_moeda'][] = 'Dolar';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Lookup_moeda'][] = 'Real';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['moeda']['valList'][$i] = form_contas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_sld_dolar($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['upload_dir'][$fieldName][] = $newName;
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['Field_no_validate'] = array();
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_contas']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_contas = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total'] = $qt_geral_reg_form_contas;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_contas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] > $qt_geral_reg_form_contas)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] = $qt_geral_reg_form_contas; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] = 0;
      }
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['parms'] = ""; 
          $nmgp_select = "SELECT ID, ID_EMPRESA, DATA, CREDITO, DEBITO, ID_SUBCONTA, ID_ORDEM, REFERENCIA, moeda from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          $aWhere[] = $sc_where_filter;
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              $aWhere[] = "ID = $this->id"; 
              if (!empty($sc_where_filter))  
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] < $qt_geral_reg_form_contas;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_contas_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['table_refresh'])
        {
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dyn_search_cache']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_contas = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total'] = $qt_geral_reg_form_contas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_contas_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["data"] = "date";
         ...
         if (isset($Nm_datas[$campo_join]))
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_contas_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_contas_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "last":
                ...
                break;
            case "new":
                return array("sc_b_new_t.sc-unique-btn-5", "sc_b_new_b.sc-unique-btn-13");
                break;
            case "insert":
                return array("sc_b_ins_t.sc-unique-btn-6", "sc_b_ins_b.sc-unique-btn-14");
                break;
            case "0":
            ...
            case "exit":
                ...
                break;
            case "update":
                return array("sc_b_upd_b.sc-unique-btn-15");
                break;
            case "delete":
                return array("sc_b_del_b.sc-unique-btn-16");
                break;
            case "bcancelar":
                return array("sc_b_sai_b.sc-unique-btn-17");
                break;
        }
    ...
    function displayAppFooter()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['ordem_ord'] == " desc") {
