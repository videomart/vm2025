  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_empresa
  function do_ajax_form_contas_validate_id_empresa()
  {
  } // do_ajax_form_contas_validate_id_empresa

  function do_ajax_form_contas_validate_id_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_id_empresa_cb

  // ---------- Validate data
  function do_ajax_form_contas_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_data(var_data, var_script_case_init, do_ajax_form_contas_validate_data_cb);
  } // do_ajax_form_contas_validate_data

  function do_ajax_form_contas_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_data_cb

  // ---------- Validate referencia
  function do_ajax_form_contas_validate_referencia()
  {
    var nomeCampo_referencia = "referencia";
    var var_referencia = scAjaxGetFieldText(nomeCampo_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_referencia(var_referencia, var_script_case_init, do_ajax_form_contas_validate_referencia_cb);
  } // do_ajax_form_contas_validate_referencia

  function do_ajax_form_contas_validate_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_referencia_cb

  // ---------- Validate id_ordem
  function do_ajax_form_contas_validate_id_ordem()
  {
    var nomeCampo_id_ordem = "id_ordem";
    var var_id_ordem = scAjaxGetFieldHidden(nomeCampo_id_ordem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_id_ordem(var_id_ordem, var_script_case_init, do_ajax_form_contas_validate_id_ordem_cb);
  } // do_ajax_form_contas_validate_id_ordem

  function do_ajax_form_contas_validate_id_ordem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_id_ordem_cb

  // ---------- Validate id_subconta
  function do_ajax_form_contas_validate_id_subconta()
  {
    var nomeCampo_id_subconta = "id_subconta";
    var var_id_subconta = scAjaxGetFieldSelect(nomeCampo_id_subconta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_id_subconta(var_id_subconta, var_script_case_init, do_ajax_form_contas_validate_id_subconta_cb);
  } // do_ajax_form_contas_validate_id_subconta

  function do_ajax_form_contas_validate_id_subconta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_id_subconta_cb

  // ---------- Validate moeda
  function do_ajax_form_contas_validate_moeda()
  {
    var nomeCampo_moeda = "moeda";
    var var_moeda = scAjaxGetFieldRadio(nomeCampo_moeda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_moeda(var_moeda, var_script_case_init, do_ajax_form_contas_validate_moeda_cb);
  } // do_ajax_form_contas_validate_moeda

  function do_ajax_form_contas_validate_moeda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_moeda_cb

  // ---------- Validate debito
  function do_ajax_form_contas_validate_debito()
  {
    var nomeCampo_debito = "debito";
    var var_debito = scAjaxGetFieldText(nomeCampo_debito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_debito(var_debito, var_script_case_init, do_ajax_form_contas_validate_debito_cb);
  } // do_ajax_form_contas_validate_debito

  function do_ajax_form_contas_validate_debito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_debito_cb

  // ---------- Validate credito
  function do_ajax_form_contas_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldText(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_credito(var_credito, var_script_case_init, do_ajax_form_contas_validate_credito_cb);
  } // do_ajax_form_contas_validate_credito

  function do_ajax_form_contas_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_credito_cb

  // ---------- Validate sld_real
  function do_ajax_form_contas_validate_sld_real()
  {
    var nomeCampo_sld_real = "sld_real";
    var var_sld_real = scAjaxGetFieldHidden(nomeCampo_sld_real);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_sld_real(var_sld_real, var_script_case_init, do_ajax_form_contas_validate_sld_real_cb);
  } // do_ajax_form_contas_validate_sld_real

  function do_ajax_form_contas_validate_sld_real_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_sld_real_cb

  // ---------- Validate sld_dolar
  function do_ajax_form_contas_validate_sld_dolar()
  {
    var nomeCampo_sld_dolar = "sld_dolar";
    var var_sld_dolar = scAjaxGetFieldHidden(nomeCampo_sld_dolar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_validate_sld_dolar(var_sld_dolar, var_script_case_init, do_ajax_form_contas_validate_sld_dolar_cb);
  } // do_ajax_form_contas_validate_sld_dolar

  function do_ajax_form_contas_validate_sld_dolar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_validate_sld_dolar_cb

  // ---------- Event onchange id_empresa
  function do_ajax_form_contas_event_id_empresa_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_contas_event_id_empresa_onchange(var_id_empresa, var_sld_real, var_sld_dolar, var_script_case_init, do_ajax_form_contas_event_id_empresa_onchange_cb);
  } // do_ajax_form_contas_event_id_empresa_onchange

  function do_ajax_form_contas_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_contas_event_id_empresa_onchange_cb
  function do_ajax_form_contas_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onblur id_subconta
  function do_ajax_form_contas_event_id_subconta_onblur()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_event_id_subconta_onblur(var_id_subconta, var_credito, var_debito, var_script_case_init, do_ajax_form_contas_event_id_subconta_onblur_cb);
  } // do_ajax_form_contas_event_id_subconta_onblur

  function do_ajax_form_contas_event_id_subconta_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_subconta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_event_id_subconta_onblur_cb_after_alert);
  } // do_ajax_form_contas_event_id_subconta_onblur_cb
  function do_ajax_form_contas_event_id_subconta_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_event_id_subconta_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contas_submit_form(var_id_empresa, var_data, var_referencia, var_id_ordem, var_id_subconta, var_moeda, var_debito, var_credito, var_sld_real, var_sld_dolar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_contas_submit_form_cb);
  } // do_ajax_form_contas_submit_form

  function do_ajax_form_contas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contas_submit_form_cb_after_alert);
  } // do_ajax_form_contas_submit_form_cb
  function do_ajax_form_contas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contas_navigate_form, function() {});
    } else {
      perform_ajax_form_contas_navigate_form();
    }
  }

  function perform_ajax_form_contas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contas_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contas_navigate_form_cb);
  } // do_ajax_form_contas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contas_navigate_form_cb_after_alert);
  } // do_ajax_form_contas_navigate_form_cb
  function do_ajax_form_contas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contas_navigate_form_cb_after_alert

  function sc_hide_form_contas_form()
  {
  ...
  function do_ajax_form_contas_lkpedt_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_empresa";
    x_ajax_form_contas_lkpedt_refresh_id_empresa(var_id_empresa, nmgp_refresh_fields, var_script_case_init, do_ajax_form_contas_lkpedt_refresh_id_empresa_cb);
  } // do_ajax_form_contas_lkpedt_refresh_id_empresa

  function do_ajax_form_contas_lkpedt_refresh_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_contas_lkpedt_refresh_id_empresa_cb
