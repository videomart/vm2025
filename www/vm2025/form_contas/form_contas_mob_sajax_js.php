  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contas_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_empresa
  function do_ajax_form_contas_mob_validate_id_empresa()
  {
  } // do_ajax_form_contas_mob_validate_id_empresa

  function do_ajax_form_contas_mob_validate_id_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_id_empresa_cb

  // ---------- Validate data
  function do_ajax_form_contas_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_data(var_data, var_script_case_init, do_ajax_form_contas_mob_validate_data_cb);
  } // do_ajax_form_contas_mob_validate_data

  function do_ajax_form_contas_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_data_cb

  // ---------- Validate referencia
  function do_ajax_form_contas_mob_validate_referencia()
  {
    var nomeCampo_referencia = "referencia";
    var var_referencia = scAjaxGetFieldText(nomeCampo_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_referencia(var_referencia, var_script_case_init, do_ajax_form_contas_mob_validate_referencia_cb);
  } // do_ajax_form_contas_mob_validate_referencia

  function do_ajax_form_contas_mob_validate_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_referencia_cb

  // ---------- Validate id_ordem
  function do_ajax_form_contas_mob_validate_id_ordem()
  {
    var nomeCampo_id_ordem = "id_ordem";
    var var_id_ordem = scAjaxGetFieldHidden(nomeCampo_id_ordem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_id_ordem(var_id_ordem, var_script_case_init, do_ajax_form_contas_mob_validate_id_ordem_cb);
  } // do_ajax_form_contas_mob_validate_id_ordem

  function do_ajax_form_contas_mob_validate_id_ordem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_ordem";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_id_ordem_cb

  // ---------- Validate id_subconta
  function do_ajax_form_contas_mob_validate_id_subconta()
  {
    var nomeCampo_id_subconta = "id_subconta";
    var var_id_subconta = scAjaxGetFieldSelect(nomeCampo_id_subconta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_id_subconta(var_id_subconta, var_script_case_init, do_ajax_form_contas_mob_validate_id_subconta_cb);
  } // do_ajax_form_contas_mob_validate_id_subconta

  function do_ajax_form_contas_mob_validate_id_subconta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "id_subconta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_id_subconta_cb

  // ---------- Validate moeda
  function do_ajax_form_contas_mob_validate_moeda()
  {
    var nomeCampo_moeda = "moeda";
    var var_moeda = scAjaxGetFieldRadio(nomeCampo_moeda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_moeda(var_moeda, var_script_case_init, do_ajax_form_contas_mob_validate_moeda_cb);
  } // do_ajax_form_contas_mob_validate_moeda

  function do_ajax_form_contas_mob_validate_moeda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_moeda_cb

  // ---------- Validate debito
  function do_ajax_form_contas_mob_validate_debito()
  {
    var nomeCampo_debito = "debito";
    var var_debito = scAjaxGetFieldText(nomeCampo_debito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_debito(var_debito, var_script_case_init, do_ajax_form_contas_mob_validate_debito_cb);
  } // do_ajax_form_contas_mob_validate_debito

  function do_ajax_form_contas_mob_validate_debito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_debito_cb

  // ---------- Validate credito
  function do_ajax_form_contas_mob_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldText(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_credito(var_credito, var_script_case_init, do_ajax_form_contas_mob_validate_credito_cb);
  } // do_ajax_form_contas_mob_validate_credito

  function do_ajax_form_contas_mob_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_credito_cb

  // ---------- Validate sld_real
  function do_ajax_form_contas_mob_validate_sld_real()
  {
    var nomeCampo_sld_real = "sld_real";
    var var_sld_real = scAjaxGetFieldHidden(nomeCampo_sld_real);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_sld_real(var_sld_real, var_script_case_init, do_ajax_form_contas_mob_validate_sld_real_cb);
  } // do_ajax_form_contas_mob_validate_sld_real

  function do_ajax_form_contas_mob_validate_sld_real_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "sld_real";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_sld_real_cb

  // ---------- Validate sld_dolar
  function do_ajax_form_contas_mob_validate_sld_dolar()
  {
    var nomeCampo_sld_dolar = "sld_dolar";
    var var_sld_dolar = scAjaxGetFieldHidden(nomeCampo_sld_dolar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_mob_validate_sld_dolar(var_sld_dolar, var_script_case_init, do_ajax_form_contas_mob_validate_sld_dolar_cb);
  } // do_ajax_form_contas_mob_validate_sld_dolar

  function do_ajax_form_contas_mob_validate_sld_dolar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "sld_dolar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_mob_validate_sld_dolar_cb

  // ---------- Event onchange id_empresa
  function do_ajax_form_contas_mob_event_id_empresa_onchange()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_sld_real = scAjaxGetFieldHidden("sld_real");
    var var_sld_dolar = scAjaxGetFieldHidden("sld_dolar");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_mob_event_id_empresa_onchange(var_id_empresa, var_sld_real, var_sld_dolar, var_script_case_init, do_ajax_form_contas_mob_event_id_empresa_onchange_cb);
  } // do_ajax_form_contas_mob_event_id_empresa_onchange

  function do_ajax_form_contas_mob_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_mob_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_contas_mob_event_id_empresa_onchange_cb
  function do_ajax_form_contas_mob_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_mob_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onblur id_subconta
  function do_ajax_form_contas_mob_event_id_subconta_onblur()
  {
    var var_id_subconta = scAjaxGetFieldSelect("id_subconta");
    var var_credito = scAjaxGetFieldText("credito");
    var var_debito = scAjaxGetFieldText("debito");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_mob_event_id_subconta_onblur(var_id_subconta, var_credito, var_debito, var_script_case_init, do_ajax_form_contas_mob_event_id_subconta_onblur_cb);
  } // do_ajax_form_contas_mob_event_id_subconta_onblur

  function do_ajax_form_contas_mob_event_id_subconta_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_subconta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_mob_event_id_subconta_onblur_cb_after_alert);
  } // do_ajax_form_contas_mob_event_id_subconta_onblur_cb
  function do_ajax_form_contas_mob_event_id_subconta_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_mob_event_id_subconta_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    ...
    var var_id_ordem = scAjaxGetFieldHidden("id_ordem");
    var var_id_subconta = scAjaxGetFieldSelect("id_subconta");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contas_mob_submit_form(var_id_empresa, var_data, var_referencia, var_id_ordem, var_id_subconta, var_moeda, var_debito, var_credito, var_sld_real, var_sld_dolar, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_contas_mob_submit_form_cb);
  } // do_ajax_form_contas_mob_submit_form

  function do_ajax_form_contas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_ordem");
      scAjaxHideErrorDisplay("id_subconta");
      scAjaxHideErrorDisplay("moeda");
      scAjaxHideErrorDisplay("debito");
      scAjaxHideErrorDisplay("credito");
      scAjaxHideErrorDisplay("sld_real");
      scAjaxHideErrorDisplay("sld_dolar");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contas_mob_submit_form_cb
  function do_ajax_form_contas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_contas_mob_navigate_form();
    }
  }

  function perform_ajax_form_contas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contas_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contas_mob_navigate_form_cb);
  } // do_ajax_form_contas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contas_mob_navigate_form_cb
  function do_ajax_form_contas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contas_mob_navigate_form_cb_after_alert

  function sc_hide_form_contas_mob_form()
  {
  ...
  function do_ajax_form_contas_mob_lkpedt_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_empresa";
    x_ajax_form_contas_mob_lkpedt_refresh_id_empresa(var_id_empresa, nmgp_refresh_fields, var_script_case_init, do_ajax_form_contas_mob_lkpedt_refresh_id_empresa_cb);
  } // do_ajax_form_contas_mob_lkpedt_refresh_id_empresa

  function do_ajax_form_contas_mob_lkpedt_refresh_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_contas_mob_lkpedt_refresh_id_empresa_cb
  ...
  ajax_field_list[2] = "referencia";
  ajax_field_list[3] = "id_ordem";
  ajax_field_list[4] = "id_subconta";
  ajax_field_list[5] = "moeda";
  ajax_field_list[6] = "debito";
  ajax_field_list[7] = "credito";
  ajax_field_list[8] = "sld_real";
  ajax_field_list[9] = "sld_dolar";
  ...
  var ajax_error_list = {
    ...
    "referencia": {"label": "Referência", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_ordem": {"label": "Ordem", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_subconta": {"label": "Subconta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "moeda": {"label": "Moeda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "debito": {"label": "Débito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "credito": {"label": "Crédito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sld_real": {"label": "Saldo Real", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "sld_dolar": {"label": "Saldo Dolar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["id_ordem"][1] = "id_ordem";
  ajax_field_mult["id_subconta"][1] = "id_subconta";
  ajax_field_mult["moeda"][1] = "moeda";
  ajax_field_mult["debito"][1] = "debito";
  ajax_field_mult["credito"][1] = "credito";
  ajax_field_mult["sld_real"][1] = "sld_real";
  ajax_field_mult["sld_dolar"][1] = "sld_dolar";
  ...
  var ajax_field_id = {
    ...
    "id_ordem": new Array("hidden_field_label_id_ordem", "hidden_field_data_id_ordem"),
    "id_subconta": new Array("hidden_field_label_id_subconta", "hidden_field_data_id_subconta"),
    "moeda": new Array("hidden_field_label_moeda", "hidden_field_data_moeda"),
    "debito": new Array("hidden_field_label_debito", "hidden_field_data_debito"),
    "credito": new Array("hidden_field_label_credito", "hidden_field_data_credito"),
    "sld_real": new Array("hidden_field_label_sld_real", "hidden_field_data_sld_real"),
    "sld_dolar": new Array("hidden_field_label_sld_dolar", "hidden_field_data_sld_dolar")
  };
