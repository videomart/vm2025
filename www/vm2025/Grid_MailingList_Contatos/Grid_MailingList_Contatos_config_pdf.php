...
session_start();
    ...
    $SC_cod_proj = "VM2025";
    $SC_apl_proc = "Grid_MailingList_Contatos";
    $SC_ver_93   = true;
...
<form name="config_pdf" method="post">
    ...
    <table id="main_table" class="exportConfig"
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['summarizing_drill_down']);
        $isAnalitic = isset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['graf_opc_atual'];

        if ($ver_93 == "n") {
            $sDisplay = !isset($_SESSION['sc_session']['Grid_MailingList_Contatos']['show_skip_charts_option']) ||
            !$_SESSION['sc_session']['Grid_MailingList_Contatos']['show_skip_charts_option'] ||
            (isset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['SC_Ind_Groupby']) ||
            $isMultiSeriesChart ||
            $isAnalitic ||
            ($opc == 'pdf_det')
                ? ' style="display: none"' : '';
        ...
        {
        $sDisplay =
//                    !isset($_SESSION['sc_session']['Grid_MailingList_Contatos']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['Grid_MailingList_Contatos']['show_skip_charts_option'] ||
            $isMultiSeriesChart ||
            $isAnalitic ||
