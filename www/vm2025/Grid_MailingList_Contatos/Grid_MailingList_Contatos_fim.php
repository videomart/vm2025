...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____Grid_MailingList_Contatos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____Grid_MailingList_Contatos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Grid_MailingList_Contatos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['embutida_filho'] as $ind => $sc_init)
          {
