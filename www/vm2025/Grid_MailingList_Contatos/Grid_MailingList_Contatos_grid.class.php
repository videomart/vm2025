<?php
class Grid_MailingList_Contatos_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   { 
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "Grid_MailingList_Contatos/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new Grid_MailingList_Contatos_resumo();
       $this->Res->Db     = $this->Db;
    ...
    if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['Grid_MailingList_Contatos'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if (!$this->Proc_link_res && $nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print')
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_refresh'] = array();
           $this->html_dynamic_search();
       } 
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new Grid_MailingList_Contatos_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("pt_br");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_pdf']['all_label'] : "N";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_add']))
   {
       ...
       $NM_func_dyn_add = "dynamic_search_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_add']['cmp'];
       $Lin_dyn_add = $this->$NM_func_dyn_add($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_add']['seq'], 'S');
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_ch_bi']))
   {
       $tmp_opc = $opc = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_ch_bi']['opc'];
       $this->Ini->process_cond_bi($opc, $bi_dt1, $bi_dt2);
       $NM_func_dyn_ch_bi = "formata_bi_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_ch_bi']['cmp'];
       ...
       $oJson = new Services_JSON();
       echo $oJson->encode($this->Arr_result);
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_ch_bi']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("Grid_MailingList_Contatos", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['EMPRESA'] = " asc";
   $this->Cmps_ord_def['CONTATO'] = " asc";
   $this->Cmps_ord_def['DATA'] = " asc";
   $this->Cmps_ord_def['ANO'] = " asc";
   $this->Cmps_ord_def['CATEGORIA'] = " asc";
   $this->Cmps_ord_def['NEWSLETTER'] = " desc";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'];
       ...
       $data_2 = (isset($Busca_temp['data_input_2'])) ? $Busca_temp['data_input_2'] : ""; 
       $this->data_2 = $data_2; 
   } 
   else 
   { 
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Grid_MailingList_Contatos'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['Grid_MailingList_Contatos'];
   ...
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "Grid_MailingList_Contatos_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new Grid_MailingList_Contatos_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] = 30;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['rows'];  
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['rows']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_select']['ANO + `DATA`'] = 'DESC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!$GLOBALS['nm_restore_grid_save'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['prim_cons'] || !empty($nmgp_parms)) )  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq_filtro'] = "";
   }   
   $GLOBALS['nm_restore_grid_save'] = false;
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['contr_array_resumo'] = "NAO";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['using_summary_cache']);
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = 0; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'];
   }
//----- 
    if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   { 
       $nmgp_select = "SELECT EMAIL, EMPRESA, CONTATO, DATA, ANO, CATEGORIA, NEWSLETTER from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp"; 
   } 
   else 
   { 
       $nmgp_select = "SELECT EMAIL, EMPRESA, CONTATO, DATA, ANO, CATEGORIA, NEWSLETTER from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp"; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->empresa = $this->rs_grid->fields[1] ;  
       $this->contato = $this->rs_grid->fields[2] ;  
       $this->data = $this->rs_grid->fields[3] ;  
       $this->ano = $this->rs_grid->fields[4] ;  
       $this->ano = (string)$this->ano;
       $this->categoria = $this->rs_grid->fields[5] ;  
       $this->newsletter = $this->rs_grid->fields[6] ;  
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']; 
   ...
   $this->NM_hidden_filters = ($this->Ini->Embutida_iframe && !empty($this->nm_grid_sem_reg) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['initialize']) ? true : false;
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['Grid_MailingList_Contatos']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
<!DOCTYPE html>
...
<HEAD>
 <TITLE>Sistema Videomart 2020 :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               Grid_MailingList_Contatos_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               Grid_MailingList_Contatos_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               Grid_MailingList_Contatos_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               Grid_MailingList_Contatos_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               Grid_MailingList_Contatos_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Sistema Videomart 2020</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/scriptcase__NM__ico__NM__favicon.ico\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"Grid_MailingList_Contatos_jquery_4080.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"Grid_MailingList_Contatos_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"Grid_MailingList_Contatos_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
$nm_saida->saida("    </style>\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
     ...
     if (!$_SESSION['scriptcase']['proc_mobile']) { 
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"Grid_MailingList_Contatos_save_grid.php\",\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Grid_MailingList_Contatos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Grid_MailingList_Contatos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_Grid_MailingList_Contatos_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".Grid_MailingList_Contatos_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .Grid_MailingList_Contatos_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".Grid_MailingList_Contatos_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida    = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['css_body_embutida'] : "";
   $this->css_remove_margin     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['link_info']['remove_margin']))     ? "margin: 0;" : "";
   $this->css_remove_border     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['link_info']['remove_border']))     ? "border-width: 0;" : "";
   $this->css_remove_background = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['link_info']['remove_background'])) ? "background-color: transparent; background-image: none;" : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && !$this->Print_All && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_total")
           {
       ...
       $this->Tab_valign = "top";
       $this->Tab_width = "";
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['pdf_res'])
       {
           return;
       } 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf_vert'])
   {
   }
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Grid_MailingList_Contatos']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Grid_MailingList_Contatos']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Grid_MailingList_Contatos']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Grid_MailingList_Contatos']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida']) ? "Grid_MailingList_Contatos_" : "";
   $this->css_sep = " ";
   ...
   $this->css_contato_label = $compl_css_emb . "css_contato_label";
   $this->css_contato_grid_line = $compl_css_emb . "css_contato_grid_line";
   ...
   $this->css_newsletter_label = $compl_css_emb . "css_newsletter_label";
   $this->css_newsletter_grid_line = $compl_css_emb . "css_newsletter_grid_line";
 }  
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_Grid_MailingList_Contatos__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-Grid_MailingList_Contatos-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_newsletter_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_newsletter_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_seq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_seq'] == "S") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_newsletter_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".Grid_MailingList_Contatos_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_email()
 {
   ...
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
 ...
 function NM_label_empresa()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_empresa_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_empresa_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('EMPRESA');
        $fieldSortIcon = $this->scGetColumnOrderIcon('EMPRESA', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_empresa_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_empresa_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('EMPRESA')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_contato()
 {
   ...
   if (!isset($this->NM_cmp_hidden['contato']) || $this->NM_cmp_hidden['contato'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_contato_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_contato_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('CONTATO');
        $fieldSortIcon = $this->scGetColumnOrderIcon('CONTATO', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_contato_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_contato_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('CONTATO')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_data()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_data_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_data_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('DATA');
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_data_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            ...
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_data_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('DATA')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
 ...
 function NM_label_ano()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_ano_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_ano_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('ANO');
        $fieldSortIcon = $this->scGetColumnOrderIcon('ANO', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_ano_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_ano_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('ANO')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_categoria_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_categoria_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_categoria_label . "\" style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: pre-line\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_categoria_label . "\" style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: pre-line" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
 ...
 function NM_label_newsletter()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['newsletter'])) ? $this->New_label['newsletter'] : "NEWSLETTER";
   $classColFld = "";
   $classColTitle = "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
     $classColFld = " sc-col-fld sc-col-fld-" . $this->grid_fixed_column_no;
   ...
   if (!isset($this->NM_cmp_hidden['newsletter']) || $this->NM_cmp_hidden['newsletter'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_newsletter_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_newsletter_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
        $fieldSortRule = $this->scGetColumnOrderRule('NEWSLETTER');
        $fieldSortIcon = $this->scGetColumnOrderIcon('NEWSLETTER', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_newsletter_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_field') {
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div></div>";
        } elseif ($this->Ini->Label_sort_pos == 'right_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_newsletter_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span></div>";
        } elseif ($this->Ini->Label_sort_pos == 'left_cell') {
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><span style=\"vertical-align: top;\">" . $fieldSortIcon . "</span><div style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div></div>";
        } else {
            $label_labelContent = "<div style=\"flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>";
        }
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('NEWSLETTER')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['email'])) ? $this->New_label['email'] : "EMAIL";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['empresa'])) ? $this->New_label['empresa'] : "EMPRESA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['contato'])) ? $this->New_label['contato'] : "CONTATO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['contato'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['data'])) ? $this->New_label['data'] : "DATA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['data'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ano'])) ? $this->New_label['ano'] : "ANO";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['ano'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['categoria'])) ? $this->New_label['categoria'] : "CATEGORIA";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['categoria'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['newsletter'])) ? $this->New_label['newsletter'] : "NEWSLETTER";
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['labels']['newsletter'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['Grid_MailingList_Contatos']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_Grid_MailingList_Contatos#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
   ...
   { 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'])
{
}
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_Grid_MailingList_Contatos#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-ff8793ee\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  Grid_MailingList_Contatos_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->newsletter = $this->rs_grid->fields[6] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['rows_emb']++;
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_newsletter_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_newsletter_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_seq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_seq'] == "S") { 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_newsletter_grid_line'] . "\" NOWRAP align=\"right\" valign=\"top\"   HEIGHT=\"0px\">" . $seq_det . "</TD>\r\n");
 } 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['field_order'] as $Cada_col)
          { 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'])
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_email()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['email']) || $this->NM_cmp_hidden['email'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_grid_empresa()
 {
      ...
      if (!isset($this->NM_cmp_hidden['empresa']) || $this->NM_cmp_hidden['empresa'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'empresa', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'empresa', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
 ...
 function NM_grid_contato()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['contato']) || $this->NM_cmp_hidden['contato'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              $conteudo = NM_encode_input(sc_strip_script($this->contato));
              $conteudo_original = NM_encode_input(sc_strip_script($this->contato));
          }
          else {
              $conteudo = sc_strip_script($this->contato); 
              $conteudo_original = sc_strip_script($this->contato); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'contato', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'contato', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_contato_grid_line . "\"  style=\"" . $this->Css_Cmp['css_contato_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_contato_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_ano()
 {
      ...
      if (!isset($this->NM_cmp_hidden['ano']) || $this->NM_cmp_hidden['ano'] != "off") { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" && isset($_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content']) && $_SESSION['nm_session']['sys_wkhtmltopdf_show_html_content'] == 'Y') {
              ...
              $conteudo = sc_strip_script($this->ano); 
              $conteudo_original = sc_strip_script($this->ano); 
          }
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
 ...
 function NM_grid_newsletter()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['newsletter']) || $this->NM_cmp_hidden['newsletter'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->newsletter)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->newsletter)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
          $this->Lookup->lookup_newsletter($conteudo); 
          $str_tem_display = $conteudo;
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'newsletter', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'newsletter', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != 'pdf') {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_newsletter_grid_line . "\"  style=\"" . $this->Css_Cmp['css_newsletter_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_newsletter_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_pdf'] == "pdf")
   {
       if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_seq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['exibe_seq'] != "S") && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf")
       {
           $this->NM_colspan--; 
       }
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['print_navigator'] == "Netscape")
            {
        ...
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $nm_saida->saida("         <span id=\"quicksearch_group_top\" class=\"scButton_default_group\" style='display: inline-block;'>\r\n");
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ajax_nav'])
          {
          ...
          $SC_Label_atu['empresa'] = (isset($this->New_label['empresa'])) ? $this->New_label['empresa'] : 'EMPRESA'; 
          $SC_Label_atu['contato'] = (isset($this->New_label['contato'])) ? $this->New_label['contato'] : 'CONTATO'; 
          ...
          $SC_Label_atu['newsletter'] = (isset($this->New_label['newsletter'])) ? $this->New_label['newsletter'] : 'NEWSLETTER'; 
       ...
       $nm_saida->saida("      $Cod_Btn \r\n");
          ...
          $nm_saida->saida("             </div>\r\n");
          $nm_saida->saida("          </span>");
          $nm_saida->saida("<span class='css_toolbar_obj css_toolbar_obj_qs_container' onclick=\"nm_gp_open_qsearch_div('top');\"><i id='SC_fast_search_dropdown_top' style='line-height: inherit; ' class='fas fa-caret-down'></i></span>");
          $nm_saida->saida("<span onclick=\"nm_gp_submit_qsearch('top');\" class='css_toolbar_obj css_toolbar_obj_qs_container'><span class='css_toolbar_obj_qs_container_height'></span><img style=\"display: \" id=\"SC_fast_search_submit_top\" src=\"" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_search . "\" align='absmiddle' /></span>");
          $nm_saida->saida("<span onclick=\"document.getElementById('SC_fast_search_top').value = '__Clear_Fast__'; nm_gp_submit_qsearch('top');\" class='css_toolbar_obj css_toolbar_obj_qs_container'><span class='css_toolbar_obj_qs_container_height'></span><img style=\"display: \" class='css_toolbar_obj_qs_search_img' id=\"SC_fast_search_close_top\" src=\"" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "\" align='absmiddle' /></span>");
          $nm_saida->saida("         </span>\r\n");
          $NM_btn = true;
      }
          $nm_saida->saida("         </td> \r\n");
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "", "", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $UseAlias =  "S";
              $this->nm_btn_exist['sort_col'][] = "ordcmp_top";
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "", "", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $Tem_gb_pdf  = "s";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_total")
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=pt_br&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=Grid_MailingList_Contatos&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
          {
          ...
          $Csv_mod_export = "grid,resume,chart";
          if ($Tem_csv_res == "n")
          {
              $Csv_mod_export = "grid";
          }
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
          {
          ...
          $Xls_mod_export = "grid,resume,chart";
          if ($Tem_xls_res == "n")
          {
              $Xls_mod_export = "grid";
          }
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
      ...
      if ($this->nmgp_botoes['gridsave'] == "on" && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          if (!$_SESSION['scriptcase']['proc_mobile'])
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgridsave", "", "", "save_grid_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "thickbox", "" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_save_grid.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_origem=cons&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("              $Cod_Btn \r\n");
          }
          else
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgridsave", "scBtnSaveGridShow('" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_save_grid.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_origem=cons&embbed_groupby=Y&toolbar_pos=top', 'Y', 'top', '', '');", "scBtnSaveGridShow('" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_save_grid.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_origem=cons&embbed_groupby=Y&toolbar_pos=top', 'Y', 'top', '', '');", "save_grid_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
                  $nm_saida->saida("           $Cod_Btn \r\n");
          }
          if ($save_grid_format == 'simplified' && !$_SESSION['scriptcase']['proc_mobile'])
          {
          ...
          if (is_file("Grid_MailingList_Contatos_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("Grid_MailingList_Contatos_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] == '30') ? " selected" : "";
              $nm_saida->saida("           <option value=\"30\" " . $obj_sel . ">30</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] == '50') ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Gb_Free_cmp']))
      {
          ...
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=pt_br&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=Grid_MailingList_Contatos&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $Xml_mod_export = "grid,resume,chart";
          if ($Tem_xml_res == "n")
          {
              $Xml_mod_export = "grid";
          }
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['SC_Ind_Groupby'] != "sc_free_total")
          {
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_dynamic_search()
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cond_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cond_pesq']))
       {
           $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['cond_pesq'];
           $pos = strrpos($tmp, "##*@@");
           if ($pos !== false)
           {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['email'] = (isset($this->New_label['email'])) ? $this->New_label['email'] : "EMAIL";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['empresa'] = (isset($this->New_label['empresa'])) ? $this->New_label['empresa'] : "EMPRESA";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['contato'] = (isset($this->New_label['contato'])) ? $this->New_label['contato'] : "CONTATO";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['categoria'] = (isset($this->New_label['categoria'])) ? $this->New_label['categoria'] : "CATEGORIA";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['data'] = (isset($this->New_label['data'])) ? $this->New_label['data'] : "DATA";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['ano'] = (isset($this->New_label['ano'])) ? $this->New_label['ano'] : "ANO";
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
   ...
   $_display = (empty($this->Dyn_search_str)?'none':'');
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search'] as $IX => $def)
           {
               $cmp = $def['cmp'];
               if ($cmp == "email")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "email";
                   $lin_obj = $this->dynamic_search_email($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               if ($cmp == "empresa")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "empresa";
                   $lin_obj = $this->dynamic_search_empresa($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               if ($cmp == "contato")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "contato";
                   $lin_obj = $this->dynamic_search_contato($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               if ($cmp == "categoria")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "categoria";
                   $lin_obj = $this->dynamic_search_categoria($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               if ($cmp == "data")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "data";
                   $lin_obj = $this->dynamic_search_data($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
               if ($cmp == "ano")
               {
                   $this->Dyn_search_seq++;;
                   $this->Dyn_search_dat[$this->Dyn_search_seq] = "ano";
                   $lin_obj = $this->dynamic_search_ano($this->Dyn_search_seq, 'N', $def['opc'], $def['val']);
                   $nm_saida->saida("" . $lin_obj . "\r\n");
               }
           }
       }
       $nm_saida->saida("                </div>\r\n");
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_out_cond']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_out_cond']))
       {
           $prim_out = true;
           $nm_saida->saida("              <div id='id_dyn_search_out_inside'>\r\n");
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_out_cond'] as $cada_out)
           {
               if (!$prim_out)
               {
                   $nm_saida->saida("              &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
       ...
       $nm_saida->saida("                <div id='Add_field_email' class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('email', 'grid')\">\r\n");
       $nm_saida->saida("                  " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['email'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div id='Add_field_empresa' class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('empresa', 'grid')\">\r\n");
       $nm_saida->saida("                  " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['empresa'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div id='Add_field_contato' class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('contato', 'grid')\">\r\n");
       $nm_saida->saida("                  " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['contato'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div id='Add_field_categoria' class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('categoria', 'grid')\">\r\n");
       $nm_saida->saida("                  " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['categoria'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div id='Add_field_data' class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('data', 'grid')\">\r\n");
       $nm_saida->saida("                  " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['data'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("        <tr>\r\n");
       $nm_saida->saida("            <td class='scBtnGrpBackground'>\r\n");
       $nm_saida->saida("                <div id='Add_field_ano' class='scBtnGrpText' style='cursor: pointer;' onclick=\"ajax_add_dyn_search('ano', 'grid')\">\r\n");
       $nm_saida->saida("                  " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['ano'] . "\r\n");
       $nm_saida->saida("                </div>\r\n");
       $nm_saida->saida("            </td>\r\n");
       $nm_saida->saida("        </tr>\r\n");
       $nm_saida->saida("      </table> \r\n");
       ...
       { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_clear']))
           { 
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_clear']);
               return;
           } 
           ...
           elseif(!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['new']['fields']) || !is_array($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['new']['fields']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['new']['fields']))
           {
   ...
   function dynamic_search_email($ind, $ajax, $opc="", $val=array(), $enabled = 'S')
   {
       $lin_obj  = "";
       $_classAlign = '';
       if (empty($opc))
       ...
       $lin_obj .= "     <div id='dyn_search_email_" . $ind . "' class='align " . $_classAlign . " " . ($enabled=='S'?'':'disabled') . "'>";
       ...
       $lin_obj .= "         " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['email'] . " ";
       $lin_obj .= "       </div>";
       $lin_obj .= "      </div >";
       $lin_obj .= "      <div class='fixed_width_conditions '>";
       $lin_obj .= "       <select id='dyn_search_email_cond_" . $ind . "' name='cond_dyn_search_email_" . $ind . "' class=' " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' style='vertical-align: middle; display: none'>";
       ...
       $nm_comando = "select distinct EMAIL from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where #lowerI#EMAIL#lowerF# = #lowerI#'$email_look'#lowerF#"; 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' id='dyn_search_email_val_" . $ind . "' name='val_dyn_search_email_" . $ind . "' onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn'); buttonDisable_dyn('SC_nmgp_save_name_dyn');\" value=\"" . NM_encode_input($val_cmp) . "\" size=25 alt=\"{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none' >";
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' type='text' id='id_ac_email" . $ind . "' name='val_dyn_search_email_autocomp" . $ind . "' size='25' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\"  onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $lin_obj .= "        </span>";
       $lin_obj .= "      </div>";
       $lin_obj .= "       <div class='fixed_width_toolbar'>";
       $lin_obj .= "       <img class='dyn_search_field_close' style='cursor:pointer' id='dyn_search_email_close_" . $ind . "' class='dyn_search_close' title='". $this->Ini->Nm_lang['lang_usr_lang_del'] ."' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_email_" . $ind . "', " . $ind . ", 'only');buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $enabled = 'S';
       $lin_obj .= "         <input type='hidden' class='dyn_search_enabled' name='dyn_search_enabled_email_" . $ind . "'  id='dyn_search_enabled_email_" . $ind . "' value='" . $enabled . "' />";
       $lin_obj .= "       </div>";
       $lin_obj .= "     </div>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne") {
           $lin_obj .= "     <script>";
   ...
   function dynamic_search_empresa($ind, $ajax, $opc="", $val=array(), $enabled = 'S')
   {
       $lin_obj  = "";
       $_classAlign = '';
       if (empty($opc))
       ...
       $lin_obj .= "     <div id='dyn_search_empresa_" . $ind . "' class='align " . $_classAlign . " " . ($enabled=='S'?'':'disabled') . "'>";
       $lin_obj .= "      <i class='fa-solid fa-grip-lines-vertical drag_handle'></i>";
       $lin_obj .= "      <div class='fixed_width_select'>";
       $lin_obj .= "       <div class='width-constrain' style='display: '>";
       $lin_obj .= "         " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['empresa'] . " ";
       $lin_obj .= "       </div>";
       $lin_obj .= "      </div >";
       $lin_obj .= "      <div class='fixed_width_conditions '>";
       $lin_obj .= "       <select id='dyn_search_empresa_cond_" . $ind . "' name='cond_dyn_search_empresa_" . $ind . "' class=' " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $lin_obj .= "       </select>";
       $lin_obj .= "      </div>";
       ...
       if ($empresa != "")
       {
       $empresa_look = (is_string($empresa) ? substr($this->Db->qstr($empresa), 1, -1) : $empresa); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct EMPRESA from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where #lowerI#EMPRESA#lowerF# = #lowerI#'$empresa_look'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$empresa]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$empresa];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' id='dyn_search_empresa_val_" . $ind . "' name='val_dyn_search_empresa_" . $ind . "' onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn'); buttonDisable_dyn('SC_nmgp_save_name_dyn');\" value=\"" . NM_encode_input($val_cmp) . "\" size=23 alt=\"{datatype: 'text', maxLength: 23, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none' >";
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' type='text' id='id_ac_empresa" . $ind . "' name='val_dyn_search_empresa_autocomp" . $ind . "' size='23' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 23, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\"  onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $lin_obj .= "        </span>";
       $lin_obj .= "      </div>";
       $lin_obj .= "       <div class='fixed_width_toolbar'>";
       $lin_obj .= "       <img class='dyn_search_field_close' style='cursor:pointer' id='dyn_search_empresa_close_" . $ind . "' class='dyn_search_close' title='". $this->Ini->Nm_lang['lang_usr_lang_del'] ."' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_empresa_" . $ind . "', " . $ind . ", 'only');buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $enabled = 'S';
       $lin_obj .= "         <input type='hidden' class='dyn_search_enabled' name='dyn_search_enabled_empresa_" . $ind . "'  id='dyn_search_enabled_empresa_" . $ind . "' value='" . $enabled . "' />";
       $lin_obj .= "       </div>";
       $lin_obj .= "     </div>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne") {
           $lin_obj .= "     <script>";
   ...
   function dynamic_search_contato($ind, $ajax, $opc="", $val=array(), $enabled = 'S')
   {
       $lin_obj  = "";
       $_classAlign = '';
       if (empty($opc))
       ...
       $lin_obj .= "     <div id='dyn_search_contato_" . $ind . "' class='align " . $_classAlign . " " . ($enabled=='S'?'':'disabled') . "'>";
       $lin_obj .= "      <i class='fa-solid fa-grip-lines-vertical drag_handle'></i>";
       $lin_obj .= "      <div class='fixed_width_select'>";
       $lin_obj .= "       <div class='width-constrain' style='display: '>";
       $lin_obj .= "         " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['contato'] . " ";
       $lin_obj .= "       </div>";
       $lin_obj .= "      </div >";
       $lin_obj .= "      <div class='fixed_width_conditions '>";
       $lin_obj .= "       <select id='dyn_search_contato_cond_" . $ind . "' name='cond_dyn_search_contato_" . $ind . "' class=' " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $lin_obj .= "       </select>";
       $lin_obj .= "      </div>";
       ...
       if ($contato != "")
       {
       $contato_look = (is_string($contato) ? substr($this->Db->qstr($contato), 1, -1) : $contato); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct CONTATO from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where #lowerI#CONTATO#lowerF# = #lowerI#'$contato_look'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$contato]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$contato];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' id='dyn_search_contato_val_" . $ind . "' name='val_dyn_search_contato_" . $ind . "' onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn'); buttonDisable_dyn('SC_nmgp_save_name_dyn');\" value=\"" . NM_encode_input($val_cmp) . "\" size=12 alt=\"{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none' >";
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' type='text' id='id_ac_contato" . $ind . "' name='val_dyn_search_contato_autocomp" . $ind . "' size='12' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\"  onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $lin_obj .= "        </span>";
       $lin_obj .= "      </div>";
       $lin_obj .= "       <div class='fixed_width_toolbar'>";
       $lin_obj .= "       <img class='dyn_search_field_close' style='cursor:pointer' id='dyn_search_contato_close_" . $ind . "' class='dyn_search_close' title='". $this->Ini->Nm_lang['lang_usr_lang_del'] ."' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_contato_" . $ind . "', " . $ind . ", 'only');buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $enabled = 'S';
       $lin_obj .= "         <input type='hidden' class='dyn_search_enabled' name='dyn_search_enabled_contato_" . $ind . "'  id='dyn_search_enabled_contato_" . $ind . "' value='" . $enabled . "' />";
       $lin_obj .= "       </div>";
       $lin_obj .= "     </div>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne") {
           $lin_obj .= "     <script>";
   ...
   function dynamic_search_categoria($ind, $ajax, $opc="", $val=array(), $enabled = 'S')
   {
       $lin_obj  = "";
       $_classAlign = '';
       if (empty($opc))
       ...
       $lin_obj .= "     <div id='dyn_search_categoria_" . $ind . "' class='align " . $_classAlign . " " . ($enabled=='S'?'':'disabled') . "'>";
       $lin_obj .= "      <i class='fa-solid fa-grip-lines-vertical drag_handle'></i>";
       $lin_obj .= "      <div class='fixed_width_select'>";
       $lin_obj .= "       <div class='width-constrain' style='display: '>";
       $lin_obj .= "         " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['categoria'] . " ";
       $lin_obj .= "       </div>";
       $lin_obj .= "      </div >";
       $lin_obj .= "      <div class='fixed_width_conditions '>";
       $lin_obj .= "       <select id='dyn_search_categoria_cond_" . $ind . "' name='cond_dyn_search_categoria_" . $ind . "' class=' " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "qp") ? " selected" : "";
       $lin_obj .= "        <option value='qp'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_like'] . "</option>";
       $lin_obj .= "       </select>";
       $lin_obj .= "      </div>";
       ...
       $lin_obj .= "      <div class='fixed_width_input  fixed_width_input100'>";
       $lin_obj .= "        <span class='fixed_width_input_content' style='display:" . $display_in_1 . "'>";
       $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['psq_check_ret']['categoria'] = array();
       $categoria_look = (is_string($categoria) ? substr($this->Db->qstr($categoria), 1, -1) : $categoria); 
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "Categoria?#??#?N?@?"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['psq_check_ret']['categoria'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . " css_toolbar_obj' id=\"dyn_search_categoria_val_" . $ind . "\" name=\"val_dyn_search_categoria_" . $ind . "\"  size=1 onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn'); buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $delimitador = "##@@";
       ...
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $categoria_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "        </span>";
       $lin_obj .= "      </div>";
       $lin_obj .= "       <div class='fixed_width_toolbar'>";
       $lin_obj .= "       <img class='dyn_search_field_close' style='cursor:pointer' id='dyn_search_categoria_close_" . $ind . "' class='dyn_search_close' title='". $this->Ini->Nm_lang['lang_usr_lang_del'] ."' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_categoria_" . $ind . "', " . $ind . ", 'only');buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $enabled = 'S';
       $lin_obj .= "         <input type='hidden' class='dyn_search_enabled' name='dyn_search_enabled_categoria_" . $ind . "'  id='dyn_search_enabled_categoria_" . $ind . "' value='" . $enabled . "' />";
       $lin_obj .= "       </div>";
       $lin_obj .= "     </div>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne") {
           $lin_obj .= "     <script>";
   ...
   function dynamic_search_data($ind, $ajax, $opc="", $val=array(), $enabled = 'S')
   {
       $lin_obj  = "";
       $_classAlign = '';
       if (empty($opc))
       ...
       $lin_obj .= "     <div id='dyn_search_data_" . $ind . "' class='align " . $_classAlign . " " . ($enabled=='S'?'':'disabled') . "'>";
       $lin_obj .= "      <i class='fa-solid fa-grip-lines-vertical drag_handle'></i>";
       $lin_obj .= "      <div class='fixed_width_select'>";
       $lin_obj .= "       <div class='width-constrain' style='display: '>";
       $lin_obj .= "         " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['data'] . " ";
       $lin_obj .= "       </div>";
       $lin_obj .= "      </div >";
       $lin_obj .= "      <div class='fixed_width_conditions '>";
       $lin_obj .= "       <select id='dyn_search_data_cond_" . $ind . "' name='cond_dyn_search_data_" . $ind . "' class=' " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' style='vertical-align: middle;' onChange='buttonEnable_dyn(\"dyn_search\");dyn_search_change_bi(\"data\", $ind)'>";
       ...
       $selected = ($opc == "bi_last_3_months_current") ? " selected" : "";
       $lin_obj .= "        <option value='bi_last_3_months_current'" . $selected . ">" . $this->Ini->Nm_lang['lang_search_last_3_months_current'] . "</option>";
       $selected = ($opc == "bi_current_quarter_today") ? " selected" : "";
       $lin_obj .= "        <option value='bi_current_quarter_today'" . $selected . ">" . $this->Ini->Nm_lang['lang_search_summary_current_quarter_today'] . "</option>";
       ...
       $lin_obj .= "      <div class='fixed_width_input '>";
       $lin_obj .= "        <span class='fixed_width_input_content' style='display:" . $display_in_1 . "'>";
       $Form_base          = "ddmmyyyy";
       $date_format_show   = "";
       ...
       if (substr($opc, 0, 3) == "bi_")
       {
           ...
           if ($opc != "bi_TP")
           {
               ...
               $this->formata_bi_data($opc, $bi_dt1, $bi_dt2, $tmp_opc);
           }
       }
       else
       {
       ...
       $lin_obj .= "<SPAN id=\"ID_bi_dados_data_" . $ind . "\" style=\"display:" . $display_bi . ";\">" . $bi_dt1 . $bi_dt2 . "</SPAN>";
       $lin_obj .= "<table id=\"ID_nm_dados_data_" . $ind . "\" style=\"display:" . $display_nm . ";\" cellpadding=0 cellspacing=0>";
       $lin_obj .= "<tr><td nowrap>";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj fixed_width_year' id='dyn_search_data_ano_val_" . $ind . "' name='val_dyn_search_data_ano_" . $ind . "' placeholder=\"" . $Place_holder['yyyy'] . "\" value=\"" . NM_encode_input($val_cmp) . "\" size=4  alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: true}\" onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj fixed_width_date' id='dyn_search_data_mes_val_" . $ind . "' name='val_dyn_search_data_mes_" . $ind . "' placeholder=\"" . $Place_holder['mm'] . "\" value=\"" . NM_encode_input($val_cmp) . "\" size=2  alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: true}\" onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj fixed_width_date' id='dyn_search_data_dia_val_" . $ind . "' name='val_dyn_search_data_dia_" . $ind . "' placeholder=\"" . $Place_holder['dd'] . "\" value=\"" . NM_encode_input($val_cmp) . "\" size=2  alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: true}\" onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "</td></tr></table>";
       if ($opc == "bw")
       ...
       $lin_obj .= "       <span id=\"dyn_data_in_2_" . $ind . "\" style=\"margin-top: .4rem; display:" . $display_in_2 . "\">";
       $date_sep_bw = " Até ";
       if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
       {
           $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
       }
       $lin_obj .= "       <span style='margin: .4rem 0px; display:block;'></span>";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['ano'])) ? $val_r['ano'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj fixed_width_year' id='dyn_search_data_v2__ano_val_" . $ind . "' name='val_dyn_search_data_v2__ano_" . $ind . "' placeholder=\"" . $Place_holder['yyyy'] . "\" value=\"" . NM_encode_input($val_cmp) . "\" size=4  alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: true}\" onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj fixed_width_date' id='dyn_search_data_v2__mes_val_" . $ind . "' name='val_dyn_search_data_v2__mes_" . $ind . "' placeholder=\"" . $Place_holder['mm'] . "\" value=\"" . NM_encode_input($val_cmp) . "\" size=2  alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: true}\" onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj fixed_width_date' id='dyn_search_data_v2__dia_val_" . $ind . "' name='val_dyn_search_data_v2__dia_" . $ind . "' placeholder=\"" . $Place_holder['dd'] . "\" value=\"" . NM_encode_input($val_cmp) . "\" size=2  alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: true}\" onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "       </span>";
       $lin_obj .= "        </span>";
       $lin_obj .= "      </div>";
       $lin_obj .= "       <div class='fixed_width_toolbar'>";
       $lin_obj .= "       <img class='dyn_search_field_close' style='cursor:pointer' id='dyn_search_data_close_" . $ind . "' class='dyn_search_close' title='". $this->Ini->Nm_lang['lang_usr_lang_del'] ."' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_data_" . $ind . "', " . $ind . ", 'only');buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $enabled = 'S';
       $lin_obj .= "         <input type='hidden' class='dyn_search_enabled' name='dyn_search_enabled_data_" . $ind . "'  id='dyn_search_enabled_data_" . $ind . "' value='" . $enabled . "' />";
       $lin_obj .= "       </div>";
       $lin_obj .= "     </div>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne" || substr($opc, 0, 3) == "bi_") {
           $lin_obj .= "     <script>";
           $lin_obj .= "        $( document ).ready(function() {buttonEnable_dyn('dyn_search');});";
           $lin_obj .= "     </script>";
       }
   ...
   function dynamic_search_ano($ind, $ajax, $opc="", $val=array(), $enabled = 'S')
   {
       $lin_obj  = "";
       $_classAlign = '';
       if (empty($opc))
       ...
       $lin_obj .= "     <div id='dyn_search_ano_" . $ind . "' class='align " . $_classAlign . " " . ($enabled=='S'?'':'disabled') . "'>";
       $lin_obj .= "      <i class='fa-solid fa-grip-lines-vertical drag_handle'></i>";
       $lin_obj .= "      <div class='fixed_width_select'>";
       $lin_obj .= "       <div class='width-constrain' style='display: '>";
       $lin_obj .= "         " . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_label']['ano'] . " ";
       $lin_obj .= "       </div>";
       $lin_obj .= "      </div >";
       $lin_obj .= "      <div class='fixed_width_conditions '>";
       $lin_obj .= "       <select id='dyn_search_ano_cond_" . $ind . "' name='cond_dyn_search_ano_" . $ind . "' class=' " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' style='vertical-align: middle;' onChange='buttonEnable_dyn(\"dyn_search\");dyn_search_hide_input(\"ano\", $ind)'>";
       ...
       if ($ano != "")
       {
       $ano_look = (is_string($ano) ? substr($this->Db->qstr($ano), 1, -1) : $ano); 
       $nmgp_def_dados = array(); 
    if (is_numeric($ano))
    { 
       $nm_comando = "select distinct ANO from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where ANO = $ano_look"; 
       $nm_comando = str_replace("#lowerI#", "", $nm_comando);
       $nm_comando = str_replace("#lowerF#", "", $nm_comando);
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' id='dyn_search_ano_val_" . $ind . "' name='val_dyn_search_ano_" . $ind . "' onChange=\"buttonEnable_dyn('dyn_search'); buttonDisable_dyn('Save_frm_dyn'); buttonDisable_dyn('SC_nmgp_save_name_dyn');\" value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'text', maxLength: 4, allowedChars: '0123456789" . $_SESSION['scriptcase']['reg_conf']['dec_num']  . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', lettersCase: '', enterTab: false}\" style='display: none' >";
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . " css_toolbar_obj' type='text' id='id_ac_ano" . $ind . "' name='val_dyn_search_ano_autocomp" . $ind . "' size='4' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 4, allowedChars: '0123456789" . $_SESSION['scriptcase']['reg_conf']['dec_num']  . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', lettersCase: '', enterTab: false}\"  onChange=\"buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $lin_obj .= "        </span>";
       $lin_obj .= "      </div>";
       $lin_obj .= "       <div class='fixed_width_toolbar'>";
       $lin_obj .= "       <img class='dyn_search_field_close' style='cursor:pointer' id='dyn_search_ano_close_" . $ind . "' class='dyn_search_close' title='". $this->Ini->Nm_lang['lang_usr_lang_del'] ."' src='" . $this->Ini->path_botoes . "/" . $this->Ini->Img_qs_clean . "' onclick=\"del_dyn_search('dyn_search_ano_" . $ind . "', " . $ind . ", 'only');buttonEnable_dyn('dyn_search');buttonDisable_dyn('Save_frm_dyn');buttonDisable_dyn('SC_nmgp_save_name_dyn');\">";
       $enabled = 'S';
       $lin_obj .= "         <input type='hidden' class='dyn_search_enabled' name='dyn_search_enabled_ano_" . $ind . "'  id='dyn_search_enabled_ano_" . $ind . "' value='" . $enabled . "' />";
       $lin_obj .= "       </div>";
       $lin_obj .= "     </div>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne") {
           $lin_obj .= "     <script>";
   ...
   function lookup_ajax_email($email)
   {
       ...
       $email_look = (is_string($email) ? substr($this->Db->qstr($email), 1, -1) : $email); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct EMAIL from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where  #lowerI#EMAIL#lowerF# like #lowerI#'%" . $email . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = Grid_MailingList_Contatos_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function lookup_ajax_empresa($empresa)
   {
       $empresa = substr($this->Db->qstr($empresa), 1, -1);
       $this->NM_case_insensitive = true;
       $empresa_look = (is_string($empresa) ? substr($this->Db->qstr($empresa), 1, -1) : $empresa); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct EMPRESA from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where  #lowerI#EMPRESA#lowerF# like #lowerI#'%" . $empresa . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function lookup_ajax_contato($contato)
   {
       $contato = substr($this->Db->qstr($contato), 1, -1);
       $this->NM_case_insensitive = true;
       $contato_look = (is_string($contato) ? substr($this->Db->qstr($contato), 1, -1) : $contato); 
       $nmgp_def_dados = array(); 
       $nm_comando = "select distinct CONTATO from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where  #lowerI#CONTATO#lowerF# like #lowerI#'%" . $contato . "%'#lowerF#"; 
       if ($this->NM_case_insensitive)
       {
           if (isset($this->Ini->nm_bases_access) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
           {
   ...
   function lookup_ajax_ano($ano)
   {
      ...
      {
          $nm_comando = "select distinct ANO from (SELECT  	 lower( 		trim(contato.EMAIL) 	) as EMAIL, EMPRESA, contato.CONTATO ,empresa.CATEGORIA,  	 DATA , year(DATA) as ANO , contato.NEWSLETTER FROM  	contato,  	empresa  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')  UNION   SELECT  	 lower( 		trim(empresa.EMAIL) 	) as EMAIL, EMPRESA,empresa.CONTATO,empresa.CATEGORIA, 	 DATA , year(DATA) as ANO, empresa.NEWSLETTER FROM  	empresa,  	contato  where  	(empresa.ID = contato.ID_EMPRESA)  	and (contato.email <> '')   ) nm_sel_esp where  ANO like '%" . $ano . "%'"; 
      }
   ...
   function formata_bi_data($opc, &$bi_dt1, &$bi_dt2, $opc_bi)
   {
       $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
   ...
   function dynamicSearchStartHtmlRec($arr_arvore, $str_id)
   {
       ...
       if(isset($arr_arvore['fields']) && !empty($arr_arvore['fields']))
       {
           foreach($arr_arvore['fields'] as $chield)
           {
               ...
               {
                   $bol_found = false;
                   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['old'] as $_tmp)
                   {
                   ...
                   if ($chield['name'] == "email")
                   {
                       $this->Dyn_search_seq++;
                       $this->Dyn_search_dat[$this->Dyn_search_seq] = "email";
                       $str_filhos .= $this->dynamic_search_email($this->Dyn_search_seq, 'N', $def['opc'], $def['val'], $chield['enabled']);
                   }
                   if ($chield['name'] == "empresa")
                   {
                       $this->Dyn_search_seq++;
                       $this->Dyn_search_dat[$this->Dyn_search_seq] = "empresa";
                       $str_filhos .= $this->dynamic_search_empresa($this->Dyn_search_seq, 'N', $def['opc'], $def['val'], $chield['enabled']);
                   }
                   if ($chield['name'] == "contato")
                   {
                       $this->Dyn_search_seq++;
                       $this->Dyn_search_dat[$this->Dyn_search_seq] = "contato";
                       $str_filhos .= $this->dynamic_search_contato($this->Dyn_search_seq, 'N', $def['opc'], $def['val'], $chield['enabled']);
                   }
                   if ($chield['name'] == "categoria")
                   {
                       $this->Dyn_search_seq++;
                       $this->Dyn_search_dat[$this->Dyn_search_seq] = "categoria";
                       $str_filhos .= $this->dynamic_search_categoria($this->Dyn_search_seq, 'N', $def['opc'], $def['val'], $chield['enabled']);
                   }
                   if ($chield['name'] == "data")
                   {
                       $this->Dyn_search_seq++;
                       $this->Dyn_search_dat[$this->Dyn_search_seq] = "data";
                       $str_filhos .= $this->dynamic_search_data($this->Dyn_search_seq, 'N', $def['opc'], $def['val'], $chield['enabled']);
                   }
                   if ($chield['name'] == "ano")
                   {
                       $this->Dyn_search_seq++;
                       $this->Dyn_search_dat[$this->Dyn_search_seq] = "ano";
                       $str_filhos .= $this->dynamic_search_ano($this->Dyn_search_seq, 'N', $def['opc'], $def['val'], $chield['enabled']);
                   }
               }
               $str_filhos .= '</li>';
           }
...
';
   ...
   function dynamicSearchStartHtml()
   {
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</style>\r\n");
       if(!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['new'] = array('condition' => 'AND', 'type'=>'ul', 'fields'=>'array()');
           $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['old'] = array();
       }
       $contUl = 0;
       $dynamicSearchStartHtmlRec = $this->dynamicSearchStartHtmlRec($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search_and_or']['new'], 'dynamicSearchStart');
   ...
   function JS_dynamic_search()
   {
       ...
       $nm_saida->saida(" function sc_Grid_MailingList_Contatos_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_Grid_MailingList_Contatos_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['data_mes'] =  'sc_Grid_MailingList_Contatos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['data_dia'] =  'sc_Grid_MailingList_Contatos_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['data_v2__mes'] =  'sc_Grid_MailingList_Contatos_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_dyn_search['data_v2__dia'] =  'sc_Grid_MailingList_Contatos_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['data_mes']", 'value' => 'sc_Grid_MailingList_Contatos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['data_dia']", 'value' => 'sc_Grid_MailingList_Contatos_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['data_v2__mes']", 'value' => 'sc_Grid_MailingList_Contatos_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_dyn_search['data_v2__dia']", 'value' => 'sc_Grid_MailingList_Contatos_valida_dia(this)');
...
$nm_saida->saida("         Tab_obj_dyn_search[seq] = obj.value;\r\n");
       ...
       $nm_saida->saida("                      $(\"#id_ac_email\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                          $(\"#dyn_search_email_val_\" + x).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#dyn_search_email_val_\" + x).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'empresa')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_empresa\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#dyn_search_empresa_val_\" + x).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#dyn_search_empresa_val_\" + x).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'contato')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_contato\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#dyn_search_contato_val_\" + x).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#dyn_search_contato_val_\" + x).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'ano')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_ano\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#dyn_search_ano_val_\" + x).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#dyn_search_ano_val_\" + x).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("        if(parm == 'bw') $('#dyn_search_'+ field +'_' + ind).addClass('alignTop');\r\n");
       $nm_saida->saida("        else $('#dyn_search_'+ field +'_' + ind).removeClass('alignTop');\r\n");
       ...
       $nm_saida->saida("            if (parm == \"nu\" || parm == \"nn\" || parm == \"ep\" || parm == \"ne\")\r\n");
       $nm_saida->saida("            {\r\n");
       $nm_saida->saida("                $('#dyn_search_' + field + '_' + ind+' .fixed_width_input_content').hide();\r\n");
       $nm_saida->saida("            }\r\n");
       $nm_saida->saida("            else\r\n");
       $nm_saida->saida("            {\r\n");
       $nm_saida->saida("                $('#dyn_search_' + field + '_' + ind+' .fixed_width_input_content').show();\r\n");
       $nm_saida->saida("            }\r\n");
       $nm_saida->saida("        }\r\n");
       $nm_saida->saida("     }\r\n");
       ...
       $nm_saida->saida("         }\r\n");
       $nm_saida->saida("         ajax_add_dyn_search_js('email', 'grid')\r\n");
       $nm_saida->saida("     }\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search']) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search'])
            )
            {
                foreach($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['dyn_search'] as $_fld)
                {
                    if($_fld['cmp'] == $field)
                    {
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('empresa', 'categoria', 'contato', 'email'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Grid_MailingList_Contatos', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"Grid_MailingList_Contatos\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"Grid_MailingList_Contatos_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"Grid_MailingList_Contatos_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "Grid_MailingList_Contatos/Grid_MailingList_Contatos_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"Grid_MailingList_Contatos_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Grid_MailingList_Contatos_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@Grid_MailingList_Contatos@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"Grid_MailingList_Contatos_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"Grid_MailingList_Contatos_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"Grid_MailingList_Contatos_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['Grid_MailingList_Contatos']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"Grid_MailingList_Contatos_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Grid_MailingList_Contatos']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('Grid_MailingList_Contatos')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('Grid_MailingList_Contatos', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
