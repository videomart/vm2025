...
<?php
   ...
   $Ord_Cmp = new Grid_MailingList_Contatos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Grid_MailingList_Contatos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["email"] : "EMAIL";
   $tab_ger_campos['empresa'] = "on";
   $tab_def_campos['empresa'] = "EMPRESA";
   $tab_labels["empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["empresa"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["empresa"] : "EMPRESA";
   $tab_ger_campos['contato'] = "on";
   $tab_def_campos['contato'] = "CONTATO";
   $tab_labels["contato"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["contato"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["contato"] : "CONTATO";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "DATA";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["data"] : "DATA";
   $tab_ger_campos['ano'] = "on";
   $tab_def_campos['ano'] = "ANO";
   $tab_labels["ano"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["ano"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["ano"] : "ANO";
   $tab_ger_campos['categoria'] = "on";
   $tab_def_campos['categoria'] = "CATEGORIA";
   $tab_labels["categoria"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["categoria"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["categoria"] : "CATEGORIA";
   $tab_ger_campos['newsletter'] = "on";
   $tab_def_campos['newsletter'] = "NEWSLETTER";
   $tab_labels["newsletter"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["newsletter"])) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['labels']["newsletter"] : "NEWSLETTER";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Grid_MailingList_Contatos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Grid_MailingList_Contatos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
