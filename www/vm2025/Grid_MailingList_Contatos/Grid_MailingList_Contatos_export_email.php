<?php
   ...
   session_start();
    ...
    $exportEmail = new exportEmail_Grid_MailingList_Contatos(); 
   
class exportEmail_Grid_MailingList_Contatos
{
  ...
  'smtp_port' => '465',
  'smtp_user' => 'vmbroadcast@videomart.com.br',
  'smtp_password' => 'broadcast123',
  'smtp_protocol' => 'TLS',
  'from_email' => 'comercial@videomart.com.br',
  'from_name' => 'Sistema VM',
),
                          'message' => [
...
<HEAD>
 <TITLE><?php echo "Sistema Videomart 2020"; ?></TITLE>
...
?>
            ...
            function html_export_email_send()
            {
                $.ajax({
                    type: 'POST',
                    url: 'Grid_MailingList_Contatos_export_email.php',
