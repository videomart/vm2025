<?php
@session_start() ;
$_SESSION['scriptcase']['Grid_MailingList_Contatos']['sc_process_barr'] = true;
require_once('../Grid_MailingList_Contatos/index.php');
unset($_SESSION['scriptcase']['Grid_MailingList_Contatos']['sc_process_barr']);
$ExportCtrl = new Grid_MailingList_Contatos_export_control;
$ExportCtrl->Export_barr();

class Grid_MailingList_Contatos_export_control
{
