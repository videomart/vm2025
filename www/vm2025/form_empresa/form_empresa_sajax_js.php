  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empresa" == sTestField)
        {
...
?>
  ...
  // ---------- Validate tipo
  function do_ajax_form_empresa_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_empresa_validate_tipo_cb);
  } // do_ajax_form_empresa_validate_tipo

  function do_ajax_form_empresa_validate_tipo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_tipo_cb

  // ---------- Validate cnpj_cpf
  function do_ajax_form_empresa_validate_cnpj_cpf()
  {
    var nomeCampo_cnpj_cpf = "cnpj_cpf";
    var nomeCampo_tipo = "tipo";
    var var_cnpj_cpf = scAjaxGetFieldText(nomeCampo_cnpj_cpf);
    var var_tipo = scAjaxGetFieldRadio(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_cnpj_cpf(var_cnpj_cpf, var_tipo, var_script_case_init, do_ajax_form_empresa_validate_cnpj_cpf_cb);
  } // do_ajax_form_empresa_validate_cnpj_cpf

  function do_ajax_form_empresa_validate_cnpj_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "cnpj_cpf";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_cnpj_cpf_cb

  // ---------- Validate categoria
  function do_ajax_form_empresa_validate_categoria()
  {
    var nomeCampo_categoria = "categoria";
    var var_categoria = scAjaxGetFieldSelect(nomeCampo_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_categoria(var_categoria, var_script_case_init, do_ajax_form_empresa_validate_categoria_cb);
  } // do_ajax_form_empresa_validate_categoria

  function do_ajax_form_empresa_validate_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_categoria_cb

  // ---------- Validate rede
  function do_ajax_form_empresa_validate_rede()
  {
    var nomeCampo_rede = "rede";
    var var_rede = scAjaxGetFieldSelect(nomeCampo_rede);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_rede(var_rede, var_script_case_init, do_ajax_form_empresa_validate_rede_cb);
  } // do_ajax_form_empresa_validate_rede

  function do_ajax_form_empresa_validate_rede_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_rede_cb

  // ---------- Validate empresa
  function do_ajax_form_empresa_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_empresa_validate_empresa_cb);
  } // do_ajax_form_empresa_validate_empresa

  function do_ajax_form_empresa_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_empresa_cb

  // ---------- Validate contato
  function do_ajax_form_empresa_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_contato(var_contato, var_script_case_init, do_ajax_form_empresa_validate_contato_cb);
  } // do_ajax_form_empresa_validate_contato

  function do_ajax_form_empresa_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_contato_cb

  // ---------- Validate cep
  function do_ajax_form_empresa_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_cep(var_cep, var_script_case_init, do_ajax_form_empresa_validate_cep_cb);
  } // do_ajax_form_empresa_validate_cep

  function do_ajax_form_empresa_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_empresa_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_empresa_validate_endereco_cb);
  } // do_ajax_form_empresa_validate_endereco

  function do_ajax_form_empresa_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_endereco_cb

  // ---------- Validate id_cidade
  function do_ajax_form_empresa_validate_id_cidade()
  {
    var nomeCampo_id_cidade = "id_cidade";
    var var_id_cidade = scAjaxGetFieldSelect(nomeCampo_id_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_id_cidade(var_id_cidade, var_script_case_init, do_ajax_form_empresa_validate_id_cidade_cb);
  } // do_ajax_form_empresa_validate_id_cidade

  function do_ajax_form_empresa_validate_id_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_id_cidade_cb

  // ---------- Validate telefone
  function do_ajax_form_empresa_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_empresa_validate_telefone_cb);
  } // do_ajax_form_empresa_validate_telefone

  function do_ajax_form_empresa_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_empresa_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_email(var_email, var_script_case_init, do_ajax_form_empresa_validate_email_cb);
  } // do_ajax_form_empresa_validate_email

  function do_ajax_form_empresa_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_email_cb

  // ---------- Validate celular
  function do_ajax_form_empresa_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_celular(var_celular, var_script_case_init, do_ajax_form_empresa_validate_celular_cb);
  } // do_ajax_form_empresa_validate_celular

  function do_ajax_form_empresa_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_celular_cb

  // ---------- Validate cidade
  function do_ajax_form_empresa_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_empresa_validate_cidade_cb);
  } // do_ajax_form_empresa_validate_cidade

  function do_ajax_form_empresa_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_cidade_cb

  // ---------- Validate uf
  function do_ajax_form_empresa_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_uf(var_uf, var_script_case_init, do_ajax_form_empresa_validate_uf_cb);
  } // do_ajax_form_empresa_validate_uf

  function do_ajax_form_empresa_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_uf_cb

  // ---------- Validate bairro
  function do_ajax_form_empresa_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_empresa_validate_bairro_cb);
  } // do_ajax_form_empresa_validate_bairro

  function do_ajax_form_empresa_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_bairro_cb

  // ---------- Validate logradouro
  function do_ajax_form_empresa_validate_logradouro()
  {
    var nomeCampo_logradouro = "logradouro";
    var var_logradouro = scAjaxGetFieldText(nomeCampo_logradouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_logradouro(var_logradouro, var_script_case_init, do_ajax_form_empresa_validate_logradouro_cb);
  } // do_ajax_form_empresa_validate_logradouro

  function do_ajax_form_empresa_validate_logradouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_logradouro_cb

  // ---------- Validate dat_ult_mov
  function do_ajax_form_empresa_validate_dat_ult_mov()
  {
    var nomeCampo_dat_ult_mov = "dat_ult_mov";
    var var_dat_ult_mov = scAjaxGetFieldHidden(nomeCampo_dat_ult_mov);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_dat_ult_mov(var_dat_ult_mov, var_script_case_init, do_ajax_form_empresa_validate_dat_ult_mov_cb);
  } // do_ajax_form_empresa_validate_dat_ult_mov

  function do_ajax_form_empresa_validate_dat_ult_mov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_dat_ult_mov_cb

  // ---------- Validate data
  function do_ajax_form_empresa_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_data(var_data, var_script_case_init, do_ajax_form_empresa_validate_data_cb);
  } // do_ajax_form_empresa_validate_data

  function do_ajax_form_empresa_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_data_cb

  // ---------- Validate homepage
  function do_ajax_form_empresa_validate_homepage()
  {
    var nomeCampo_homepage = "homepage";
    var var_homepage = scAjaxGetFieldText(nomeCampo_homepage);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_homepage(var_homepage, var_script_case_init, do_ajax_form_empresa_validate_homepage_cb);
  } // do_ajax_form_empresa_validate_homepage

  function do_ajax_form_empresa_validate_homepage_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_homepage_cb

  // ---------- Validate inscmun
  function do_ajax_form_empresa_validate_inscmun()
  {
    var nomeCampo_inscmun = "inscmun";
    var var_inscmun = scAjaxGetFieldText(nomeCampo_inscmun);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_inscmun(var_inscmun, var_script_case_init, do_ajax_form_empresa_validate_inscmun_cb);
  } // do_ajax_form_empresa_validate_inscmun

  function do_ajax_form_empresa_validate_inscmun_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_inscmun_cb

  // ---------- Validate inscest
  function do_ajax_form_empresa_validate_inscest()
  {
    var nomeCampo_inscest = "inscest";
    var var_inscest = scAjaxGetFieldText(nomeCampo_inscest);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_inscest(var_inscest, var_script_case_init, do_ajax_form_empresa_validate_inscest_cb);
  } // do_ajax_form_empresa_validate_inscest

  function do_ajax_form_empresa_validate_inscest_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_inscest_cb

  // ---------- Validate whatsapp
  function do_ajax_form_empresa_validate_whatsapp()
  {
    var nomeCampo_whatsapp = "whatsapp";
    var var_whatsapp = scAjaxGetFieldText(nomeCampo_whatsapp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_whatsapp(var_whatsapp, var_script_case_init, do_ajax_form_empresa_validate_whatsapp_cb);
  } // do_ajax_form_empresa_validate_whatsapp

  function do_ajax_form_empresa_validate_whatsapp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "whatsapp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_whatsapp_cb

  // ---------- Validate cadastrante
  function do_ajax_form_empresa_validate_cadastrante()
  {
    var nomeCampo_cadastrante = "cadastrante";
    var var_cadastrante = scAjaxGetFieldText(nomeCampo_cadastrante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_cadastrante(var_cadastrante, var_script_case_init, do_ajax_form_empresa_validate_cadastrante_cb);
  } // do_ajax_form_empresa_validate_cadastrante

  function do_ajax_form_empresa_validate_cadastrante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_cadastrante_cb

  // ---------- Validate obs
  function do_ajax_form_empresa_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldEditorHtml(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_obs(var_obs, var_script_case_init, do_ajax_form_empresa_validate_obs_cb);
  } // do_ajax_form_empresa_validate_obs

  function do_ajax_form_empresa_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_obs_cb

  // ---------- Validate contatos
  function do_ajax_form_empresa_validate_contatos()
  {
    var nomeCampo_contatos = "contatos";
    var var_contatos = scAjaxGetFieldText(nomeCampo_contatos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresa_validate_contatos(var_contatos, var_script_case_init, do_ajax_form_empresa_validate_contatos_cb);
  } // do_ajax_form_empresa_validate_contatos

  function do_ajax_form_empresa_validate_contatos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresa_validate_contatos_cb

  // ---------- Event onchange categoria
  function do_ajax_form_empresa_event_categoria_onchange()
  {
    var var_categoria = scAjaxGetFieldSelect("categoria");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_event_categoria_onchange(var_categoria, var_script_case_init, do_ajax_form_empresa_event_categoria_onchange_cb);
  } // do_ajax_form_empresa_event_categoria_onchange

  function do_ajax_form_empresa_event_categoria_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "categoria";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_event_categoria_onchange_cb_after_alert);
  } // do_ajax_form_empresa_event_categoria_onchange_cb
  function do_ajax_form_empresa_event_categoria_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_event_categoria_onchange_cb_after_alert

  // ---------- Event onchange empresa
  function do_ajax_form_empresa_event_empresa_onchange()
  {
    var var_empresa = scAjaxGetFieldText("empresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_event_empresa_onchange(var_empresa, var_script_case_init, do_ajax_form_empresa_event_empresa_onchange_cb);
  } // do_ajax_form_empresa_event_empresa_onchange

  function do_ajax_form_empresa_event_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_event_empresa_onchange_cb_after_alert);
  } // do_ajax_form_empresa_event_empresa_onchange_cb
  function do_ajax_form_empresa_event_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_event_empresa_onchange_cb_after_alert

  // ---------- Event onclick endereco
  function do_ajax_form_empresa_event_endereco_onclick()
  {
    ...
    var var_id_cidade = scAjaxGetFieldSelect("id_cidade");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_event_endereco_onclick(var_bairro, var_endereco, var_logradouro, var_cidade, var_uf, var_id_cidade, var_script_case_init, do_ajax_form_empresa_event_endereco_onclick_cb);
  } // do_ajax_form_empresa_event_endereco_onclick

  function do_ajax_form_empresa_event_endereco_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "endereco";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_event_endereco_onclick_cb_after_alert);
  } // do_ajax_form_empresa_event_endereco_onclick_cb
  function do_ajax_form_empresa_event_endereco_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_event_endereco_onclick_cb_after_alert

  // ---------- Event onchange id_cidade
  function do_ajax_form_empresa_event_id_cidade_onchange()
  {
    var var_id_cidade = scAjaxGetFieldSelect("id_cidade");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_event_id_cidade_onchange(var_id_cidade, var_script_case_init, do_ajax_form_empresa_event_id_cidade_onchange_cb);
  } // do_ajax_form_empresa_event_id_cidade_onchange

  function do_ajax_form_empresa_event_id_cidade_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_cidade";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_event_id_cidade_onchange_cb_after_alert);
  } // do_ajax_form_empresa_event_id_cidade_onchange_cb
  function do_ajax_form_empresa_event_id_cidade_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_event_id_cidade_onchange_cb_after_alert

  // ---------- Event onclick tipo
  function do_ajax_form_empresa_event_tipo_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresa_event_tipo_onclick(var_tipo, var_categoria, var_rede, var_script_case_init, do_ajax_form_empresa_event_tipo_onclick_cb);
  } // do_ajax_form_empresa_event_tipo_onclick

  function do_ajax_form_empresa_event_tipo_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresa_event_tipo_onclick_cb_after_alert);
  } // do_ajax_form_empresa_event_tipo_onclick_cb
  function do_ajax_form_empresa_event_tipo_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresa_event_tipo_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empresa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empresa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo = scAjaxGetFieldRadio("tipo");
    var var_cnpj_cpf = scAjaxGetFieldText("cnpj_cpf");
    var var_categoria = scAjaxGetFieldSelect("categoria");
    var var_rede = scAjaxGetFieldSelect("rede");
    var var_empresa = scAjaxGetFieldText("empresa");
    ...
    var var_bairro = scAjaxGetFieldText("bairro");
    var var_logradouro = scAjaxGetFieldText("logradouro");
    var var_dat_ult_mov = scAjaxGetFieldHidden("dat_ult_mov");
    ...
    var var_whatsapp = scAjaxGetFieldText("whatsapp");
    var var_cadastrante = scAjaxGetFieldText("cadastrante");
    var var_obs = scAjaxGetFieldEditorHtml("obs");
    ...
    scAjaxProcOn();
    x_ajax_form_empresa_submit_form(var_tipo, var_cnpj_cpf, var_categoria, var_rede, var_empresa, var_contato, var_cep, var_endereco, var_id_cidade, var_telefone, var_email, var_celular, var_cidade, var_uf, var_bairro, var_logradouro, var_dat_ult_mov, var_data, var_homepage, var_inscmun, var_inscest, var_whatsapp, var_cadastrante, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_empresa_submit_form_cb);
  } // do_ajax_form_empresa_submit_form

  function do_ajax_form_empresa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("cnpj_cpf");
      ...
      scAjaxHideErrorDisplay("whatsapp");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_empresa_submit_form_cb_after_alert);
  } // do_ajax_form_empresa_submit_form_cb
  function do_ajax_form_empresa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empresa_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_contato"] = "off";

  function do_ajax_form_empresa_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_empresa_navigate_form, function() {});
    } else {
      perform_ajax_form_empresa_navigate_form();
    }
  }

  function perform_ajax_form_empresa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_empresa_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empresa_navigate_form_cb);
  } // do_ajax_form_empresa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empresa_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_contato"] && "nmsc_iframe_liga_form_contato" != scMasterDetailIframe["nmsc_iframe_liga_form_contato"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_contato').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_contato').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_contato').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empresa_navigate_form_cb_after_alert);
  } // do_ajax_form_empresa_navigate_form_cb
  function do_ajax_form_empresa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_empresa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_empresa_navigate_form_cb_after_alert

  function sc_hide_form_empresa_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_contato"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "cnpj_cpf";
  ajax_field_list[2] = "categoria";
  ajax_field_list[3] = "rede";
  ajax_field_list[4] = "empresa";
  ajax_field_list[5] = "contato";
  ajax_field_list[6] = "cep";
  ajax_field_list[7] = "endereco";
  ajax_field_list[8] = "id_cidade";
  ajax_field_list[9] = "telefone";
  ajax_field_list[10] = "email";
  ajax_field_list[11] = "celular";
  ajax_field_list[12] = "cidade";
  ajax_field_list[13] = "uf";
  ajax_field_list[14] = "bairro";
  ajax_field_list[15] = "logradouro";
  ajax_field_list[16] = "dat_ult_mov";
  ajax_field_list[17] = "data";
  ajax_field_list[18] = "homepage";
  ajax_field_list[19] = "inscmun";
  ajax_field_list[20] = "inscest";
  ajax_field_list[21] = "whatsapp";
  ajax_field_list[22] = "cadastrante";
  ajax_field_list[23] = "obs";
  ajax_field_list[24] = "contatos";
  ...
  var ajax_error_list = {
    "tipo": {"label": "CLASSIFICAÇÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cnpj_cpf": {"label": "CNPJ CPF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "endereco": {"label": "ENDERECO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "logradouro": {"label": "LOGRADOURO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dat_ult_mov": {"label": "ATUALIZAÇÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data": {"label": "DATA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "homepage": {"label": "HOMEPAGE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "inscmun": {"label": "INSCMUN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "inscest": {"label": "INSCEST", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "whatsapp": {"label": "WHATSAPP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["cnpj_cpf"][1] = "cnpj_cpf";
  ...
  ajax_field_mult["whatsapp"][1] = "whatsapp";
  ...
  var ajax_field_id = {
    ...
    "cnpj_cpf": new Array("hidden_field_label_cnpj_cpf", "hidden_field_data_cnpj_cpf"),
    ...
    "whatsapp": new Array("hidden_field_label_whatsapp", "hidden_field_data_whatsapp"),
