...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'logradouro':
      case 'dat_ult_mov':
        sc_exib_ocult_pag('form_empresa_form0');
        break;
      case 'data':
      case 'homepage':
      case 'inscmun':
      ...
      case 'cadastrante':
      case 'obs':
        sc_exib_ocult_pag('form_empresa_form1');
        break;
      case 'contatos':
        sc_exib_ocult_pag('form_empresa_form2');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_empresa_id_onchange(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_form_empresa_tipo_onblur('#id_sc_field_tipo' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_empresa_tipo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_rede' + iSeqRow).bind('blur', function() { sc_form_empresa_rede_onblur('#id_sc_field_rede' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_empresa_rede_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_empresa_rede_onfocus(this, iSeqRow) });
  $('#id_sc_field_razao_social' + iSeqRow).bind('change', function() { sc_form_empresa_razao_social_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_endereco' + iSeqRow).bind('blur', function() { sc_form_empresa_endereco_onblur('#id_sc_field_endereco' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_empresa_endereco_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_telefone' + iSeqRow).bind('blur', function() { sc_form_empresa_telefone_onblur('#id_sc_field_telefone' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_empresa_telefone_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_celular' + iSeqRow).bind('blur', function() { sc_form_empresa_celular_onblur('#id_sc_field_celular' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_empresa_celular_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_whatsapp' + iSeqRow).bind('blur', function() { sc_form_empresa_whatsapp_onblur('#id_sc_field_whatsapp' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_empresa_whatsapp_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_contato' + iSeqRow).bind('blur', function() { sc_form_empresa_contato_onblur('#id_sc_field_contato' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_empresa_contato_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cnpj_cpf' + iSeqRow).bind('blur', function() { sc_form_empresa_cnpj_cpf_onblur('#id_sc_field_cnpj_cpf' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_empresa_cnpj_cpf_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_empresa_cnpj_cpf_onfocus(this, iSeqRow) });
  $('#id_sc_field_local' + iSeqRow).bind('change', function() { sc_form_empresa_local_onchange(this, iSeqRow) });
  $('#id_sc_field_inscest' + iSeqRow).bind('blur', function() { sc_form_empresa_inscest_onblur('#id_sc_field_inscest' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_empresa_inscest_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_inscmun' + iSeqRow).bind('blur', function() { sc_form_empresa_inscmun_onblur('#id_sc_field_inscmun' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_empresa_inscmun_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_form_empresa_email_onblur('#id_sc_field_email' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_empresa_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_homepage' + iSeqRow).bind('blur', function() { sc_form_empresa_homepage_onblur('#id_sc_field_homepage' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_empresa_homepage_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_obs' + iSeqRow).bind('blur', function() { sc_form_empresa_obs_onblur('#id_sc_field_obs' + iSeqRow, iSeqRow) })
                                 .bind('change', function() { sc_form_empresa_obs_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_empresa_obs_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('change', function() { sc_form_empresa_saldo_onchange(this, iSeqRow) });
  $('#id_sc_field_saldo_real' + iSeqRow).bind('change', function() { sc_form_empresa_saldo_real_onchange(this, iSeqRow) });
  $('#id_sc_field_saldo_dolar' + iSeqRow).bind('change', function() { sc_form_empresa_saldo_dolar_onchange(this, iSeqRow) });
  $('#id_sc_field_dat_ult_mov' + iSeqRow).bind('blur', function() { sc_form_empresa_dat_ult_mov_onblur('#id_sc_field_dat_ult_mov' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_empresa_dat_ult_mov_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_empresa_dat_ult_mov_onfocus(this, iSeqRow) });
  $('#id_sc_field_dat_ult_proposta' + iSeqRow).bind('change', function() { sc_form_empresa_dat_ult_proposta_onchange(this, iSeqRow) });
  $('#id_sc_field_data' + iSeqRow).bind('blur', function() { sc_form_empresa_data_onblur('#id_sc_field_data' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_empresa_data_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cadastrante' + iSeqRow).bind('blur', function() { sc_form_empresa_cadastrante_onblur('#id_sc_field_cadastrante' + iSeqRow, iSeqRow) })
                                         .bind('change', function() { sc_form_empresa_cadastrante_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_empresa_cadastrante_onfocus(this, iSeqRow) });
  $('#id_sc_field_dealer' + iSeqRow).bind('change', function() { sc_form_empresa_dealer_onchange(this, iSeqRow) });
  $('#id_sc_field_newsletter' + iSeqRow).bind('change', function() { sc_form_empresa_newsletter_onchange(this, iSeqRow) });
  $('#id_sc_field_contatos' + iSeqRow).bind('blur', function() { sc_form_empresa_contatos_onblur('#id_sc_field_contatos' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_empresa_contatos_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cidade' + iSeqRow).bind('blur', function() { sc_form_empresa_cidade_onblur('#id_sc_field_cidade' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_empresa_cidade_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_uf' + iSeqRow).bind('blur', function() { sc_form_empresa_uf_onblur('#id_sc_field_uf' + iSeqRow, iSeqRow) })
                                .bind('change', function() { sc_form_empresa_uf_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_bairro' + iSeqRow).bind('blur', function() { sc_form_empresa_bairro_onblur('#id_sc_field_bairro' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_empresa_bairro_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_logradouro' + iSeqRow).bind('blur', function() { sc_form_empresa_logradouro_onblur('#id_sc_field_logradouro' + iSeqRow, iSeqRow) })
                                        .bind('change', function() { sc_form_empresa_logradouro_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_empresa_logradouro_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_empresa_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_rede_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_razao_social_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_endereco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_telefone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_celular_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_whatsapp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_contato_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_cnpj_cpf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_local_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_inscest_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_inscmun_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_homepage_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_obs_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empresa_saldo_real_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empresa_saldo_dolar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_dat_ult_mov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_dat_ult_proposta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_data_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_cadastrante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_dealer_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empresa_newsletter_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_contatos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_cidade_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_uf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_bairro_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresa_logradouro_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
        $("#id_form_empresa_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  ...
  $("#id_sc_field_data" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_empresa_validate_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_dat_ult_proposta" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_empresa_validate_dat_ult_proposta(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_empresa')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
