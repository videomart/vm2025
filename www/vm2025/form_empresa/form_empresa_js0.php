...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="F8" method="post" 
  ...
  <input type="hidden" name="SC_Pdf_pag_ativa" value=""/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_empresa"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresa']['where_detal']))
  {
?>  
...
{ 
    ...
    document.F8.SC_Pdf_pag_ativa.value = pag_ativa;
    document.F8.submit();
}
...
function cep_cep(num_cep, campos_cep)
{
   ...
   jsrsExecute("form_empresa_cep.php?cep=" + num_cep + "&onchange=s", recebe_cep, "cep", num_cep, false);
}
...
{
    document.getElementById('form_empresa_form0').style.width='1px';
    document.getElementById('form_empresa_form0').style.height='0px';
    document.getElementById('form_empresa_form0').style.display='none';
    document.getElementById('form_empresa_form0').style.overflow='scroll';
    document.getElementById('form_empresa_form1').style.width='1px';
    document.getElementById('form_empresa_form1').style.height='0px';
    document.getElementById('form_empresa_form1').style.display='none';
    document.getElementById('form_empresa_form1').style.overflow='scroll';
    document.getElementById('form_empresa_form2').style.width='1px';
    document.getElementById('form_empresa_form2').style.height='0px';
    document.getElementById('form_empresa_form2').style.display='none';
    document.getElementById('form_empresa_form2').style.overflow='scroll';
<?php
...
?>
   ...
   if ("form_empresa_form2" == N_pagina) {
...
function scCssBlur(oHtmlObj)
{
 ...
 function nm_field_disabled(Fields, Opt) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "homepage")
     {
        $('input[name="homepage"]').prop("disabled", F_opc);
        if (F_opc == "disabled" || F_opc == true) {
            $('input[name="homepage"]').addClass("scFormInputDisabled");
        }
        else {
            $('input[name="homepage"]').removeClass("scFormInputDisabled");
        }
     }
  }
 } // nm_field_disabled
