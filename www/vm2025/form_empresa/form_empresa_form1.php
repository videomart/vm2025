<div id="form_empresa_form1" style='<?php echo ($this->tabCssClass["form_empresa_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
?>
<TABLE align="center" id="hidden_bloco_3" class="scFormTable scFormDataOdd<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><?php $sStyleHidden_logradouro_dumb = ('' == $sStyleHidden_logradouro) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_logradouro_dumb" style="<?php echo $sStyleHidden_logradouro_dumb; ?>"></TD>
<?php $sStyleHidden_dat_ult_mov_dumb = ('' == $sStyleHidden_dat_ult_mov) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dat_ult_mov_dumb" style="<?php echo $sStyleHidden_dat_ult_mov_dumb; ?>"></TD>
...
<?php $sStyleHidden_homepage_dumb = ('' == $sStyleHidden_homepage) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_homepage_dumb" style="<?php echo $sStyleHidden_homepage_dumb; ?>"></TD>
<?php $sStyleHidden_inscmun_dumb = ('' == $sStyleHidden_inscmun) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_inscmun_dumb" style="<?php echo $sStyleHidden_inscmun_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_inscest_dumb = ('' == $sStyleHidden_inscest) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_inscest_dumb" style="<?php echo $sStyleHidden_inscest_dumb; ?>"></TD>
<?php $sStyleHidden_whatsapp_dumb = ('' == $sStyleHidden_whatsapp) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_whatsapp_dumb" style="<?php echo $sStyleHidden_whatsapp_dumb; ?>"></TD>
