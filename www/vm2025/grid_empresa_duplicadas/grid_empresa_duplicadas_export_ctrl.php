<?php
@session_start() ;
$_SESSION['scriptcase']['grid_empresa_duplicadas']['sc_process_barr'] = true;
require_once('../grid_empresa_duplicadas/index.php');
unset($_SESSION['scriptcase']['grid_empresa_duplicadas']['sc_process_barr']);
$ExportCtrl = new grid_empresa_duplicadas_export_control;
$ExportCtrl->Export_barr();

class grid_empresa_duplicadas_export_control
{
