...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cnpj_cpf_cond" name="cnpj_cpf_cond" onChange="nm_campos_between(document.getElementById('id_vis_cnpj_cpf'), this, 'cnpj_cpf')">
      ...
      <br><span id="id_hide_cnpj_cpf"  <?php echo $str_hide_cnpj_cpf?>><?php
      if ($cnpj_cpf != "")
      {
      $cnpj_cpf_look = (is_string($cnpj_cpf) ? substr($this->Db->qstr($cnpj_cpf), 1, -1) : $cnpj_cpf); 
      $nmgp_def_dados = array(); 
