...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____grid_empresa_duplicadas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____grid_empresa_duplicadas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_empresa_duplicadas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_empresa_duplicadas']['embutida_filho'] as $ind => $sc_init)
          {
