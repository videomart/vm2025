  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_classe" == sTestField)
        {
...
?>
  ...
  // ---------- Validate classe
  function do_ajax_form_classe_validate_classe()
  {
    var nomeCampo_classe = "classe";
    var var_classe = scAjaxGetFieldText(nomeCampo_classe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classe_validate_classe(var_classe, var_script_case_init, do_ajax_form_classe_validate_classe_cb);
  } // do_ajax_form_classe_validate_classe

  function do_ajax_form_classe_validate_classe_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classe_validate_classe_cb

  // ---------- Validate cst
  function do_ajax_form_classe_validate_cst()
  {
    var nomeCampo_cst = "cst";
    var var_cst = scAjaxGetFieldSelect(nomeCampo_cst);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classe_validate_cst(var_cst, var_script_case_init, do_ajax_form_classe_validate_cst_cb);
  } // do_ajax_form_classe_validate_cst

  function do_ajax_form_classe_validate_cst_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classe_validate_cst_cb

  // ---------- Validate ncm
  function do_ajax_form_classe_validate_ncm()
  {
    var nomeCampo_ncm = "ncm";
    var var_ncm = scAjaxGetFieldText(nomeCampo_ncm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classe_validate_ncm(var_ncm, var_script_case_init, do_ajax_form_classe_validate_ncm_cb);
  } // do_ajax_form_classe_validate_ncm

  function do_ajax_form_classe_validate_ncm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classe_validate_ncm_cb

  // ---------- Validate id_markup
  function do_ajax_form_classe_validate_id_markup()
  {
    var nomeCampo_id_markup = "id_markup";
    var var_id_markup = scAjaxGetFieldSelect(nomeCampo_id_markup);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classe_validate_id_markup(var_id_markup, var_script_case_init, do_ajax_form_classe_validate_id_markup_cb);
  } // do_ajax_form_classe_validate_id_markup

  function do_ajax_form_classe_validate_id_markup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classe_validate_id_markup_cb

  // ---------- Validate markup
  function do_ajax_form_classe_validate_markup()
  {
    var nomeCampo_markup = "markup";
    var var_markup = scAjaxGetFieldText(nomeCampo_markup);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classe_validate_markup(var_markup, var_script_case_init, do_ajax_form_classe_validate_markup_cb);
  } // do_ajax_form_classe_validate_markup

  function do_ajax_form_classe_validate_markup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classe_validate_markup_cb

  // ---------- Validate descricao
  function do_ajax_form_classe_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classe_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_classe_validate_descricao_cb);
  } // do_ajax_form_classe_validate_descricao

  function do_ajax_form_classe_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classe_validate_descricao_cb

  // ---------- Event onchange id_markup
  function do_ajax_form_classe_event_id_markup_onchange()
  {
    var var_id_markup = scAjaxGetFieldSelect("id_markup");
    var var_markup = scAjaxGetFieldText("markup");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_classe_event_id_markup_onchange(var_id_markup, var_markup, var_script_case_init, do_ajax_form_classe_event_id_markup_onchange_cb);
  } // do_ajax_form_classe_event_id_markup_onchange

  function do_ajax_form_classe_event_id_markup_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_markup";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_classe_event_id_markup_onchange_cb_after_alert);
  } // do_ajax_form_classe_event_id_markup_onchange_cb
  function do_ajax_form_classe_event_id_markup_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_classe_event_id_markup_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_classe_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_classe_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_classe_submit_form(var_classe, var_cst, var_ncm, var_id_markup, var_markup, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_classe_submit_form_cb);
  } // do_ajax_form_classe_submit_form

  function do_ajax_form_classe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_classe_submit_form_cb_after_alert);
  } // do_ajax_form_classe_submit_form_cb
  function do_ajax_form_classe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_classe_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_classe_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_classe_navigate_form, function() {});
    } else {
      perform_ajax_form_classe_navigate_form();
    }
  }

  function perform_ajax_form_classe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_classe_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_classe_navigate_form_cb);
  } // do_ajax_form_classe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_classe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_classe_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_classe_navigate_form_cb_after_alert);
  } // do_ajax_form_classe_navigate_form_cb
  function do_ajax_form_classe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_classe_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_classe_navigate_form_cb_after_alert

  function sc_hide_form_classe_form()
  {
  ...
  function do_ajax_form_classe_lkpedt_refresh_cst()
  {
    var var_cst = scAjaxGetFieldSelect("cst");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "cst";
    x_ajax_form_classe_lkpedt_refresh_cst(var_cst, nmgp_refresh_fields, var_script_case_init, do_ajax_form_classe_lkpedt_refresh_cst_cb);
  } // do_ajax_form_classe_lkpedt_refresh_cst

  function do_ajax_form_classe_lkpedt_refresh_cst_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_classe_lkpedt_refresh_cst_cb

  function do_ajax_form_classe_lkpedt_refresh_id_markup()
  {
    var var_id_markup = scAjaxGetFieldSelect("id_markup");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_markup";
    x_ajax_form_classe_lkpedt_refresh_id_markup(var_id_markup, nmgp_refresh_fields, var_script_case_init, do_ajax_form_classe_lkpedt_refresh_id_markup_cb);
  } // do_ajax_form_classe_lkpedt_refresh_id_markup

  function do_ajax_form_classe_lkpedt_refresh_id_markup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_classe_lkpedt_refresh_id_markup_cb
