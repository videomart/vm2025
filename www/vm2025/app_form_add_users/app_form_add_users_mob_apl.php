...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['app_form_add_users_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['app_form_add_users_mob']['opc_ant']);
          }
          if (isset($this->req_active_by_email)) 
          {
              $_SESSION['req_active_by_email'] = $this->req_active_by_email;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
...
if ($this->Ini->sc_tem_trans_banco)
{
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('app_Login') . "/", $this->nm_location, "return_msg_email_act?#?" . NM_encode_input($return_msg_email_act) . "?@?", "_self", "ret_self", 440, 630);
 };
if (isset($this->sc_temp_sett_send_email_adm)) { $_SESSION['sett_send_email_adm'] = $this->sc_temp_sett_send_email_adm;}
if (isset($this->sc_temp_sett_req_email_act)) { $_SESSION['sett_req_email_act'] = $this->sc_temp_sett_req_email_act;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
      ...
      $Nm_datas["pswd_last_updated"] = "timestamp";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              ...
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['SC_sep_date1'];
              }
          }
