...
function sc_app_form_add_users_role_onblur(oThis, iSeqRow) {
  do_ajax_app_form_add_users_mob_validate_role();
  scCssBlur(oThis);
}
...
function sc_app_form_add_users_phone_onblur(oThis, iSeqRow) {
  do_ajax_app_form_add_users_mob_validate_phone();
  scCssBlur(oThis);
}
...
function sc_app_form_add_users_pswd_rules_onblur(oThis, iSeqRow) {
  do_ajax_app_form_add_users_mob_validate_pswd_rules();
  scCssBlur(oThis);
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_app_form_add_users_mob_validate_pswd_last_updated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
