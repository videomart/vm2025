...
?>
  ...
  // ---------- Validate pswd_rules
  function do_ajax_app_form_add_users_validate_pswd_rules()
  {
    var nomeCampo_pswd_rules = "pswd_rules";
    var var_pswd_rules = scAjaxGetFieldHidden(nomeCampo_pswd_rules);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_pswd_rules(var_pswd_rules, var_script_case_init, do_ajax_app_form_add_users_validate_pswd_rules_cb);
  } // do_ajax_app_form_add_users_validate_pswd_rules

  function do_ajax_app_form_add_users_validate_pswd_rules_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_pswd_rules_cb
  ...
  // ---------- Validate role
  function do_ajax_app_form_add_users_validate_role()
  {
    var nomeCampo_role = "role";
    var var_role = scAjaxGetFieldText(nomeCampo_role);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_role(var_role, var_script_case_init, do_ajax_app_form_add_users_validate_role_cb);
  } // do_ajax_app_form_add_users_validate_role

  function do_ajax_app_form_add_users_validate_role_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_role_cb

  // ---------- Validate phone
  function do_ajax_app_form_add_users_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_add_users_validate_phone(var_phone, var_script_case_init, do_ajax_app_form_add_users_validate_phone_cb);
  } // do_ajax_app_form_add_users_validate_phone

  function do_ajax_app_form_add_users_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_add_users_validate_phone_cb
