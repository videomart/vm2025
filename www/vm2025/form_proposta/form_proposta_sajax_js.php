  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_proposta" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_proposta_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_id(var_id, var_script_case_init, do_ajax_form_proposta_validate_id_cb);
  } // do_ajax_form_proposta_validate_id

  function do_ajax_form_proposta_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_id_cb

  // ---------- Validate id_empresa
  function do_ajax_form_proposta_validate_id_empresa()
  {
  } // do_ajax_form_proposta_validate_id_empresa

  function do_ajax_form_proposta_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_id_empresa_cb

  // ---------- Validate natureza
  function do_ajax_form_proposta_validate_natureza()
  {
    var nomeCampo_natureza = "natureza";
    var var_natureza = scAjaxGetFieldSelect(nomeCampo_natureza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_natureza(var_natureza, var_script_case_init, do_ajax_form_proposta_validate_natureza_cb);
  } // do_ajax_form_proposta_validate_natureza

  function do_ajax_form_proposta_validate_natureza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_natureza_cb

  // ---------- Validate cliente
  function do_ajax_form_proposta_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldText(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_cliente(var_cliente, var_script_case_init, do_ajax_form_proposta_validate_cliente_cb);
  } // do_ajax_form_proposta_validate_cliente

  function do_ajax_form_proposta_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_cliente_cb

  // ---------- Validate atencao
  function do_ajax_form_proposta_validate_atencao()
  {
    var nomeCampo_atencao = "atencao";
    var var_atencao = scAjaxGetFieldText(nomeCampo_atencao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_atencao(var_atencao, var_script_case_init, do_ajax_form_proposta_validate_atencao_cb);
  } // do_ajax_form_proposta_validate_atencao

  function do_ajax_form_proposta_validate_atencao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_atencao_cb

  // ---------- Validate local_entrega
  function do_ajax_form_proposta_validate_local_entrega()
  {
    var nomeCampo_local_entrega = "local_entrega";
    var var_local_entrega = scAjaxGetFieldText(nomeCampo_local_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_local_entrega(var_local_entrega, var_script_case_init, do_ajax_form_proposta_validate_local_entrega_cb);
  } // do_ajax_form_proposta_validate_local_entrega

  function do_ajax_form_proposta_validate_local_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_local_entrega_cb

  // ---------- Validate telefone
  function do_ajax_form_proposta_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_proposta_validate_telefone_cb);
  } // do_ajax_form_proposta_validate_telefone

  function do_ajax_form_proposta_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_proposta_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_email(var_email, var_script_case_init, do_ajax_form_proposta_validate_email_cb);
  } // do_ajax_form_proposta_validate_email

  function do_ajax_form_proposta_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_email_cb

  // ---------- Validate cod_vend
  function do_ajax_form_proposta_validate_cod_vend()
  {
    var nomeCampo_cod_vend = "cod_vend";
    var var_cod_vend = scAjaxGetFieldSelect(nomeCampo_cod_vend);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_cod_vend(var_cod_vend, var_script_case_init, do_ajax_form_proposta_validate_cod_vend_cb);
  } // do_ajax_form_proposta_validate_cod_vend

  function do_ajax_form_proposta_validate_cod_vend_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_cod_vend_cb

  // ---------- Validate data
  function do_ajax_form_proposta_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_data(var_data, var_script_case_init, do_ajax_form_proposta_validate_data_cb);
  } // do_ajax_form_proposta_validate_data

  function do_ajax_form_proposta_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_data_cb

  // ---------- Validate total
  function do_ajax_form_proposta_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_total(var_total, var_script_case_init, do_ajax_form_proposta_validate_total_cb);
  } // do_ajax_form_proposta_validate_total

  function do_ajax_form_proposta_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_total_cb

  // ---------- Validate desconto
  function do_ajax_form_proposta_validate_desconto()
  {
    var nomeCampo_desconto = "desconto";
    var var_desconto = scAjaxGetFieldText(nomeCampo_desconto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_desconto(var_desconto, var_script_case_init, do_ajax_form_proposta_validate_desconto_cb);
  } // do_ajax_form_proposta_validate_desconto

  function do_ajax_form_proposta_validate_desconto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_desconto_cb

  // ---------- Validate itensdaproposta
  function do_ajax_form_proposta_validate_itensdaproposta()
  {
    var nomeCampo_itensdaproposta = "itensdaproposta";
    var var_itensdaproposta = scAjaxGetFieldText(nomeCampo_itensdaproposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_itensdaproposta(var_itensdaproposta, var_script_case_init, do_ajax_form_proposta_validate_itensdaproposta_cb);
  } // do_ajax_form_proposta_validate_itensdaproposta

  function do_ajax_form_proposta_validate_itensdaproposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_itensdaproposta_cb

  // ---------- Validate tabela
  function do_ajax_form_proposta_validate_tabela()
  {
    var nomeCampo_tabela = "tabela";
    var var_tabela = scAjaxGetFieldSelect(nomeCampo_tabela);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_tabela(var_tabela, var_script_case_init, do_ajax_form_proposta_validate_tabela_cb);
  } // do_ajax_form_proposta_validate_tabela

  function do_ajax_form_proposta_validate_tabela_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_tabela_cb

  // ---------- Validate transportadora
  function do_ajax_form_proposta_validate_transportadora()
  {
    var nomeCampo_transportadora = "transportadora";
    var var_transportadora = scAjaxGetFieldSelect(nomeCampo_transportadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_transportadora(var_transportadora, var_script_case_init, do_ajax_form_proposta_validate_transportadora_cb);
  } // do_ajax_form_proposta_validate_transportadora

  function do_ajax_form_proposta_validate_transportadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_transportadora_cb

  // ---------- Validate previsao
  function do_ajax_form_proposta_validate_previsao()
  {
    var nomeCampo_previsao = "previsao";
    var var_previsao = scAjaxGetFieldText(nomeCampo_previsao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_previsao(var_previsao, var_script_case_init, do_ajax_form_proposta_validate_previsao_cb);
  } // do_ajax_form_proposta_validate_previsao

  function do_ajax_form_proposta_validate_previsao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_previsao_cb

  // ---------- Validate condpag
  function do_ajax_form_proposta_validate_condpag()
  {
    var nomeCampo_condpag = "condpag";
    var var_condpag = scAjaxGetFieldEditorHtml(nomeCampo_condpag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_condpag(var_condpag, var_script_case_init, do_ajax_form_proposta_validate_condpag_cb);
  } // do_ajax_form_proposta_validate_condpag

  function do_ajax_form_proposta_validate_condpag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_condpag_cb

  // ---------- Validate header
  function do_ajax_form_proposta_validate_header()
  {
    var nomeCampo_header = "header";
    var var_header = scAjaxGetFieldEditorHtml(nomeCampo_header);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_header(var_header, var_script_case_init, do_ajax_form_proposta_validate_header_cb);
  } // do_ajax_form_proposta_validate_header

  function do_ajax_form_proposta_validate_header_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_header_cb

  // ---------- Validate obs
  function do_ajax_form_proposta_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldEditorHtml(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_validate_obs(var_obs, var_script_case_init, do_ajax_form_proposta_validate_obs_cb);
  } // do_ajax_form_proposta_validate_obs

  function do_ajax_form_proposta_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_validate_obs_cb

  // ---------- Event onchange id_empresa
  function do_ajax_form_proposta_event_id_empresa_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_proposta_event_id_empresa_onchange(var_id_empresa, var_cliente, var_atencao, var_telefone, var_email, var_local_entrega, var_script_case_init, do_ajax_form_proposta_event_id_empresa_onchange_cb);
  } // do_ajax_form_proposta_event_id_empresa_onchange

  function do_ajax_form_proposta_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_proposta_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_proposta_event_id_empresa_onchange_cb
  function do_ajax_form_proposta_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_proposta_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onchange tabela
  function do_ajax_form_proposta_event_tabela_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_proposta_event_tabela_onchange(var_tabela, var_previsao, var_obs, var_condpag, var_header, var_script_case_init, do_ajax_form_proposta_event_tabela_onchange_cb);
  } // do_ajax_form_proposta_event_tabela_onchange

  function do_ajax_form_proposta_event_tabela_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tabela";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_proposta_event_tabela_onchange_cb_after_alert);
  } // do_ajax_form_proposta_event_tabela_onchange_cb
  function do_ajax_form_proposta_event_tabela_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_proposta_event_tabela_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_proposta_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_proposta_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_proposta_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_proposta_submit_page_0

  function do_ajax_form_proposta_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_proposta_submit_page_cb_0

  function do_ajax_form_proposta_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_proposta_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_proposta_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_proposta_submit_page_1

  function do_ajax_form_proposta_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_proposta_submit_page_cb_1

  function do_ajax_form_proposta_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_proposta_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_proposta_submit_form(var_id, var_id_empresa, var_natureza, var_cliente, var_atencao, var_local_entrega, var_telefone, var_email, var_cod_vend, var_data, var_total, var_desconto, var_tabela, var_transportadora, var_previsao, var_condpag, var_header, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_proposta_submit_form_cb);
  } // do_ajax_form_proposta_submit_form

  function do_ajax_form_proposta_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxUpdateErrors("valid");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_proposta_submit_form_cb_after_alert);
  } // do_ajax_form_proposta_submit_form_cb
  function do_ajax_form_proposta_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_proposta_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_itemproposta"] = "off";

  function do_ajax_form_proposta_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_proposta_navigate_form, function() {});
    } else {
      perform_ajax_form_proposta_navigate_form();
    }
  }

  function perform_ajax_form_proposta_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_itemproposta"] = "on";
    x_ajax_form_proposta_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_proposta_navigate_form_cb);
  } // do_ajax_form_proposta_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_proposta']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_proposta_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_itemproposta"] && "nmsc_iframe_liga_form_itemproposta" != scMasterDetailIframe["nmsc_iframe_liga_form_itemproposta"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_itemproposta"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_itemproposta').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_itemproposta').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_itemproposta').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_proposta_navigate_form_cb_after_alert);
  } // do_ajax_form_proposta_navigate_form_cb
  function do_ajax_form_proposta_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_proposta_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_proposta_navigate_form_cb_after_alert

  function sc_hide_form_proposta_form()
  {
  ...
  function do_ajax_form_proposta_lkpedt_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_empresa";
    x_ajax_form_proposta_lkpedt_refresh_id_empresa(var_id_empresa, nmgp_refresh_fields, var_script_case_init, do_ajax_form_proposta_lkpedt_refresh_id_empresa_cb);
  } // do_ajax_form_proposta_lkpedt_refresh_id_empresa

  function do_ajax_form_proposta_lkpedt_refresh_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_proposta_lkpedt_refresh_id_empresa_cb
  ...
  {
    if ("off" == scStatusDetail["form_itemproposta"])
    {
      return true;
    }
    return false;
