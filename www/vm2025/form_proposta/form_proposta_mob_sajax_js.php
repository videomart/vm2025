  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_proposta_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_proposta_mob_form();
        }
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_proposta_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_id(var_id, var_script_case_init, do_ajax_form_proposta_mob_validate_id_cb);
  } // do_ajax_form_proposta_mob_validate_id

  function do_ajax_form_proposta_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_id_cb

  // ---------- Validate id_empresa
  function do_ajax_form_proposta_mob_validate_id_empresa()
  {
  } // do_ajax_form_proposta_mob_validate_id_empresa

  function do_ajax_form_proposta_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_id_empresa_cb

  // ---------- Validate natureza
  function do_ajax_form_proposta_mob_validate_natureza()
  {
    var nomeCampo_natureza = "natureza";
    var var_natureza = scAjaxGetFieldSelect(nomeCampo_natureza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_natureza(var_natureza, var_script_case_init, do_ajax_form_proposta_mob_validate_natureza_cb);
  } // do_ajax_form_proposta_mob_validate_natureza

  function do_ajax_form_proposta_mob_validate_natureza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_natureza_cb

  // ---------- Validate cliente
  function do_ajax_form_proposta_mob_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldText(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_cliente(var_cliente, var_script_case_init, do_ajax_form_proposta_mob_validate_cliente_cb);
  } // do_ajax_form_proposta_mob_validate_cliente

  function do_ajax_form_proposta_mob_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_cliente_cb

  // ---------- Validate atencao
  function do_ajax_form_proposta_mob_validate_atencao()
  {
    var nomeCampo_atencao = "atencao";
    var var_atencao = scAjaxGetFieldText(nomeCampo_atencao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_atencao(var_atencao, var_script_case_init, do_ajax_form_proposta_mob_validate_atencao_cb);
  } // do_ajax_form_proposta_mob_validate_atencao

  function do_ajax_form_proposta_mob_validate_atencao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_atencao_cb

  // ---------- Validate local_entrega
  function do_ajax_form_proposta_mob_validate_local_entrega()
  {
    var nomeCampo_local_entrega = "local_entrega";
    var var_local_entrega = scAjaxGetFieldText(nomeCampo_local_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_local_entrega(var_local_entrega, var_script_case_init, do_ajax_form_proposta_mob_validate_local_entrega_cb);
  } // do_ajax_form_proposta_mob_validate_local_entrega

  function do_ajax_form_proposta_mob_validate_local_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "local_entrega";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_local_entrega_cb

  // ---------- Validate telefone
  function do_ajax_form_proposta_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_proposta_mob_validate_telefone_cb);
  } // do_ajax_form_proposta_mob_validate_telefone

  function do_ajax_form_proposta_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_form_proposta_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_email(var_email, var_script_case_init, do_ajax_form_proposta_mob_validate_email_cb);
  } // do_ajax_form_proposta_mob_validate_email

  function do_ajax_form_proposta_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_email_cb

  // ---------- Validate cod_vend
  function do_ajax_form_proposta_mob_validate_cod_vend()
  {
    var nomeCampo_cod_vend = "cod_vend";
    var var_cod_vend = scAjaxGetFieldSelect(nomeCampo_cod_vend);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_cod_vend(var_cod_vend, var_script_case_init, do_ajax_form_proposta_mob_validate_cod_vend_cb);
  } // do_ajax_form_proposta_mob_validate_cod_vend

  function do_ajax_form_proposta_mob_validate_cod_vend_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "cod_vend";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_cod_vend_cb

  // ---------- Validate data
  function do_ajax_form_proposta_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_data(var_data, var_script_case_init, do_ajax_form_proposta_mob_validate_data_cb);
  } // do_ajax_form_proposta_mob_validate_data

  function do_ajax_form_proposta_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_data_cb

  // ---------- Validate total
  function do_ajax_form_proposta_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_total(var_total, var_script_case_init, do_ajax_form_proposta_mob_validate_total_cb);
  } // do_ajax_form_proposta_mob_validate_total

  function do_ajax_form_proposta_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_total_cb

  // ---------- Validate desconto
  function do_ajax_form_proposta_mob_validate_desconto()
  {
    var nomeCampo_desconto = "desconto";
    var var_desconto = scAjaxGetFieldText(nomeCampo_desconto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_desconto(var_desconto, var_script_case_init, do_ajax_form_proposta_mob_validate_desconto_cb);
  } // do_ajax_form_proposta_mob_validate_desconto

  function do_ajax_form_proposta_mob_validate_desconto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "desconto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_desconto_cb

  // ---------- Validate itensdaproposta
  function do_ajax_form_proposta_mob_validate_itensdaproposta()
  {
    var nomeCampo_itensdaproposta = "itensdaproposta";
    var var_itensdaproposta = scAjaxGetFieldText(nomeCampo_itensdaproposta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_itensdaproposta(var_itensdaproposta, var_script_case_init, do_ajax_form_proposta_mob_validate_itensdaproposta_cb);
  } // do_ajax_form_proposta_mob_validate_itensdaproposta

  function do_ajax_form_proposta_mob_validate_itensdaproposta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "itensdaproposta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_itensdaproposta_cb

  // ---------- Validate tabela
  function do_ajax_form_proposta_mob_validate_tabela()
  {
    var nomeCampo_tabela = "tabela";
    var var_tabela = scAjaxGetFieldSelect(nomeCampo_tabela);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_tabela(var_tabela, var_script_case_init, do_ajax_form_proposta_mob_validate_tabela_cb);
  } // do_ajax_form_proposta_mob_validate_tabela

  function do_ajax_form_proposta_mob_validate_tabela_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_tabela_cb

  // ---------- Validate transportadora
  function do_ajax_form_proposta_mob_validate_transportadora()
  {
    var nomeCampo_transportadora = "transportadora";
    var var_transportadora = scAjaxGetFieldSelect(nomeCampo_transportadora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_transportadora(var_transportadora, var_script_case_init, do_ajax_form_proposta_mob_validate_transportadora_cb);
  } // do_ajax_form_proposta_mob_validate_transportadora

  function do_ajax_form_proposta_mob_validate_transportadora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "transportadora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_transportadora_cb

  // ---------- Validate previsao
  function do_ajax_form_proposta_mob_validate_previsao()
  {
    var nomeCampo_previsao = "previsao";
    var var_previsao = scAjaxGetFieldText(nomeCampo_previsao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_previsao(var_previsao, var_script_case_init, do_ajax_form_proposta_mob_validate_previsao_cb);
  } // do_ajax_form_proposta_mob_validate_previsao

  function do_ajax_form_proposta_mob_validate_previsao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "previsao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_previsao_cb

  // ---------- Validate condpag
  function do_ajax_form_proposta_mob_validate_condpag()
  {
    var nomeCampo_condpag = "condpag";
    var var_condpag = scAjaxGetFieldEditorHtml(nomeCampo_condpag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_condpag(var_condpag, var_script_case_init, do_ajax_form_proposta_mob_validate_condpag_cb);
  } // do_ajax_form_proposta_mob_validate_condpag

  function do_ajax_form_proposta_mob_validate_condpag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_condpag_cb

  // ---------- Validate header
  function do_ajax_form_proposta_mob_validate_header()
  {
    var nomeCampo_header = "header";
    var var_header = scAjaxGetFieldEditorHtml(nomeCampo_header);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_header(var_header, var_script_case_init, do_ajax_form_proposta_mob_validate_header_cb);
  } // do_ajax_form_proposta_mob_validate_header

  function do_ajax_form_proposta_mob_validate_header_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_header_cb

  // ---------- Validate obs
  function do_ajax_form_proposta_mob_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldEditorHtml(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_proposta_mob_validate_obs(var_obs, var_script_case_init, do_ajax_form_proposta_mob_validate_obs_cb);
  } // do_ajax_form_proposta_mob_validate_obs

  function do_ajax_form_proposta_mob_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_proposta_mob_validate_obs_cb

  // ---------- Event onchange id_empresa
  function do_ajax_form_proposta_mob_event_id_empresa_onchange()
  {
    var var_id_empresa = scAjaxGetFieldText("id_ac_id_empresa");
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_atencao = scAjaxGetFieldText("atencao");
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_email = scAjaxGetFieldText("email");
    var var_local_entrega = scAjaxGetFieldText("local_entrega");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_proposta_mob_event_id_empresa_onchange(var_id_empresa, var_cliente, var_atencao, var_telefone, var_email, var_local_entrega, var_script_case_init, do_ajax_form_proposta_mob_event_id_empresa_onchange_cb);
  } // do_ajax_form_proposta_mob_event_id_empresa_onchange

  function do_ajax_form_proposta_mob_event_id_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_proposta_mob_event_id_empresa_onchange_cb_after_alert);
  } // do_ajax_form_proposta_mob_event_id_empresa_onchange_cb
  function do_ajax_form_proposta_mob_event_id_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_proposta_mob_event_id_empresa_onchange_cb_after_alert

  // ---------- Event onchange tabela
  function do_ajax_form_proposta_mob_event_tabela_onchange()
  {
    var var_tabela = scAjaxGetFieldSelect("tabela");
    var var_previsao = scAjaxGetFieldText("previsao");
    var var_obs = scAjaxGetFieldEditorHtml("obs");
    var var_condpag = scAjaxGetFieldEditorHtml("condpag");
    var var_header = scAjaxGetFieldEditorHtml("header");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_proposta_mob_event_tabela_onchange(var_tabela, var_previsao, var_obs, var_condpag, var_header, var_script_case_init, do_ajax_form_proposta_mob_event_tabela_onchange_cb);
  } // do_ajax_form_proposta_mob_event_tabela_onchange

  function do_ajax_form_proposta_mob_event_tabela_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tabela";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_proposta_mob_event_tabela_onchange_cb_after_alert);
  } // do_ajax_form_proposta_mob_event_tabela_onchange_cb
  function do_ajax_form_proposta_mob_event_tabela_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_proposta_mob_event_tabela_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_proposta_mob_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_proposta_mob_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_proposta_mob.php",
      method: "POST",
      dataType: "json",
      data: {
        id: scAjaxGetFieldHidden("id"),
        id_empresa: scAjaxGetFieldText("id_empresa"),
        natureza: scAjaxGetFieldSelect("natureza"),
        cliente: scAjaxGetFieldText("cliente"),
        atencao: scAjaxGetFieldText("atencao"),
        local_entrega: scAjaxGetFieldText("local_entrega"),
        telefone: scAjaxGetFieldText("telefone"),
        email: scAjaxGetFieldText("email"),
        cod_vend: scAjaxGetFieldSelect("cod_vend"),
        data: scAjaxGetFieldText("data"),
        total: scAjaxGetFieldText("total"),
        desconto: scAjaxGetFieldText("desconto"),
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_proposta_mob_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_proposta_mob_submit_page_0

  function do_ajax_form_proposta_mob_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_proposta_mob_submit_page_cb_0

  function do_ajax_form_proposta_mob_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_proposta_mob_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      dataType: "json",
      data: {
        tabela: scAjaxGetFieldSelect("tabela"),
        transportadora: scAjaxGetFieldSelect("transportadora"),
        previsao: scAjaxGetFieldText("previsao"),
        condpag: scAjaxGetFieldEditorHtml("condpag"),
        header: scAjaxGetFieldEditorHtml("header"),
        obs: scAjaxGetFieldEditorHtml("obs"),
        nm_form_submit: document.F1.nm_form_submit.value,
        nmgp_url_saida: document.F1.nmgp_url_saida.value,
        nmgp_ancora: document.F1.nmgp_ancora.value,
        nmgp_num_form: document.F1.nmgp_num_form.value,
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_proposta_mob_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_proposta_mob_submit_page_1

  function do_ajax_form_proposta_mob_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_proposta_mob_submit_page_cb_1

  function do_ajax_form_proposta_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_proposta_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_natureza = scAjaxGetFieldSelect("natureza");
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_atencao = scAjaxGetFieldText("atencao");
    var var_local_entrega = scAjaxGetFieldText("local_entrega");
    var var_telefone = scAjaxGetFieldText("telefone");
    var var_email = scAjaxGetFieldText("email");
    var var_cod_vend = scAjaxGetFieldSelect("cod_vend");
    var var_data = scAjaxGetFieldText("data");
    var var_total = scAjaxGetFieldText("total");
    var var_desconto = scAjaxGetFieldText("desconto");
    var var_tabela = scAjaxGetFieldSelect("tabela");
    var var_transportadora = scAjaxGetFieldSelect("transportadora");
    var var_previsao = scAjaxGetFieldText("previsao");
    var var_condpag = scAjaxGetFieldEditorHtml("condpag");
    var var_header = scAjaxGetFieldEditorHtml("header");
    var var_obs = scAjaxGetFieldEditorHtml("obs");
    ...
    scAjaxProcOn();
    x_ajax_form_proposta_mob_submit_form(var_id, var_id_empresa, var_natureza, var_cliente, var_atencao, var_local_entrega, var_telefone, var_email, var_cod_vend, var_data, var_total, var_desconto, var_tabela, var_transportadora, var_previsao, var_condpag, var_header, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_proposta_mob_submit_form_cb);
  } // do_ajax_form_proposta_mob_submit_form

  function do_ajax_form_proposta_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxUpdateErrors("valid");
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("atencao");
      scAjaxHideErrorDisplay("local_entrega");
      scAjaxHideErrorDisplay("telefone");
      scAjaxHideErrorDisplay("email");
      scAjaxHideErrorDisplay("cod_vend");
      scAjaxHideErrorDisplay("data");
      scAjaxHideErrorDisplay("total");
      scAjaxHideErrorDisplay("desconto");
      scAjaxHideErrorDisplay("itensdaproposta");
      scAjaxHideErrorDisplay("tabela");
      scAjaxHideErrorDisplay("transportadora");
      scAjaxHideErrorDisplay("previsao");
      scAjaxHideErrorDisplay("condpag");
      scAjaxHideErrorDisplay("header");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_proposta_mob_submit_form_cb_after_alert);
  } // do_ajax_form_proposta_mob_submit_form_cb
  function do_ajax_form_proposta_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_proposta_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_itemproposta_mob"] = "off";

  function do_ajax_form_proposta_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_proposta_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_proposta_mob_navigate_form();
    }
  }

  function perform_ajax_form_proposta_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_itemproposta_mob"] = "on";
    x_ajax_form_proposta_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_proposta_mob_navigate_form_cb);
  } // do_ajax_form_proposta_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_proposta_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_proposta_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    scJQWizardGoToStep(0);
    scAjaxSetDisplay(true);
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_itemproposta_mob"] && "nmsc_iframe_liga_form_itemproposta_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_itemproposta_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_itemproposta_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_itemproposta_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_itemproposta_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_itemproposta_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_proposta_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_proposta_mob_navigate_form_cb
  function do_ajax_form_proposta_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_proposta_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_proposta_mob_navigate_form_cb_after_alert

  function sc_hide_form_proposta_mob_form()
  {
  ...
  function do_ajax_form_proposta_mob_lkpedt_refresh_id_empresa()
  {
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_empresa";
    x_ajax_form_proposta_mob_lkpedt_refresh_id_empresa(var_id_empresa, nmgp_refresh_fields, var_script_case_init, do_ajax_form_proposta_mob_lkpedt_refresh_id_empresa_cb);
  } // do_ajax_form_proposta_mob_lkpedt_refresh_id_empresa

  function do_ajax_form_proposta_mob_lkpedt_refresh_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_proposta_mob_lkpedt_refresh_id_empresa_cb
  ...
  {
    if ("off" == scStatusDetail["form_itemproposta_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "natureza";
  ajax_field_list[3] = "cliente";
  ajax_field_list[4] = "atencao";
  ajax_field_list[5] = "local_entrega";
  ajax_field_list[6] = "telefone";
  ajax_field_list[7] = "email";
  ajax_field_list[8] = "cod_vend";
  ajax_field_list[9] = "data";
  ajax_field_list[10] = "total";
  ajax_field_list[11] = "desconto";
  ajax_field_list[12] = "itensdaproposta";
  ajax_field_list[13] = "tabela";
  ajax_field_list[14] = "transportadora";
  ajax_field_list[15] = "previsao";
  ajax_field_list[16] = "condpag";
  ajax_field_list[17] = "header";
  ...
  var ajax_error_list = {
    "id": {"label": "ORDEM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_empresa": {"label": "CLIENTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "cliente": {"label": "EMPRESA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "atencao": {"label": "Atencao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "local_entrega": {"label": "LOCAL ENTREGA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "cod_vend": {"label": "VENDEDOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "data": {"label": "Data", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "total": {"label": "Total s/  desconto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "desconto": {"label": "Total c/ desconto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "itensdaproposta": {"label": "ItensDaProposta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tabela": {"label": "Tabela", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "transportadora": {"label": "Transportadora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "previsao": {"label": "Previsao", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "condpag": {"label": "Condições de pagamento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "header": {"label": "Cabeçalho da proposta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "obs": {"label": "Observações", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "total": new Array(),
    "desconto": new Array(),
    "itensdaproposta": new Array(),
    "tabela": new Array(),
    "transportadora": new Array(),
    "previsao": new Array(),
    "condpag": new Array(),
    "header": new Array(),
    "obs": new Array()
  ...
  ajax_field_mult["atencao"][1] = "atencao";
  ajax_field_mult["local_entrega"][1] = "local_entrega";
  ajax_field_mult["telefone"][1] = "telefone";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["cod_vend"][1] = "cod_vend";
  ajax_field_mult["data"][1] = "data";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["desconto"][1] = "desconto";
  ajax_field_mult["itensdaproposta"][1] = "itensdaproposta";
  ajax_field_mult["tabela"][1] = "tabela";
  ajax_field_mult["transportadora"][1] = "transportadora";
  ajax_field_mult["previsao"][1] = "previsao";
  ajax_field_mult["condpag"][1] = "condpag";
  ...
  var ajax_field_id = {
    ...
    "atencao": new Array("hidden_field_label_atencao", "hidden_field_data_atencao"),
    "local_entrega": new Array("hidden_field_label_local_entrega", "hidden_field_data_local_entrega"),
    ...
    "cod_vend": new Array("hidden_field_label_cod_vend", "hidden_field_data_cod_vend"),
    ...
    "desconto": new Array("hidden_field_label_desconto", "hidden_field_data_desconto"),
    "itensdaproposta": new Array("hidden_field_label_itensdaproposta", "hidden_field_data_itensdaproposta"),
    "tabela": new Array("hidden_field_label_tabela", "hidden_field_data_tabela"),
    "transportadora": new Array("hidden_field_label_transportadora", "hidden_field_data_transportadora"),
    "previsao": new Array("hidden_field_label_previsao", "hidden_field_data_previsao"),
    "condpag": new Array("hidden_field_label_condpag", "hidden_field_data_condpag"),
