...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_proposta_id_onblur('#id_sc_field_id' + iSeqRow, iSeqRow) })
                                .bind('change', function() { sc_form_proposta_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_form_proposta_cliente_onblur('#id_sc_field_cliente' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_proposta_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_atencao' + iSeqRow).bind('blur', function() { sc_form_proposta_atencao_onblur('#id_sc_field_atencao' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_proposta_atencao_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_telefone' + iSeqRow).bind('blur', function() { sc_form_proposta_telefone_onblur('#id_sc_field_telefone' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_proposta_telefone_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_form_proposta_email_onblur('#id_sc_field_email' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_proposta_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_natureza' + iSeqRow).bind('blur', function() { sc_form_proposta_natureza_onblur('#id_sc_field_natureza' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_proposta_natureza_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_data' + iSeqRow).bind('blur', function() { sc_form_proposta_data_onblur('#id_sc_field_data' + iSeqRow, iSeqRow) })
                                  .bind('change', function() { sc_form_proposta_data_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cod_vend' + iSeqRow).bind('blur', function() { sc_form_proposta_cod_vend_onblur('#id_sc_field_cod_vend' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_proposta_cod_vend_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_previsao' + iSeqRow).bind('blur', function() { sc_form_proposta_previsao_onblur('#id_sc_field_previsao' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_proposta_previsao_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_proposta_total_onblur('#id_sc_field_total' + iSeqRow, iSeqRow) })
                                   .bind('change', function() { sc_form_proposta_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_desconto' + iSeqRow).bind('blur', function() { sc_form_proposta_desconto_onblur('#id_sc_field_desconto' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_form_proposta_desconto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_condpag' + iSeqRow).bind('blur', function() { sc_form_proposta_condpag_onblur('#id_sc_field_condpag' + iSeqRow, iSeqRow) })
                                     .bind('change', function() { sc_form_proposta_condpag_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_obs' + iSeqRow).bind('blur', function() { sc_form_proposta_obs_onblur('#id_sc_field_obs' + iSeqRow, iSeqRow) })
                                 .bind('change', function() { sc_form_proposta_obs_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_header' + iSeqRow).bind('blur', function() { sc_form_proposta_header_onblur('#id_sc_field_header' + iSeqRow, iSeqRow) })
                                    .bind('change', function() { sc_form_proposta_header_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_transportadora' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_proposta_transportadora_onblur('#id_sc_field_transportadora' + iSeqRow, iSeqRow);}, 300) })
                                            .bind('change', function() { sc_form_proposta_transportadora_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_local_entrega' + iSeqRow).bind('blur', function() { setTimeout(function() {sc_form_proposta_local_entrega_onblur('#id_sc_field_local_entrega' + iSeqRow, iSeqRow);}, 300) })
                                           .bind('change', function() { sc_form_proposta_local_entrega_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_itensdaproposta' + iSeqRow).bind('blur', function() { sc_form_proposta_itensdaproposta_onblur('#id_sc_field_itensdaproposta' + iSeqRow, iSeqRow) })
                                             .bind('change', function() { sc_form_proposta_itensdaproposta_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_proposta_itensdaproposta_onfocus(this, iSeqRow) });
  $('#id_sc_field_cnpj' + iSeqRow).bind('change', function() { sc_form_proposta_cnpj_onchange(this, iSeqRow) });
  $('#id_sc_field_empresa' + iSeqRow).bind('change', function() { sc_form_proposta_empresa_onchange(this, iSeqRow) });
  $('#id_sc_field_endereco' + iSeqRow).bind('change', function() { sc_form_proposta_endereco_onchange(this, iSeqRow) });
  $('#id_sc_field_emailvm' + iSeqRow).bind('change', function() { sc_form_proposta_emailvm_onchange(this, iSeqRow) });
  $('#id_sc_field_telefonevm' + iSeqRow).bind('change', function() { sc_form_proposta_telefonevm_onchange(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_proposta_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_atencao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_telefone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_natureza_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_data_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_cod_vend_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_previsao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_desconto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_condpag_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_obs_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_header_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_transportadora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_local_entrega_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_itensdaproposta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_proposta_cnpj_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_proposta_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_proposta_endereco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_proposta_emailvm_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_proposta_telefonevm_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_itensdaproposta(row, status) {
    var fieldId;
        if ("on" == status && typeof $("#nmsc_iframe_liga_form_itemproposta")[0].contentWindow.scRecreateSelect2 === "function") {
                $("#nmsc_iframe_liga_form_itemproposta")[0].contentWindow.scRecreateSelect2();
        }
}
...
function scHidePage(pageNo) {
        $("#id_form_proposta_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_proposta')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
var wizardActualStep = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_proposta']['form_wizard']['actual_step']; ?>;
var wizardTotalSteps = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_proposta']['form_wizard']['total_steps']; ?>;
...
function scJQWizardValidateStep(stepGoTo)
{
    if (0 == wizardActualStep) {
        do_ajax_form_proposta_submit_page_0(stepGoTo);
    }
    if (1 == wizardActualStep) {
        do_ajax_form_proposta_submit_page_1(stepGoTo);
    }
}
