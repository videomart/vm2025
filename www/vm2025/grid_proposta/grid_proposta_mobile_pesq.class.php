...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = 'data';$Nm_datas[] = 'vencimento';$Nm_numeric[] = "id";$Nm_numeric[] = "id_empresa";$Nm_numeric[] = "previsao";$Nm_numeric[] = "total";$Nm_numeric[] = "desconto";
...
?>
<span class="scFilterLabelEven scFilterLabelAboveEven"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_data"  <?php echo $str_hide_data?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_data_dia" name="data_dia" value="<?php echo NM_encode_input($data_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
<?php
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_data_mes" name="data_mes" value="<?php echo NM_encode_input($data_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_data_ano" name="data_ano" value="<?php echo NM_encode_input($data_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_data_input_2_dia" name="data_input_2_dia" value="<?php echo NM_encode_input($data_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_data_input_2_mes" name="data_input_2_mes" value="<?php echo NM_encode_input($data_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: true}">
<?php
if($bol_generate_calendar && $bol_last)
{
?>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_data_input_2_ano" name="data_input_2_ano" value="<?php echo NM_encode_input($data_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: true}">
 <?php
if($bol_generate_calendar && $bol_last)
{
?>
...
?>
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br><span id="id_hide_natureza"  <?php echo $str_hide_natureza?>> 
<?php
