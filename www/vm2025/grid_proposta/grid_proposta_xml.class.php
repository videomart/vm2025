...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_proposta/grid_proposta_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_label'];
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_return']);
          if ($this->Tem_xml_res) {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_proposta.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_proposta>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_proposta";
...
$_SESSION['scriptcase']['grid_proposta']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              $this->Res = new grid_proposta_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_res_grid']);
          } 
      }
   ...
   function NM_export_empresa()
   {
         ...
         if ($this->New_Format) {
             $this->empresa .= " " . $this->NM_export_id_empresa(true);
             $this->empresa .= " " . $this->NM_export_atencao(true);
             $this->empresa .= " " . $this->NM_export_telefone(true);
         }
         else {
             $this->empresa .= " " . $this->NM_export_id_empresa(true);
             $this->empresa .= " " . $this->NM_export_telefone(true);
   ...
   function NM_export_cod_vend($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->cod_vend) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->cod_vend) . "\"";
         }
   ...
   function NM_export_natureza($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->natureza) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->natureza) . "\"";
         }
   ...
   function NM_export_periodo($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->periodo) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->periodo) . "\"";
         }
   ...
   function NM_export_vencimento($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->vencimento) . "</" . $SC_Label . ">\r\n";
         }
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->vencimento) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->vencimento) . "\"";
         }
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->vencimento) . "\"";
         }
   }
   //----- total
   function NM_export_total($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->total) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->total) . "\"";
         }
   ...
   function NM_export_cliente($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->cliente) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->cliente) . "\"";
         }
   ...
   function NM_export_atencao($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->atencao) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->atencao) . "\"";
         }
   ...
   function NM_export_id_empresa($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->look_id_empresa) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->look_id_empresa) . "\"";
         }
   ...
   function NM_export_telefone($Grouping=false)
   {
         ...
         {
         if ($Grouping) {
             return " <" . $SC_Label . ">" . $this->trata_dados($this->telefone) . "</" . $SC_Label . ">\r\n";
         }
         ...
         {
         if ($Grouping) {
             return " " . $SC_Label . " =\"" . $this->trata_dados($this->telefone) . "\"";
         }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
