...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_proposta/grid_proposta_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_proposta.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_name']);
      }
...
$_SESSION['scriptcase']['grid_proposta']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_proposta_res_json.class.php");
              $this->Res = new grid_proposta_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_res_grid']);
          } 
      }
   ...
   //----- id
   function NM_export_id($Grouping=false, $Lab_Mult="")
   {
         ...
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->id;
         }
         else {
   ...
   function NM_export_empresa()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->NM_export_id_empresa(true, $SC_Label);
         $this->NM_export_atencao(true, $SC_Label);
         $this->NM_export_telefone(true, $SC_Label);
   }
   //----- cod_vend
   function NM_export_cod_vend($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->cod_vend;
         }
         else {
   ...
   //----- natureza
   function NM_export_natureza($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->natureza;
         }
         else {
   ...
   //----- periodo
   function NM_export_periodo($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->periodo;
         }
         else {
   ...
   //----- data
   function NM_export_data($Grouping=false, $Lab_Mult="")
   {
         if ($this->Json_format)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->data;
         }
         else {
   ...
   //----- vencimento
   function NM_export_vencimento($Grouping=false, $Lab_Mult="")
   {
         if ($this->Json_format)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->vencimento;
         }
         else {
             $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->vencimento;
         }
   }
   //----- total
   function NM_export_total($Grouping=false, $Lab_Mult="")
   {
         if ($this->Json_format)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->total;
         }
         else {
   ...
   //----- cliente
   function NM_export_cliente($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->cliente;
         }
         else {
   ...
   //----- atencao
   function NM_export_atencao($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->atencao;
         }
         else {
             $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->atencao;
         }
   }
   //----- id_empresa
   function NM_export_id_empresa($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->look_id_empresa;
         }
         else {
   ...
   //----- telefone
   function NM_export_telefone($Grouping=false, $Lab_Mult="")
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         if ($Grouping && !empty($Lab_Mult)) {
             $this->json_registro[$this->SC_seq_json][$Lab_Mult][$SC_Label] = $this->telefone;
         }
         else {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
