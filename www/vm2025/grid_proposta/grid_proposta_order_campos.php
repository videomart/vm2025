<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_proposta']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_proposta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_proposta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["id"] : "ORDEM";
   ...
   $tab_labels["empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["empresa"] : "Empresa";
   $tab_ger_campos['cod_vend'] = "on";
   $tab_def_campos['cod_vend'] = "cod_vend";
   $tab_labels["cod_vend"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["cod_vend"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["cod_vend"] : "Consultor";
   $tab_ger_campos['natureza'] = "on";
   $tab_def_campos['natureza'] = "natureza";
   $tab_labels["natureza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["natureza"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["natureza"] : "Natureza";
   ...
   {
       $tab_def_campos['periodo'] = "DATE_FORMAT(proposta.data,'%m/%y')";
   }
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["periodo"] : "Periodo";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "data";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["data"] : "Data";
   $tab_ger_campos['vencimento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['vencimento'] = "vencimento";
   }
   else
   {
       $tab_def_campos['vencimento'] = "";
   }
   $tab_labels["vencimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["vencimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["vencimento"] : "Vencimento";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["total"] : "Total";
   $tab_ger_campos['id_empresa'] = "on";
   $tab_def_campos['id_empresa'] = "ID_EMPRESA";
   $tab_labels["id_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["id_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["id_empresa"] : "EMPRESA";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "telefone";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['labels']["telefone"] : "Telefone";
   $tab_ger_campos['id'] = "none";
   $tab_ger_campos['empresa'] = "none";
   $tab_ger_campos['vencimento'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_proposta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_proposta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_proposta']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_proposta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_proposta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
