...
$_SESSION['scriptcase']['grid_proposta']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          $this->Res = new grid_proposta_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proposta']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   {
      $this->NM_export_id_empresa();
      $this->NM_export_atencao();
      $this->NM_export_telefone();
   }
   //----- cod_vend
   ...
   function NM_export_vencimento()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->vencimento);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   //----- total
