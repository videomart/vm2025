<?php
@session_start() ;
$_SESSION['scriptcase']['grid_proposta']['sc_process_barr'] = true;
require_once('../grid_proposta/index.php');
unset($_SESSION['scriptcase']['grid_proposta']['sc_process_barr']);
$ExportCtrl = new grid_proposta_export_control;
$ExportCtrl->Export_barr();

class grid_proposta_export_control
{
