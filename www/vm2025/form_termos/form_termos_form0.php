...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_termos/form_termos_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_termos_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_termos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['link_info']['remove_border']) {
...
<?php
 include_once("form_termos_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_termos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_termos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_codigo_line" id="hidden_field_data_codigo" style="<?php echo $sStyleHidden_codigo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_codigo" class="css_codigo_line" style="<?php echo $sStyleReadLab_codigo; ?>"><?php echo $this->form_format_readonly("codigo", $this->form_encode_input($this->codigo)); ?></span><span id="id_read_off_codigo" class="css_read_off_codigo" style="<?php echo $sStyleReadInp_codigo; ?>"><input type="hidden" name="codigo" value="<?php echo $this->form_encode_input($codigo) . "\">"?><span id="id_ajax_label_codigo"><?php echo nl2br($codigo); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_codigo_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_codigo_text"></span></td></tr></table></td></tr></table></TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_moeda_label" id="hidden_field_label_moeda" style="<?php echo $sStyleHidden_moeda; ?>"><span id="id_label_moeda"><?php echo $this->nm_new_label['moeda']; ?></span></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['Lookup_moeda'][] = 'DOLAR'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['Lookup_moeda'][] = 'REAL'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_entrega_label" id="hidden_field_label_entrega" style="<?php echo $sStyleHidden_entrega; ?>"><span id="id_label_entrega"><?php echo $this->nm_new_label['entrega']; ?></span></TD>
    <TD class="scFormDataOdd css_entrega_line" id="hidden_field_data_entrega" style="<?php echo $sStyleHidden_entrega; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_entrega_line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_entrega_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_entrega_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_garantia_label" id="hidden_field_label_garantia" style="<?php echo $sStyleHidden_garantia; ?>"><span id="id_label_garantia"><?php echo $this->nm_new_label['garantia']; ?></span></TD>
    <TD class="scFormDataOdd css_garantia_line" id="hidden_field_data_garantia" style="<?php echo $sStyleHidden_garantia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_garantia_line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_garantia_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_garantia_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_condpag_label" id="hidden_field_label_condpag" style="<?php echo $sStyleHidden_condpag; ?>"><span id="id_label_condpag"><?php echo $this->nm_new_label['condpag']; ?></span></TD>
    <TD class="scFormDataOdd css_condpag_line" id="hidden_field_data_condpag" style="<?php echo $sStyleHidden_condpag; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_condpag_line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_condpag_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_condpag_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_formpag_label" id="hidden_field_label_formpag" style="<?php echo $sStyleHidden_formpag; ?>"><span id="id_label_formpag"><?php echo $this->nm_new_label['formpag']; ?></span></TD>
    <TD class="scFormDataOdd css_formpag_line" id="hidden_field_data_formpag" style="<?php echo $sStyleHidden_formpag; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_formpag_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_formpag" class="sc-ui-readonly-formpag css_formpag_line" style="<?php echo $sStyleReadLab_formpag; ?>"><?php echo $this->form_format_readonly("formpag", $this->form_encode_input($this->formpag)); ?></span><span id="id_read_off_formpag" class="css_read_off_formpag<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_formpag; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=30"; } ?> maxlength=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_formpag_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_formpag_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_instdep_label" id="hidden_field_label_instdep" style="<?php echo $sStyleHidden_instdep; ?>"><span id="id_label_instdep"><?php echo $this->nm_new_label['instdep']; ?></span></TD>
    <TD class="scFormDataOdd css_instdep_line" id="hidden_field_data_instdep" style="<?php echo $sStyleHidden_instdep; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_instdep_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_instdep" class="sc-ui-readonly-instdep css_instdep_line" style="<?php echo $sStyleReadLab_instdep; ?>"><?php echo $this->form_format_readonly("instdep", $this->form_encode_input($this->instdep)); ?></span><span id="id_read_off_instdep" class="css_read_off_instdep<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_instdep; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=50"; } ?> maxlength=75 alt="{datatype: 'text', maxLength: 75, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_instdep_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_instdep_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mensagem_line" id="hidden_field_data_mensagem" style="<?php echo $sStyleHidden_mensagem; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mensagem_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_mensagem" class="sc-ui-readonly-mensagem css_mensagem_line" style="<?php echo $sStyleReadLab_mensagem; ?>"><?php echo $this->form_format_readonly("mensagem", $this->form_encode_input($this->mensagem)); ?></span><span id="id_read_off_mensagem" class="css_read_off_mensagem<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_mensagem; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=50"; } ?> maxlength=75 alt="{datatype: 'text', maxLength: 75, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_mensagem_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_mensagem_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_validade_label" id="hidden_field_label_validade" style="<?php echo $sStyleHidden_validade; ?>"><span id="id_label_validade"><?php echo $this->nm_new_label['validade']; ?></span></TD>
    <TD class="scFormDataOdd css_validade_line" id="hidden_field_data_validade" style="<?php echo $sStyleHidden_validade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_validade_line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_validade_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_validade_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_impostos_label" id="hidden_field_label_impostos" style="<?php echo $sStyleHidden_impostos; ?>"><span id="id_label_impostos"><?php echo $this->nm_new_label['impostos']; ?></span></TD>
    <TD class="scFormDataOdd css_impostos_line" id="hidden_field_data_impostos" style="<?php echo $sStyleHidden_impostos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_impostos_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['Lookup_impostos'][] = 'SIM'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['Lookup_impostos'][] = 'NAO'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_desconto_label" id="hidden_field_label_desconto" style="<?php echo $sStyleHidden_desconto; ?>"><span id="id_label_desconto"><?php echo $this->nm_new_label['desconto']; ?></span></TD>
    <TD class="scFormDataOdd css_desconto_line" id="hidden_field_data_desconto" style="<?php echo $sStyleHidden_desconto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desconto_line" style="vertical-align: top;padding: 0px">
...
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_desconto_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_desconto_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_frete_label" id="hidden_field_label_frete" style="<?php echo $sStyleHidden_frete; ?>"><span id="id_label_frete"><?php echo $this->nm_new_label['frete']; ?></span></TD>
    <TD class="scFormDataOdd css_frete_line" id="hidden_field_data_frete" style="<?php echo $sStyleHidden_frete; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_frete_line" style="vertical-align: top;padding: 0px">
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_frete_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_frete_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['btn_label']['bcancelar'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_termos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_termos");
 parent.scAjaxDetailHeight("form_termos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
