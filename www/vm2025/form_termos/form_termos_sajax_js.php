  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_termos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate codigo
  function do_ajax_form_termos_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldHidden(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_termos_validate_codigo_cb);
  } // do_ajax_form_termos_validate_codigo

  function do_ajax_form_termos_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_codigo_cb

  // ---------- Validate moeda
  function do_ajax_form_termos_validate_moeda()
  {
    var nomeCampo_moeda = "moeda";
    var var_moeda = scAjaxGetFieldRadio(nomeCampo_moeda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_moeda(var_moeda, var_script_case_init, do_ajax_form_termos_validate_moeda_cb);
  } // do_ajax_form_termos_validate_moeda

  function do_ajax_form_termos_validate_moeda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_moeda_cb

  // ---------- Validate entrega
  function do_ajax_form_termos_validate_entrega()
  {
    var nomeCampo_entrega = "entrega";
    var var_entrega = scAjaxGetFieldText(nomeCampo_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_entrega(var_entrega, var_script_case_init, do_ajax_form_termos_validate_entrega_cb);
  } // do_ajax_form_termos_validate_entrega

  function do_ajax_form_termos_validate_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_entrega_cb

  // ---------- Validate garantia
  function do_ajax_form_termos_validate_garantia()
  {
    var nomeCampo_garantia = "garantia";
    var var_garantia = scAjaxGetFieldText(nomeCampo_garantia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_garantia(var_garantia, var_script_case_init, do_ajax_form_termos_validate_garantia_cb);
  } // do_ajax_form_termos_validate_garantia

  function do_ajax_form_termos_validate_garantia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_garantia_cb

  // ---------- Validate condpag
  function do_ajax_form_termos_validate_condpag()
  {
    var nomeCampo_condpag = "condpag";
    var var_condpag = scAjaxGetFieldText(nomeCampo_condpag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_condpag(var_condpag, var_script_case_init, do_ajax_form_termos_validate_condpag_cb);
  } // do_ajax_form_termos_validate_condpag

  function do_ajax_form_termos_validate_condpag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_condpag_cb

  // ---------- Validate formpag
  function do_ajax_form_termos_validate_formpag()
  {
    var nomeCampo_formpag = "formpag";
    var var_formpag = scAjaxGetFieldText(nomeCampo_formpag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_formpag(var_formpag, var_script_case_init, do_ajax_form_termos_validate_formpag_cb);
  } // do_ajax_form_termos_validate_formpag

  function do_ajax_form_termos_validate_formpag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_formpag_cb

  // ---------- Validate instdep
  function do_ajax_form_termos_validate_instdep()
  {
    var nomeCampo_instdep = "instdep";
    var var_instdep = scAjaxGetFieldText(nomeCampo_instdep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_instdep(var_instdep, var_script_case_init, do_ajax_form_termos_validate_instdep_cb);
  } // do_ajax_form_termos_validate_instdep

  function do_ajax_form_termos_validate_instdep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_instdep_cb

  // ---------- Validate mensagem
  function do_ajax_form_termos_validate_mensagem()
  {
    var nomeCampo_mensagem = "mensagem";
    var var_mensagem = scAjaxGetFieldText(nomeCampo_mensagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_mensagem(var_mensagem, var_script_case_init, do_ajax_form_termos_validate_mensagem_cb);
  } // do_ajax_form_termos_validate_mensagem

  function do_ajax_form_termos_validate_mensagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_mensagem_cb

  // ---------- Validate validade
  function do_ajax_form_termos_validate_validade()
  {
    var nomeCampo_validade = "validade";
    var var_validade = scAjaxGetFieldText(nomeCampo_validade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_validade(var_validade, var_script_case_init, do_ajax_form_termos_validate_validade_cb);
  } // do_ajax_form_termos_validate_validade

  function do_ajax_form_termos_validate_validade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_validade_cb

  // ---------- Validate impostos
  function do_ajax_form_termos_validate_impostos()
  {
    var nomeCampo_impostos = "impostos";
    var var_impostos = scAjaxGetFieldRadio(nomeCampo_impostos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_impostos(var_impostos, var_script_case_init, do_ajax_form_termos_validate_impostos_cb);
  } // do_ajax_form_termos_validate_impostos

  function do_ajax_form_termos_validate_impostos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_impostos_cb

  // ---------- Validate desconto
  function do_ajax_form_termos_validate_desconto()
  {
    var nomeCampo_desconto = "desconto";
    var var_desconto = scAjaxGetFieldText(nomeCampo_desconto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_desconto(var_desconto, var_script_case_init, do_ajax_form_termos_validate_desconto_cb);
  } // do_ajax_form_termos_validate_desconto

  function do_ajax_form_termos_validate_desconto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_desconto_cb

  // ---------- Validate frete
  function do_ajax_form_termos_validate_frete()
  {
    var nomeCampo_frete = "frete";
    var var_frete = scAjaxGetFieldText(nomeCampo_frete);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_termos_validate_frete(var_frete, var_script_case_init, do_ajax_form_termos_validate_frete_cb);
  } // do_ajax_form_termos_validate_frete

  function do_ajax_form_termos_validate_frete_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_termos_validate_frete_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_termos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_termos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_termos_submit_form(var_codigo, var_moeda, var_entrega, var_garantia, var_condpag, var_formpag, var_instdep, var_mensagem, var_validade, var_impostos, var_desconto, var_frete, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_termos_submit_form_cb);
  } // do_ajax_form_termos_submit_form

  function do_ajax_form_termos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_termos_submit_form_cb_after_alert);
  } // do_ajax_form_termos_submit_form_cb
  function do_ajax_form_termos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_termos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_termos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_termos_navigate_form, function() {});
    } else {
      perform_ajax_form_termos_navigate_form();
    }
  }

  function perform_ajax_form_termos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_termos_navigate_form(var_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_termos_navigate_form_cb);
  } // do_ajax_form_termos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_termos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_termos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_termos_navigate_form_cb_after_alert);
  } // do_ajax_form_termos_navigate_form_cb
  function do_ajax_form_termos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_termos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_termos_navigate_form_cb_after_alert

  function sc_hide_form_termos_form()
  {
