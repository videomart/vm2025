  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_uf_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate uf
  function do_ajax_form_uf_mob_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_uf_mob_validate_uf(var_uf, var_script_case_init, do_ajax_form_uf_mob_validate_uf_cb);
  } // do_ajax_form_uf_mob_validate_uf

  function do_ajax_form_uf_mob_validate_uf_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_uf_mob_validate_uf_cb

  // ---------- Validate regiao
  function do_ajax_form_uf_mob_validate_regiao()
  {
    var nomeCampo_regiao = "regiao";
    var var_regiao = scAjaxGetFieldRadio(nomeCampo_regiao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_uf_mob_validate_regiao(var_regiao, var_script_case_init, do_ajax_form_uf_mob_validate_regiao_cb);
  } // do_ajax_form_uf_mob_validate_regiao

  function do_ajax_form_uf_mob_validate_regiao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_uf_mob_validate_regiao_cb

  // ---------- Validate icm
  function do_ajax_form_uf_mob_validate_icm()
  {
    var nomeCampo_icm = "icm";
    var var_icm = scAjaxGetFieldText(nomeCampo_icm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_uf_mob_validate_icm(var_icm, var_script_case_init, do_ajax_form_uf_mob_validate_icm_cb);
  } // do_ajax_form_uf_mob_validate_icm

  function do_ajax_form_uf_mob_validate_icm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_uf_mob_validate_icm_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_uf_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_uf_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_uf = scAjaxGetFieldText("uf");
    var var_regiao = scAjaxGetFieldRadio("regiao");
    var var_icm = scAjaxGetFieldText("icm");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_uf_mob_submit_form(var_uf, var_regiao, var_icm, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_uf_mob_submit_form_cb);
  } // do_ajax_form_uf_mob_submit_form

  function do_ajax_form_uf_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("regiao");
      scAjaxHideErrorDisplay("icm");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_uf_mob_submit_form_cb_after_alert);
  } // do_ajax_form_uf_mob_submit_form_cb
  function do_ajax_form_uf_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_uf_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_uf_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_uf_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_uf_mob_navigate_form();
    }
  }

  function perform_ajax_form_uf_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_uf_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_uf_mob_navigate_form_cb);
  } // do_ajax_form_uf_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_uf_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_uf_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_uf_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_uf_mob_navigate_form_cb
  function do_ajax_form_uf_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_uf_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_uf_mob_navigate_form_cb_after_alert

  function sc_hide_form_uf_mob_form()
  {
  ...
  ajax_field_list[0] = "uf";
  ajax_field_list[1] = "regiao";
  ajax_field_list[2] = "icm";
  ...
  var ajax_error_list = {
    ...
    "icm": {"label": "ICM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "icm": new Array("hidden_field_label_icm", "hidden_field_data_icm")
  };
