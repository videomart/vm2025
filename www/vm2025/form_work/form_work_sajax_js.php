...
?>
  ...
  // ---------- Validate descricao_
  function do_ajax_form_work_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_work_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_form_work_validate_descricao__cb);
  } // do_ajax_form_work_validate_descricao_

  function do_ajax_form_work_validate_descricao__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_work_validate_descricao__cb

  // ---------- Validate htec_
  function do_ajax_form_work_validate_htec_(iNumLinha)
  {
    var nomeCampo_htec_ = "htec_" + iNumLinha;
    var var_htec_ = scAjaxGetFieldText(nomeCampo_htec_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_work_validate_htec_(var_htec_, iNumLinha, var_script_case_init, do_ajax_form_work_validate_htec__cb);
  } // do_ajax_form_work_validate_htec_

  function do_ajax_form_work_validate_htec__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "htec_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "htec_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_work_validate_htec__cb

  // ---------- Validate valor_
  function do_ajax_form_work_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_work_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_work_validate_valor__cb);
  } // do_ajax_form_work_validate_valor_

  function do_ajax_form_work_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_work_validate_valor__cb

  // ---------- Event onchange htec_
  function do_ajax_form_work_event_htec__onchange(iSeqForm)
  {
    var var_valor_ = scAjaxGetFieldText("valor_" + iSeqForm);
    var var_htec_ = scAjaxGetFieldText("htec_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_work_event_htec__onchange(var_valor_, var_htec_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_work_event_htec__onchange_cb);
  } // do_ajax_form_work_event_htec__onchange

  function do_ajax_form_work_event_htec__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_work_event_htec__onchange_cb_after_alert);
  } // do_ajax_form_work_event_htec__onchange_cb
  function do_ajax_form_work_event_htec__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_work_event_htec__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_work_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_work_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_work_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_work_add_new_line_cb);
  } // do_ajax_form_work_add_new_line

  var ctrl_new_line  = false;
  var ctrl_last_line = 0;
  function do_ajax_form_work_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_work_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_work_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_work_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_work_backup_line_cb);
  } // do_ajax_form_work_backup_line

  function do_ajax_form_work_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_work_backup_line_cb

  function do_ajax_form_work_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_work_cancel_insert

  function do_ajax_form_work_cancel_update(iSeqVert)
  {
    do_ajax_form_work_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_work_cancel_update

  function do_ajax_form_work_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_work_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_work_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_work_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_work_table_refresh_cb);
  } //  do_ajax_form_work_table_refresh

  function do_ajax_form_work_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_work_table_refresh_cb_after_alert);
  } // do_ajax_form_work_table_refresh_cb
  function do_ajax_form_work_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_work_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_work_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_work_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_htec_ = scAjaxGetFieldText("htec_" + iNumLinha);
...
?>
    x_ajax_form_work_submit_form(var_descricao_, var_htec_, var_valor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_work_submit_form_cb);
  } // do_ajax_form_work_submit_form

  function do_ajax_form_work_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("htec_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_work_submit_form_cb_after_alert);
  } // do_ajax_form_work_submit_form_cb
  function do_ajax_form_work_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_work_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_work_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_work_navigate_form, function() {});
    } else {
      perform_ajax_form_work_navigate_form();
    }
  }

  function perform_ajax_form_work_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_work_cancel_insert(sc_form_work_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("htec_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_work_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_work_navigate_form_cb);
  } // do_ajax_form_work_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_work']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_work_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_work_navigate_form_cb_after_alert);
  } // do_ajax_form_work_navigate_form_cb
  function do_ajax_form_work_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_work_navigate_form_cb_after_alert

    function sc_form_work_get_last_line_number()
    {
    ...
    } //sc_form_work_get_last_line_number

  function sc_hide_form_work_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "htec_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["descricao_" + iNumLinha] = {"label": "Descrição do serviço<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["htec_" + iNumLinha] = {"label": "Horas técnicas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["htec_"][iNumLinha] = "htec_" + iNumLinha;
    ...
    ajax_field_id["htec_" + iNumLinha] = new Array("hidden_field_label_htec_", "hidden_field_data_htec_" + iNumLinha);
    ...
    ajax_error_count["htec_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["htec_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["htec_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["htec_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["htec_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["htec_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["htec_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["htec_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["htec_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['htec_'])) ? $this->nmgp_cmp_readonly['htec_'] : 'off';
?>
    scAjaxFieldRead("htec_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["htec_" + iRow] || "on" == ajax_error_count["valor_" + iRow]))
    {
      ...
      $("#hidden_field_data_htec_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["htec_" + iRow] && "off" == ajax_error_count["valor_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["descricao_" + iRow] = "off";
        ajax_error_count["htec_" + iRow] = "off";
      ...
      $("#hidden_field_data_htec_" + iRow).removeClass("scFormErrorLine");
