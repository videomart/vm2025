  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_categoria_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
        ...
        sc_hide_form_categoria_mob_form();
        }
...
?>
  ...
  // ---------- Validate categoria
  function do_ajax_form_categoria_mob_validate_categoria()
  {
    var nomeCampo_categoria = "categoria";
    var var_categoria = scAjaxGetFieldText(nomeCampo_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_mob_validate_categoria(var_categoria, var_script_case_init, do_ajax_form_categoria_mob_validate_categoria_cb);
  } // do_ajax_form_categoria_mob_validate_categoria

  function do_ajax_form_categoria_mob_validate_categoria_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_categoria_cb

  // ---------- Validate id_vendedor
  function do_ajax_form_categoria_mob_validate_id_vendedor()
  {
  } // do_ajax_form_categoria_mob_validate_id_vendedor

  function do_ajax_form_categoria_mob_validate_id_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_mob_validate_id_vendedor_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_categoria_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_categoria_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categoria_mob_submit_form(var_categoria, var_id_vendedor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_categoria_mob_submit_form_cb);
  } // do_ajax_form_categoria_mob_submit_form

  function do_ajax_form_categoria_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_categoria_mob_submit_form_cb_after_alert);
  } // do_ajax_form_categoria_mob_submit_form_cb
  function do_ajax_form_categoria_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_categoria_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_categoria_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_categoria_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_categoria_mob_navigate_form();
    }
  }

  function perform_ajax_form_categoria_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("categoria");
    scAjaxHideErrorDisplay("id_vendedor");
    var var_categoria = document.F2.categoria.value;
    ...
    scAjaxProcOn();
    x_ajax_form_categoria_mob_navigate_form(var_categoria, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categoria_mob_navigate_form_cb);
  } // do_ajax_form_categoria_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_categoria_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_categoria_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxSetVariables();
    scAjaxSetSummaryLine();
    document.F2.categoria.value = scAjaxGetKeyValue("categoria");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_categoria_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_categoria_mob_navigate_form_cb
  function do_ajax_form_categoria_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_categoria_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_categoria_mob_navigate_form_cb_after_alert

  function sc_hide_form_categoria_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "id_vendedor": {"label": "VENDEDOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
