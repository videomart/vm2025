...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['form_funcionario_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          $_POST['nmgp_opcao'] = "novo";
          $this->nmgp_opcao    = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_funcionario_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_funcionario_mob']['opc_ant'] = "inicio";
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['form_funcionario_mob']['opc_ant']);
          }
      } 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_funcionario_mob']['upload_field_info']['assinatura'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_funcionario_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_funcionario_mob']['upload_field_info']['retrato'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_funcionario_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - funcionario";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->assinatura_ul_name]))
          {
              $this->NM_ajax_info['param']['assinatura_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->assinatura_ul_name];
          }
      ...
      elseif (isset($this->assinatura_ul_name) && '' != $this->assinatura_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->assinatura_ul_name]))
          {
              $this->assinatura_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->assinatura_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->retrato_ul_name]))
          {
              $this->NM_ajax_info['param']['retrato_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->retrato_ul_name];
          }
      ...
      elseif (isset($this->retrato_ul_name) && '' != $this->retrato_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->retrato_ul_name]))
          {
              $this->retrato_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['upload_field_ul_name'][$this->retrato_ul_name];
          }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['opc_ant'] : "";
      } 
...
//
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
//
      ...
      if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form" && !$this->Apl_com_erro)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['sc_redir_atualiz'] == "ok")
          {
...
//---
   ...
   if (isset($this->Field_no_validate['nivel'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_nivel']) && !in_array($this->nivel, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_nivel']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['usuario'])) {
       return;
               ...
               if (!empty($this->usuario) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_usuario']) && !in_array($this->usuario, $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_usuario']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_salario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->salario, 6, 6, -0, 999999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Salario; " ; 
                  if (!isset($Campos_Erros['salario']))
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_funcionario_mob_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dados_form']['assinatura']) && $this->assinatura_limpa != "S")
          {
              $this->assinatura = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dados_form']['assinatura'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dados_form']['retrato']) && $this->retrato_limpa != "S")
          {
              $this->retrato = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dados_form']['retrato'];
          }
      } 
   }
...
$aLookup[] = array(form_funcionario_mob_pack_protect_string('TECNICA') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Técnica")));
$aLookup[] = array(form_funcionario_mob_pack_protect_string('COMERCIAL') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Comercial")));
$aLookup[] = array(form_funcionario_mob_pack_protect_string('ADM') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Administração")));
$aLookup[] = array(form_funcionario_mob_pack_protect_string('APOIO') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Apoio")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_divisao'][] = 'TECNICA';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_divisao'][] = 'COMERCIAL';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_divisao'][] = 'ADM';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_divisao'][] = 'APOIO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['divisao']['valList'][$i] = form_funcionario_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_funcionario_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Sim")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_consultor'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['consultor']['valList'][$i] = form_funcionario_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_funcionario_mob_pack_protect_string('0') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Usuário")));
$aLookup[] = array(form_funcionario_mob_pack_protect_string('1') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Gerencia")));
$aLookup[] = array(form_funcionario_mob_pack_protect_string('2') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Administrador")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_nivel'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_nivel'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_nivel'][] = '2';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['nivel']['valList'][$i] = form_funcionario_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_funcionario_mob_pack_protect_string('') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string('Selecione o usuario')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_usuario'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['usuario']['valList'][$i] = form_funcionario_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_funcionario_mob_pack_protect_string('SIM') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Sim")));
$aLookup[] = array(form_funcionario_mob_pack_protect_string('NAO') => str_replace('<', '&lt;',form_funcionario_mob_pack_protect_string("Não")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_ativo'][] = 'SIM';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Lookup_ativo'][] = 'NAO';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
   ...
   $out_assinatura = '';
   $out1_assinatura = '';
   if ('' != $this->assinatura_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->assinatura_ul_name))
   {
       $this->assinatura = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->assinatura_ul_name);
   }
   ...
   $out_retrato = '';
   $out1_retrato = '';
   if ('' != $this->retrato_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->retrato_ul_name))
   {
       $this->retrato = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->retrato_ul_name);
   }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['Field_no_validate'] = array();
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dyn_search_and_or']);
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dyn_search_cache']);
...
<?php
  exit;
    ...
    function displayAppFooter()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    function getSummaryLine()
    {
        ...
        $summaryLine = str_replace(
            ...
            [
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['reg_start'] + 1,
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['total'] + 1,
            ],
            $summaryLine
        );
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['ordem_ord'] == " desc") {
