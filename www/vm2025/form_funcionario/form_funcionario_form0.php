...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['margin_top']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['margin_top']) {
?>
<style>
.scFormBorder {
...
.scBlockRowFirst .scFormTable {
    margin-top: <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['margin_top'] ?>;
}
</style>
<?php
}
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    $remove_background = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['remove_background'] ? 'background-color: transparent; background-image: none; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['remove_background']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['remove_background']) {
        $remove_background = 'background-color: transparent; background-image: none; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['last'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['help'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<input type="hidden" name="assinatura_ul_name" id="id_sc_field_assinatura_ul_name" value="<?php echo $this->form_encode_input($this->assinatura_ul_name);?>">
...
<ul class="scTabLine">
<li id="id_tabs_0_0" class="scTabActive"><a href="javascript: sc_control_tabs_0(0)">Dados do funcionário</a></li>
<li id="id_tabs_0_1" class="scTabInactive"><a href="javascript: sc_control_tabs_0(1)">Detalhe</a></li>
</ul>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_id" style="<?php echo $sStyleHidden_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_line" style="vertical-align: top;padding: 0px"><table style="border-spacing: 0px; border-width: 0px; border-collapse: collapse; width: 100%" cellspacing=0 cellpadding=0><tr><td class="scFormLabelOddFormat scFormLabelAboveOddFormat css_id_label" style=" padding: 0px; width: 100%;"><span id="id_label_id"><?php echo $this->nm_new_label['id']; ?></span></td></tr><tr><td class="css_id_line" style="padding: 0px; width: 100%;">
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_id" class="css_id_line" style="<?php echo $sStyleReadLab_id; ?>"><?php echo $this->form_format_readonly("id", $this->form_encode_input($this->id)); ?></span><span id="id_read_off_id" class="css_read_off_id" style="<?php echo $sStyleReadInp_id; ?>"><input type="hidden" name="id" value="<?php echo $this->form_encode_input($id) . "\">"?><span id="id_ajax_label_id"><?php echo nl2br($id); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_text"></span></td></tr></table></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } 
?> 
<?php $sStyleHidden_nascimento_dumb = ('' == $sStyleHidden_nascimento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_nascimento_dumb" style="<?php echo $sStyleHidden_nascimento_dumb; ?>"></TD>
...
<?php $sStyleHidden_filiacao_dumb = ('' == $sStyleHidden_filiacao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_filiacao_dumb" style="<?php echo $sStyleHidden_filiacao_dumb; ?>"></TD>
<?php $sStyleHidden_identidade_dumb = ('' == $sStyleHidden_identidade) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_identidade_dumb" style="<?php echo $sStyleHidden_identidade_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_habilitaca_dumb = ('' == $sStyleHidden_habilitaca) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_habilitaca_dumb" style="<?php echo $sStyleHidden_habilitaca_dumb; ?>"></TD>
<?php $sStyleHidden_certreserv_dumb = ('' == $sStyleHidden_certreserv) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_certreserv_dumb" style="<?php echo $sStyleHidden_certreserv_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_divisao'][] = 'TECNICA'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_divisao'][] = 'COMERCIAL'; ?>
 <option  value="ADM" <?php  if ($this->divisao == "ADM") { echo " selected" ;} ?>>Administração</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_divisao'][] = 'ADM'; ?>
 <option  value="APOIO" <?php  if ($this->divisao == "APOIO") { echo " selected" ;} ?>>Apoio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_divisao'][] = 'APOIO'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_divisao_dumb = ('' == $sStyleHidden_divisao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_divisao_dumb" style="<?php echo $sStyleHidden_divisao_dumb; ?>"></TD>
<?php $sStyleHidden_funcao_dumb = ('' == $sStyleHidden_funcao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_funcao_dumb" style="<?php echo $sStyleHidden_funcao_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_consultor'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_nivel'][] = '0'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_nivel'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_nivel'][] = '2'; ?>
...
<?php } 
?> 
<?php $sStyleHidden_consultor_dumb = ('' == $sStyleHidden_consultor) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_consultor_dumb" style="<?php echo $sStyleHidden_consultor_dumb; ?>"></TD>
...
<?php $sStyleHidden_salario_dumb = ('' == $sStyleHidden_salario) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_salario_dumb" style="<?php echo $sStyleHidden_salario_dumb; ?>"></TD>
<?php $sStyleHidden_admissao_dumb = ('' == $sStyleHidden_admissao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_admissao_dumb" style="<?php echo $sStyleHidden_admissao_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_ativo'][] = 'SIM'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['Lookup_ativo'][] = 'NAO'; ?>
...
<div id="id_sc_dragdrop_assinatura" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_assinatura ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
...
<?php $sStyleHidden_assinatura_dumb = ('' == $sStyleHidden_assinatura) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_assinatura_dumb" style="<?php echo $sStyleHidden_assinatura_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<div id="id_sc_dragdrop_retrato" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_retrato ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
<?php echo $this->Ini->Nm_lang['lang_errm_mu_dragimg'] ?></div>
...
<?php $sStyleHidden_rodape_dumb = ('' == $sStyleHidden_rodape) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_rodape_dumb" style="<?php echo $sStyleHidden_rodape_dumb; ?>"></TD>
...
<?php $sc_hidden_no = 1; ?>
   ...
   <a name="bloco_2"></a>
   <table width="100%" height="100%" cellpadding="0" cellspacing=0 class="scBlockRow"><tr valign="top"><td width="60%" height="">
