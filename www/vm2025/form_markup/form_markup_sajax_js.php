  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_markup" == sTestField)
        {
...
?>
  ...
  // ---------- Validate titulo
  function do_ajax_form_markup_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_markup_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_markup_validate_titulo_cb);
  } // do_ajax_form_markup_validate_titulo

  function do_ajax_form_markup_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_markup_validate_titulo_cb

  // ---------- Validate aliquota
  function do_ajax_form_markup_validate_aliquota()
  {
    var nomeCampo_aliquota = "aliquota";
    var var_aliquota = scAjaxGetFieldText(nomeCampo_aliquota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_markup_validate_aliquota(var_aliquota, var_script_case_init, do_ajax_form_markup_validate_aliquota_cb);
  } // do_ajax_form_markup_validate_aliquota

  function do_ajax_form_markup_validate_aliquota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_markup_validate_aliquota_cb

  // ---------- Validate markup
  function do_ajax_form_markup_validate_markup()
  {
    var nomeCampo_markup = "markup";
    var var_markup = scAjaxGetFieldText(nomeCampo_markup);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_markup_validate_markup(var_markup, var_script_case_init, do_ajax_form_markup_validate_markup_cb);
  } // do_ajax_form_markup_validate_markup

  function do_ajax_form_markup_validate_markup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_markup_validate_markup_cb

  // ---------- Validate markupitems
  function do_ajax_form_markup_validate_markupitems()
  {
    var nomeCampo_markupitems = "markupitems";
    var var_markupitems = scAjaxGetFieldText(nomeCampo_markupitems);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_markup_validate_markupitems(var_markupitems, var_script_case_init, do_ajax_form_markup_validate_markupitems_cb);
  } // do_ajax_form_markup_validate_markupitems

  function do_ajax_form_markup_validate_markupitems_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_markup_validate_markupitems_cb

  // ---------- Event onchange aliquota
  function do_ajax_form_markup_event_aliquota_onchange()
  {
    var var_markup = scAjaxGetFieldText("markup");
    var var_aliquota = scAjaxGetFieldText("aliquota");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_markup_event_aliquota_onchange(var_markup, var_aliquota, var_script_case_init, do_ajax_form_markup_event_aliquota_onchange_cb);
  } // do_ajax_form_markup_event_aliquota_onchange

  function do_ajax_form_markup_event_aliquota_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "aliquota";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_markup_event_aliquota_onchange_cb_after_alert);
  } // do_ajax_form_markup_event_aliquota_onchange_cb
  function do_ajax_form_markup_event_aliquota_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_markup_event_aliquota_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_markup_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_markup_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_markup_submit_form(var_titulo, var_aliquota, var_markup, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_markup_submit_form_cb);
  } // do_ajax_form_markup_submit_form

  function do_ajax_form_markup_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_markup_submit_form_cb_after_alert);
  } // do_ajax_form_markup_submit_form_cb
  function do_ajax_form_markup_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_markup_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_markup_items"] = "off";

  function do_ajax_form_markup_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_markup_navigate_form, function() {});
    } else {
      perform_ajax_form_markup_navigate_form();
    }
  }

  function perform_ajax_form_markup_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_markup_items"] = "on";
    x_ajax_form_markup_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_markup_navigate_form_cb);
  } // do_ajax_form_markup_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_markup']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_markup_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_markup_items"] && "nmsc_iframe_liga_form_markup_items" != scMasterDetailIframe["nmsc_iframe_liga_form_markup_items"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_markup_items"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_markup_items').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_markup_items').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_markup_items').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_markup_navigate_form_cb_after_alert);
  } // do_ajax_form_markup_navigate_form_cb
  function do_ajax_form_markup_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_markup_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_markup_navigate_form_cb_after_alert

  function sc_hide_form_markup_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_markup_items"])
    {
      return true;
    }
    return false;
