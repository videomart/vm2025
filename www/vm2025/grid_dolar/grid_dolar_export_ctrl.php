<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dolar']['sc_process_barr'] = true;
require_once('../grid_dolar/index.php');
unset($_SESSION['scriptcase']['grid_dolar']['sc_process_barr']);
$ExportCtrl = new grid_dolar_export_control;
$ExportCtrl->Export_barr();

class grid_dolar_export_control
{
