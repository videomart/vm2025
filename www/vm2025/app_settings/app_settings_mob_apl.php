...
class app_settings_mob_apl
{
   ...
   var $auth_sn_fb;
   var $auth_sn_fb_1;
   var $auth_sn_fb_app_id;
   var $auth_sn_fb_secret;
   var $auth_sn_x;
   var $auth_sn_x_1;
   var $auth_sn_x_key;
   var $auth_sn_x_secret;
   var $auth_sn_google;
   var $auth_sn_google_1;
   var $auth_sn_google_client_id;
   var $auth_sn_google_secret;
   var $auth_sn_position;
   var $auth_sn_position_1;
   var $nm_data;
   var $nmgp_opcao;
   var $nmgp_opc_ant;
   var $sc_evento;
...
//----- 
   function ini_controle()
   {
      ...
      {
          if (isset($this->NM_ajax_info['param']['auth_sn_fb']))
          {
              $this->auth_sn_fb = $this->NM_ajax_info['param']['auth_sn_fb'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_fb_app_id']))
          {
              $this->auth_sn_fb_app_id = $this->NM_ajax_info['param']['auth_sn_fb_app_id'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_fb_secret']))
          {
              $this->auth_sn_fb_secret = $this->NM_ajax_info['param']['auth_sn_fb_secret'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_google']))
          {
              $this->auth_sn_google = $this->NM_ajax_info['param']['auth_sn_google'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_google_client_id']))
          {
              $this->auth_sn_google_client_id = $this->NM_ajax_info['param']['auth_sn_google_client_id'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_google_secret']))
          {
              $this->auth_sn_google_secret = $this->NM_ajax_info['param']['auth_sn_google_secret'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_position']))
          {
              $this->auth_sn_position = $this->NM_ajax_info['param']['auth_sn_position'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_x']))
          {
              $this->auth_sn_x = $this->NM_ajax_info['param']['auth_sn_x'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_x_key']))
          {
              $this->auth_sn_x_key = $this->NM_ajax_info['param']['auth_sn_x_key'];
          }
          if (isset($this->NM_ajax_info['param']['auth_sn_x_secret']))
          {
              $this->auth_sn_x_secret = $this->NM_ajax_info['param']['auth_sn_x_secret'];
          }
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['app_settings_mob']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['app_settings_mob']['opc_ant']);
          }
          if (isset($this->sett_smtp_api)) 
          {
              $_SESSION['sett_smtp_api'] = $this->sett_smtp_api;
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_auth_sn_position' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_position');
          }
          if ('validate_auth_sn_fb' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_fb');
          }
          if ('validate_auth_sn_fb_app_id' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_fb_app_id');
          }
          if ('validate_auth_sn_fb_secret' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_fb_secret');
          }
          if ('validate_auth_sn_x' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_x');
          }
          if ('validate_auth_sn_x_key' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_x_key');
          }
          if ('validate_auth_sn_x_secret' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_x_secret');
          }
          if ('validate_auth_sn_google' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_google');
          }
          if ('validate_auth_sn_google_client_id' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_google_client_id');
          }
          if ('validate_auth_sn_google_secret' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'auth_sn_google_secret');
          }
      ...
      {
          $this->nm_tira_formatacao();
          if ('event_auth_sn_fb_onclick' == $this->NM_ajax_opcao)
          {
              $this->auth_sn_fb_onClick();
          }
          if ('event_auth_sn_google_onclick' == $this->NM_ajax_opcao)
          {
              $this->auth_sn_google_onClick();
          }
          if ('event_auth_sn_x_onclick' == $this->NM_ajax_opcao)
          {
              $this->auth_sn_x_onClick();
          }
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (is_array($this->auth_sn_fb))
          {
              ...
              $this->auth_sn_fb = ""; 
              if ($this->auth_sn_fb_1 != "") 
              { 
                  foreach ($this->auth_sn_fb_1 as $dados_auth_sn_fb_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->auth_sn_fb .= ";";
                      } 
                      $this->auth_sn_fb .= $dados_auth_sn_fb_1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->auth_sn_x))
          {
              ...
              if ($this->auth_sn_x_1 != "") 
              { 
                  foreach ($this->auth_sn_x_1 as $dados_auth_sn_x_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->auth_sn_x .= ";";
                      } 
                      $this->auth_sn_x .= $dados_auth_sn_x_1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->auth_sn_google))
          {
              ...
              $this->auth_sn_google = ""; 
              if ($this->auth_sn_google_1 != "") 
              { 
                  foreach ($this->auth_sn_google_1 as $dados_auth_sn_google_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->auth_sn_google .= ";";
                      } 
                      $this->auth_sn_google .= $dados_auth_sn_google_1;
                      $x++ ; 
                  } 
              } 
          } 
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->auth_sn_fb = "" ;  
          $this->auth_sn_fb_app_id = "" ;  
          $this->auth_sn_fb_secret = "" ;  
          $this->auth_sn_x = "" ;  
          $this->auth_sn_x_key = "" ;  
          $this->auth_sn_x_secret = "" ;  
          $this->auth_sn_google = "" ;  
          $this->auth_sn_google_client_id = "" ;  
          $this->auth_sn_google_secret = "" ;  
          $this->auth_sn_position = "" ;  
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  ...
                  $theme = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][3]; 
                  $language = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][4]; 
                  $login_mode = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][5]; 
                  $captcha = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][6]; 
                  $pswd_last_updated = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][7]; 
                  $brute_force = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][8]; 
                  $brute_force_attempts = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][9]; 
                  $brute_force_time_block = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][10]; 
                  $retrieve_password = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][11]; 
                  $recover_pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][12]; 
                  $password_min = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][13]; 
                  $password_strength = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][14]; 
                  $group_administrator = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][15]; 
                  $enable_2fa = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][16]; 
                  $enable_2fa_expiration_time = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][17]; 
                  $enable_2fa_mode = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][18]; 
                  $enable_2fa_api_type = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][19]; 
                  $enable_2fa_api = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][20]; 
                  $mfa_last_updated = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][21]; 
                  $new_users = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][22]; 
                  $req_email_act = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][23]; 
                  $send_email_adm = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][24]; 
                  $group_default = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][25]; 
                  $smtp_api = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][26]; 
                  $smtp_server = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][27]; 
                  $smtp_port = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][28]; 
                  $smtp_security = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][29]; 
                  $smtp_user = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][30]; 
                  $smtp_pass = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][31]; 
                  $smtp_from_email = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][32]; 
                  $smtp_from_name = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][33]; 
                  $auth_sn_position = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][34]; 
                  $auth_sn_fb = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][35]; 
                  $auth_sn_fb_app_id = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][36]; 
                  $auth_sn_fb_secret = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][37]; 
                  $auth_sn_x = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][38]; 
                  $auth_sn_x_key = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][39]; 
                  $auth_sn_x_secret = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][40]; 
                  $auth_sn_google = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][41]; 
                  $auth_sn_google_client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][42]; 
                  $auth_sn_google_secret = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][43]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][3] = $this->theme; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][4] = $this->language; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][5] = $this->login_mode; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][6] = $this->captcha; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][7] = $this->pswd_last_updated; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][8] = $this->brute_force; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][9] = $this->brute_force_attempts; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][10] = $this->brute_force_time_block; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][11] = $this->retrieve_password; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][12] = $this->recover_pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][13] = $this->password_min; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][14] = $this->password_strength; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][15] = $this->group_administrator; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][16] = $this->enable_2fa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][17] = $this->enable_2fa_expiration_time; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][18] = $this->enable_2fa_mode; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][19] = $this->enable_2fa_api_type; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][20] = $this->enable_2fa_api; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][21] = $this->mfa_last_updated; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][22] = $this->new_users; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][23] = $this->req_email_act; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][24] = $this->send_email_adm; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][25] = $this->group_default; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][26] = $this->smtp_api; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][27] = $this->smtp_server; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][28] = $this->smtp_port; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][29] = $this->smtp_security; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][30] = $this->smtp_user; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][31] = $this->smtp_pass; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][32] = $this->smtp_from_email; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][33] = $this->smtp_from_name; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][34] = $this->auth_sn_position; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][35] = $this->auth_sn_fb; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][36] = $this->auth_sn_fb_app_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][37] = $this->auth_sn_fb_secret; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][38] = $this->auth_sn_x; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][39] = $this->auth_sn_x_key; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][40] = $this->auth_sn_x_secret; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][41] = $this->auth_sn_google; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][42] = $this->auth_sn_google_client_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['campos'][43] = $this->auth_sn_google_secret; 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'smtp_from_name':
               ...
               break;
           case 'auth_sn_position':
               return "" . $this->Ini->Nm_lang['lang_sec_set_sn_position'] . "";
               break;
           case 'auth_sn_fb':
               return "Facebook";
               break;
           case 'auth_sn_fb_app_id':
               return "APP ID";
               break;
           case 'auth_sn_fb_secret':
               return "Secret";
               break;
           case 'auth_sn_x':
               return "X (Twitter)";
           ...
           case 'auth_sn_x_key':
               return "Key";
               break;
           case 'auth_sn_x_secret':
               return "Secret";
               break;
           case 'auth_sn_google':
               return "Google";
               break;
           case 'auth_sn_google_client_id':
               return "Client ID";
               break;
           case 'auth_sn_google_secret':
               return "Secret";
               break;
       }
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_position' == $filtro)) || (is_array($filtro) && in_array('auth_sn_position', $filtro)))
        $this->ValidateField_auth_sn_position($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_fb' == $filtro)) || (is_array($filtro) && in_array('auth_sn_fb', $filtro)))
        $this->ValidateField_auth_sn_fb($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_fb_app_id' == $filtro)) || (is_array($filtro) && in_array('auth_sn_fb_app_id', $filtro)))
        $this->ValidateField_auth_sn_fb_app_id($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_fb_secret' == $filtro)) || (is_array($filtro) && in_array('auth_sn_fb_secret', $filtro)))
        $this->ValidateField_auth_sn_fb_secret($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_x' == $filtro)) || (is_array($filtro) && in_array('auth_sn_x', $filtro)))
        $this->ValidateField_auth_sn_x($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_x_key' == $filtro)) || (is_array($filtro) && in_array('auth_sn_x_key', $filtro)))
        $this->ValidateField_auth_sn_x_key($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_x_secret' == $filtro)) || (is_array($filtro) && in_array('auth_sn_x_secret', $filtro)))
        $this->ValidateField_auth_sn_x_secret($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_google' == $filtro)) || (is_array($filtro) && in_array('auth_sn_google', $filtro)))
        $this->ValidateField_auth_sn_google($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_google_client_id' == $filtro)) || (is_array($filtro) && in_array('auth_sn_google_client_id', $filtro)))
        $this->ValidateField_auth_sn_google_client_id($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'auth_sn_google_secret' == $filtro)) || (is_array($filtro) && in_array('auth_sn_google_secret', $filtro)))
        $this->ValidateField_auth_sn_google_secret($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
{
    $original_auth_sn_fb = $this->auth_sn_fb;
    $original_auth_sn_fb_app_id = $this->auth_sn_fb_app_id;
    $original_auth_sn_fb_secret = $this->auth_sn_fb_secret;
    $original_auth_sn_google = $this->auth_sn_google;
    $original_auth_sn_google_client_id = $this->auth_sn_google_client_id;
    $original_auth_sn_google_secret = $this->auth_sn_google_secret;
    $original_auth_sn_position = $this->auth_sn_position;
    $original_auth_sn_x = $this->auth_sn_x;
    $original_auth_sn_x_key = $this->auth_sn_x_key;
    $original_auth_sn_x_secret = $this->auth_sn_x_secret;
...
if(strpos($this->smtp_api , "css_api_obj_fld") !== false){
    $this->smtp_api  = '';
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_position )      . " WHERE set_name=". $this->Db->qstr('auth_sn_position'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_fb )      . " WHERE set_name=". $this->Db->qstr('auth_sn_fb'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_fb_app_id )      . " WHERE set_name=". $this->Db->qstr('auth_sn_fb_app_id'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_fb_secret )      . " WHERE set_name=". $this->Db->qstr('auth_sn_fb_secret'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_x )      . " WHERE set_name=". $this->Db->qstr('auth_sn_x'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_x_key )      . " WHERE set_name=". $this->Db->qstr('auth_sn_x_key'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_x_secret )      . " WHERE set_name=". $this->Db->qstr('auth_sn_x_secret'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_google )      . " WHERE set_name=". $this->Db->qstr('auth_sn_google'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_google_client_id )      . " WHERE set_name=". $this->Db->qstr('auth_sn_google_client_id'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = $sql . $this->Db->qstr($this->auth_sn_google_secret )      . " WHERE set_name=". $this->Db->qstr('auth_sn_google_secret'); 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_auth_sn_fb != $this->auth_sn_fb || (isset($bFlagRead_auth_sn_fb) && $bFlagRead_auth_sn_fb)))
    {
        $this->ajax_return_values_auth_sn_fb(true);
    }
    if (($original_auth_sn_fb_app_id != $this->auth_sn_fb_app_id || (isset($bFlagRead_auth_sn_fb_app_id) && $bFlagRead_auth_sn_fb_app_id)))
    {
        $this->ajax_return_values_auth_sn_fb_app_id(true);
    }
    if (($original_auth_sn_fb_secret != $this->auth_sn_fb_secret || (isset($bFlagRead_auth_sn_fb_secret) && $bFlagRead_auth_sn_fb_secret)))
    {
        $this->ajax_return_values_auth_sn_fb_secret(true);
    }
    if (($original_auth_sn_google != $this->auth_sn_google || (isset($bFlagRead_auth_sn_google) && $bFlagRead_auth_sn_google)))
    {
        $this->ajax_return_values_auth_sn_google(true);
    }
    if (($original_auth_sn_google_client_id != $this->auth_sn_google_client_id || (isset($bFlagRead_auth_sn_google_client_id) && $bFlagRead_auth_sn_google_client_id)))
    {
        $this->ajax_return_values_auth_sn_google_client_id(true);
    }
    if (($original_auth_sn_google_secret != $this->auth_sn_google_secret || (isset($bFlagRead_auth_sn_google_secret) && $bFlagRead_auth_sn_google_secret)))
    {
        $this->ajax_return_values_auth_sn_google_secret(true);
    }
    if (($original_auth_sn_position != $this->auth_sn_position || (isset($bFlagRead_auth_sn_position) && $bFlagRead_auth_sn_position)))
    {
        $this->ajax_return_values_auth_sn_position(true);
    }
    if (($original_auth_sn_x != $this->auth_sn_x || (isset($bFlagRead_auth_sn_x) && $bFlagRead_auth_sn_x)))
    {
        $this->ajax_return_values_auth_sn_x(true);
    }
    if (($original_auth_sn_x_key != $this->auth_sn_x_key || (isset($bFlagRead_auth_sn_x_key) && $bFlagRead_auth_sn_x_key)))
    {
        $this->ajax_return_values_auth_sn_x_key(true);
    }
    if (($original_auth_sn_x_secret != $this->auth_sn_x_secret || (isset($bFlagRead_auth_sn_x_secret) && $bFlagRead_auth_sn_x_secret)))
    {
        $this->ajax_return_values_auth_sn_x_secret(true);
    }
...
$_SESSION['scriptcase']['app_settings_mob']['contr_erro'] = 'off'; 
   ...
   if (isset($this->Field_no_validate['group_administrator'])) {
       return;
               ...
               if (!empty($this->group_administrator) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_group_administrator']) && !in_array($this->group_administrator, $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_group_administrator']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['enable_2fa_api_type'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_api_type']) && !in_array($this->enable_2fa_api_type, $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_api_type']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['group_default'])) {
       return;
               ...
               if (!empty($this->group_default) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_group_default']) && !in_array($this->group_default, $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_group_default']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['smtp_security'])) {
    ...
    function ValidateField_auth_sn_position(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['auth_sn_position'])) {
       return;
   }
      if ($this->auth_sn_position == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_position';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_position

    function ValidateField_auth_sn_fb(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['auth_sn_fb'])) {
       return;
   }
      if ($this->auth_sn_fb == "" && $this->nmgp_opcao != "excluir")
      { 
          $this->auth_sn_fb = "N";
      } 
      else 
      { 
          if (is_array($this->auth_sn_fb))
          {
              ...
              foreach ($this->auth_sn_fb as $ind => $dados_auth_sn_fb_1 ) 
              {
                  if ($dados_auth_sn_fb_1 != "") 
                  {
                      $this->auth_sn_fb_1[] = $dados_auth_sn_fb_1;
                  } 
              } 
              $this->auth_sn_fb = ""; 
              foreach ($this->auth_sn_fb_1 as $dados_auth_sn_fb_1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_fb';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_fb

    function ValidateField_auth_sn_fb_app_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['auth_sn_fb_app_id'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->auth_sn_fb_app_id) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "APP ID " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['auth_sn_fb_app_id']))
              {
                  $Campos_Erros['auth_sn_fb_app_id'] = array();
              }
              $Campos_Erros['auth_sn_fb_app_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['auth_sn_fb_app_id']) || !is_array($this->NM_ajax_info['errList']['auth_sn_fb_app_id']))
              {
                  $this->NM_ajax_info['errList']['auth_sn_fb_app_id'] = array();
              }
              $this->NM_ajax_info['errList']['auth_sn_fb_app_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_fb_app_id';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_fb_app_id

    function ValidateField_auth_sn_fb_secret(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['auth_sn_fb_secret'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->auth_sn_fb_secret) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Secret " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['auth_sn_fb_secret']))
              {
                  $Campos_Erros['auth_sn_fb_secret'] = array();
              }
              $Campos_Erros['auth_sn_fb_secret'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['auth_sn_fb_secret']) || !is_array($this->NM_ajax_info['errList']['auth_sn_fb_secret']))
              {
                  $this->NM_ajax_info['errList']['auth_sn_fb_secret'] = array();
              }
              $this->NM_ajax_info['errList']['auth_sn_fb_secret'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_fb_secret';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_fb_secret

    function ValidateField_auth_sn_x(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['auth_sn_x'])) {
       return;
   }
      if ($this->auth_sn_x == "" && $this->nmgp_opcao != "excluir")
      { 
          $this->auth_sn_x = "N";
      } 
      else 
      { 
          if (is_array($this->auth_sn_x))
          {
              ...
              foreach ($this->auth_sn_x as $ind => $dados_auth_sn_x_1 ) 
              {
                  if ($dados_auth_sn_x_1 != "") 
                  {
                      $this->auth_sn_x_1[] = $dados_auth_sn_x_1;
                  } 
              } 
              $this->auth_sn_x = ""; 
              foreach ($this->auth_sn_x_1 as $dados_auth_sn_x_1 ) 
    ...
    } // ValidateField_auth_sn_x

    function ValidateField_auth_sn_x_key(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['auth_sn_x_key'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->auth_sn_x_key) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Key " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['auth_sn_x_key']))
              {
                  $Campos_Erros['auth_sn_x_key'] = array();
              }
              $Campos_Erros['auth_sn_x_key'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['auth_sn_x_key']) || !is_array($this->NM_ajax_info['errList']['auth_sn_x_key']))
              {
                  $this->NM_ajax_info['errList']['auth_sn_x_key'] = array();
              }
              $this->NM_ajax_info['errList']['auth_sn_x_key'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_x_key';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_x_key

    function ValidateField_auth_sn_x_secret(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['auth_sn_x_secret'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->auth_sn_x_secret) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Secret " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['auth_sn_x_secret']))
              {
                  $Campos_Erros['auth_sn_x_secret'] = array();
              }
              $Campos_Erros['auth_sn_x_secret'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['auth_sn_x_secret']) || !is_array($this->NM_ajax_info['errList']['auth_sn_x_secret']))
              {
                  $this->NM_ajax_info['errList']['auth_sn_x_secret'] = array();
              }
              $this->NM_ajax_info['errList']['auth_sn_x_secret'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_x_secret';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_x_secret

    function ValidateField_auth_sn_google(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['auth_sn_google'])) {
       return;
   }
      if ($this->auth_sn_google == "" && $this->nmgp_opcao != "excluir")
      { 
      ...
      { 
          if (is_array($this->auth_sn_google))
          {
              ...
              foreach ($this->auth_sn_google as $ind => $dados_auth_sn_google_1 ) 
              {
                  if ($dados_auth_sn_google_1 != "") 
                  {
                      $this->auth_sn_google_1[] = $dados_auth_sn_google_1;
                  } 
              } 
              $this->auth_sn_google = ""; 
              foreach ($this->auth_sn_google_1 as $dados_auth_sn_google_1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_google';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_google

    function ValidateField_auth_sn_google_client_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['auth_sn_google_client_id'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->auth_sn_google_client_id) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Client ID " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['auth_sn_google_client_id']))
              {
                  $Campos_Erros['auth_sn_google_client_id'] = array();
              }
              $Campos_Erros['auth_sn_google_client_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['auth_sn_google_client_id']) || !is_array($this->NM_ajax_info['errList']['auth_sn_google_client_id']))
              {
                  $this->NM_ajax_info['errList']['auth_sn_google_client_id'] = array();
              }
              $this->NM_ajax_info['errList']['auth_sn_google_client_id'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_google_client_id';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_google_client_id

    function ValidateField_auth_sn_google_secret(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['auth_sn_google_secret'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->auth_sn_google_secret) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Secret " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['auth_sn_google_secret']))
              {
                  $Campos_Erros['auth_sn_google_secret'] = array();
              }
              $Campos_Erros['auth_sn_google_secret'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['auth_sn_google_secret']) || !is_array($this->NM_ajax_info['errList']['auth_sn_google_secret']))
              {
                  $this->NM_ajax_info['errList']['auth_sn_google_secret'] = array();
              }
              $this->NM_ajax_info['errList']['auth_sn_google_secret'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'auth_sn_google_secret';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_auth_sn_google_secret
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['auth_sn_position'] = $this->auth_sn_position;
    $this->nmgp_dados_form['auth_sn_fb'] = $this->auth_sn_fb;
    $this->nmgp_dados_form['auth_sn_fb_app_id'] = $this->auth_sn_fb_app_id;
    $this->nmgp_dados_form['auth_sn_fb_secret'] = $this->auth_sn_fb_secret;
    $this->nmgp_dados_form['auth_sn_x'] = $this->auth_sn_x;
    $this->nmgp_dados_form['auth_sn_x_key'] = $this->auth_sn_x_key;
    $this->nmgp_dados_form['auth_sn_x_secret'] = $this->auth_sn_x_secret;
    $this->nmgp_dados_form['auth_sn_google'] = $this->auth_sn_google;
    $this->nmgp_dados_form['auth_sn_google_client_id'] = $this->auth_sn_google_client_id;
    $this->nmgp_dados_form['auth_sn_google_secret'] = $this->auth_sn_google_secret;
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_auth_sn_position();
          $this->ajax_return_values_auth_sn_fb();
          $this->ajax_return_values_auth_sn_fb_app_id();
          $this->ajax_return_values_auth_sn_fb_secret();
          $this->ajax_return_values_auth_sn_x();
          $this->ajax_return_values_auth_sn_x_key();
          $this->ajax_return_values_auth_sn_x_secret();
          $this->ajax_return_values_auth_sn_google();
          $this->ajax_return_values_auth_sn_google_client_id();
          $this->ajax_return_values_auth_sn_google_secret();
...
$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_language'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['language']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('username') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_login_mode_user'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('email') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("E-mail")));
$aLookup[] = array(app_settings_mob_pack_protect_string('both') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_login_mode_both'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_login_mode'][] = 'username';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_login_mode'][] = 'email';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_login_mode'][] = 'both';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['login_mode']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_captcha'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['captcha']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('reset_send') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_reset_send'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('send_link') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_send_link'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_recover_pswd'][] = 'reset_send';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_recover_pswd'][] = 'send_link';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['recover_pswd']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('uppercase_letter') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_uppercase_letter'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('lowercase_letter') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_lowercase_letter'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('numbers') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_numbers'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('special_chars') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_special_chars'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_password_strength'][] = 'uppercase_letter';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_password_strength'][] = 'lowercase_letter';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_password_strength'][] = 'numbers';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_password_strength'][] = 'special_chars';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['password_strength']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(app_settings_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', app_settings_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['group_administrator']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('individual') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_2fa_individual'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('all') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_2fa_all'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_mode'][] = 'individual';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_mode'][] = 'all';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa_mode']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('email') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("E-mail")));
$aLookup[] = array(app_settings_mob_pack_protect_string('auth') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("Google Auth")));
$aLookup[] = array(app_settings_mob_pack_protect_string('sms') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("SMS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_api_type'][] = 'email';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_api_type'][] = 'auth';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_enable_2fa_api_type'][] = 'sms';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa_api_type']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_req_email_act'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['req_email_act']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_send_email_adm'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['send_email_adm']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_group_default'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['group_default']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_mob_pack_protect_string('ssl') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("SSL")));
$aLookup[] = array(app_settings_mob_pack_protect_string('tls') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("TLS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_smtp_security'][] = 'ssl';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_smtp_security'][] = 'tls';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['smtp_security']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_smtp_from_name($bForce = false)
   {
          ...
          //----- auth_sn_position
   function ajax_return_values_auth_sn_position($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_position", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_position);
              $aLookup = array();
              $this->_tmp_lookup_auth_sn_position = $this->auth_sn_position;

$aLookup[] = array(app_settings_mob_pack_protect_string('beside') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_buttons_beside'] . "")));
$aLookup[] = array(app_settings_mob_pack_protect_string('below') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_buttons_below'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_auth_sn_position'][] = 'beside';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_auth_sn_position'][] = 'below';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"auth_sn_position\"";
          if (isset($this->NM_ajax_info['select_html']['auth_sn_position']) && !empty($this->NM_ajax_info['select_html']['auth_sn_position']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['auth_sn_position']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->auth_sn_position == $sValue)
                  {
                      $this->_tmp_lookup_auth_sn_position = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['auth_sn_position'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['auth_sn_position']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['auth_sn_position']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['auth_sn_position']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['auth_sn_position']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['auth_sn_position']['labList'] = $aLabel;
          }
   }

          //----- auth_sn_fb
   function ajax_return_values_auth_sn_fb($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_fb", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_fb);
              $aLookup = array();
              $this->_tmp_lookup_auth_sn_fb = $this->auth_sn_fb;

$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_auth_sn_fb'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['auth_sn_fb']) && !empty($this->NM_ajax_info['select_html']['auth_sn_fb']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['auth_sn_fb']);
          }
          $this->NM_ajax_info['fldList']['auth_sn_fb'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => true,
               'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-auth_sn_fb',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['auth_sn_fb']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['auth_sn_fb']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['auth_sn_fb']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['auth_sn_fb']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['auth_sn_fb']['labList'] = $aLabel;
          }
   }

          //----- auth_sn_fb_app_id
   function ajax_return_values_auth_sn_fb_app_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_fb_app_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_fb_app_id);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['auth_sn_fb_app_id'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- auth_sn_fb_secret
   function ajax_return_values_auth_sn_fb_secret($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_fb_secret", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_fb_secret);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['auth_sn_fb_secret'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- auth_sn_x
   function ajax_return_values_auth_sn_x($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_x", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_x);
              $aLookup = array();
              $this->_tmp_lookup_auth_sn_x = $this->auth_sn_x;

$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_auth_sn_x'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['auth_sn_x']) && !empty($this->NM_ajax_info['select_html']['auth_sn_x']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['auth_sn_x']);
          }
          $this->NM_ajax_info['fldList']['auth_sn_x'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => true,
               'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-auth_sn_x',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['auth_sn_x']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['auth_sn_x']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['auth_sn_x']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['auth_sn_x']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['auth_sn_x']['labList'] = $aLabel;
          }
   }

          //----- auth_sn_x_key
   function ajax_return_values_auth_sn_x_key($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_x_key", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_x_key);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['auth_sn_x_key'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- auth_sn_x_secret
   function ajax_return_values_auth_sn_x_secret($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_x_secret", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_x_secret);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['auth_sn_x_secret'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
          ...
          //----- auth_sn_google
   function ajax_return_values_auth_sn_google($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_google", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_google);
              $aLookup = array();
              $this->_tmp_lookup_auth_sn_google = $this->auth_sn_google;

$aLookup[] = array(app_settings_mob_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings_mob']['Lookup_auth_sn_google'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['auth_sn_google']) && !empty($this->NM_ajax_info['select_html']['auth_sn_google']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['auth_sn_google']);
          }
          $this->NM_ajax_info['fldList']['auth_sn_google'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => true,
               'valList' => explode(';', $sTmpValue),
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-auth_sn_google',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['auth_sn_google']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['auth_sn_google']['valList'][$i] = app_settings_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['auth_sn_google']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['auth_sn_google']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['auth_sn_google']['labList'] = $aLabel;
          }
   }

          //----- auth_sn_google_client_id
   function ajax_return_values_auth_sn_google_client_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_google_client_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_google_client_id);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['auth_sn_google_client_id'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   function ajax_return_values_auth_sn_google_secret($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("auth_sn_google_secret", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->auth_sn_google_secret);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['auth_sn_google_secret'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
...
if( $this->auth_sn_fb  == 'Y' ){
	$this->nmgp_cmp_hidden["auth_sn_fb_app_id"] = 'on'; $this->NM_ajax_info['fieldDisplay']['auth_sn_fb_app_id'] = 'on';
	$this->nmgp_cmp_hidden["auth_sn_fb_secret"] = 'on'; $this->NM_ajax_info['fieldDisplay']['auth_sn_fb_secret'] = 'on';
}else{
	$this->nmgp_cmp_hidden["auth_sn_fb_app_id"] = 'off'; $this->NM_ajax_info['fieldDisplay']['auth_sn_fb_app_id'] = 'off';
	$this->nmgp_cmp_hidden["auth_sn_fb_secret"] = 'off'; $this->NM_ajax_info['fieldDisplay']['auth_sn_fb_secret'] = 'off';
}

$modificado_auth_sn_fb = $this->auth_sn_fb;
$modificado_auth_sn_fb_app_id = $this->auth_sn_fb_app_id;
$modificado_auth_sn_fb_secret = $this->auth_sn_fb_secret;
$this->nm_formatar_campos('auth_sn_fb', 'auth_sn_fb_app_id', 'auth_sn_fb_secret');
if ($original_auth_sn_fb !== $modificado_auth_sn_fb || isset($this->nmgp_cmp_readonly['auth_sn_fb']) || (isset($bFlagRead_auth_sn_fb) && $bFlagRead_auth_sn_fb))
{
    $this->ajax_return_values_auth_sn_fb(true);
}
if ($original_auth_sn_fb_app_id !== $modificado_auth_sn_fb_app_id || isset($this->nmgp_cmp_readonly['auth_sn_fb_app_id']) || (isset($bFlagRead_auth_sn_fb_app_id) && $bFlagRead_auth_sn_fb_app_id))
{
    $this->ajax_return_values_auth_sn_fb_app_id(true);
}
if ($original_auth_sn_fb_secret !== $modificado_auth_sn_fb_secret || isset($this->nmgp_cmp_readonly['auth_sn_fb_secret']) || (isset($bFlagRead_auth_sn_fb_secret) && $bFlagRead_auth_sn_fb_secret))
{
    $this->ajax_return_values_auth_sn_fb_secret(true);
}
$this->NM_ajax_info['event_field'] = 'auth';
app_settings_mob_pack_ajax_response();
exit;
$_SESSION['scriptcase']['app_settings_mob']['contr_erro'] = 'off';
}
function auth_sn_google_onClick()
{
$_SESSION['scriptcase']['app_settings_mob']['contr_erro'] = 'on';
...
if( $this->auth_sn_google  == 'Y' ){
	$this->nmgp_cmp_hidden["auth_sn_google_client_id"] = 'on'; $this->NM_ajax_info['fieldDisplay']['auth_sn_google_client_id'] = 'on';
	$this->nmgp_cmp_hidden["auth_sn_google_secret"] = 'on'; $this->NM_ajax_info['fieldDisplay']['auth_sn_google_secret'] = 'on';
}else{
	$this->nmgp_cmp_hidden["auth_sn_google_client_id"] = 'off'; $this->NM_ajax_info['fieldDisplay']['auth_sn_google_client_id'] = 'off';
	$this->nmgp_cmp_hidden["auth_sn_google_secret"] = 'off'; $this->NM_ajax_info['fieldDisplay']['auth_sn_google_secret'] = 'off';
}

$modificado_auth_sn_google = $this->auth_sn_google;
$modificado_auth_sn_google_client_id = $this->auth_sn_google_client_id;
$modificado_auth_sn_google_secret = $this->auth_sn_google_secret;
$this->nm_formatar_campos('auth_sn_google', 'auth_sn_google_client_id', 'auth_sn_google_secret');
if ($original_auth_sn_google !== $modificado_auth_sn_google || isset($this->nmgp_cmp_readonly['auth_sn_google']) || (isset($bFlagRead_auth_sn_google) && $bFlagRead_auth_sn_google))
{
    $this->ajax_return_values_auth_sn_google(true);
}
if ($original_auth_sn_google_client_id !== $modificado_auth_sn_google_client_id || isset($this->nmgp_cmp_readonly['auth_sn_google_client_id']) || (isset($bFlagRead_auth_sn_google_client_id) && $bFlagRead_auth_sn_google_client_id))
{
    $this->ajax_return_values_auth_sn_google_client_id(true);
}
if ($original_auth_sn_google_secret !== $modificado_auth_sn_google_secret || isset($this->nmgp_cmp_readonly['auth_sn_google_secret']) || (isset($bFlagRead_auth_sn_google_secret) && $bFlagRead_auth_sn_google_secret))
{
    $this->ajax_return_values_auth_sn_google_secret(true);
}
$this->NM_ajax_info['event_field'] = 'auth';
...
if( $this->auth_sn_x  == 'Y' ){
	$this->nmgp_cmp_hidden["auth_sn_x_key"] = 'on'; $this->NM_ajax_info['fieldDisplay']['auth_sn_x_key'] = 'on';
	$this->nmgp_cmp_hidden["auth_sn_x_secret"] = 'on'; $this->NM_ajax_info['fieldDisplay']['auth_sn_x_secret'] = 'on';
}else{
	$this->nmgp_cmp_hidden["auth_sn_x_key"] = 'off'; $this->NM_ajax_info['fieldDisplay']['auth_sn_x_key'] = 'off';
	$this->nmgp_cmp_hidden["auth_sn_x_secret"] = 'off'; $this->NM_ajax_info['fieldDisplay']['auth_sn_x_secret'] = 'off';
}

$modificado_auth_sn_x = $this->auth_sn_x;
$modificado_auth_sn_x_key = $this->auth_sn_x_key;
$modificado_auth_sn_x_secret = $this->auth_sn_x_secret;
$this->nm_formatar_campos('auth_sn_x', 'auth_sn_x_key', 'auth_sn_x_secret');
if ($original_auth_sn_x !== $modificado_auth_sn_x || isset($this->nmgp_cmp_readonly['auth_sn_x']) || (isset($bFlagRead_auth_sn_x) && $bFlagRead_auth_sn_x))
{
    $this->ajax_return_values_auth_sn_x(true);
}
if ($original_auth_sn_x_key !== $modificado_auth_sn_x_key || isset($this->nmgp_cmp_readonly['auth_sn_x_key']) || (isset($bFlagRead_auth_sn_x_key) && $bFlagRead_auth_sn_x_key))
{
    $this->ajax_return_values_auth_sn_x_key(true);
}
if ($original_auth_sn_x_secret !== $modificado_auth_sn_x_secret || isset($this->nmgp_cmp_readonly['auth_sn_x_secret']) || (isset($bFlagRead_auth_sn_x_secret) && $bFlagRead_auth_sn_x_secret))
{
    $this->ajax_return_values_auth_sn_x_secret(true);
}
$this->NM_ajax_info['event_field'] = 'auth';
...
$api_smtp_field = "<select name='smtp_api' class='sc-js-input css_smtp_api_obj css_api_obj_fld sc-ui-100perc-input scFormObjectOdd' style='width:100%' onchange='$(\"input[name=smtp_api]\").val(this.value);do_ajax_app_settings_event_smtp_api_onchange();'>";
...
else
{
   ...
   function Form_lookup_auth_sn_position()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_sec_opt_buttons_beside'] . "?#?beside?#?N?@?";
       $nmgp_def_dados .= "" . $this->Ini->Nm_lang['lang_sec_opt_buttons_below'] . "?#?below?#?N?@?";
       $todo = explode("?@?", $nmgp_def_dados);
       return $todo;

   }
   function Form_lookup_auth_sn_fb()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "?#?Y?#?N?@?";
       $todo = explode("?@?", $nmgp_def_dados);
   ...
   function Form_lookup_auth_sn_x()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "?#?Y?#?N?@?";
       $todo = explode("?@?", $nmgp_def_dados);
   ...
   function Form_lookup_auth_sn_google()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "?#?Y?#?N?@?";
       $todo = explode("?@?", $nmgp_def_dados);
