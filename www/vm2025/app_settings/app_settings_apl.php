...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->Refresh_aba_menu)) {
          $_SESSION['sc_session'][$script_case_init]['app_settings']['Refresh_aba_menu'] = $this->Refresh_aba_menu;
      }
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['app_settings']['opc_ant']);
          }
          if (isset($this->sett_smtp_api)) 
          {
              $_SESSION['sett_smtp_api'] = $this->sett_smtp_api;
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  ...
                  $theme = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][3]; 
                  $language = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][4]; 
                  $login_mode = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][5]; 
                  $captcha = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][6]; 
                  $pswd_last_updated = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][7]; 
                  $brute_force = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][8]; 
                  $brute_force_attempts = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][9]; 
                  $brute_force_time_block = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][10]; 
                  $retrieve_password = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][11]; 
                  $recover_pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][12]; 
                  $password_min = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][13]; 
                  $password_strength = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][14]; 
                  $group_administrator = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][15]; 
                  $enable_2fa = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][16]; 
                  $enable_2fa_expiration_time = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][17]; 
                  $enable_2fa_mode = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][18]; 
                  $enable_2fa_api_type = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][19]; 
                  $enable_2fa_api = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][20]; 
                  $mfa_last_updated = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][21]; 
                  $new_users = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][22]; 
                  $req_email_act = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][23]; 
                  $send_email_adm = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][24]; 
                  $group_default = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][25]; 
                  $smtp_api = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][26]; 
                  $smtp_server = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][27]; 
                  $smtp_port = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][28]; 
                  $smtp_security = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][29]; 
                  $smtp_user = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][30]; 
                  $smtp_pass = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][31]; 
                  $smtp_from_email = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][32]; 
                  $smtp_from_name = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][33]; 
                  $auth_sn_position = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][34]; 
                  $auth_sn_fb = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][35]; 
                  $auth_sn_fb_app_id = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][36]; 
                  $auth_sn_fb_secret = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][37]; 
                  $auth_sn_x = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][38]; 
                  $auth_sn_x_key = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][39]; 
                  $auth_sn_x_secret = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][40]; 
                  $auth_sn_google = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][41]; 
                  $auth_sn_google_client_id = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][42]; 
                  $auth_sn_google_secret = $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][43]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][3] = $this->theme; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][4] = $this->language; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][5] = $this->login_mode; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][6] = $this->captcha; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][7] = $this->pswd_last_updated; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][8] = $this->brute_force; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][9] = $this->brute_force_attempts; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][10] = $this->brute_force_time_block; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][11] = $this->retrieve_password; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][12] = $this->recover_pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][13] = $this->password_min; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][14] = $this->password_strength; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][15] = $this->group_administrator; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][16] = $this->enable_2fa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][17] = $this->enable_2fa_expiration_time; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][18] = $this->enable_2fa_mode; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][19] = $this->enable_2fa_api_type; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][20] = $this->enable_2fa_api; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][21] = $this->mfa_last_updated; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][22] = $this->new_users; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][23] = $this->req_email_act; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][24] = $this->send_email_adm; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][25] = $this->group_default; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][26] = $this->smtp_api; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][27] = $this->smtp_server; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][28] = $this->smtp_port; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][29] = $this->smtp_security; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][30] = $this->smtp_user; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][31] = $this->smtp_pass; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][32] = $this->smtp_from_email; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][33] = $this->smtp_from_name; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][34] = $this->auth_sn_position; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][35] = $this->auth_sn_fb; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][36] = $this->auth_sn_fb_app_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][37] = $this->auth_sn_fb_secret; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][38] = $this->auth_sn_x; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][39] = $this->auth_sn_x_key; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][40] = $this->auth_sn_x_secret; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][41] = $this->auth_sn_google; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][42] = $this->auth_sn_google_client_id; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['campos'][43] = $this->auth_sn_google_secret; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
...
$_SESSION['scriptcase']['app_settings']['contr_erro'] = 'off'; 
   ...
   if (isset($this->Field_no_validate['group_administrator'])) {
       return;
               ...
               if (!empty($this->group_administrator) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_group_administrator']) && !in_array($this->group_administrator, $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_group_administrator']))
               {
                   $hasError = true;
   ...
   if (isset($this->Field_no_validate['enable_2fa_api_type'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_api_type']) && !in_array($this->enable_2fa_api_type, $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_api_type']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   if (isset($this->Field_no_validate['group_default'])) {
       return;
               ...
               if (!empty($this->group_default) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_group_default']) && !in_array($this->group_default, $_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_group_default']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_language'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['language']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('username') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_login_mode_user'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('email') => str_replace('<', '&lt;',app_settings_pack_protect_string("E-mail")));
$aLookup[] = array(app_settings_pack_protect_string('both') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_login_mode_both'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_login_mode'][] = 'username';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_login_mode'][] = 'email';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_login_mode'][] = 'both';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['login_mode']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_captcha'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['captcha']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('reset_send') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_reset_send'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('send_link') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_send_link'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_recover_pswd'][] = 'reset_send';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_recover_pswd'][] = 'send_link';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['recover_pswd']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('uppercase_letter') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_uppercase_letter'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('lowercase_letter') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_lowercase_letter'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('numbers') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_numbers'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('special_chars') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_ps_special_chars'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_password_strength'][] = 'uppercase_letter';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_password_strength'][] = 'lowercase_letter';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_password_strength'][] = 'numbers';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_password_strength'][] = 'special_chars';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['password_strength']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(app_settings_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', app_settings_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['group_administrator']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('individual') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_2fa_individual'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('all') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_2fa_all'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_mode'][] = 'individual';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_mode'][] = 'all';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa_mode']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('email') => str_replace('<', '&lt;',app_settings_pack_protect_string("E-mail")));
$aLookup[] = array(app_settings_pack_protect_string('auth') => str_replace('<', '&lt;',app_settings_pack_protect_string("Google Auth")));
$aLookup[] = array(app_settings_pack_protect_string('sms') => str_replace('<', '&lt;',app_settings_pack_protect_string("SMS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_api_type'][] = 'email';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_api_type'][] = 'auth';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_enable_2fa_api_type'][] = 'sms';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa_api_type']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_req_email_act'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['req_email_act']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_send_email_adm'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['send_email_adm']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('') => str_replace('<', '&lt;',app_settings_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_group_default'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['group_default']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('ssl') => str_replace('<', '&lt;',app_settings_pack_protect_string("SSL")));
$aLookup[] = array(app_settings_pack_protect_string('tls') => str_replace('<', '&lt;',app_settings_pack_protect_string("TLS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_smtp_security'][] = 'ssl';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_smtp_security'][] = 'tls';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['smtp_security']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('beside') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_buttons_beside'] . "")));
$aLookup[] = array(app_settings_pack_protect_string('below') => str_replace('<', '&lt;',app_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_opt_buttons_below'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_auth_sn_position'][] = 'beside';
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_auth_sn_position'][] = 'below';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['auth_sn_position']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_auth_sn_fb'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['auth_sn_fb']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_auth_sn_x'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['auth_sn_x']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(app_settings_pack_protect_string('Y') => str_replace('<', '&lt;',app_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['app_settings']['Lookup_auth_sn_google'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['auth_sn_google']['valList'][$i] = app_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
