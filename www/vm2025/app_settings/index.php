...
//
   ...
   $_SESSION['scriptcase']['app_settings']['glo_nm_perfil']          = "vmdata_con";
...
/*NM*/            $_SESSION['scriptcase']['app_settings']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 2, $this->force_db_utf8); 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_settings']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_settings']['session_timeout']['redir']))
    {
        ...
        if ('ajax_app_settings_validate_theme' == $_POST['rs'])
        {
            $theme = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_language' == $_POST['rs'])
        {
            $language = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_login_mode' == $_POST['rs'])
        {
            $login_mode = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_captcha' == $_POST['rs'])
        {
            $captcha = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_pswd_last_updated' == $_POST['rs'])
        {
        ...
        if ('ajax_app_settings_validate_recover_pswd' == $_POST['rs'])
        {
            $recover_pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_password_min' == $_POST['rs'])
        {
            $password_min = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_password_strength' == $_POST['rs'])
        {
            $password_strength = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_group_administrator' == $_POST['rs'])
        {
        ...
        if ('ajax_app_settings_validate_enable_2fa_mode' == $_POST['rs'])
        {
            $enable_2fa_mode = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_enable_2fa_api_type' == $_POST['rs'])
        {
            $enable_2fa_api_type = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_enable_2fa_api' == $_POST['rs'])
        {
            $enable_2fa_api = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_mfa_last_updated' == $_POST['rs'])
        {
        ...
        if ('ajax_app_settings_validate_req_email_act' == $_POST['rs'])
        {
            $req_email_act = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_send_email_adm' == $_POST['rs'])
        {
            $send_email_adm = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_group_default' == $_POST['rs'])
        {
            $group_default = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_api' == $_POST['rs'])
        {
            $smtp_api = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_server' == $_POST['rs'])
        {
            $smtp_server = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_port' == $_POST['rs'])
        {
            $smtp_port = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_security' == $_POST['rs'])
        {
            $smtp_security = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_user' == $_POST['rs'])
        {
            $smtp_user = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_pass' == $_POST['rs'])
        {
            $smtp_pass = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_from_email' == $_POST['rs'])
        {
            $smtp_from_email = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_smtp_from_name' == $_POST['rs'])
        {
            $smtp_from_name = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_position' == $_POST['rs'])
        {
            $auth_sn_position = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_fb' == $_POST['rs'])
        {
            $auth_sn_fb = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_fb_app_id' == $_POST['rs'])
        {
            $auth_sn_fb_app_id = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_fb_secret' == $_POST['rs'])
        {
            $auth_sn_fb_secret = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_x' == $_POST['rs'])
        {
            $auth_sn_x = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_x_key' == $_POST['rs'])
        {
            $auth_sn_x_key = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_x_secret' == $_POST['rs'])
        {
            $auth_sn_x_secret = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_google' == $_POST['rs'])
        {
            $auth_sn_google = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_google_client_id' == $_POST['rs'])
        {
            $auth_sn_google_client_id = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_validate_auth_sn_google_secret' == $_POST['rs'])
        {
            $auth_sn_google_secret = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_app_settings_event_auth_sn_fb_onclick' == $_POST['rs'])
        {
            $auth_sn_fb = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_app_settings_event_auth_sn_google_onclick' == $_POST['rs'])
        {
            $auth_sn_google = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_app_settings_event_auth_sn_x_onclick' == $_POST['rs'])
        {
            $auth_sn_x = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_app_settings_event_enable_2fa_api_type_onclick' == $_POST['rs'])
        {
            $enable_2fa_api_type = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_app_settings_event_retrieve_password_onclick' == $_POST['rs'])
        {
            $retrieve_password = NM_utf8_urldecode($_POST['rsargs'][0]);
            $recover_pswd = NM_utf8_urldecode($_POST['rsargs'][1]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][2]);
        }
        if ('ajax_app_settings_event_smtp_api_onchange' == $_POST['rs'])
        {
            $smtp_api = NM_utf8_urldecode($_POST['rsargs'][0]);
    ...
    else
    {
        ...
        if (isset($_POST["sett_smtp_api"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_api']);
        }
        ...
        if (isset($_POST["sett_smtp"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp']);
        }
        ...
        if (isset($_POST["sett_smtp_server"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_server']);
        }
        ...
        if (isset($_POST["sett_smtp_security"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_security']);
        }
        ...
        if (isset($_POST["sett_smtp_port"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_port']);
        }
        ...
        if (isset($_POST["sett_smtp_user"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_user']);
        }
        ...
        if (isset($_POST["sett_smtp_pass"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_pass']);
        }
        ...
        if (isset($_POST["sett_smtp_from_email"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_from_email']);
        }
        ...
        if (isset($_POST["sett_smtp_from_name"])) 
        {
            ...
            nm_limpa_str_app_settings($_SESSION['sett_smtp_from_name']);
        }
...
<?php
    ...
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['language'] = " onClick=\"\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['login_mode'] = "class=\"sc-js-input scFormObjectOdd css_login_mode_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_login_mode\" name=\"login_mode\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['captcha'] = " onClick=\"\" ";
    ...
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['retrieve_password'] = " onClick=\"do_ajax_app_settings_event_retrieve_password_onclick();\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['recover_pswd'] = "class=\"sc-js-input scFormObjectOdd css_recover_pswd_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_recover_pswd\" name=\"recover_pswd\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['password_strength'] = " onClick=\"\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['group_administrator'] = "class=\"sc-js-input scFormObjectOdd css_group_administrator_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_group_administrator\" name=\"group_administrator\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    ...
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['enable_2fa_mode'] = "class=\"sc-js-input scFormObjectOdd css_enable_2fa_mode_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_enable_2fa_mode\" name=\"enable_2fa_mode\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['enable_2fa_api_type'] = " onClick=\"do_ajax_app_settings_event_enable_2fa_api_type_onclick();\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['new_users'] = " onClick=\"\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['req_email_act'] = " onClick=\"\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['send_email_adm'] = " onClick=\"\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['group_default'] = "class=\"sc-js-input scFormObjectOdd css_group_default_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_group_default\" name=\"group_default\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['smtp_security'] = "class=\"sc-js-input scFormObjectOdd css_smtp_security_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_smtp_security\" name=\"smtp_security\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['auth_sn_position'] = "class=\"sc-js-input scFormObjectOdd css_auth_sn_position_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_auth_sn_position\" name=\"auth_sn_position\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['auth_sn_fb'] = " onClick=\"do_ajax_app_settings_event_auth_sn_fb_onclick();\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['auth_sn_x'] = " onClick=\"do_ajax_app_settings_event_auth_sn_x_onclick();\" ";
    $inicial_app_settings->contr_app_settings->NM_ajax_info['select_html']['auth_sn_google'] = " onClick=\"do_ajax_app_settings_event_auth_sn_google_onclick();\" ";
    ...
    sajax_export("ajax_app_settings_validate_theme");
    sajax_export("ajax_app_settings_validate_language");
    sajax_export("ajax_app_settings_validate_login_mode");
    sajax_export("ajax_app_settings_validate_captcha");
    sajax_export("ajax_app_settings_validate_pswd_last_updated");
    ...
    sajax_export("ajax_app_settings_validate_recover_pswd");
    sajax_export("ajax_app_settings_validate_password_min");
    sajax_export("ajax_app_settings_validate_password_strength");
    sajax_export("ajax_app_settings_validate_group_administrator");
    sajax_export("ajax_app_settings_validate_enable_2fa");
    sajax_export("ajax_app_settings_validate_enable_2fa_expiration_time");
    sajax_export("ajax_app_settings_validate_enable_2fa_mode");
    sajax_export("ajax_app_settings_validate_enable_2fa_api_type");
    sajax_export("ajax_app_settings_validate_enable_2fa_api");
    sajax_export("ajax_app_settings_validate_mfa_last_updated");
    sajax_export("ajax_app_settings_validate_new_users");
    sajax_export("ajax_app_settings_validate_req_email_act");
    sajax_export("ajax_app_settings_validate_send_email_adm");
    sajax_export("ajax_app_settings_validate_group_default");
    sajax_export("ajax_app_settings_validate_smtp_api");
    sajax_export("ajax_app_settings_validate_smtp_server");
    sajax_export("ajax_app_settings_validate_smtp_port");
    sajax_export("ajax_app_settings_validate_smtp_security");
    sajax_export("ajax_app_settings_validate_smtp_user");
    sajax_export("ajax_app_settings_validate_smtp_pass");
    sajax_export("ajax_app_settings_validate_smtp_from_email");
    sajax_export("ajax_app_settings_validate_smtp_from_name");
    sajax_export("ajax_app_settings_validate_auth_sn_position");
    sajax_export("ajax_app_settings_validate_auth_sn_fb");
    sajax_export("ajax_app_settings_validate_auth_sn_fb_app_id");
    sajax_export("ajax_app_settings_validate_auth_sn_fb_secret");
    sajax_export("ajax_app_settings_validate_auth_sn_x");
    sajax_export("ajax_app_settings_validate_auth_sn_x_key");
    sajax_export("ajax_app_settings_validate_auth_sn_x_secret");
    sajax_export("ajax_app_settings_validate_auth_sn_google");
    sajax_export("ajax_app_settings_validate_auth_sn_google_client_id");
    sajax_export("ajax_app_settings_validate_auth_sn_google_secret");
    sajax_export("ajax_app_settings_event_auth_sn_fb_onclick");
    sajax_export("ajax_app_settings_event_auth_sn_google_onclick");
    sajax_export("ajax_app_settings_event_auth_sn_x_onclick");
    sajax_export("ajax_app_settings_event_brute_force_onclick");
    sajax_export("ajax_app_settings_event_enable_2fa_api_type_onclick");
    sajax_export("ajax_app_settings_event_enable_2fa_onclick");
    sajax_export("ajax_app_settings_event_remember_me_onclick");
    sajax_export("ajax_app_settings_event_retrieve_password_onclick");
    sajax_export("ajax_app_settings_event_smtp_api_onchange");
...
//
    ...
    function ajax_app_settings_validate_theme($theme, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_theme';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_language($language, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_language';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_login_mode($login_mode, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_login_mode';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_captcha($captcha, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_captcha';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_pswd_last_updated($pswd_last_updated, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_pswd_last_updated';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_recover_pswd($recover_pswd, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_recover_pswd';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_password_min($password_min, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_password_min';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_password_strength($password_strength, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_password_strength';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_group_administrator($group_administrator, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_group_administrator';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_enable_2fa_mode($enable_2fa_mode, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_enable_2fa_mode';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_enable_2fa_api_type($enable_2fa_api_type, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_enable_2fa_api_type';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_enable_2fa_api($enable_2fa_api, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_enable_2fa_api';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_mfa_last_updated($mfa_last_updated, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_mfa_last_updated';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_req_email_act($req_email_act, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_req_email_act';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_send_email_adm($send_email_adm, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_send_email_adm';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_group_default($group_default, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_group_default';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_api($smtp_api, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_api';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_server($smtp_server, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_server';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_port($smtp_port, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_port';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_security($smtp_security, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_security';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_user($smtp_user, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_user';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_pass($smtp_pass, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_pass';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_from_email($smtp_from_email, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_from_email';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_smtp_from_name($smtp_from_name, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_smtp_from_name';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_position($auth_sn_position, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_position';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_fb($auth_sn_fb, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_fb';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_fb_app_id($auth_sn_fb_app_id, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_fb_app_id';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_fb_secret($auth_sn_fb_secret, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_fb_secret';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_x($auth_sn_x, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_x';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_x_key($auth_sn_x_key, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_x_key';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_x_secret($auth_sn_x_secret, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_x_secret';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_google($auth_sn_google, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_google';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_google_client_id($auth_sn_google_client_id, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_google_client_id';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_validate_auth_sn_google_secret($auth_sn_google_secret, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'validate_auth_sn_google_secret';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
    ...
    function ajax_app_settings_event_auth_sn_fb_onclick($auth_sn_fb, $auth_sn_fb_app_id, $auth_sn_fb_secret, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'event_auth_sn_fb_onclick';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
                  'auth_sn_fb' => NM_utf8_urldecode($auth_sn_fb),
                  'auth_sn_fb_app_id' => NM_utf8_urldecode($auth_sn_fb_app_id),
                  'auth_sn_fb_secret' => NM_utf8_urldecode($auth_sn_fb_secret),
    ...
    function ajax_app_settings_event_auth_sn_google_onclick($auth_sn_google, $auth_sn_google_client_id, $auth_sn_google_secret, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'event_auth_sn_google_onclick';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
                  'auth_sn_google' => NM_utf8_urldecode($auth_sn_google),
                  'auth_sn_google_client_id' => NM_utf8_urldecode($auth_sn_google_client_id),
                  'auth_sn_google_secret' => NM_utf8_urldecode($auth_sn_google_secret),
    ...
    function ajax_app_settings_event_auth_sn_x_onclick($auth_sn_x, $auth_sn_x_key, $auth_sn_x_secret, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'event_auth_sn_x_onclick';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
                  'auth_sn_x' => NM_utf8_urldecode($auth_sn_x),
                  'auth_sn_x_key' => NM_utf8_urldecode($auth_sn_x_key),
                  'auth_sn_x_secret' => NM_utf8_urldecode($auth_sn_x_secret),
    ...
    function ajax_app_settings_event_enable_2fa_api_type_onclick($enable_2fa_api_type, $enable_2fa_api, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'event_enable_2fa_api_type_onclick';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
                  'enable_2fa_api_type' => NM_utf8_urldecode($enable_2fa_api_type),
                  'enable_2fa_api' => NM_utf8_urldecode($enable_2fa_api),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_app_settings_event_enable_2fa_onclick($enable_2fa, $enable_2fa_expiration_time, $enable_2fa_mode, $enable_2fa_api, $enable_2fa_api_type, $mfa_last_updated, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
    ...
    function ajax_app_settings_event_retrieve_password_onclick($retrieve_password, $recover_pswd, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'event_retrieve_password_onclick';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
                  'retrieve_password' => NM_utf8_urldecode($retrieve_password),
                  'recover_pswd' => NM_utf8_urldecode($recover_pswd),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
    ...
    function ajax_app_settings_event_smtp_api_onchange($smtp_api, $smtp_server, $smtp_port, $smtp_security, $smtp_user, $smtp_pass, $smtp_from_email, $smtp_from_name, $script_case_init)
    {
        global $inicial_app_settings;
        //register_shutdown_function("app_settings_pack_ajax_response");
        $inicial_app_settings->contr_app_settings->NM_ajax_flag          = true;
        $inicial_app_settings->contr_app_settings->NM_ajax_opcao         = 'event_smtp_api_onchange';
        $inicial_app_settings->contr_app_settings->NM_ajax_info['param'] = array(
                  'smtp_api' => NM_utf8_urldecode($smtp_api),
                  'smtp_server' => NM_utf8_urldecode($smtp_server),
                  'smtp_port' => NM_utf8_urldecode($smtp_port),
