<?php
   ...
   session_start();
    ...
    $exportEmail = new exportEmail_consulta_fatura(); 
   
class exportEmail_consulta_fatura
{
    ...
    function exportEmailSend()
    {
        ...
        $arr_cc   = array();
        $arr_bcc  = array();
        $arr_cc  = SC_Mail_Address_array_api("comercial@videomart.com.br", 'cc');
...
<HEAD>
 <TITLE><?php echo "" . sprintf($this->Nm_lang['lang_othr_grid_title'], '') . " proposta"; ?></TITLE>
...
?>
            ...
            function html_export_email_send()
            {
                $.ajax({
                    type: 'POST',
                    url: 'consulta_fatura_export_email.php',
    ...
    <tr>
     <td style="vertical-align: top">
       ...
       <div id='id_body_exportemail' class='scExportEmailTable'>
           ...
           <div id='id_div_export_email_subject' class='scExportEmailDiv'><span class='scExportEmailLabel'><?php echo $this->Nm_lang['lang_othr_grid_export_email_subject']; ?></span><br /><input id="id_html_export_email_subject" name="html_export_email_subject" size=70 class='scExportEmailInput' value="<?php echo "" . sprintf($this->Nm_lang['lang_export_email_subject'], '') . " proposta "; ?>" type="text"><br /></div>
