<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['consulta_fatura']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new consulta_fatura_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class consulta_fatura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["id"] : "ID";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["cliente"] : "Cliente";
   $tab_ger_campos['atencao'] = "on";
   $tab_def_campos['atencao'] = "atencao";
   $tab_labels["atencao"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["atencao"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["atencao"] : "Atencao";
   $tab_ger_campos['natureza'] = "on";
   $tab_def_campos['natureza'] = "natureza";
   $tab_labels["natureza"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["natureza"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["natureza"] : "Natureza";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["email"] : "Email";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "data";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["data"] : "Data";
   $tab_ger_campos['telefone'] = "on";
   $tab_def_campos['telefone'] = "telefone";
   $tab_labels["telefone"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["telefone"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["telefone"] : "Telefone";
   $tab_ger_campos['cod_vend'] = "on";
   $tab_def_campos['cod_vend'] = "cod_vend";
   $tab_labels["cod_vend"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["cod_vend"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["cod_vend"] : "Cod Vend";
   $tab_ger_campos['previsao'] = "on";
   $tab_def_campos['previsao'] = "previsao";
   $tab_labels["previsao"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["previsao"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["previsao"] : "Previsao";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["total"] : "Total";
   $tab_ger_campos['desconto'] = "on";
   $tab_def_campos['desconto'] = "desconto";
   $tab_labels["desconto"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["desconto"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["desconto"] : "Desconto";
   $tab_ger_campos['condpag'] = "on";
   $tab_def_campos['condpag'] = "condpag";
   $tab_labels["condpag"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["condpag"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["condpag"] : "Condpag";
   $tab_ger_campos['obs'] = "on";
   $tab_def_campos['obs'] = "obs";
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["obs"] : "Obs";
   $tab_ger_campos['header'] = "on";
   $tab_def_campos['header'] = "HEADER";
   $tab_labels["header"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["header"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["header"] : "HEADER";
   $tab_ger_campos['transportadora'] = "on";
   $tab_def_campos['transportadora'] = "TRANSPORTADORA";
   $tab_labels["transportadora"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["transportadora"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["transportadora"] : "TRANSPORTADORA";
   $tab_ger_campos['local_entrega'] = "on";
   $tab_def_campos['local_entrega'] = "LOCAL_ENTREGA";
   $tab_labels["local_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["local_entrega"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["local_entrega"] : "LOCAL ENTREGA";
   $tab_ger_campos['itenspedido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['itenspedido'] = "ItensPedido";
   }
   else
   {
       $tab_def_campos['itenspedido'] = "";
   }
   $tab_labels["itenspedido"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["itenspedido"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["itenspedido"] : "ItensPedido";
   $tab_ger_campos['valor_desconto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['valor_desconto'] = "Valor_Desconto";
   }
   else
   {
       $tab_def_campos['valor_desconto'] = "";
   }
   $tab_labels["valor_desconto"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["valor_desconto"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["valor_desconto"] : "Valor_Desconto";
   ...
   $tab_labels["cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["cnpj"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["cnpj"] : "CNPJ";
   $tab_ger_campos['endereco_vm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['endereco_vm'] = "Endereco_VM";
   }
   else
   {
       $tab_def_campos['endereco_vm'] = "";
   }
   $tab_labels["endereco_vm"]   = (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["endereco_vm"])) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['labels']["endereco_vm"] : "Endereco_VM";
   $tab_ger_campos['id'] = "none";
   $tab_ger_campos['condpag'] = "none";
   $tab_ger_campos['obs'] = "none";
   $tab_ger_campos['header'] = "none";
   $tab_ger_campos['local_entrega'] = "none";
   $tab_ger_campos['itenspedido'] = "none";
   $tab_ger_campos['valor_desconto'] = "none";
   $tab_ger_campos['cnpj'] = "none";
   $tab_ger_campos['endereco_vm'] = "none";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['consulta_fatura']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['consulta_fatura']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['consulta_fatura']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['consulta_fatura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['consulta_fatura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> proposta</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "consulta_fatura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['consulta_fatura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
