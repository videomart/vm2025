...
function actionBar_isValidState($buttonName, $buttonState)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "consulta_fatura/consulta_fatura_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "consulta_fatura_res_xls.class.php");
              $this->Res_xls = new consulta_fatura_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_consulta_fatura.zip";
          $this->Arquivo   .= "_consulta_fatura" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['consulta_fatura']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['consulta_fatura']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_previsao()
   {
         ...
         if (is_numeric($this->previsao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->previsao);
         $this->Xls_col++;
   }
   //----- total
   ...
   function NM_export_desconto()
   {
         ...
         if (is_numeric($this->desconto))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->desconto);
         $this->Xls_col++;
   }
   //----- condpag
   ...
   function NM_export_local_entrega()
   {
      ...
      if (!empty($this->local_entrega))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->local_entrega, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->local_entrega, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- itenspedido
   function NM_export_itenspedido()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->itenspedido, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->itenspedido, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- valor_desconto
   function NM_export_valor_desconto()
   {
         ...
         if (is_numeric($this->valor_desconto))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_desconto);
         $this->Xls_col++;
   }
   //----- cnpj
   ...
   function NM_export_endereco_vm()
   {
      ...
      if (!empty($this->endereco_vm))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->endereco_vm, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->endereco_vm, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- id
   ...
   //----- previsao
   function NM_sub_cons_previsao()
   {
         $this->previsao = NM_charset_to_utf8($this->previsao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->previsao;
   ...
   //----- desconto
   function NM_sub_cons_desconto()
   {
         $this->desconto = NM_charset_to_utf8($this->desconto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->desconto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- local_entrega
   function NM_sub_cons_local_entrega()
   {
      if (!empty($this->local_entrega))
      {
         if ($this->local_entrega !== "&nbsp;") 
         ...
         $this->local_entrega = strip_tags($this->local_entrega);
         $this->local_entrega = NM_charset_to_utf8($this->local_entrega);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->local_entrega;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- itenspedido
   function NM_sub_cons_itenspedido()
   {
         $this->itenspedido = html_entity_decode($this->itenspedido, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->itenspedido = strip_tags($this->itenspedido);
         $this->itenspedido = NM_charset_to_utf8($this->itenspedido);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->itenspedido;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- valor_desconto
   function NM_sub_cons_valor_desconto()
   {
         $this->valor_desconto = NM_charset_to_utf8($this->valor_desconto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_desconto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- endereco_vm
   function NM_sub_cons_endereco_vm()
   {
      if (!empty($this->endereco_vm))
      {
         if ($this->endereco_vm !== "&nbsp;") 
         ...
         $this->endereco_vm = strip_tags($this->endereco_vm);
         $this->endereco_vm = NM_charset_to_utf8($this->endereco_vm);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->endereco_vm;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['consulta_fatura']['nolabel'])
       {
