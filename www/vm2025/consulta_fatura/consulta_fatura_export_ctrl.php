<?php
@session_start() ;
$_SESSION['scriptcase']['consulta_fatura']['sc_process_barr'] = true;
require_once('../consulta_fatura/index.php');
unset($_SESSION['scriptcase']['consulta_fatura']['sc_process_barr']);
$ExportCtrl = new consulta_fatura_export_control;
$ExportCtrl->Export_barr();

class consulta_fatura_export_control
{
