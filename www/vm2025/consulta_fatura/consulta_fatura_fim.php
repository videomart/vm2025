...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____consulta_fatura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____consulta_fatura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['consulta_fatura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['consulta_fatura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['embutida_filho'] as $ind => $sc_init)
          {
