...
session_start();
    ...
    $SC_cod_proj = "VM2025";
    $SC_apl_proc = "consulta_fatura";
    $SC_ver_93   = true;
    $SC_conf_opt = explode(",","tem_res_cons,cor_imp,papel,orientacao,bookmarks,tem_res_res,pdf_compacted,page_break");
/* sc_apl_default */
...
<form name="config_pdf" method="post">
    ...
    <table id="main_table" class="exportConfig"
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['consulta_fatura']['summarizing_drill_down']);
        $isAnalitic = isset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['consulta_fatura']['graf_opc_atual'];

        if ($ver_93 == "n") {
            $sDisplay = !isset($_SESSION['sc_session']['consulta_fatura']['show_skip_charts_option']) ||
            !$_SESSION['sc_session']['consulta_fatura']['show_skip_charts_option'] ||
            (isset($_SESSION['sc_session'][$script_case_init]['consulta_fatura']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['consulta_fatura']['SC_Ind_Groupby']) ||
            $isMultiSeriesChart ||
            $isAnalitic ||
            ($opc == 'pdf_det')
                ? ' style="display: none"' : '';
        ...
        {
        $sDisplay =
//                    !isset($_SESSION['sc_session']['consulta_fatura']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['consulta_fatura']['show_skip_charts_option'] ||
            $isMultiSeriesChart ||
            $isAnalitic ||
