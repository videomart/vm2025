...
//
   ...
   $_SESSION['scriptcase']['app_Login']['glo_nm_perfil']          = "vmdata_con";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
/*NM*/            $_SESSION['scriptcase']['app_Login']['glo_nm_perfil'] = $NM_con_dest;
      ...
      {
          db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 2, $this->force_db_utf8); 
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'VM2025', 1, $this->force_db_utf8);
    }
    else {
...
;
	...
	else if($this->rs[0][1] == 'Y')
	{
      ...
      { 
		...
		if(!empty($picture)){
			...
			file_put_contents($this->root . $path_img, $picture_data);
		...
		if(empty($this->sc_temp_usr_picture) && !empty($this->rs[0][8])){
			if(substr($this->rs[0][8], 0, 5) != 'http:' && substr($this->rs[0][8], 0, 6) != 'https:'){
				$path_img = $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] .'/sc_img_'. $this->sc_temp_usr_login . hash("md5",date('YmdHis')) . '.png';
				file_put_contents($this->root . $path_img, $this->rs[0][8]);
				$this->sc_temp_usr_picture = $path_img;
			}
			else{
 ...
 {
$this->nmgp_redireciona_form($this->path_link . "" . SC_dir_app_name('app_control_2fa') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };
				}
			}
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->path_link . "" . SC_dir_app_name('app_add_2fa') . "/", $this->nm_location, "redir_menu?#?" . NM_encode_input("1") . "?@?", "_self", "ret_self", 440, 630);
 };
			}
...
if (!isset($this->sc_temp_usr_login)) {$this->sc_temp_usr_login = (isset($_SESSION['usr_login'])) ? $_SESSION['usr_login'] : "";}
	...
	if(!empty($picture)){
		...
		file_put_contents($this->root . $picture, $picture_data);
...
if (is_file("../_lib/_app_data/app_Login_ini.php")) {
    ...
    fclose ($SC_arq_def);
    setcookie('sc_apl_default_VM2025','app_Login, $this->sc_temp_sett_session_expire','0','/', '', ini_get('session.cookie_secure'), ini_get('session.cookie_httponly'));
}
;
        }
...
$databaseType = strtolower($this->nm_tpbanco);
$nm_bases_lob_geral = array_merge(
    $this->nm_bases_oracle, 
    $this->nm_bases_ibase, 
    $this->nm_bases_informix, 
    $this->nm_bases_mysql, 
    $this->nm_bases_access, 
    $this->nm_bases_sqlite, 
    $this->nm_bases_db2,
	$this->nm_bases_postgres,
    ['pdo_sqlsrv']
);

if (in_array($databaseType, $this->nm_bases_access)) {
...
} elseif (in_array($databaseType, $this->nm_bases_mssql) && $databaseType !== "pdo_sqlsrv") {
    if (!empty($img_val) && $img_val !== 'null' && substr($img_val, 0, 4) !== "*nm*") {
        $img_val = "*nm*" . base64_encode($img_val);
    }
...
$temp_img = "''";
if ($img_val === "" && in_array($databaseType, $this->nm_bases_access)) {
    $temp_img = "null";
} elseif (!in_array($databaseType, $nm_bases_lob_geral)) {
    $temp_img = "'" . $img_val . "'";
    ...
    $temp_img = "''";
} elseif (in_array($databaseType, $this->nm_bases_informix)) {
    $temp_img = "null";
} elseif (!in_array($databaseType, array_merge($this->nm_bases_sqlite, $this->nm_bases_postgres))) {
    $temp_img = "empty_blob()";
}
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_VM2025.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_VM2025'])) {
                $_SESSION['scriptcase']['app_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_VM2025'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['app_Login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_app_Login_validate_language' == $_POST['rs'])
        {
    ...
    { 
        ...
        if (isset($sett_auth_sn_fb)) 
        {
            $_SESSION['sett_auth_sn_fb'] = $sett_auth_sn_fb;
        }
        if (isset($sett_auth_sn_x)) 
        {
            $_SESSION['sett_auth_sn_x'] = $sett_auth_sn_x;
        }
        if (isset($sett_auth_sn_google)) 
        {
            $_SESSION['sett_auth_sn_google'] = $sett_auth_sn_google;
        }
        if (isset($sett_auth_sn_position)) 
        {
            $_SESSION['sett_auth_sn_position'] = $sett_auth_sn_position;
        }
        if (isset($sett_auth_sn_fb_app_id)) 
        {
            $_SESSION['sett_auth_sn_fb_app_id'] = $sett_auth_sn_fb_app_id;
        }
        if (isset($sett_auth_sn_fb_secret)) 
        {
            $_SESSION['sett_auth_sn_fb_secret'] = $sett_auth_sn_fb_secret;
        }
        if (isset($sett_auth_sn_x_key)) 
        {
            $_SESSION['sett_auth_sn_x_key'] = $sett_auth_sn_x_key;
        }
        if (isset($sett_auth_sn_x_secret)) 
        {
            $_SESSION['sett_auth_sn_x_secret'] = $sett_auth_sn_x_secret;
        }
        if (isset($sett_auth_sn_google_client_id)) 
        {
            $_SESSION['sett_auth_sn_google_client_id'] = $sett_auth_sn_google_client_id;
        }
        if (isset($sett_auth_sn_google_secret)) 
        {
            $_SESSION['sett_auth_sn_google_secret'] = $sett_auth_sn_google_secret;
        }
    } 
    ...
    else
    {
        ...
        if (isset($_POST["usr_phone"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['usr_phone']);
        }
        ...
        if (isset($_POST["usr_picture"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['usr_picture']);
        }
        ...
        if (isset($_POST["usr_groups"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['usr_groups']);
        }
        ...
        if (isset($_POST["sett_group_administrator"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_group_administrator']);
        }
        ...
        if (isset($_POST["sett_mfa_last_updated"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_mfa_last_updated']);
        }
        ...
        if (isset($_POST["sett_enable_2fa_mode"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_enable_2fa_mode']);
        }
        ...
        if (isset($_POST["sett_group_default"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_group_default']);
        }
        ...
        if (isset($_POST["sett_smtp_api"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_api']);
        }
        ...
        if (isset($_POST["sett_smtp"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp']);
        }
        ...
        if (isset($_POST["sett_smtp_server"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_server']);
        }
        ...
        if (isset($_POST["sett_smtp_security"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_security']);
        }
        ...
        if (isset($_POST["sett_smtp_port"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_port']);
        }
        ...
        if (isset($_POST["sett_smtp_user"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_user']);
        }
        ...
        if (isset($_POST["sett_smtp_pass"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_pass']);
        }
        ...
        if (isset($_POST["sett_smtp_from_email"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_from_email']);
        }
        ...
        if (isset($_POST["sett_smtp_from_name"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_smtp_from_name']);
        }
        ...
        if (isset($_POST["sett_theme"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_theme']);
        }
        ...
        if (isset($_POST["sett_captcha"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_captcha']);
        }
        ...
        if (isset($_POST["return_msg_email_act"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['return_msg_email_act']);
        }
        ...
        if (isset($_POST["sett_language"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_language']);
        }
        ...
        if (isset($_POST["sett_login_mode"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_login_mode']);
        }
        ...
        if (isset($_POST["sett_pswd_last_updated"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['sett_pswd_last_updated']);
        }
        ...
        if (isset($_POST["google_photo"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['google_photo']);
        }
        ...
        if (isset($_POST["sett_auth_sn_fb"])) 
        {
            $_SESSION['sett_auth_sn_fb'] = $_POST["sett_auth_sn_fb"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_fb']);
        }
        if (isset($_GET["sett_auth_sn_fb"])) 
        {
            $_SESSION['sett_auth_sn_fb'] = $_GET["sett_auth_sn_fb"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_fb']);
        }
        if (isset($_POST["sett_auth_sn_x"])) 
        {
            $_SESSION['sett_auth_sn_x'] = $_POST["sett_auth_sn_x"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_x']);
        }
        if (isset($_GET["sett_auth_sn_x"])) 
        {
            $_SESSION['sett_auth_sn_x'] = $_GET["sett_auth_sn_x"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_x']);
        }
        if (isset($_POST["sett_auth_sn_google"])) 
        {
            $_SESSION['sett_auth_sn_google'] = $_POST["sett_auth_sn_google"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_google']);
        }
        if (isset($_GET["sett_auth_sn_google"])) 
        {
            $_SESSION['sett_auth_sn_google'] = $_GET["sett_auth_sn_google"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_google']);
        }
        if (isset($_POST["sett_auth_sn_position"])) 
        {
            $_SESSION['sett_auth_sn_position'] = $_POST["sett_auth_sn_position"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_position']);
        }
        if (isset($_GET["sett_auth_sn_position"])) 
        {
            $_SESSION['sett_auth_sn_position'] = $_GET["sett_auth_sn_position"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_position']);
        }
        if (isset($_POST["sett_auth_sn_fb_app_id"])) 
        {
            $_SESSION['sett_auth_sn_fb_app_id'] = $_POST["sett_auth_sn_fb_app_id"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_fb_app_id']);
        }
        if (isset($_GET["sett_auth_sn_fb_app_id"])) 
        {
            $_SESSION['sett_auth_sn_fb_app_id'] = $_GET["sett_auth_sn_fb_app_id"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_fb_app_id']);
        }
        if (isset($_POST["sett_auth_sn_fb_secret"])) 
        {
            $_SESSION['sett_auth_sn_fb_secret'] = $_POST["sett_auth_sn_fb_secret"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_fb_secret']);
        }
        if (isset($_GET["sett_auth_sn_fb_secret"])) 
        {
            $_SESSION['sett_auth_sn_fb_secret'] = $_GET["sett_auth_sn_fb_secret"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_fb_secret']);
        }
        if (isset($_POST["sett_auth_sn_x_key"])) 
        {
            $_SESSION['sett_auth_sn_x_key'] = $_POST["sett_auth_sn_x_key"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_x_key']);
        }
        if (isset($_GET["sett_auth_sn_x_key"])) 
        {
            $_SESSION['sett_auth_sn_x_key'] = $_GET["sett_auth_sn_x_key"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_x_key']);
        }
        if (isset($_POST["sett_auth_sn_x_secret"])) 
        {
            $_SESSION['sett_auth_sn_x_secret'] = $_POST["sett_auth_sn_x_secret"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_x_secret']);
        }
        if (isset($_GET["sett_auth_sn_x_secret"])) 
        {
            $_SESSION['sett_auth_sn_x_secret'] = $_GET["sett_auth_sn_x_secret"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_x_secret']);
        }
        if (isset($_POST["sett_auth_sn_google_client_id"])) 
        {
            $_SESSION['sett_auth_sn_google_client_id'] = $_POST["sett_auth_sn_google_client_id"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_google_client_id']);
        }
        if (isset($_GET["sett_auth_sn_google_client_id"])) 
        {
            $_SESSION['sett_auth_sn_google_client_id'] = $_GET["sett_auth_sn_google_client_id"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_google_client_id']);
        }
        if (isset($_POST["sett_auth_sn_google_secret"])) 
        {
            $_SESSION['sett_auth_sn_google_secret'] = $_POST["sett_auth_sn_google_secret"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_google_secret']);
        }
        if (isset($_GET["sett_auth_sn_google_secret"])) 
        {
            $_SESSION['sett_auth_sn_google_secret'] = $_GET["sett_auth_sn_google_secret"];
            nm_limpa_str_app_Login($_SESSION['sett_auth_sn_google_secret']);
        }
    ...
    $inicial_app_Login->contr_app_Login->NM_ajax_info['select_html']['language'] = "id=\"id_sc_field_language\" class=\"sc-js-input scFormObjectOdd\" name=\"language\" alt=\"{type: 'select', enterTab: false}\" onChange=\"document.F1.nmgp_opcao.value='change_lang_f'; setLocale(this); document.F1.submit(); return false\"";
    ...
    sajax_export("ajax_app_Login_validate_language");
...
//
    ...
    function ajax_app_Login_validate_language($language, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'validate_language';
        $inicial_app_Login->contr_app_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_app_Login_submit_form($login, $pswd, $remember_me, $new_user, $retrieve_pswd, $language, $new_user_sc_target_name, $retrieve_pswd_sc_target_name, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $captcha_code, $captcha_sent, $csrf_token, $bok)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
