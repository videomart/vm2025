   ...
   function ini_controle()
   {
      ...
      { 
          ...
          if (isset($this->sc_redir_insert))
          {
              ...
              unset($_SESSION['sc_session'][$script_case_init]['app_Login']['opc_ant']);
          }
          if (isset($this->facebook_error_code)) 
          {
              $_SESSION['facebook_error_code'] = $this->facebook_error_code;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['csrf_token']) && $this->scCsrfGetToken() != $this->csrf_token)
     {
          $this->Campos_Mens_erro .= (empty($this->Campos_Mens_erro)) ? "" : "<br />";
