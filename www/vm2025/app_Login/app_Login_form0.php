...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_disabled']['facebook']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_disabled']['facebook']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['facebook']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['facebook']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['facebook'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_disabled']['google']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_disabled']['google']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['google']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['google']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['google'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "bgoogle", "scBtnFn_sys_auth_google()", "scBtnFn_sys_auth_google()", "bgoogle_b", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "", '', '', '', '', '', '', '', '', "");?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_disabled']['twitter']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_disabled']['twitter']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['twitter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['twitter']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login']['btn_label']['twitter'];
        }
?>
...
<script type="text/javascript">
        ...
        function scBtnFn_sys_auth_facebook() {
                if ($("#bfacebook_b.sc-unique-btn-2").length && $("#bfacebook_b.sc-unique-btn-2").is(":visible")) {
                    if ($("#bfacebook_b.sc-unique-btn-2").hasClass("disabled")) {
                        return;
                    }
                        sc_facebook_auth()
                         return;
        ...
        function scBtnFn_sys_auth_google() {
                if ($("#bgoogle_b.sc-unique-btn-3").length && $("#bgoogle_b.sc-unique-btn-3").is(":visible")) {
                    if ($("#bgoogle_b.sc-unique-btn-3").hasClass("disabled")) {
                        return;
                    }
                        sc_google_auth()
                         return;
        ...
        function scBtnFn_sys_auth_twitter() {
                if ($("#btwitter_b.sc-unique-btn-4").length && $("#btwitter_b.sc-unique-btn-4").is(":visible")) {
                    if ($("#btwitter_b.sc-unique-btn-4").hasClass("disabled")) {
                        return;
                    }
                        sc_twitter_auth()
                         return;
