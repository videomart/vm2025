...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____app_Login"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____app_Login"]);
   }
   ...
   if ((isset($nmgp_parms) && $nmgp_parms == "glo_menu") || $fecha_janela)
   {
       ...
       else
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['app_Login']['Refresh_aba_menu']) && !empty($_SESSION['sc_session'][$script_case_init]['app_Login']['Refresh_aba_menu'])) {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['app_Login']['Refresh_aba_menu'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['app_Login']['Refresh_aba_menu']);
