...
?>
  ...
  // ---------- Validate language
  function do_ajax_app_Login_validate_language()
  {
    var nomeCampo_language = "language";
    var var_language = scAjaxGetFieldText(nomeCampo_language);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_validate_language(var_language, var_script_case_init, do_ajax_app_Login_validate_language_cb);
  } // do_ajax_app_Login_validate_language

  function do_ajax_app_Login_validate_language_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_language_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    x_ajax_app_Login_submit_form(var_login, var_pswd, var_remember_me, var_new_user, var_retrieve_pswd, var_language, var_new_user_sc_target_name, var_retrieve_pswd_sc_target_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_captcha_sent, var_csrf_token, var_bok, do_ajax_app_Login_submit_form_cb);
