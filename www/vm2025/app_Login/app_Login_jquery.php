...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_language' + iSeqRow).bind('blur', function() { sc_app_Login_language_onblur('#id_sc_field_language' + iSeqRow, iSeqRow) })
                                      .bind('change', function() { sc_app_Login_language_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_app_Login_language_onfocus(this, iSeqRow) });
...
function sc_app_Login_language_onblur(oThis, iSeqRow) {
  do_ajax_app_Login_validate_language();
  scCssBlur(oThis);
}

function sc_app_Login_language_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_app_Login_language_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
