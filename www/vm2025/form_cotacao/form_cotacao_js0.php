...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cotacao']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_cotacao']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_cotacao"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_Email_Cotacao = false;
function sc_btn_Email_Cotacao()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Email_Cotacao(); }, 500);
      return;
    }
    if (Crtl_btn_Email_Cotacao) {return;}
    sc_btn_Email_Cotacao_ok();
}
function sc_btn_Email_Cotacao_cancel()
{
}
function sc_btn_Email_Cotacao_ok()
{
    Crtl_btn_Email_Cotacao = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?Email_Cotacao?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cotacao']['where_detal']))
  {
?>  
