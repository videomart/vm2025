  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cotacao_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_empresa
  function do_ajax_form_cotacao_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldSelect(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cotacao_mob_validate_id_empresa_cb);
  } // do_ajax_form_cotacao_mob_validate_id_empresa

  function do_ajax_form_cotacao_mob_validate_id_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_id_empresa_cb

  // ---------- Validate atencao
  function do_ajax_form_cotacao_mob_validate_atencao()
  {
    var nomeCampo_atencao = "atencao";
    var var_atencao = scAjaxGetFieldText(nomeCampo_atencao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_atencao(var_atencao, var_script_case_init, do_ajax_form_cotacao_mob_validate_atencao_cb);
  } // do_ajax_form_cotacao_mob_validate_atencao

  function do_ajax_form_cotacao_mob_validate_atencao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_atencao_cb

  // ---------- Validate comprador
  function do_ajax_form_cotacao_mob_validate_comprador()
  {
    var nomeCampo_comprador = "comprador";
    var var_comprador = scAjaxGetFieldText(nomeCampo_comprador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_comprador(var_comprador, var_script_case_init, do_ajax_form_cotacao_mob_validate_comprador_cb);
  } // do_ajax_form_cotacao_mob_validate_comprador

  function do_ajax_form_cotacao_mob_validate_comprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_comprador_cb

  // ---------- Validate emaildealer
  function do_ajax_form_cotacao_mob_validate_emaildealer()
  {
    var nomeCampo_emaildealer = "emaildealer";
    var var_emaildealer = scAjaxGetFieldCheckbox(nomeCampo_emaildealer, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_emaildealer(var_emaildealer, var_script_case_init, do_ajax_form_cotacao_mob_validate_emaildealer_cb);
  } // do_ajax_form_cotacao_mob_validate_emaildealer

  function do_ajax_form_cotacao_mob_validate_emaildealer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "emaildealer";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_emaildealer_cb

  // ---------- Validate ordernumb
  function do_ajax_form_cotacao_mob_validate_ordernumb()
  {
    var nomeCampo_ordernumb = "ordernumb";
    var var_ordernumb = scAjaxGetFieldHidden(nomeCampo_ordernumb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_ordernumb(var_ordernumb, var_script_case_init, do_ajax_form_cotacao_mob_validate_ordernumb_cb);
  } // do_ajax_form_cotacao_mob_validate_ordernumb

  function do_ajax_form_cotacao_mob_validate_ordernumb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "ordernumb";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_ordernumb_cb

  // ---------- Validate moeda
  function do_ajax_form_cotacao_mob_validate_moeda()
  {
    var nomeCampo_moeda = "moeda";
    var var_moeda = scAjaxGetFieldRadio(nomeCampo_moeda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_moeda(var_moeda, var_script_case_init, do_ajax_form_cotacao_mob_validate_moeda_cb);
  } // do_ajax_form_cotacao_mob_validate_moeda

  function do_ajax_form_cotacao_mob_validate_moeda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_moeda_cb

  // ---------- Validate data
  function do_ajax_form_cotacao_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_data(var_data, var_script_case_init, do_ajax_form_cotacao_mob_validate_data_cb);
  } // do_ajax_form_cotacao_mob_validate_data

  function do_ajax_form_cotacao_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_data_cb

  // ---------- Validate natureza
  function do_ajax_form_cotacao_mob_validate_natureza()
  {
    var nomeCampo_natureza = "natureza";
    var var_natureza = scAjaxGetFieldRadio(nomeCampo_natureza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_natureza(var_natureza, var_script_case_init, do_ajax_form_cotacao_mob_validate_natureza_cb);
  } // do_ajax_form_cotacao_mob_validate_natureza

  function do_ajax_form_cotacao_mob_validate_natureza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_natureza_cb

  // ---------- Validate obs
  function do_ajax_form_cotacao_mob_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldText(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_obs(var_obs, var_script_case_init, do_ajax_form_cotacao_mob_validate_obs_cb);
  } // do_ajax_form_cotacao_mob_validate_obs

  function do_ajax_form_cotacao_mob_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_obs_cb

  // ---------- Validate itenscompra
  function do_ajax_form_cotacao_mob_validate_itenscompra()
  {
    var nomeCampo_itenscompra = "itenscompra";
    var var_itenscompra = scAjaxGetFieldText(nomeCampo_itenscompra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cotacao_mob_validate_itenscompra(var_itenscompra, var_script_case_init, do_ajax_form_cotacao_mob_validate_itenscompra_cb);
  } // do_ajax_form_cotacao_mob_validate_itenscompra

  function do_ajax_form_cotacao_mob_validate_itenscompra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxClearErrors();
    scAjaxRedir();
    sFieldValid = "itenscompra";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cotacao_mob_validate_itenscompra_cb

  // ---------- Event onblur id_empresa
  function do_ajax_form_cotacao_mob_event_id_empresa_onblur()
  {
    var var_id_empresa = scAjaxGetFieldSelect("id_empresa");
    var var_atencao = scAjaxGetFieldText("atencao");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cotacao_mob_event_id_empresa_onblur(var_id_empresa, var_atencao, var_script_case_init, do_ajax_form_cotacao_mob_event_id_empresa_onblur_cb);
  } // do_ajax_form_cotacao_mob_event_id_empresa_onblur

  function do_ajax_form_cotacao_mob_event_id_empresa_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cotacao_mob_event_id_empresa_onblur_cb_after_alert);
  } // do_ajax_form_cotacao_mob_event_id_empresa_onblur_cb
  function do_ajax_form_cotacao_mob_event_id_empresa_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cotacao_mob_event_id_empresa_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cotacao_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cotacao_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_empresa = scAjaxGetFieldSelect("id_empresa");
    var var_atencao = scAjaxGetFieldText("atencao");
    var var_comprador = scAjaxGetFieldText("comprador");
    var var_emaildealer = scAjaxGetFieldCheckbox("emaildealer", ";");
    var var_ordernumb = scAjaxGetFieldHidden("ordernumb");
    var var_moeda = scAjaxGetFieldRadio("moeda");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cotacao_mob_submit_form(var_id_empresa, var_atencao, var_comprador, var_emaildealer, var_ordernumb, var_moeda, var_data, var_natureza, var_obs, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cotacao_mob_submit_form_cb);
  } // do_ajax_form_cotacao_mob_submit_form

  function do_ajax_form_cotacao_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("emaildealer");
      scAjaxHideErrorDisplay("ordernumb");
      scAjaxHideErrorDisplay("moeda");
      scAjaxHideErrorDisplay("data");
      scAjaxHideErrorDisplay("natureza");
      scAjaxHideErrorDisplay("obs");
      scAjaxHideErrorDisplay("itenscompra");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cotacao_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cotacao_mob_submit_form_cb
  function do_ajax_form_cotacao_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cotacao_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_itcotcompra_mob"] = "off";

  function do_ajax_form_cotacao_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cotacao_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_cotacao_mob_navigate_form();
    }
  }

  function perform_ajax_form_cotacao_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_itcotcompra_mob"] = "on";
    x_ajax_form_cotacao_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cotacao_mob_navigate_form_cb);
  } // do_ajax_form_cotacao_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cotacao_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cotacao_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_itcotcompra_mob"] && "nmsc_iframe_liga_form_itcotcompra_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_itcotcompra_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_itcotcompra_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_itcotcompra_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_itcotcompra_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_itcotcompra_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cotacao_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cotacao_mob_navigate_form_cb
  function do_ajax_form_cotacao_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cotacao_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cotacao_mob_navigate_form_cb_after_alert

  function sc_hide_form_cotacao_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_itcotcompra_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "atencao";
  ajax_field_list[2] = "comprador";
  ajax_field_list[3] = "emaildealer";
  ajax_field_list[4] = "ordernumb";
  ajax_field_list[5] = "moeda";
  ajax_field_list[6] = "data";
  ajax_field_list[7] = "natureza";
  ajax_field_list[8] = "obs";
  ajax_field_list[9] = "itenscompra";
  ...
  var ajax_error_list = {
    ...
    "atencao": {"label": "Atenção", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "emaildealer": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ordernumb": {"label": "Order number", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "moeda": {"label": "Moeda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "itenscompra": {"label": "Itens da Cotação", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "emaildealer": new Array("hidden_field_label_emaildealer", "hidden_field_data_emaildealer"),
    "ordernumb": new Array("hidden_field_label_ordernumb", "hidden_field_data_ordernumb"),
    "moeda": new Array("hidden_field_label_moeda", "hidden_field_data_moeda"),
    "data": new Array("hidden_field_label_data", "hidden_field_data_data"),
    "obs": new Array("hidden_field_label_obs", "hidden_field_data_obs"),
    "itenscompra": new Array("hidden_field_label_itenscompra", "hidden_field_data_itenscompra")
  };
