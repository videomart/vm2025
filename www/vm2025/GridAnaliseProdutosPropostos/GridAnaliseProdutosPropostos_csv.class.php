...
class GridAnaliseProdutosPropostos_csv
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo  .= ".csv";
      $this->Tit_doc   = "GridAnaliseProdutosPropostos.csv";
      ...
      if (!$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_return']);
          if ($this->Tem_csv_res) {
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_name']);
      }
      ...
      { 
          ...
          { 
              ...
              if ($Cada_col == "cliente" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
              {
                  ...
                  $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
                  $this->NM_prim_col++;
                  $SC_Label = (isset($this->New_label['empresa_email'])) ? $this->New_label['empresa_email'] : "{lang_btns_emai}";
                  $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
                  $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $SC_Label);
                  $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
                  $this->NM_prim_col++;
      ...
      { 
          ...
          require_once($this->Ini->path_aplicacao . "GridAnaliseProdutosPropostos_res_csv.class.php");
          $this->Res = new GridAnaliseProdutosPropostos_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   {
      $this->NM_export_proposta_natureza();
      $this->NM_export_proposta_ordem();
   }
   //----- produto
   function NM_export_produto()
   {
      $this->NM_export_itemproposta_modelo();
      $this->NM_export_marca_marca();
      $this->NM_export_itemproposta_descricao();
   }
   //----- cliente
   function NM_export_cliente()
   {
      $this->NM_export_proposta_cliente();
      $this->NM_export_proposta_atencao();
      $this->NM_export_empresa_email();
      $this->NM_export_empresa_telefone();
      $this->NM_export_empresa_celular();
   }
   //----- proposta_cod_vend
   ...
   function NM_export_proposta_ordem()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->proposta_ordem);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   //----- itemproposta_descricao
   function NM_export_itemproposta_descricao()
   {
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->itemproposta_descricao);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   //----- proposta_natureza
   ...
   //----- empresa_celular
   function NM_export_empresa_celular()
   {
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->empresa_celular);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   //----- marca_marca
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
