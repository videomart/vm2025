<?php
@session_start() ;
$_SESSION['scriptcase']['GridAnaliseProdutosPropostos']['sc_process_barr'] = true;
require_once('../GridAnaliseProdutosPropostos/index.php');
unset($_SESSION['scriptcase']['GridAnaliseProdutosPropostos']['sc_process_barr']);
$ExportCtrl = new GridAnaliseProdutosPropostos_export_control;
$ExportCtrl->Export_barr();

class GridAnaliseProdutosPropostos_export_control
{
