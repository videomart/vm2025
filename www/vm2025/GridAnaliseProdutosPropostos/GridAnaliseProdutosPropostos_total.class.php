...
class GridAnaliseProdutosPropostos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['GridAnaliseProdutosPropostos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['GridAnaliseProdutosPropostos']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['tot_geral'] = array() ;  
      $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['contr_total_geral'] = "OK";
   } 

   //-----  proposta_id
   function quebra_proposta_id_sc_free_group_by($proposta_id, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_proposta_id = array() ;  
      $tot_proposta_id[0] = $proposta_id ; 
   }
