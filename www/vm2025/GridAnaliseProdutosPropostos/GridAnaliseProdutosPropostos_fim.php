...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["VM2025_____GridAnaliseProdutosPropostos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["VM2025_____GridAnaliseProdutosPropostos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>GridAnaliseProdutosPropostos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['GridAnaliseProdutosPropostos']['embutida_filho'] as $ind => $sc_init)
          {
