...
<?php
   ...
   $Ord_Cmp = new GridAnaliseProdutosPropostos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class GridAnaliseProdutosPropostos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['natureza'] = "";
   }
   $tab_labels["natureza"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["natureza"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["natureza"] : "Natureza";
   ...
   {
       $tab_def_campos['produto'] = "";
   }
   $tab_labels["produto"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["produto"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["produto"] : "Dados do Produto";
   ...
   {
       $tab_def_campos['cliente'] = "";
   }
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["cliente"] : "Dados do cliente";
   $tab_ger_campos['proposta_cod_vend'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_cod_vend'] = "proposta_cod_vend";
   }
   else
   {
       $tab_def_campos['proposta_cod_vend'] = "proposta.cod_vend";
   }
   $tab_labels["proposta_cod_vend"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["proposta_cod_vend"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["proposta_cod_vend"] : "Consultor";
   $tab_ger_campos['proposta_data'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['proposta_data'] = "proposta_data";
   }
   else
   {
       $tab_def_campos['proposta_data'] = "proposta.data";
   }
   $tab_labels["proposta_data"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["proposta_data"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["proposta_data"] : "Data";
   $tab_ger_campos['empresa_celular'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['empresa_celular'] = "empresa_celular";
   }
   else
   {
       $tab_def_campos['empresa_celular'] = "empresa.celular";
   }
   $tab_labels["empresa_celular"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["empresa_celular"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["empresa_celular"] : "Celular";
   $tab_ger_campos['marca_marca'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['marca_marca'] = "marca_marca";
   }
   else
   {
       $tab_def_campos['marca_marca'] = "marca.marca";
   }
   $tab_labels["marca_marca"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["marca_marca"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["marca_marca"] : "Marca";
   $tab_ger_campos['itemproposta_modelo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['itemproposta_modelo'] = "itemproposta_modelo";
   }
   else
   {
       $tab_def_campos['itemproposta_modelo'] = "itemproposta.modelo";
   }
   $tab_labels["itemproposta_modelo"]   = (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["itemproposta_modelo"])) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['labels']["itemproposta_modelo"] : "Modelo";
   $tab_ger_campos['natureza'] = "none";
   $tab_ger_campos['produto'] = "none";
   $tab_ger_campos['cliente'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "GridAnaliseProdutosPropostos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['GridAnaliseProdutosPropostos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
