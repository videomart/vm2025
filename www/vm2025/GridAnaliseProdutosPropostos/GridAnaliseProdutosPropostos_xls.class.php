...
class GridAnaliseProdutosPropostos_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "GridAnaliseProdutosPropostos/GridAnaliseProdutosPropostos_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "GridAnaliseProdutosPropostos_res_xls.class.php");
              $this->Res_xls = new GridAnaliseProdutosPropostos_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_GridAnaliseProdutosPropostos.zip";
          $this->Arquivo   .= "_GridAnaliseProdutosPropostos" . $this->Xls_tp;
          $this->Tit_doc    = "GridAnaliseProdutosPropostos" . $this->Xls_tp;
          $this->Tit_zip    = "GridAnaliseProdutosPropostos.zip";
      ...
      require_once($this->Ini->path_aplicacao . "GridAnaliseProdutosPropostos_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->Xls_row++;
         $this->proposta_cod_vend = $rs->fields[0] ;  
         $this->proposta_data = $rs->fields[1] ;  
         $this->proposta_ordem = $rs->fields[2] ;  
         $this->proposta_ordem = (string)$this->proposta_ordem;
         $this->itemproposta_descricao = $rs->fields[3] ;  
         $this->proposta_natureza = $rs->fields[4] ;  
         $this->proposta_cliente = $rs->fields[5] ;  
         $this->proposta_atencao = $rs->fields[6] ;  
         $this->empresa_email = $rs->fields[7] ;  
         $this->empresa_telefone = $rs->fields[8] ;  
         $this->proposta_id = $rs->fields[9] ;  
         $this->proposta_id = (string)$this->proposta_id;
         $this->empresa_celular = $rs->fields[10] ;  
         $this->marca_marca = $rs->fields[11] ;  
         $this->itemproposta_modelo = $rs->fields[12] ;  
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "itemproposta_descricao" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "empresa_celular" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "marca_marca" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_natureza()
   {
         ...
         $Data_Out .= $SC_Lab . "\n";
         $Data_Out .= $this->NM_export_proposta_natureza(true);
         $Data_Out .= "\n";
         $SC_Lab = (isset($this->New_label['proposta_ordem'])) ? $this->New_label['proposta_ordem'] : "Ordem";
         $Data_Out .= $SC_Lab . "\n";
         $Data_Out .= $this->NM_export_proposta_ordem(true);
   ...
   //----- proposta_cod_vend
   function NM_export_proposta_cod_vend($Grouping=false)
   {
         if ($Grouping) {
             if ($this->proposta_cod_vend !== "&nbsp;") 
             { 
                 $this->proposta_cod_vend = sc_strtoupper($this->proposta_cod_vend); 
             } 
         }
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
      ...
      if (!empty($this->proposta_cod_vend))
      {
             if ($this->proposta_cod_vend !== "&nbsp;") 
             { 
                 $this->proposta_cod_vend = sc_strtoupper($this->proposta_cod_vend); 
   ...
   //----- proposta_data
   function NM_export_proposta_data($Grouping=false)
   {
         if ($Grouping) {
   ...
   //----- proposta_ordem
   function NM_export_proposta_ordem($Grouping=false)
   {
         if ($Grouping) {
             nmgp_Form_Num_Val($this->proposta_ordem, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         }
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
         ...
         if ($Grouping) {
             return $this->proposta_ordem;
         }
         if (is_numeric($this->proposta_ordem))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->proposta_ordem);
         $this->Xls_col++;
   }
   //----- itemproposta_descricao
   function NM_export_itemproposta_descricao($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
         ...
         $this->itemproposta_descricao = html_entity_decode($this->itemproposta_descricao, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->itemproposta_descricao = strip_tags($this->itemproposta_descricao);
         $this->itemproposta_descricao = NM_charset_to_utf8($this->itemproposta_descricao);
         if ($Grouping) {
             return $this->itemproposta_descricao;
         }
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->itemproposta_descricao, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->itemproposta_descricao, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- proposta_natureza
   function NM_export_proposta_natureza($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
   ...
   //----- proposta_cliente
   function NM_export_proposta_cliente($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
   ...
   //----- proposta_atencao
   function NM_export_proposta_atencao($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
   ...
   //----- empresa_celular
   function NM_export_empresa_celular($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
         ...
         $this->empresa_celular = html_entity_decode($this->empresa_celular, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->empresa_celular = strip_tags($this->empresa_celular);
         $this->empresa_celular = NM_charset_to_utf8($this->empresa_celular);
         if ($Grouping) {
             return $this->empresa_celular;
         }
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->empresa_celular, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->empresa_celular, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- marca_marca
   function NM_export_marca_marca($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
         ...
         $this->marca_marca = html_entity_decode($this->marca_marca, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->marca_marca = strip_tags($this->marca_marca);
         $this->marca_marca = NM_charset_to_utf8($this->marca_marca);
         if ($Grouping) {
             return $this->marca_marca;
         }
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->marca_marca, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->marca_marca, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- itemproposta_modelo
   function NM_export_itemproposta_modelo($Grouping=false)
   {
         if (!$Grouping) {
             $current_cell_ref = $this->calc_cell($this->Xls_col);
             if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
         ...
         if ($Grouping) {
             return $this->itemproposta_modelo;
         }
         if ($this->Use_phpspreadsheet) {
   ...
   function NM_sub_cons_natureza()
   {
         ...
         $prim_group = false;
         $this->Xls_row++;
         $this->natureza = $this->NM_sub_cons_proposta_natureza(true);
         ...
         $prim_group = false;
         $this->Xls_row++;
         $this->natureza = $this->NM_sub_cons_proposta_ordem(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->natureza;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function NM_sub_cons_produto()
   {
         ...
         $prim_group = false;
         $this->Xls_row++;
         $this->produto = $this->NM_sub_cons_itemproposta_modelo(true);
         ...
         $prim_group = false;
         $this->Xls_row++;
         $this->produto = $this->NM_sub_cons_marca_marca(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->produto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         ...
         $prim_group = false;
         $this->Xls_row++;
         $this->produto = $this->NM_sub_cons_itemproposta_descricao(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->produto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function NM_sub_cons_cliente()
   {
         ...
         $xls_row_base = $this->Xls_row;
         $SC_Lab = (isset($this->New_label['proposta_cliente'])) ? $this->New_label['proposta_cliente'] : "Cliente";
         $this->cliente = $SC_Lab . ": " . $this->NM_sub_cons_proposta_cliente(true);
         ...
         $this->Xls_row++;
         $SC_Lab = (isset($this->New_label['proposta_atencao'])) ? $this->New_label['proposta_atencao'] : "Atencao";
         $this->cliente = $SC_Lab . ": " . $this->NM_sub_cons_proposta_atencao(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         ...
         $this->Xls_row++;
         $SC_Lab = (isset($this->New_label['empresa_email'])) ? $this->New_label['empresa_email'] : "{lang_btns_emai}";
         $this->cliente = $SC_Lab . ": " . $this->NM_sub_cons_empresa_email(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         ...
         $this->Xls_row++;
         $SC_Lab = (isset($this->New_label['empresa_telefone'])) ? $this->New_label['empresa_telefone'] : "Telefone";
         $this->cliente = $SC_Lab . ": " . $this->NM_sub_cons_empresa_telefone(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         ...
         $this->Xls_row++;
         $SC_Lab = (isset($this->New_label['empresa_celular'])) ? $this->New_label['empresa_celular'] : "Celular";
         $this->cliente = $SC_Lab . ": " . $this->NM_sub_cons_empresa_celular(true);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   //----- proposta_cod_vend
   function NM_sub_cons_proposta_cod_vend($Grouping=false)
   {
         if ($Grouping) {
         if ($this->proposta_cod_vend !== "&nbsp;") 
         { 
   ...
   //----- proposta_data
   function NM_sub_cons_proposta_data($Grouping=false)
   {
         if ($Grouping) {
         $conteudo_x =  $this->proposta_data;
         nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD");
   ...
   //----- proposta_ordem
   function NM_sub_cons_proposta_ordem($Grouping=false)
   {
         if ($Grouping) {
         nmgp_Form_Num_Val($this->proposta_ordem, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         }
   ...
   //----- itemproposta_descricao
   function NM_sub_cons_itemproposta_descricao($Grouping=false)
   {
         $this->itemproposta_descricao = html_entity_decode($this->itemproposta_descricao, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->itemproposta_descricao = strip_tags($this->itemproposta_descricao);
         $this->itemproposta_descricao = NM_charset_to_utf8($this->itemproposta_descricao);
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->itemproposta_descricao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- proposta_natureza
   function NM_sub_cons_proposta_natureza($Grouping=false)
   {
         $this->proposta_natureza = html_entity_decode($this->proposta_natureza, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->proposta_natureza = strip_tags($this->proposta_natureza);
         $this->proposta_natureza = NM_charset_to_utf8($this->proposta_natureza);
   ...
   //----- proposta_cliente
   function NM_sub_cons_proposta_cliente($Grouping=false)
   {
         $this->proposta_cliente = html_entity_decode($this->proposta_cliente, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->proposta_cliente = strip_tags($this->proposta_cliente);
         $this->proposta_cliente = NM_charset_to_utf8($this->proposta_cliente);
   ...
   //----- proposta_atencao
   function NM_sub_cons_proposta_atencao($Grouping=false)
   {
         $this->proposta_atencao = html_entity_decode($this->proposta_atencao, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->proposta_atencao = strip_tags($this->proposta_atencao);
         $this->proposta_atencao = NM_charset_to_utf8($this->proposta_atencao);
   ...
   //----- empresa_celular
   function NM_sub_cons_empresa_celular($Grouping=false)
   {
         $this->empresa_celular = html_entity_decode($this->empresa_celular, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->empresa_celular = strip_tags($this->empresa_celular);
         $this->empresa_celular = NM_charset_to_utf8($this->empresa_celular);
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->empresa_celular;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- marca_marca
   function NM_sub_cons_marca_marca($Grouping=false)
   {
         $this->marca_marca = html_entity_decode($this->marca_marca, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->marca_marca = strip_tags($this->marca_marca);
         $this->marca_marca = NM_charset_to_utf8($this->marca_marca);
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->marca_marca;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- itemproposta_modelo
   function NM_sub_cons_itemproposta_modelo($Grouping=false)
   {
         $this->itemproposta_modelo = html_entity_decode($this->itemproposta_modelo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->itemproposta_modelo = strip_tags($this->itemproposta_modelo);
         $this->itemproposta_modelo = NM_charset_to_utf8($this->itemproposta_modelo);
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['nolabel'])
       {
 ...
 function quebra_proposta_id_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_proposta_id_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_proposta_id as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_proposta_id_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['GridAnaliseProdutosPropostos']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
